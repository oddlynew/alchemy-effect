...
Set your Cloudflare environment variables.
...
:::note
Find your Cloudflare Account ID on [Account Home](https://dash.cloudflare.com/?to=/:account/home) and [create your Cloudflare API Token here](https://dash.cloudflare.com/profile/api-tokens). The "Edit Cloudflare Workers" template is sufficient for this tutorial.
:::
