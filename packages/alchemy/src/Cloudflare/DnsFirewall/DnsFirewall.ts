 ...
 */
export const DnsFirewall = Resource<DnsFirewall>(DnsFirewallTypeId);

/**
 * Returns true if the given value is a DnsFirewall resource.
 */
export const isDnsFirewall = (value: unknown): value is DnsFirewall =>
  Predicate.hasProperty(value, "Type") && value.Type === DnsFirewallTypeId;

export const DnsFirewallProvider = () =>
  Provider.succeed(DnsFirewall, {
