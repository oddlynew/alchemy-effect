...
projects/alchemy/apps/website/src/content/docs/providers/{Cloud}/{Resource}.md  # API reference, generated by `bun nx build:reference @oddlynew/alchemy-website`
```
...
```sh
bun nx build:reference @oddlynew/alchemy-website   # -> projects/alchemy/apps/website/src/content/docs/providers/{Cloud}/{Resource}.md
```
...
After editing JSDoc on a resource, run `bun nx build:reference @oddlynew/alchemy-website` to refresh the website docs.
