...
const svc = T.AwsApiService({ sdkId: "S3 Control", serviceShapeName: "AWSS3ControlServiceV20180820" });
...
export class AssociateAccessGrantsIdentityCenterRequest extends S.Class<AssociateAccessGrantsIdentityCenterRequest>("AssociateAccessGrantsIdentityCenterRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), IdentityCenterArn: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/v20180820/accessgrantsinstance/identitycenter" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class AssociateAccessGrantsIdentityCenterResponse extends S.Class<AssociateAccessGrantsIdentityCenterResponse>("AssociateAccessGrantsIdentityCenterResponse")({}, ns) {}
export class Tag extends S.Class<Tag>("Tag")({Key: S.String, Value: S.String}) {}
export const TagList = S.Array(Tag.pipe(T.XmlName("Tag")));
export class CreateAccessGrantsInstanceRequest extends S.Class<CreateAccessGrantsInstanceRequest>("CreateAccessGrantsInstanceRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), IdentityCenterArn: S.optional(S.String), Tags: S.optional(TagList)}, T.all(ns, T.Http({ method: "POST", uri: "/v20180820/accessgrantsinstance" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class CreateAccessGrantsLocationRequest extends S.Class<CreateAccessGrantsLocationRequest>("CreateAccessGrantsLocationRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), LocationScope: S.String, IAMRoleArn: S.String, Tags: S.optional(TagList)}, T.all(ns, T.Http({ method: "POST", uri: "/v20180820/accessgrantsinstance/location" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class DeleteAccessGrantRequest extends S.Class<DeleteAccessGrantRequest>("DeleteAccessGrantRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), AccessGrantId: S.String.pipe(T.HttpLabel("AccessGrantId"))}, T.all(ns, T.Http({ method: "DELETE", uri: "/v20180820/accessgrantsinstance/grant/{AccessGrantId}" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class DeleteAccessGrantResponse extends S.Class<DeleteAccessGrantResponse>("DeleteAccessGrantResponse")({}, ns) {}
export class DeleteAccessGrantsInstanceRequest extends S.Class<DeleteAccessGrantsInstanceRequest>("DeleteAccessGrantsInstanceRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel())}, T.all(ns, T.Http({ method: "DELETE", uri: "/v20180820/accessgrantsinstance" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class DeleteAccessGrantsInstanceResponse extends S.Class<DeleteAccessGrantsInstanceResponse>("DeleteAccessGrantsInstanceResponse")({}, ns) {}
export class DeleteAccessGrantsInstanceResourcePolicyRequest extends S.Class<DeleteAccessGrantsInstanceResourcePolicyRequest>("DeleteAccessGrantsInstanceResourcePolicyRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel())}, T.all(ns, T.Http({ method: "DELETE", uri: "/v20180820/accessgrantsinstance/resourcepolicy" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class DeleteAccessGrantsInstanceResourcePolicyResponse extends S.Class<DeleteAccessGrantsInstanceResourcePolicyResponse>("DeleteAccessGrantsInstanceResourcePolicyResponse")({}, ns) {}
export class DeleteAccessGrantsLocationRequest extends S.Class<DeleteAccessGrantsLocationRequest>("DeleteAccessGrantsLocationRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), AccessGrantsLocationId: S.String.pipe(T.HttpLabel("AccessGrantsLocationId"))}, T.all(ns, T.Http({ method: "DELETE", uri: "/v20180820/accessgrantsinstance/location/{AccessGrantsLocationId}" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class DeleteAccessGrantsLocationResponse extends S.Class<DeleteAccessGrantsLocationResponse>("DeleteAccessGrantsLocationResponse")({}, ns) {}
export class DeleteAccessPointRequest extends S.Class<DeleteAccessPointRequest>("DeleteAccessPointRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Name: S.String.pipe(T.HttpLabel("Name"), T.ContextParam("AccessPointName"))}, T.all(ns, T.Http({ method: "DELETE", uri: "/v20180820/accesspoint/{Name}" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class DeleteAccessPointResponse extends S.Class<DeleteAccessPointResponse>("DeleteAccessPointResponse")({}, ns) {}
export class DeleteAccessPointForObjectLambdaRequest extends S.Class<DeleteAccessPointForObjectLambdaRequest>("DeleteAccessPointForObjectLambdaRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Name: S.String.pipe(T.HttpLabel("Name"))}, T.all(ns, T.Http({ method: "DELETE", uri: "/v20180820/accesspointforobjectlambda/{Name}" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class DeleteAccessPointForObjectLambdaResponse extends S.Class<DeleteAccessPointForObjectLambdaResponse>("DeleteAccessPointForObjectLambdaResponse")({}, ns) {}
export class DeleteAccessPointPolicyRequest extends S.Class<DeleteAccessPointPolicyRequest>("DeleteAccessPointPolicyRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Name: S.String.pipe(T.HttpLabel("Name"), T.ContextParam("AccessPointName"))}, T.all(ns, T.Http({ method: "DELETE", uri: "/v20180820/accesspoint/{Name}/policy" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class DeleteAccessPointPolicyResponse extends S.Class<DeleteAccessPointPolicyResponse>("DeleteAccessPointPolicyResponse")({}, ns) {}
export class DeleteAccessPointPolicyForObjectLambdaRequest extends S.Class<DeleteAccessPointPolicyForObjectLambdaRequest>("DeleteAccessPointPolicyForObjectLambdaRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Name: S.String.pipe(T.HttpLabel("Name"))}, T.all(ns, T.Http({ method: "DELETE", uri: "/v20180820/accesspointforobjectlambda/{Name}/policy" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class DeleteAccessPointPolicyForObjectLambdaResponse extends S.Class<DeleteAccessPointPolicyForObjectLambdaResponse>("DeleteAccessPointPolicyForObjectLambdaResponse")({}, ns) {}
export class DeleteAccessPointScopeRequest extends S.Class<DeleteAccessPointScopeRequest>("DeleteAccessPointScopeRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Name: S.String.pipe(T.HttpLabel("Name"), T.ContextParam("AccessPointName"))}, T.all(ns, T.Http({ method: "DELETE", uri: "/v20180820/accesspoint/{Name}/scope" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true},"UseS3ExpressControlEndpoint":{"value":true}}))) {}
export class DeleteAccessPointScopeResponse extends S.Class<DeleteAccessPointScopeResponse>("DeleteAccessPointScopeResponse")({}, ns) {}
export class DeleteBucketRequest extends S.Class<DeleteBucketRequest>("DeleteBucketRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket"))}, T.all(ns, T.Http({ method: "DELETE", uri: "/v20180820/bucket/{Bucket}" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class DeleteBucketResponse extends S.Class<DeleteBucketResponse>("DeleteBucketResponse")({}, ns) {}
export class DeleteBucketLifecycleConfigurationRequest extends S.Class<DeleteBucketLifecycleConfigurationRequest>("DeleteBucketLifecycleConfigurationRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket"))}, T.all(ns, T.Http({ method: "DELETE", uri: "/v20180820/bucket/{Bucket}/lifecycleconfiguration" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class DeleteBucketLifecycleConfigurationResponse extends S.Class<DeleteBucketLifecycleConfigurationResponse>("DeleteBucketLifecycleConfigurationResponse")({}, ns) {}
export class DeleteBucketPolicyRequest extends S.Class<DeleteBucketPolicyRequest>("DeleteBucketPolicyRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket"))}, T.all(ns, T.Http({ method: "DELETE", uri: "/v20180820/bucket/{Bucket}/policy" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class DeleteBucketPolicyResponse extends S.Class<DeleteBucketPolicyResponse>("DeleteBucketPolicyResponse")({}, ns) {}
export class DeleteBucketReplicationRequest extends S.Class<DeleteBucketReplicationRequest>("DeleteBucketReplicationRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket"))}, T.all(ns, T.Http({ method: "DELETE", uri: "/v20180820/bucket/{Bucket}/replication" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
...
export class DeleteBucketTaggingRequest extends S.Class<DeleteBucketTaggingRequest>("DeleteBucketTaggingRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket"))}, T.all(ns, T.Http({ method: "DELETE", uri: "/v20180820/bucket/{Bucket}/tagging" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class DeleteBucketTaggingResponse extends S.Class<DeleteBucketTaggingResponse>("DeleteBucketTaggingResponse")({}, ns) {}
export class DeleteJobTaggingRequest extends S.Class<DeleteJobTaggingRequest>("DeleteJobTaggingRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), JobId: S.String.pipe(T.HttpLabel("JobId"))}, T.all(ns, T.Http({ method: "DELETE", uri: "/v20180820/jobs/{JobId}/tagging" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class DeleteJobTaggingResult extends S.Class<DeleteJobTaggingResult>("DeleteJobTaggingResult")({}, ns) {}
...
export class DeleteStorageLensConfigurationRequest extends S.Class<DeleteStorageLensConfigurationRequest>("DeleteStorageLensConfigurationRequest")({ConfigId: S.String.pipe(T.HttpLabel("ConfigId")), AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel())}, T.all(ns, T.Http({ method: "DELETE", uri: "/v20180820/storagelens/{ConfigId}" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class DeleteStorageLensConfigurationResponse extends S.Class<DeleteStorageLensConfigurationResponse>("DeleteStorageLensConfigurationResponse")({}, ns) {}
export class DeleteStorageLensConfigurationTaggingRequest extends S.Class<DeleteStorageLensConfigurationTaggingRequest>("DeleteStorageLensConfigurationTaggingRequest")({ConfigId: S.String.pipe(T.HttpLabel("ConfigId")), AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel())}, T.all(ns, T.Http({ method: "DELETE", uri: "/v20180820/storagelens/{ConfigId}/tagging" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class DeleteStorageLensConfigurationTaggingResult extends S.Class<DeleteStorageLensConfigurationTaggingResult>("DeleteStorageLensConfigurationTaggingResult")({}, ns) {}
export class DeleteStorageLensGroupRequest extends S.Class<DeleteStorageLensGroupRequest>("DeleteStorageLensGroupRequest")({Name: S.String.pipe(T.HttpLabel("Name")), AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel())}, T.all(ns, T.Http({ method: "DELETE", uri: "/v20180820/storagelensgroup/{Name}" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class DeleteStorageLensGroupResponse extends S.Class<DeleteStorageLensGroupResponse>("DeleteStorageLensGroupResponse")({}, ns) {}
export class DescribeJobRequest extends S.Class<DescribeJobRequest>("DescribeJobRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), JobId: S.String.pipe(T.HttpLabel("JobId"))}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/jobs/{JobId}" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class DescribeMultiRegionAccessPointOperationRequest extends S.Class<DescribeMultiRegionAccessPointOperationRequest>("DescribeMultiRegionAccessPointOperationRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), RequestTokenARN: S.String.pipe(T.HttpLabel("RequestTokenARN"))}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/async-requests/mrap/{RequestTokenARN+}" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class DissociateAccessGrantsIdentityCenterRequest extends S.Class<DissociateAccessGrantsIdentityCenterRequest>("DissociateAccessGrantsIdentityCenterRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel())}, T.all(ns, T.Http({ method: "DELETE", uri: "/v20180820/accessgrantsinstance/identitycenter" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class DissociateAccessGrantsIdentityCenterResponse extends S.Class<DissociateAccessGrantsIdentityCenterResponse>("DissociateAccessGrantsIdentityCenterResponse")({}, ns) {}
export class GetAccessGrantRequest extends S.Class<GetAccessGrantRequest>("GetAccessGrantRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), AccessGrantId: S.String.pipe(T.HttpLabel("AccessGrantId"))}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/accessgrantsinstance/grant/{AccessGrantId}" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class GetAccessGrantsInstanceRequest extends S.Class<GetAccessGrantsInstanceRequest>("GetAccessGrantsInstanceRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel())}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/accessgrantsinstance" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class GetAccessGrantsInstanceForPrefixRequest extends S.Class<GetAccessGrantsInstanceForPrefixRequest>("GetAccessGrantsInstanceForPrefixRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), S3Prefix: S.String.pipe(T.HttpQuery("s3prefix"))}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/accessgrantsinstance/prefix" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class GetAccessGrantsInstanceResourcePolicyRequest extends S.Class<GetAccessGrantsInstanceResourcePolicyRequest>("GetAccessGrantsInstanceResourcePolicyRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel())}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/accessgrantsinstance/resourcepolicy" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class GetAccessGrantsLocationRequest extends S.Class<GetAccessGrantsLocationRequest>("GetAccessGrantsLocationRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), AccessGrantsLocationId: S.String.pipe(T.HttpLabel("AccessGrantsLocationId"))}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/accessgrantsinstance/location/{AccessGrantsLocationId}" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class GetAccessPointRequest extends S.Class<GetAccessPointRequest>("GetAccessPointRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Name: S.String.pipe(T.HttpLabel("Name"), T.ContextParam("AccessPointName"))}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/accesspoint/{Name}" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class GetAccessPointConfigurationForObjectLambdaRequest extends S.Class<GetAccessPointConfigurationForObjectLambdaRequest>("GetAccessPointConfigurationForObjectLambdaRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Name: S.String.pipe(T.HttpLabel("Name"))}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/accesspointforobjectlambda/{Name}/configuration" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class GetAccessPointForObjectLambdaRequest extends S.Class<GetAccessPointForObjectLambdaRequest>("GetAccessPointForObjectLambdaRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Name: S.String.pipe(T.HttpLabel("Name"))}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/accesspointforobjectlambda/{Name}" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class GetAccessPointPolicyRequest extends S.Class<GetAccessPointPolicyRequest>("GetAccessPointPolicyRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Name: S.String.pipe(T.HttpLabel("Name"), T.ContextParam("AccessPointName"))}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/accesspoint/{Name}/policy" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class GetAccessPointPolicyForObjectLambdaRequest extends S.Class<GetAccessPointPolicyForObjectLambdaRequest>("GetAccessPointPolicyForObjectLambdaRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Name: S.String.pipe(T.HttpLabel("Name"))}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/accesspointforobjectlambda/{Name}/policy" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class GetAccessPointPolicyStatusRequest extends S.Class<GetAccessPointPolicyStatusRequest>("GetAccessPointPolicyStatusRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Name: S.String.pipe(T.HttpLabel("Name"), T.ContextParam("AccessPointName"))}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/accesspoint/{Name}/policyStatus" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class GetAccessPointPolicyStatusForObjectLambdaRequest extends S.Class<GetAccessPointPolicyStatusForObjectLambdaRequest>("GetAccessPointPolicyStatusForObjectLambdaRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Name: S.String.pipe(T.HttpLabel("Name"))}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/accesspointforobjectlambda/{Name}/policyStatus" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class GetAccessPointScopeRequest extends S.Class<GetAccessPointScopeRequest>("GetAccessPointScopeRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Name: S.String.pipe(T.HttpLabel("Name"), T.ContextParam("AccessPointName"))}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/accesspoint/{Name}/scope" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true},"UseS3ExpressControlEndpoint":{"value":true}}))) {}
export class GetBucketRequest extends S.Class<GetBucketRequest>("GetBucketRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket"))}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/bucket/{Bucket}" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class GetBucketLifecycleConfigurationRequest extends S.Class<GetBucketLifecycleConfigurationRequest>("GetBucketLifecycleConfigurationRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket"))}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/bucket/{Bucket}/lifecycleconfiguration" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class GetBucketPolicyRequest extends S.Class<GetBucketPolicyRequest>("GetBucketPolicyRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket"))}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/bucket/{Bucket}/policy" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class GetBucketReplicationRequest extends S.Class<GetBucketReplicationRequest>("GetBucketReplicationRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket"))}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/bucket/{Bucket}/replication" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class GetBucketTaggingRequest extends S.Class<GetBucketTaggingRequest>("GetBucketTaggingRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket"))}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/bucket/{Bucket}/tagging" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class GetBucketVersioningRequest extends S.Class<GetBucketVersioningRequest>("GetBucketVersioningRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket"))}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/bucket/{Bucket}/versioning" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class GetDataAccessRequest extends S.Class<GetDataAccessRequest>("GetDataAccessRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Target: S.String.pipe(T.HttpQuery("target")), Permission: S.String.pipe(T.HttpQuery("permission")), DurationSeconds: S.optional(S.Number).pipe(T.HttpQuery("durationSeconds")), Privilege: S.optional(S.String).pipe(T.HttpQuery("privilege")), TargetType: S.optional(S.String).pipe(T.HttpQuery("targetType"))}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/accessgrantsinstance/dataaccess" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class GetJobTaggingRequest extends S.Class<GetJobTaggingRequest>("GetJobTaggingRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), JobId: S.String.pipe(T.HttpLabel("JobId"))}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/jobs/{JobId}/tagging" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class GetMultiRegionAccessPointRequest extends S.Class<GetMultiRegionAccessPointRequest>("GetMultiRegionAccessPointRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Name: S.String.pipe(T.HttpLabel("Name"))}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/mrap/instances/{Name+}" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class GetMultiRegionAccessPointPolicyRequest extends S.Class<GetMultiRegionAccessPointPolicyRequest>("GetMultiRegionAccessPointPolicyRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Name: S.String.pipe(T.HttpLabel("Name"))}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/mrap/instances/{Name+}/policy" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class GetMultiRegionAccessPointPolicyStatusRequest extends S.Class<GetMultiRegionAccessPointPolicyStatusRequest>("GetMultiRegionAccessPointPolicyStatusRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Name: S.String.pipe(T.HttpLabel("Name"))}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/mrap/instances/{Name+}/policystatus" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class GetMultiRegionAccessPointRoutesRequest extends S.Class<GetMultiRegionAccessPointRoutesRequest>("GetMultiRegionAccessPointRoutesRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Mrap: S.String.pipe(T.HttpLabel("Mrap"))}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/mrap/instances/{Mrap+}/routes" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class GetPublicAccessBlockRequest extends S.Class<GetPublicAccessBlockRequest>("GetPublicAccessBlockRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel())}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/configuration/publicAccessBlock" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class GetStorageLensConfigurationRequest extends S.Class<GetStorageLensConfigurationRequest>("GetStorageLensConfigurationRequest")({ConfigId: S.String.pipe(T.HttpLabel("ConfigId")), AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel())}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/storagelens/{ConfigId}" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class GetStorageLensConfigurationTaggingRequest extends S.Class<GetStorageLensConfigurationTaggingRequest>("GetStorageLensConfigurationTaggingRequest")({ConfigId: S.String.pipe(T.HttpLabel("ConfigId")), AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel())}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/storagelens/{ConfigId}/tagging" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class GetStorageLensGroupRequest extends S.Class<GetStorageLensGroupRequest>("GetStorageLensGroupRequest")({Name: S.String.pipe(T.HttpLabel("Name")), AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel())}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/storagelensgroup/{Name}" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class ListAccessGrantsRequest extends S.Class<ListAccessGrantsRequest>("ListAccessGrantsRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), NextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken")), MaxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults")), GranteeType: S.optional(S.String).pipe(T.HttpQuery("granteetype")), GranteeIdentifier: S.optional(S.String).pipe(T.HttpQuery("granteeidentifier")), Permission: S.optional(S.String).pipe(T.HttpQuery("permission")), GrantScope: S.optional(S.String).pipe(T.HttpQuery("grantscope")), ApplicationArn: S.optional(S.String).pipe(T.HttpQuery("application_arn"))}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/accessgrantsinstance/grants" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class ListAccessGrantsInstancesRequest extends S.Class<ListAccessGrantsInstancesRequest>("ListAccessGrantsInstancesRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), NextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken")), MaxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults"))}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/accessgrantsinstances" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class ListAccessGrantsLocationsRequest extends S.Class<ListAccessGrantsLocationsRequest>("ListAccessGrantsLocationsRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), NextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken")), MaxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults")), LocationScope: S.optional(S.String).pipe(T.HttpQuery("locationscope"))}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/accessgrantsinstance/locations" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class ListAccessPointsRequest extends S.Class<ListAccessPointsRequest>("ListAccessPointsRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Bucket: S.optional(S.String).pipe(T.HttpQuery("bucket"), T.ContextParam("Bucket")), NextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken")), MaxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults")), DataSourceId: S.optional(S.String).pipe(T.HttpQuery("dataSourceId")), DataSourceType: S.optional(S.String).pipe(T.HttpQuery("dataSourceType"))}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/accesspoint" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class ListAccessPointsForDirectoryBucketsRequest extends S.Class<ListAccessPointsForDirectoryBucketsRequest>("ListAccessPointsForDirectoryBucketsRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), DirectoryBucket: S.optional(S.String).pipe(T.HttpQuery("directoryBucket")), NextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken")), MaxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults"))}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/accesspointfordirectory" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true},"UseS3ExpressControlEndpoint":{"value":true}}))) {}
export class ListAccessPointsForObjectLambdaRequest extends S.Class<ListAccessPointsForObjectLambdaRequest>("ListAccessPointsForObjectLambdaRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), NextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken")), MaxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults"))}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/accesspointforobjectlambda" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class ListCallerAccessGrantsRequest extends S.Class<ListCallerAccessGrantsRequest>("ListCallerAccessGrantsRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), GrantScope: S.optional(S.String).pipe(T.HttpQuery("grantscope")), NextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken")), MaxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults")), AllowedByApplication: S.optional(S.Boolean).pipe(T.HttpQuery("allowedByApplication"))}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/accessgrantsinstance/caller/grants" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class ListJobsRequest extends S.Class<ListJobsRequest>("ListJobsRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), JobStatuses: S.optional(JobStatusList).pipe(T.HttpQuery("jobStatuses")), NextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken")), MaxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults"))}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/jobs" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class ListMultiRegionAccessPointsRequest extends S.Class<ListMultiRegionAccessPointsRequest>("ListMultiRegionAccessPointsRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), NextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken")), MaxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults"))}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/mrap/instances" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class ListRegionalBucketsRequest extends S.Class<ListRegionalBucketsRequest>("ListRegionalBucketsRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), NextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken")), MaxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults")), OutpostId: S.optional(S.String).pipe(T.HttpHeader("x-amz-outpost-id"), T.ContextParam("OutpostId"))}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/bucket" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class ListStorageLensConfigurationsRequest extends S.Class<ListStorageLensConfigurationsRequest>("ListStorageLensConfigurationsRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), NextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken"))}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/storagelens" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class ListStorageLensGroupsRequest extends S.Class<ListStorageLensGroupsRequest>("ListStorageLensGroupsRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), NextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken"))}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/storagelensgroup" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class ListTagsForResourceRequest extends S.Class<ListTagsForResourceRequest>("ListTagsForResourceRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), ResourceArn: S.String.pipe(T.HttpLabel("ResourceArn"), T.ContextParam("ResourceArn"))}, T.all(ns, T.Http({ method: "GET", uri: "/v20180820/tags/{ResourceArn+}" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class PutAccessGrantsInstanceResourcePolicyRequest extends S.Class<PutAccessGrantsInstanceResourcePolicyRequest>("PutAccessGrantsInstanceResourcePolicyRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Policy: S.String, Organization: S.optional(S.String)}, T.all(ns, T.Http({ method: "PUT", uri: "/v20180820/accessgrantsinstance/resourcepolicy" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export const ObjectLambdaAllowedFeaturesList = S.Array(S.String.pipe(T.XmlName("AllowedFeature")));
export const ObjectLambdaTransformationConfigurationActionsList = S.Array(S.String.pipe(T.XmlName("Action")));
...
export const ObjectLambdaContentTransformation = S.Union(S.Struct({ AwsLambda: AwsLambdaTransformation }));
...
export const ObjectLambdaTransformationConfigurationsList = S.Array(ObjectLambdaTransformationConfiguration.pipe(T.XmlName("TransformationConfiguration")));
...
export class PutAccessPointConfigurationForObjectLambdaRequest extends S.Class<PutAccessPointConfigurationForObjectLambdaRequest>("PutAccessPointConfigurationForObjectLambdaRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Name: S.String.pipe(T.HttpLabel("Name")), Configuration: ObjectLambdaConfiguration}, T.all(ns, T.Http({ method: "PUT", uri: "/v20180820/accesspointforobjectlambda/{Name}/configuration" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class PutAccessPointConfigurationForObjectLambdaResponse extends S.Class<PutAccessPointConfigurationForObjectLambdaResponse>("PutAccessPointConfigurationForObjectLambdaResponse")({}, ns) {}
export class PutAccessPointPolicyRequest extends S.Class<PutAccessPointPolicyRequest>("PutAccessPointPolicyRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Name: S.String.pipe(T.HttpLabel("Name"), T.ContextParam("AccessPointName")), Policy: S.String}, T.all(ns, T.Http({ method: "PUT", uri: "/v20180820/accesspoint/{Name}/policy" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class PutAccessPointPolicyResponse extends S.Class<PutAccessPointPolicyResponse>("PutAccessPointPolicyResponse")({}, ns) {}
export class PutAccessPointPolicyForObjectLambdaRequest extends S.Class<PutAccessPointPolicyForObjectLambdaRequest>("PutAccessPointPolicyForObjectLambdaRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Name: S.String.pipe(T.HttpLabel("Name")), Policy: S.String}, T.all(ns, T.Http({ method: "PUT", uri: "/v20180820/accesspointforobjectlambda/{Name}/policy" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class PutAccessPointPolicyForObjectLambdaResponse extends S.Class<PutAccessPointPolicyForObjectLambdaResponse>("PutAccessPointPolicyForObjectLambdaResponse")({}, ns) {}
export const PrefixesList = S.Array(S.String.pipe(T.XmlName("Prefix")));
export const ScopePermissionList = S.Array(S.String.pipe(T.XmlName("Permission")));
export class Scope extends S.Class<Scope>("Scope")({Prefixes: S.optional(PrefixesList).pipe(T.XmlName("Prefixes")), Permissions: S.optional(ScopePermissionList).pipe(T.XmlName("Permissions"))}) {}
export class PutAccessPointScopeRequest extends S.Class<PutAccessPointScopeRequest>("PutAccessPointScopeRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Name: S.String.pipe(T.HttpLabel("Name"), T.ContextParam("AccessPointName")), Scope: Scope}, T.all(ns, T.Http({ method: "PUT", uri: "/v20180820/accesspoint/{Name}/scope" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true},"UseS3ExpressControlEndpoint":{"value":true}}))) {}
export class PutAccessPointScopeResponse extends S.Class<PutAccessPointScopeResponse>("PutAccessPointScopeResponse")({}, ns) {}
export class PutBucketPolicyRequest extends S.Class<PutBucketPolicyRequest>("PutBucketPolicyRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket")), ConfirmRemoveSelfBucketAccess: S.optional(S.Boolean).pipe(T.HttpHeader("x-amz-confirm-remove-self-bucket-access")), Policy: S.String}, T.all(ns, T.Http({ method: "PUT", uri: "/v20180820/bucket/{Bucket}/policy" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
...
export class PutJobTaggingRequest extends S.Class<PutJobTaggingRequest>("PutJobTaggingRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), JobId: S.String.pipe(T.HttpLabel("JobId")), Tags: S3TagSet}, T.all(ns, T.Http({ method: "PUT", uri: "/v20180820/jobs/{JobId}/tagging" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class PutJobTaggingResult extends S.Class<PutJobTaggingResult>("PutJobTaggingResult")({}, ns) {}
...
export class PutPublicAccessBlockRequest extends S.Class<PutPublicAccessBlockRequest>("PutPublicAccessBlockRequest")({PublicAccessBlockConfiguration: PublicAccessBlockConfiguration.pipe(T.HttpPayload(), T.XmlName("PublicAccessBlockConfiguration")), AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel())}, T.all(ns, T.Http({ method: "PUT", uri: "/v20180820/configuration/publicAccessBlock" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
...
export class PutStorageLensConfigurationTaggingRequest extends S.Class<PutStorageLensConfigurationTaggingRequest>("PutStorageLensConfigurationTaggingRequest")({ConfigId: S.String.pipe(T.HttpLabel("ConfigId")), AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Tags: StorageLensTags}, T.all(ns, T.Http({ method: "PUT", uri: "/v20180820/storagelens/{ConfigId}/tagging" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class PutStorageLensConfigurationTaggingResult extends S.Class<PutStorageLensConfigurationTaggingResult>("PutStorageLensConfigurationTaggingResult")({}, ns) {}
export class TagResourceRequest extends S.Class<TagResourceRequest>("TagResourceRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), ResourceArn: S.String.pipe(T.HttpLabel("ResourceArn"), T.ContextParam("ResourceArn")), Tags: TagList}, T.all(ns, T.Http({ method: "POST", uri: "/v20180820/tags/{ResourceArn+}" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class TagResourceResult extends S.Class<TagResourceResult>("TagResourceResult")({}, ns) {}
export class UntagResourceRequest extends S.Class<UntagResourceRequest>("UntagResourceRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), ResourceArn: S.String.pipe(T.HttpLabel("ResourceArn"), T.ContextParam("ResourceArn")), TagKeys: TagKeyList.pipe(T.HttpQuery("tagKeys"))}, T.all(ns, T.Http({ method: "DELETE", uri: "/v20180820/tags/{ResourceArn+}" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class UntagResourceResult extends S.Class<UntagResourceResult>("UntagResourceResult")({}, ns) {}
export class UpdateAccessGrantsLocationRequest extends S.Class<UpdateAccessGrantsLocationRequest>("UpdateAccessGrantsLocationRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), AccessGrantsLocationId: S.String.pipe(T.HttpLabel("AccessGrantsLocationId")), IAMRoleArn: S.String}, T.all(ns, T.Http({ method: "PUT", uri: "/v20180820/accessgrantsinstance/location/{AccessGrantsLocationId}" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class UpdateJobPriorityRequest extends S.Class<UpdateJobPriorityRequest>("UpdateJobPriorityRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), JobId: S.String.pipe(T.HttpLabel("JobId")), Priority: S.Number.pipe(T.HttpQuery("priority"))}, T.all(ns, T.Http({ method: "POST", uri: "/v20180820/jobs/{JobId}/priority" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class UpdateJobStatusRequest extends S.Class<UpdateJobStatusRequest>("UpdateJobStatusRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), JobId: S.String.pipe(T.HttpLabel("JobId")), RequestedJobStatus: S.String.pipe(T.HttpQuery("requestedJobStatus")), StatusUpdateReason: S.optional(S.String).pipe(T.HttpQuery("statusUpdateReason"))}, T.all(ns, T.Http({ method: "POST", uri: "/v20180820/jobs/{JobId}/status" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
...
export class UpdateStorageLensGroupRequest extends S.Class<UpdateStorageLensGroupRequest>("UpdateStorageLensGroupRequest")({Name: S.String.pipe(T.HttpLabel("Name")), AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), StorageLensGroup: StorageLensGroup}, T.all(ns, T.Http({ method: "PUT", uri: "/v20180820/storagelensgroup/{Name}" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class UpdateStorageLensGroupResponse extends S.Class<UpdateStorageLensGroupResponse>("UpdateStorageLensGroupResponse")({}, ns) {}
...
export const MultiRegionAccessPointReportList = S.Array(MultiRegionAccessPointReport.pipe(T.XmlName("AccessPoint")));
...
export const RouteList = S.Array(MultiRegionAccessPointRoute.pipe(T.XmlName("Route")));
...
export class CreateAccessPointRequest extends S.Class<CreateAccessPointRequest>("CreateAccessPointRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Name: S.String.pipe(T.HttpLabel("Name"), T.ContextParam("AccessPointName")), Bucket: S.String.pipe(T.ContextParam("Bucket")), VpcConfiguration: S.optional(VpcConfiguration), PublicAccessBlockConfiguration: S.optional(PublicAccessBlockConfiguration), BucketAccountId: S.optional(S.String), Scope: S.optional(Scope), Tags: S.optional(TagList)}, T.all(ns, T.Http({ method: "PUT", uri: "/v20180820/accesspoint/{Name}" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class CreateBucketRequest extends S.Class<CreateBucketRequest>("CreateBucketRequest")({ACL: S.optional(S.String).pipe(T.HttpHeader("x-amz-acl")), Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket")), CreateBucketConfiguration: S.optional(CreateBucketConfiguration).pipe(T.HttpPayload(), T.XmlName("CreateBucketConfiguration")), GrantFullControl: S.optional(S.String).pipe(T.HttpHeader("x-amz-grant-full-control")), GrantRead: S.optional(S.String).pipe(T.HttpHeader("x-amz-grant-read")), GrantReadACP: S.optional(S.String).pipe(T.HttpHeader("x-amz-grant-read-acp")), GrantWrite: S.optional(S.String).pipe(T.HttpHeader("x-amz-grant-write")), GrantWriteACP: S.optional(S.String).pipe(T.HttpHeader("x-amz-grant-write-acp")), ObjectLockEnabledForBucket: S.optional(S.Boolean).pipe(T.HttpHeader("x-amz-bucket-object-lock-enabled")), OutpostId: S.optional(S.String).pipe(T.HttpHeader("x-amz-outpost-id"), T.ContextParam("OutpostId"))}, T.all(ns, T.Http({ method: "PUT", uri: "/v20180820/bucket/{Bucket}" }), svc, auth, proto, ver, rules)) {}
export class DeleteMultiRegionAccessPointRequest extends S.Class<DeleteMultiRegionAccessPointRequest>("DeleteMultiRegionAccessPointRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), ClientToken: S.String, Details: DeleteMultiRegionAccessPointInput}, T.all(ns, T.Http({ method: "POST", uri: "/v20180820/async-requests/mrap/delete" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
...
export class GetAccessGrantsInstanceForPrefixResult extends S.Class<GetAccessGrantsInstanceForPrefixResult>("GetAccessGrantsInstanceForPrefixResult")({AccessGrantsInstanceArn: S.optional(S.String), AccessGrantsInstanceId: S.optional(S.String)}, ns) {}
export class GetAccessGrantsInstanceResourcePolicyResult extends S.Class<GetAccessGrantsInstanceResourcePolicyResult>("GetAccessGrantsInstanceResourcePolicyResult")({Policy: S.optional(S.String), Organization: S.optional(S.String), CreatedAt: S.optional(S.Date)}, ns) {}
export class GetAccessGrantsLocationResult extends S.Class<GetAccessGrantsLocationResult>("GetAccessGrantsLocationResult")({CreatedAt: S.optional(S.Date), AccessGrantsLocationId: S.optional(S.String), AccessGrantsLocationArn: S.optional(S.String), LocationScope: S.optional(S.String), IAMRoleArn: S.optional(S.String)}, ns) {}
export class GetAccessPointConfigurationForObjectLambdaResult extends S.Class<GetAccessPointConfigurationForObjectLambdaResult>("GetAccessPointConfigurationForObjectLambdaResult")({Configuration: S.optional(ObjectLambdaConfiguration)}, ns) {}
export class GetAccessPointPolicyResult extends S.Class<GetAccessPointPolicyResult>("GetAccessPointPolicyResult")({Policy: S.optional(S.String)}, ns) {}
export class GetAccessPointPolicyForObjectLambdaResult extends S.Class<GetAccessPointPolicyForObjectLambdaResult>("GetAccessPointPolicyForObjectLambdaResult")({Policy: S.optional(S.String)}, ns) {}
...
export class GetAccessPointPolicyStatusForObjectLambdaResult extends S.Class<GetAccessPointPolicyStatusForObjectLambdaResult>("GetAccessPointPolicyStatusForObjectLambdaResult")({PolicyStatus: S.optional(PolicyStatus)}, ns) {}
export class GetAccessPointScopeResult extends S.Class<GetAccessPointScopeResult>("GetAccessPointScopeResult")({Scope: S.optional(Scope)}, ns) {}
export class GetBucketResult extends S.Class<GetBucketResult>("GetBucketResult")({Bucket: S.optional(S.String), PublicAccessBlockEnabled: S.optional(S.Boolean), CreationDate: S.optional(S.Date)}, ns) {}
...
export const NoncurrentVersionTransitionList = S.Array(NoncurrentVersionTransition.pipe(T.XmlName("NoncurrentVersionTransition")));
...
export class GetBucketLifecycleConfigurationResult extends S.Class<GetBucketLifecycleConfigurationResult>("GetBucketLifecycleConfigurationResult")({Rules: S.optional(LifecycleRules)}, ns) {}
export class GetBucketPolicyResult extends S.Class<GetBucketPolicyResult>("GetBucketPolicyResult")({Policy: S.optional(S.String)}, ns) {}
...
export const ReplicationRules = S.Array(ReplicationRule.pipe(T.XmlName("Rule")));
...
export class GetBucketReplicationResult extends S.Class<GetBucketReplicationResult>("GetBucketReplicationResult")({ReplicationConfiguration: S.optional(ReplicationConfiguration)}, ns) {}
export class GetBucketTaggingResult extends S.Class<GetBucketTaggingResult>("GetBucketTaggingResult")({TagSet: S3TagSet}, ns) {}
export class GetBucketVersioningResult extends S.Class<GetBucketVersioningResult>("GetBucketVersioningResult")({Status: S.optional(S.String), MFADelete: S.optional(S.String).pipe(T.XmlName("MfaDelete"))}, ns) {}
export class GetJobTaggingResult extends S.Class<GetJobTaggingResult>("GetJobTaggingResult")({Tags: S.optional(S3TagSet)}, ns) {}
export class GetMultiRegionAccessPointPolicyStatusResult extends S.Class<GetMultiRegionAccessPointPolicyStatusResult>("GetMultiRegionAccessPointPolicyStatusResult")({Established: S.optional(PolicyStatus)}, ns) {}
export class GetMultiRegionAccessPointRoutesResult extends S.Class<GetMultiRegionAccessPointRoutesResult>("GetMultiRegionAccessPointRoutesResult")({Mrap: S.optional(S.String), Routes: S.optional(RouteList)}, ns) {}
...
export const StorageLensGroupLevelInclude = S.Array(S.String.pipe(T.XmlName("Arn")));
export const StorageLensGroupLevelExclude = S.Array(S.String.pipe(T.XmlName("Arn")));
...
export class StorageLensDataExportEncryption extends S.Class<StorageLensDataExportEncryption>("StorageLensDataExportEncryption")({SSES3: S.optional(SSES3).pipe(T.XmlName("SSE-S3")), SSEKMS: S.optional(SSEKMS).pipe(T.XmlName("SSE-KMS"))}) {}
...
export class GetStorageLensConfigurationResult extends S.Class<GetStorageLensConfigurationResult>("GetStorageLensConfigurationResult")({StorageLensConfiguration: S.optional(StorageLensConfiguration).pipe(T.HttpPayload())}, ns) {}
export class GetStorageLensConfigurationTaggingResult extends S.Class<GetStorageLensConfigurationTaggingResult>("GetStorageLensConfigurationTaggingResult")({Tags: S.optional(StorageLensTags)}, ns) {}
export class GetStorageLensGroupResult extends S.Class<GetStorageLensGroupResult>("GetStorageLensGroupResult")({StorageLensGroup: S.optional(StorageLensGroup).pipe(T.HttpPayload())}, ns) {}
...
export const AccessPointList = S.Array(AccessPoint.pipe(T.XmlName("AccessPoint")));
export class ListAccessPointsForDirectoryBucketsResult extends S.Class<ListAccessPointsForDirectoryBucketsResult>("ListAccessPointsForDirectoryBucketsResult")({AccessPointList: S.optional(AccessPointList), NextToken: S.optional(S.String)}, ns) {}
export class ListMultiRegionAccessPointsResult extends S.Class<ListMultiRegionAccessPointsResult>("ListMultiRegionAccessPointsResult")({AccessPoints: S.optional(MultiRegionAccessPointReportList), NextToken: S.optional(S.String)}, ns) {}
export class ListTagsForResourceResult extends S.Class<ListTagsForResourceResult>("ListTagsForResourceResult")({Tags: S.optional(TagList)}, ns) {}
export class PutAccessGrantsInstanceResourcePolicyResult extends S.Class<PutAccessGrantsInstanceResourcePolicyResult>("PutAccessGrantsInstanceResourcePolicyResult")({Policy: S.optional(S.String), Organization: S.optional(S.String), CreatedAt: S.optional(S.Date)}, ns) {}
export class PutBucketTaggingRequest extends S.Class<PutBucketTaggingRequest>("PutBucketTaggingRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket")), Tagging: Tagging.pipe(T.HttpPayload(), T.XmlName("Tagging"))}, T.all(ns, T.Http({ method: "PUT", uri: "/v20180820/bucket/{Bucket}/tagging" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class PutBucketTaggingResponse extends S.Class<PutBucketTaggingResponse>("PutBucketTaggingResponse")({}, ns) {}
export class PutBucketVersioningRequest extends S.Class<PutBucketVersioningRequest>("PutBucketVersioningRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket")), MFA: S.optional(S.String).pipe(T.HttpHeader("x-amz-mfa")), VersioningConfiguration: VersioningConfiguration.pipe(T.HttpPayload(), T.XmlName("VersioningConfiguration"))}, T.all(ns, T.Http({ method: "PUT", uri: "/v20180820/bucket/{Bucket}/versioning" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class PutBucketVersioningResponse extends S.Class<PutBucketVersioningResponse>("PutBucketVersioningResponse")({}, ns) {}
export class PutMultiRegionAccessPointPolicyRequest extends S.Class<PutMultiRegionAccessPointPolicyRequest>("PutMultiRegionAccessPointPolicyRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), ClientToken: S.String, Details: PutMultiRegionAccessPointPolicyInput}, T.all(ns, T.Http({ method: "POST", uri: "/v20180820/async-requests/mrap/put-policy" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class SubmitMultiRegionAccessPointRoutesRequest extends S.Class<SubmitMultiRegionAccessPointRoutesRequest>("SubmitMultiRegionAccessPointRoutesRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Mrap: S.String.pipe(T.HttpLabel("Mrap")), RouteUpdates: RouteList}, T.all(ns, T.Http({ method: "PATCH", uri: "/v20180820/mrap/instances/{Mrap+}/routes" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class SubmitMultiRegionAccessPointRoutesResult extends S.Class<SubmitMultiRegionAccessPointRoutesResult>("SubmitMultiRegionAccessPointRoutesResult")({}, ns) {}
...
export class UpdateJobPriorityResult extends S.Class<UpdateJobPriorityResult>("UpdateJobPriorityResult")({JobId: S.String, Priority: S.Number}, ns) {}
export class UpdateJobStatusResult extends S.Class<UpdateJobStatusResult>("UpdateJobStatusResult")({JobId: S.optional(S.String), Status: S.optional(S.String), StatusUpdateReason: S.optional(S.String)}, ns) {}
...
export const AccessGrantsList = S.Array(ListAccessGrantEntry.pipe(T.XmlName("AccessGrant")));
export class ListAccessGrantsInstanceEntry extends S.Class<ListAccessGrantsInstanceEntry>("ListAccessGrantsInstanceEntry")({AccessGrantsInstanceId: S.optional(S.String), AccessGrantsInstanceArn: S.optional(S.String), CreatedAt: S.optional(S.Date), IdentityCenterArn: S.optional(S.String), IdentityCenterInstanceArn: S.optional(S.String), IdentityCenterApplicationArn: S.optional(S.String)}) {}
export const AccessGrantsInstancesList = S.Array(ListAccessGrantsInstanceEntry.pipe(T.XmlName("AccessGrantsInstance")));
...
export const AccessGrantsLocationsList = S.Array(ListAccessGrantsLocationsEntry.pipe(T.XmlName("AccessGrantsLocation")));
...
export const ObjectLambdaAccessPointList = S.Array(ObjectLambdaAccessPoint.pipe(T.XmlName("ObjectLambdaAccessPoint")));
...
export const CallerAccessGrantsList = S.Array(ListCallerAccessGrantsEntry.pipe(T.XmlName("AccessGrant")));
...
export const RegionalBucketList = S.Array(RegionalBucket.pipe(T.XmlName("RegionalBucket")));
...
export const StorageLensConfigurationList = S.Array(ListStorageLensConfigurationEntry.pipe(T.XmlName("StorageLensConfiguration")));
...
export const StorageLensGroupList = S.Array(ListStorageLensGroupEntry.pipe(T.XmlName("StorageLensGroup")));
...
export class CreateAccessPointResult extends S.Class<CreateAccessPointResult>("CreateAccessPointResult")({AccessPointArn: S.optional(S.String), Alias: S.optional(S.String)}, ns) {}
export class CreateBucketResult extends S.Class<CreateBucketResult>("CreateBucketResult")({Location: S.optional(S.String).pipe(T.HttpHeader("Location")), BucketArn: S.optional(S.String)}, ns) {}
export class SSES3Encryption extends S.Class<SSES3Encryption>("SSES3Encryption")({}, T.XmlName("SSE-S3")) {}
...
export class CreateMultiRegionAccessPointRequest extends S.Class<CreateMultiRegionAccessPointRequest>("CreateMultiRegionAccessPointRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), ClientToken: S.String, Details: CreateMultiRegionAccessPointInput}, T.all(ns, T.Http({ method: "POST", uri: "/v20180820/async-requests/mrap/create" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class DeleteMultiRegionAccessPointResult extends S.Class<DeleteMultiRegionAccessPointResult>("DeleteMultiRegionAccessPointResult")({RequestTokenARN: S.optional(S.String)}, ns) {}
...
export class GetAccessPointPolicyStatusResult extends S.Class<GetAccessPointPolicyStatusResult>("GetAccessPointPolicyStatusResult")({PolicyStatus: S.optional(PolicyStatus)}, ns) {}
export class GetDataAccessResult extends S.Class<GetDataAccessResult>("GetDataAccessResult")({Credentials: S.optional(Credentials), MatchedGrantTarget: S.optional(S.String), Grantee: S.optional(Grantee)}, ns) {}
export class ListAccessGrantsResult extends S.Class<ListAccessGrantsResult>("ListAccessGrantsResult")({NextToken: S.optional(S.String), AccessGrantsList: S.optional(AccessGrantsList)}, ns) {}
export class ListAccessGrantsInstancesResult extends S.Class<ListAccessGrantsInstancesResult>("ListAccessGrantsInstancesResult")({NextToken: S.optional(S.String), AccessGrantsInstancesList: S.optional(AccessGrantsInstancesList)}, ns) {}
export class ListAccessGrantsLocationsResult extends S.Class<ListAccessGrantsLocationsResult>("ListAccessGrantsLocationsResult")({NextToken: S.optional(S.String), AccessGrantsLocationsList: S.optional(AccessGrantsLocationsList)}, ns) {}
export class ListAccessPointsResult extends S.Class<ListAccessPointsResult>("ListAccessPointsResult")({AccessPointList: S.optional(AccessPointList), NextToken: S.optional(S.String)}, ns) {}
export class ListAccessPointsForObjectLambdaResult extends S.Class<ListAccessPointsForObjectLambdaResult>("ListAccessPointsForObjectLambdaResult")({ObjectLambdaAccessPointList: S.optional(ObjectLambdaAccessPointList), NextToken: S.optional(S.String)}, ns) {}
export class ListCallerAccessGrantsResult extends S.Class<ListCallerAccessGrantsResult>("ListCallerAccessGrantsResult")({NextToken: S.optional(S.String), CallerAccessGrantsList: S.optional(CallerAccessGrantsList)}, ns) {}
export class ListJobsResult extends S.Class<ListJobsResult>("ListJobsResult")({NextToken: S.optional(S.String), Jobs: S.optional(JobListDescriptorList)}, ns) {}
export class ListRegionalBucketsResult extends S.Class<ListRegionalBucketsResult>("ListRegionalBucketsResult")({RegionalBucketList: S.optional(RegionalBucketList), NextToken: S.optional(S.String)}, ns) {}
export class ListStorageLensConfigurationsResult extends S.Class<ListStorageLensConfigurationsResult>("ListStorageLensConfigurationsResult")({NextToken: S.optional(S.String), StorageLensConfigurationList: S.optional(StorageLensConfigurationList).pipe(T.XmlName("StorageLensConfiguration"), T.XmlFlattened())}, T.all(T.XmlName("ListStorageLensConfigurationResult"), ns)) {}
export class ListStorageLensGroupsResult extends S.Class<ListStorageLensGroupsResult>("ListStorageLensGroupsResult")({NextToken: S.optional(S.String), StorageLensGroupList: S.optional(StorageLensGroupList).pipe(T.XmlName("StorageLensGroup"), T.XmlFlattened())}, ns) {}
export class PutMultiRegionAccessPointPolicyResult extends S.Class<PutMultiRegionAccessPointPolicyResult>("PutMultiRegionAccessPointPolicyResult")({RequestTokenARN: S.optional(S.String)}, ns) {}
...
export class SSEKMSEncryption extends S.Class<SSEKMSEncryption>("SSEKMSEncryption")({KeyId: S.String}, T.XmlName("SSE-KMS")) {}
...
export class CreateMultiRegionAccessPointResult extends S.Class<CreateMultiRegionAccessPointResult>("CreateMultiRegionAccessPointResult")({RequestTokenARN: S.optional(S.String)}, ns) {}
export class CreateStorageLensGroupRequest extends S.Class<CreateStorageLensGroupRequest>("CreateStorageLensGroupRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), StorageLensGroup: StorageLensGroup, Tags: S.optional(TagList)}, T.all(ns, T.Http({ method: "POST", uri: "/v20180820/storagelensgroup" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class CreateStorageLensGroupResponse extends S.Class<CreateStorageLensGroupResponse>("CreateStorageLensGroupResponse")({}, ns) {}
export class GetMultiRegionAccessPointResult extends S.Class<GetMultiRegionAccessPointResult>("GetMultiRegionAccessPointResult")({AccessPoint: S.optional(MultiRegionAccessPointReport)}, ns) {}
export class GetMultiRegionAccessPointPolicyResult extends S.Class<GetMultiRegionAccessPointPolicyResult>("GetMultiRegionAccessPointPolicyResult")({Policy: S.optional(MultiRegionAccessPointPolicyDocument)}, ns) {}
...
export class GeneratedManifestEncryption extends S.Class<GeneratedManifestEncryption>("GeneratedManifestEncryption")({SSES3: S.optional(SSES3Encryption).pipe(T.XmlName("SSE-S3")), SSEKMS: S.optional(SSEKMSEncryption).pipe(T.XmlName("SSE-KMS"))}) {}
export const ObjectEncryptionFilter = S.Union(S.Struct({ SSES3: SSES3Filter.pipe(T.XmlName("SSE-S3")) }), S.Struct({ SSEKMS: SSEKMSFilter.pipe(T.XmlName("SSE-KMS")) }), S.Struct({ DSSEKMS: DSSEKMSFilter.pipe(T.XmlName("DSSE-KMS")) }), S.Struct({ SSEC: SSECFilter.pipe(T.XmlName("SSE-C")) }), S.Struct({ NOTSSE: NotSSEFilter.pipe(T.XmlName("NOT-SSE")) }));
export const ObjectEncryptionFilterList = S.Array(ObjectEncryptionFilter.pipe(T.XmlName("ObjectEncryption")));
...
export const MultiRegionAccessPointRegionalResponseList = S.Array(MultiRegionAccessPointRegionalResponse.pipe(T.XmlName("Region")));
...
export const JobManifestGenerator = S.Union(S.Struct({ S3JobManifestGenerator: S3JobManifestGenerator }));
...
export class CreateAccessPointForObjectLambdaRequest extends S.Class<CreateAccessPointForObjectLambdaRequest>("CreateAccessPointForObjectLambdaRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Name: S.String.pipe(T.HttpLabel("Name")), Configuration: ObjectLambdaConfiguration}, T.all(ns, T.Http({ method: "PUT", uri: "/v20180820/accesspointforobjectlambda/{Name}" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class DescribeJobResult extends S.Class<DescribeJobResult>("DescribeJobResult")({Job: S.optional(JobDescriptor)}, ns) {}
export class PutBucketLifecycleConfigurationRequest extends S.Class<PutBucketLifecycleConfigurationRequest>("PutBucketLifecycleConfigurationRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket")), LifecycleConfiguration: S.optional(LifecycleConfiguration).pipe(T.HttpPayload(), T.XmlName("LifecycleConfiguration"))}, T.all(ns, T.Http({ method: "PUT", uri: "/v20180820/bucket/{Bucket}/lifecycleconfiguration" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class PutBucketLifecycleConfigurationResponse extends S.Class<PutBucketLifecycleConfigurationResponse>("PutBucketLifecycleConfigurationResponse")({}, ns) {}
...
export class CreateAccessPointForObjectLambdaResult extends S.Class<CreateAccessPointForObjectLambdaResult>("CreateAccessPointForObjectLambdaResult")({ObjectLambdaAccessPointArn: S.optional(S.String), Alias: S.optional(ObjectLambdaAccessPointAlias)}, ns) {}
export class CreateJobRequest extends S.Class<CreateJobRequest>("CreateJobRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), ConfirmationRequired: S.optional(S.Boolean), Operation: JobOperation, Report: JobReport, ClientRequestToken: S.String, Manifest: S.optional(JobManifest), Description: S.optional(S.String), Priority: S.Number, RoleArn: S.String, Tags: S.optional(S3TagSet), ManifestGenerator: S.optional(JobManifestGenerator)}, T.all(ns, T.Http({ method: "POST", uri: "/v20180820/jobs" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class DescribeMultiRegionAccessPointOperationResult extends S.Class<DescribeMultiRegionAccessPointOperationResult>("DescribeMultiRegionAccessPointOperationResult")({AsyncOperation: S.optional(AsyncOperation)}, ns) {}
export class PutBucketReplicationRequest extends S.Class<PutBucketReplicationRequest>("PutBucketReplicationRequest")({AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket")), ReplicationConfiguration: ReplicationConfiguration.pipe(T.HttpPayload(), T.XmlName("ReplicationConfiguration"))}, T.all(ns, T.Http({ method: "PUT", uri: "/v20180820/bucket/{Bucket}/replication" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class PutBucketReplicationResponse extends S.Class<PutBucketReplicationResponse>("PutBucketReplicationResponse")({}, ns) {}
export class CreateJobResult extends S.Class<CreateJobResult>("CreateJobResult")({JobId: S.optional(S.String)}, ns) {}
export class PutStorageLensConfigurationRequest extends S.Class<PutStorageLensConfigurationRequest>("PutStorageLensConfigurationRequest")({ConfigId: S.String.pipe(T.HttpLabel("ConfigId")), AccountId: S.String.pipe(T.HttpHeader("x-amz-account-id"), T.ContextParam("AccountId"), T.HostLabel()), StorageLensConfiguration: StorageLensConfiguration, Tags: S.optional(StorageLensTags)}, T.all(ns, T.Http({ method: "PUT", uri: "/v20180820/storagelens/{ConfigId}" }), svc, auth, proto, ver, rules, T.StaticContextParams({"RequiresAccountId":{"value":true}}))) {}
export class PutStorageLensConfigurationResponse extends S.Class<PutStorageLensConfigurationResponse>("PutStorageLensConfigurationResponse")({}, ns) {}
 ...
 */
export const associateAccessGrantsIdentityCenter = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: AssociateAccessGrantsIdentityCenterRequest, output: AssociateAccessGrantsIdentityCenterResponse, errors: [] }));
/**
 ...
 */
export const deleteAccessGrant = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteAccessGrantRequest, output: DeleteAccessGrantResponse, errors: [] }));
/**
 ...
 */
export const deleteAccessGrantsInstance = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteAccessGrantsInstanceRequest, output: DeleteAccessGrantsInstanceResponse, errors: [] }));
/**
 ...
 */
export const deleteAccessGrantsInstanceResourcePolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteAccessGrantsInstanceResourcePolicyRequest, output: DeleteAccessGrantsInstanceResourcePolicyResponse, errors: [] }));
/**
 ...
 */
export const deleteAccessGrantsLocation = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteAccessGrantsLocationRequest, output: DeleteAccessGrantsLocationResponse, errors: [] }));
/**
 ...
 * - ListAccessPoints
 */
export const deleteAccessPoint = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteAccessPointRequest, output: DeleteAccessPointResponse, errors: [] }));
/**
 ...
 */
export const deleteAccessPointForObjectLambda = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteAccessPointForObjectLambdaRequest, output: DeleteAccessPointForObjectLambdaResponse, errors: [] }));
/**
 ...
 */
export const deleteAccessPointPolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteAccessPointPolicyRequest, output: DeleteAccessPointPolicyResponse, errors: [] }));
/**
 * This operation is not supported by directory buckets.
 * 
 ...
 */
export const deleteAccessPointPolicyForObjectLambda = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteAccessPointPolicyForObjectLambdaRequest, output: DeleteAccessPointPolicyForObjectLambdaResponse, errors: [] }));
/**
 ...
 */
export const deleteAccessPointScope = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteAccessPointScopeRequest, output: DeleteAccessPointScopeResponse, errors: [] }));
/**
 ...
 * - DeleteObject
 */
export const deleteBucket = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteBucketRequest, output: DeleteBucketResponse, errors: [] }));
/**
 ...
 */
export const deleteBucketLifecycleConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteBucketLifecycleConfigurationRequest, output: DeleteBucketLifecycleConfigurationResponse, errors: [] }));
/**
 ...
 * - PutBucketPolicy
 */
export const deleteBucketPolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteBucketPolicyRequest, output: DeleteBucketPolicyResponse, errors: [] }));
/**
 ...
 */
export const deleteBucketReplication = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteBucketReplicationRequest, output: DeleteBucketReplicationResponse, errors: [] }));
/**
 ...
 * - PutBucketTagging
 */
export const deleteBucketTagging = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteBucketTaggingRequest, output: DeleteBucketTaggingResponse, errors: [] }));
/**
 * This operation is not supported by directory buckets.
 * 
 ...
 */
export const deletePublicAccessBlock = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeletePublicAccessBlockRequest, output: DeletePublicAccessBlockResponse, errors: [] }));
/**
 * This operation is not supported by directory buckets.
 * 
 ...
 */
export const deleteStorageLensConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteStorageLensConfigurationRequest, output: DeleteStorageLensConfigurationResponse, errors: [] }));
/**
 * This operation is not supported by directory buckets.
 * 
 ...
 * use Amazon S3 Storage Lens in the *Amazon S3 User Guide*.
 */
export const deleteStorageLensConfigurationTagging = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteStorageLensConfigurationTaggingRequest, output: DeleteStorageLensConfigurationTaggingResult, errors: [] }));
/**
 ...
 * Lens error codes.
 */
export const deleteStorageLensGroup = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteStorageLensGroupRequest, output: DeleteStorageLensGroupResponse, errors: [] }));
/**
 ...
 */
export const dissociateAccessGrantsIdentityCenter = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DissociateAccessGrantsIdentityCenterRequest, output: DissociateAccessGrantsIdentityCenterResponse, errors: [] }));
/**
 * This operation is not supported by directory buckets.
 * 
 ...
 */
export const putAccessPointConfigurationForObjectLambda = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutAccessPointConfigurationForObjectLambdaRequest, output: PutAccessPointConfigurationForObjectLambdaResponse, errors: [] }));
/**
 ...
 */
export const putAccessPointPolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutAccessPointPolicyRequest, output: PutAccessPointPolicyResponse, errors: [] }));
/**
 * This operation is not supported by directory buckets.
 * 
 ...
 * - GetAccessPointPolicyForObjectLambda
 */
export const putAccessPointPolicyForObjectLambda = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutAccessPointPolicyForObjectLambdaRequest, output: PutAccessPointPolicyForObjectLambdaResponse, errors: [] }));
/**
 ...
 * For information about REST API errors, see REST error responses.
 */
export const putAccessPointScope = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutAccessPointScopeRequest, output: PutAccessPointScopeResponse, errors: [] }));
/**
 ...
 * - DeleteBucketPolicy
 */
export const putBucketPolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutBucketPolicyRequest, output: PutBucketPolicyResponse, errors: [] }));
/**
 * This operation is not supported by directory buckets.
 * 
 ...
 */
export const putPublicAccessBlock = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutPublicAccessBlockRequest, output: PutPublicAccessBlockResponse, errors: [] }));
/**
 * This operation is not supported by directory buckets.
 * 
 ...
 * use Amazon S3 Storage Lens in the *Amazon S3 User Guide*.
 */
export const putStorageLensConfigurationTagging = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutStorageLensConfigurationTaggingRequest, output: PutStorageLensConfigurationTaggingResult, errors: [] }));
/**
 ...
 */
export const tagResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: TagResourceRequest, output: TagResourceResult, errors: [] }));
/**
 ...
 * Tagging error codes.
 */
export const untagResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UntagResourceRequest, output: UntagResourceResult, errors: [] }));
/**
 ...
 * Lens error codes.
 */
export const updateStorageLensGroup = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateStorageLensGroupRequest, output: UpdateStorageLensGroupResponse, errors: [] }));
/**
 ...
 */
export const createAccessGrantsInstance = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateAccessGrantsInstanceRequest, output: CreateAccessGrantsInstanceResult, errors: [] }));
/**
 ...
 */
export const createAccessGrantsLocation = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateAccessGrantsLocationRequest, output: CreateAccessGrantsLocationResult, errors: [] }));
/**
 ...
 */
export const getAccessGrant = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetAccessGrantRequest, output: GetAccessGrantResult, errors: [] }));
/**
 ...
 */
export const getAccessGrantsInstance = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetAccessGrantsInstanceRequest, output: GetAccessGrantsInstanceResult, errors: [] }));
/**
 ...
 */
export const getAccessGrantsInstanceForPrefix = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetAccessGrantsInstanceForPrefixRequest, output: GetAccessGrantsInstanceForPrefixResult, errors: [] }));
/**
 ...
 */
export const getAccessGrantsInstanceResourcePolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetAccessGrantsInstanceResourcePolicyRequest, output: GetAccessGrantsInstanceResourcePolicyResult, errors: [] }));
/**
 ...
 */
export const getAccessGrantsLocation = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetAccessGrantsLocationRequest, output: GetAccessGrantsLocationResult, errors: [] }));
/**
 * This operation is not supported by directory buckets.
 * 
 ...
 * - PutAccessPointConfigurationForObjectLambda
 */
export const getAccessPointConfigurationForObjectLambda = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetAccessPointConfigurationForObjectLambdaRequest, output: GetAccessPointConfigurationForObjectLambdaResult, errors: [] }));
/**
 ...
 * - DeleteAccessPointPolicy
 */
export const getAccessPointPolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetAccessPointPolicyRequest, output: GetAccessPointPolicyResult, errors: [] }));
/**
 * This operation is not supported by directory buckets.
 * 
 ...
 * - PutAccessPointPolicyForObjectLambda
 */
export const getAccessPointPolicyForObjectLambda = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetAccessPointPolicyForObjectLambdaRequest, output: GetAccessPointPolicyForObjectLambdaResult, errors: [] }));
/**
 * This operation is not supported by directory buckets.
 * 
 * Returns the status of the resource policy associated with an Object Lambda Access Point.
 */
export const getAccessPointPolicyStatusForObjectLambda = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetAccessPointPolicyStatusForObjectLambdaRequest, output: GetAccessPointPolicyStatusForObjectLambdaResult, errors: [] }));
/**
 ...
 * For information about REST API errors, see REST error responses.
 */
export const getAccessPointScope = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetAccessPointScopeRequest, output: GetAccessPointScopeResult, errors: [] }));
/**
 ...
 * - DeleteBucket
 */
export const getBucket = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetBucketRequest, output: GetBucketResult, errors: [] }));
/**
 ...
 */
export const getBucketLifecycleConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetBucketLifecycleConfigurationRequest, output: GetBucketLifecycleConfigurationResult, errors: [] }));
/**
 ...
 * - DeleteBucketPolicy
 */
export const getBucketPolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetBucketPolicyRequest, output: GetBucketPolicyResult, errors: [] }));
/**
 ...
 */
export const getBucketReplication = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetBucketReplicationRequest, output: GetBucketReplicationResult, errors: [] }));
/**
 ...
 * - DeleteBucketTagging
 */
export const getBucketTagging = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetBucketTaggingRequest, output: GetBucketTaggingResult, errors: [] }));
/**
 ...
 * - GetBucketLifecycleConfiguration
 */
export const getBucketVersioning = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetBucketVersioningRequest, output: GetBucketVersioningResult, errors: [] }));
/**
 * This operation is not supported by directory buckets.
 * 
 ...
 */
export const getMultiRegionAccessPointPolicyStatus = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetMultiRegionAccessPointPolicyStatusRequest, output: GetMultiRegionAccessPointPolicyStatusResult, errors: [] }));
/**
 * This operation is not supported by directory buckets.
 * 
 ...
 * - `eu-west-1`
 */
export const getMultiRegionAccessPointRoutes = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetMultiRegionAccessPointRoutesRequest, output: GetMultiRegionAccessPointRoutesResult, errors: [] }));
/**
 * This operation is not supported by directory buckets.
 * 
 ...
 * *Amazon S3 User Guide*.
 */
export const getStorageLensConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetStorageLensConfigurationRequest, output: GetStorageLensConfigurationResult, errors: [] }));
/**
 * This operation is not supported by directory buckets.
 * 
 ...
 * use Amazon S3 Storage Lens in the *Amazon S3 User Guide*.
 */
export const getStorageLensConfigurationTagging = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetStorageLensConfigurationTaggingRequest, output: GetStorageLensConfigurationTaggingResult, errors: [] }));
/**
 ...
 * Lens error codes.
 */
export const getStorageLensGroup = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetStorageLensGroupRequest, output: GetStorageLensGroupResult, errors: [] }));
/**
 ...
 * For information about REST API errors, see REST error responses.
 */
export const listAccessPointsForDirectoryBuckets = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListAccessPointsForDirectoryBucketsRequest, output: ListAccessPointsForDirectoryBucketsResult, errors: [] }));
/**
 * This operation is not supported by directory buckets.
 * 
 ...
 */
export const listMultiRegionAccessPoints = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListMultiRegionAccessPointsRequest, output: ListMultiRegionAccessPointsResult, errors: [] }));
/**
 ...
 * For information about S3 Tagging errors, see List of Amazon S3 Tagging error codes.
 */
export const listTagsForResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListTagsForResourceRequest, output: ListTagsForResourceResult, errors: [] }));
/**
 ...
 */
export const putAccessGrantsInstanceResourcePolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutAccessGrantsInstanceResourcePolicyRequest, output: PutAccessGrantsInstanceResourcePolicyResult, errors: [] }));
/**
 ...
 * - DeleteBucketTagging
 */
export const putBucketTagging = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutBucketTaggingRequest, output: PutBucketTaggingResponse, errors: [] }));
/**
 ...
 * - GetBucketLifecycleConfiguration
 */
export const putBucketVersioning = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutBucketVersioningRequest, output: PutBucketVersioningResponse, errors: [] }));
/**
 * This operation is not supported by directory buckets.
 * 
 ...
 * - `eu-west-1`
 */
export const submitMultiRegionAccessPointRoutes = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: SubmitMultiRegionAccessPointRoutesRequest, output: SubmitMultiRegionAccessPointRoutesResult, errors: [] }));
/**
 ...
 */
export const updateAccessGrantsLocation = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateAccessGrantsLocationRequest, output: UpdateAccessGrantsLocationResult, errors: [] }));
/**
 ...
 */
export const createAccessGrant = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateAccessGrantRequest, output: CreateAccessGrantResult, errors: [] }));
/**
 ...
 */
export const createAccessPoint = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateAccessPointRequest, output: CreateAccessPointResult, errors: [] }));
/**
 ...
 * - PutAccessPointPolicy
 */
export const createBucket = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateBucketRequest, output: CreateBucketResult, errors: [BucketAlreadyExists, BucketAlreadyOwnedByYou] }));
/**
 * This operation is not supported by directory buckets.
 * 
 ...
 */
export const deleteMultiRegionAccessPoint = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteMultiRegionAccessPointRequest, output: DeleteMultiRegionAccessPointResult, errors: [] }));
/**
 ...
 * - ListAccessPoints
 */
export const getAccessPoint = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetAccessPointRequest, output: GetAccessPointResult, errors: [] }));
/**
 * This operation is not supported by directory buckets.
 * 
 ...
 * - ListAccessPointsForObjectLambda
 */
export const getAccessPointForObjectLambda = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetAccessPointForObjectLambdaRequest, output: GetAccessPointForObjectLambdaResult, errors: [] }));
/**
 * This operation is not supported by directory buckets.
 * 
 ...
 */
export const getAccessPointPolicyStatus = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetAccessPointPolicyStatusRequest, output: GetAccessPointPolicyStatusResult, errors: [] }));
/**
 ...
 */
export const getDataAccess = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetDataAccessRequest, output: GetDataAccessResult, errors: [] }));
/**
 * This operation is not supported by directory buckets.
 * 
 ...
 * - PutPublicAccessBlock
 */
export const getPublicAccessBlock = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetPublicAccessBlockRequest, output: GetPublicAccessBlockOutput, errors: [NoSuchPublicAccessBlockConfiguration] }));
/**
 ...
 */
export const listAccessGrants = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListAccessGrantsRequest, output: ListAccessGrantsResult, errors: [] }));
/**
 ...
 */
export const listAccessGrantsInstances = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListAccessGrantsInstancesRequest, output: ListAccessGrantsInstancesResult, errors: [] }));
/**
 ...
 */
export const listAccessGrantsLocations = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListAccessGrantsLocationsRequest, output: ListAccessGrantsLocationsResult, errors: [] }));
/**
 * This operation is not supported by directory buckets.
 * 
 ...
 * - GetAccessPoint
 */
export const listAccessPoints = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListAccessPointsRequest, output: ListAccessPointsResult, errors: [] }));
/**
 * This operation is not supported by directory buckets.
 * 
 ...
 * - GetAccessPointForObjectLambda
 */
export const listAccessPointsForObjectLambda = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListAccessPointsForObjectLambdaRequest, output: ListAccessPointsForObjectLambdaResult, errors: [] }));
/**
 ...
 */
export const listCallerAccessGrants = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListCallerAccessGrantsRequest, output: ListCallerAccessGrantsResult, errors: [] }));
/**
 * This operation is not supported by directory buckets.
 * 
 ...
 */
export const listRegionalBuckets = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListRegionalBucketsRequest, output: ListRegionalBucketsResult, errors: [] }));
/**
 * This operation is not supported by directory buckets.
 * 
 ...
 * use Amazon S3 Storage Lens in the *Amazon S3 User Guide*.
 */
export const listStorageLensConfigurations = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListStorageLensConfigurationsRequest, output: ListStorageLensConfigurationsResult, errors: [] }));
/**
 ...
 * Lens error codes.
 */
export const listStorageLensGroups = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListStorageLensGroupsRequest, output: ListStorageLensGroupsResult, errors: [] }));
/**
 * This operation is not supported by directory buckets.
 * 
 ...
 * - GetMultiRegionAccessPointPolicyStatus
 */
export const putMultiRegionAccessPointPolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutMultiRegionAccessPointPolicyRequest, output: PutMultiRegionAccessPointPolicyResult, errors: [] }));
/**
 * This operation is not supported by directory buckets.
 * 
 ...
 * - ListMultiRegionAccessPoints
 */
export const createMultiRegionAccessPoint = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateMultiRegionAccessPointRequest, output: CreateMultiRegionAccessPointResult, errors: [] }));
/**
 ...
 * Lens error codes.
 */
export const createStorageLensGroup = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateStorageLensGroupRequest, output: CreateStorageLensGroupResponse, errors: [] }));
/**
 ...
 * - PutJobTagging
 */
export const deleteJobTagging = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteJobTaggingRequest, output: DeleteJobTaggingResult, errors: [InternalServiceException, NotFoundException, TooManyRequestsException] }));
/**
 * This operation is not supported by directory buckets.
 * 
 ...
 * - ListMultiRegionAccessPoints
 */
export const getMultiRegionAccessPoint = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetMultiRegionAccessPointRequest, output: GetMultiRegionAccessPointResult, errors: [] }));
/**
 * This operation is not supported by directory buckets.
 * 
 ...
 * - PutMultiRegionAccessPointPolicy
 */
export const getMultiRegionAccessPointPolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetMultiRegionAccessPointPolicyRequest, output: GetMultiRegionAccessPointPolicyResult, errors: [] }));
/**
 ...
 * - UpdateJobStatus
 */
export const updateJobPriority = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateJobPriorityRequest, output: UpdateJobPriorityResult, errors: [BadRequestException, InternalServiceException, NotFoundException, TooManyRequestsException] }));
/**
 ...
 * - DeleteJobTagging
 */
export const getJobTagging = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetJobTaggingRequest, output: GetJobTaggingResult, errors: [InternalServiceException, NotFoundException, TooManyRequestsException] }));
/**
 ...
 * - UpdateJobStatus
 */
export const updateJobStatus = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateJobStatusRequest, output: UpdateJobStatusResult, errors: [BadRequestException, InternalServiceException, JobStatusException, NotFoundException, TooManyRequestsException] }));
/**
 ...
 * - UpdateJobStatus
 */
export const describeJob = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeJobRequest, output: DescribeJobResult, errors: [BadRequestException, InternalServiceException, NotFoundException, TooManyRequestsException] }));
/**
 ...
 * - UpdateJobStatus
 */
export const listJobs = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListJobsRequest, output: ListJobsResult, errors: [InternalServiceException, InvalidNextTokenException, InvalidRequestException] }));
/**
 ...
 * - DeleteBucketLifecycleConfiguration
 */
export const putBucketLifecycleConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutBucketLifecycleConfigurationRequest, output: PutBucketLifecycleConfigurationResponse, errors: [] }));
/**
 ...
 * - DeleteJobTagging
 */
export const putJobTagging = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutJobTaggingRequest, output: PutJobTaggingResult, errors: [InternalServiceException, NotFoundException, TooManyRequestsException, TooManyTagsException] }));
/**
 * This operation is not supported by directory buckets.
 * 
 ...
 * - ListAccessPointsForObjectLambda
 */
export const createAccessPointForObjectLambda = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateAccessPointForObjectLambdaRequest, output: CreateAccessPointForObjectLambdaResult, errors: [] }));
/**
 * This operation is not supported by directory buckets.
 * 
 ...
 * - ListMultiRegionAccessPoints
 */
export const describeMultiRegionAccessPointOperation = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeMultiRegionAccessPointOperationRequest, output: DescribeMultiRegionAccessPointOperationResult, errors: [] }));
/**
 ...
 * - DeleteBucketReplication
 */
export const putBucketReplication = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutBucketReplicationRequest, output: PutBucketReplicationResponse, errors: [] }));
/**
 * This operation is not supported by directory buckets.
 * 
 ...
 * *Amazon S3 User Guide*.
 */
export const putStorageLensConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutStorageLensConfigurationRequest, output: PutStorageLensConfigurationResponse, errors: [] }));
/**
 ...
 * - JobOperation
 */
export const createJob = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateJobRequest, output: CreateJobResult, errors: [BadRequestException, IdempotencyException, InternalServiceException, TooManyRequestsException] }));
