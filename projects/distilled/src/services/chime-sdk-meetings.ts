...
const svc = T.AwsApiService({ sdkId: "Chime SDK Meetings", serviceShapeName: "ChimeMeetingsSDKService" });
...
export class CreateAttendeeRequest extends S.Class<CreateAttendeeRequest>("CreateAttendeeRequest")({MeetingId: S.String.pipe(T.HttpLabel("MeetingId")), ExternalUserId: S.String, Capabilities: S.optional(AttendeeCapabilities)}, T.all(T.Http({ method: "POST", uri: "/meetings/{MeetingId}/attendees" }), svc, auth, proto, ver, rules)) {}
...
export class CreateMeetingWithAttendeesRequest extends S.Class<CreateMeetingWithAttendeesRequest>("CreateMeetingWithAttendeesRequest")({ClientRequestToken: S.String, MediaRegion: S.String, MeetingHostId: S.optional(S.String), ExternalMeetingId: S.String, MeetingFeatures: S.optional(MeetingFeaturesConfiguration), NotificationsConfiguration: S.optional(NotificationsConfiguration), Attendees: CreateMeetingWithAttendeesRequestItemList, PrimaryMeetingId: S.optional(S.String), TenantIds: S.optional(TenantIdList), Tags: S.optional(TagList), MediaPlacementNetworkType: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/meetings?operation=create-attendees" }), svc, auth, proto, ver, rules)) {}
export class DeleteAttendeeRequest extends S.Class<DeleteAttendeeRequest>("DeleteAttendeeRequest")({MeetingId: S.String.pipe(T.HttpLabel("MeetingId")), AttendeeId: S.String.pipe(T.HttpLabel("AttendeeId"))}, T.all(T.Http({ method: "DELETE", uri: "/meetings/{MeetingId}/attendees/{AttendeeId}" }), svc, auth, proto, ver, rules)) {}
export class DeleteAttendeeResponse extends S.Class<DeleteAttendeeResponse>("DeleteAttendeeResponse")({}) {}
export class DeleteMeetingRequest extends S.Class<DeleteMeetingRequest>("DeleteMeetingRequest")({MeetingId: S.String.pipe(T.HttpLabel("MeetingId"))}, T.all(T.Http({ method: "DELETE", uri: "/meetings/{MeetingId}" }), svc, auth, proto, ver, rules)) {}
export class DeleteMeetingResponse extends S.Class<DeleteMeetingResponse>("DeleteMeetingResponse")({}) {}
export class GetAttendeeRequest extends S.Class<GetAttendeeRequest>("GetAttendeeRequest")({MeetingId: S.String.pipe(T.HttpLabel("MeetingId")), AttendeeId: S.String.pipe(T.HttpLabel("AttendeeId"))}, T.all(T.Http({ method: "GET", uri: "/meetings/{MeetingId}/attendees/{AttendeeId}" }), svc, auth, proto, ver, rules)) {}
export class GetMeetingRequest extends S.Class<GetMeetingRequest>("GetMeetingRequest")({MeetingId: S.String.pipe(T.HttpLabel("MeetingId"))}, T.all(T.Http({ method: "GET", uri: "/meetings/{MeetingId}" }), svc, auth, proto, ver, rules)) {}
export class ListAttendeesRequest extends S.Class<ListAttendeesRequest>("ListAttendeesRequest")({MeetingId: S.String.pipe(T.HttpLabel("MeetingId")), NextToken: S.optional(S.String).pipe(T.HttpQuery("next-token")), MaxResults: S.optional(S.Number).pipe(T.HttpQuery("max-results"))}, T.all(T.Http({ method: "GET", uri: "/meetings/{MeetingId}/attendees" }), svc, auth, proto, ver, rules)) {}
export class ListTagsForResourceRequest extends S.Class<ListTagsForResourceRequest>("ListTagsForResourceRequest")({ResourceARN: S.String.pipe(T.HttpQuery("arn"))}, T.all(T.Http({ method: "GET", uri: "/tags" }), svc, auth, proto, ver, rules)) {}
export class StopMeetingTranscriptionRequest extends S.Class<StopMeetingTranscriptionRequest>("StopMeetingTranscriptionRequest")({MeetingId: S.String.pipe(T.HttpLabel("MeetingId"))}, T.all(T.Http({ method: "POST", uri: "/meetings/{MeetingId}/transcription?operation=stop" }), svc, auth, proto, ver, rules)) {}
export class StopMeetingTranscriptionResponse extends S.Class<StopMeetingTranscriptionResponse>("StopMeetingTranscriptionResponse")({}) {}
export class TagResourceRequest extends S.Class<TagResourceRequest>("TagResourceRequest")({ResourceARN: S.String, Tags: TagList}, T.all(T.Http({ method: "POST", uri: "/tags?operation=tag-resource" }), svc, auth, proto, ver, rules)) {}
export class TagResourceResponse extends S.Class<TagResourceResponse>("TagResourceResponse")({}) {}
export class UntagResourceRequest extends S.Class<UntagResourceRequest>("UntagResourceRequest")({ResourceARN: S.String, TagKeys: TagKeyList}, T.all(T.Http({ method: "POST", uri: "/tags?operation=untag-resource" }), svc, auth, proto, ver, rules)) {}
export class UntagResourceResponse extends S.Class<UntagResourceResponse>("UntagResourceResponse")({}) {}
export class UpdateAttendeeCapabilitiesRequest extends S.Class<UpdateAttendeeCapabilitiesRequest>("UpdateAttendeeCapabilitiesRequest")({MeetingId: S.String.pipe(T.HttpLabel("MeetingId")), AttendeeId: S.String.pipe(T.HttpLabel("AttendeeId")), Capabilities: AttendeeCapabilities}, T.all(T.Http({ method: "PUT", uri: "/meetings/{MeetingId}/attendees/{AttendeeId}/capabilities" }), svc, auth, proto, ver, rules)) {}
...
export class BatchCreateAttendeeRequest extends S.Class<BatchCreateAttendeeRequest>("BatchCreateAttendeeRequest")({MeetingId: S.String.pipe(T.HttpLabel("MeetingId")), Attendees: CreateAttendeeRequestItemList}, T.all(T.Http({ method: "POST", uri: "/meetings/{MeetingId}/attendees?operation=batch-create" }), svc, auth, proto, ver, rules)) {}
export class BatchUpdateAttendeeCapabilitiesExceptRequest extends S.Class<BatchUpdateAttendeeCapabilitiesExceptRequest>("BatchUpdateAttendeeCapabilitiesExceptRequest")({MeetingId: S.String.pipe(T.HttpLabel("MeetingId")), ExcludedAttendeeIds: AttendeeIdsList, Capabilities: AttendeeCapabilities}, T.all(T.Http({ method: "PUT", uri: "/meetings/{MeetingId}/attendees/capabilities?operation=batch-update-except" }), svc, auth, proto, ver, rules)) {}
export class BatchUpdateAttendeeCapabilitiesExceptResponse extends S.Class<BatchUpdateAttendeeCapabilitiesExceptResponse>("BatchUpdateAttendeeCapabilitiesExceptResponse")({}) {}
...
export class StartMeetingTranscriptionRequest extends S.Class<StartMeetingTranscriptionRequest>("StartMeetingTranscriptionRequest")({MeetingId: S.String.pipe(T.HttpLabel("MeetingId")), TranscriptionConfiguration: TranscriptionConfiguration}, T.all(T.Http({ method: "POST", uri: "/meetings/{MeetingId}/transcription?operation=start" }), svc, auth, proto, ver, rules)) {}
export class StartMeetingTranscriptionResponse extends S.Class<StartMeetingTranscriptionResponse>("StartMeetingTranscriptionResponse")({}) {}
...
//# Errors
export class BadRequestException extends S.TaggedError<BadRequestException>()("BadRequestException", {Code: S.optional(S.String), Message: S.optional(S.String), RequestId: S.optional(S.String)}) {}
export class ForbiddenException extends S.TaggedError<ForbiddenException>()("ForbiddenException", {Code: S.optional(S.String), Message: S.optional(S.String), RequestId: S.optional(S.String)}) {}
export class ConflictException extends S.TaggedError<ConflictException>()("ConflictException", {Code: S.optional(S.String), Message: S.optional(S.String), RequestId: S.optional(S.String)}) {}
export class NotFoundException extends S.TaggedError<NotFoundException>()("NotFoundException", {Code: S.optional(S.String), Message: S.optional(S.String), RequestId: S.optional(S.String)}) {}
export class LimitExceededException extends S.TaggedError<LimitExceededException>()("LimitExceededException", {Code: S.optional(S.String), Message: S.optional(S.String), RequestId: S.optional(S.String)}) {}
export class ServiceFailureException extends S.TaggedError<ServiceFailureException>()("ServiceFailureException", {Code: S.optional(S.String), Message: S.optional(S.String), RequestId: S.optional(S.String)}).pipe(withCategory(ERROR_CATEGORIES.SERVER_ERROR)) {}
export class ResourceNotFoundException extends S.TaggedError<ResourceNotFoundException>()("ResourceNotFoundException", {Code: S.optional(S.String), Message: S.optional(S.String), RequestId: S.optional(S.String), ResourceName: S.optional(S.String)}) {}
export class ServiceUnavailableException extends S.TaggedError<ServiceUnavailableException>()("ServiceUnavailableException", {Code: S.optional(S.String), Message: S.optional(S.String), RequestId: S.optional(S.String), RetryAfterSeconds: S.optional(S.String).pipe(T.HttpHeader("Retry-After"))}).pipe(withCategory(ERROR_CATEGORIES.SERVER_ERROR)) {}
export class ThrottlingException extends S.TaggedError<ThrottlingException>()("ThrottlingException", {Code: S.optional(S.String), Message: S.optional(S.String), RequestId: S.optional(S.String)}).pipe(withCategory(ERROR_CATEGORIES.THROTTLING_ERROR)) {}
export class UnauthorizedException extends S.TaggedError<UnauthorizedException>()("UnauthorizedException", {Code: S.optional(S.String), Message: S.optional(S.String), RequestId: S.optional(S.String)}) {}
...
export class UnprocessableEntityException extends S.TaggedError<UnprocessableEntityException>()("UnprocessableEntityException", {Code: S.optional(S.String), Message: S.optional(S.String), RequestId: S.optional(S.String)}) {}
 ...
 */
export const deleteAttendee = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteAttendeeRequest, output: DeleteAttendeeResponse, errors: [BadRequestException, ForbiddenException, NotFoundException, ServiceFailureException, ServiceUnavailableException, ThrottlingException, UnauthorizedException] }));
/**
 * The resource that supports tags.
 */
export const tagResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: TagResourceRequest, output: TagResourceResponse, errors: [BadRequestException, ForbiddenException, LimitExceededException, ResourceNotFoundException, ServiceFailureException, ServiceUnavailableException, ThrottlingException, TooManyTagsException, UnauthorizedException] }));
/**
 ...
 */
export const updateAttendeeCapabilities = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateAttendeeCapabilitiesRequest, output: UpdateAttendeeCapabilitiesResponse, errors: [BadRequestException, ConflictException, ForbiddenException, NotFoundException, ServiceFailureException, ServiceUnavailableException, ThrottlingException, UnauthorizedException] }));
/**
 * Gets the Amazon Chime SDK attendee details for a specified meeting ID and attendee ID. For more information about the Amazon Chime SDK, see
 * Using the Amazon Chime SDK
 * in the *Amazon Chime Developer Guide*.
 */
export const getAttendee = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetAttendeeRequest, output: GetAttendeeResponse, errors: [BadRequestException, ForbiddenException, NotFoundException, ServiceFailureException, ServiceUnavailableException, ThrottlingException, UnauthorizedException] }));
/**
 ...
 * in the *Amazon Chime Developer Guide*.
 */
export const getMeeting = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetMeetingRequest, output: GetMeetingResponse, errors: [BadRequestException, ForbiddenException, NotFoundException, ServiceFailureException, ServiceUnavailableException, ThrottlingException, UnauthorizedException] }));
/**
 * Lists the attendees for the specified Amazon Chime SDK meeting. For more information about the Amazon Chime SDK, see
 * Using the Amazon Chime SDK
 * in the *Amazon Chime Developer Guide*.
 */
export const listAttendees = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListAttendeesRequest, output: ListAttendeesResponse, errors: [BadRequestException, ForbiddenException, NotFoundException, ServiceFailureException, ServiceUnavailableException, ThrottlingException, UnauthorizedException] }));
/**
 ...
 */
export const deleteMeeting = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteMeetingRequest, output: DeleteMeetingResponse, errors: [BadRequestException, ForbiddenException, NotFoundException, ServiceFailureException, ServiceUnavailableException, ThrottlingException, UnauthorizedException] }));
/**
 ...
 * and if the attendee turned on their video or content streams, remote attendees can receive those streams, but only after media renegotiation between the client and the Amazon Chime back-end server.
 */
export const batchUpdateAttendeeCapabilitiesExcept = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: BatchUpdateAttendeeCapabilitiesExceptRequest, output: BatchUpdateAttendeeCapabilitiesExceptResponse, errors: [BadRequestException, ConflictException, ForbiddenException, NotFoundException, ServiceFailureException, ServiceUnavailableException, ThrottlingException, UnauthorizedException] }));
/**
 ...
 */
export const createMeeting = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateMeetingRequest, output: CreateMeetingResponse, errors: [BadRequestException, ConflictException, ForbiddenException, LimitExceededException, ServiceFailureException, ServiceUnavailableException, ThrottlingException, UnauthorizedException] }));
/**
 ...
 * - Video.MaxResolution: HD
 */
export const createMeetingWithAttendees = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateMeetingWithAttendeesRequest, output: CreateMeetingWithAttendeesResponse, errors: [BadRequestException, ConflictException, ForbiddenException, LimitExceededException, ServiceFailureException, ServiceUnavailableException, ThrottlingException, UnauthorizedException] }));
/**
 * Returns a list of the tags available for the specified resource.
 */
export const listTagsForResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListTagsForResourceRequest, output: ListTagsForResourceResponse, errors: [BadRequestException, ForbiddenException, LimitExceededException, ResourceNotFoundException, ServiceFailureException, ServiceUnavailableException, ThrottlingException, UnauthorizedException] }));
/**
 ...
 */
export const untagResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UntagResourceRequest, output: UntagResourceResponse, errors: [BadRequestException, ForbiddenException, LimitExceededException, ResourceNotFoundException, ServiceFailureException, ServiceUnavailableException, ThrottlingException, UnauthorizedException] }));
/**
 ...
 */
export const startMeetingTranscription = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StartMeetingTranscriptionRequest, output: StartMeetingTranscriptionResponse, errors: [BadRequestException, ForbiddenException, LimitExceededException, NotFoundException, ServiceFailureException, ServiceUnavailableException, ThrottlingException, UnauthorizedException, UnprocessableEntityException] }));
/**
 ...
 */
export const stopMeetingTranscription = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StopMeetingTranscriptionRequest, output: StopMeetingTranscriptionResponse, errors: [BadRequestException, ForbiddenException, NotFoundException, ServiceFailureException, ServiceUnavailableException, ThrottlingException, UnauthorizedException, UnprocessableEntityException] }));
/**
 ...
 */
export const batchCreateAttendee = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: BatchCreateAttendeeRequest, output: BatchCreateAttendeeResponse, errors: [BadRequestException, ForbiddenException, LimitExceededException, NotFoundException, ServiceFailureException, ServiceUnavailableException, ThrottlingException, UnauthorizedException, UnprocessableEntityException] }));
/**
 ...
 * *Amazon Chime Developer Guide*.
 */
export const createAttendee = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateAttendeeRequest, output: CreateAttendeeResponse, errors: [BadRequestException, ForbiddenException, LimitExceededException, NotFoundException, ServiceFailureException, ServiceUnavailableException, ThrottlingException, UnauthorizedException, UnprocessableEntityException] }));
