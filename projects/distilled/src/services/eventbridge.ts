...
export class ActivateEventSourceRequest extends S.Class<ActivateEventSourceRequest>("ActivateEventSourceRequest")({Name: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ActivateEventSourceResponse extends S.Class<ActivateEventSourceResponse>("ActivateEventSourceResponse")({}, ns) {}
export class CancelReplayRequest extends S.Class<CancelReplayRequest>("CancelReplayRequest")({ReplayName: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class CreateApiDestinationRequest extends S.Class<CreateApiDestinationRequest>("CreateApiDestinationRequest")({Name: S.String, Description: S.optional(S.String), ConnectionArn: S.String, InvocationEndpoint: S.String, HttpMethod: S.String, InvocationRateLimitPerSecond: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class CreateArchiveRequest extends S.Class<CreateArchiveRequest>("CreateArchiveRequest")({ArchiveName: S.String, EventSourceArn: S.String, Description: S.optional(S.String), EventPattern: S.optional(S.String), RetentionDays: S.optional(S.Number), KmsKeyIdentifier: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class CreatePartnerEventSourceRequest extends S.Class<CreatePartnerEventSourceRequest>("CreatePartnerEventSourceRequest")({Name: S.String, Account: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeactivateEventSourceRequest extends S.Class<DeactivateEventSourceRequest>("DeactivateEventSourceRequest")({Name: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeactivateEventSourceResponse extends S.Class<DeactivateEventSourceResponse>("DeactivateEventSourceResponse")({}, ns) {}
export class DeauthorizeConnectionRequest extends S.Class<DeauthorizeConnectionRequest>("DeauthorizeConnectionRequest")({Name: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteApiDestinationRequest extends S.Class<DeleteApiDestinationRequest>("DeleteApiDestinationRequest")({Name: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteApiDestinationResponse extends S.Class<DeleteApiDestinationResponse>("DeleteApiDestinationResponse")({}, ns) {}
export class DeleteArchiveRequest extends S.Class<DeleteArchiveRequest>("DeleteArchiveRequest")({ArchiveName: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteArchiveResponse extends S.Class<DeleteArchiveResponse>("DeleteArchiveResponse")({}, ns) {}
export class DeleteConnectionRequest extends S.Class<DeleteConnectionRequest>("DeleteConnectionRequest")({Name: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteEndpointRequest extends S.Class<DeleteEndpointRequest>("DeleteEndpointRequest")({Name: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteEndpointResponse extends S.Class<DeleteEndpointResponse>("DeleteEndpointResponse")({}, ns) {}
export class DeleteEventBusRequest extends S.Class<DeleteEventBusRequest>("DeleteEventBusRequest")({Name: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteEventBusResponse extends S.Class<DeleteEventBusResponse>("DeleteEventBusResponse")({}, ns) {}
export class DeletePartnerEventSourceRequest extends S.Class<DeletePartnerEventSourceRequest>("DeletePartnerEventSourceRequest")({Name: S.String, Account: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeletePartnerEventSourceResponse extends S.Class<DeletePartnerEventSourceResponse>("DeletePartnerEventSourceResponse")({}, ns) {}
export class DeleteRuleRequest extends S.Class<DeleteRuleRequest>("DeleteRuleRequest")({Name: S.String, EventBusName: S.optional(S.String), Force: S.optional(S.Boolean)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteRuleResponse extends S.Class<DeleteRuleResponse>("DeleteRuleResponse")({}, ns) {}
export class DescribeApiDestinationRequest extends S.Class<DescribeApiDestinationRequest>("DescribeApiDestinationRequest")({Name: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeArchiveRequest extends S.Class<DescribeArchiveRequest>("DescribeArchiveRequest")({ArchiveName: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeConnectionRequest extends S.Class<DescribeConnectionRequest>("DescribeConnectionRequest")({Name: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeEndpointRequest extends S.Class<DescribeEndpointRequest>("DescribeEndpointRequest")({Name: S.String, HomeRegion: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeEventBusRequest extends S.Class<DescribeEventBusRequest>("DescribeEventBusRequest")({Name: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeEventSourceRequest extends S.Class<DescribeEventSourceRequest>("DescribeEventSourceRequest")({Name: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribePartnerEventSourceRequest extends S.Class<DescribePartnerEventSourceRequest>("DescribePartnerEventSourceRequest")({Name: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeReplayRequest extends S.Class<DescribeReplayRequest>("DescribeReplayRequest")({ReplayName: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeRuleRequest extends S.Class<DescribeRuleRequest>("DescribeRuleRequest")({Name: S.String, EventBusName: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DisableRuleRequest extends S.Class<DisableRuleRequest>("DisableRuleRequest")({Name: S.String, EventBusName: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DisableRuleResponse extends S.Class<DisableRuleResponse>("DisableRuleResponse")({}, ns) {}
export class EnableRuleRequest extends S.Class<EnableRuleRequest>("EnableRuleRequest")({Name: S.String, EventBusName: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class EnableRuleResponse extends S.Class<EnableRuleResponse>("EnableRuleResponse")({}, ns) {}
export class ListApiDestinationsRequest extends S.Class<ListApiDestinationsRequest>("ListApiDestinationsRequest")({NamePrefix: S.optional(S.String), ConnectionArn: S.optional(S.String), NextToken: S.optional(S.String), Limit: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListArchivesRequest extends S.Class<ListArchivesRequest>("ListArchivesRequest")({NamePrefix: S.optional(S.String), EventSourceArn: S.optional(S.String), State: S.optional(S.String), NextToken: S.optional(S.String), Limit: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListConnectionsRequest extends S.Class<ListConnectionsRequest>("ListConnectionsRequest")({NamePrefix: S.optional(S.String), ConnectionState: S.optional(S.String), NextToken: S.optional(S.String), Limit: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListEndpointsRequest extends S.Class<ListEndpointsRequest>("ListEndpointsRequest")({NamePrefix: S.optional(S.String), HomeRegion: S.optional(S.String), NextToken: S.optional(S.String), MaxResults: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListEventBusesRequest extends S.Class<ListEventBusesRequest>("ListEventBusesRequest")({NamePrefix: S.optional(S.String), NextToken: S.optional(S.String), Limit: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListEventSourcesRequest extends S.Class<ListEventSourcesRequest>("ListEventSourcesRequest")({NamePrefix: S.optional(S.String), NextToken: S.optional(S.String), Limit: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListPartnerEventSourceAccountsRequest extends S.Class<ListPartnerEventSourceAccountsRequest>("ListPartnerEventSourceAccountsRequest")({EventSourceName: S.String, NextToken: S.optional(S.String), Limit: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListPartnerEventSourcesRequest extends S.Class<ListPartnerEventSourcesRequest>("ListPartnerEventSourcesRequest")({NamePrefix: S.String, NextToken: S.optional(S.String), Limit: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListReplaysRequest extends S.Class<ListReplaysRequest>("ListReplaysRequest")({NamePrefix: S.optional(S.String), State: S.optional(S.String), EventSourceArn: S.optional(S.String), NextToken: S.optional(S.String), Limit: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListRuleNamesByTargetRequest extends S.Class<ListRuleNamesByTargetRequest>("ListRuleNamesByTargetRequest")({TargetArn: S.String, EventBusName: S.optional(S.String), NextToken: S.optional(S.String), Limit: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListRulesRequest extends S.Class<ListRulesRequest>("ListRulesRequest")({NamePrefix: S.optional(S.String), EventBusName: S.optional(S.String), NextToken: S.optional(S.String), Limit: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class ListTargetsByRuleRequest extends S.Class<ListTargetsByRuleRequest>("ListTargetsByRuleRequest")({Rule: S.String, EventBusName: S.optional(S.String), NextToken: S.optional(S.String), Limit: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class RemovePermissionRequest extends S.Class<RemovePermissionRequest>("RemovePermissionRequest")({StatementId: S.optional(S.String), RemoveAllPermissions: S.optional(S.Boolean), EventBusName: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class RemovePermissionResponse extends S.Class<RemovePermissionResponse>("RemovePermissionResponse")({}, ns) {}
export class RemoveTargetsRequest extends S.Class<RemoveTargetsRequest>("RemoveTargetsRequest")({Rule: S.String, EventBusName: S.optional(S.String), Ids: TargetIdList, Force: S.optional(S.Boolean)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class TestEventPatternRequest extends S.Class<TestEventPatternRequest>("TestEventPatternRequest")({EventPattern: S.String, Event: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class UpdateArchiveRequest extends S.Class<UpdateArchiveRequest>("UpdateArchiveRequest")({ArchiveName: S.String, Description: S.optional(S.String), EventPattern: S.optional(S.String), RetentionDays: S.optional(S.Number), KmsKeyIdentifier: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class UpdateEventBusRequest extends S.Class<UpdateEventBusRequest>("UpdateEventBusRequest")({Name: S.optional(S.String), KmsKeyIdentifier: S.optional(S.String), Description: S.optional(S.String), DeadLetterConfig: S.optional(DeadLetterConfig), LogConfig: S.optional(LogConfig)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class PutPartnerEventsRequestEntry extends S.Class<PutPartnerEventsRequestEntry>("PutPartnerEventsRequestEntry")({Time: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), Source: S.optional(S.String), Resources: S.optional(EventResourceList), DetailType: S.optional(S.String), Detail: S.optional(S.String)}) {}
...
export class CancelReplayResponse extends S.Class<CancelReplayResponse>("CancelReplayResponse")({ReplayArn: S.optional(S.String), State: S.optional(S.String), StateReason: S.optional(S.String)}, ns) {}
export class CreateApiDestinationResponse extends S.Class<CreateApiDestinationResponse>("CreateApiDestinationResponse")({ApiDestinationArn: S.optional(S.String), ApiDestinationState: S.optional(S.String), CreationTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), LastModifiedTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}, ns) {}
export class CreateArchiveResponse extends S.Class<CreateArchiveResponse>("CreateArchiveResponse")({ArchiveArn: S.optional(S.String), State: S.optional(S.String), StateReason: S.optional(S.String), CreationTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}, ns) {}
export class CreateEventBusRequest extends S.Class<CreateEventBusRequest>("CreateEventBusRequest")({Name: S.String, EventSourceName: S.optional(S.String), Description: S.optional(S.String), KmsKeyIdentifier: S.optional(S.String), DeadLetterConfig: S.optional(DeadLetterConfig), LogConfig: S.optional(LogConfig), Tags: S.optional(TagList)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class CreatePartnerEventSourceResponse extends S.Class<CreatePartnerEventSourceResponse>("CreatePartnerEventSourceResponse")({EventSourceArn: S.optional(S.String)}, ns) {}
export class DeauthorizeConnectionResponse extends S.Class<DeauthorizeConnectionResponse>("DeauthorizeConnectionResponse")({ConnectionArn: S.optional(S.String), ConnectionState: S.optional(S.String), CreationTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), LastModifiedTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), LastAuthorizedTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}, ns) {}
export class DeleteConnectionResponse extends S.Class<DeleteConnectionResponse>("DeleteConnectionResponse")({ConnectionArn: S.optional(S.String), ConnectionState: S.optional(S.String), CreationTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), LastModifiedTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), LastAuthorizedTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}, ns) {}
...
export class DescribeEventSourceResponse extends S.Class<DescribeEventSourceResponse>("DescribeEventSourceResponse")({Arn: S.optional(S.String), CreatedBy: S.optional(S.String), CreationTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), ExpirationTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), Name: S.optional(S.String), State: S.optional(S.String)}, ns) {}
export class DescribePartnerEventSourceResponse extends S.Class<DescribePartnerEventSourceResponse>("DescribePartnerEventSourceResponse")({Arn: S.optional(S.String), Name: S.optional(S.String)}, ns) {}
export class DescribeReplayResponse extends S.Class<DescribeReplayResponse>("DescribeReplayResponse")({ReplayName: S.optional(S.String), ReplayArn: S.optional(S.String), Description: S.optional(S.String), State: S.optional(S.String), StateReason: S.optional(S.String), EventSourceArn: S.optional(S.String), Destination: S.optional(ReplayDestination), EventStartTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), EventEndTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), EventLastReplayedTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), ReplayStartTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), ReplayEndTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}, ns) {}
...
export class ListRuleNamesByTargetResponse extends S.Class<ListRuleNamesByTargetResponse>("ListRuleNamesByTargetResponse")({RuleNames: S.optional(RuleNameList), NextToken: S.optional(S.String)}, ns) {}
...
export class ListTargetsByRuleResponse extends S.Class<ListTargetsByRuleResponse>("ListTargetsByRuleResponse")({Targets: S.optional(TargetList), NextToken: S.optional(S.String)}, ns) {}
export class PutEventsRequest extends S.Class<PutEventsRequest>("PutEventsRequest")({Entries: PutEventsRequestEntryList, EndpointId: S.optional(S.String).pipe(T.ContextParam("EndpointId"))}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutPartnerEventsRequest extends S.Class<PutPartnerEventsRequest>("PutPartnerEventsRequest")({Entries: PutPartnerEventsRequestEntryList}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutPermissionRequest extends S.Class<PutPermissionRequest>("PutPermissionRequest")({EventBusName: S.optional(S.String), Action: S.optional(S.String), Principal: S.optional(S.String), StatementId: S.optional(S.String), Condition: S.optional(Condition), Policy: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutPermissionResponse extends S.Class<PutPermissionResponse>("PutPermissionResponse")({}, ns) {}
export class PutRuleResponse extends S.Class<PutRuleResponse>("PutRuleResponse")({RuleArn: S.optional(S.String)}, ns) {}
export class StartReplayRequest extends S.Class<StartReplayRequest>("StartReplayRequest")({ReplayName: S.String, Description: S.optional(S.String), EventSourceArn: S.String, EventStartTime: S.Date.pipe(T.TimestampFormat("epoch-seconds")), EventEndTime: S.Date.pipe(T.TimestampFormat("epoch-seconds")), Destination: ReplayDestination}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class TestEventPatternResponse extends S.Class<TestEventPatternResponse>("TestEventPatternResponse")({Result: S.optional(S.Boolean)}, ns) {}
export class UpdateApiDestinationResponse extends S.Class<UpdateApiDestinationResponse>("UpdateApiDestinationResponse")({ApiDestinationArn: S.optional(S.String), ApiDestinationState: S.optional(S.String), CreationTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), LastModifiedTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}, ns) {}
export class UpdateArchiveResponse extends S.Class<UpdateArchiveResponse>("UpdateArchiveResponse")({ArchiveArn: S.optional(S.String), State: S.optional(S.String), StateReason: S.optional(S.String), CreationTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}, ns) {}
export class UpdateEndpointResponse extends S.Class<UpdateEndpointResponse>("UpdateEndpointResponse")({Name: S.optional(S.String), Arn: S.optional(S.String), RoutingConfig: S.optional(RoutingConfig), ReplicationConfig: S.optional(ReplicationConfig), EventBuses: S.optional(EndpointEventBusList), RoleArn: S.optional(S.String), EndpointId: S.optional(S.String), EndpointUrl: S.optional(S.String), State: S.optional(S.String)}, ns) {}
export class UpdateEventBusResponse extends S.Class<UpdateEventBusResponse>("UpdateEventBusResponse")({Arn: S.optional(S.String), Name: S.optional(S.String), KmsKeyIdentifier: S.optional(S.String), Description: S.optional(S.String), DeadLetterConfig: S.optional(DeadLetterConfig), LogConfig: S.optional(LogConfig)}, ns) {}
...
export class EventBus extends S.Class<EventBus>("EventBus")({Name: S.optional(S.String), Arn: S.optional(S.String), Description: S.optional(S.String), Policy: S.optional(S.String), CreationTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), LastModifiedTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
export const EventBusList = S.Array(EventBus);
export class EventSource extends S.Class<EventSource>("EventSource")({Arn: S.optional(S.String), CreatedBy: S.optional(S.String), CreationTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), ExpirationTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), Name: S.optional(S.String), State: S.optional(S.String)}) {}
export const EventSourceList = S.Array(EventSource);
export class PartnerEventSourceAccount extends S.Class<PartnerEventSourceAccount>("PartnerEventSourceAccount")({Account: S.optional(S.String), CreationTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), ExpirationTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), State: S.optional(S.String)}) {}
...
export class CreateEventBusResponse extends S.Class<CreateEventBusResponse>("CreateEventBusResponse")({EventBusArn: S.optional(S.String), Description: S.optional(S.String), KmsKeyIdentifier: S.optional(S.String), DeadLetterConfig: S.optional(DeadLetterConfig), LogConfig: S.optional(LogConfig)}, ns) {}
export class ListApiDestinationsResponse extends S.Class<ListApiDestinationsResponse>("ListApiDestinationsResponse")({ApiDestinations: S.optional(ApiDestinationResponseList), NextToken: S.optional(S.String)}, ns) {}
export class ListArchivesResponse extends S.Class<ListArchivesResponse>("ListArchivesResponse")({Archives: S.optional(ArchiveResponseList), NextToken: S.optional(S.String)}, ns) {}
export class ListConnectionsResponse extends S.Class<ListConnectionsResponse>("ListConnectionsResponse")({Connections: S.optional(ConnectionResponseList), NextToken: S.optional(S.String)}, ns) {}
export class ListEndpointsResponse extends S.Class<ListEndpointsResponse>("ListEndpointsResponse")({Endpoints: S.optional(EndpointList), NextToken: S.optional(S.String)}, ns) {}
export class ListEventBusesResponse extends S.Class<ListEventBusesResponse>("ListEventBusesResponse")({EventBuses: S.optional(EventBusList), NextToken: S.optional(S.String)}, ns) {}
export class ListEventSourcesResponse extends S.Class<ListEventSourcesResponse>("ListEventSourcesResponse")({EventSources: S.optional(EventSourceList), NextToken: S.optional(S.String)}, ns) {}
export class ListPartnerEventSourceAccountsResponse extends S.Class<ListPartnerEventSourceAccountsResponse>("ListPartnerEventSourceAccountsResponse")({PartnerEventSourceAccounts: S.optional(PartnerEventSourceAccountList), NextToken: S.optional(S.String)}, ns) {}
export class ListPartnerEventSourcesResponse extends S.Class<ListPartnerEventSourcesResponse>("ListPartnerEventSourcesResponse")({PartnerEventSources: S.optional(PartnerEventSourceList), NextToken: S.optional(S.String)}, ns) {}
export class ListReplaysResponse extends S.Class<ListReplaysResponse>("ListReplaysResponse")({Replays: S.optional(ReplayList), NextToken: S.optional(S.String)}, ns) {}
export class ListRulesResponse extends S.Class<ListRulesResponse>("ListRulesResponse")({Rules: S.optional(RuleResponseList), NextToken: S.optional(S.String)}, ns) {}
export class RemoveTargetsResponse extends S.Class<RemoveTargetsResponse>("RemoveTargetsResponse")({FailedEntryCount: S.optional(S.Number), FailedEntries: S.optional(RemoveTargetsResultEntryList)}, ns) {}
export class StartReplayResponse extends S.Class<StartReplayResponse>("StartReplayResponse")({ReplayArn: S.optional(S.String), State: S.optional(S.String), StateReason: S.optional(S.String), ReplayStartTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}, ns) {}
...
export class CreateEndpointRequest extends S.Class<CreateEndpointRequest>("CreateEndpointRequest")({Name: S.String, Description: S.optional(S.String), RoutingConfig: RoutingConfig, ReplicationConfig: S.optional(ReplicationConfig), EventBuses: EndpointEventBusList, RoleArn: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutEventsResponse extends S.Class<PutEventsResponse>("PutEventsResponse")({FailedEntryCount: S.optional(S.Number), Entries: S.optional(PutEventsResultEntryList)}, ns) {}
export class PutPartnerEventsResponse extends S.Class<PutPartnerEventsResponse>("PutPartnerEventsResponse")({FailedEntryCount: S.optional(S.Number), Entries: S.optional(PutPartnerEventsResultEntryList)}, ns) {}
...
export class PutTargetsRequest extends S.Class<PutTargetsRequest>("PutTargetsRequest")({Rule: S.String, EventBusName: S.optional(S.String), Targets: TargetList}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class UpdateConnectionResponse extends S.Class<UpdateConnectionResponse>("UpdateConnectionResponse")({ConnectionArn: S.optional(S.String), ConnectionState: S.optional(S.String), CreationTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), LastModifiedTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), LastAuthorizedTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}, ns) {}
...
export class PutTargetsResponse extends S.Class<PutTargetsResponse>("PutTargetsResponse")({FailedEntryCount: S.optional(S.Number), FailedEntries: S.optional(PutTargetsResultEntryList)}, ns) {}
...
export class InternalException extends S.TaggedError<InternalException>()("InternalException", {message: S.optional(S.String)}) {}
...
export class OperationDisabledException extends S.TaggedError<OperationDisabledException>()("OperationDisabledException", {message: S.optional(S.String)}) {}
export class ManagedRuleException extends S.TaggedError<ManagedRuleException>()("ManagedRuleException", {message: S.optional(S.String)}) {}
export class InvalidEventPatternException extends S.TaggedError<InvalidEventPatternException>()("InvalidEventPatternException", {message: S.optional(S.String)}) {}
 ...
 */
export const listApiDestinations = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListApiDestinationsRequest, output: ListApiDestinationsResponse, errors: [InternalException] }));
/**
 * Retrieves a list of connections from the account.
 */
export const listConnections = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListConnectionsRequest, output: ListConnectionsResponse, errors: [InternalException] }));
/**
 ...
 * .
 */
export const listEndpoints = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListEndpointsRequest, output: ListEndpointsResponse, errors: [InternalException] }));
/**
 * Lists all the event buses in your account, including the default event bus, custom event
 * buses, and partner event buses.
 */
export const listEventBuses = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListEventBusesRequest, output: ListEventBusesResponse, errors: [InternalException] }));
/**
 ...
 */
export const listReplays = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListReplaysRequest, output: ListReplaysResponse, errors: [InternalException] }));
/**
 ...
 */
export const deleteEventBus = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteEventBusRequest, output: DeleteEventBusResponse, errors: [ConcurrentModificationException, InternalException] }));
/**
 * Cancels the specified replay.
 */
export const cancelReplay = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CancelReplayRequest, output: CancelReplayResponse, errors: [ConcurrentModificationException, IllegalStatusException, InternalException, ResourceNotFoundException] }));
/**
 ...
 */
export const listEventSources = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListEventSourcesRequest, output: ListEventSourcesResponse, errors: [InternalException, OperationDisabledException] }));
/**
 ...
 */
export const putEvents = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutEventsRequest, output: PutEventsResponse, errors: [InternalException] }));
/**
 ...
 */
export const putPartnerEvents = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutPartnerEventsRequest, output: PutPartnerEventsResponse, errors: [InternalException, OperationDisabledException] }));
/**
 ...
 */
export const removeTargets = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: RemoveTargetsRequest, output: RemoveTargetsResponse, errors: [ConcurrentModificationException, InternalException, ManagedRuleException, ResourceNotFoundException] }));
/**
 * Retrieves details about an archive.
 */
export const describeArchive = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeArchiveRequest, output: DescribeArchiveResponse, errors: [InternalException, ResourceAlreadyExistsException, ResourceNotFoundException] }));
/**
 ...
 */
export const createEventBus = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateEventBusRequest, output: CreateEventBusResponse, errors: [ConcurrentModificationException, InternalException, InvalidStateException, LimitExceededException, OperationDisabledException, ResourceAlreadyExistsException, ResourceNotFoundException] }));
/**
 ...
 */
export const deactivateEventSource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeactivateEventSourceRequest, output: DeactivateEventSourceResponse, errors: [ConcurrentModificationException, InternalException, InvalidStateException, OperationDisabledException, ResourceNotFoundException] }));
/**
 ...
 */
export const listArchives = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListArchivesRequest, output: ListArchivesResponse, errors: [InternalException, ResourceNotFoundException] }));
/**
 ...
 */
export const listRules = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListRulesRequest, output: ListRulesResponse, errors: [InternalException, ResourceNotFoundException] }));
/**
 ...
 */
export const deauthorizeConnection = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeauthorizeConnectionRequest, output: DeauthorizeConnectionResponse, errors: [ConcurrentModificationException, InternalException, ResourceNotFoundException] }));
/**
 * Deletes a connection.
 */
export const deleteConnection = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteConnectionRequest, output: DeleteConnectionResponse, errors: [ConcurrentModificationException, InternalException, ResourceNotFoundException] }));
/**
 * Retrieves details about an API destination.
 */
export const describeApiDestination = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeApiDestinationRequest, output: DescribeApiDestinationResponse, errors: [InternalException, ResourceNotFoundException] }));
/**
 ...
 * .
 */
export const describeEndpoint = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeEndpointRequest, output: DescribeEndpointResponse, errors: [InternalException, ResourceNotFoundException] }));
/**
 ...
 */
export const describeEventBus = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeEventBusRequest, output: DescribeEventBusResponse, errors: [InternalException, ResourceNotFoundException] }));
/**
 ...
 */
export const describeReplay = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeReplayRequest, output: DescribeReplayResponse, errors: [InternalException, ResourceNotFoundException] }));
/**
 ...
 */
export const describeRule = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeRuleRequest, output: DescribeRuleResponse, errors: [InternalException, ResourceNotFoundException] }));
/**
 ...
 * The maximum number of results per page for requests is 100.
 */
export const listRuleNamesByTarget = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListRuleNamesByTargetRequest, output: ListRuleNamesByTargetResponse, errors: [InternalException, ResourceNotFoundException] }));
/**
 * Displays the tags associated with an EventBridge resource. In EventBridge, rules and event
 * buses can be tagged.
 */
export const listTagsForResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListTagsForResourceRequest, output: ListTagsForResourceResponse, errors: [InternalException, ResourceNotFoundException] }));
/**
 * Lists the targets assigned to the specified rule.
 * 
 * The maximum number of results per page for requests is 100.
 */
export const listTargetsByRule = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListTargetsByRuleRequest, output: ListTargetsByRuleResponse, errors: [InternalException, ResourceNotFoundException] }));
/**
 ...
 * .
 */
export const updateEndpoint = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateEndpointRequest, output: UpdateEndpointResponse, errors: [ConcurrentModificationException, InternalException, ResourceNotFoundException] }));
/**
 * Deletes the specified API destination.
 */
export const deleteApiDestination = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteApiDestinationRequest, output: DeleteApiDestinationResponse, errors: [ConcurrentModificationException, InternalException, ResourceNotFoundException] }));
/**
 * Deletes the specified archive.
 */
export const deleteArchive = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteArchiveRequest, output: DeleteArchiveResponse, errors: [ConcurrentModificationException, InternalException, ResourceNotFoundException] }));
/**
 ...
 * .
 */
export const deleteEndpoint = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteEndpointRequest, output: DeleteEndpointResponse, errors: [ConcurrentModificationException, InternalException, ResourceNotFoundException] }));
/**
 ...
 */
export const listPartnerEventSourceAccounts = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListPartnerEventSourceAccountsRequest, output: ListPartnerEventSourceAccountsResponse, errors: [InternalException, OperationDisabledException, ResourceNotFoundException] }));
/**
 ...
 */
export const listPartnerEventSources = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListPartnerEventSourcesRequest, output: ListPartnerEventSourcesResponse, errors: [InternalException, OperationDisabledException] }));
/**
 * This operation lists details about a partner event source that is shared with your
 * account.
 */
export const describeEventSource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeEventSourceRequest, output: DescribeEventSourceResponse, errors: [InternalException, OperationDisabledException, ResourceNotFoundException] }));
/**
 ...
 * them.
 */
export const describePartnerEventSource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribePartnerEventSourceRequest, output: DescribePartnerEventSourceResponse, errors: [InternalException, OperationDisabledException, ResourceNotFoundException] }));
/**
 * Updates the specified event bus.
 */
export const updateEventBus = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateEventBusRequest, output: UpdateEventBusResponse, errors: [ConcurrentModificationException, InternalException, OperationDisabledException, ResourceNotFoundException] }));
/**
 ...
 */
export const deletePartnerEventSource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeletePartnerEventSourceRequest, output: DeletePartnerEventSourceResponse, errors: [ConcurrentModificationException, InternalException, OperationDisabledException] }));
/**
 ...
 */
export const removePermission = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: RemovePermissionRequest, output: RemovePermissionResponse, errors: [ConcurrentModificationException, InternalException, OperationDisabledException, ResourceNotFoundException] }));
/**
 ...
 */
export const activateEventSource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ActivateEventSourceRequest, output: ActivateEventSourceResponse, errors: [ConcurrentModificationException, InternalException, InvalidStateException, OperationDisabledException, ResourceNotFoundException] }));
/**
 ...
 * rule.
 */
export const deleteRule = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteRuleRequest, output: DeleteRuleResponse, errors: [ConcurrentModificationException, InternalException, ManagedRuleException, ResourceNotFoundException] }));
/**
 ...
 */
export const disableRule = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DisableRuleRequest, output: DisableRuleResponse, errors: [ConcurrentModificationException, InternalException, ManagedRuleException, ResourceNotFoundException] }));
/**
 ...
 */
export const enableRule = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: EnableRuleRequest, output: EnableRuleResponse, errors: [ConcurrentModificationException, InternalException, ManagedRuleException, ResourceNotFoundException] }));
/**
 ...
 */
export const tagResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: TagResourceRequest, output: TagResourceResponse, errors: [ConcurrentModificationException, InternalException, ManagedRuleException, ResourceNotFoundException] }));
/**
 ...
 */
export const untagResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UntagResourceRequest, output: UntagResourceResponse, errors: [ConcurrentModificationException, InternalException, ManagedRuleException, ResourceNotFoundException] }));
/**
 ...
 */
export const createArchive = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateArchiveRequest, output: CreateArchiveResponse, errors: [ConcurrentModificationException, InternalException, InvalidEventPatternException, LimitExceededException, ResourceAlreadyExistsException, ResourceNotFoundException] }));
/**
 ...
 */
export const putRule = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutRuleRequest, output: PutRuleResponse, errors: [ConcurrentModificationException, InternalException, InvalidEventPatternException, LimitExceededException, ManagedRuleException, ResourceNotFoundException] }));
/**
 ...
 */
export const testEventPattern = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: TestEventPatternRequest, output: TestEventPatternResponse, errors: [InternalException, InvalidEventPatternException] }));
/**
 * Updates the specified archive.
 */
export const updateArchive = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateArchiveRequest, output: UpdateArchiveResponse, errors: [ConcurrentModificationException, InternalException, InvalidEventPatternException, LimitExceededException, ResourceNotFoundException] }));
/**
 ...
 */
export const createPartnerEventSource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreatePartnerEventSourceRequest, output: CreatePartnerEventSourceResponse, errors: [ConcurrentModificationException, InternalException, LimitExceededException, OperationDisabledException, ResourceAlreadyExistsException] }));
/**
 * Updates an API destination.
 */
export const updateApiDestination = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateApiDestinationRequest, output: UpdateApiDestinationResponse, errors: [ConcurrentModificationException, InternalException, LimitExceededException, ResourceNotFoundException] }));
/**
 ...
 * replayed.
 */
export const startReplay = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StartReplayRequest, output: StartReplayResponse, errors: [InternalException, InvalidEventPatternException, LimitExceededException, ResourceAlreadyExistsException, ResourceNotFoundException] }));
/**
 ...
 * *EventBridge User Guide*.
 */
export const createApiDestination = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateApiDestinationRequest, output: CreateApiDestinationResponse, errors: [InternalException, LimitExceededException, ResourceAlreadyExistsException, ResourceNotFoundException] }));
/**
 ...
 * a "healthy" state.
 */
export const createEndpoint = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateEndpointRequest, output: CreateEndpointResponse, errors: [InternalException, LimitExceededException, ResourceAlreadyExistsException] }));
/**
 * Retrieves details about a connection.
 */
export const describeConnection = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeConnectionRequest, output: DescribeConnectionResponse, errors: [InternalException, ResourceNotFoundException] }));
/**
 ...
 */
export const putPermission = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutPermissionRequest, output: PutPermissionResponse, errors: [ConcurrentModificationException, InternalException, OperationDisabledException, PolicyLengthExceededException, ResourceNotFoundException] }));
/**
 ...
 */
export const createConnection = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateConnectionRequest, output: CreateConnectionResponse, errors: [AccessDeniedException, InternalException, LimitExceededException, ResourceAlreadyExistsException, ResourceNotFoundException, ThrottlingException] }));
/**
 ...
 * `FailedEntries` provides the ID of the failed target and the error code.
 */
export const putTargets = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutTargetsRequest, output: PutTargetsResponse, errors: [ConcurrentModificationException, InternalException, LimitExceededException, ManagedRuleException, ResourceNotFoundException] }));
/**
 * Updates settings for a connection.
 */
export const updateConnection = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateConnectionRequest, output: UpdateConnectionResponse, errors: [AccessDeniedException, ConcurrentModificationException, InternalException, LimitExceededException, ResourceNotFoundException, ThrottlingException] }));
