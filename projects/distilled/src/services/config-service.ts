...
//# Schemas
export class GetComplianceSummaryByConfigRuleRequest extends S.Class<GetComplianceSummaryByConfigRuleRequest>("GetComplianceSummaryByConfigRuleRequest")({}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class AssociateResourceTypesRequest extends S.Class<AssociateResourceTypesRequest>("AssociateResourceTypesRequest")({ConfigurationRecorderArn: S.String, ResourceTypes: ResourceTypeList}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteAggregationAuthorizationRequest extends S.Class<DeleteAggregationAuthorizationRequest>("DeleteAggregationAuthorizationRequest")({AuthorizedAccountId: S.String, AuthorizedAwsRegion: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteAggregationAuthorizationResponse extends S.Class<DeleteAggregationAuthorizationResponse>("DeleteAggregationAuthorizationResponse")({}, ns) {}
export class DeleteConfigRuleRequest extends S.Class<DeleteConfigRuleRequest>("DeleteConfigRuleRequest")({ConfigRuleName: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteConfigRuleResponse extends S.Class<DeleteConfigRuleResponse>("DeleteConfigRuleResponse")({}, ns) {}
export class DeleteConfigurationAggregatorRequest extends S.Class<DeleteConfigurationAggregatorRequest>("DeleteConfigurationAggregatorRequest")({ConfigurationAggregatorName: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteConfigurationAggregatorResponse extends S.Class<DeleteConfigurationAggregatorResponse>("DeleteConfigurationAggregatorResponse")({}, ns) {}
export class DeleteConfigurationRecorderRequest extends S.Class<DeleteConfigurationRecorderRequest>("DeleteConfigurationRecorderRequest")({ConfigurationRecorderName: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteConfigurationRecorderResponse extends S.Class<DeleteConfigurationRecorderResponse>("DeleteConfigurationRecorderResponse")({}, ns) {}
export class DeleteConformancePackRequest extends S.Class<DeleteConformancePackRequest>("DeleteConformancePackRequest")({ConformancePackName: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteConformancePackResponse extends S.Class<DeleteConformancePackResponse>("DeleteConformancePackResponse")({}, ns) {}
export class DeleteDeliveryChannelRequest extends S.Class<DeleteDeliveryChannelRequest>("DeleteDeliveryChannelRequest")({DeliveryChannelName: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteDeliveryChannelResponse extends S.Class<DeleteDeliveryChannelResponse>("DeleteDeliveryChannelResponse")({}, ns) {}
export class DeleteEvaluationResultsRequest extends S.Class<DeleteEvaluationResultsRequest>("DeleteEvaluationResultsRequest")({ConfigRuleName: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteEvaluationResultsResponse extends S.Class<DeleteEvaluationResultsResponse>("DeleteEvaluationResultsResponse")({}, ns) {}
export class DeleteOrganizationConfigRuleRequest extends S.Class<DeleteOrganizationConfigRuleRequest>("DeleteOrganizationConfigRuleRequest")({OrganizationConfigRuleName: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteOrganizationConfigRuleResponse extends S.Class<DeleteOrganizationConfigRuleResponse>("DeleteOrganizationConfigRuleResponse")({}, ns) {}
export class DeleteOrganizationConformancePackRequest extends S.Class<DeleteOrganizationConformancePackRequest>("DeleteOrganizationConformancePackRequest")({OrganizationConformancePackName: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteOrganizationConformancePackResponse extends S.Class<DeleteOrganizationConformancePackResponse>("DeleteOrganizationConformancePackResponse")({}, ns) {}
export class DeletePendingAggregationRequestRequest extends S.Class<DeletePendingAggregationRequestRequest>("DeletePendingAggregationRequestRequest")({RequesterAccountId: S.String, RequesterAwsRegion: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeletePendingAggregationRequestResponse extends S.Class<DeletePendingAggregationRequestResponse>("DeletePendingAggregationRequestResponse")({}, ns) {}
export class DeleteRemediationConfigurationRequest extends S.Class<DeleteRemediationConfigurationRequest>("DeleteRemediationConfigurationRequest")({ConfigRuleName: S.String, ResourceType: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteRemediationConfigurationResponse extends S.Class<DeleteRemediationConfigurationResponse>("DeleteRemediationConfigurationResponse")({}, ns) {}
export class DeleteResourceConfigRequest extends S.Class<DeleteResourceConfigRequest>("DeleteResourceConfigRequest")({ResourceType: S.String, ResourceId: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteResourceConfigResponse extends S.Class<DeleteResourceConfigResponse>("DeleteResourceConfigResponse")({}, ns) {}
export class DeleteRetentionConfigurationRequest extends S.Class<DeleteRetentionConfigurationRequest>("DeleteRetentionConfigurationRequest")({RetentionConfigurationName: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteRetentionConfigurationResponse extends S.Class<DeleteRetentionConfigurationResponse>("DeleteRetentionConfigurationResponse")({}, ns) {}
export class DeleteServiceLinkedConfigurationRecorderRequest extends S.Class<DeleteServiceLinkedConfigurationRecorderRequest>("DeleteServiceLinkedConfigurationRecorderRequest")({ServicePrincipal: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteStoredQueryRequest extends S.Class<DeleteStoredQueryRequest>("DeleteStoredQueryRequest")({QueryName: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteStoredQueryResponse extends S.Class<DeleteStoredQueryResponse>("DeleteStoredQueryResponse")({}, ns) {}
export class DeliverConfigSnapshotRequest extends S.Class<DeliverConfigSnapshotRequest>("DeliverConfigSnapshotRequest")({deliveryChannelName: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeAggregationAuthorizationsRequest extends S.Class<DescribeAggregationAuthorizationsRequest>("DescribeAggregationAuthorizationsRequest")({Limit: S.optional(S.Number), NextToken: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeComplianceByConfigRuleRequest extends S.Class<DescribeComplianceByConfigRuleRequest>("DescribeComplianceByConfigRuleRequest")({ConfigRuleNames: S.optional(ConfigRuleNames), ComplianceTypes: S.optional(ComplianceTypes), NextToken: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeComplianceByResourceRequest extends S.Class<DescribeComplianceByResourceRequest>("DescribeComplianceByResourceRequest")({ResourceType: S.optional(S.String), ResourceId: S.optional(S.String), ComplianceTypes: S.optional(ComplianceTypes), Limit: S.optional(S.Number), NextToken: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeConfigRuleEvaluationStatusRequest extends S.Class<DescribeConfigRuleEvaluationStatusRequest>("DescribeConfigRuleEvaluationStatusRequest")({ConfigRuleNames: S.optional(ConfigRuleNames), NextToken: S.optional(S.String), Limit: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeConfigurationAggregatorsRequest extends S.Class<DescribeConfigurationAggregatorsRequest>("DescribeConfigurationAggregatorsRequest")({ConfigurationAggregatorNames: S.optional(ConfigurationAggregatorNameList), NextToken: S.optional(S.String), Limit: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class DescribeConfigurationRecordersRequest extends S.Class<DescribeConfigurationRecordersRequest>("DescribeConfigurationRecordersRequest")({ConfigurationRecorderNames: S.optional(ConfigurationRecorderNameList), ServicePrincipal: S.optional(S.String), Arn: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeConfigurationRecorderStatusRequest extends S.Class<DescribeConfigurationRecorderStatusRequest>("DescribeConfigurationRecorderStatusRequest")({ConfigurationRecorderNames: S.optional(ConfigurationRecorderNameList), ServicePrincipal: S.optional(S.String), Arn: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeConformancePacksRequest extends S.Class<DescribeConformancePacksRequest>("DescribeConformancePacksRequest")({ConformancePackNames: S.optional(ConformancePackNamesList), Limit: S.optional(S.Number), NextToken: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class DescribeDeliveryChannelsRequest extends S.Class<DescribeDeliveryChannelsRequest>("DescribeDeliveryChannelsRequest")({DeliveryChannelNames: S.optional(DeliveryChannelNameList)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeDeliveryChannelStatusRequest extends S.Class<DescribeDeliveryChannelStatusRequest>("DescribeDeliveryChannelStatusRequest")({DeliveryChannelNames: S.optional(DeliveryChannelNameList)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeOrganizationConfigRulesRequest extends S.Class<DescribeOrganizationConfigRulesRequest>("DescribeOrganizationConfigRulesRequest")({OrganizationConfigRuleNames: S.optional(OrganizationConfigRuleNames), Limit: S.optional(S.Number), NextToken: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class DescribePendingAggregationRequestsRequest extends S.Class<DescribePendingAggregationRequestsRequest>("DescribePendingAggregationRequestsRequest")({Limit: S.optional(S.Number), NextToken: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeRemediationConfigurationsRequest extends S.Class<DescribeRemediationConfigurationsRequest>("DescribeRemediationConfigurationsRequest")({ConfigRuleNames: ConfigRuleNames}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class DescribeRemediationExecutionStatusRequest extends S.Class<DescribeRemediationExecutionStatusRequest>("DescribeRemediationExecutionStatusRequest")({ConfigRuleName: S.String, ResourceKeys: S.optional(ResourceKeys), Limit: S.optional(S.Number), NextToken: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeRetentionConfigurationsRequest extends S.Class<DescribeRetentionConfigurationsRequest>("DescribeRetentionConfigurationsRequest")({RetentionConfigurationNames: S.optional(RetentionConfigurationNameList), NextToken: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DisassociateResourceTypesRequest extends S.Class<DisassociateResourceTypesRequest>("DisassociateResourceTypesRequest")({ConfigurationRecorderArn: S.String, ResourceTypes: ResourceTypeList}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class GetAggregateResourceConfigRequest extends S.Class<GetAggregateResourceConfigRequest>("GetAggregateResourceConfigRequest")({ConfigurationAggregatorName: S.String, ResourceIdentifier: AggregateResourceIdentifier}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetComplianceDetailsByConfigRuleRequest extends S.Class<GetComplianceDetailsByConfigRuleRequest>("GetComplianceDetailsByConfigRuleRequest")({ConfigRuleName: S.String, ComplianceTypes: S.optional(ComplianceTypes), Limit: S.optional(S.Number), NextToken: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class GetComplianceSummaryByResourceTypeRequest extends S.Class<GetComplianceSummaryByResourceTypeRequest>("GetComplianceSummaryByResourceTypeRequest")({ResourceTypes: S.optional(ResourceTypes)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetConformancePackComplianceSummaryRequest extends S.Class<GetConformancePackComplianceSummaryRequest>("GetConformancePackComplianceSummaryRequest")({ConformancePackNames: ConformancePackNamesToSummarizeList, Limit: S.optional(S.Number), NextToken: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetCustomRulePolicyRequest extends S.Class<GetCustomRulePolicyRequest>("GetCustomRulePolicyRequest")({ConfigRuleName: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetDiscoveredResourceCountsRequest extends S.Class<GetDiscoveredResourceCountsRequest>("GetDiscoveredResourceCountsRequest")({resourceTypes: S.optional(ResourceTypes), limit: S.optional(S.Number), nextToken: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetOrganizationCustomRulePolicyRequest extends S.Class<GetOrganizationCustomRulePolicyRequest>("GetOrganizationCustomRulePolicyRequest")({OrganizationConfigRuleName: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetResourceConfigHistoryRequest extends S.Class<GetResourceConfigHistoryRequest>("GetResourceConfigHistoryRequest")({resourceType: S.String, resourceId: S.String, laterTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), earlierTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), chronologicalOrder: S.optional(S.String), limit: S.optional(S.Number), nextToken: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetResourceEvaluationSummaryRequest extends S.Class<GetResourceEvaluationSummaryRequest>("GetResourceEvaluationSummaryRequest")({ResourceEvaluationId: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetStoredQueryRequest extends S.Class<GetStoredQueryRequest>("GetStoredQueryRequest")({QueryName: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class ListStoredQueriesRequest extends S.Class<ListStoredQueriesRequest>("ListStoredQueriesRequest")({NextToken: S.optional(S.String), MaxResults: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListTagsForResourceRequest extends S.Class<ListTagsForResourceRequest>("ListTagsForResourceRequest")({ResourceArn: S.String, Limit: S.optional(S.Number), NextToken: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class PutOrganizationConformancePackRequest extends S.Class<PutOrganizationConformancePackRequest>("PutOrganizationConformancePackRequest")({OrganizationConformancePackName: S.String, TemplateS3Uri: S.optional(S.String), TemplateBody: S.optional(S.String), DeliveryS3Bucket: S.optional(S.String), DeliveryS3KeyPrefix: S.optional(S.String), ConformancePackInputParameters: S.optional(ConformancePackInputParameters), ExcludedAccounts: S.optional(ExcludedAccounts)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutRemediationExceptionsRequest extends S.Class<PutRemediationExceptionsRequest>("PutRemediationExceptionsRequest")({ConfigRuleName: S.String, ResourceKeys: RemediationExceptionResourceKeys, Message: S.optional(S.String), ExpirationTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutRetentionConfigurationRequest extends S.Class<PutRetentionConfigurationRequest>("PutRetentionConfigurationRequest")({RetentionPeriodInDays: S.Number}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export const TagsList = S.Array(Tag);
export class PutServiceLinkedConfigurationRecorderRequest extends S.Class<PutServiceLinkedConfigurationRecorderRequest>("PutServiceLinkedConfigurationRecorderRequest")({ServicePrincipal: S.String, Tags: S.optional(TagsList)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class SelectAggregateResourceConfigRequest extends S.Class<SelectAggregateResourceConfigRequest>("SelectAggregateResourceConfigRequest")({Expression: S.String, ConfigurationAggregatorName: S.String, Limit: S.optional(S.Number), MaxResults: S.optional(S.Number), NextToken: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class SelectResourceConfigRequest extends S.Class<SelectResourceConfigRequest>("SelectResourceConfigRequest")({Expression: S.String, Limit: S.optional(S.Number), NextToken: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class StartConfigRulesEvaluationRequest extends S.Class<StartConfigRulesEvaluationRequest>("StartConfigRulesEvaluationRequest")({ConfigRuleNames: S.optional(ReevaluateConfigRuleNames)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class StartConfigRulesEvaluationResponse extends S.Class<StartConfigRulesEvaluationResponse>("StartConfigRulesEvaluationResponse")({}, ns) {}
export class StartConfigurationRecorderRequest extends S.Class<StartConfigurationRecorderRequest>("StartConfigurationRecorderRequest")({ConfigurationRecorderName: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class StartConfigurationRecorderResponse extends S.Class<StartConfigurationRecorderResponse>("StartConfigurationRecorderResponse")({}, ns) {}
export class StartRemediationExecutionRequest extends S.Class<StartRemediationExecutionRequest>("StartRemediationExecutionRequest")({ConfigRuleName: S.String, ResourceKeys: ResourceKeys}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class StopConfigurationRecorderRequest extends S.Class<StopConfigurationRecorderRequest>("StopConfigurationRecorderRequest")({ConfigurationRecorderName: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class StopConfigurationRecorderResponse extends S.Class<StopConfigurationRecorderResponse>("StopConfigurationRecorderResponse")({}, ns) {}
export class TagResourceRequest extends S.Class<TagResourceRequest>("TagResourceRequest")({ResourceArn: S.String, Tags: TagList}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class TagResourceResponse extends S.Class<TagResourceResponse>("TagResourceResponse")({}, ns) {}
export class UntagResourceRequest extends S.Class<UntagResourceRequest>("UntagResourceRequest")({ResourceArn: S.String, TagKeys: TagKeyList}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class Evaluation extends S.Class<Evaluation>("Evaluation")({ComplianceResourceType: S.String, ComplianceResourceId: S.String, ComplianceType: S.String, Annotation: S.optional(S.String), OrderingTimestamp: S.Date.pipe(T.TimestampFormat("epoch-seconds"))}) {}
export const Evaluations = S.Array(Evaluation);
export class ExternalEvaluation extends S.Class<ExternalEvaluation>("ExternalEvaluation")({ComplianceResourceType: S.String, ComplianceResourceId: S.String, ComplianceType: S.String, Annotation: S.optional(S.String), OrderingTimestamp: S.Date.pipe(T.TimestampFormat("epoch-seconds"))}) {}
...
export class AssociateResourceTypesResponse extends S.Class<AssociateResourceTypesResponse>("AssociateResourceTypesResponse")({ConfigurationRecorder: ConfigurationRecorder}, ns) {}
export class BatchGetAggregateResourceConfigRequest extends S.Class<BatchGetAggregateResourceConfigRequest>("BatchGetAggregateResourceConfigRequest")({ConfigurationAggregatorName: S.String, ResourceIdentifiers: ResourceIdentifiersList}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class BatchGetResourceConfigRequest extends S.Class<BatchGetResourceConfigRequest>("BatchGetResourceConfigRequest")({resourceKeys: ResourceKeys}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteRemediationExceptionsRequest extends S.Class<DeleteRemediationExceptionsRequest>("DeleteRemediationExceptionsRequest")({ConfigRuleName: S.String, ResourceKeys: RemediationExceptionResourceKeys}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteServiceLinkedConfigurationRecorderResponse extends S.Class<DeleteServiceLinkedConfigurationRecorderResponse>("DeleteServiceLinkedConfigurationRecorderResponse")({Arn: S.String, Name: S.String}, ns) {}
export class DeliverConfigSnapshotResponse extends S.Class<DeliverConfigSnapshotResponse>("DeliverConfigSnapshotResponse")({configSnapshotId: S.optional(S.String)}, ns) {}
...
export class DescribeConfigRulesRequest extends S.Class<DescribeConfigRulesRequest>("DescribeConfigRulesRequest")({ConfigRuleNames: S.optional(ConfigRuleNames), NextToken: S.optional(S.String), Filters: S.optional(DescribeConfigRulesFilters)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeConfigurationRecordersResponse extends S.Class<DescribeConfigurationRecordersResponse>("DescribeConfigurationRecordersResponse")({ConfigurationRecorders: S.optional(ConfigurationRecorderList)}, ns) {}
export class DescribeConformancePackComplianceRequest extends S.Class<DescribeConformancePackComplianceRequest>("DescribeConformancePackComplianceRequest")({ConformancePackName: S.String, Filters: S.optional(ConformancePackComplianceFilters), Limit: S.optional(S.Number), NextToken: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeDeliveryChannelsResponse extends S.Class<DescribeDeliveryChannelsResponse>("DescribeDeliveryChannelsResponse")({DeliveryChannels: S.optional(DeliveryChannelList)}, ns) {}
...
export class DescribeRemediationConfigurationsResponse extends S.Class<DescribeRemediationConfigurationsResponse>("DescribeRemediationConfigurationsResponse")({RemediationConfigurations: S.optional(RemediationConfigurations)}, ns) {}
export class DisassociateResourceTypesResponse extends S.Class<DisassociateResourceTypesResponse>("DisassociateResourceTypesResponse")({ConfigurationRecorder: ConfigurationRecorder}, ns) {}
...
export class EvaluationResultIdentifier extends S.Class<EvaluationResultIdentifier>("EvaluationResultIdentifier")({EvaluationResultQualifier: S.optional(EvaluationResultQualifier), OrderingTimestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), ResourceEvaluationId: S.optional(S.String)}) {}
export class EvaluationResult extends S.Class<EvaluationResult>("EvaluationResult")({EvaluationResultIdentifier: S.optional(EvaluationResultIdentifier), ComplianceType: S.optional(S.String), ResultRecordedTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), ConfigRuleInvokedTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), Annotation: S.optional(S.String), ResultToken: S.optional(S.String)}) {}
export const EvaluationResults = S.Array(EvaluationResult);
export class GetComplianceDetailsByResourceResponse extends S.Class<GetComplianceDetailsByResourceResponse>("GetComplianceDetailsByResourceResponse")({EvaluationResults: S.optional(EvaluationResults), NextToken: S.optional(S.String)}, ns) {}
export class GetConformancePackComplianceDetailsRequest extends S.Class<GetConformancePackComplianceDetailsRequest>("GetConformancePackComplianceDetailsRequest")({ConformancePackName: S.String, Filters: S.optional(ConformancePackEvaluationFilters), Limit: S.optional(S.Number), NextToken: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetCustomRulePolicyResponse extends S.Class<GetCustomRulePolicyResponse>("GetCustomRulePolicyResponse")({PolicyText: S.optional(S.String)}, ns) {}
export class GetOrganizationConfigRuleDetailedStatusRequest extends S.Class<GetOrganizationConfigRuleDetailedStatusRequest>("GetOrganizationConfigRuleDetailedStatusRequest")({OrganizationConfigRuleName: S.String, Filters: S.optional(StatusDetailFilters), Limit: S.optional(S.Number), NextToken: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class GetOrganizationCustomRulePolicyResponse extends S.Class<GetOrganizationCustomRulePolicyResponse>("GetOrganizationCustomRulePolicyResponse")({PolicyText: S.optional(S.String)}, ns) {}
export class GetResourceConfigHistoryResponse extends S.Class<GetResourceConfigHistoryResponse>("GetResourceConfigHistoryResponse")({configurationItems: S.optional(ConfigurationItemList), nextToken: S.optional(S.String)}, ns) {}
export class GetStoredQueryResponse extends S.Class<GetStoredQueryResponse>("GetStoredQueryResponse")({StoredQuery: S.optional(StoredQuery)}, ns) {}
export class ListAggregateDiscoveredResourcesRequest extends S.Class<ListAggregateDiscoveredResourcesRequest>("ListAggregateDiscoveredResourcesRequest")({ConfigurationAggregatorName: S.String, ResourceType: S.String, Filters: S.optional(ResourceFilters), Limit: S.optional(S.Number), NextToken: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListConfigurationRecordersRequest extends S.Class<ListConfigurationRecordersRequest>("ListConfigurationRecordersRequest")({Filters: S.optional(ConfigurationRecorderFilterList), MaxResults: S.optional(S.Number), NextToken: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class ListTagsForResourceResponse extends S.Class<ListTagsForResourceResponse>("ListTagsForResourceResponse")({Tags: S.optional(TagList), NextToken: S.optional(S.String)}, ns) {}
export class PutAggregationAuthorizationRequest extends S.Class<PutAggregationAuthorizationRequest>("PutAggregationAuthorizationRequest")({AuthorizedAccountId: S.String, AuthorizedAwsRegion: S.String, Tags: S.optional(TagsList)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class PutEvaluationsRequest extends S.Class<PutEvaluationsRequest>("PutEvaluationsRequest")({Evaluations: S.optional(Evaluations), ResultToken: S.String, TestMode: S.optional(S.Boolean)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutExternalEvaluationRequest extends S.Class<PutExternalEvaluationRequest>("PutExternalEvaluationRequest")({ConfigRuleName: S.String, ExternalEvaluation: ExternalEvaluation}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutExternalEvaluationResponse extends S.Class<PutExternalEvaluationResponse>("PutExternalEvaluationResponse")({}, ns) {}
export class PutOrganizationConfigRuleRequest extends S.Class<PutOrganizationConfigRuleRequest>("PutOrganizationConfigRuleRequest")({OrganizationConfigRuleName: S.String, OrganizationManagedRuleMetadata: S.optional(OrganizationManagedRuleMetadata), OrganizationCustomRuleMetadata: S.optional(OrganizationCustomRuleMetadata), ExcludedAccounts: S.optional(ExcludedAccounts), OrganizationCustomPolicyRuleMetadata: S.optional(OrganizationCustomPolicyRuleMetadata)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutOrganizationConformancePackResponse extends S.Class<PutOrganizationConformancePackResponse>("PutOrganizationConformancePackResponse")({OrganizationConformancePackArn: S.optional(S.String)}, ns) {}
export class PutResourceConfigRequest extends S.Class<PutResourceConfigRequest>("PutResourceConfigRequest")({ResourceType: S.String, SchemaVersionId: S.String, ResourceId: S.String, ResourceName: S.optional(S.String), Configuration: S.String, Tags: S.optional(Tags)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutResourceConfigResponse extends S.Class<PutResourceConfigResponse>("PutResourceConfigResponse")({}, ns) {}
...
export class PutRetentionConfigurationResponse extends S.Class<PutRetentionConfigurationResponse>("PutRetentionConfigurationResponse")({RetentionConfiguration: S.optional(RetentionConfiguration)}, ns) {}
export class PutServiceLinkedConfigurationRecorderResponse extends S.Class<PutServiceLinkedConfigurationRecorderResponse>("PutServiceLinkedConfigurationRecorderResponse")({Arn: S.optional(S.String), Name: S.optional(S.String)}, ns) {}
export class PutStoredQueryRequest extends S.Class<PutStoredQueryRequest>("PutStoredQueryRequest")({StoredQuery: StoredQuery, Tags: S.optional(TagsList)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class SelectResourceConfigResponse extends S.Class<SelectResourceConfigResponse>("SelectResourceConfigResponse")({Results: S.optional(Results), QueryInfo: S.optional(QueryInfo), NextToken: S.optional(S.String)}, ns) {}
export class StartRemediationExecutionResponse extends S.Class<StartRemediationExecutionResponse>("StartRemediationExecutionResponse")({FailureMessage: S.optional(S.String), FailedItems: S.optional(ResourceKeys)}, ns) {}
export class StartResourceEvaluationRequest extends S.Class<StartResourceEvaluationRequest>("StartResourceEvaluationRequest")({ResourceDetails: ResourceDetails, EvaluationContext: S.optional(EvaluationContext), EvaluationMode: S.String, EvaluationTimeout: S.optional(S.Number), ClientToken: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class TimeWindow extends S.Class<TimeWindow>("TimeWindow")({StartTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), EndTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
...
export class AggregationAuthorization extends S.Class<AggregationAuthorization>("AggregationAuthorization")({AggregationAuthorizationArn: S.optional(S.String), AuthorizedAccountId: S.optional(S.String), AuthorizedAwsRegion: S.optional(S.String), CreationTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
...
export class ConfigRuleEvaluationStatus extends S.Class<ConfigRuleEvaluationStatus>("ConfigRuleEvaluationStatus")({ConfigRuleName: S.optional(S.String), ConfigRuleArn: S.optional(S.String), ConfigRuleId: S.optional(S.String), LastSuccessfulInvocationTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), LastFailedInvocationTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), LastSuccessfulEvaluationTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), LastFailedEvaluationTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), FirstActivatedTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), LastDeactivatedTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), LastErrorCode: S.optional(S.String), LastErrorMessage: S.optional(S.String), FirstEvaluationStarted: S.optional(S.Boolean), LastDebugLogDeliveryStatus: S.optional(S.String), LastDebugLogDeliveryStatusReason: S.optional(S.String), LastDebugLogDeliveryTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
...
export class ConfigurationRecorderStatus extends S.Class<ConfigurationRecorderStatus>("ConfigurationRecorderStatus")({arn: S.optional(S.String), name: S.optional(S.String), lastStartTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), lastStopTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), recording: S.optional(S.Boolean), lastStatus: S.optional(S.String), lastErrorCode: S.optional(S.String), lastErrorMessage: S.optional(S.String), lastStatusChangeTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), servicePrincipal: S.optional(S.String)}) {}
...
export class OrganizationConformancePackStatus extends S.Class<OrganizationConformancePackStatus>("OrganizationConformancePackStatus")({OrganizationConformancePackName: S.String, Status: S.String, ErrorCode: S.optional(S.String), ErrorMessage: S.optional(S.String), LastUpdateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
...
export class RemediationException extends S.Class<RemediationException>("RemediationException")({ConfigRuleName: S.String, ResourceType: S.String, ResourceId: S.String, Message: S.optional(S.String), ExpirationTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
...
export class ComplianceSummary extends S.Class<ComplianceSummary>("ComplianceSummary")({CompliantResourceCount: S.optional(ComplianceContributorCount), NonCompliantResourceCount: S.optional(ComplianceContributorCount), ComplianceSummaryTimestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
...
export class ResourceIdentifier extends S.Class<ResourceIdentifier>("ResourceIdentifier")({resourceType: S.optional(S.String), resourceId: S.optional(S.String), resourceName: S.optional(S.String), resourceDeletionTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
...
export class BaseConfigurationItem extends S.Class<BaseConfigurationItem>("BaseConfigurationItem")({version: S.optional(S.String), accountId: S.optional(S.String), configurationItemCaptureTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), configurationItemStatus: S.optional(S.String), configurationStateId: S.optional(S.String), arn: S.optional(S.String), resourceType: S.optional(S.String), resourceId: S.optional(S.String), resourceName: S.optional(S.String), awsRegion: S.optional(S.String), availabilityZone: S.optional(S.String), resourceCreationTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), configuration: S.optional(S.String), supplementaryConfiguration: S.optional(SupplementaryConfiguration), recordingFrequency: S.optional(S.String), configurationItemDeliveryTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
export const BaseConfigurationItems = S.Array(BaseConfigurationItem);
export class BatchGetResourceConfigResponse extends S.Class<BatchGetResourceConfigResponse>("BatchGetResourceConfigResponse")({baseConfigurationItems: S.optional(BaseConfigurationItems), unprocessedResourceKeys: S.optional(ResourceKeys)}, ns) {}
export class DescribeAggregationAuthorizationsResponse extends S.Class<DescribeAggregationAuthorizationsResponse>("DescribeAggregationAuthorizationsResponse")({AggregationAuthorizations: S.optional(AggregationAuthorizationList), NextToken: S.optional(S.String)}, ns) {}
export class DescribeComplianceByResourceResponse extends S.Class<DescribeComplianceByResourceResponse>("DescribeComplianceByResourceResponse")({ComplianceByResources: S.optional(ComplianceByResources), NextToken: S.optional(S.String)}, ns) {}
export class DescribeConfigRuleEvaluationStatusResponse extends S.Class<DescribeConfigRuleEvaluationStatusResponse>("DescribeConfigRuleEvaluationStatusResponse")({ConfigRulesEvaluationStatus: S.optional(ConfigRuleEvaluationStatusList), NextToken: S.optional(S.String)}, ns) {}
export class DescribeConfigRulesResponse extends S.Class<DescribeConfigRulesResponse>("DescribeConfigRulesResponse")({ConfigRules: S.optional(ConfigRules), NextToken: S.optional(S.String)}, ns) {}
export class DescribeConfigurationAggregatorsResponse extends S.Class<DescribeConfigurationAggregatorsResponse>("DescribeConfigurationAggregatorsResponse")({ConfigurationAggregators: S.optional(ConfigurationAggregatorList), NextToken: S.optional(S.String)}, ns) {}
export class DescribeConfigurationAggregatorSourcesStatusResponse extends S.Class<DescribeConfigurationAggregatorSourcesStatusResponse>("DescribeConfigurationAggregatorSourcesStatusResponse")({AggregatedSourceStatusList: S.optional(AggregatedSourceStatusList), NextToken: S.optional(S.String)}, ns) {}
export class DescribeConfigurationRecorderStatusResponse extends S.Class<DescribeConfigurationRecorderStatusResponse>("DescribeConfigurationRecorderStatusResponse")({ConfigurationRecordersStatus: S.optional(ConfigurationRecorderStatusList)}, ns) {}
export class DescribeConformancePacksResponse extends S.Class<DescribeConformancePacksResponse>("DescribeConformancePacksResponse")({ConformancePackDetails: S.optional(ConformancePackDetailList), NextToken: S.optional(S.String)}, ns) {}
export class DescribeConformancePackStatusResponse extends S.Class<DescribeConformancePackStatusResponse>("DescribeConformancePackStatusResponse")({ConformancePackStatusDetails: S.optional(ConformancePackStatusDetailsList), NextToken: S.optional(S.String)}, ns) {}
export class DescribeOrganizationConfigRuleStatusesResponse extends S.Class<DescribeOrganizationConfigRuleStatusesResponse>("DescribeOrganizationConfigRuleStatusesResponse")({OrganizationConfigRuleStatuses: S.optional(OrganizationConfigRuleStatuses), NextToken: S.optional(S.String)}, ns) {}
export class DescribeOrganizationConformancePacksResponse extends S.Class<DescribeOrganizationConformancePacksResponse>("DescribeOrganizationConformancePacksResponse")({OrganizationConformancePacks: S.optional(OrganizationConformancePacks), NextToken: S.optional(S.String)}, ns) {}
export class DescribeOrganizationConformancePackStatusesResponse extends S.Class<DescribeOrganizationConformancePackStatusesResponse>("DescribeOrganizationConformancePackStatusesResponse")({OrganizationConformancePackStatuses: S.optional(OrganizationConformancePackStatuses), NextToken: S.optional(S.String)}, ns) {}
export class DescribePendingAggregationRequestsResponse extends S.Class<DescribePendingAggregationRequestsResponse>("DescribePendingAggregationRequestsResponse")({PendingAggregationRequests: S.optional(PendingAggregationRequestList), NextToken: S.optional(S.String)}, ns) {}
export class DescribeRemediationExceptionsResponse extends S.Class<DescribeRemediationExceptionsResponse>("DescribeRemediationExceptionsResponse")({RemediationExceptions: S.optional(RemediationExceptions), NextToken: S.optional(S.String)}, ns) {}
export class DescribeRetentionConfigurationsResponse extends S.Class<DescribeRetentionConfigurationsResponse>("DescribeRetentionConfigurationsResponse")({RetentionConfigurations: S.optional(RetentionConfigurationList), NextToken: S.optional(S.String)}, ns) {}
export class GetComplianceDetailsByConfigRuleResponse extends S.Class<GetComplianceDetailsByConfigRuleResponse>("GetComplianceDetailsByConfigRuleResponse")({EvaluationResults: S.optional(EvaluationResults), NextToken: S.optional(S.String)}, ns) {}
export class GetComplianceSummaryByConfigRuleResponse extends S.Class<GetComplianceSummaryByConfigRuleResponse>("GetComplianceSummaryByConfigRuleResponse")({ComplianceSummary: S.optional(ComplianceSummary)}, ns) {}
export class GetComplianceSummaryByResourceTypeResponse extends S.Class<GetComplianceSummaryByResourceTypeResponse>("GetComplianceSummaryByResourceTypeResponse")({ComplianceSummariesByResourceType: S.optional(ComplianceSummariesByResourceType)}, ns) {}
export class GetConformancePackComplianceSummaryResponse extends S.Class<GetConformancePackComplianceSummaryResponse>("GetConformancePackComplianceSummaryResponse")({ConformancePackComplianceSummaryList: S.optional(ConformancePackComplianceSummaryList), NextToken: S.optional(S.String)}, ns) {}
export class GetDiscoveredResourceCountsResponse extends S.Class<GetDiscoveredResourceCountsResponse>("GetDiscoveredResourceCountsResponse")({totalDiscoveredResources: S.optional(S.Number), resourceCounts: S.optional(ResourceCounts), nextToken: S.optional(S.String)}, ns) {}
export class GetResourceEvaluationSummaryResponse extends S.Class<GetResourceEvaluationSummaryResponse>("GetResourceEvaluationSummaryResponse")({ResourceEvaluationId: S.optional(S.String), EvaluationMode: S.optional(S.String), EvaluationStatus: S.optional(EvaluationStatus), EvaluationStartTimestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), Compliance: S.optional(S.String), EvaluationContext: S.optional(EvaluationContext), ResourceDetails: S.optional(ResourceDetails)}, ns) {}
export class ListAggregateDiscoveredResourcesResponse extends S.Class<ListAggregateDiscoveredResourcesResponse>("ListAggregateDiscoveredResourcesResponse")({ResourceIdentifiers: S.optional(DiscoveredResourceIdentifierList), NextToken: S.optional(S.String)}, ns) {}
export class ListDiscoveredResourcesResponse extends S.Class<ListDiscoveredResourcesResponse>("ListDiscoveredResourcesResponse")({resourceIdentifiers: S.optional(ResourceIdentifierList), nextToken: S.optional(S.String)}, ns) {}
export class ListResourceEvaluationsRequest extends S.Class<ListResourceEvaluationsRequest>("ListResourceEvaluationsRequest")({Filters: S.optional(ResourceEvaluationFilters), Limit: S.optional(S.Number), NextToken: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListStoredQueriesResponse extends S.Class<ListStoredQueriesResponse>("ListStoredQueriesResponse")({StoredQueryMetadata: S.optional(StoredQueryMetadataList), NextToken: S.optional(S.String)}, ns) {}
export class PutAggregationAuthorizationResponse extends S.Class<PutAggregationAuthorizationResponse>("PutAggregationAuthorizationResponse")({AggregationAuthorization: S.optional(AggregationAuthorization)}, ns) {}
export class PutConfigurationAggregatorRequest extends S.Class<PutConfigurationAggregatorRequest>("PutConfigurationAggregatorRequest")({ConfigurationAggregatorName: S.String, AccountAggregationSources: S.optional(AccountAggregationSourceList), OrganizationAggregationSource: S.optional(OrganizationAggregationSource), Tags: S.optional(TagsList), AggregatorFilters: S.optional(AggregatorFilters)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutConformancePackResponse extends S.Class<PutConformancePackResponse>("PutConformancePackResponse")({ConformancePackArn: S.optional(S.String)}, ns) {}
export class PutDeliveryChannelRequest extends S.Class<PutDeliveryChannelRequest>("PutDeliveryChannelRequest")({DeliveryChannel: DeliveryChannel}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutDeliveryChannelResponse extends S.Class<PutDeliveryChannelResponse>("PutDeliveryChannelResponse")({}, ns) {}
export class PutEvaluationsResponse extends S.Class<PutEvaluationsResponse>("PutEvaluationsResponse")({FailedEvaluations: S.optional(Evaluations)}, ns) {}
export class PutOrganizationConfigRuleResponse extends S.Class<PutOrganizationConfigRuleResponse>("PutOrganizationConfigRuleResponse")({OrganizationConfigRuleArn: S.optional(S.String)}, ns) {}
export class PutRemediationExceptionsResponse extends S.Class<PutRemediationExceptionsResponse>("PutRemediationExceptionsResponse")({FailedBatches: S.optional(FailedRemediationExceptionBatches)}, ns) {}
export class PutStoredQueryResponse extends S.Class<PutStoredQueryResponse>("PutStoredQueryResponse")({QueryArn: S.optional(S.String)}, ns) {}
export class StartResourceEvaluationResponse extends S.Class<StartResourceEvaluationResponse>("StartResourceEvaluationResponse")({ResourceEvaluationId: S.optional(S.String)}, ns) {}
export const ControlsList = S.Array(S.String);
export class ConfigExportDeliveryInfo extends S.Class<ConfigExportDeliveryInfo>("ConfigExportDeliveryInfo")({lastStatus: S.optional(S.String), lastErrorCode: S.optional(S.String), lastErrorMessage: S.optional(S.String), lastAttemptTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), lastSuccessfulTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), nextDeliveryTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
export class ConfigStreamDeliveryInfo extends S.Class<ConfigStreamDeliveryInfo>("ConfigStreamDeliveryInfo")({lastStatus: S.optional(S.String), lastErrorCode: S.optional(S.String), lastErrorMessage: S.optional(S.String), lastStatusChangeTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
...
export class RemediationExecutionStep extends S.Class<RemediationExecutionStep>("RemediationExecutionStep")({Name: S.optional(S.String), State: S.optional(S.String), ErrorMessage: S.optional(S.String), StartTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), StopTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
...
export class ConformancePackEvaluationResult extends S.Class<ConformancePackEvaluationResult>("ConformancePackEvaluationResult")({ComplianceType: S.String, EvaluationResultIdentifier: EvaluationResultIdentifier, ConfigRuleInvokedTime: S.Date.pipe(T.TimestampFormat("epoch-seconds")), ResultRecordedTime: S.Date.pipe(T.TimestampFormat("epoch-seconds")), Annotation: S.optional(S.String)}) {}
export const ConformancePackRuleEvaluationResultsList = S.Array(ConformancePackEvaluationResult);
export class MemberAccountStatus extends S.Class<MemberAccountStatus>("MemberAccountStatus")({AccountId: S.String, ConfigRuleName: S.String, MemberAccountRuleStatus: S.String, ErrorCode: S.optional(S.String), ErrorMessage: S.optional(S.String), LastUpdateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
...
export class ConformancePackComplianceScore extends S.Class<ConformancePackComplianceScore>("ConformancePackComplianceScore")({Score: S.optional(S.String), ConformancePackName: S.optional(S.String), LastUpdatedTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
export const ConformancePackComplianceScores = S.Array(ConformancePackComplianceScore);
export class BatchGetAggregateResourceConfigResponse extends S.Class<BatchGetAggregateResourceConfigResponse>("BatchGetAggregateResourceConfigResponse")({BaseConfigurationItems: S.optional(BaseConfigurationItems), UnprocessedResourceIdentifiers: S.optional(UnprocessedResourceIdentifierList)}, ns) {}
export class DeleteRemediationExceptionsResponse extends S.Class<DeleteRemediationExceptionsResponse>("DeleteRemediationExceptionsResponse")({FailedBatches: S.optional(FailedDeleteRemediationExceptionsBatches)}, ns) {}
export class DescribeAggregateComplianceByConfigRulesResponse extends S.Class<DescribeAggregateComplianceByConfigRulesResponse>("DescribeAggregateComplianceByConfigRulesResponse")({AggregateComplianceByConfigRules: S.optional(AggregateComplianceByConfigRuleList), NextToken: S.optional(S.String)}, ns) {}
export class DescribeComplianceByConfigRuleResponse extends S.Class<DescribeComplianceByConfigRuleResponse>("DescribeComplianceByConfigRuleResponse")({ComplianceByConfigRules: S.optional(ComplianceByConfigRules), NextToken: S.optional(S.String)}, ns) {}
export class DescribeConformancePackComplianceResponse extends S.Class<DescribeConformancePackComplianceResponse>("DescribeConformancePackComplianceResponse")({ConformancePackName: S.String, ConformancePackRuleComplianceList: ConformancePackRuleComplianceList, NextToken: S.optional(S.String)}, ns) {}
export class DescribeDeliveryChannelStatusResponse extends S.Class<DescribeDeliveryChannelStatusResponse>("DescribeDeliveryChannelStatusResponse")({DeliveryChannelsStatus: S.optional(DeliveryChannelStatusList)}, ns) {}
export class DescribeOrganizationConfigRulesResponse extends S.Class<DescribeOrganizationConfigRulesResponse>("DescribeOrganizationConfigRulesResponse")({OrganizationConfigRules: S.optional(OrganizationConfigRules), NextToken: S.optional(S.String)}, ns) {}
export class DescribeRemediationExecutionStatusResponse extends S.Class<DescribeRemediationExecutionStatusResponse>("DescribeRemediationExecutionStatusResponse")({RemediationExecutionStatuses: S.optional(RemediationExecutionStatuses), NextToken: S.optional(S.String)}, ns) {}
export class GetAggregateConfigRuleComplianceSummaryResponse extends S.Class<GetAggregateConfigRuleComplianceSummaryResponse>("GetAggregateConfigRuleComplianceSummaryResponse")({GroupByKey: S.optional(S.String), AggregateComplianceCounts: S.optional(AggregateComplianceCountList), NextToken: S.optional(S.String)}, ns) {}
...
export class GetAggregateResourceConfigResponse extends S.Class<GetAggregateResourceConfigResponse>("GetAggregateResourceConfigResponse")({ConfigurationItem: S.optional(ConfigurationItem)}, ns) {}
...
export class GetOrganizationConfigRuleDetailedStatusResponse extends S.Class<GetOrganizationConfigRuleDetailedStatusResponse>("GetOrganizationConfigRuleDetailedStatusResponse")({OrganizationConfigRuleDetailedStatus: S.optional(OrganizationConfigRuleDetailedStatus), NextToken: S.optional(S.String)}, ns) {}
...
export class ListConfigurationRecordersResponse extends S.Class<ListConfigurationRecordersResponse>("ListConfigurationRecordersResponse")({ConfigurationRecorderSummaries: ConfigurationRecorderSummaries, NextToken: S.optional(S.String)}, ns) {}
export class ListConformancePackComplianceScoresResponse extends S.Class<ListConformancePackComplianceScoresResponse>("ListConformancePackComplianceScoresResponse")({NextToken: S.optional(S.String), ConformancePackComplianceScores: ConformancePackComplianceScores}, ns) {}
export class PutConfigRuleRequest extends S.Class<PutConfigRuleRequest>("PutConfigRuleRequest")({ConfigRule: ConfigRule, Tags: S.optional(TagsList)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutConfigRuleResponse extends S.Class<PutConfigRuleResponse>("PutConfigRuleResponse")({}, ns) {}
export class PutConfigurationAggregatorResponse extends S.Class<PutConfigurationAggregatorResponse>("PutConfigurationAggregatorResponse")({ConfigurationAggregator: S.optional(ConfigurationAggregator)}, ns) {}
export class PutConfigurationRecorderRequest extends S.Class<PutConfigurationRecorderRequest>("PutConfigurationRecorderRequest")({ConfigurationRecorder: ConfigurationRecorder, Tags: S.optional(TagsList)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutConfigurationRecorderResponse extends S.Class<PutConfigurationRecorderResponse>("PutConfigurationRecorderResponse")({}, ns) {}
export class SelectAggregateResourceConfigResponse extends S.Class<SelectAggregateResourceConfigResponse>("SelectAggregateResourceConfigResponse")({Results: S.optional(Results), QueryInfo: S.optional(QueryInfo), NextToken: S.optional(S.String)}, ns) {}
...
export class ResourceEvaluation extends S.Class<ResourceEvaluation>("ResourceEvaluation")({ResourceEvaluationId: S.optional(S.String), EvaluationMode: S.optional(S.String), EvaluationStartTimestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
...
export class GetAggregateComplianceDetailsByConfigRuleResponse extends S.Class<GetAggregateComplianceDetailsByConfigRuleResponse>("GetAggregateComplianceDetailsByConfigRuleResponse")({AggregateEvaluationResults: S.optional(AggregateEvaluationResultList), NextToken: S.optional(S.String)}, ns) {}
...
export class ListResourceEvaluationsResponse extends S.Class<ListResourceEvaluationsResponse>("ListResourceEvaluationsResponse")({ResourceEvaluations: S.optional(ResourceEvaluations), NextToken: S.optional(S.String)}, ns) {}
export class PutRemediationConfigurationsRequest extends S.Class<PutRemediationConfigurationsRequest>("PutRemediationConfigurationsRequest")({RemediationConfigurations: RemediationConfigurations}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class PutRemediationConfigurationsResponse extends S.Class<PutRemediationConfigurationsResponse>("PutRemediationConfigurationsResponse")({FailedBatches: S.optional(FailedRemediationBatches)}, ns) {}
...
export class NoSuchConfigRuleException extends S.TaggedError<NoSuchConfigRuleException>()("NoSuchConfigRuleException", {message: S.optional(S.String)}) {}
...
export class NoSuchConfigurationRecorderException extends S.TaggedError<NoSuchConfigurationRecorderException>()("NoSuchConfigurationRecorderException", {message: S.optional(S.String)}) {}
...
export class UnmodifiableEntityException extends S.TaggedError<UnmodifiableEntityException>()("UnmodifiableEntityException", {message: S.optional(S.String)}) {}
export class NoSuchDeliveryChannelException extends S.TaggedError<NoSuchDeliveryChannelException>()("NoSuchDeliveryChannelException", {message: S.optional(S.String)}) {}
export class OrganizationAccessDeniedException extends S.TaggedError<OrganizationAccessDeniedException>()("OrganizationAccessDeniedException", {message: S.optional(S.String)}) {}
export class NoSuchRemediationConfigurationException extends S.TaggedError<NoSuchRemediationConfigurationException>()("NoSuchRemediationConfigurationException", {message: S.optional(S.String)}) {}
...
export class NoAvailableConfigurationRecorderException extends S.TaggedError<NoAvailableConfigurationRecorderException>()("NoAvailableConfigurationRecorderException", {message: S.optional(S.String)}) {}
export class InvalidLimitException extends S.TaggedError<InvalidLimitException>()("InvalidLimitException", {message: S.optional(S.String)}) {}
...
export class NoAvailableOrganizationException extends S.TaggedError<NoAvailableOrganizationException>()("NoAvailableOrganizationException", {message: S.optional(S.String)}) {}
...
export class NoSuchConfigRuleInConformancePackException extends S.TaggedError<NoSuchConfigRuleInConformancePackException>()("NoSuchConfigRuleInConformancePackException", {message: S.optional(S.String)}) {}
...
export class OrganizationAllFeaturesNotEnabledException extends S.TaggedError<OrganizationAllFeaturesNotEnabledException>()("OrganizationAllFeaturesNotEnabledException", {message: S.optional(S.String)}) {}
...
export class ResourceNotDiscoveredException extends S.TaggedError<ResourceNotDiscoveredException>()("ResourceNotDiscoveredException", {message: S.optional(S.String)}) {}
 ...
 */
export const deleteAggregationAuthorization = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteAggregationAuthorizationRequest, output: DeleteAggregationAuthorizationResponse, errors: [InvalidParameterValueException] }));
/**
 * Deletes the specified configuration aggregator and the
 * aggregated data associated with the aggregator.
 */
export const deleteConfigurationAggregator = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteConfigurationAggregatorRequest, output: DeleteConfigurationAggregatorResponse, errors: [NoSuchConfigurationAggregatorException] }));
/**
 * Returns the details of one or more remediation configurations.
 */
export const describeRemediationConfigurations = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeRemediationConfigurationsRequest, output: DescribeRemediationConfigurationsResponse, errors: [] }));
/**
 ...
 */
export const getComplianceDetailsByResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetComplianceDetailsByResourceRequest, output: GetComplianceDetailsByResourceResponse, errors: [InvalidParameterValueException] }));
/**
 * Returns the policy definition containing the logic for your Config Custom Policy rule.
 */
export const getCustomRulePolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetCustomRulePolicyRequest, output: GetCustomRulePolicyResponse, errors: [NoSuchConfigRuleException] }));
/**
 * Add or updates the evaluations for process checks.
 * This API checks if the rule is a process check when the name of the Config rule is provided.
 */
export const putExternalEvaluation = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutExternalEvaluationRequest, output: PutExternalEvaluationResponse, errors: [InvalidParameterValueException, NoSuchConfigRuleException] }));
/**
 * Deletes pending authorization requests for a specified
 * aggregator account in a specified region.
 */
export const deletePendingAggregationRequest = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeletePendingAggregationRequestRequest, output: DeletePendingAggregationRequestResponse, errors: [InvalidParameterValueException] }));
/**
 ...
 */
export const deleteConfigRule = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteConfigRuleRequest, output: DeleteConfigRuleResponse, errors: [NoSuchConfigRuleException, ResourceInUseException] }));
/**
 ...
 */
export const deleteConfigurationRecorder = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteConfigurationRecorderRequest, output: DeleteConfigurationRecorderResponse, errors: [NoSuchConfigurationRecorderException, UnmodifiableEntityException] }));
/**
 ...
 */
export const deleteDeliveryChannel = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteDeliveryChannelRequest, output: DeleteDeliveryChannelResponse, errors: [LastDeliveryChannelDeleteFailedException, NoSuchDeliveryChannelException] }));
/**
 ...
 * when recording is disabled for `AWS::Config::ResourceCompliance`, rule evaluations will not be recorded in the associated resource’s history.
 */
export const deleteOrganizationConfigRule = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteOrganizationConfigRuleRequest, output: DeleteOrganizationConfigRuleResponse, errors: [NoSuchOrganizationConfigRuleException, OrganizationAccessDeniedException, ResourceInUseException] }));
/**
 * Records the configuration state for a custom resource that has been deleted. This API records a new ConfigurationItem with a ResourceDeleted status. You can retrieve the ConfigurationItems recorded for this resource in your Config History.
 */
export const deleteResourceConfig = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteResourceConfigRequest, output: DeleteResourceConfigResponse, errors: [NoRunningConfigurationRecorderException, ValidationException] }));
/**
 ...
 * failed.
 */
export const deliverConfigSnapshot = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeliverConfigSnapshotRequest, output: DeliverConfigSnapshotResponse, errors: [NoAvailableConfigurationRecorderException, NoRunningConfigurationRecorderException, NoSuchDeliveryChannelException] }));
/**
 ...
 */
export const describeConfigurationRecorderStatus = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeConfigurationRecorderStatusRequest, output: DescribeConfigurationRecorderStatusResponse, errors: [NoSuchConfigurationRecorderException, ValidationException] }));
/**
 * Returns the number of Config rules that are compliant and
 * noncompliant, up to a maximum of 25 for each.
 */
export const getComplianceSummaryByConfigRule = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetComplianceSummaryByConfigRuleRequest, output: GetComplianceSummaryByConfigRuleResponse, errors: [] }));
/**
 ...
 */
export const getComplianceSummaryByResourceType = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetComplianceSummaryByResourceTypeRequest, output: GetComplianceSummaryByResourceTypeResponse, errors: [InvalidParameterValueException] }));
/**
 ...
 */
export const getResourceEvaluationSummary = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetResourceEvaluationSummaryRequest, output: GetResourceEvaluationSummaryResponse, errors: [ResourceNotFoundException] }));
/**
 ...
 */
export const putAggregationAuthorization = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutAggregationAuthorizationRequest, output: PutAggregationAuthorizationResponse, errors: [InvalidParameterValueException] }));
/**
 ...
 */
export const putRemediationExceptions = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutRemediationExceptionsRequest, output: PutRemediationExceptionsResponse, errors: [InsufficientPermissionsException, InvalidParameterValueException] }));
/**
 ...
 */
export const putResourceConfig = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutResourceConfigRequest, output: PutResourceConfigResponse, errors: [InsufficientPermissionsException, MaxActiveResourcesExceededException, NoRunningConfigurationRecorderException, ValidationException] }));
/**
 ...
 */
export const putRetentionConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutRetentionConfigurationRequest, output: PutRetentionConfigurationResponse, errors: [InvalidParameterValueException, MaxNumberOfRetentionConfigurationsExceededException] }));
/**
 ...
 */
export const deleteServiceLinkedConfigurationRecorder = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteServiceLinkedConfigurationRecorderRequest, output: DeleteServiceLinkedConfigurationRecorderResponse, errors: [ConflictException, NoSuchConfigurationRecorderException, ValidationException] }));
/**
 ...
 */
export const disassociateResourceTypes = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DisassociateResourceTypesRequest, output: DisassociateResourceTypesResponse, errors: [ConflictException, NoSuchConfigurationRecorderException, ValidationException] }));
/**
 * Deletes the retention configuration.
 */
export const deleteRetentionConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteRetentionConfigurationRequest, output: DeleteRetentionConfigurationResponse, errors: [InvalidParameterValueException, NoSuchRetentionConfigurationException] }));
/**
 ...
 * every 24 hours.
 */
export const startConfigRulesEvaluation = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StartConfigRulesEvaluationRequest, output: StartConfigRulesEvaluationResponse, errors: [InvalidParameterValueException, LimitExceededException, NoSuchConfigRuleException, ResourceInUseException] }));
/**
 ...
 * when recording is disabled for `AWS::Config::ResourceCompliance`, rule evaluations will not be recorded in the associated resource’s history.
 */
export const deleteConformancePack = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteConformancePackRequest, output: DeleteConformancePackResponse, errors: [NoSuchConformancePackException, ResourceInUseException] }));
/**
 ...
 */
export const deleteEvaluationResults = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteEvaluationResultsRequest, output: DeleteEvaluationResultsResponse, errors: [NoSuchConfigRuleException, ResourceInUseException] }));
/**
 ...
 */
export const startConfigurationRecorder = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StartConfigurationRecorderRequest, output: StartConfigurationRecorderResponse, errors: [NoAvailableDeliveryChannelException, NoSuchConfigurationRecorderException, UnmodifiableEntityException] }));
/**
 ...
 */
export const stopConfigurationRecorder = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StopConfigurationRecorderRequest, output: StopConfigurationRecorderResponse, errors: [NoSuchConfigurationRecorderException, UnmodifiableEntityException] }));
/**
 ...
 */
export const describeDeliveryChannels = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeDeliveryChannelsRequest, output: DescribeDeliveryChannelsResponse, errors: [NoSuchDeliveryChannelException] }));
/**
 ...
 * when recording is disabled for `AWS::Config::ResourceCompliance`, rule evaluations will not be recorded in the associated resource’s history.
 */
export const deleteOrganizationConformancePack = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteOrganizationConformancePackRequest, output: DeleteOrganizationConformancePackResponse, errors: [NoSuchOrganizationConformancePackException, OrganizationAccessDeniedException, ResourceInUseException] }));
/**
 * Returns the policy definition containing the logic for your organization Config Custom Policy rule.
 */
export const getOrganizationCustomRulePolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetOrganizationCustomRulePolicyRequest, output: GetOrganizationCustomRulePolicyResponse, errors: [NoSuchOrganizationConfigRuleException, OrganizationAccessDeniedException] }));
/**
 * Runs an on-demand remediation for the specified Config rules against the last known remediation configuration. It runs an execution against the current state of your resources. Remediation execution is asynchronous.
 * 
 * You can specify up to 100 resource keys per request. An existing StartRemediationExecution call for the specified resource keys must complete before you can call the API again.
 */
export const startRemediationExecution = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StartRemediationExecutionRequest, output: StartRemediationExecutionResponse, errors: [InsufficientPermissionsException, InvalidParameterValueException, NoSuchRemediationConfigurationException] }));
/**
 * Deletes the stored query for a single Amazon Web Services account and a single Amazon Web Services Region.
 */
export const deleteStoredQuery = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteStoredQueryRequest, output: DeleteStoredQueryResponse, errors: [ResourceNotFoundException, ValidationException] }));
/**
 ...
 * When making a request to this operation, you can only specify one configuration recorder.
 */
export const describeConfigurationRecorders = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeConfigurationRecordersRequest, output: DescribeConfigurationRecordersResponse, errors: [NoSuchConfigurationRecorderException, ValidationException] }));
/**
 * Returns the details of a specific stored query.
 */
export const getStoredQuery = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetStoredQueryRequest, output: GetStoredQueryResponse, errors: [ResourceNotFoundException, ValidationException] }));
/**
 * Deletes specified tags from a resource.
 */
export const untagResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UntagResourceRequest, output: UntagResourceResponse, errors: [ResourceNotFoundException, ValidationException] }));
/**
 ...
 */
export const associateResourceTypes = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: AssociateResourceTypesRequest, output: AssociateResourceTypesResponse, errors: [ConflictException, NoSuchConfigurationRecorderException, ValidationException] }));
/**
 ...
 */
export const tagResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: TagResourceRequest, output: TagResourceResponse, errors: [ResourceNotFoundException, TooManyTagsException, ValidationException] }));
/**
 ...
 * response.
 */
export const batchGetResourceConfig = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: BatchGetResourceConfigRequest, output: BatchGetResourceConfigResponse, errors: [NoAvailableConfigurationRecorderException, ValidationException] }));
/**
 ...
 * Use TagResource and UntagResource to update tags after creation.
 */
export const putServiceLinkedConfigurationRecorder = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutServiceLinkedConfigurationRecorderRequest, output: PutServiceLinkedConfigurationRecorderResponse, errors: [ConflictException, InsufficientPermissionsException, LimitExceededException, ValidationException] }));
/**
 ...
 */
export const batchGetAggregateResourceConfig = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: BatchGetAggregateResourceConfigRequest, output: BatchGetAggregateResourceConfigResponse, errors: [NoSuchConfigurationAggregatorException, ValidationException] }));
/**
 * Deletes the remediation configuration.
 */
export const deleteRemediationConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteRemediationConfigurationRequest, output: DeleteRemediationConfigurationResponse, errors: [InsufficientPermissionsException, InvalidParameterValueException, NoSuchRemediationConfigurationException, RemediationInProgressException] }));
/**
 ...
 * the rule's scope.
 */
export const describeComplianceByResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeComplianceByResourceRequest, output: DescribeComplianceByResourceResponse, errors: [InvalidNextTokenException, InvalidParameterValueException] }));
/**
 ...
 * region in your account.
 */
export const describeDeliveryChannelStatus = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeDeliveryChannelStatusRequest, output: DescribeDeliveryChannelStatusResponse, errors: [NoSuchDeliveryChannelException] }));
/**
 ...
 * those APIs.
 */
export const describeOrganizationConfigRules = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeOrganizationConfigRulesRequest, output: DescribeOrganizationConfigRulesResponse, errors: [InvalidLimitException, InvalidNextTokenException, NoSuchOrganizationConfigRuleException, OrganizationAccessDeniedException] }));
/**
 ...
 * When you specify the limit and the next token, you receive a paginated response.
 */
export const describeRemediationExecutionStatus = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeRemediationExecutionStatusRequest, output: DescribeRemediationExecutionStatusResponse, errors: [InvalidNextTokenException, InvalidParameterValueException, NoSuchRemediationConfigurationException] }));
/**
 ...
 * page.
 */
export const getAggregateConfigRuleComplianceSummary = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetAggregateConfigRuleComplianceSummaryRequest, output: GetAggregateConfigRuleComplianceSummaryResponse, errors: [InvalidLimitException, InvalidNextTokenException, NoSuchConfigurationAggregatorException, ValidationException] }));
/**
 ...
 */
export const getAggregateDiscoveredResourceCounts = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetAggregateDiscoveredResourceCountsRequest, output: GetAggregateDiscoveredResourceCountsResponse, errors: [InvalidLimitException, InvalidNextTokenException, NoSuchConfigurationAggregatorException, ValidationException] }));
/**
 * Returns detailed status for each member account within an organization for a given organization Config rule.
 */
export const getOrganizationConfigRuleDetailedStatus = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetOrganizationConfigRuleDetailedStatusRequest, output: GetOrganizationConfigRuleDetailedStatusResponse, errors: [InvalidLimitException, InvalidNextTokenException, NoSuchOrganizationConfigRuleException, OrganizationAccessDeniedException] }));
/**
 * Returns detailed status for each member account within an organization for a given organization conformance pack.
 */
export const getOrganizationConformancePackDetailedStatus = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetOrganizationConformancePackDetailedStatusRequest, output: GetOrganizationConformancePackDetailedStatusResponse, errors: [InvalidLimitException, InvalidNextTokenException, NoSuchOrganizationConformancePackException, OrganizationAccessDeniedException] }));
/**
 * Returns a list of configuration recorders depending on the filters you specify.
 */
export const listConfigurationRecorders = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListConfigurationRecordersRequest, output: ListConfigurationRecordersResponse, errors: [ValidationException] }));
/**
 ...
 */
export const listConformancePackComplianceScores = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListConformancePackComplianceScoresRequest, output: ListConformancePackComplianceScoresResponse, errors: [InvalidLimitException, InvalidNextTokenException, InvalidParameterValueException] }));
/**
 ...
 */
export const putEvaluations = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutEvaluationsRequest, output: PutEvaluationsResponse, errors: [InvalidParameterValueException, InvalidResultTokenException, NoSuchConfigRuleException] }));
/**
 ...
 * Config will ignore these differences and treat it as an idempotent request of the previous. In this case, `tags` will not be updated, even if they are different.
 */
export const putStoredQuery = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutStoredQueryRequest, output: PutStoredQueryResponse, errors: [ResourceConcurrentModificationException, TooManyTagsException, ValidationException] }));
/**
 ...
 */
export const selectAggregateResourceConfig = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: SelectAggregateResourceConfigRequest, output: SelectAggregateResourceConfigResponse, errors: [InvalidExpressionException, InvalidLimitException, InvalidNextTokenException, NoSuchConfigurationAggregatorException] }));
/**
 ...
 */
export const startResourceEvaluation = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StartResourceEvaluationRequest, output: StartResourceEvaluationResponse, errors: [IdempotentParameterMismatch, InvalidParameterValueException] }));
/**
 ...
 */
export const describeConfigRuleEvaluationStatus = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeConfigRuleEvaluationStatusRequest, output: DescribeConfigRuleEvaluationStatusResponse, errors: [InvalidNextTokenException, InvalidParameterValueException, NoSuchConfigRuleException] }));
/**
 * Returns details about your Config rules.
 */
export const describeConfigRules = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeConfigRulesRequest, output: DescribeConfigRulesResponse, errors: [InvalidNextTokenException, InvalidParameterValueException, NoSuchConfigRuleException] }));
/**
 ...
 */
export const describeRemediationExceptions = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeRemediationExceptionsRequest, output: DescribeRemediationExceptionsResponse, errors: [InvalidNextTokenException, InvalidParameterValueException] }));
/**
 ...
 * configuration per region in your account.
 */
export const describeRetentionConfigurations = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeRetentionConfigurationsRequest, output: DescribeRetentionConfigurationsResponse, errors: [InvalidNextTokenException, InvalidParameterValueException, NoSuchRetentionConfigurationException] }));
/**
 ...
 */
export const getComplianceDetailsByConfigRule = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetComplianceDetailsByConfigRuleRequest, output: GetComplianceDetailsByConfigRuleResponse, errors: [InvalidNextTokenException, InvalidParameterValueException, NoSuchConfigRuleException] }));
/**
 ...
 */
export const listAggregateDiscoveredResources = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListAggregateDiscoveredResourcesRequest, output: ListAggregateDiscoveredResourcesResponse, errors: [InvalidLimitException, InvalidNextTokenException, NoSuchConfigurationAggregatorException, ValidationException] }));
/**
 ...
 */
export const listDiscoveredResources = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListDiscoveredResourcesRequest, output: ListDiscoveredResourcesResponse, errors: [InvalidLimitException, InvalidNextTokenException, NoAvailableConfigurationRecorderException, ValidationException] }));
/**
 * Lists the stored queries for a single Amazon Web Services account and a single Amazon Web Services Region. The default is 100.
 */
export const listStoredQueries = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListStoredQueriesRequest, output: ListStoredQueriesResponse, errors: [InvalidNextTokenException, ValidationException] }));
/**
 ...
 * section in the *Config Developer Guide*.
 */
export const selectResourceConfig = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: SelectResourceConfigRequest, output: SelectResourceConfigResponse, errors: [InvalidExpressionException, InvalidLimitException, InvalidNextTokenException] }));
/**
 * List the tags for Config resource.
 */
export const listTagsForResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListTagsForResourceRequest, output: ListTagsForResourceResponse, errors: [InvalidLimitException, InvalidNextTokenException, ResourceNotFoundException, ValidationException] }));
/**
 * Returns a list of authorizations granted to various aggregator
 * accounts and regions.
 */
export const describeAggregationAuthorizations = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeAggregationAuthorizationsRequest, output: DescribeAggregationAuthorizationsResponse, errors: [InvalidLimitException, InvalidNextTokenException, InvalidParameterValueException] }));
/**
 ...
 * with the account.
 */
export const describeConfigurationAggregators = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeConfigurationAggregatorsRequest, output: DescribeConfigurationAggregatorsResponse, errors: [InvalidLimitException, InvalidNextTokenException, InvalidParameterValueException, NoSuchConfigurationAggregatorException] }));
/**
 ...
 */
export const describeConfigurationAggregatorSourcesStatus = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeConfigurationAggregatorSourcesStatusRequest, output: DescribeConfigurationAggregatorSourcesStatusResponse, errors: [InvalidLimitException, InvalidNextTokenException, InvalidParameterValueException, NoSuchConfigurationAggregatorException] }));
/**
 * Returns a list of one or more conformance packs.
 */
export const describeConformancePacks = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeConformancePacksRequest, output: DescribeConformancePacksResponse, errors: [InvalidLimitException, InvalidNextTokenException, InvalidParameterValueException, NoSuchConformancePackException] }));
/**
 * Provides one or more conformance packs deployment status.
 * 
 * If there are no conformance packs then you will see an empty result.
 */
export const describeConformancePackStatus = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeConformancePackStatusRequest, output: DescribeConformancePackStatusResponse, errors: [InvalidLimitException, InvalidNextTokenException, InvalidParameterValueException] }));
/**
 ...
 * It is only applicable, when you request all the organization Config rules.
 */
export const describeOrganizationConfigRuleStatuses = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeOrganizationConfigRuleStatusesRequest, output: DescribeOrganizationConfigRuleStatusesResponse, errors: [InvalidLimitException, InvalidNextTokenException, NoSuchOrganizationConfigRuleException, OrganizationAccessDeniedException] }));
/**
 ...
 * those APIs.
 */
export const describeOrganizationConformancePacks = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeOrganizationConformancePacksRequest, output: DescribeOrganizationConformancePacksResponse, errors: [InvalidLimitException, InvalidNextTokenException, NoSuchOrganizationConformancePackException, OrganizationAccessDeniedException] }));
/**
 ...
 */
export const describeOrganizationConformancePackStatuses = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeOrganizationConformancePackStatusesRequest, output: DescribeOrganizationConformancePackStatusesResponse, errors: [InvalidLimitException, InvalidNextTokenException, NoSuchOrganizationConformancePackException, OrganizationAccessDeniedException] }));
/**
 * Returns a list of all pending aggregation requests.
 */
export const describePendingAggregationRequests = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribePendingAggregationRequestsRequest, output: DescribePendingAggregationRequestsResponse, errors: [InvalidLimitException, InvalidNextTokenException, InvalidParameterValueException] }));
/**
 * Returns compliance details for the conformance pack based on the cumulative compliance results of all the rules in that conformance pack.
 */
export const getConformancePackComplianceSummary = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetConformancePackComplianceSummaryRequest, output: GetConformancePackComplianceSummaryResponse, errors: [InvalidLimitException, InvalidNextTokenException, NoSuchConformancePackException] }));
/**
 ...
 */
export const getDiscoveredResourceCounts = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetDiscoveredResourceCountsRequest, output: GetDiscoveredResourceCountsResponse, errors: [InvalidLimitException, InvalidNextTokenException, ValidationException] }));
/**
 ...
 * page.
 */
export const describeAggregateComplianceByConfigRules = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeAggregateComplianceByConfigRulesRequest, output: DescribeAggregateComplianceByConfigRulesResponse, errors: [InvalidLimitException, InvalidNextTokenException, NoSuchConfigurationAggregatorException, ValidationException] }));
/**
 ...
 * the rule's scope.
 */
export const describeComplianceByConfigRule = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeComplianceByConfigRuleRequest, output: DescribeComplianceByConfigRuleResponse, errors: [InvalidNextTokenException, InvalidParameterValueException, NoSuchConfigRuleException] }));
/**
 ...
 * Remediation exceptions blocks auto-remediation until the exception is cleared.
 */
export const deleteRemediationExceptions = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteRemediationExceptionsRequest, output: DeleteRemediationExceptionsResponse, errors: [NoSuchRemediationExceptionException] }));
/**
 ...
 */
export const describeAggregateComplianceByConformancePacks = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeAggregateComplianceByConformancePacksRequest, output: DescribeAggregateComplianceByConformancePacksResponse, errors: [InvalidLimitException, InvalidNextTokenException, NoSuchConfigurationAggregatorException, ValidationException] }));
/**
 * Returns compliance details for each rule in that conformance pack.
 * 
 * You must provide exact rule names.
 */
export const describeConformancePackCompliance = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeConformancePackComplianceRequest, output: DescribeConformancePackComplianceResponse, errors: [InvalidLimitException, InvalidNextTokenException, InvalidParameterValueException, NoSuchConfigRuleInConformancePackException, NoSuchConformancePackException] }));
/**
 * Returns the evaluation results for the specified Config
 ...
 * page.
 */
export const getAggregateComplianceDetailsByConfigRule = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetAggregateComplianceDetailsByConfigRuleRequest, output: GetAggregateComplianceDetailsByConfigRuleResponse, errors: [InvalidLimitException, InvalidNextTokenException, NoSuchConfigurationAggregatorException, ValidationException] }));
/**
 * Returns the count of compliant and noncompliant conformance packs across all Amazon Web Services accounts and Amazon Web Services Regions in an aggregator. You can filter based on Amazon Web Services account ID or Amazon Web Services Region.
 * 
 * The results can return an empty result page, but if you have a nextToken, the results are displayed on the next page.
 */
export const getAggregateConformancePackComplianceSummary = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetAggregateConformancePackComplianceSummaryRequest, output: GetAggregateConformancePackComplianceSummaryResponse, errors: [InvalidLimitException, InvalidNextTokenException, NoSuchConfigurationAggregatorException, ValidationException] }));
/**
 ...
 * Use TagResource and UntagResource to update tags after creation.
 */
export const putConfigRule = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutConfigRuleRequest, output: PutConfigRuleResponse, errors: [InsufficientPermissionsException, InvalidParameterValueException, MaxNumberOfConfigRulesExceededException, NoAvailableConfigurationRecorderException, ResourceInUseException] }));
/**
 ...
 */
export const putConformancePack = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutConformancePackRequest, output: PutConformancePackResponse, errors: [ConformancePackTemplateValidationException, InsufficientPermissionsException, InvalidParameterValueException, MaxNumberOfConformancePacksExceededException, ResourceInUseException] }));
/**
 * Returns compliance details of a conformance pack for all Amazon Web Services resources that are monitered by conformance pack.
 */
export const getConformancePackComplianceDetails = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetConformancePackComplianceDetailsRequest, output: GetConformancePackComplianceDetailsResponse, errors: [InvalidLimitException, InvalidNextTokenException, InvalidParameterValueException, NoSuchConfigRuleInConformancePackException, NoSuchConformancePackException] }));
/**
 ...
 * Use TagResource and UntagResource to update tags after creation.
 */
export const putConfigurationAggregator = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutConfigurationAggregatorRequest, output: PutConfigurationAggregatorResponse, errors: [InvalidParameterValueException, InvalidRoleException, LimitExceededException, NoAvailableOrganizationException, OrganizationAccessDeniedException, OrganizationAllFeaturesNotEnabledException] }));
/**
 * Returns a list of proactive resource evaluations.
 */
export const listResourceEvaluations = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListResourceEvaluationsRequest, output: ListResourceEvaluationsResponse, errors: [InvalidNextTokenException, InvalidParameterValueException, InvalidTimeRangeException] }));
/**
 * Returns configuration item that is aggregated for your specific resource in a specific source account and region.
 * 
 * The API does not return results for deleted resources.
 */
export const getAggregateResourceConfig = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetAggregateResourceConfigRequest, output: GetAggregateResourceConfigResponse, errors: [NoSuchConfigurationAggregatorException, OversizedConfigurationItemException, ResourceNotDiscoveredException, ValidationException] }));
/**
 ...
 * You cannot update a conformance pack while it is in this state.
 */
export const putOrganizationConformancePack = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutOrganizationConformancePackRequest, output: PutOrganizationConformancePackResponse, errors: [InsufficientPermissionsException, MaxNumberOfOrganizationConformancePacksExceededException, NoAvailableOrganizationException, OrganizationAccessDeniedException, OrganizationAllFeaturesNotEnabledException, OrganizationConformancePackTemplateValidationException, ResourceInUseException, ValidationException] }));
/**
 ...
 * `nextToken`.
 */
export const getResourceConfigHistory = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetResourceConfigHistoryRequest, output: GetResourceConfigHistoryResponse, errors: [InvalidLimitException, InvalidNextTokenException, InvalidTimeRangeException, NoAvailableConfigurationRecorderException, ResourceNotDiscoveredException, ValidationException] }));
/**
 ...
 * Use TagResource and UntagResource to update tags after creation.
 */
export const putConfigurationRecorder = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutConfigurationRecorderRequest, output: PutConfigurationRecorderResponse, errors: [InvalidConfigurationRecorderNameException, InvalidRecordingGroupException, InvalidRoleException, MaxNumberOfConfigurationRecordersExceededException, UnmodifiableEntityException, ValidationException] }));
/**
 ...
 * This means that in some cases auto remediation can be initiated even for compliant resources, since the bootstrap processor uses a database that can have stale evaluation results based on the last known compliance data snapshot.
 */
export const putRemediationConfigurations = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutRemediationConfigurationsRequest, output: PutRemediationConfigurationsResponse, errors: [InsufficientPermissionsException, InvalidParameterValueException] }));
/**
 ...
 */
export const putDeliveryChannel = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutDeliveryChannelRequest, output: PutDeliveryChannelResponse, errors: [InsufficientDeliveryPolicyException, InvalidDeliveryChannelNameException, InvalidS3KeyPrefixException, InvalidS3KmsKeyArnException, InvalidSNSTopicARNException, MaxNumberOfDeliveryChannelsExceededException, NoAvailableConfigurationRecorderException, NoSuchBucketException] }));
