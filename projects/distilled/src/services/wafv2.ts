...
export class AssociateWebACLRequest extends S.Class<AssociateWebACLRequest>("AssociateWebACLRequest")({WebACLArn: S.String, ResourceArn: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class AssociateWebACLResponse extends S.Class<AssociateWebACLResponse>("AssociateWebACLResponse")({}, ns) {}
export class CreateAPIKeyRequest extends S.Class<CreateAPIKeyRequest>("CreateAPIKeyRequest")({Scope: S.String, TokenDomains: APIKeyTokenDomains}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteAPIKeyRequest extends S.Class<DeleteAPIKeyRequest>("DeleteAPIKeyRequest")({Scope: S.String, APIKey: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteAPIKeyResponse extends S.Class<DeleteAPIKeyResponse>("DeleteAPIKeyResponse")({}, ns) {}
export class DeleteFirewallManagerRuleGroupsRequest extends S.Class<DeleteFirewallManagerRuleGroupsRequest>("DeleteFirewallManagerRuleGroupsRequest")({WebACLArn: S.String, WebACLLockToken: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteIPSetRequest extends S.Class<DeleteIPSetRequest>("DeleteIPSetRequest")({Name: S.String, Scope: S.String, Id: S.String, LockToken: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteIPSetResponse extends S.Class<DeleteIPSetResponse>("DeleteIPSetResponse")({}, ns) {}
export class DeleteLoggingConfigurationRequest extends S.Class<DeleteLoggingConfigurationRequest>("DeleteLoggingConfigurationRequest")({ResourceArn: S.String, LogType: S.optional(S.String), LogScope: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteLoggingConfigurationResponse extends S.Class<DeleteLoggingConfigurationResponse>("DeleteLoggingConfigurationResponse")({}, ns) {}
export class DeletePermissionPolicyRequest extends S.Class<DeletePermissionPolicyRequest>("DeletePermissionPolicyRequest")({ResourceArn: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeletePermissionPolicyResponse extends S.Class<DeletePermissionPolicyResponse>("DeletePermissionPolicyResponse")({}, ns) {}
export class DeleteRegexPatternSetRequest extends S.Class<DeleteRegexPatternSetRequest>("DeleteRegexPatternSetRequest")({Name: S.String, Scope: S.String, Id: S.String, LockToken: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteRegexPatternSetResponse extends S.Class<DeleteRegexPatternSetResponse>("DeleteRegexPatternSetResponse")({}, ns) {}
export class DeleteRuleGroupRequest extends S.Class<DeleteRuleGroupRequest>("DeleteRuleGroupRequest")({Name: S.String, Scope: S.String, Id: S.String, LockToken: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteRuleGroupResponse extends S.Class<DeleteRuleGroupResponse>("DeleteRuleGroupResponse")({}, ns) {}
export class DeleteWebACLRequest extends S.Class<DeleteWebACLRequest>("DeleteWebACLRequest")({Name: S.String, Scope: S.String, Id: S.String, LockToken: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteWebACLResponse extends S.Class<DeleteWebACLResponse>("DeleteWebACLResponse")({}, ns) {}
export class DescribeAllManagedProductsRequest extends S.Class<DescribeAllManagedProductsRequest>("DescribeAllManagedProductsRequest")({Scope: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeManagedProductsByVendorRequest extends S.Class<DescribeManagedProductsByVendorRequest>("DescribeManagedProductsByVendorRequest")({VendorName: S.String, Scope: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeManagedRuleGroupRequest extends S.Class<DescribeManagedRuleGroupRequest>("DescribeManagedRuleGroupRequest")({VendorName: S.String, Name: S.String, Scope: S.String, VersionName: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DisassociateWebACLRequest extends S.Class<DisassociateWebACLRequest>("DisassociateWebACLRequest")({ResourceArn: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DisassociateWebACLResponse extends S.Class<DisassociateWebACLResponse>("DisassociateWebACLResponse")({}, ns) {}
export class GenerateMobileSdkReleaseUrlRequest extends S.Class<GenerateMobileSdkReleaseUrlRequest>("GenerateMobileSdkReleaseUrlRequest")({Platform: S.String, ReleaseVersion: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetDecryptedAPIKeyRequest extends S.Class<GetDecryptedAPIKeyRequest>("GetDecryptedAPIKeyRequest")({Scope: S.String, APIKey: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetIPSetRequest extends S.Class<GetIPSetRequest>("GetIPSetRequest")({Name: S.String, Scope: S.String, Id: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetLoggingConfigurationRequest extends S.Class<GetLoggingConfigurationRequest>("GetLoggingConfigurationRequest")({ResourceArn: S.String, LogType: S.optional(S.String), LogScope: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetManagedRuleSetRequest extends S.Class<GetManagedRuleSetRequest>("GetManagedRuleSetRequest")({Name: S.String, Scope: S.String, Id: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetMobileSdkReleaseRequest extends S.Class<GetMobileSdkReleaseRequest>("GetMobileSdkReleaseRequest")({Platform: S.String, ReleaseVersion: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetPermissionPolicyRequest extends S.Class<GetPermissionPolicyRequest>("GetPermissionPolicyRequest")({ResourceArn: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetRateBasedStatementManagedKeysRequest extends S.Class<GetRateBasedStatementManagedKeysRequest>("GetRateBasedStatementManagedKeysRequest")({Scope: S.String, WebACLName: S.String, WebACLId: S.String, RuleGroupRuleName: S.optional(S.String), RuleName: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetRegexPatternSetRequest extends S.Class<GetRegexPatternSetRequest>("GetRegexPatternSetRequest")({Name: S.String, Scope: S.String, Id: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetRuleGroupRequest extends S.Class<GetRuleGroupRequest>("GetRuleGroupRequest")({Name: S.optional(S.String), Scope: S.optional(S.String), Id: S.optional(S.String), ARN: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetWebACLRequest extends S.Class<GetWebACLRequest>("GetWebACLRequest")({Name: S.optional(S.String), Scope: S.optional(S.String), Id: S.optional(S.String), ARN: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetWebACLForResourceRequest extends S.Class<GetWebACLForResourceRequest>("GetWebACLForResourceRequest")({ResourceArn: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListAPIKeysRequest extends S.Class<ListAPIKeysRequest>("ListAPIKeysRequest")({Scope: S.String, NextMarker: S.optional(S.String), Limit: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListAvailableManagedRuleGroupsRequest extends S.Class<ListAvailableManagedRuleGroupsRequest>("ListAvailableManagedRuleGroupsRequest")({Scope: S.String, NextMarker: S.optional(S.String), Limit: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListAvailableManagedRuleGroupVersionsRequest extends S.Class<ListAvailableManagedRuleGroupVersionsRequest>("ListAvailableManagedRuleGroupVersionsRequest")({VendorName: S.String, Name: S.String, Scope: S.String, NextMarker: S.optional(S.String), Limit: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListIPSetsRequest extends S.Class<ListIPSetsRequest>("ListIPSetsRequest")({Scope: S.String, NextMarker: S.optional(S.String), Limit: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListLoggingConfigurationsRequest extends S.Class<ListLoggingConfigurationsRequest>("ListLoggingConfigurationsRequest")({Scope: S.String, NextMarker: S.optional(S.String), Limit: S.optional(S.Number), LogScope: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListManagedRuleSetsRequest extends S.Class<ListManagedRuleSetsRequest>("ListManagedRuleSetsRequest")({Scope: S.String, NextMarker: S.optional(S.String), Limit: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListMobileSdkReleasesRequest extends S.Class<ListMobileSdkReleasesRequest>("ListMobileSdkReleasesRequest")({Platform: S.String, NextMarker: S.optional(S.String), Limit: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListRegexPatternSetsRequest extends S.Class<ListRegexPatternSetsRequest>("ListRegexPatternSetsRequest")({Scope: S.String, NextMarker: S.optional(S.String), Limit: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListResourcesForWebACLRequest extends S.Class<ListResourcesForWebACLRequest>("ListResourcesForWebACLRequest")({WebACLArn: S.String, ResourceType: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListRuleGroupsRequest extends S.Class<ListRuleGroupsRequest>("ListRuleGroupsRequest")({Scope: S.String, NextMarker: S.optional(S.String), Limit: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListTagsForResourceRequest extends S.Class<ListTagsForResourceRequest>("ListTagsForResourceRequest")({NextMarker: S.optional(S.String), Limit: S.optional(S.Number), ResourceARN: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListWebACLsRequest extends S.Class<ListWebACLsRequest>("ListWebACLsRequest")({Scope: S.String, NextMarker: S.optional(S.String), Limit: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutPermissionPolicyRequest extends S.Class<PutPermissionPolicyRequest>("PutPermissionPolicyRequest")({ResourceArn: S.String, Policy: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutPermissionPolicyResponse extends S.Class<PutPermissionPolicyResponse>("PutPermissionPolicyResponse")({}, ns) {}
...
export class UpdateIPSetRequest extends S.Class<UpdateIPSetRequest>("UpdateIPSetRequest")({Name: S.String, Scope: S.String, Id: S.String, Description: S.optional(S.String), Addresses: IPAddresses, LockToken: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class UpdateManagedRuleSetVersionExpiryDateRequest extends S.Class<UpdateManagedRuleSetVersionExpiryDateRequest>("UpdateManagedRuleSetVersionExpiryDateRequest")({Name: S.String, Scope: S.String, Id: S.String, LockToken: S.String, VersionToExpire: S.String, ExpiryTimestamp: S.Date.pipe(T.TimestampFormat("epoch-seconds"))}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class UpdateRegexPatternSetRequest extends S.Class<UpdateRegexPatternSetRequest>("UpdateRegexPatternSetRequest")({Name: S.String, Scope: S.String, Id: S.String, Description: S.optional(S.String), RegularExpressionList: RegularExpressionList, LockToken: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class ByteMatchStatement extends S.Class<ByteMatchStatement>("ByteMatchStatement")({SearchString: T.Blob, FieldToMatch: FieldToMatch, TextTransformations: TextTransformations, PositionalConstraint: S.String}) {}
...
export class UpdateRuleGroupRequest extends S.Class<UpdateRuleGroupRequest>("UpdateRuleGroupRequest")({Name: S.String, Scope: S.String, Id: S.String, Description: S.optional(S.String), Rules: S.optional(Rules), VisibilityConfig: VisibilityConfig, LockToken: S.String, CustomResponseBodies: S.optional(CustomResponseBodies)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class CreateAPIKeyResponse extends S.Class<CreateAPIKeyResponse>("CreateAPIKeyResponse")({APIKey: S.optional(S.String)}, ns) {}
export class CreateIPSetRequest extends S.Class<CreateIPSetRequest>("CreateIPSetRequest")({Name: S.String, Scope: S.String, Description: S.optional(S.String), IPAddressVersion: S.String, Addresses: IPAddresses, Tags: S.optional(TagList)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class CreateRegexPatternSetRequest extends S.Class<CreateRegexPatternSetRequest>("CreateRegexPatternSetRequest")({Name: S.String, Scope: S.String, Description: S.optional(S.String), RegularExpressionList: RegularExpressionList, Tags: S.optional(TagList)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteFirewallManagerRuleGroupsResponse extends S.Class<DeleteFirewallManagerRuleGroupsResponse>("DeleteFirewallManagerRuleGroupsResponse")({NextWebACLLockToken: S.optional(S.String)}, ns) {}
...
export class DescribeManagedProductsByVendorResponse extends S.Class<DescribeManagedProductsByVendorResponse>("DescribeManagedProductsByVendorResponse")({ManagedProducts: S.optional(ManagedProductDescriptors)}, ns) {}
export class GenerateMobileSdkReleaseUrlResponse extends S.Class<GenerateMobileSdkReleaseUrlResponse>("GenerateMobileSdkReleaseUrlResponse")({Url: S.optional(S.String)}, ns) {}
export class GetDecryptedAPIKeyResponse extends S.Class<GetDecryptedAPIKeyResponse>("GetDecryptedAPIKeyResponse")({TokenDomains: S.optional(TokenDomains), CreationTimestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}, ns) {}
export class GetLoggingConfigurationResponse extends S.Class<GetLoggingConfigurationResponse>("GetLoggingConfigurationResponse")({LoggingConfiguration: S.optional(LoggingConfiguration)}, ns) {}
export class GetPermissionPolicyResponse extends S.Class<GetPermissionPolicyResponse>("GetPermissionPolicyResponse")({Policy: S.optional(S.String)}, ns) {}
export class GetSampledRequestsRequest extends S.Class<GetSampledRequestsRequest>("GetSampledRequestsRequest")({WebAclArn: S.String, RuleMetricName: S.String, Scope: S.String, TimeWindow: TimeWindow, MaxItems: S.Number}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class GetWebACLForResourceResponse extends S.Class<GetWebACLForResourceResponse>("GetWebACLForResourceResponse")({WebACL: S.optional(WebACL)}, ns) {}
export class ListLoggingConfigurationsResponse extends S.Class<ListLoggingConfigurationsResponse>("ListLoggingConfigurationsResponse")({LoggingConfigurations: S.optional(LoggingConfigurations), NextMarker: S.optional(S.String)}, ns) {}
export class ListResourcesForWebACLResponse extends S.Class<ListResourcesForWebACLResponse>("ListResourcesForWebACLResponse")({ResourceArns: S.optional(ResourceArns)}, ns) {}
export class UpdateIPSetResponse extends S.Class<UpdateIPSetResponse>("UpdateIPSetResponse")({NextLockToken: S.optional(S.String)}, ns) {}
export class UpdateManagedRuleSetVersionExpiryDateResponse extends S.Class<UpdateManagedRuleSetVersionExpiryDateResponse>("UpdateManagedRuleSetVersionExpiryDateResponse")({ExpiringVersion: S.optional(S.String), ExpiryTimestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), NextLockToken: S.optional(S.String)}, ns) {}
export class UpdateRegexPatternSetResponse extends S.Class<UpdateRegexPatternSetResponse>("UpdateRegexPatternSetResponse")({NextLockToken: S.optional(S.String)}, ns) {}
export class UpdateRuleGroupResponse extends S.Class<UpdateRuleGroupResponse>("UpdateRuleGroupResponse")({NextLockToken: S.optional(S.String)}, ns) {}
export class UpdateWebACLResponse extends S.Class<UpdateWebACLResponse>("UpdateWebACLResponse")({NextLockToken: S.optional(S.String)}, ns) {}
...
export class MobileSdkRelease extends S.Class<MobileSdkRelease>("MobileSdkRelease")({ReleaseVersion: S.optional(S.String), Timestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), ReleaseNotes: S.optional(S.String), Tags: S.optional(TagList)}) {}
...
export class APIKeySummary extends S.Class<APIKeySummary>("APIKeySummary")({TokenDomains: S.optional(TokenDomains), APIKey: S.optional(S.String), CreationTimestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), Version: S.optional(S.Number)}) {}
...
export class ManagedRuleGroupVersion extends S.Class<ManagedRuleGroupVersion>("ManagedRuleGroupVersion")({Name: S.optional(S.String), LastUpdateTimestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
...
export class ReleaseSummary extends S.Class<ReleaseSummary>("ReleaseSummary")({ReleaseVersion: S.optional(S.String), Timestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
...
export class CreateIPSetResponse extends S.Class<CreateIPSetResponse>("CreateIPSetResponse")({Summary: S.optional(IPSetSummary)}, ns) {}
export class CreateRegexPatternSetResponse extends S.Class<CreateRegexPatternSetResponse>("CreateRegexPatternSetResponse")({Summary: S.optional(RegexPatternSetSummary)}, ns) {}
export class CreateRuleGroupRequest extends S.Class<CreateRuleGroupRequest>("CreateRuleGroupRequest")({Name: S.String, Scope: S.String, Capacity: S.Number, Description: S.optional(S.String), Rules: S.optional(Rules), VisibilityConfig: VisibilityConfig, Tags: S.optional(TagList), CustomResponseBodies: S.optional(CustomResponseBodies)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeAllManagedProductsResponse extends S.Class<DescribeAllManagedProductsResponse>("DescribeAllManagedProductsResponse")({ManagedProducts: S.optional(ManagedProductDescriptors)}, ns) {}
export class DescribeManagedRuleGroupResponse extends S.Class<DescribeManagedRuleGroupResponse>("DescribeManagedRuleGroupResponse")({VersionName: S.optional(S.String), SnsTopicArn: S.optional(S.String), Capacity: S.optional(S.Number), Rules: S.optional(RuleSummaries), LabelNamespace: S.optional(S.String), AvailableLabels: S.optional(LabelSummaries), ConsumedLabels: S.optional(LabelSummaries)}, ns) {}
export class GetIPSetResponse extends S.Class<GetIPSetResponse>("GetIPSetResponse")({IPSet: S.optional(IPSet), LockToken: S.optional(S.String)}, ns) {}
export class GetMobileSdkReleaseResponse extends S.Class<GetMobileSdkReleaseResponse>("GetMobileSdkReleaseResponse")({MobileSdkRelease: S.optional(MobileSdkRelease)}, ns) {}
export class GetRateBasedStatementManagedKeysResponse extends S.Class<GetRateBasedStatementManagedKeysResponse>("GetRateBasedStatementManagedKeysResponse")({ManagedKeysIPV4: S.optional(RateBasedStatementManagedKeysIPSet), ManagedKeysIPV6: S.optional(RateBasedStatementManagedKeysIPSet)}, ns) {}
export class GetRegexPatternSetResponse extends S.Class<GetRegexPatternSetResponse>("GetRegexPatternSetResponse")({RegexPatternSet: S.optional(RegexPatternSet), LockToken: S.optional(S.String)}, ns) {}
export class GetRuleGroupResponse extends S.Class<GetRuleGroupResponse>("GetRuleGroupResponse")({RuleGroup: S.optional(RuleGroup), LockToken: S.optional(S.String)}, ns) {}
export class ListAPIKeysResponse extends S.Class<ListAPIKeysResponse>("ListAPIKeysResponse")({NextMarker: S.optional(S.String), APIKeySummaries: S.optional(APIKeySummaries), ApplicationIntegrationURL: S.optional(S.String)}, ns) {}
export class ListAvailableManagedRuleGroupsResponse extends S.Class<ListAvailableManagedRuleGroupsResponse>("ListAvailableManagedRuleGroupsResponse")({NextMarker: S.optional(S.String), ManagedRuleGroups: S.optional(ManagedRuleGroupSummaries)}, ns) {}
export class ListAvailableManagedRuleGroupVersionsResponse extends S.Class<ListAvailableManagedRuleGroupVersionsResponse>("ListAvailableManagedRuleGroupVersionsResponse")({NextMarker: S.optional(S.String), Versions: S.optional(ManagedRuleGroupVersions), CurrentDefaultVersion: S.optional(S.String)}, ns) {}
export class ListIPSetsResponse extends S.Class<ListIPSetsResponse>("ListIPSetsResponse")({NextMarker: S.optional(S.String), IPSets: S.optional(IPSetSummaries)}, ns) {}
export class ListManagedRuleSetsResponse extends S.Class<ListManagedRuleSetsResponse>("ListManagedRuleSetsResponse")({NextMarker: S.optional(S.String), ManagedRuleSets: S.optional(ManagedRuleSetSummaries)}, ns) {}
export class ListMobileSdkReleasesResponse extends S.Class<ListMobileSdkReleasesResponse>("ListMobileSdkReleasesResponse")({ReleaseSummaries: S.optional(ReleaseSummaries), NextMarker: S.optional(S.String)}, ns) {}
export class ListRegexPatternSetsResponse extends S.Class<ListRegexPatternSetsResponse>("ListRegexPatternSetsResponse")({NextMarker: S.optional(S.String), RegexPatternSets: S.optional(RegexPatternSetSummaries)}, ns) {}
export class ListRuleGroupsResponse extends S.Class<ListRuleGroupsResponse>("ListRuleGroupsResponse")({NextMarker: S.optional(S.String), RuleGroups: S.optional(RuleGroupSummaries)}, ns) {}
export class ListTagsForResourceResponse extends S.Class<ListTagsForResourceResponse>("ListTagsForResourceResponse")({NextMarker: S.optional(S.String), TagInfoForResource: S.optional(TagInfoForResource)}, ns) {}
export class ListWebACLsResponse extends S.Class<ListWebACLsResponse>("ListWebACLsResponse")({NextMarker: S.optional(S.String), WebACLs: S.optional(WebACLSummaries)}, ns) {}
export class PutManagedRuleSetVersionsRequest extends S.Class<PutManagedRuleSetVersionsRequest>("PutManagedRuleSetVersionsRequest")({Name: S.String, Scope: S.String, Id: S.String, LockToken: S.String, RecommendedVersion: S.optional(S.String), VersionsToPublish: S.optional(VersionsToPublish)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ManagedRuleSetVersion extends S.Class<ManagedRuleSetVersion>("ManagedRuleSetVersion")({AssociatedRuleGroupArn: S.optional(S.String), Capacity: S.optional(S.Number), ForecastedLifetime: S.optional(S.Number), PublishTimestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), LastUpdateTimestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), ExpiryTimestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
...
export class CreateRuleGroupResponse extends S.Class<CreateRuleGroupResponse>("CreateRuleGroupResponse")({Summary: S.optional(RuleGroupSummary)}, ns) {}
export class PutManagedRuleSetVersionsResponse extends S.Class<PutManagedRuleSetVersionsResponse>("PutManagedRuleSetVersionsResponse")({NextLockToken: S.optional(S.String)}, ns) {}
...
export class GetManagedRuleSetResponse extends S.Class<GetManagedRuleSetResponse>("GetManagedRuleSetResponse")({ManagedRuleSet: S.optional(ManagedRuleSet), LockToken: S.optional(S.String)}, ns) {}
export class GetSampledRequestsResponse extends S.Class<GetSampledRequestsResponse>("GetSampledRequestsResponse")({SampledRequests: S.optional(SampledHTTPRequests), PopulationSize: S.optional(S.Number), TimeWindow: S.optional(TimeWindow)}, ns) {}
export class GetWebACLResponse extends S.Class<GetWebACLResponse>("GetWebACLResponse")({WebACL: S.optional(WebACL), LockToken: S.optional(S.String), ApplicationIntegrationURL: S.optional(S.String)}, ns) {}
export class CreateWebACLResponse extends S.Class<CreateWebACLResponse>("CreateWebACLResponse")({Summary: S.optional(WebACLSummary)}, ns) {}
export class PutLoggingConfigurationRequest extends S.Class<PutLoggingConfigurationRequest>("PutLoggingConfigurationRequest")({LoggingConfiguration: LoggingConfiguration}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutLoggingConfigurationResponse extends S.Class<PutLoggingConfigurationResponse>("PutLoggingConfigurationResponse")({LoggingConfiguration: S.optional(LoggingConfiguration)}, ns) {}
export class CheckCapacityRequest extends S.Class<CheckCapacityRequest>("CheckCapacityRequest")({Scope: S.String, Rules: Rules}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class CheckCapacityResponse extends S.Class<CheckCapacityResponse>("CheckCapacityResponse")({Capacity: S.optional(S.Number)}, ns) {}

//# Errors
export class WAFInternalErrorException extends S.TaggedError<WAFInternalErrorException>()("WAFInternalErrorException", {Message: S.optional(S.String)}) {}
export class WAFAssociatedItemException extends S.TaggedError<WAFAssociatedItemException>()("WAFAssociatedItemException", {Message: S.optional(S.String)}) {}
...
export class WAFInvalidOperationException extends S.TaggedError<WAFInvalidOperationException>()("WAFInvalidOperationException", {Message: S.optional(S.String)}) {}
export class WAFInvalidParameterException extends S.TaggedError<WAFInvalidParameterException>()("WAFInvalidParameterException", {message: S.optional(S.String), Field: S.optional(S.String), Parameter: S.optional(S.String), Reason: S.optional(S.String)}) {}
export class WAFDuplicateItemException extends S.TaggedError<WAFDuplicateItemException>()("WAFDuplicateItemException", {Message: S.optional(S.String)}) {}
export class WAFConfigurationWarningException extends S.TaggedError<WAFConfigurationWarningException>()("WAFConfigurationWarningException", {Message: S.optional(S.String)}) {}
export class WAFExpiredManagedRuleGroupVersionException extends S.TaggedError<WAFExpiredManagedRuleGroupVersionException>()("WAFExpiredManagedRuleGroupVersionException", {Message: S.optional(S.String)}) {}
export class WAFNonexistentItemException extends S.TaggedError<WAFNonexistentItemException>()("WAFNonexistentItemException", {Message: S.optional(S.String)}) {}
export class WAFInvalidResourceException extends S.TaggedError<WAFInvalidResourceException>()("WAFInvalidResourceException", {Message: S.optional(S.String)}) {}
export class WAFLimitsExceededException extends S.TaggedError<WAFLimitsExceededException>()("WAFLimitsExceededException", {Message: S.optional(S.String), SourceType: S.optional(S.String)}) {}
...
export class WAFOptimisticLockException extends S.TaggedError<WAFOptimisticLockException>()("WAFOptimisticLockException", {Message: S.optional(S.String)}) {}
...
export class WAFTagOperationException extends S.TaggedError<WAFTagOperationException>()("WAFTagOperationException", {Message: S.optional(S.String)}) {}
...
export class WAFTagOperationInternalErrorException extends S.TaggedError<WAFTagOperationInternalErrorException>()("WAFTagOperationInternalErrorException", {Message: S.optional(S.String)}) {}
 ...
 * subscribed to.
 */
export const listAvailableManagedRuleGroups = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListAvailableManagedRuleGroupsRequest, output: ListAvailableManagedRuleGroupsResponse, errors: [WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException] }));
/**
 * Retrieves an array of IPSetSummary objects for the IP sets that you
 * manage.
 */
export const listIPSets = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListIPSetsRequest, output: ListIPSetsResponse, errors: [WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException] }));
/**
 ...
 */
export const listManagedRuleSets = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListManagedRuleSetsRequest, output: ListManagedRuleSetsResponse, errors: [WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException] }));
/**
 ...
 */
export const listMobileSdkReleases = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListMobileSdkReleasesRequest, output: ListMobileSdkReleasesResponse, errors: [WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException] }));
/**
 * Retrieves an array of RegexPatternSetSummary objects for the regex
 * pattern sets that you manage.
 */
export const listRegexPatternSets = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListRegexPatternSetsRequest, output: ListRegexPatternSetsResponse, errors: [WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException] }));
/**
 * Retrieves an array of RuleGroupSummary objects for the rule groups
 * that you manage.
 */
export const listRuleGroups = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListRuleGroupsRequest, output: ListRuleGroupsResponse, errors: [WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException] }));
/**
 * Retrieves an array of WebACLSummary objects for the web ACLs that you
 * manage.
 */
export const listWebACLs = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListWebACLsRequest, output: ListWebACLsResponse, errors: [WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException] }));
/**
 * Provides high-level information for the managed rule groups owned by a specific vendor.
 */
export const describeManagedProductsByVendor = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeManagedProductsByVendorRequest, output: DescribeManagedProductsByVendorResponse, errors: [WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException] }));
/**
 * Retrieves an array of your LoggingConfiguration objects.
 */
export const listLoggingConfigurations = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListLoggingConfigurationsRequest, output: ListLoggingConfigurationsResponse, errors: [WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException] }));
/**
 * Provides high-level information for the Amazon Web Services Managed Rules rule groups and Amazon Web Services Marketplace managed rule groups.
 */
export const describeAllManagedProducts = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeAllManagedProductsRequest, output: DescribeAllManagedProductsResponse, errors: [WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException] }));
/**
 * Returns the IAM policy that is attached to the specified rule group.
 * 
 * You must be the owner of the rule group to perform this operation.
 */
export const getPermissionPolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetPermissionPolicyRequest, output: GetPermissionPolicyResponse, errors: [WAFInternalErrorException, WAFInvalidParameterException, WAFNonexistentItemException] }));
/**
 ...
 */
export const listAPIKeys = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListAPIKeysRequest, output: ListAPIKeysResponse, errors: [WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException, WAFInvalidResourceException] }));
/**
 ...
 */
export const putPermissionPolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutPermissionPolicyRequest, output: PutPermissionPolicyResponse, errors: [WAFInternalErrorException, WAFInvalidParameterException, WAFInvalidPermissionPolicyException, WAFNonexistentItemException] }));
/**
 * Retrieves the specified RegexPatternSet.
 */
export const getRegexPatternSet = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetRegexPatternSetRequest, output: GetRegexPatternSetResponse, errors: [WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException, WAFNonexistentItemException] }));
/**
 * Retrieves the specified RuleGroup.
 */
export const getRuleGroup = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetRuleGroupRequest, output: GetRuleGroupResponse, errors: [WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException, WAFNonexistentItemException] }));
/**
 * Returns a list of the available versions for the specified managed rule group.
 */
export const listAvailableManagedRuleGroupVersions = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListAvailableManagedRuleGroupVersionsRequest, output: ListAvailableManagedRuleGroupVersionsResponse, errors: [WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException, WAFNonexistentItemException] }));
/**
 ...
 * WAF client application integration in the *WAF Developer Guide*.
 */
export const generateMobileSdkReleaseUrl = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GenerateMobileSdkReleaseUrlRequest, output: GenerateMobileSdkReleaseUrlResponse, errors: [WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException, WAFNonexistentItemException] }));
/**
 * Returns the LoggingConfiguration for the specified web ACL.
 */
export const getLoggingConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetLoggingConfigurationRequest, output: GetLoggingConfigurationResponse, errors: [WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException, WAFNonexistentItemException] }));
/**
 ...
 */
export const listResourcesForWebACL = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListResourcesForWebACLRequest, output: ListResourcesForWebACLResponse, errors: [WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException, WAFNonexistentItemException] }));
/**
 ...
 */
export const disassociateWebACL = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DisassociateWebACLRequest, output: DisassociateWebACLResponse, errors: [WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException, WAFNonexistentItemException] }));
/**
 * Permanently deletes an IAM policy from the specified rule group.
 * 
 * You must be the owner of the rule group to perform this operation.
 */
export const deletePermissionPolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeletePermissionPolicyRequest, output: DeletePermissionPolicyResponse, errors: [WAFInternalErrorException, WAFInvalidParameterException, WAFNonexistentItemException] }));
/**
 * Retrieves the specified IPSet.
 */
export const getIPSet = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetIPSetRequest, output: GetIPSetResponse, errors: [WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException, WAFNonexistentItemException] }));
/**
 ...
 * WAF client application integration in the *WAF Developer Guide*.
 */
export const getMobileSdkRelease = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetMobileSdkReleaseRequest, output: GetMobileSdkReleaseResponse, errors: [WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException, WAFNonexistentItemException] }));
/**
 ...
 * For more information about the CAPTCHA JavaScript integration, see WAF client application integration in the *WAF Developer Guide*.
 */
export const getDecryptedAPIKey = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetDecryptedAPIKeyRequest, output: GetDecryptedAPIKeyResponse, errors: [WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException, WAFInvalidResourceException, WAFNonexistentItemException] }));
/**
 * Provides high-level information for a managed rule group, including descriptions of the rules.
 */
export const describeManagedRuleGroup = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeManagedRuleGroupRequest, output: DescribeManagedRuleGroupResponse, errors: [WAFExpiredManagedRuleGroupVersionException, WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException, WAFInvalidResourceException, WAFNonexistentItemException] }));
/**
 ...
 * integration.
 */
export const createAPIKey = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateAPIKeyRequest, output: CreateAPIKeyResponse, errors: [WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException, WAFLimitsExceededException] }));
/**
 ...
 * Vendors, you can use the managed rule set APIs to provide controlled rollout of your versioned managed rule group offerings for your customers. The APIs are `ListManagedRuleSets`, `GetManagedRuleSet`, `PutManagedRuleSetVersions`, and `UpdateManagedRuleSetVersionExpiryDate`.
 */
export const getManagedRuleSet = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetManagedRuleSetRequest, output: GetManagedRuleSetResponse, errors: [WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException, WAFNonexistentItemException] }));
/**
 ...
 */
export const getSampledRequests = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetSampledRequestsRequest, output: GetSampledRequestsResponse, errors: [WAFInternalErrorException, WAFInvalidParameterException, WAFNonexistentItemException] }));
/**
 * Retrieves the specified WebACL.
 */
export const getWebACL = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetWebACLRequest, output: GetWebACLResponse, errors: [WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException, WAFNonexistentItemException] }));
/**
 ...
 */
export const putManagedRuleSetVersions = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutManagedRuleSetVersionsRequest, output: PutManagedRuleSetVersionsResponse, errors: [WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException, WAFNonexistentItemException, WAFOptimisticLockException] }));
/**
 ...
 * first.
 */
export const getRateBasedStatementManagedKeys = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetRateBasedStatementManagedKeysRequest, output: GetRateBasedStatementManagedKeysResponse, errors: [WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException, WAFNonexistentItemException, WAFUnsupportedAggregateKeyTypeException] }));
/**
 ...
 */
export const getWebACLForResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetWebACLForResourceRequest, output: GetWebACLForResourceResponse, errors: [WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException, WAFNonexistentItemException, WAFUnavailableEntityException] }));
/**
 ...
 */
export const updateIPSet = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateIPSetRequest, output: UpdateIPSetResponse, errors: [WAFDuplicateItemException, WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException, WAFLimitsExceededException, WAFNonexistentItemException, WAFOptimisticLockException] }));
/**
 ...
 */
export const deleteFirewallManagerRuleGroups = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteFirewallManagerRuleGroupsRequest, output: DeleteFirewallManagerRuleGroupsResponse, errors: [WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException, WAFNonexistentItemException, WAFOptimisticLockException] }));
/**
 ...
 * Vendors, you can use the managed rule set APIs to provide controlled rollout of your versioned managed rule group offerings for your customers. The APIs are `ListManagedRuleSets`, `GetManagedRuleSet`, `PutManagedRuleSetVersions`, and `UpdateManagedRuleSetVersionExpiryDate`.
 */
export const updateManagedRuleSetVersionExpiryDate = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateManagedRuleSetVersionExpiryDateRequest, output: UpdateManagedRuleSetVersionExpiryDateResponse, errors: [WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException, WAFNonexistentItemException, WAFOptimisticLockException] }));
/**
 * Deletes the LoggingConfiguration from the specified web ACL.
 */
export const deleteLoggingConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteLoggingConfigurationRequest, output: DeleteLoggingConfigurationResponse, errors: [WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException, WAFNonexistentItemException, WAFOptimisticLockException] }));
/**
 * Deletes the specified API key.
 * 
 * After you delete a key, it can take up to 24 hours for WAF to disallow use of the key in all regions.
 */
export const deleteAPIKey = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteAPIKeyRequest, output: DeleteAPIKeyResponse, errors: [WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException, WAFNonexistentItemException, WAFOptimisticLockException] }));
/**
 ...
 * - After you add an IP address to an IP set that is in use in a blocking rule, the new address might be blocked in one area while still allowed in another.
 */
export const updateRegexPatternSet = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateRegexPatternSetRequest, output: UpdateRegexPatternSetResponse, errors: [WAFDuplicateItemException, WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException, WAFLimitsExceededException, WAFNonexistentItemException, WAFOptimisticLockException] }));
/**
 ...
 * - After you add an IP address to an IP set that is in use in a blocking rule, the new address might be blocked in one area while still allowed in another.
 */
export const associateWebACL = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: AssociateWebACLRequest, output: AssociateWebACLResponse, errors: [WAFFeatureNotIncludedInPricingPlanException, WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException, WAFLimitsExceededException, WAFNonexistentItemException, WAFUnavailableEntityException] }));
/**
 ...
 * console.
 */
export const listTagsForResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListTagsForResourceRequest, output: ListTagsForResourceResponse, errors: [WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException, WAFNonexistentItemException, WAFTagOperationException, WAFTagOperationInternalErrorException] }));
/**
 ...
 * - After you add an IP address to an IP set that is in use in a blocking rule, the new address might be blocked in one area while still allowed in another.
 */
export const updateWebACL = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateWebACLRequest, output: UpdateWebACLResponse, errors: [WAFConfigurationWarningException, WAFDuplicateItemException, WAFExpiredManagedRuleGroupVersionException, WAFFeatureNotIncludedInPricingPlanException, WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException, WAFInvalidResourceException, WAFLimitsExceededException, WAFNonexistentItemException, WAFOptimisticLockException, WAFSubscriptionNotFoundException, WAFUnavailableEntityException] }));
/**
 * Deletes the specified IPSet.
 */
export const deleteIPSet = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteIPSetRequest, output: DeleteIPSetResponse, errors: [WAFAssociatedItemException, WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException, WAFNonexistentItemException, WAFOptimisticLockException, WAFTagOperationException, WAFTagOperationInternalErrorException] }));
/**
 * Deletes the specified RegexPatternSet.
 */
export const deleteRegexPatternSet = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteRegexPatternSetRequest, output: DeleteRegexPatternSetResponse, errors: [WAFAssociatedItemException, WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException, WAFNonexistentItemException, WAFOptimisticLockException, WAFTagOperationException, WAFTagOperationInternalErrorException] }));
/**
 * Deletes the specified RuleGroup.
 */
export const deleteRuleGroup = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteRuleGroupRequest, output: DeleteRuleGroupResponse, errors: [WAFAssociatedItemException, WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException, WAFNonexistentItemException, WAFOptimisticLockException, WAFTagOperationException, WAFTagOperationInternalErrorException] }));
/**
 ...
 */
export const deleteWebACL = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteWebACLRequest, output: DeleteWebACLResponse, errors: [WAFAssociatedItemException, WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException, WAFNonexistentItemException, WAFOptimisticLockException, WAFTagOperationException, WAFTagOperationInternalErrorException] }));
/**
 ...
 */
export const createIPSet = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateIPSetRequest, output: CreateIPSetResponse, errors: [WAFDuplicateItemException, WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException, WAFLimitsExceededException, WAFOptimisticLockException, WAFTagOperationException, WAFTagOperationInternalErrorException] }));
/**
 ...
 */
export const createRegexPatternSet = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateRegexPatternSetRequest, output: CreateRegexPatternSetResponse, errors: [WAFDuplicateItemException, WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException, WAFLimitsExceededException, WAFOptimisticLockException, WAFTagOperationException, WAFTagOperationInternalErrorException] }));
/**
 ...
 */
export const untagResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UntagResourceRequest, output: UntagResourceResponse, errors: [WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException, WAFNonexistentItemException, WAFTagOperationException, WAFTagOperationInternalErrorException] }));
/**
 ...
 * console.
 */
export const tagResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: TagResourceRequest, output: TagResourceResponse, errors: [WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException, WAFLimitsExceededException, WAFNonexistentItemException, WAFTagOperationException, WAFTagOperationInternalErrorException] }));
/**
 ...
 * - After you add an IP address to an IP set that is in use in a blocking rule, the new address might be blocked in one area while still allowed in another.
 */
export const updateRuleGroup = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateRuleGroupRequest, output: UpdateRuleGroupResponse, errors: [WAFConfigurationWarningException, WAFDuplicateItemException, WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException, WAFLimitsExceededException, WAFNonexistentItemException, WAFOptimisticLockException, WAFSubscriptionNotFoundException, WAFUnavailableEntityException] }));
/**
 * Creates a RuleGroup per the specifications provided.
 * 
 * A rule group defines a collection of rules to inspect and control web requests that you can use in a WebACL. When you create a rule group, you define an immutable capacity limit. If you update a rule group, you must stay within the capacity. This allows others to reuse the rule group with confidence in its capacity requirements.
 */
export const createRuleGroup = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateRuleGroupRequest, output: CreateRuleGroupResponse, errors: [WAFDuplicateItemException, WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException, WAFLimitsExceededException, WAFNonexistentItemException, WAFOptimisticLockException, WAFSubscriptionNotFoundException, WAFTagOperationException, WAFTagOperationInternalErrorException, WAFUnavailableEntityException] }));
/**
 * Creates a WebACL per the specifications provided.
 * 
 * A web ACL defines a collection of rules to use to inspect and control web requests. Each rule has a statement that defines what to look for in web requests and an action that WAF applies to requests that match the statement. In the web ACL, you assign a default action to take (allow, block) for any request that does not match any of the rules. The rules in a web ACL can be a combination of the types Rule, RuleGroup, and managed rule group. You can associate a web ACL with one or more Amazon Web Services resources to protect. The resource types include Amazon CloudFront distribution, Amazon API Gateway REST API, Application Load Balancer, AppSync GraphQL API, Amazon Cognito user pool, App Runner service, Amplify application, and Amazon Web Services Verified Access instance.
 */
export const createWebACL = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateWebACLRequest, output: CreateWebACLResponse, errors: [WAFConfigurationWarningException, WAFDuplicateItemException, WAFExpiredManagedRuleGroupVersionException, WAFInternalErrorException, WAFInvalidOperationException, WAFInvalidParameterException, WAFInvalidResourceException, WAFLimitsExceededException, WAFNonexistentItemException, WAFOptimisticLockException, WAFSubscriptionNotFoundException, WAFTagOperationException, WAFTagOperationInternalErrorException, WAFUnavailableEntityException] }));
/**
