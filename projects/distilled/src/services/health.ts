...
//# Schemas
export class DescribeHealthServiceStatusForOrganizationRequest extends S.Class<DescribeHealthServiceStatusForOrganizationRequest>("DescribeHealthServiceStatusForOrganizationRequest")({}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DisableHealthServiceAccessForOrganizationRequest extends S.Class<DisableHealthServiceAccessForOrganizationRequest>("DisableHealthServiceAccessForOrganizationRequest")({}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DisableHealthServiceAccessForOrganizationResponse extends S.Class<DisableHealthServiceAccessForOrganizationResponse>("DisableHealthServiceAccessForOrganizationResponse")({}) {}
export class EnableHealthServiceAccessForOrganizationRequest extends S.Class<EnableHealthServiceAccessForOrganizationRequest>("EnableHealthServiceAccessForOrganizationRequest")({}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class EnableHealthServiceAccessForOrganizationResponse extends S.Class<EnableHealthServiceAccessForOrganizationResponse>("EnableHealthServiceAccessForOrganizationResponse")({}) {}
...
export class DescribeAffectedAccountsForOrganizationRequest extends S.Class<DescribeAffectedAccountsForOrganizationRequest>("DescribeAffectedAccountsForOrganizationRequest")({eventArn: S.String, nextToken: S.optional(S.String), maxResults: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeEntityAggregatesRequest extends S.Class<DescribeEntityAggregatesRequest>("DescribeEntityAggregatesRequest")({eventArns: S.optional(EventArnsList)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeEntityAggregatesForOrganizationRequest extends S.Class<DescribeEntityAggregatesForOrganizationRequest>("DescribeEntityAggregatesForOrganizationRequest")({eventArns: OrganizationEventArnsList, awsAccountIds: S.optional(OrganizationAccountIdsList)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeEventDetailsRequest extends S.Class<DescribeEventDetailsRequest>("DescribeEventDetailsRequest")({eventArns: eventArnList, locale: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class DateTimeRange extends S.Class<DateTimeRange>("DateTimeRange")({from: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), to: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
...
export class DescribeEventsRequest extends S.Class<DescribeEventsRequest>("DescribeEventsRequest")({filter: S.optional(EventFilter), nextToken: S.optional(S.String), maxResults: S.optional(S.Number), locale: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class DescribeEventAggregatesRequest extends S.Class<DescribeEventAggregatesRequest>("DescribeEventAggregatesRequest")({filter: S.optional(EventFilter), aggregateField: S.String, maxResults: S.optional(S.Number), nextToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeEventsForOrganizationRequest extends S.Class<DescribeEventsForOrganizationRequest>("DescribeEventsForOrganizationRequest")({filter: S.optional(OrganizationEventFilter), nextToken: S.optional(S.String), maxResults: S.optional(S.Number), locale: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeEventTypesRequest extends S.Class<DescribeEventTypesRequest>("DescribeEventTypesRequest")({filter: S.optional(EventTypeFilter), locale: S.optional(S.String), nextToken: S.optional(S.String), maxResults: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class DescribeAffectedEntitiesRequest extends S.Class<DescribeAffectedEntitiesRequest>("DescribeAffectedEntitiesRequest")({filter: EntityFilter, locale: S.optional(S.String), nextToken: S.optional(S.String), maxResults: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class UnsupportedLocale extends S.TaggedError<UnsupportedLocale>()("UnsupportedLocale", {message: S.optional(S.String)}) {}
 ...
 * management account.
 */
export const describeHealthServiceStatusForOrganization = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeHealthServiceStatusForOrganizationRequest, output: DescribeHealthServiceStatusForOrganizationResponse, errors: [] }));
/**
 ...
 */
export const disableHealthServiceAccessForOrganization = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DisableHealthServiceAccessForOrganizationRequest, output: DisableHealthServiceAccessForOrganizationResponse, errors: [ConcurrentModificationException] }));
/**
 ...
 * Health events in the *Health User Guide*.
 */
export const enableHealthServiceAccessForOrganization = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: EnableHealthServiceAccessForOrganizationRequest, output: EnableHealthServiceAccessForOrganizationResponse, errors: [ConcurrentModificationException] }));
/**
 ...
 */
export const describeAffectedAccountsForOrganization = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeAffectedAccountsForOrganizationRequest, output: DescribeAffectedAccountsForOrganizationResponse, errors: [InvalidPaginationToken] }));
/**
 * Returns the number of entities that are affected by each of the specified events.
 */
export const describeEntityAggregates = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeEntityAggregatesRequest, output: DescribeEntityAggregatesResponse, errors: [] }));
/**
 * Returns a list of entity aggregates for your Organizations that are affected by each of the specified events.
 */
export const describeEntityAggregatesForOrganization = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeEntityAggregatesForOrganizationRequest, output: DescribeEntityAggregatesForOrganizationResponse, errors: [] }));
/**
 ...
 * This API operation uses pagination. Specify the `nextToken` parameter in the next request to return more results.
 */
export const describeEventAggregates = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeEventAggregatesRequest, output: DescribeEventAggregatesResponse, errors: [InvalidPaginationToken] }));
/**
 ...
 */
export const describeEventDetailsForOrganization = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeEventDetailsForOrganizationRequest, output: DescribeEventDetailsForOrganizationResponse, errors: [UnsupportedLocale] }));
/**
 ...
 * This API operation uses pagination. Specify the `nextToken` parameter in the next request to return more results.
 */
export const describeEventsForOrganization = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeEventsForOrganizationRequest, output: DescribeEventsForOrganizationResponse, errors: [InvalidPaginationToken, UnsupportedLocale] }));
/**
 ...
 * This API operation uses pagination. Specify the `nextToken` parameter in the next request to return more results.
 */
export const describeEventTypes = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeEventTypesRequest, output: DescribeEventTypesResponse, errors: [InvalidPaginationToken, UnsupportedLocale] }));
/**
 ...
 * - This API operation uses pagination. Specify the `nextToken` parameter in the next request to return more results.
 */
export const describeEvents = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeEventsRequest, output: DescribeEventsResponse, errors: [InvalidPaginationToken, UnsupportedLocale] }));
/**
 ...
 * information, see Resource- and action-based conditions in the *Health User Guide*.
 */
export const describeAffectedEntities = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeAffectedEntitiesRequest, output: DescribeAffectedEntitiesResponse, errors: [InvalidPaginationToken, UnsupportedLocale] }));
/**
 ...
 * information, see Resource- and action-based conditions in the *Health User Guide*.
 */
export const describeEventDetails = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeEventDetailsRequest, output: DescribeEventDetailsResponse, errors: [UnsupportedLocale] }));
/**
 ...
 * information, see Resource- and action-based conditions in the *Health User Guide*.
 */
export const describeAffectedEntitiesForOrganization = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeAffectedEntitiesForOrganizationRequest, output: DescribeAffectedEntitiesForOrganizationResponse, errors: [InvalidPaginationToken, UnsupportedLocale] }));
