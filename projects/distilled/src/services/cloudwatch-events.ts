...
export class CreateArchiveRequest extends S.Class<CreateArchiveRequest>("CreateArchiveRequest")({ArchiveName: S.String, EventSourceArn: S.String, Description: S.optional(S.String), EventPattern: S.optional(S.String), RetentionDays: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class UpdateArchiveRequest extends S.Class<UpdateArchiveRequest>("UpdateArchiveRequest")({ArchiveName: S.String, Description: S.optional(S.String), EventPattern: S.optional(S.String), RetentionDays: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class CreateEventBusRequest extends S.Class<CreateEventBusRequest>("CreateEventBusRequest")({Name: S.String, EventSourceName: S.optional(S.String), Tags: S.optional(TagList)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class DescribeEventBusResponse extends S.Class<DescribeEventBusResponse>("DescribeEventBusResponse")({Name: S.optional(S.String), Arn: S.optional(S.String), Policy: S.optional(S.String)}, ns) {}
...
export class PutEventsRequest extends S.Class<PutEventsRequest>("PutEventsRequest")({Entries: PutEventsRequestEntryList}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class CreateEventBusResponse extends S.Class<CreateEventBusResponse>("CreateEventBusResponse")({EventBusArn: S.optional(S.String)}, ns) {}
...
export class CreateConnectionRequest extends S.Class<CreateConnectionRequest>("CreateConnectionRequest")({Name: S.String, Description: S.optional(S.String), AuthorizationType: S.String, AuthParameters: CreateConnectionAuthRequestParameters}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
 ...
 */
export const createConnection = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateConnectionRequest, output: CreateConnectionResponse, errors: [InternalException, LimitExceededException, ResourceAlreadyExistsException] }));
/**
 ...
 */
export const updateConnection = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateConnectionRequest, output: UpdateConnectionResponse, errors: [ConcurrentModificationException, InternalException, LimitExceededException, ResourceNotFoundException] }));
/**
