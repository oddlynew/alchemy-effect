...
const svc = T.AwsApiService({ sdkId: "Service Catalog", serviceShapeName: "AWS242ServiceCatalogService" });
...
//# Schemas
export class DisableAWSOrganizationsAccessInput extends S.Class<DisableAWSOrganizationsAccessInput>("DisableAWSOrganizationsAccessInput")({}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class EnableAWSOrganizationsAccessInput extends S.Class<EnableAWSOrganizationsAccessInput>("EnableAWSOrganizationsAccessInput")({}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class GetAWSOrganizationsAccessStatusInput extends S.Class<GetAWSOrganizationsAccessStatusInput>("GetAWSOrganizationsAccessStatusInput")({}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class AcceptPortfolioShareInput extends S.Class<AcceptPortfolioShareInput>("AcceptPortfolioShareInput")({AcceptLanguage: S.optional(S.String), PortfolioId: S.String, PortfolioShareType: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class AcceptPortfolioShareOutput extends S.Class<AcceptPortfolioShareOutput>("AcceptPortfolioShareOutput")({}) {}
export class AssociateBudgetWithResourceInput extends S.Class<AssociateBudgetWithResourceInput>("AssociateBudgetWithResourceInput")({BudgetName: S.String, ResourceId: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class AssociatePrincipalWithPortfolioInput extends S.Class<AssociatePrincipalWithPortfolioInput>("AssociatePrincipalWithPortfolioInput")({AcceptLanguage: S.optional(S.String), PortfolioId: S.String, PrincipalARN: S.String, PrincipalType: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class AssociateProductWithPortfolioInput extends S.Class<AssociateProductWithPortfolioInput>("AssociateProductWithPortfolioInput")({AcceptLanguage: S.optional(S.String), ProductId: S.String, PortfolioId: S.String, SourcePortfolioId: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class AssociateTagOptionWithResourceInput extends S.Class<AssociateTagOptionWithResourceInput>("AssociateTagOptionWithResourceInput")({ResourceId: S.String, TagOptionId: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class BatchDisassociateServiceActionFromProvisioningArtifactInput extends S.Class<BatchDisassociateServiceActionFromProvisioningArtifactInput>("BatchDisassociateServiceActionFromProvisioningArtifactInput")({ServiceActionAssociations: ServiceActionAssociations, AcceptLanguage: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class CreateConstraintInput extends S.Class<CreateConstraintInput>("CreateConstraintInput")({AcceptLanguage: S.optional(S.String), PortfolioId: S.String, ProductId: S.String, Parameters: S.String, Type: S.String, Description: S.optional(S.String), IdempotencyToken: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class CreateProvisioningArtifactInput extends S.Class<CreateProvisioningArtifactInput>("CreateProvisioningArtifactInput")({AcceptLanguage: S.optional(S.String), ProductId: S.String, Parameters: ProvisioningArtifactProperties, IdempotencyToken: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class CreateTagOptionInput extends S.Class<CreateTagOptionInput>("CreateTagOptionInput")({Key: S.String, Value: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteConstraintInput extends S.Class<DeleteConstraintInput>("DeleteConstraintInput")({AcceptLanguage: S.optional(S.String), Id: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteConstraintOutput extends S.Class<DeleteConstraintOutput>("DeleteConstraintOutput")({}) {}
export class DeletePortfolioInput extends S.Class<DeletePortfolioInput>("DeletePortfolioInput")({AcceptLanguage: S.optional(S.String), Id: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class DeletePortfolioShareInput extends S.Class<DeletePortfolioShareInput>("DeletePortfolioShareInput")({AcceptLanguage: S.optional(S.String), PortfolioId: S.String, AccountId: S.optional(S.String), OrganizationNode: S.optional(OrganizationNode)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteProductInput extends S.Class<DeleteProductInput>("DeleteProductInput")({AcceptLanguage: S.optional(S.String), Id: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteProductOutput extends S.Class<DeleteProductOutput>("DeleteProductOutput")({}) {}
export class DeleteProvisionedProductPlanInput extends S.Class<DeleteProvisionedProductPlanInput>("DeleteProvisionedProductPlanInput")({AcceptLanguage: S.optional(S.String), PlanId: S.String, IgnoreErrors: S.optional(S.Boolean)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class DeleteProvisioningArtifactInput extends S.Class<DeleteProvisioningArtifactInput>("DeleteProvisioningArtifactInput")({AcceptLanguage: S.optional(S.String), ProductId: S.String, ProvisioningArtifactId: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class DeleteServiceActionInput extends S.Class<DeleteServiceActionInput>("DeleteServiceActionInput")({Id: S.String, AcceptLanguage: S.optional(S.String), IdempotencyToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteServiceActionOutput extends S.Class<DeleteServiceActionOutput>("DeleteServiceActionOutput")({}) {}
export class DeleteTagOptionInput extends S.Class<DeleteTagOptionInput>("DeleteTagOptionInput")({Id: S.String.pipe(T.HttpQuery("id"))}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteTagOptionOutput extends S.Class<DeleteTagOptionOutput>("DeleteTagOptionOutput")({}) {}
export class DescribeConstraintInput extends S.Class<DescribeConstraintInput>("DescribeConstraintInput")({AcceptLanguage: S.optional(S.String), Id: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeCopyProductStatusInput extends S.Class<DescribeCopyProductStatusInput>("DescribeCopyProductStatusInput")({AcceptLanguage: S.optional(S.String), CopyProductToken: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribePortfolioInput extends S.Class<DescribePortfolioInput>("DescribePortfolioInput")({AcceptLanguage: S.optional(S.String), Id: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribePortfolioSharesInput extends S.Class<DescribePortfolioSharesInput>("DescribePortfolioSharesInput")({PortfolioId: S.String, Type: S.String, PageToken: S.optional(S.String), PageSize: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribePortfolioShareStatusInput extends S.Class<DescribePortfolioShareStatusInput>("DescribePortfolioShareStatusInput")({PortfolioShareToken: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeProductInput extends S.Class<DescribeProductInput>("DescribeProductInput")({AcceptLanguage: S.optional(S.String), Id: S.optional(S.String), Name: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeProductAsAdminInput extends S.Class<DescribeProductAsAdminInput>("DescribeProductAsAdminInput")({AcceptLanguage: S.optional(S.String), Id: S.optional(S.String), Name: S.optional(S.String), SourcePortfolioId: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeProductViewInput extends S.Class<DescribeProductViewInput>("DescribeProductViewInput")({AcceptLanguage: S.optional(S.String), Id: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeProvisionedProductInput extends S.Class<DescribeProvisionedProductInput>("DescribeProvisionedProductInput")({AcceptLanguage: S.optional(S.String), Id: S.optional(S.String), Name: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeProvisionedProductPlanInput extends S.Class<DescribeProvisionedProductPlanInput>("DescribeProvisionedProductPlanInput")({AcceptLanguage: S.optional(S.String), PlanId: S.String, PageSize: S.optional(S.Number), PageToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeProvisioningArtifactInput extends S.Class<DescribeProvisioningArtifactInput>("DescribeProvisioningArtifactInput")({AcceptLanguage: S.optional(S.String), ProvisioningArtifactId: S.optional(S.String), ProductId: S.optional(S.String), ProvisioningArtifactName: S.optional(S.String), ProductName: S.optional(S.String), Verbose: S.optional(S.Boolean), IncludeProvisioningArtifactParameters: S.optional(S.Boolean)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class DescribeRecordInput extends S.Class<DescribeRecordInput>("DescribeRecordInput")({AcceptLanguage: S.optional(S.String), Id: S.String, PageToken: S.optional(S.String), PageSize: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeServiceActionInput extends S.Class<DescribeServiceActionInput>("DescribeServiceActionInput")({Id: S.String, AcceptLanguage: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeServiceActionExecutionParametersInput extends S.Class<DescribeServiceActionExecutionParametersInput>("DescribeServiceActionExecutionParametersInput")({ProvisionedProductId: S.String, ServiceActionId: S.String, AcceptLanguage: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeTagOptionInput extends S.Class<DescribeTagOptionInput>("DescribeTagOptionInput")({Id: S.String.pipe(T.HttpQuery("id"))}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DisassociateBudgetFromResourceInput extends S.Class<DisassociateBudgetFromResourceInput>("DisassociateBudgetFromResourceInput")({BudgetName: S.String, ResourceId: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class DisassociatePrincipalFromPortfolioInput extends S.Class<DisassociatePrincipalFromPortfolioInput>("DisassociatePrincipalFromPortfolioInput")({AcceptLanguage: S.optional(S.String), PortfolioId: S.String, PrincipalARN: S.String, PrincipalType: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class DisassociateProductFromPortfolioInput extends S.Class<DisassociateProductFromPortfolioInput>("DisassociateProductFromPortfolioInput")({AcceptLanguage: S.optional(S.String), ProductId: S.String, PortfolioId: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class DisassociateTagOptionFromResourceInput extends S.Class<DisassociateTagOptionFromResourceInput>("DisassociateTagOptionFromResourceInput")({ResourceId: S.String.pipe(T.HttpQuery("resourceId")), TagOptionId: S.String.pipe(T.HttpQuery("tagOptionId"))}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class ExecuteProvisionedProductPlanInput extends S.Class<ExecuteProvisionedProductPlanInput>("ExecuteProvisionedProductPlanInput")({AcceptLanguage: S.optional(S.String), PlanId: S.String, IdempotencyToken: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class ImportAsProvisionedProductInput extends S.Class<ImportAsProvisionedProductInput>("ImportAsProvisionedProductInput")({AcceptLanguage: S.optional(S.String), ProductId: S.String, ProvisioningArtifactId: S.String, ProvisionedProductName: S.String, PhysicalId: S.String, IdempotencyToken: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListAcceptedPortfolioSharesInput extends S.Class<ListAcceptedPortfolioSharesInput>("ListAcceptedPortfolioSharesInput")({AcceptLanguage: S.optional(S.String), PageToken: S.optional(S.String), PageSize: S.optional(S.Number), PortfolioShareType: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListBudgetsForResourceInput extends S.Class<ListBudgetsForResourceInput>("ListBudgetsForResourceInput")({AcceptLanguage: S.optional(S.String), ResourceId: S.String, PageSize: S.optional(S.Number), PageToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListConstraintsForPortfolioInput extends S.Class<ListConstraintsForPortfolioInput>("ListConstraintsForPortfolioInput")({AcceptLanguage: S.optional(S.String), PortfolioId: S.String, ProductId: S.optional(S.String), PageSize: S.optional(S.Number), PageToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListLaunchPathsInput extends S.Class<ListLaunchPathsInput>("ListLaunchPathsInput")({AcceptLanguage: S.optional(S.String), ProductId: S.String, PageSize: S.optional(S.Number), PageToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListOrganizationPortfolioAccessInput extends S.Class<ListOrganizationPortfolioAccessInput>("ListOrganizationPortfolioAccessInput")({AcceptLanguage: S.optional(S.String), PortfolioId: S.String, OrganizationNodeType: S.String, PageToken: S.optional(S.String), PageSize: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListPortfolioAccessInput extends S.Class<ListPortfolioAccessInput>("ListPortfolioAccessInput")({AcceptLanguage: S.optional(S.String), PortfolioId: S.String, OrganizationParentId: S.optional(S.String), PageToken: S.optional(S.String), PageSize: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListPortfoliosInput extends S.Class<ListPortfoliosInput>("ListPortfoliosInput")({AcceptLanguage: S.optional(S.String), PageToken: S.optional(S.String), PageSize: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListPortfoliosForProductInput extends S.Class<ListPortfoliosForProductInput>("ListPortfoliosForProductInput")({AcceptLanguage: S.optional(S.String), ProductId: S.String, PageToken: S.optional(S.String), PageSize: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListPrincipalsForPortfolioInput extends S.Class<ListPrincipalsForPortfolioInput>("ListPrincipalsForPortfolioInput")({AcceptLanguage: S.optional(S.String), PortfolioId: S.String, PageSize: S.optional(S.Number), PageToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListProvisioningArtifactsInput extends S.Class<ListProvisioningArtifactsInput>("ListProvisioningArtifactsInput")({AcceptLanguage: S.optional(S.String), ProductId: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListProvisioningArtifactsForServiceActionInput extends S.Class<ListProvisioningArtifactsForServiceActionInput>("ListProvisioningArtifactsForServiceActionInput")({ServiceActionId: S.String, PageSize: S.optional(S.Number), PageToken: S.optional(S.String), AcceptLanguage: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListResourcesForTagOptionInput extends S.Class<ListResourcesForTagOptionInput>("ListResourcesForTagOptionInput")({TagOptionId: S.String.pipe(T.HttpQuery("tagOptionId")), ResourceType: S.optional(S.String).pipe(T.HttpQuery("resourceType")), PageSize: S.optional(S.Number).pipe(T.HttpQuery("pageSize")), PageToken: S.optional(S.String).pipe(T.HttpQuery("pageToken"))}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListServiceActionsInput extends S.Class<ListServiceActionsInput>("ListServiceActionsInput")({AcceptLanguage: S.optional(S.String), PageSize: S.optional(S.Number), PageToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class ListStackInstancesForProvisionedProductInput extends S.Class<ListStackInstancesForProvisionedProductInput>("ListStackInstancesForProvisionedProductInput")({AcceptLanguage: S.optional(S.String), ProvisionedProductId: S.String, PageToken: S.optional(S.String), PageSize: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class RejectPortfolioShareInput extends S.Class<RejectPortfolioShareInput>("RejectPortfolioShareInput")({AcceptLanguage: S.optional(S.String), PortfolioId: S.String, PortfolioShareType: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class ScanProvisionedProductsInput extends S.Class<ScanProvisionedProductsInput>("ScanProvisionedProductsInput")({AcceptLanguage: S.optional(S.String), AccessLevelFilter: S.optional(AccessLevelFilter), PageSize: S.optional(S.Number), PageToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class TerminateProvisionedProductInput extends S.Class<TerminateProvisionedProductInput>("TerminateProvisionedProductInput")({ProvisionedProductName: S.optional(S.String), ProvisionedProductId: S.optional(S.String), TerminateToken: S.String, IgnoreErrors: S.optional(S.Boolean), AcceptLanguage: S.optional(S.String), RetainPhysicalResources: S.optional(S.Boolean)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class UpdateConstraintInput extends S.Class<UpdateConstraintInput>("UpdateConstraintInput")({AcceptLanguage: S.optional(S.String), Id: S.String, Description: S.optional(S.String), Parameters: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export const AddTags = S.Array(Tag);
export class UpdatePortfolioInput extends S.Class<UpdatePortfolioInput>("UpdatePortfolioInput")({AcceptLanguage: S.optional(S.String), Id: S.String, DisplayName: S.optional(S.String), Description: S.optional(S.String), ProviderName: S.optional(S.String), AddTags: S.optional(AddTags), RemoveTags: S.optional(TagKeys)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class UpdatePortfolioShareInput extends S.Class<UpdatePortfolioShareInput>("UpdatePortfolioShareInput")({AcceptLanguage: S.optional(S.String), PortfolioId: S.String, AccountId: S.optional(S.String), OrganizationNode: S.optional(OrganizationNode), ShareTagOptions: S.optional(S.Boolean), SharePrincipals: S.optional(S.Boolean)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class UpdateServiceActionInput extends S.Class<UpdateServiceActionInput>("UpdateServiceActionInput")({Id: S.String, Name: S.optional(S.String), Definition: S.optional(ServiceActionDefinitionMap), Description: S.optional(S.String), AcceptLanguage: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class UpdateTagOptionInput extends S.Class<UpdateTagOptionInput>("UpdateTagOptionInput")({Id: S.String, Value: S.optional(S.String), Active: S.optional(S.Boolean)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class PortfolioDetail extends S.Class<PortfolioDetail>("PortfolioDetail")({Id: S.optional(S.String), ARN: S.optional(S.String), DisplayName: S.optional(S.String), Description: S.optional(S.String), CreatedTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), ProviderName: S.optional(S.String)}) {}
...
export class LastSync extends S.Class<LastSync>("LastSync")({LastSyncTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), LastSyncStatus: S.optional(S.String), LastSyncStatusMessage: S.optional(S.String), LastSuccessfulSyncTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), LastSuccessfulSyncProvisioningArtifactId: S.optional(S.String)}) {}
...
export class ProductViewDetail extends S.Class<ProductViewDetail>("ProductViewDetail")({ProductViewSummary: S.optional(ProductViewSummary), Status: S.optional(S.String), ProductARN: S.optional(S.String), CreatedTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), SourceConnection: S.optional(SourceConnectionDetail)}) {}
...
export class BatchAssociateServiceActionWithProvisioningArtifactInput extends S.Class<BatchAssociateServiceActionWithProvisioningArtifactInput>("BatchAssociateServiceActionWithProvisioningArtifactInput")({ServiceActionAssociations: ServiceActionAssociations, AcceptLanguage: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class CreatePortfolioInput extends S.Class<CreatePortfolioInput>("CreatePortfolioInput")({AcceptLanguage: S.optional(S.String), DisplayName: S.String, Description: S.optional(S.String), ProviderName: S.String, Tags: S.optional(AddTags), IdempotencyToken: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class CreateServiceActionInput extends S.Class<CreateServiceActionInput>("CreateServiceActionInput")({Name: S.String, DefinitionType: S.String, Definition: ServiceActionDefinitionMap, Description: S.optional(S.String), AcceptLanguage: S.optional(S.String), IdempotencyToken: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class ProvisioningArtifact extends S.Class<ProvisioningArtifact>("ProvisioningArtifact")({Id: S.optional(S.String), Name: S.optional(S.String), Description: S.optional(S.String), CreatedTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), Guidance: S.optional(S.String)}) {}
...
export class ListRecordHistoryInput extends S.Class<ListRecordHistoryInput>("ListRecordHistoryInput")({AcceptLanguage: S.optional(S.String), AccessLevelFilter: S.optional(AccessLevelFilter), SearchFilter: S.optional(ListRecordHistorySearchFilter), PageSize: S.optional(S.Number), PageToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class ListTagOptionsInput extends S.Class<ListTagOptionsInput>("ListTagOptionsInput")({Filters: S.optional(ListTagOptionsFilters), PageSize: S.optional(S.Number), PageToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class SearchProductsInput extends S.Class<SearchProductsInput>("SearchProductsInput")({AcceptLanguage: S.optional(S.String), Filters: S.optional(ProductViewFilters), PageSize: S.optional(S.Number), SortBy: S.optional(S.String), SortOrder: S.optional(S.String), PageToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class UpdateProvisionedProductPropertiesInput extends S.Class<UpdateProvisionedProductPropertiesInput>("UpdateProvisionedProductPropertiesInput")({AcceptLanguage: S.optional(S.String), ProvisionedProductId: S.String, ProvisionedProductProperties: ProvisionedProductProperties, IdempotencyToken: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class ProvisioningArtifactSummary extends S.Class<ProvisioningArtifactSummary>("ProvisioningArtifactSummary")({Id: S.optional(S.String), Name: S.optional(S.String), Description: S.optional(S.String), CreatedTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), ProvisioningArtifactMetadata: S.optional(ProvisioningArtifactInfo)}) {}
...
export class ResourceDetail extends S.Class<ResourceDetail>("ResourceDetail")({Id: S.optional(S.String), ARN: S.optional(S.String), Name: S.optional(S.String), Description: S.optional(S.String), CreatedTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
...
export class InvalidParametersException extends S.TaggedError<InvalidParametersException>()("InvalidParametersException", {Message: S.optional(S.String)}) {}
export class DuplicateResourceException extends S.TaggedError<DuplicateResourceException>()("DuplicateResourceException", {Message: S.optional(S.String)}) {}
...
export class TagOptionNotMigratedException extends S.TaggedError<TagOptionNotMigratedException>()("TagOptionNotMigratedException", {Message: S.optional(S.String)}) {}

//# Operations
/**
 * Disassociates the specified budget from the specified resource.
 */
export const disassociateBudgetFromResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DisassociateBudgetFromResourceInput, output: DisassociateBudgetFromResourceOutput, errors: [ResourceNotFoundException] }));
/**
 * Provisions or modifies a product based on the resource changes for the specified plan.
 */
export const executeProvisionedProductPlan = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ExecuteProvisionedProductPlanInput, output: ExecuteProvisionedProductPlanOutput, errors: [InvalidParametersException, InvalidStateException, ResourceNotFoundException] }));
/**
 * This API takes either a `ProvisonedProductId` or a `ProvisionedProductName`, along with a list of one or more output keys, and responds with the key/value pairs of those outputs.
 */
export const getProvisionedProductOutputs = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetProvisionedProductOutputsInput, output: GetProvisionedProductOutputsOutput, errors: [InvalidParametersException, ResourceNotFoundException] }));
/**
 ...
 */
export const importAsProvisionedProduct = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ImportAsProvisionedProductInput, output: ImportAsProvisionedProductOutput, errors: [DuplicateResourceException, InvalidParametersException, InvalidStateException, ResourceNotFoundException] }));
/**
 ...
 */
export const listAcceptedPortfolioShares = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListAcceptedPortfolioSharesInput, output: ListAcceptedPortfolioSharesOutput, errors: [InvalidParametersException, OperationNotSupportedException] }));
/**
 * Lists all the budgets associated to the specified resource.
 */
export const listBudgetsForResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListBudgetsForResourceInput, output: ListBudgetsForResourceOutput, errors: [InvalidParametersException, ResourceNotFoundException] }));
/**
 * Lists the constraints for the specified portfolio and product.
 */
export const listConstraintsForPortfolio = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListConstraintsForPortfolioInput, output: ListConstraintsForPortfolioOutput, errors: [InvalidParametersException, ResourceNotFoundException] }));
/**
 ...
 */
export const listOrganizationPortfolioAccess = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListOrganizationPortfolioAccessInput, output: ListOrganizationPortfolioAccessOutput, errors: [InvalidParametersException, OperationNotSupportedException, ResourceNotFoundException] }));
/**
 * Lists the account IDs that have access to the specified portfolio.
 * 
 * A delegated admin can list the accounts that have access to the shared portfolio. Note that if a delegated admin is de-registered, they can no longer perform this operation.
 */
export const listPortfolioAccess = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListPortfolioAccessInput, output: ListPortfolioAccessOutput, errors: [InvalidParametersException, ResourceNotFoundException] }));
/**
 * Lists all portfolios in the catalog.
 */
export const listPortfolios = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListPortfoliosInput, output: ListPortfoliosOutput, errors: [InvalidParametersException] }));
/**
 * Lists all portfolios that the specified product is associated with.
 */
export const listPortfoliosForProduct = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListPortfoliosForProductInput, output: ListPortfoliosForProductOutput, errors: [InvalidParametersException, ResourceNotFoundException] }));
/**
 * Lists all provisioning artifacts (also known as versions) for the specified product.
 */
export const listProvisioningArtifacts = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListProvisioningArtifactsInput, output: ListProvisioningArtifactsOutput, errors: [InvalidParametersException, ResourceNotFoundException] }));
/**
 * Returns a paginated list of self-service actions associated with the specified Product ID and Provisioning Artifact ID.
 */
export const listServiceActionsForProvisioningArtifact = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListServiceActionsForProvisioningArtifactInput, output: ListServiceActionsForProvisioningArtifactOutput, errors: [InvalidParametersException, ResourceNotFoundException] }));
/**
 * Lists the provisioned products that are available (not terminated).
 * 
 * To use additional filtering, see SearchProvisionedProducts.
 */
export const scanProvisionedProducts = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ScanProvisionedProductsInput, output: ScanProvisionedProductsOutput, errors: [InvalidParametersException] }));
/**
 * Gets information about the products for the specified portfolio or all products.
 */
export const searchProductsAsAdmin = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: SearchProductsAsAdminInput, output: SearchProductsAsAdminOutput, errors: [InvalidParametersException, ResourceNotFoundException] }));
/**
 ...
 */
export const terminateProvisionedProduct = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: TerminateProvisionedProductInput, output: TerminateProvisionedProductOutput, errors: [ResourceNotFoundException] }));
/**
 * Updates the specified constraint.
 */
export const updateConstraint = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateConstraintInput, output: UpdateConstraintOutput, errors: [InvalidParametersException, ResourceNotFoundException] }));
/**
 ...
 */
export const updatePortfolioShare = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdatePortfolioShareInput, output: UpdatePortfolioShareOutput, errors: [InvalidParametersException, InvalidStateException, OperationNotSupportedException, ResourceNotFoundException] }));
/**
 * Updates the specified provisioning artifact (also known as a version) for the specified product.
 * 
 * You cannot update a provisioning artifact for a product that was shared with you.
 */
export const updateProvisioningArtifact = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateProvisioningArtifactInput, output: UpdateProvisioningArtifactOutput, errors: [InvalidParametersException, ResourceNotFoundException] }));
/**
 * Updates a self-service action.
 */
export const updateServiceAction = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateServiceActionInput, output: UpdateServiceActionOutput, errors: [InvalidParametersException, ResourceNotFoundException] }));
/**
 * Deletes the specified constraint.
 * 
 * A delegated admin is authorized to invoke this command.
 */
export const deleteConstraint = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteConstraintInput, output: DeleteConstraintOutput, errors: [InvalidParametersException, ResourceNotFoundException] }));
/**
 * Deletes the specified plan.
 */
export const deleteProvisionedProductPlan = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteProvisionedProductPlanInput, output: DeleteProvisionedProductPlanOutput, errors: [InvalidParametersException, ResourceNotFoundException] }));
/**
 ...
 */
export const deleteProvisioningArtifact = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteProvisioningArtifactInput, output: DeleteProvisioningArtifactOutput, errors: [InvalidParametersException, ResourceInUseException, ResourceNotFoundException] }));
/**
 * Deletes a self-service action.
 */
export const deleteServiceAction = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteServiceActionInput, output: DeleteServiceActionOutput, errors: [InvalidParametersException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 */
export const disassociatePrincipalFromPortfolio = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DisassociatePrincipalFromPortfolioInput, output: DisassociatePrincipalFromPortfolioOutput, errors: [InvalidParametersException, ResourceNotFoundException] }));
/**
 * Disassociates the specified product from the specified portfolio.
 * 
 * A delegated admin is authorized to invoke this command.
 */
export const disassociateProductFromPortfolio = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DisassociateProductFromPortfolioInput, output: DisassociateProductFromPortfolioOutput, errors: [InvalidParametersException, ResourceInUseException, ResourceNotFoundException] }));
/**
 * Disassociates the specified self-service action association from the specified provisioning artifact.
 */
export const disassociateServiceActionFromProvisioningArtifact = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DisassociateServiceActionFromProvisioningArtifactInput, output: DisassociateServiceActionFromProvisioningArtifactOutput, errors: [InvalidParametersException, ResourceNotFoundException] }));
/**
 * Notifies the result
 * of the terminate engine execution.
 */
export const notifyTerminateProvisionedProductEngineWorkflowResult = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: NotifyTerminateProvisionedProductEngineWorkflowResultInput, output: NotifyTerminateProvisionedProductEngineWorkflowResultOutput, errors: [InvalidParametersException, ResourceNotFoundException] }));
/**
 * Notifies the result
 * of the update engine execution.
 */
export const notifyUpdateProvisionedProductEngineWorkflowResult = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: NotifyUpdateProvisionedProductEngineWorkflowResultInput, output: NotifyUpdateProvisionedProductEngineWorkflowResultOutput, errors: [InvalidParametersException, ResourceNotFoundException] }));
/**
 ...
 */
export const getAWSOrganizationsAccessStatus = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetAWSOrganizationsAccessStatusInput, output: GetAWSOrganizationsAccessStatusOutput, errors: [OperationNotSupportedException, ResourceNotFoundException] }));
/**
 ...
 */
export const enableAWSOrganizationsAccess = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: EnableAWSOrganizationsAccessInput, output: EnableAWSOrganizationsAccessOutput, errors: [InvalidStateException, OperationNotSupportedException, ResourceNotFoundException] }));
/**
 ...
 */
export const deletePortfolioShare = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeletePortfolioShareInput, output: DeletePortfolioShareOutput, errors: [InvalidParametersException, InvalidStateException, OperationNotSupportedException, ResourceNotFoundException] }));
/**
 * Rejects an offer to share the specified portfolio.
 */
export const rejectPortfolioShare = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: RejectPortfolioShareInput, output: RejectPortfolioShareOutput, errors: [ResourceNotFoundException] }));
/**
 * Gets information about the specified constraint.
 */
export const describeConstraint = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeConstraintInput, output: DescribeConstraintOutput, errors: [ResourceNotFoundException] }));
/**
 * Gets the status of the specified copy product operation.
 */
export const describeCopyProductStatus = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeCopyProductStatusInput, output: DescribeCopyProductStatusOutput, errors: [ResourceNotFoundException] }));
/**
 * Gets information about the specified product.
 */
export const describeProductView = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeProductViewInput, output: DescribeProductViewOutput, errors: [InvalidParametersException, ResourceNotFoundException] }));
/**
 ...
 */
export const disableAWSOrganizationsAccess = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DisableAWSOrganizationsAccessInput, output: DisableAWSOrganizationsAccessOutput, errors: [InvalidStateException, OperationNotSupportedException, ResourceNotFoundException] }));
/**
 * Accepts an offer to share the specified portfolio.
 */
export const acceptPortfolioShare = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: AcceptPortfolioShareInput, output: AcceptPortfolioShareOutput, errors: [InvalidParametersException, LimitExceededException, ResourceNotFoundException] }));
/**
 * Associates multiple self-service actions with provisioning artifacts.
 */
export const batchAssociateServiceActionWithProvisioningArtifact = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: BatchAssociateServiceActionWithProvisioningArtifactInput, output: BatchAssociateServiceActionWithProvisioningArtifactOutput, errors: [InvalidParametersException] }));
/**
 * Disassociates a batch of self-service actions from the specified provisioning artifact.
 */
export const batchDisassociateServiceActionFromProvisioningArtifact = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: BatchDisassociateServiceActionFromProvisioningArtifactInput, output: BatchDisassociateServiceActionFromProvisioningArtifactOutput, errors: [InvalidParametersException] }));
/**
 ...
 */
export const copyProduct = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CopyProductInput, output: CopyProductOutput, errors: [InvalidParametersException, ResourceNotFoundException] }));
/**
 * Creates a constraint.
 * 
 * A delegated admin is authorized to invoke this command.
 */
export const createConstraint = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateConstraintInput, output: CreateConstraintOutput, errors: [DuplicateResourceException, InvalidParametersException, LimitExceededException, ResourceNotFoundException] }));
/**
 ...
 * the `PrincipalARN` must already exist in the recipient account before it can be associated.
 */
export const createPortfolioShare = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreatePortfolioShareInput, output: CreatePortfolioShareOutput, errors: [InvalidParametersException, InvalidStateException, LimitExceededException, OperationNotSupportedException, ResourceNotFoundException] }));
/**
 * Creates a plan.
 * 
 ...
 */
export const createProvisionedProductPlan = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateProvisionedProductPlanInput, output: CreateProvisionedProductPlanOutput, errors: [InvalidParametersException, InvalidStateException, ResourceNotFoundException] }));
/**
 ...
 */
export const createProvisioningArtifact = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateProvisioningArtifactInput, output: CreateProvisioningArtifactOutput, errors: [InvalidParametersException, LimitExceededException, ResourceNotFoundException] }));
/**
 * Creates a self-service action.
 */
export const createServiceAction = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateServiceActionInput, output: CreateServiceActionOutput, errors: [InvalidParametersException, LimitExceededException] }));
/**
 * Gets information about the specified portfolio.
 * 
 * A delegated admin is authorized to invoke this command.
 */
export const describePortfolio = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribePortfolioInput, output: DescribePortfolioOutput, errors: [ResourceNotFoundException] }));
/**
 ...
 */
export const describePortfolioShares = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribePortfolioSharesInput, output: DescribePortfolioSharesOutput, errors: [InvalidParametersException, ResourceNotFoundException] }));
/**
 * Gets information about the specified product.
 * 
 ...
 */
export const describeProduct = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeProductInput, output: DescribeProductOutput, errors: [InvalidParametersException, ResourceNotFoundException] }));
/**
 * Gets information about the specified provisioned product.
 */
export const describeProvisionedProduct = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeProvisionedProductInput, output: DescribeProvisionedProductOutput, errors: [InvalidParametersException, ResourceNotFoundException] }));
/**
 ...
 */
export const describeProvisioningParameters = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeProvisioningParametersInput, output: DescribeProvisioningParametersOutput, errors: [InvalidParametersException, ResourceNotFoundException] }));
/**
 * Describes a self-service action.
 */
export const describeServiceAction = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeServiceActionInput, output: DescribeServiceActionOutput, errors: [ResourceNotFoundException] }));
/**
 * Finds the default parameters for a specific self-service action on a specific provisioned product and returns a map of the results to the user.
 */
export const describeServiceActionExecutionParameters = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeServiceActionExecutionParametersInput, output: DescribeServiceActionExecutionParametersOutput, errors: [InvalidParametersException, ResourceNotFoundException] }));
/**
 * Executes a self-service action against a provisioned product.
 */
export const executeProvisionedProductServiceAction = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ExecuteProvisionedProductServiceActionInput, output: ExecuteProvisionedProductServiceActionOutput, errors: [InvalidParametersException, InvalidStateException, ResourceNotFoundException] }));
/**
 * Lists the paths
 ...
 */
export const listLaunchPaths = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListLaunchPathsInput, output: ListLaunchPathsOutput, errors: [InvalidParametersException, ResourceNotFoundException] }));
/**
 * Lists all `PrincipalARN`s and corresponding `PrincipalType`s associated with the specified portfolio.
 */
export const listPrincipalsForPortfolio = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListPrincipalsForPortfolioInput, output: ListPrincipalsForPortfolioOutput, errors: [InvalidParametersException, ResourceNotFoundException] }));
/**
 * Lists all provisioning artifacts (also known as versions) for the specified self-service action.
 */
export const listProvisioningArtifactsForServiceAction = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListProvisioningArtifactsForServiceActionInput, output: ListProvisioningArtifactsForServiceActionOutput, errors: [InvalidParametersException, ResourceNotFoundException] }));
/**
 * Lists the specified requests or all performed requests.
 */
export const listRecordHistory = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListRecordHistoryInput, output: ListRecordHistoryOutput, errors: [InvalidParametersException] }));
/**
 * Lists all self-service actions.
 */
export const listServiceActions = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListServiceActionsInput, output: ListServiceActionsOutput, errors: [InvalidParametersException] }));
/**
 ...
 */
export const listStackInstancesForProvisionedProduct = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListStackInstancesForProvisionedProductInput, output: ListStackInstancesForProvisionedProductOutput, errors: [InvalidParametersException, ResourceNotFoundException] }));
/**
 * Notifies the result
 * of the provisioning engine execution.
 */
export const notifyProvisionProductEngineWorkflowResult = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: NotifyProvisionProductEngineWorkflowResultInput, output: NotifyProvisionProductEngineWorkflowResultOutput, errors: [InvalidParametersException, ResourceNotFoundException] }));
/**
 ...
 * in the *Service Catalog User Guide*.
 */
export const provisionProduct = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ProvisionProductInput, output: ProvisionProductOutput, errors: [DuplicateResourceException, InvalidParametersException, ResourceNotFoundException] }));
/**
 * Updates the specified product.
 */
export const updateProduct = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateProductInput, output: UpdateProductOutput, errors: [InvalidParametersException, ResourceNotFoundException, TagOptionNotMigratedException] }));
/**
 ...
 * You can check the status of this request using DescribeRecord.
 */
export const updateProvisionedProduct = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateProvisionedProductInput, output: UpdateProvisionedProductOutput, errors: [InvalidParametersException, ResourceNotFoundException] }));
/**
 * Requests updates to the properties of the specified provisioned product.
 */
export const updateProvisionedProductProperties = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateProvisionedProductPropertiesInput, output: UpdateProvisionedProductPropertiesOutput, errors: [InvalidParametersException, InvalidStateException, ResourceNotFoundException] }));
/**
 * Associates the specified budget with the specified resource.
 */
export const associateBudgetWithResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: AssociateBudgetWithResourceInput, output: AssociateBudgetWithResourceOutput, errors: [DuplicateResourceException, InvalidParametersException, LimitExceededException, ResourceNotFoundException] }));
/**
 * Updates the specified portfolio.
 * 
 * You cannot update a product that was shared with you.
 */
export const updatePortfolio = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdatePortfolioInput, output: UpdatePortfolioOutput, errors: [InvalidParametersException, LimitExceededException, ResourceNotFoundException, TagOptionNotMigratedException] }));
/**
 ...
 * the `PrincipalARN` must already exist in the recipient account before it can be associated.
 */
export const associatePrincipalWithPortfolio = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: AssociatePrincipalWithPortfolioInput, output: AssociatePrincipalWithPortfolioOutput, errors: [InvalidParametersException, LimitExceededException, ResourceNotFoundException] }));
/**
 * Associates the specified product with the specified portfolio.
 * 
 * A delegated admin is authorized to invoke this command.
 */
export const associateProductWithPortfolio = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: AssociateProductWithPortfolioInput, output: AssociateProductWithPortfolioOutput, errors: [InvalidParametersException, LimitExceededException, ResourceNotFoundException] }));
/**
 * Associates a self-service action with a provisioning artifact.
 */
export const associateServiceActionWithProvisioningArtifact = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: AssociateServiceActionWithProvisioningArtifactInput, output: AssociateServiceActionWithProvisioningArtifactOutput, errors: [DuplicateResourceException, InvalidParametersException, LimitExceededException, ResourceNotFoundException] }));
/**
 * Associate the specified TagOption with the specified portfolio or product.
 */
export const associateTagOptionWithResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: AssociateTagOptionWithResourceInput, output: AssociateTagOptionWithResourceOutput, errors: [DuplicateResourceException, InvalidParametersException, InvalidStateException, LimitExceededException, ResourceNotFoundException, TagOptionNotMigratedException] }));
/**
 * Updates the specified TagOption.
 */
export const updateTagOption = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateTagOptionInput, output: UpdateTagOptionOutput, errors: [DuplicateResourceException, InvalidParametersException, ResourceNotFoundException, TagOptionNotMigratedException] }));
/**
 ...
 * A delegated admin is authorized to invoke this command.
 */
export const deletePortfolio = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeletePortfolioInput, output: DeletePortfolioOutput, errors: [InvalidParametersException, ResourceInUseException, ResourceNotFoundException, TagOptionNotMigratedException] }));
/**
 ...
 * A delegated admin is authorized to invoke this command.
 */
export const deleteProduct = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteProductInput, output: DeleteProductOutput, errors: [InvalidParametersException, ResourceInUseException, ResourceNotFoundException, TagOptionNotMigratedException] }));
/**
 * Disassociates the specified TagOption from the specified resource.
 */
export const disassociateTagOptionFromResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DisassociateTagOptionFromResourceInput, output: DisassociateTagOptionFromResourceOutput, errors: [ResourceNotFoundException, TagOptionNotMigratedException] }));
/**
 * Deletes the specified TagOption.
 * 
 * You cannot delete a TagOption if it is associated with a product or portfolio.
 */
export const deleteTagOption = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteTagOptionInput, output: DeleteTagOptionOutput, errors: [ResourceInUseException, ResourceNotFoundException, TagOptionNotMigratedException] }));
/**
 * Gets information about the specified TagOption.
 */
export const describeTagOption = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeTagOptionInput, output: DescribeTagOptionOutput, errors: [ResourceNotFoundException, TagOptionNotMigratedException] }));
/**
 * Creates a portfolio.
 * 
 * A delegated admin is authorized to invoke this command.
 */
export const createPortfolio = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreatePortfolioInput, output: CreatePortfolioOutput, errors: [InvalidParametersException, LimitExceededException, TagOptionNotMigratedException] }));
/**
 * Creates a TagOption.
 */
export const createTagOption = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateTagOptionInput, output: CreateTagOptionOutput, errors: [DuplicateResourceException, LimitExceededException, TagOptionNotMigratedException] }));
/**
 * Lists the resources associated with the specified TagOption.
 */
export const listResourcesForTagOption = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListResourcesForTagOptionInput, output: ListResourcesForTagOptionOutput, errors: [InvalidParametersException, ResourceNotFoundException, TagOptionNotMigratedException] }));
/**
 * Lists the specified TagOptions or all TagOptions.
 */
export const listTagOptions = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListTagOptionsInput, output: ListTagOptionsOutput, errors: [InvalidParametersException, TagOptionNotMigratedException] }));
/**
 ...
 */
export const describePortfolioShareStatus = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribePortfolioShareStatusInput, output: DescribePortfolioShareStatusOutput, errors: [InvalidParametersException, OperationNotSupportedException, ResourceNotFoundException] }));
/**
 * Gets information about the specified provisioning artifact (also known as a version) for the specified product.
 */
export const describeProvisioningArtifact = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeProvisioningArtifactInput, output: DescribeProvisioningArtifactOutput, errors: [InvalidParametersException, ResourceNotFoundException] }));
/**
 ...
 */
export const describeRecord = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeRecordInput, output: DescribeRecordOutput, errors: [ResourceNotFoundException] }));
/**
 * Lists the plans for the specified provisioned product or all plans to which the user has access.
 */
export const listProvisionedProductPlans = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListProvisionedProductPlansInput, output: ListProvisionedProductPlansOutput, errors: [InvalidParametersException, ResourceNotFoundException] }));
/**
 * Gets information about the provisioned products that meet the specified criteria.
 */
export const searchProvisionedProducts = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: SearchProvisionedProductsInput, output: SearchProvisionedProductsOutput, errors: [InvalidParametersException] }));
/**
 * Creates a product.
 * 
 * A delegated admin is authorized to invoke this command.
 ...
 */
export const createProduct = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateProductInput, output: CreateProductOutput, errors: [InvalidParametersException, LimitExceededException, TagOptionNotMigratedException] }));
/**
 * Gets information about the specified product. This operation is run with administrator access.
 */
export const describeProductAsAdmin = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeProductAsAdminInput, output: DescribeProductAsAdminOutput, errors: [InvalidParametersException, ResourceNotFoundException] }));
/**
 * Gets information about the resource changes for the specified plan.
 */
export const describeProvisionedProductPlan = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeProvisionedProductPlanInput, output: DescribeProvisionedProductPlanOutput, errors: [InvalidParametersException, ResourceNotFoundException] }));
/**
 * Gets information about the products to which the caller has access.
 */
export const searchProducts = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: SearchProductsInput, output: SearchProductsOutput, errors: [InvalidParametersException] }));
