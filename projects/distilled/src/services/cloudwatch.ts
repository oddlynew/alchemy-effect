...
const svc = T.AwsApiService({ sdkId: "CloudWatch", serviceShapeName: "GraniteServiceVersion20100801" });
...
export class DeleteAlarmsInput extends S.Class<DeleteAlarmsInput>("DeleteAlarmsInput")({AlarmNames: AlarmNames}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteAlarmsResponse extends S.Class<DeleteAlarmsResponse>("DeleteAlarmsResponse")({}, ns) {}
export class DeleteDashboardsInput extends S.Class<DeleteDashboardsInput>("DeleteDashboardsInput")({DashboardNames: DashboardNames}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteDashboardsOutput extends S.Class<DeleteDashboardsOutput>("DeleteDashboardsOutput")({}, ns) {}
export class DeleteInsightRulesInput extends S.Class<DeleteInsightRulesInput>("DeleteInsightRulesInput")({RuleNames: InsightRuleNames}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteMetricStreamInput extends S.Class<DeleteMetricStreamInput>("DeleteMetricStreamInput")({Name: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteMetricStreamOutput extends S.Class<DeleteMetricStreamOutput>("DeleteMetricStreamOutput")({}, ns) {}
export class DescribeAlarmContributorsInput extends S.Class<DescribeAlarmContributorsInput>("DescribeAlarmContributorsInput")({AlarmName: S.String, NextToken: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeAlarmHistoryInput extends S.Class<DescribeAlarmHistoryInput>("DescribeAlarmHistoryInput")({AlarmName: S.optional(S.String), AlarmContributorId: S.optional(S.String), AlarmTypes: S.optional(AlarmTypes), HistoryItemType: S.optional(S.String), StartDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), EndDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), MaxRecords: S.optional(S.Number), NextToken: S.optional(S.String), ScanBy: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class DescribeAnomalyDetectorsInput extends S.Class<DescribeAnomalyDetectorsInput>("DescribeAnomalyDetectorsInput")({NextToken: S.optional(S.String), MaxResults: S.optional(S.Number), Namespace: S.optional(S.String), MetricName: S.optional(S.String), Dimensions: S.optional(Dimensions), AnomalyDetectorTypes: S.optional(AnomalyDetectorTypes)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeInsightRulesInput extends S.Class<DescribeInsightRulesInput>("DescribeInsightRulesInput")({NextToken: S.optional(S.String), MaxResults: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DisableAlarmActionsInput extends S.Class<DisableAlarmActionsInput>("DisableAlarmActionsInput")({AlarmNames: AlarmNames}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DisableAlarmActionsResponse extends S.Class<DisableAlarmActionsResponse>("DisableAlarmActionsResponse")({}, ns) {}
export class DisableInsightRulesInput extends S.Class<DisableInsightRulesInput>("DisableInsightRulesInput")({RuleNames: InsightRuleNames}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class EnableAlarmActionsInput extends S.Class<EnableAlarmActionsInput>("EnableAlarmActionsInput")({AlarmNames: AlarmNames}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class EnableAlarmActionsResponse extends S.Class<EnableAlarmActionsResponse>("EnableAlarmActionsResponse")({}, ns) {}
export class EnableInsightRulesInput extends S.Class<EnableInsightRulesInput>("EnableInsightRulesInput")({RuleNames: InsightRuleNames}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetDashboardInput extends S.Class<GetDashboardInput>("GetDashboardInput")({DashboardName: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetInsightRuleReportInput extends S.Class<GetInsightRuleReportInput>("GetInsightRuleReportInput")({RuleName: S.String, StartTime: S.Date.pipe(T.TimestampFormat("epoch-seconds")), EndTime: S.Date.pipe(T.TimestampFormat("epoch-seconds")), Period: S.Number, MaxContributorCount: S.optional(S.Number), Metrics: S.optional(InsightRuleMetricList), OrderBy: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetMetricStatisticsInput extends S.Class<GetMetricStatisticsInput>("GetMetricStatisticsInput")({Namespace: S.String, MetricName: S.String, Dimensions: S.optional(Dimensions), StartTime: S.Date.pipe(T.TimestampFormat("epoch-seconds")), EndTime: S.Date.pipe(T.TimestampFormat("epoch-seconds")), Period: S.Number, Statistics: S.optional(Statistics), ExtendedStatistics: S.optional(ExtendedStatistics), Unit: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetMetricStreamInput extends S.Class<GetMetricStreamInput>("GetMetricStreamInput")({Name: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetMetricWidgetImageInput extends S.Class<GetMetricWidgetImageInput>("GetMetricWidgetImageInput")({MetricWidget: S.String, OutputFormat: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListDashboardsInput extends S.Class<ListDashboardsInput>("ListDashboardsInput")({DashboardNamePrefix: S.optional(S.String), NextToken: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListManagedInsightRulesInput extends S.Class<ListManagedInsightRulesInput>("ListManagedInsightRulesInput")({ResourceARN: S.String, NextToken: S.optional(S.String), MaxResults: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListMetricStreamsInput extends S.Class<ListMetricStreamsInput>("ListMetricStreamsInput")({NextToken: S.optional(S.String), MaxResults: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListTagsForResourceInput extends S.Class<ListTagsForResourceInput>("ListTagsForResourceInput")({ResourceARN: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutDashboardInput extends S.Class<PutDashboardInput>("PutDashboardInput")({DashboardName: S.String, DashboardBody: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class Tag extends S.Class<Tag>("Tag")({Key: S.String, Value: S.String}) {}
export const TagList = S.Array(Tag);
export class PutInsightRuleInput extends S.Class<PutInsightRuleInput>("PutInsightRuleInput")({RuleName: S.String, RuleState: S.optional(S.String), RuleDefinition: S.String, Tags: S.optional(TagList), ApplyOnTransformedLogs: S.optional(S.Boolean)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutInsightRuleOutput extends S.Class<PutInsightRuleOutput>("PutInsightRuleOutput")({}, ns) {}
...
export class PutMetricAlarmResponse extends S.Class<PutMetricAlarmResponse>("PutMetricAlarmResponse")({}, ns) {}
export class SetAlarmStateInput extends S.Class<SetAlarmStateInput>("SetAlarmStateInput")({AlarmName: S.String, StateValue: S.String, StateReason: S.String, StateReasonData: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class SetAlarmStateResponse extends S.Class<SetAlarmStateResponse>("SetAlarmStateResponse")({}, ns) {}
export class StartMetricStreamsInput extends S.Class<StartMetricStreamsInput>("StartMetricStreamsInput")({Names: MetricStreamNames}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class StartMetricStreamsOutput extends S.Class<StartMetricStreamsOutput>("StartMetricStreamsOutput")({}, ns) {}
export class StopMetricStreamsInput extends S.Class<StopMetricStreamsInput>("StopMetricStreamsInput")({Names: MetricStreamNames}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class StopMetricStreamsOutput extends S.Class<StopMetricStreamsOutput>("StopMetricStreamsOutput")({}, ns) {}
export class TagResourceInput extends S.Class<TagResourceInput>("TagResourceInput")({ResourceARN: S.String, Tags: TagList}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class TagResourceOutput extends S.Class<TagResourceOutput>("TagResourceOutput")({}, ns) {}
export class UntagResourceInput extends S.Class<UntagResourceInput>("UntagResourceInput")({ResourceARN: S.String, TagKeys: TagKeyList}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class UntagResourceOutput extends S.Class<UntagResourceOutput>("UntagResourceOutput")({}, ns) {}
...
export class DisableInsightRulesOutput extends S.Class<DisableInsightRulesOutput>("DisableInsightRulesOutput")({Failures: S.optional(BatchFailures)}, ns) {}
export class EnableInsightRulesOutput extends S.Class<EnableInsightRulesOutput>("EnableInsightRulesOutput")({Failures: S.optional(BatchFailures)}, ns) {}
export class GetDashboardOutput extends S.Class<GetDashboardOutput>("GetDashboardOutput")({DashboardArn: S.optional(S.String), DashboardBody: S.optional(S.String), DashboardName: S.optional(S.String)}, ns) {}
...
export class GetMetricStreamOutput extends S.Class<GetMetricStreamOutput>("GetMetricStreamOutput")({Arn: S.optional(S.String), Name: S.optional(S.String), IncludeFilters: S.optional(MetricStreamFilters), ExcludeFilters: S.optional(MetricStreamFilters), FirehoseArn: S.optional(S.String), RoleArn: S.optional(S.String), State: S.optional(S.String), CreationDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), LastUpdateDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), OutputFormat: S.optional(S.String), StatisticsConfigurations: S.optional(MetricStreamStatisticsConfigurations), IncludeLinkedAccountsMetrics: S.optional(S.Boolean)}, ns) {}
export class GetMetricWidgetImageOutput extends S.Class<GetMetricWidgetImageOutput>("GetMetricWidgetImageOutput")({MetricWidgetImage: S.optional(T.Blob)}, ns) {}
...
export class PutCompositeAlarmInput extends S.Class<PutCompositeAlarmInput>("PutCompositeAlarmInput")({ActionsEnabled: S.optional(S.Boolean), AlarmActions: S.optional(ResourceList), AlarmDescription: S.optional(S.String), AlarmName: S.String, AlarmRule: S.String, InsufficientDataActions: S.optional(ResourceList), OKActions: S.optional(ResourceList), Tags: S.optional(TagList), ActionsSuppressor: S.optional(S.String), ActionsSuppressorWaitPeriod: S.optional(S.Number), ActionsSuppressorExtensionPeriod: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutCompositeAlarmResponse extends S.Class<PutCompositeAlarmResponse>("PutCompositeAlarmResponse")({}, ns) {}
export class PutManagedInsightRulesInput extends S.Class<PutManagedInsightRulesInput>("PutManagedInsightRulesInput")({ManagedRules: ManagedRules}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export const InsightRuleContributorKeys = S.Array(S.String);
export class Range extends S.Class<Range>("Range")({StartTime: S.Date.pipe(T.TimestampFormat("epoch-seconds")), EndTime: S.Date.pipe(T.TimestampFormat("epoch-seconds"))}) {}
...
export class InsightRuleMetricDatapoint extends S.Class<InsightRuleMetricDatapoint>("InsightRuleMetricDatapoint")({Timestamp: S.Date.pipe(T.TimestampFormat("epoch-seconds")), UniqueContributors: S.optional(S.Number), MaxContributorValue: S.optional(S.Number), SampleCount: S.optional(S.Number), Average: S.optional(S.Number), Sum: S.optional(S.Number), Minimum: S.optional(S.Number), Maximum: S.optional(S.Number)}) {}
export const InsightRuleMetricDatapoints = S.Array(InsightRuleMetricDatapoint);
export class DashboardEntry extends S.Class<DashboardEntry>("DashboardEntry")({DashboardName: S.optional(S.String), DashboardArn: S.optional(S.String), LastModified: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), Size: S.optional(S.Number)}) {}
...
export class MetricDatum extends S.Class<MetricDatum>("MetricDatum")({MetricName: S.String, Dimensions: S.optional(Dimensions), Timestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), Value: S.optional(S.Number), StatisticValues: S.optional(StatisticSet), Values: S.optional(Values), Counts: S.optional(Counts), Unit: S.optional(S.String), StorageResolution: S.optional(S.Number)}) {}
...
export class DeleteInsightRulesOutput extends S.Class<DeleteInsightRulesOutput>("DeleteInsightRulesOutput")({Failures: S.optional(BatchFailures)}, ns) {}
export class DescribeAlarmHistoryOutput extends S.Class<DescribeAlarmHistoryOutput>("DescribeAlarmHistoryOutput")({AlarmHistoryItems: S.optional(AlarmHistoryItems), NextToken: S.optional(S.String)}, ns) {}
export class DescribeAlarmsOutput extends S.Class<DescribeAlarmsOutput>("DescribeAlarmsOutput")({CompositeAlarms: S.optional(CompositeAlarms), MetricAlarms: S.optional(MetricAlarms), NextToken: S.optional(S.String)}, ns) {}
export class DescribeAnomalyDetectorsOutput extends S.Class<DescribeAnomalyDetectorsOutput>("DescribeAnomalyDetectorsOutput")({AnomalyDetectors: S.optional(AnomalyDetectors), NextToken: S.optional(S.String)}, ns) {}
export class DescribeInsightRulesOutput extends S.Class<DescribeInsightRulesOutput>("DescribeInsightRulesOutput")({NextToken: S.optional(S.String), InsightRules: S.optional(InsightRules)}, ns) {}
export class ListDashboardsOutput extends S.Class<ListDashboardsOutput>("ListDashboardsOutput")({DashboardEntries: S.optional(DashboardEntries), NextToken: S.optional(S.String)}, ns) {}
export class ListMetricsOutput extends S.Class<ListMetricsOutput>("ListMetricsOutput")({Metrics: S.optional(Metrics), NextToken: S.optional(S.String), OwningAccounts: S.optional(OwningAccounts)}, ns) {}
export class ListMetricStreamsOutput extends S.Class<ListMetricStreamsOutput>("ListMetricStreamsOutput")({NextToken: S.optional(S.String), Entries: S.optional(MetricStreamEntries)}, ns) {}
export class PutAnomalyDetectorInput extends S.Class<PutAnomalyDetectorInput>("PutAnomalyDetectorInput")({Namespace: S.optional(S.String), MetricName: S.optional(S.String), Dimensions: S.optional(Dimensions), Stat: S.optional(S.String), Configuration: S.optional(AnomalyDetectorConfiguration), MetricCharacteristics: S.optional(MetricCharacteristics), SingleMetricAnomalyDetector: S.optional(SingleMetricAnomalyDetector), MetricMathAnomalyDetector: S.optional(MetricMathAnomalyDetector)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutAnomalyDetectorOutput extends S.Class<PutAnomalyDetectorOutput>("PutAnomalyDetectorOutput")({}, ns) {}
export class PutDashboardOutput extends S.Class<PutDashboardOutput>("PutDashboardOutput")({DashboardValidationMessages: S.optional(DashboardValidationMessages)}, ns) {}
export class PutManagedInsightRulesOutput extends S.Class<PutManagedInsightRulesOutput>("PutManagedInsightRulesOutput")({Failures: S.optional(BatchFailures)}, ns) {}
export class PutMetricStreamInput extends S.Class<PutMetricStreamInput>("PutMetricStreamInput")({Name: S.String, IncludeFilters: S.optional(MetricStreamFilters), ExcludeFilters: S.optional(MetricStreamFilters), FirehoseArn: S.String, RoleArn: S.String, OutputFormat: S.String, Tags: S.optional(TagList), StatisticsConfigurations: S.optional(MetricStreamStatisticsConfigurations), IncludeLinkedAccountsMetrics: S.optional(S.Boolean)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class InsightRuleContributorDatapoint extends S.Class<InsightRuleContributorDatapoint>("InsightRuleContributorDatapoint")({Timestamp: S.Date.pipe(T.TimestampFormat("epoch-seconds")), ApproximateValue: S.Number}) {}
...
export class AlarmContributor extends S.Class<AlarmContributor>("AlarmContributor")({ContributorId: S.String, ContributorAttributes: ContributorAttributes, StateReason: S.String, StateTransitionedTimestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
...
export class Datapoint extends S.Class<Datapoint>("Datapoint")({Timestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), SampleCount: S.optional(S.Number), Average: S.optional(S.Number), Sum: S.optional(S.Number), Minimum: S.optional(S.Number), Maximum: S.optional(S.Number), Unit: S.optional(S.String), ExtendedStatistics: S.optional(DatapointValueMap)}) {}
...
export class DescribeAlarmContributorsOutput extends S.Class<DescribeAlarmContributorsOutput>("DescribeAlarmContributorsOutput")({AlarmContributors: AlarmContributors, NextToken: S.optional(S.String)}, ns) {}
export class GetInsightRuleReportOutput extends S.Class<GetInsightRuleReportOutput>("GetInsightRuleReportOutput")({KeyLabels: S.optional(InsightRuleContributorKeyLabels), AggregationStatistic: S.optional(S.String), AggregateValue: S.optional(S.Number), ApproximateUniqueCount: S.optional(S.Number), Contributors: S.optional(InsightRuleContributors), MetricDatapoints: S.optional(InsightRuleMetricDatapoints)}, ns) {}
export class GetMetricDataInput extends S.Class<GetMetricDataInput>("GetMetricDataInput")({MetricDataQueries: MetricDataQueries, StartTime: S.Date.pipe(T.TimestampFormat("epoch-seconds")), EndTime: S.Date.pipe(T.TimestampFormat("epoch-seconds")), NextToken: S.optional(S.String), ScanBy: S.optional(S.String), MaxDatapoints: S.optional(S.Number), LabelOptions: S.optional(LabelOptions)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetMetricStatisticsOutput extends S.Class<GetMetricStatisticsOutput>("GetMetricStatisticsOutput")({Label: S.optional(S.String), Datapoints: S.optional(Datapoints)}, ns) {}
export class ListManagedInsightRulesOutput extends S.Class<ListManagedInsightRulesOutput>("ListManagedInsightRulesOutput")({ManagedRules: S.optional(ManagedRuleDescriptions), NextToken: S.optional(S.String)}, ns) {}
export class PutMetricDataInput extends S.Class<PutMetricDataInput>("PutMetricDataInput")({Namespace: S.String, MetricData: S.optional(MetricData), EntityMetricData: S.optional(EntityMetricDataList), StrictEntityValidation: S.optional(S.Boolean)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutMetricDataResponse extends S.Class<PutMetricDataResponse>("PutMetricDataResponse")({}, ns) {}
export class PutMetricStreamOutput extends S.Class<PutMetricStreamOutput>("PutMetricStreamOutput")({Arn: S.optional(S.String)}, ns) {}
...
export class GetMetricDataOutput extends S.Class<GetMetricDataOutput>("GetMetricDataOutput")({MetricDataResults: S.optional(MetricDataResults), NextToken: S.optional(S.String), Messages: S.optional(MetricDataResultMessages)}, ns) {}

//# Errors
export class ResourceNotFound extends S.TaggedError<ResourceNotFound>()("ResourceNotFound", {message: S.optional(S.String)}, T.AwsQueryError({ code: "ResourceNotFound", httpResponseCode: 404 })) {}
export class ConflictException extends S.TaggedError<ConflictException>()("ConflictException", {Message: S.optional(S.String)}) {}
export class InternalServiceFault extends S.TaggedError<InternalServiceFault>()("InternalServiceFault", {Message: S.optional(S.String)}, T.AwsQueryError({ code: "InternalServiceError", httpResponseCode: 500 })).pipe(withCategory(ERROR_CATEGORIES.SERVER_ERROR)) {}
...
export class InvalidFormatFault extends S.TaggedError<InvalidFormatFault>()("InvalidFormatFault", {message: S.optional(S.String)}, T.AwsQueryError({ code: "InvalidFormat", httpResponseCode: 400 })) {}
export class ConcurrentModificationException extends S.TaggedError<ConcurrentModificationException>()("ConcurrentModificationException", {Message: S.optional(S.String)}, T.AwsQueryError({ code: "ConcurrentModificationException", httpResponseCode: 429 })).pipe(withCategory(ERROR_CATEGORIES.THROTTLING_ERROR)) {}
export class DashboardNotFoundError extends S.TaggedError<DashboardNotFoundError>()("DashboardNotFoundError", {message: S.optional(S.String)}, T.AwsQueryError({ code: "ResourceNotFound", httpResponseCode: 404 })) {}
...
export class LimitExceededException extends S.TaggedError<LimitExceededException>()("LimitExceededException", {Message: S.optional(S.String)}, T.AwsQueryError({ code: "LimitExceededException", httpResponseCode: 400 })) {}
export class ResourceNotFoundException extends S.TaggedError<ResourceNotFoundException>()("ResourceNotFoundException", {ResourceType: S.optional(S.String), ResourceId: S.optional(S.String), Message: S.optional(S.String)}, T.AwsQueryError({ code: "ResourceNotFoundException", httpResponseCode: 404 })) {}
export class MissingRequiredParameterException extends S.TaggedError<MissingRequiredParameterException>()("MissingRequiredParameterException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "MissingParameter", httpResponseCode: 400 })) {}
...
export class DashboardInvalidInputError extends S.TaggedError<DashboardInvalidInputError>()("DashboardInvalidInputError", {message: S.optional(S.String), dashboardValidationMessages: S.optional(DashboardValidationMessages)}, T.AwsQueryError({ code: "InvalidParameterInput", httpResponseCode: 400 })) {}
 ...
 */
export const disableAlarmActions = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DisableAlarmActionsInput, output: DisableAlarmActionsResponse, errors: [] }));
/**
 * Enables the actions for the specified alarms.
 */
export const enableAlarmActions = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: EnableAlarmActionsInput, output: EnableAlarmActionsResponse, errors: [] }));
/**
 ...
 */
export const deleteAlarms = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteAlarmsInput, output: DeleteAlarmsResponse, errors: [ResourceNotFound] }));
/**
 ...
 */
export const describeAlarmsForMetric = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeAlarmsForMetricInput, output: DescribeAlarmsForMetricOutput, errors: [] }));
/**
 ...
 */
export const getMetricWidgetImage = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetMetricWidgetImageInput, output: GetMetricWidgetImageOutput, errors: [] }));
/**
 ...
 */
export const putMetricAlarm = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutMetricAlarmInput, output: PutMetricAlarmResponse, errors: [LimitExceededFault] }));
/**
 ...
 */
export const setAlarmState = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: SetAlarmStateInput, output: SetAlarmStateResponse, errors: [InvalidFormatFault, ResourceNotFound] }));
/**
 ...
 */
export const putCompositeAlarm = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutCompositeAlarmInput, output: PutCompositeAlarmResponse, errors: [LimitExceededFault] }));
/**
 ...
 */
export const deleteDashboards = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteDashboardsInput, output: DeleteDashboardsOutput, errors: [ConflictException, DashboardNotFoundError, InternalServiceFault, InvalidParameterValueException] }));
/**
 ...
 * 1000 results.
 */
export const listDashboards = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListDashboardsInput, output: ListDashboardsOutput, errors: [InternalServiceFault, InvalidParameterValueException] }));
/**
 ...
 */
export const listMetrics = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListMetricsInput, output: ListMetricsOutput, errors: [InternalServiceFault, InvalidParameterValueException] }));
/**
 ...
 */
export const tagResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: TagResourceInput, output: TagResourceOutput, errors: [ConcurrentModificationException, ConflictException, InternalServiceFault, InvalidParameterValueException, ResourceNotFoundException] }));
/**
 ...
 */
export const getDashboard = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetDashboardInput, output: GetDashboardOutput, errors: [DashboardNotFoundError, InternalServiceFault, InvalidParameterValueException] }));
/**
 * Starts the streaming of metrics for one or more of your metric streams.
 */
export const startMetricStreams = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StartMetricStreamsInput, output: StartMetricStreamsOutput, errors: [InternalServiceFault, InvalidParameterValueException, MissingRequiredParameterException] }));
/**
 ...
 * Guide.
 */
export const deleteAnomalyDetector = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteAnomalyDetectorInput, output: DeleteAnomalyDetectorOutput, errors: [InternalServiceFault, InvalidParameterCombinationException, InvalidParameterValueException, MissingRequiredParameterException, ResourceNotFoundException] }));
/**
 * Enables the specified Contributor Insights rules. When rules are enabled, they
 * immediately begin analyzing log data.
 */
export const enableInsightRules = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: EnableInsightRulesInput, output: EnableInsightRulesOutput, errors: [InvalidParameterValueException, LimitExceededException, MissingRequiredParameterException] }));
/**
 ...
 */
export const putAnomalyDetector = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutAnomalyDetectorInput, output: PutAnomalyDetectorOutput, errors: [InternalServiceFault, InvalidParameterCombinationException, InvalidParameterValueException, LimitExceededException, MissingRequiredParameterException] }));
/**
 * Displays the tags associated with a CloudWatch resource. Currently, alarms and
 * Contributor Insights rules support tagging.
 */
export const listTagsForResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListTagsForResourceInput, output: ListTagsForResourceOutput, errors: [InternalServiceFault, InvalidParameterValueException, ResourceNotFoundException] }));
/**
 * Removes one or more tags from the specified resource.
 */
export const untagResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UntagResourceInput, output: UntagResourceOutput, errors: [ConcurrentModificationException, ConflictException, InternalServiceFault, InvalidParameterValueException, ResourceNotFoundException] }));
/**
 * Stops the streaming of metrics for one or more of your metric streams.
 */
export const stopMetricStreams = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StopMetricStreamsInput, output: StopMetricStreamsOutput, errors: [InternalServiceFault, InvalidParameterValueException, MissingRequiredParameterException] }));
/**
 * Permanently deletes the metric stream that you specify.
 */
export const deleteMetricStream = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteMetricStreamInput, output: DeleteMetricStreamOutput, errors: [InternalServiceFault, InvalidParameterValueException, MissingRequiredParameterException] }));
/**
 ...
 */
export const disableInsightRules = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DisableInsightRulesInput, output: DisableInsightRulesOutput, errors: [InvalidParameterValueException, MissingRequiredParameterException] }));
/**
 ...
 */
export const deleteInsightRules = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteInsightRulesInput, output: DeleteInsightRulesOutput, errors: [InvalidParameterValueException, MissingRequiredParameterException] }));
/**
 * Returns information about the metric stream that you specify.
 */
export const getMetricStream = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetMetricStreamInput, output: GetMetricStreamOutput, errors: [InternalServiceFault, InvalidParameterCombinationException, InvalidParameterValueException, MissingRequiredParameterException, ResourceNotFoundException] }));
/**
 ...
 * data from the first time the rule was created might not be available.
 */
export const putInsightRule = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutInsightRuleInput, output: PutInsightRuleOutput, errors: [InvalidParameterValueException, LimitExceededException, MissingRequiredParameterException] }));
/**
 ...
 */
export const putManagedInsightRules = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutManagedInsightRulesInput, output: PutManagedInsightRulesOutput, errors: [InvalidParameterValueException, MissingRequiredParameterException] }));
/**
 ...
 */
export const describeAlarmHistory = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeAlarmHistoryInput, output: DescribeAlarmHistoryOutput, errors: [InvalidNextToken] }));
/**
 ...
 * time period represented by that data point.
 */
export const getInsightRuleReport = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetInsightRuleReportInput, output: GetInsightRuleReportOutput, errors: [InvalidParameterValueException, MissingRequiredParameterException, ResourceNotFoundException] }));
/**
 ...
 * Guide.
 */
export const getMetricStatistics = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetMetricStatisticsInput, output: GetMetricStatisticsOutput, errors: [InternalServiceFault, InvalidParameterCombinationException, InvalidParameterValueException, MissingRequiredParameterException] }));
/**
 * Returns a list that contains the number of managed Contributor Insights rules in your
 * account.
 */
export const listManagedInsightRules = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListManagedInsightRulesInput, output: ListManagedInsightRulesOutput, errors: [InvalidNextToken, InvalidParameterValueException, MissingRequiredParameterException] }));
/**
 ...
 */
export const putDashboard = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutDashboardInput, output: PutDashboardOutput, errors: [ConflictException, DashboardInvalidInputError, InternalServiceFault] }));
/**
 ...
 */
export const putMetricData = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutMetricDataInput, output: PutMetricDataResponse, errors: [InternalServiceFault, InvalidParameterCombinationException, InvalidParameterValueException, MissingRequiredParameterException] }));
/**
 ...
 */
export const putMetricStream = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutMetricStreamInput, output: PutMetricStreamOutput, errors: [ConcurrentModificationException, InternalServiceFault, InvalidParameterCombinationException, InvalidParameterValueException, MissingRequiredParameterException] }));
/**
 ...
 */
export const describeAlarms = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeAlarmsInput, output: DescribeAlarmsOutput, errors: [InvalidNextToken] }));
/**
 ...
 */
export const describeAnomalyDetectors = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeAnomalyDetectorsInput, output: DescribeAnomalyDetectorsOutput, errors: [InternalServiceFault, InvalidNextToken, InvalidParameterCombinationException, InvalidParameterValueException] }));
/**
 ...
 * Insights to Analyze High-Cardinality Data.
 */
export const describeInsightRules = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeInsightRulesInput, output: DescribeInsightRulesOutput, errors: [InvalidNextToken] }));
/**
 * Returns a list of metric streams in this account.
 */
export const listMetricStreams = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListMetricStreamsInput, output: ListMetricStreamsOutput, errors: [InternalServiceFault, InvalidNextToken, InvalidParameterValueException, MissingRequiredParameterException] }));
/**
 ...
 */
export const describeAlarmContributors = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeAlarmContributorsInput, output: DescribeAlarmContributorsOutput, errors: [InvalidNextToken, ResourceNotFoundException] }));
/**
 ...
 * time series.
 */
export const getMetricData = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetMetricDataInput, output: GetMetricDataOutput, errors: [InvalidNextToken] }));
