...
export class CancelKeyDeletionRequest extends S.Class<CancelKeyDeletionRequest>("CancelKeyDeletionRequest")({KeyId: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ConnectCustomKeyStoreRequest extends S.Class<ConnectCustomKeyStoreRequest>("ConnectCustomKeyStoreRequest")({CustomKeyStoreId: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ConnectCustomKeyStoreResponse extends S.Class<ConnectCustomKeyStoreResponse>("ConnectCustomKeyStoreResponse")({}, ns) {}
export class CreateAliasRequest extends S.Class<CreateAliasRequest>("CreateAliasRequest")({AliasName: S.String, TargetKeyId: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class CreateAliasResponse extends S.Class<CreateAliasResponse>("CreateAliasResponse")({}, ns) {}
export class DeleteAliasRequest extends S.Class<DeleteAliasRequest>("DeleteAliasRequest")({AliasName: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteAliasResponse extends S.Class<DeleteAliasResponse>("DeleteAliasResponse")({}, ns) {}
export class DeleteCustomKeyStoreRequest extends S.Class<DeleteCustomKeyStoreRequest>("DeleteCustomKeyStoreRequest")({CustomKeyStoreId: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteCustomKeyStoreResponse extends S.Class<DeleteCustomKeyStoreResponse>("DeleteCustomKeyStoreResponse")({}, ns) {}
export class DeleteImportedKeyMaterialRequest extends S.Class<DeleteImportedKeyMaterialRequest>("DeleteImportedKeyMaterialRequest")({KeyId: S.String, KeyMaterialId: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class RecipientInfo extends S.Class<RecipientInfo>("RecipientInfo")({KeyEncryptionAlgorithm: S.optional(S.String), AttestationDocument: S.optional(T.Blob)}) {}
export class DeriveSharedSecretRequest extends S.Class<DeriveSharedSecretRequest>("DeriveSharedSecretRequest")({KeyId: S.String, KeyAgreementAlgorithm: S.String, PublicKey: T.Blob, GrantTokens: S.optional(GrantTokenList), DryRun: S.optional(S.Boolean), Recipient: S.optional(RecipientInfo)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeCustomKeyStoresRequest extends S.Class<DescribeCustomKeyStoresRequest>("DescribeCustomKeyStoresRequest")({CustomKeyStoreId: S.optional(S.String), CustomKeyStoreName: S.optional(S.String), Limit: S.optional(S.Number), Marker: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeKeyRequest extends S.Class<DescribeKeyRequest>("DescribeKeyRequest")({KeyId: S.String, GrantTokens: S.optional(GrantTokenList)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DisableKeyRequest extends S.Class<DisableKeyRequest>("DisableKeyRequest")({KeyId: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DisableKeyResponse extends S.Class<DisableKeyResponse>("DisableKeyResponse")({}, ns) {}
export class DisableKeyRotationRequest extends S.Class<DisableKeyRotationRequest>("DisableKeyRotationRequest")({KeyId: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DisableKeyRotationResponse extends S.Class<DisableKeyRotationResponse>("DisableKeyRotationResponse")({}, ns) {}
export class DisconnectCustomKeyStoreRequest extends S.Class<DisconnectCustomKeyStoreRequest>("DisconnectCustomKeyStoreRequest")({CustomKeyStoreId: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DisconnectCustomKeyStoreResponse extends S.Class<DisconnectCustomKeyStoreResponse>("DisconnectCustomKeyStoreResponse")({}, ns) {}
export class EnableKeyRequest extends S.Class<EnableKeyRequest>("EnableKeyRequest")({KeyId: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class EnableKeyResponse extends S.Class<EnableKeyResponse>("EnableKeyResponse")({}, ns) {}
export class EnableKeyRotationRequest extends S.Class<EnableKeyRotationRequest>("EnableKeyRotationRequest")({KeyId: S.String, RotationPeriodInDays: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class EnableKeyRotationResponse extends S.Class<EnableKeyRotationResponse>("EnableKeyRotationResponse")({}, ns) {}
export const EncryptionContextType = S.Record({key: S.String, value: S.String});
export class EncryptRequest extends S.Class<EncryptRequest>("EncryptRequest")({KeyId: S.String, Plaintext: T.Blob, EncryptionContext: S.optional(EncryptionContextType), GrantTokens: S.optional(GrantTokenList), EncryptionAlgorithm: S.optional(S.String), DryRun: S.optional(S.Boolean)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GenerateDataKeyRequest extends S.Class<GenerateDataKeyRequest>("GenerateDataKeyRequest")({KeyId: S.String, EncryptionContext: S.optional(EncryptionContextType), NumberOfBytes: S.optional(S.Number), KeySpec: S.optional(S.String), GrantTokens: S.optional(GrantTokenList), Recipient: S.optional(RecipientInfo), DryRun: S.optional(S.Boolean)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GenerateDataKeyPairRequest extends S.Class<GenerateDataKeyPairRequest>("GenerateDataKeyPairRequest")({EncryptionContext: S.optional(EncryptionContextType), KeyId: S.String, KeyPairSpec: S.String, GrantTokens: S.optional(GrantTokenList), Recipient: S.optional(RecipientInfo), DryRun: S.optional(S.Boolean)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GenerateDataKeyPairWithoutPlaintextRequest extends S.Class<GenerateDataKeyPairWithoutPlaintextRequest>("GenerateDataKeyPairWithoutPlaintextRequest")({EncryptionContext: S.optional(EncryptionContextType), KeyId: S.String, KeyPairSpec: S.String, GrantTokens: S.optional(GrantTokenList), DryRun: S.optional(S.Boolean)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GenerateDataKeyWithoutPlaintextRequest extends S.Class<GenerateDataKeyWithoutPlaintextRequest>("GenerateDataKeyWithoutPlaintextRequest")({KeyId: S.String, EncryptionContext: S.optional(EncryptionContextType), KeySpec: S.optional(S.String), NumberOfBytes: S.optional(S.Number), GrantTokens: S.optional(GrantTokenList), DryRun: S.optional(S.Boolean)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GenerateMacRequest extends S.Class<GenerateMacRequest>("GenerateMacRequest")({Message: T.Blob, KeyId: S.String, MacAlgorithm: S.String, GrantTokens: S.optional(GrantTokenList), DryRun: S.optional(S.Boolean)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GenerateRandomRequest extends S.Class<GenerateRandomRequest>("GenerateRandomRequest")({NumberOfBytes: S.optional(S.Number), CustomKeyStoreId: S.optional(S.String), Recipient: S.optional(RecipientInfo)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetKeyPolicyRequest extends S.Class<GetKeyPolicyRequest>("GetKeyPolicyRequest")({KeyId: S.String, PolicyName: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetKeyRotationStatusRequest extends S.Class<GetKeyRotationStatusRequest>("GetKeyRotationStatusRequest")({KeyId: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetParametersForImportRequest extends S.Class<GetParametersForImportRequest>("GetParametersForImportRequest")({KeyId: S.String, WrappingAlgorithm: S.String, WrappingKeySpec: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetPublicKeyRequest extends S.Class<GetPublicKeyRequest>("GetPublicKeyRequest")({KeyId: S.String, GrantTokens: S.optional(GrantTokenList)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ImportKeyMaterialRequest extends S.Class<ImportKeyMaterialRequest>("ImportKeyMaterialRequest")({KeyId: S.String, ImportToken: T.Blob, EncryptedKeyMaterial: T.Blob, ValidTo: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), ExpirationModel: S.optional(S.String), ImportType: S.optional(S.String), KeyMaterialDescription: S.optional(S.String), KeyMaterialId: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListAliasesRequest extends S.Class<ListAliasesRequest>("ListAliasesRequest")({KeyId: S.optional(S.String), Limit: S.optional(S.Number), Marker: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListGrantsRequest extends S.Class<ListGrantsRequest>("ListGrantsRequest")({Limit: S.optional(S.Number), Marker: S.optional(S.String), KeyId: S.String, GrantId: S.optional(S.String), GranteePrincipal: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListKeyPoliciesRequest extends S.Class<ListKeyPoliciesRequest>("ListKeyPoliciesRequest")({KeyId: S.String, Limit: S.optional(S.Number), Marker: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListKeyRotationsRequest extends S.Class<ListKeyRotationsRequest>("ListKeyRotationsRequest")({KeyId: S.String, IncludeKeyMaterial: S.optional(S.String), Limit: S.optional(S.Number), Marker: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListKeysRequest extends S.Class<ListKeysRequest>("ListKeysRequest")({Limit: S.optional(S.Number), Marker: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListResourceTagsRequest extends S.Class<ListResourceTagsRequest>("ListResourceTagsRequest")({KeyId: S.String, Limit: S.optional(S.Number), Marker: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListRetirableGrantsRequest extends S.Class<ListRetirableGrantsRequest>("ListRetirableGrantsRequest")({Limit: S.optional(S.Number), Marker: S.optional(S.String), RetiringPrincipal: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutKeyPolicyRequest extends S.Class<PutKeyPolicyRequest>("PutKeyPolicyRequest")({KeyId: S.String, PolicyName: S.optional(S.String), Policy: S.String, BypassPolicyLockoutSafetyCheck: S.optional(S.Boolean)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutKeyPolicyResponse extends S.Class<PutKeyPolicyResponse>("PutKeyPolicyResponse")({}, ns) {}
export class ReEncryptRequest extends S.Class<ReEncryptRequest>("ReEncryptRequest")({CiphertextBlob: T.Blob, SourceEncryptionContext: S.optional(EncryptionContextType), SourceKeyId: S.optional(S.String), DestinationKeyId: S.String, DestinationEncryptionContext: S.optional(EncryptionContextType), SourceEncryptionAlgorithm: S.optional(S.String), DestinationEncryptionAlgorithm: S.optional(S.String), GrantTokens: S.optional(GrantTokenList), DryRun: S.optional(S.Boolean)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class Tag extends S.Class<Tag>("Tag")({TagKey: S.String, TagValue: S.String}) {}
export const TagList = S.Array(Tag);
export class ReplicateKeyRequest extends S.Class<ReplicateKeyRequest>("ReplicateKeyRequest")({KeyId: S.String, ReplicaRegion: S.String, Policy: S.optional(S.String), BypassPolicyLockoutSafetyCheck: S.optional(S.Boolean), Description: S.optional(S.String), Tags: S.optional(TagList)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class RetireGrantRequest extends S.Class<RetireGrantRequest>("RetireGrantRequest")({GrantToken: S.optional(S.String), KeyId: S.optional(S.String), GrantId: S.optional(S.String), DryRun: S.optional(S.Boolean)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class RetireGrantResponse extends S.Class<RetireGrantResponse>("RetireGrantResponse")({}, ns) {}
export class RevokeGrantRequest extends S.Class<RevokeGrantRequest>("RevokeGrantRequest")({KeyId: S.String, GrantId: S.String, DryRun: S.optional(S.Boolean)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class RevokeGrantResponse extends S.Class<RevokeGrantResponse>("RevokeGrantResponse")({}, ns) {}
export class RotateKeyOnDemandRequest extends S.Class<RotateKeyOnDemandRequest>("RotateKeyOnDemandRequest")({KeyId: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ScheduleKeyDeletionRequest extends S.Class<ScheduleKeyDeletionRequest>("ScheduleKeyDeletionRequest")({KeyId: S.String, PendingWindowInDays: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class SignRequest extends S.Class<SignRequest>("SignRequest")({KeyId: S.String, Message: T.Blob, MessageType: S.optional(S.String), GrantTokens: S.optional(GrantTokenList), SigningAlgorithm: S.String, DryRun: S.optional(S.Boolean)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class TagResourceRequest extends S.Class<TagResourceRequest>("TagResourceRequest")({KeyId: S.String, Tags: TagList}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class TagResourceResponse extends S.Class<TagResourceResponse>("TagResourceResponse")({}, ns) {}
export class UntagResourceRequest extends S.Class<UntagResourceRequest>("UntagResourceRequest")({KeyId: S.String, TagKeys: TagKeyList}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class UntagResourceResponse extends S.Class<UntagResourceResponse>("UntagResourceResponse")({}, ns) {}
export class UpdateAliasRequest extends S.Class<UpdateAliasRequest>("UpdateAliasRequest")({AliasName: S.String, TargetKeyId: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class UpdateAliasResponse extends S.Class<UpdateAliasResponse>("UpdateAliasResponse")({}, ns) {}
...
export class UpdateCustomKeyStoreResponse extends S.Class<UpdateCustomKeyStoreResponse>("UpdateCustomKeyStoreResponse")({}, ns) {}
export class UpdateKeyDescriptionRequest extends S.Class<UpdateKeyDescriptionRequest>("UpdateKeyDescriptionRequest")({KeyId: S.String, Description: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class UpdateKeyDescriptionResponse extends S.Class<UpdateKeyDescriptionResponse>("UpdateKeyDescriptionResponse")({}, ns) {}
export class UpdatePrimaryRegionRequest extends S.Class<UpdatePrimaryRegionRequest>("UpdatePrimaryRegionRequest")({KeyId: S.String, PrimaryRegion: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class UpdatePrimaryRegionResponse extends S.Class<UpdatePrimaryRegionResponse>("UpdatePrimaryRegionResponse")({}, ns) {}
export class VerifyRequest extends S.Class<VerifyRequest>("VerifyRequest")({KeyId: S.String, Message: T.Blob, MessageType: S.optional(S.String), Signature: T.Blob, SigningAlgorithm: S.String, GrantTokens: S.optional(GrantTokenList), DryRun: S.optional(S.Boolean)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class VerifyMacRequest extends S.Class<VerifyMacRequest>("VerifyMacRequest")({Message: T.Blob, KeyId: S.String, MacAlgorithm: S.String, Mac: T.Blob, GrantTokens: S.optional(GrantTokenList), DryRun: S.optional(S.Boolean)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class CancelKeyDeletionResponse extends S.Class<CancelKeyDeletionResponse>("CancelKeyDeletionResponse")({KeyId: S.optional(S.String)}, ns) {}
...
export class DecryptRequest extends S.Class<DecryptRequest>("DecryptRequest")({CiphertextBlob: T.Blob, EncryptionContext: S.optional(EncryptionContextType), GrantTokens: S.optional(GrantTokenList), KeyId: S.optional(S.String), EncryptionAlgorithm: S.optional(S.String), Recipient: S.optional(RecipientInfo), DryRun: S.optional(S.Boolean)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteImportedKeyMaterialResponse extends S.Class<DeleteImportedKeyMaterialResponse>("DeleteImportedKeyMaterialResponse")({KeyId: S.optional(S.String), KeyMaterialId: S.optional(S.String)}, ns) {}
export class DeriveSharedSecretResponse extends S.Class<DeriveSharedSecretResponse>("DeriveSharedSecretResponse")({KeyId: S.optional(S.String), SharedSecret: S.optional(T.Blob), CiphertextForRecipient: S.optional(T.Blob), KeyAgreementAlgorithm: S.optional(S.String), KeyOrigin: S.optional(S.String)}, ns) {}
export class EncryptResponse extends S.Class<EncryptResponse>("EncryptResponse")({CiphertextBlob: S.optional(T.Blob), KeyId: S.optional(S.String), EncryptionAlgorithm: S.optional(S.String)}, ns) {}
export class GenerateDataKeyResponse extends S.Class<GenerateDataKeyResponse>("GenerateDataKeyResponse")({CiphertextBlob: S.optional(T.Blob), Plaintext: S.optional(T.Blob), KeyId: S.optional(S.String), CiphertextForRecipient: S.optional(T.Blob), KeyMaterialId: S.optional(S.String)}, ns) {}
export class GenerateDataKeyPairResponse extends S.Class<GenerateDataKeyPairResponse>("GenerateDataKeyPairResponse")({PrivateKeyCiphertextBlob: S.optional(T.Blob), PrivateKeyPlaintext: S.optional(T.Blob), PublicKey: S.optional(T.Blob), KeyId: S.optional(S.String), KeyPairSpec: S.optional(S.String), CiphertextForRecipient: S.optional(T.Blob), KeyMaterialId: S.optional(S.String)}, ns) {}
export class GenerateDataKeyPairWithoutPlaintextResponse extends S.Class<GenerateDataKeyPairWithoutPlaintextResponse>("GenerateDataKeyPairWithoutPlaintextResponse")({PrivateKeyCiphertextBlob: S.optional(T.Blob), PublicKey: S.optional(T.Blob), KeyId: S.optional(S.String), KeyPairSpec: S.optional(S.String), KeyMaterialId: S.optional(S.String)}, ns) {}
export class GenerateDataKeyWithoutPlaintextResponse extends S.Class<GenerateDataKeyWithoutPlaintextResponse>("GenerateDataKeyWithoutPlaintextResponse")({CiphertextBlob: S.optional(T.Blob), KeyId: S.optional(S.String), KeyMaterialId: S.optional(S.String)}, ns) {}
export class GenerateMacResponse extends S.Class<GenerateMacResponse>("GenerateMacResponse")({Mac: S.optional(T.Blob), MacAlgorithm: S.optional(S.String), KeyId: S.optional(S.String)}, ns) {}
export class GenerateRandomResponse extends S.Class<GenerateRandomResponse>("GenerateRandomResponse")({Plaintext: S.optional(T.Blob), CiphertextForRecipient: S.optional(T.Blob)}, ns) {}
export class GetKeyPolicyResponse extends S.Class<GetKeyPolicyResponse>("GetKeyPolicyResponse")({Policy: S.optional(S.String), PolicyName: S.optional(S.String)}, ns) {}
export class GetKeyRotationStatusResponse extends S.Class<GetKeyRotationStatusResponse>("GetKeyRotationStatusResponse")({KeyRotationEnabled: S.optional(S.Boolean), KeyId: S.optional(S.String), RotationPeriodInDays: S.optional(S.Number), NextRotationDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), OnDemandRotationStartDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}, ns) {}
export class GetParametersForImportResponse extends S.Class<GetParametersForImportResponse>("GetParametersForImportResponse")({KeyId: S.optional(S.String), ImportToken: S.optional(T.Blob), PublicKey: S.optional(T.Blob), ParametersValidTo: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}, ns) {}
export class GetPublicKeyResponse extends S.Class<GetPublicKeyResponse>("GetPublicKeyResponse")({KeyId: S.optional(S.String), PublicKey: S.optional(T.Blob), CustomerMasterKeySpec: S.optional(S.String), KeySpec: S.optional(S.String), KeyUsage: S.optional(S.String), EncryptionAlgorithms: S.optional(EncryptionAlgorithmSpecList), SigningAlgorithms: S.optional(SigningAlgorithmSpecList), KeyAgreementAlgorithms: S.optional(KeyAgreementAlgorithmSpecList)}, ns) {}
export class ImportKeyMaterialResponse extends S.Class<ImportKeyMaterialResponse>("ImportKeyMaterialResponse")({KeyId: S.optional(S.String), KeyMaterialId: S.optional(S.String)}, ns) {}
export class ListKeyPoliciesResponse extends S.Class<ListKeyPoliciesResponse>("ListKeyPoliciesResponse")({PolicyNames: S.optional(PolicyNameList), NextMarker: S.optional(S.String), Truncated: S.optional(S.Boolean)}, ns) {}
export class ListResourceTagsResponse extends S.Class<ListResourceTagsResponse>("ListResourceTagsResponse")({Tags: S.optional(TagList), NextMarker: S.optional(S.String), Truncated: S.optional(S.Boolean)}, ns) {}
export class ReEncryptResponse extends S.Class<ReEncryptResponse>("ReEncryptResponse")({CiphertextBlob: S.optional(T.Blob), SourceKeyId: S.optional(S.String), KeyId: S.optional(S.String), SourceEncryptionAlgorithm: S.optional(S.String), DestinationEncryptionAlgorithm: S.optional(S.String), SourceKeyMaterialId: S.optional(S.String), DestinationKeyMaterialId: S.optional(S.String)}, ns) {}
...
export class KeyMetadata extends S.Class<KeyMetadata>("KeyMetadata")({AWSAccountId: S.optional(S.String), KeyId: S.String, Arn: S.optional(S.String), CreationDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), Enabled: S.optional(S.Boolean), Description: S.optional(S.String), KeyUsage: S.optional(S.String), KeyState: S.optional(S.String), DeletionDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), ValidTo: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), Origin: S.optional(S.String), CustomKeyStoreId: S.optional(S.String), CloudHsmClusterId: S.optional(S.String), ExpirationModel: S.optional(S.String), KeyManager: S.optional(S.String), CustomerMasterKeySpec: S.optional(S.String), KeySpec: S.optional(S.String), EncryptionAlgorithms: S.optional(EncryptionAlgorithmSpecList), SigningAlgorithms: S.optional(SigningAlgorithmSpecList), KeyAgreementAlgorithms: S.optional(KeyAgreementAlgorithmSpecList), MultiRegion: S.optional(S.Boolean), MultiRegionConfiguration: S.optional(MultiRegionConfiguration), PendingDeletionWindowInDays: S.optional(S.Number), MacAlgorithms: S.optional(MacAlgorithmSpecList), XksKeyConfiguration: S.optional(XksKeyConfigurationType), CurrentKeyMaterialId: S.optional(S.String)}) {}
export class ReplicateKeyResponse extends S.Class<ReplicateKeyResponse>("ReplicateKeyResponse")({ReplicaKeyMetadata: S.optional(KeyMetadata), ReplicaPolicy: S.optional(S.String), ReplicaTags: S.optional(TagList)}, ns) {}
export class RotateKeyOnDemandResponse extends S.Class<RotateKeyOnDemandResponse>("RotateKeyOnDemandResponse")({KeyId: S.optional(S.String)}, ns) {}
export class ScheduleKeyDeletionResponse extends S.Class<ScheduleKeyDeletionResponse>("ScheduleKeyDeletionResponse")({KeyId: S.optional(S.String), DeletionDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), KeyState: S.optional(S.String), PendingWindowInDays: S.optional(S.Number)}, ns) {}
export class SignResponse extends S.Class<SignResponse>("SignResponse")({KeyId: S.optional(S.String), Signature: S.optional(T.Blob), SigningAlgorithm: S.optional(S.String)}, ns) {}
export class VerifyResponse extends S.Class<VerifyResponse>("VerifyResponse")({KeyId: S.optional(S.String), SignatureValid: S.optional(S.Boolean), SigningAlgorithm: S.optional(S.String)}, ns) {}
export class VerifyMacResponse extends S.Class<VerifyMacResponse>("VerifyMacResponse")({KeyId: S.optional(S.String), MacValid: S.optional(S.Boolean), MacAlgorithm: S.optional(S.String)}, ns) {}
export class AliasListEntry extends S.Class<AliasListEntry>("AliasListEntry")({AliasName: S.optional(S.String), AliasArn: S.optional(S.String), TargetKeyId: S.optional(S.String), CreationDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), LastUpdatedDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
export const AliasList = S.Array(AliasListEntry);
export class GrantListEntry extends S.Class<GrantListEntry>("GrantListEntry")({KeyId: S.optional(S.String), GrantId: S.optional(S.String), Name: S.optional(S.String), CreationDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), GranteePrincipal: S.optional(S.String), RetiringPrincipal: S.optional(S.String), IssuingAccount: S.optional(S.String), Operations: S.optional(GrantOperationList), Constraints: S.optional(GrantConstraints)}) {}
export const GrantList = S.Array(GrantListEntry);
export class RotationsListEntry extends S.Class<RotationsListEntry>("RotationsListEntry")({KeyId: S.optional(S.String), KeyMaterialId: S.optional(S.String), KeyMaterialDescription: S.optional(S.String), ImportState: S.optional(S.String), KeyMaterialState: S.optional(S.String), ExpirationModel: S.optional(S.String), ValidTo: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), RotationDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), RotationType: S.optional(S.String)}) {}
...
export class CreateCustomKeyStoreResponse extends S.Class<CreateCustomKeyStoreResponse>("CreateCustomKeyStoreResponse")({CustomKeyStoreId: S.optional(S.String)}, ns) {}
export class CreateGrantResponse extends S.Class<CreateGrantResponse>("CreateGrantResponse")({GrantToken: S.optional(S.String), GrantId: S.optional(S.String)}, ns) {}
export class CreateKeyResponse extends S.Class<CreateKeyResponse>("CreateKeyResponse")({KeyMetadata: S.optional(KeyMetadata)}, ns) {}
export class DecryptResponse extends S.Class<DecryptResponse>("DecryptResponse")({KeyId: S.optional(S.String), Plaintext: S.optional(T.Blob), EncryptionAlgorithm: S.optional(S.String), CiphertextForRecipient: S.optional(T.Blob), KeyMaterialId: S.optional(S.String)}, ns) {}
export class ListAliasesResponse extends S.Class<ListAliasesResponse>("ListAliasesResponse")({Aliases: S.optional(AliasList), NextMarker: S.optional(S.String), Truncated: S.optional(S.Boolean)}, ns) {}
export class ListGrantsResponse extends S.Class<ListGrantsResponse>("ListGrantsResponse")({Grants: S.optional(GrantList), NextMarker: S.optional(S.String), Truncated: S.optional(S.Boolean)}, ns) {}
export class ListKeyRotationsResponse extends S.Class<ListKeyRotationsResponse>("ListKeyRotationsResponse")({Rotations: S.optional(RotationsList), NextMarker: S.optional(S.String), Truncated: S.optional(S.Boolean)}, ns) {}
export class ListKeysResponse extends S.Class<ListKeysResponse>("ListKeysResponse")({Keys: S.optional(KeyList), NextMarker: S.optional(S.String), Truncated: S.optional(S.Boolean)}, ns) {}
...
export class CustomKeyStoresListEntry extends S.Class<CustomKeyStoresListEntry>("CustomKeyStoresListEntry")({CustomKeyStoreId: S.optional(S.String), CustomKeyStoreName: S.optional(S.String), CloudHsmClusterId: S.optional(S.String), TrustAnchorCertificate: S.optional(S.String), ConnectionState: S.optional(S.String), ConnectionErrorCode: S.optional(S.String), CreationDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), CustomKeyStoreType: S.optional(S.String), XksProxyConfiguration: S.optional(XksProxyConfigurationType)}) {}
export const CustomKeyStoresList = S.Array(CustomKeyStoresListEntry);
export class DescribeCustomKeyStoresResponse extends S.Class<DescribeCustomKeyStoresResponse>("DescribeCustomKeyStoresResponse")({CustomKeyStores: S.optional(CustomKeyStoresList), NextMarker: S.optional(S.String), Truncated: S.optional(S.Boolean)}, ns) {}
export class DescribeKeyResponse extends S.Class<DescribeKeyResponse>("DescribeKeyResponse")({KeyMetadata: S.optional(KeyMetadata)}, ns) {}

//# Errors
export class CloudHsmClusterInvalidConfigurationException extends S.TaggedError<CloudHsmClusterInvalidConfigurationException>()("CloudHsmClusterInvalidConfigurationException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "CloudHsmClusterInvalidConfigurationException", httpResponseCode: 400 })) {}
export class AlreadyExistsException extends S.TaggedError<AlreadyExistsException>()("AlreadyExistsException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "AlreadyExists", httpResponseCode: 409 })) {}
export class DependencyTimeoutException extends S.TaggedError<DependencyTimeoutException>()("DependencyTimeoutException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "DependencyTimeout", httpResponseCode: 503 })).pipe(withCategory(ERROR_CATEGORIES.SERVER_ERROR)) {}
export class CustomKeyStoreHasCMKsException extends S.TaggedError<CustomKeyStoreHasCMKsException>()("CustomKeyStoreHasCMKsException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "CustomKeyStoreHasCMKsException", httpResponseCode: 400 })) {}
export class CustomKeyStoreInvalidStateException extends S.TaggedError<CustomKeyStoreInvalidStateException>()("CustomKeyStoreInvalidStateException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "CustomKeyStoreInvalidStateException", httpResponseCode: 400 })) {}
export class InvalidArnException extends S.TaggedError<InvalidArnException>()("InvalidArnException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "InvalidArn", httpResponseCode: 400 })) {}
export class DisabledException extends S.TaggedError<DisabledException>()("DisabledException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "Disabled", httpResponseCode: 409 })) {}
export class CloudHsmClusterNotActiveException extends S.TaggedError<CloudHsmClusterNotActiveException>()("CloudHsmClusterNotActiveException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "CloudHsmClusterNotActiveException", httpResponseCode: 400 })) {}
export class KMSInternalException extends S.TaggedError<KMSInternalException>()("KMSInternalException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "KMSInternal", httpResponseCode: 500 })).pipe(withCategory(ERROR_CATEGORIES.SERVER_ERROR)) {}
export class CustomKeyStoreNotFoundException extends S.TaggedError<CustomKeyStoreNotFoundException>()("CustomKeyStoreNotFoundException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "CustomKeyStoreNotFoundException", httpResponseCode: 400 })) {}
export class ExpiredImportTokenException extends S.TaggedError<ExpiredImportTokenException>()("ExpiredImportTokenException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "ExpiredImportTokenException", httpResponseCode: 400 })) {}
export class ConflictException extends S.TaggedError<ConflictException>()("ConflictException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "ConflictException", httpResponseCode: 409 })) {}
export class DryRunOperationException extends S.TaggedError<DryRunOperationException>()("DryRunOperationException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "DryRunOperation", httpResponseCode: 412 })) {}
export class InvalidMarkerException extends S.TaggedError<InvalidMarkerException>()("InvalidMarkerException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "InvalidMarker", httpResponseCode: 400 })) {}
export class InvalidAliasNameException extends S.TaggedError<InvalidAliasNameException>()("InvalidAliasNameException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "InvalidAliasName", httpResponseCode: 400 })) {}
export class InvalidGrantTokenException extends S.TaggedError<InvalidGrantTokenException>()("InvalidGrantTokenException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "InvalidGrantToken", httpResponseCode: 400 })) {}
export class CloudHsmClusterInUseException extends S.TaggedError<CloudHsmClusterInUseException>()("CloudHsmClusterInUseException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "CloudHsmClusterInUseException", httpResponseCode: 400 })) {}
export class KMSInvalidStateException extends S.TaggedError<KMSInvalidStateException>()("KMSInvalidStateException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "KMSInvalidStateException", httpResponseCode: 409 })) {}
export class IncorrectKeyMaterialException extends S.TaggedError<IncorrectKeyMaterialException>()("IncorrectKeyMaterialException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "IncorrectKeyMaterialException", httpResponseCode: 400 })) {}
export class InvalidGrantIdException extends S.TaggedError<InvalidGrantIdException>()("InvalidGrantIdException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "InvalidGrantId", httpResponseCode: 400 })) {}
export class CloudHsmClusterNotFoundException extends S.TaggedError<CloudHsmClusterNotFoundException>()("CloudHsmClusterNotFoundException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "CloudHsmClusterNotFoundException", httpResponseCode: 400 })) {}
export class NotFoundException extends S.TaggedError<NotFoundException>()("NotFoundException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "NotFound", httpResponseCode: 404 })) {}
...
export class LimitExceededException extends S.TaggedError<LimitExceededException>()("LimitExceededException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "LimitExceeded", httpResponseCode: 400 })) {}
export class InvalidKeyUsageException extends S.TaggedError<InvalidKeyUsageException>()("InvalidKeyUsageException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "InvalidKeyUsage", httpResponseCode: 400 })) {}
export class IncorrectKeyException extends S.TaggedError<IncorrectKeyException>()("IncorrectKeyException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "IncorrectKeyException", httpResponseCode: 400 })) {}
export class InvalidCiphertextException extends S.TaggedError<InvalidCiphertextException>()("InvalidCiphertextException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "InvalidCiphertext", httpResponseCode: 400 })) {}
export class CloudHsmClusterNotRelatedException extends S.TaggedError<CloudHsmClusterNotRelatedException>()("CloudHsmClusterNotRelatedException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "CloudHsmClusterNotRelatedException", httpResponseCode: 400 })) {}
export class TagException extends S.TaggedError<TagException>()("TagException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "TagException", httpResponseCode: 400 })) {}
export class MalformedPolicyDocumentException extends S.TaggedError<MalformedPolicyDocumentException>()("MalformedPolicyDocumentException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "MalformedPolicyDocument", httpResponseCode: 400 })) {}
export class KeyUnavailableException extends S.TaggedError<KeyUnavailableException>()("KeyUnavailableException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "KeyUnavailable", httpResponseCode: 500 })).pipe(withCategory(ERROR_CATEGORIES.SERVER_ERROR)) {}
export class CustomKeyStoreNameInUseException extends S.TaggedError<CustomKeyStoreNameInUseException>()("CustomKeyStoreNameInUseException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "CustomKeyStoreNameInUseException", httpResponseCode: 400 })) {}
export class InvalidImportTokenException extends S.TaggedError<InvalidImportTokenException>()("InvalidImportTokenException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "InvalidImportTokenException", httpResponseCode: 400 })) {}
export class XksKeyAlreadyInUseException extends S.TaggedError<XksKeyAlreadyInUseException>()("XksKeyAlreadyInUseException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "XksKeyAlreadyInUse", httpResponseCode: 400 })) {}
export class IncorrectTrustAnchorException extends S.TaggedError<IncorrectTrustAnchorException>()("IncorrectTrustAnchorException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "IncorrectTrustAnchorException", httpResponseCode: 400 })) {}
export class KMSInvalidMacException extends S.TaggedError<KMSInvalidMacException>()("KMSInvalidMacException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "KMSInvalidMac", httpResponseCode: 400 })) {}
export class KMSInvalidSignatureException extends S.TaggedError<KMSInvalidSignatureException>()("KMSInvalidSignatureException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "KMSInvalidSignature", httpResponseCode: 400 })) {}
export class XksProxyIncorrectAuthenticationCredentialException extends S.TaggedError<XksProxyIncorrectAuthenticationCredentialException>()("XksProxyIncorrectAuthenticationCredentialException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "XksProxyIncorrectAuthenticationCredentialException", httpResponseCode: 400 })) {}
export class XksKeyInvalidConfigurationException extends S.TaggedError<XksKeyInvalidConfigurationException>()("XksKeyInvalidConfigurationException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "XksKeyInvalidConfiguration", httpResponseCode: 400 })) {}
export class XksProxyInvalidConfigurationException extends S.TaggedError<XksProxyInvalidConfigurationException>()("XksProxyInvalidConfigurationException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "XksProxyInvalidConfigurationException", httpResponseCode: 400 })) {}
export class XksKeyNotFoundException extends S.TaggedError<XksKeyNotFoundException>()("XksKeyNotFoundException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "XksKeyNotFoundException", httpResponseCode: 400 })) {}
export class XksProxyInvalidResponseException extends S.TaggedError<XksProxyInvalidResponseException>()("XksProxyInvalidResponseException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "XksProxyInvalidResponseException", httpResponseCode: 400 })) {}
export class XksProxyUriEndpointInUseException extends S.TaggedError<XksProxyUriEndpointInUseException>()("XksProxyUriEndpointInUseException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "XksProxyUriEndpointInUseException", httpResponseCode: 400 })) {}
export class XksProxyUriInUseException extends S.TaggedError<XksProxyUriInUseException>()("XksProxyUriInUseException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "XksProxyUriInUseException", httpResponseCode: 400 })) {}
export class XksProxyUriUnreachableException extends S.TaggedError<XksProxyUriUnreachableException>()("XksProxyUriUnreachableException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "XksProxyUriUnreachableException", httpResponseCode: 400 })) {}
export class XksProxyVpcEndpointServiceInUseException extends S.TaggedError<XksProxyVpcEndpointServiceInUseException>()("XksProxyVpcEndpointServiceInUseException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "XksProxyVpcEndpointServiceInUseException", httpResponseCode: 400 })) {}
export class XksProxyVpcEndpointServiceInvalidConfigurationException extends S.TaggedError<XksProxyVpcEndpointServiceInvalidConfigurationException>()("XksProxyVpcEndpointServiceInvalidConfigurationException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "XksProxyVpcEndpointServiceInvalidConfigurationException", httpResponseCode: 400 })) {}
export class XksProxyVpcEndpointServiceNotFoundException extends S.TaggedError<XksProxyVpcEndpointServiceNotFoundException>()("XksProxyVpcEndpointServiceNotFoundException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "XksProxyVpcEndpointServiceNotFoundException", httpResponseCode: 400 })) {}
 ...
 */
export const disconnectCustomKeyStore = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DisconnectCustomKeyStoreRequest, output: DisconnectCustomKeyStoreResponse, errors: [CustomKeyStoreInvalidStateException, CustomKeyStoreNotFoundException, KMSInternalException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const deleteCustomKeyStore = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteCustomKeyStoreRequest, output: DeleteCustomKeyStoreResponse, errors: [CustomKeyStoreHasCMKsException, CustomKeyStoreInvalidStateException, CustomKeyStoreNotFoundException, KMSInternalException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const connectCustomKeyStore = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ConnectCustomKeyStoreRequest, output: ConnectCustomKeyStoreResponse, errors: [CloudHsmClusterInvalidConfigurationException, CloudHsmClusterNotActiveException, CustomKeyStoreInvalidStateException, CustomKeyStoreNotFoundException, KMSInternalException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const listKeys = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListKeysRequest, output: ListKeysResponse, errors: [DependencyTimeoutException, InvalidMarkerException, KMSInternalException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const describeCustomKeyStores = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeCustomKeyStoresRequest, output: DescribeCustomKeyStoresResponse, errors: [CustomKeyStoreNotFoundException, InvalidMarkerException, KMSInternalException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const listRetirableGrants = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListRetirableGrantsRequest, output: ListGrantsResponse, errors: [DependencyTimeoutException, InvalidArnException, InvalidMarkerException, KMSInternalException, NotFoundException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const disableKey = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DisableKeyRequest, output: DisableKeyResponse, errors: [DependencyTimeoutException, InvalidArnException, KMSInternalException, KMSInvalidStateException, NotFoundException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const updateKeyDescription = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateKeyDescriptionRequest, output: UpdateKeyDescriptionResponse, errors: [DependencyTimeoutException, InvalidArnException, KMSInternalException, KMSInvalidStateException, NotFoundException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const cancelKeyDeletion = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CancelKeyDeletionRequest, output: CancelKeyDeletionResponse, errors: [DependencyTimeoutException, InvalidArnException, KMSInternalException, KMSInvalidStateException, NotFoundException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const getKeyPolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetKeyPolicyRequest, output: GetKeyPolicyResponse, errors: [DependencyTimeoutException, InvalidArnException, KMSInternalException, KMSInvalidStateException, NotFoundException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const listKeyPolicies = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListKeyPoliciesRequest, output: ListKeyPoliciesResponse, errors: [DependencyTimeoutException, InvalidArnException, KMSInternalException, KMSInvalidStateException, NotFoundException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const scheduleKeyDeletion = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ScheduleKeyDeletionRequest, output: ScheduleKeyDeletionResponse, errors: [DependencyTimeoutException, InvalidArnException, KMSInternalException, KMSInvalidStateException, NotFoundException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const generateRandom = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GenerateRandomRequest, output: GenerateRandomResponse, errors: [CustomKeyStoreInvalidStateException, CustomKeyStoreNotFoundException, DependencyTimeoutException, KMSInternalException, UnsupportedOperationException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const retireGrant = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: RetireGrantRequest, output: RetireGrantResponse, errors: [DependencyTimeoutException, DryRunOperationException, InvalidArnException, InvalidGrantIdException, InvalidGrantTokenException, KMSInternalException, KMSInvalidStateException, NotFoundException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const revokeGrant = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: RevokeGrantRequest, output: RevokeGrantResponse, errors: [DependencyTimeoutException, DryRunOperationException, InvalidArnException, InvalidGrantIdException, KMSInternalException, KMSInvalidStateException, NotFoundException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const listResourceTags = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListResourceTagsRequest, output: ListResourceTagsResponse, errors: [InvalidArnException, InvalidMarkerException, KMSInternalException, NotFoundException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const listAliases = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListAliasesRequest, output: ListAliasesResponse, errors: [DependencyTimeoutException, InvalidArnException, InvalidMarkerException, KMSInternalException, NotFoundException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const deleteAlias = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteAliasRequest, output: DeleteAliasResponse, errors: [DependencyTimeoutException, KMSInternalException, KMSInvalidStateException, NotFoundException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const listGrants = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListGrantsRequest, output: ListGrantsResponse, errors: [DependencyTimeoutException, InvalidArnException, InvalidGrantIdException, InvalidMarkerException, KMSInternalException, KMSInvalidStateException, NotFoundException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const updatePrimaryRegion = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdatePrimaryRegionRequest, output: UpdatePrimaryRegionResponse, errors: [DisabledException, InvalidArnException, KMSInternalException, KMSInvalidStateException, NotFoundException, UnsupportedOperationException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const disableKeyRotation = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DisableKeyRotationRequest, output: DisableKeyRotationResponse, errors: [DependencyTimeoutException, DisabledException, InvalidArnException, KMSInternalException, KMSInvalidStateException, NotFoundException, UnsupportedOperationException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const enableKeyRotation = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: EnableKeyRotationRequest, output: EnableKeyRotationResponse, errors: [DependencyTimeoutException, DisabledException, InvalidArnException, KMSInternalException, KMSInvalidStateException, NotFoundException, UnsupportedOperationException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const deleteImportedKeyMaterial = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteImportedKeyMaterialRequest, output: DeleteImportedKeyMaterialResponse, errors: [DependencyTimeoutException, InvalidArnException, KMSInternalException, KMSInvalidStateException, NotFoundException, UnsupportedOperationException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const getKeyRotationStatus = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetKeyRotationStatusRequest, output: GetKeyRotationStatusResponse, errors: [DependencyTimeoutException, InvalidArnException, KMSInternalException, KMSInvalidStateException, NotFoundException, UnsupportedOperationException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const getParametersForImport = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetParametersForImportRequest, output: GetParametersForImportResponse, errors: [DependencyTimeoutException, InvalidArnException, KMSInternalException, KMSInvalidStateException, NotFoundException, UnsupportedOperationException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const listKeyRotations = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListKeyRotationsRequest, output: ListKeyRotationsResponse, errors: [InvalidArnException, InvalidMarkerException, KMSInternalException, KMSInvalidStateException, NotFoundException, UnsupportedOperationException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const createAlias = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateAliasRequest, output: CreateAliasResponse, errors: [AlreadyExistsException, DependencyTimeoutException, InvalidAliasNameException, KMSInternalException, KMSInvalidStateException, LimitExceededException, NotFoundException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const enableKey = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: EnableKeyRequest, output: EnableKeyResponse, errors: [DependencyTimeoutException, InvalidArnException, KMSInternalException, KMSInvalidStateException, LimitExceededException, NotFoundException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const updateAlias = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateAliasRequest, output: UpdateAliasResponse, errors: [DependencyTimeoutException, KMSInternalException, KMSInvalidStateException, LimitExceededException, NotFoundException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const createGrant = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateGrantRequest, output: CreateGrantResponse, errors: [DependencyTimeoutException, DisabledException, DryRunOperationException, InvalidArnException, InvalidGrantTokenException, KMSInternalException, KMSInvalidStateException, LimitExceededException, NotFoundException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const describeKey = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeKeyRequest, output: DescribeKeyResponse, errors: [DependencyTimeoutException, InvalidArnException, KMSInternalException, NotFoundException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const untagResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UntagResourceRequest, output: UntagResourceResponse, errors: [InvalidArnException, KMSInternalException, KMSInvalidStateException, NotFoundException, TagException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const getPublicKey = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetPublicKeyRequest, output: GetPublicKeyResponse, errors: [DependencyTimeoutException, DisabledException, InvalidArnException, InvalidGrantTokenException, InvalidKeyUsageException, KeyUnavailableException, KMSInternalException, KMSInvalidStateException, NotFoundException, UnsupportedOperationException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const tagResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: TagResourceRequest, output: TagResourceResponse, errors: [InvalidArnException, KMSInternalException, KMSInvalidStateException, LimitExceededException, NotFoundException, TagException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const putKeyPolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutKeyPolicyRequest, output: PutKeyPolicyResponse, errors: [DependencyTimeoutException, InvalidArnException, KMSInternalException, KMSInvalidStateException, LimitExceededException, MalformedPolicyDocumentException, NotFoundException, UnsupportedOperationException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const replicateKey = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ReplicateKeyRequest, output: ReplicateKeyResponse, errors: [AlreadyExistsException, DisabledException, InvalidArnException, KMSInternalException, KMSInvalidStateException, LimitExceededException, MalformedPolicyDocumentException, NotFoundException, TagException, UnsupportedOperationException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const deriveSharedSecret = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeriveSharedSecretRequest, output: DeriveSharedSecretResponse, errors: [DependencyTimeoutException, DisabledException, DryRunOperationException, InvalidGrantTokenException, InvalidKeyUsageException, KeyUnavailableException, KMSInternalException, KMSInvalidStateException, NotFoundException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const encrypt = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: EncryptRequest, output: EncryptResponse, errors: [DependencyTimeoutException, DisabledException, DryRunOperationException, InvalidGrantTokenException, InvalidKeyUsageException, KeyUnavailableException, KMSInternalException, KMSInvalidStateException, NotFoundException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const generateDataKey = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GenerateDataKeyRequest, output: GenerateDataKeyResponse, errors: [DependencyTimeoutException, DisabledException, DryRunOperationException, InvalidGrantTokenException, InvalidKeyUsageException, KeyUnavailableException, KMSInternalException, KMSInvalidStateException, NotFoundException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const generateDataKeyPair = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GenerateDataKeyPairRequest, output: GenerateDataKeyPairResponse, errors: [DependencyTimeoutException, DisabledException, DryRunOperationException, InvalidGrantTokenException, InvalidKeyUsageException, KeyUnavailableException, KMSInternalException, KMSInvalidStateException, NotFoundException, UnsupportedOperationException] }));
/**
 * Returns a unique asymmetric data key pair for use outside of KMS. This operation returns
 ...
 * For more information, see KMS eventual consistency.
 */
export const generateDataKeyPairWithoutPlaintext = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GenerateDataKeyPairWithoutPlaintextRequest, output: GenerateDataKeyPairWithoutPlaintextResponse, errors: [DependencyTimeoutException, DisabledException, DryRunOperationException, InvalidGrantTokenException, InvalidKeyUsageException, KeyUnavailableException, KMSInternalException, KMSInvalidStateException, NotFoundException, UnsupportedOperationException] }));
/**
 * Returns a unique symmetric data key for use outside of KMS. This operation returns a
 ...
 * For more information, see KMS eventual consistency.
 */
export const generateDataKeyWithoutPlaintext = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GenerateDataKeyWithoutPlaintextRequest, output: GenerateDataKeyWithoutPlaintextResponse, errors: [DependencyTimeoutException, DisabledException, DryRunOperationException, InvalidGrantTokenException, InvalidKeyUsageException, KeyUnavailableException, KMSInternalException, KMSInvalidStateException, NotFoundException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const generateMac = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GenerateMacRequest, output: GenerateMacResponse, errors: [DisabledException, DryRunOperationException, InvalidGrantTokenException, InvalidKeyUsageException, KeyUnavailableException, KMSInternalException, KMSInvalidStateException, NotFoundException] }));
/**
 * Creates a digital
 ...
 * For more information, see KMS eventual consistency.
 */
export const sign = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: SignRequest, output: SignResponse, errors: [DependencyTimeoutException, DisabledException, DryRunOperationException, InvalidGrantTokenException, InvalidKeyUsageException, KeyUnavailableException, KMSInternalException, KMSInvalidStateException, NotFoundException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const reEncrypt = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ReEncryptRequest, output: ReEncryptResponse, errors: [DependencyTimeoutException, DisabledException, DryRunOperationException, IncorrectKeyException, InvalidCiphertextException, InvalidGrantTokenException, InvalidKeyUsageException, KeyUnavailableException, KMSInternalException, KMSInvalidStateException, NotFoundException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const decrypt = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DecryptRequest, output: DecryptResponse, errors: [DependencyTimeoutException, DisabledException, DryRunOperationException, IncorrectKeyException, InvalidCiphertextException, InvalidGrantTokenException, InvalidKeyUsageException, KeyUnavailableException, KMSInternalException, KMSInvalidStateException, NotFoundException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const importKeyMaterial = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ImportKeyMaterialRequest, output: ImportKeyMaterialResponse, errors: [DependencyTimeoutException, ExpiredImportTokenException, IncorrectKeyMaterialException, InvalidArnException, InvalidCiphertextException, InvalidImportTokenException, KMSInternalException, KMSInvalidStateException, NotFoundException, UnsupportedOperationException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const verifyMac = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: VerifyMacRequest, output: VerifyMacResponse, errors: [DisabledException, DryRunOperationException, InvalidGrantTokenException, InvalidKeyUsageException, KeyUnavailableException, KMSInternalException, KMSInvalidMacException, KMSInvalidStateException, NotFoundException] }));
/**
 ...
 * For more information, see KMS eventual consistency.
 */
export const verify = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: VerifyRequest, output: VerifyResponse, errors: [DependencyTimeoutException, DisabledException, DryRunOperationException, InvalidGrantTokenException, InvalidKeyUsageException, KeyUnavailableException, KMSInternalException, KMSInvalidSignatureException, KMSInvalidStateException, NotFoundException] }));
/**
