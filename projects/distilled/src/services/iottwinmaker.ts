...
//# Schemas
export class GetPricingPlanRequest extends S.Class<GetPricingPlanRequest>("GetPricingPlanRequest")({}, T.all(T.Http({ method: "GET", uri: "/pricingplan" }), svc, auth, proto, ver, rules)) {}
...
export class CancelMetadataTransferJobRequest extends S.Class<CancelMetadataTransferJobRequest>("CancelMetadataTransferJobRequest")({metadataTransferJobId: S.String.pipe(T.HttpLabel("metadataTransferJobId"))}, T.all(T.Http({ method: "PUT", uri: "/metadata-transfer-jobs/{metadataTransferJobId}/cancel" }), svc, auth, proto, ver, rules)) {}
export const TagMap = S.Record({key: S.String, value: S.String});
export class CreateSyncJobRequest extends S.Class<CreateSyncJobRequest>("CreateSyncJobRequest")({workspaceId: S.String.pipe(T.HttpLabel("workspaceId")), syncSource: S.String.pipe(T.HttpLabel("syncSource")), syncRole: S.String, tags: S.optional(TagMap)}, T.all(T.Http({ method: "POST", uri: "/workspaces/{workspaceId}/sync-jobs/{syncSource}" }), svc, auth, proto, ver, rules)) {}
export class CreateWorkspaceRequest extends S.Class<CreateWorkspaceRequest>("CreateWorkspaceRequest")({workspaceId: S.String.pipe(T.HttpLabel("workspaceId")), description: S.optional(S.String), s3Location: S.optional(S.String), role: S.optional(S.String), tags: S.optional(TagMap)}, T.all(T.Http({ method: "POST", uri: "/workspaces/{workspaceId}" }), svc, auth, proto, ver, rules)) {}
export class DeleteComponentTypeRequest extends S.Class<DeleteComponentTypeRequest>("DeleteComponentTypeRequest")({workspaceId: S.String.pipe(T.HttpLabel("workspaceId")), componentTypeId: S.String.pipe(T.HttpLabel("componentTypeId"))}, T.all(T.Http({ method: "DELETE", uri: "/workspaces/{workspaceId}/component-types/{componentTypeId}" }), svc, auth, proto, ver, rules)) {}
export class DeleteEntityRequest extends S.Class<DeleteEntityRequest>("DeleteEntityRequest")({workspaceId: S.String.pipe(T.HttpLabel("workspaceId")), entityId: S.String.pipe(T.HttpLabel("entityId")), isRecursive: S.optional(S.Boolean).pipe(T.HttpQuery("isRecursive"))}, T.all(T.Http({ method: "DELETE", uri: "/workspaces/{workspaceId}/entities/{entityId}" }), svc, auth, proto, ver, rules)) {}
export class DeleteSceneRequest extends S.Class<DeleteSceneRequest>("DeleteSceneRequest")({workspaceId: S.String.pipe(T.HttpLabel("workspaceId")), sceneId: S.String.pipe(T.HttpLabel("sceneId"))}, T.all(T.Http({ method: "DELETE", uri: "/workspaces/{workspaceId}/scenes/{sceneId}" }), svc, auth, proto, ver, rules)) {}
export class DeleteSceneResponse extends S.Class<DeleteSceneResponse>("DeleteSceneResponse")({}) {}
export class DeleteSyncJobRequest extends S.Class<DeleteSyncJobRequest>("DeleteSyncJobRequest")({workspaceId: S.String.pipe(T.HttpLabel("workspaceId")), syncSource: S.String.pipe(T.HttpLabel("syncSource"))}, T.all(T.Http({ method: "DELETE", uri: "/workspaces/{workspaceId}/sync-jobs/{syncSource}" }), svc, auth, proto, ver, rules)) {}
export class DeleteWorkspaceRequest extends S.Class<DeleteWorkspaceRequest>("DeleteWorkspaceRequest")({workspaceId: S.String.pipe(T.HttpLabel("workspaceId"))}, T.all(T.Http({ method: "DELETE", uri: "/workspaces/{workspaceId}" }), svc, auth, proto, ver, rules)) {}
export class ExecuteQueryRequest extends S.Class<ExecuteQueryRequest>("ExecuteQueryRequest")({workspaceId: S.String, queryStatement: S.String, maxResults: S.optional(S.Number), nextToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/queries/execution" }), svc, auth, proto, ver, rules)) {}
export class GetComponentTypeRequest extends S.Class<GetComponentTypeRequest>("GetComponentTypeRequest")({workspaceId: S.String.pipe(T.HttpLabel("workspaceId")), componentTypeId: S.String.pipe(T.HttpLabel("componentTypeId"))}, T.all(T.Http({ method: "GET", uri: "/workspaces/{workspaceId}/component-types/{componentTypeId}" }), svc, auth, proto, ver, rules)) {}
export class GetEntityRequest extends S.Class<GetEntityRequest>("GetEntityRequest")({workspaceId: S.String.pipe(T.HttpLabel("workspaceId")), entityId: S.String.pipe(T.HttpLabel("entityId"))}, T.all(T.Http({ method: "GET", uri: "/workspaces/{workspaceId}/entities/{entityId}" }), svc, auth, proto, ver, rules)) {}
export class GetMetadataTransferJobRequest extends S.Class<GetMetadataTransferJobRequest>("GetMetadataTransferJobRequest")({metadataTransferJobId: S.String.pipe(T.HttpLabel("metadataTransferJobId"))}, T.all(T.Http({ method: "GET", uri: "/metadata-transfer-jobs/{metadataTransferJobId}" }), svc, auth, proto, ver, rules)) {}
export class GetSceneRequest extends S.Class<GetSceneRequest>("GetSceneRequest")({workspaceId: S.String.pipe(T.HttpLabel("workspaceId")), sceneId: S.String.pipe(T.HttpLabel("sceneId"))}, T.all(T.Http({ method: "GET", uri: "/workspaces/{workspaceId}/scenes/{sceneId}" }), svc, auth, proto, ver, rules)) {}
export class GetSyncJobRequest extends S.Class<GetSyncJobRequest>("GetSyncJobRequest")({syncSource: S.String.pipe(T.HttpLabel("syncSource")), workspaceId: S.optional(S.String).pipe(T.HttpQuery("workspace"))}, T.all(T.Http({ method: "GET", uri: "/sync-jobs/{syncSource}" }), svc, auth, proto, ver, rules)) {}
export class GetWorkspaceRequest extends S.Class<GetWorkspaceRequest>("GetWorkspaceRequest")({workspaceId: S.String.pipe(T.HttpLabel("workspaceId"))}, T.all(T.Http({ method: "GET", uri: "/workspaces/{workspaceId}" }), svc, auth, proto, ver, rules)) {}
export class ListComponentsRequest extends S.Class<ListComponentsRequest>("ListComponentsRequest")({workspaceId: S.String.pipe(T.HttpLabel("workspaceId")), entityId: S.String.pipe(T.HttpLabel("entityId")), componentPath: S.optional(S.String), maxResults: S.optional(S.Number), nextToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/workspaces/{workspaceId}/entities/{entityId}/components-list" }), svc, auth, proto, ver, rules)) {}
export class ListPropertiesRequest extends S.Class<ListPropertiesRequest>("ListPropertiesRequest")({workspaceId: S.String.pipe(T.HttpLabel("workspaceId")), componentName: S.optional(S.String), componentPath: S.optional(S.String), entityId: S.String, maxResults: S.optional(S.Number), nextToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/workspaces/{workspaceId}/properties-list" }), svc, auth, proto, ver, rules)) {}
export class ListScenesRequest extends S.Class<ListScenesRequest>("ListScenesRequest")({workspaceId: S.String.pipe(T.HttpLabel("workspaceId")), maxResults: S.optional(S.Number), nextToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/workspaces/{workspaceId}/scenes-list" }), svc, auth, proto, ver, rules)) {}
export class ListSyncJobsRequest extends S.Class<ListSyncJobsRequest>("ListSyncJobsRequest")({workspaceId: S.String.pipe(T.HttpLabel("workspaceId")), maxResults: S.optional(S.Number), nextToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/workspaces/{workspaceId}/sync-jobs-list" }), svc, auth, proto, ver, rules)) {}
export class ListTagsForResourceRequest extends S.Class<ListTagsForResourceRequest>("ListTagsForResourceRequest")({resourceARN: S.String, maxResults: S.optional(S.Number), nextToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/tags-list" }), svc, auth, proto, ver, rules)) {}
export class ListWorkspacesRequest extends S.Class<ListWorkspacesRequest>("ListWorkspacesRequest")({maxResults: S.optional(S.Number), nextToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/workspaces-list" }), svc, auth, proto, ver, rules)) {}
export class TagResourceRequest extends S.Class<TagResourceRequest>("TagResourceRequest")({resourceARN: S.String, tags: TagMap}, T.all(T.Http({ method: "POST", uri: "/tags" }), svc, auth, proto, ver, rules)) {}
...
export class UpdateComponentTypeRequest extends S.Class<UpdateComponentTypeRequest>("UpdateComponentTypeRequest")({workspaceId: S.String.pipe(T.HttpLabel("workspaceId")), isSingleton: S.optional(S.Boolean), componentTypeId: S.String.pipe(T.HttpLabel("componentTypeId")), description: S.optional(S.String), propertyDefinitions: S.optional(PropertyDefinitionsRequest), extendsFrom: S.optional(ExtendsFrom), functions: S.optional(FunctionsRequest), propertyGroups: S.optional(PropertyGroupsRequest), componentTypeName: S.optional(S.String), compositeComponentTypes: S.optional(CompositeComponentTypesRequest)}, T.all(T.Http({ method: "PUT", uri: "/workspaces/{workspaceId}/component-types/{componentTypeId}" }), svc, auth, proto, ver, rules)) {}
export class UpdatePricingPlanRequest extends S.Class<UpdatePricingPlanRequest>("UpdatePricingPlanRequest")({pricingMode: S.String, bundleNames: S.optional(PricingBundles)}, T.all(T.Http({ method: "POST", uri: "/pricingplan" }), svc, auth, proto, ver, rules)) {}
export const SceneMetadataMap = S.Record({key: S.String, value: S.String});
export class UpdateSceneRequest extends S.Class<UpdateSceneRequest>("UpdateSceneRequest")({workspaceId: S.String.pipe(T.HttpLabel("workspaceId")), sceneId: S.String.pipe(T.HttpLabel("sceneId")), contentLocation: S.optional(S.String), description: S.optional(S.String), capabilities: S.optional(SceneCapabilities), sceneMetadata: S.optional(SceneMetadataMap)}, T.all(T.Http({ method: "PUT", uri: "/workspaces/{workspaceId}/scenes/{sceneId}" }), svc, auth, proto, ver, rules)) {}
export class UpdateWorkspaceRequest extends S.Class<UpdateWorkspaceRequest>("UpdateWorkspaceRequest")({workspaceId: S.String.pipe(T.HttpLabel("workspaceId")), description: S.optional(S.String), role: S.optional(S.String), s3Location: S.optional(S.String)}, T.all(T.Http({ method: "PUT", uri: "/workspaces/{workspaceId}" }), svc, auth, proto, ver, rules)) {}
...
export const ListComponentTypesFilter = S.Union(S.Struct({ extendsFrom: S.String }), S.Struct({ namespace: S.String }), S.Struct({ isAbstract: S.Boolean }));
export const ListComponentTypesFilters = S.Array(ListComponentTypesFilter);
export const ListEntitiesFilter = S.Union(S.Struct({ parentEntityId: S.String }), S.Struct({ componentTypeId: S.String }), S.Struct({ externalId: S.String }));
export const ListEntitiesFilters = S.Array(ListEntitiesFilter);
export const ListMetadataTransferJobsFilter = S.Union(S.Struct({ workspaceId: S.String }), S.Struct({ state: S.String }));
export const ListMetadataTransferJobsFilters = S.Array(ListMetadataTransferJobsFilter);
export const SyncResourceFilter = S.Union(S.Struct({ state: S.String }), S.Struct({ resourceType: S.String }), S.Struct({ resourceId: S.String }), S.Struct({ externalId: S.String }));
...
export class CreateSceneRequest extends S.Class<CreateSceneRequest>("CreateSceneRequest")({workspaceId: S.String.pipe(T.HttpLabel("workspaceId")), sceneId: S.String, contentLocation: S.String, description: S.optional(S.String), capabilities: S.optional(SceneCapabilities), tags: S.optional(TagMap), sceneMetadata: S.optional(SceneMetadataMap)}, T.all(T.Http({ method: "POST", uri: "/workspaces/{workspaceId}/scenes" }), svc, auth, proto, ver, rules)) {}
export class CreateSyncJobResponse extends S.Class<CreateSyncJobResponse>("CreateSyncJobResponse")({arn: S.String, creationDateTime: S.Date.pipe(T.TimestampFormat("epoch-seconds")), state: S.String}) {}
export class CreateWorkspaceResponse extends S.Class<CreateWorkspaceResponse>("CreateWorkspaceResponse")({arn: S.String, creationDateTime: S.Date.pipe(T.TimestampFormat("epoch-seconds"))}) {}
...
export const IotSiteWiseSourceConfigurationFilter = S.Union(S.Struct({ filterByAssetModel: FilterByAssetModel }), S.Struct({ filterByAsset: FilterByAsset }));
...
export const IotTwinMakerSourceConfigurationFilter = S.Union(S.Struct({ filterByComponentType: FilterByComponentType }), S.Struct({ filterByEntity: FilterByEntity }));
...
export class GetMetadataTransferJobResponse extends S.Class<GetMetadataTransferJobResponse>("GetMetadataTransferJobResponse")({metadataTransferJobId: S.String, arn: S.String, description: S.optional(S.String), sources: SourceConfigurations, destination: DestinationConfiguration, metadataTransferJobRole: S.String, reportUrl: S.optional(S.String), creationDateTime: S.Date.pipe(T.TimestampFormat("epoch-seconds")), updateDateTime: S.Date.pipe(T.TimestampFormat("epoch-seconds")), status: MetadataTransferJobStatus, progress: S.optional(MetadataTransferJobProgress)}) {}
export class GetWorkspaceResponse extends S.Class<GetWorkspaceResponse>("GetWorkspaceResponse")({workspaceId: S.String, arn: S.String, description: S.optional(S.String), linkedServices: S.optional(LinkedServices), s3Location: S.optional(S.String), role: S.optional(S.String), creationDateTime: S.Date.pipe(T.TimestampFormat("epoch-seconds")), updateDateTime: S.Date.pipe(T.TimestampFormat("epoch-seconds"))}) {}
export class ListComponentTypesRequest extends S.Class<ListComponentTypesRequest>("ListComponentTypesRequest")({workspaceId: S.String.pipe(T.HttpLabel("workspaceId")), filters: S.optional(ListComponentTypesFilters), nextToken: S.optional(S.String), maxResults: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/workspaces/{workspaceId}/component-types-list" }), svc, auth, proto, ver, rules)) {}
export class ListEntitiesRequest extends S.Class<ListEntitiesRequest>("ListEntitiesRequest")({workspaceId: S.String.pipe(T.HttpLabel("workspaceId")), filters: S.optional(ListEntitiesFilters), maxResults: S.optional(S.Number), nextToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/workspaces/{workspaceId}/entities-list" }), svc, auth, proto, ver, rules)) {}
export class ListMetadataTransferJobsRequest extends S.Class<ListMetadataTransferJobsRequest>("ListMetadataTransferJobsRequest")({sourceType: S.String, destinationType: S.String, filters: S.optional(ListMetadataTransferJobsFilters), nextToken: S.optional(S.String), maxResults: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/metadata-transfer-jobs-list" }), svc, auth, proto, ver, rules)) {}
export class ListSyncResourcesRequest extends S.Class<ListSyncResourcesRequest>("ListSyncResourcesRequest")({workspaceId: S.String.pipe(T.HttpLabel("workspaceId")), syncSource: S.String.pipe(T.HttpLabel("syncSource")), filters: S.optional(SyncResourceFilters), maxResults: S.optional(S.Number), nextToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/workspaces/{workspaceId}/sync-jobs/{syncSource}/resources-list" }), svc, auth, proto, ver, rules)) {}
...
export class PricingPlan extends S.Class<PricingPlan>("PricingPlan")({billableEntityCount: S.optional(S.Number), bundleInformation: S.optional(BundleInformation), effectiveDateTime: S.Date.pipe(T.TimestampFormat("epoch-seconds")), pricingMode: S.String, updateDateTime: S.Date.pipe(T.TimestampFormat("epoch-seconds")), updateReason: S.String}) {}
...
export class UpdateSceneResponse extends S.Class<UpdateSceneResponse>("UpdateSceneResponse")({updateDateTime: S.Date.pipe(T.TimestampFormat("epoch-seconds"))}) {}
export class UpdateWorkspaceResponse extends S.Class<UpdateWorkspaceResponse>("UpdateWorkspaceResponse")({updateDateTime: S.Date.pipe(T.TimestampFormat("epoch-seconds"))}) {}
export class PropertyValue extends S.Class<PropertyValue>("PropertyValue")({timestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), value: DataValue, time: S.optional(S.String)}) {}
...
export class SceneSummary extends S.Class<SceneSummary>("SceneSummary")({sceneId: S.String, contentLocation: S.String, arn: S.String, creationDateTime: S.Date.pipe(T.TimestampFormat("epoch-seconds")), updateDateTime: S.Date.pipe(T.TimestampFormat("epoch-seconds")), description: S.optional(S.String)}) {}
export const SceneSummaries = S.Array(SceneSummary);
export class SyncJobSummary extends S.Class<SyncJobSummary>("SyncJobSummary")({arn: S.optional(S.String), workspaceId: S.optional(S.String), syncSource: S.optional(S.String), status: S.optional(SyncJobStatus), creationDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), updateDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
export const SyncJobSummaries = S.Array(SyncJobSummary);
export class WorkspaceSummary extends S.Class<WorkspaceSummary>("WorkspaceSummary")({workspaceId: S.String, arn: S.String, description: S.optional(S.String), linkedServices: S.optional(LinkedServices), creationDateTime: S.Date.pipe(T.TimestampFormat("epoch-seconds")), updateDateTime: S.Date.pipe(T.TimestampFormat("epoch-seconds"))}) {}
...
export class CreateSceneResponse extends S.Class<CreateSceneResponse>("CreateSceneResponse")({arn: S.String, creationDateTime: S.Date.pipe(T.TimestampFormat("epoch-seconds"))}) {}
...
export class GetPropertyValueRequest extends S.Class<GetPropertyValueRequest>("GetPropertyValueRequest")({componentName: S.optional(S.String), componentPath: S.optional(S.String), componentTypeId: S.optional(S.String), entityId: S.optional(S.String), selectedProperties: SelectedPropertyList, workspaceId: S.String.pipe(T.HttpLabel("workspaceId")), maxResults: S.optional(S.Number), nextToken: S.optional(S.String), propertyGroupName: S.optional(S.String), tabularConditions: S.optional(TabularConditions)}, T.all(T.Http({ method: "POST", uri: "/workspaces/{workspaceId}/entity-properties/value" }), svc, auth, proto, ver, rules)) {}
...
export class GetSyncJobResponse extends S.Class<GetSyncJobResponse>("GetSyncJobResponse")({arn: S.String, workspaceId: S.String, syncSource: S.String, syncRole: S.String, status: SyncJobStatus, creationDateTime: S.Date.pipe(T.TimestampFormat("epoch-seconds")), updateDateTime: S.Date.pipe(T.TimestampFormat("epoch-seconds"))}) {}
...
export class UpdateEntityRequest extends S.Class<UpdateEntityRequest>("UpdateEntityRequest")({workspaceId: S.String.pipe(T.HttpLabel("workspaceId")), entityId: S.String.pipe(T.HttpLabel("entityId")), entityName: S.optional(S.String), description: S.optional(S.String), componentUpdates: S.optional(ComponentUpdatesMapRequest), compositeComponentUpdates: S.optional(CompositeComponentUpdatesMapRequest), parentEntityUpdate: S.optional(ParentEntityUpdateRequest)}, T.all(T.Http({ method: "PUT", uri: "/workspaces/{workspaceId}/entities/{entityId}" }), svc, auth, proto, ver, rules)) {}
...
export class ComponentTypeSummary extends S.Class<ComponentTypeSummary>("ComponentTypeSummary")({arn: S.String, componentTypeId: S.String, creationDateTime: S.Date.pipe(T.TimestampFormat("epoch-seconds")), updateDateTime: S.Date.pipe(T.TimestampFormat("epoch-seconds")), description: S.optional(S.String), status: S.optional(Status), componentTypeName: S.optional(S.String)}) {}
export const ComponentTypeSummaries = S.Array(ComponentTypeSummary);
export class EntitySummary extends S.Class<EntitySummary>("EntitySummary")({entityId: S.String, entityName: S.String, arn: S.String, parentEntityId: S.optional(S.String), status: Status, description: S.optional(S.String), hasChildEntities: S.optional(S.Boolean), creationDateTime: S.Date.pipe(T.TimestampFormat("epoch-seconds")), updateDateTime: S.Date.pipe(T.TimestampFormat("epoch-seconds"))}) {}
export const EntitySummaries = S.Array(EntitySummary);
export class MetadataTransferJobSummary extends S.Class<MetadataTransferJobSummary>("MetadataTransferJobSummary")({metadataTransferJobId: S.String, arn: S.String, creationDateTime: S.Date.pipe(T.TimestampFormat("epoch-seconds")), updateDateTime: S.Date.pipe(T.TimestampFormat("epoch-seconds")), status: MetadataTransferJobStatus, progress: S.optional(MetadataTransferJobProgress)}) {}
...
export class BatchPutPropertyValuesRequest extends S.Class<BatchPutPropertyValuesRequest>("BatchPutPropertyValuesRequest")({workspaceId: S.String.pipe(T.HttpLabel("workspaceId")), entries: Entries}, T.all(T.Http({ method: "POST", uri: "/workspaces/{workspaceId}/entity-properties" }), svc, auth, proto, ver, rules)) {}
export class CancelMetadataTransferJobResponse extends S.Class<CancelMetadataTransferJobResponse>("CancelMetadataTransferJobResponse")({metadataTransferJobId: S.String, arn: S.String, updateDateTime: S.Date.pipe(T.TimestampFormat("epoch-seconds")), status: MetadataTransferJobStatus, progress: S.optional(MetadataTransferJobProgress)}) {}
...
export class UpdateEntityResponse extends S.Class<UpdateEntityResponse>("UpdateEntityResponse")({updateDateTime: S.Date.pipe(T.TimestampFormat("epoch-seconds")), state: S.String}) {}
...
export class SyncResourceSummary extends S.Class<SyncResourceSummary>("SyncResourceSummary")({resourceType: S.optional(S.String), externalId: S.optional(S.String), resourceId: S.optional(S.String), status: S.optional(SyncResourceStatus), updateDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
...
export class CreateComponentTypeResponse extends S.Class<CreateComponentTypeResponse>("CreateComponentTypeResponse")({arn: S.String, creationDateTime: S.Date.pipe(T.TimestampFormat("epoch-seconds")), state: S.String}) {}
export class CreateEntityResponse extends S.Class<CreateEntityResponse>("CreateEntityResponse")({entityId: S.String, arn: S.String, creationDateTime: S.Date.pipe(T.TimestampFormat("epoch-seconds")), state: S.String}) {}
export class CreateMetadataTransferJobResponse extends S.Class<CreateMetadataTransferJobResponse>("CreateMetadataTransferJobResponse")({metadataTransferJobId: S.String, arn: S.String, creationDateTime: S.Date.pipe(T.TimestampFormat("epoch-seconds")), status: MetadataTransferJobStatus}) {}
export class GetEntityResponse extends S.Class<GetEntityResponse>("GetEntityResponse")({entityId: S.String, entityName: S.String, arn: S.String, status: Status, workspaceId: S.String, description: S.optional(S.String), components: S.optional(ComponentsMap), parentEntityId: S.String, hasChildEntities: S.Boolean, creationDateTime: S.Date.pipe(T.TimestampFormat("epoch-seconds")), updateDateTime: S.Date.pipe(T.TimestampFormat("epoch-seconds")), syncSource: S.optional(S.String), areAllComponentsReturned: S.optional(S.Boolean)}) {}
...
export class QueryTimeoutException extends S.TaggedError<QueryTimeoutException>()("QueryTimeoutException", {message: S.optional(S.String)}, T.Retryable()) {}
...
export class ConnectorFailureException extends S.TaggedError<ConnectorFailureException>()("ConnectorFailureException", {message: S.optional(S.String)}) {}
export class ConnectorTimeoutException extends S.TaggedError<ConnectorTimeoutException>()("ConnectorTimeoutException", {message: S.optional(S.String)}) {}

//# Operations
/**
 * Lists all tags associated with a resource.
 */
export const listTagsForResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListTagsForResourceRequest, output: ListTagsForResourceResponse, errors: [AccessDeniedException, ResourceNotFoundException] }));
/**
 * Removes tags from a resource.
 */
export const untagResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UntagResourceRequest, output: UntagResourceResponse, errors: [AccessDeniedException, ResourceNotFoundException] }));
/**
 * Adds tags to a resource.
 */
export const tagResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: TagResourceRequest, output: TagResourceResponse, errors: [AccessDeniedException, ResourceNotFoundException, TooManyTagsException] }));
/**
 * Gets the pricing plan.
 */
export const getPricingPlan = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetPricingPlanRequest, output: GetPricingPlanResponse, errors: [AccessDeniedException, InternalServerException, ThrottlingException, ValidationException] }));
/**
 * This API lists the components of an entity.
 */
export const listComponents = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListComponentsRequest, output: ListComponentsResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Lists the sync resources.
 */
export const listSyncResources = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListSyncResourcesRequest, output: ListSyncResourcesResponse, errors: [AccessDeniedException, InternalServerException, ServiceQuotaExceededException, ThrottlingException, ValidationException] }));
/**
 * Lists all component types in a workspace.
 */
export const listComponentTypes = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListComponentTypesRequest, output: ListComponentTypesResponse, errors: [AccessDeniedException, InternalServerException, ThrottlingException, ValidationException] }));
/**
 * Lists the metadata transfer jobs.
 */
export const listMetadataTransferJobs = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListMetadataTransferJobsRequest, output: ListMetadataTransferJobsResponse, errors: [AccessDeniedException, InternalServerException, ThrottlingException, ValidationException] }));
/**
 * List all SyncJobs.
 */
export const listSyncJobs = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListSyncJobsRequest, output: ListSyncJobsResponse, errors: [AccessDeniedException, InternalServerException, ServiceQuotaExceededException, ThrottlingException, ValidationException] }));
/**
 * Updates an entity.
 */
export const updateEntity = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateEntityRequest, output: UpdateEntityResponse, errors: [AccessDeniedException, ConflictException, InternalServerException, ResourceNotFoundException, ServiceQuotaExceededException, ThrottlingException, ValidationException] }));
/**
 * Lists all scenes in a workspace.
 */
export const listScenes = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListScenesRequest, output: ListScenesResponse, errors: [AccessDeniedException, InternalServerException, ThrottlingException, ValidationException] }));
/**
 * Deletes a scene.
 */
export const deleteScene = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteSceneRequest, output: DeleteSceneResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Deletes a workspace.
 */
export const deleteWorkspace = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteWorkspaceRequest, output: DeleteWorkspaceResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Gets a nmetadata transfer job.
 */
export const getMetadataTransferJob = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetMetadataTransferJobRequest, output: GetMetadataTransferJobResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Update the pricing plan.
 */
export const updatePricingPlan = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdatePricingPlanRequest, output: UpdatePricingPlanResponse, errors: [AccessDeniedException, InternalServerException, ThrottlingException, ValidationException] }));
/**
 * Updates a scene.
 */
export const updateScene = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateSceneRequest, output: UpdateSceneResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Deletes a component type.
 */
export const deleteComponentType = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteComponentTypeRequest, output: DeleteComponentTypeResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Retrieves information about a scene.
 */
export const getScene = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetSceneRequest, output: GetSceneResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * This API lists the properties of a component.
 */
export const listProperties = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListPropertiesRequest, output: ListPropertiesResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Cancels the metadata transfer job.
 */
export const cancelMetadataTransferJob = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CancelMetadataTransferJobRequest, output: CancelMetadataTransferJobResponse, errors: [AccessDeniedException, ConflictException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Retrieves information about a component type.
 */
export const getComponentType = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetComponentTypeRequest, output: GetComponentTypeResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Retrieves information about workspaces in the current account.
 */
export const listWorkspaces = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListWorkspacesRequest, output: ListWorkspacesResponse, errors: [InternalServerException, ServiceQuotaExceededException, ThrottlingException, ValidationException] }));
/**
 * Delete the SyncJob.
 */
export const deleteSyncJob = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteSyncJobRequest, output: DeleteSyncJobResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ServiceQuotaExceededException, ThrottlingException, ValidationException] }));
/**
 * Retrieves information about a workspace.
 */
export const getWorkspace = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetWorkspaceRequest, output: GetWorkspaceResponse, errors: [InternalServerException, ResourceNotFoundException, ServiceQuotaExceededException, ThrottlingException, ValidationException] }));
/**
 * Updates information in a component type.
 */
export const updateComponentType = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateComponentTypeRequest, output: UpdateComponentTypeResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ServiceQuotaExceededException, ThrottlingException, ValidationException] }));
/**
 * Updates a workspace.
 */
export const updateWorkspace = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateWorkspaceRequest, output: UpdateWorkspaceResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ServiceQuotaExceededException, ThrottlingException, ValidationException] }));
/**
 * This action creates a SyncJob.
 */
export const createSyncJob = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateSyncJobRequest, output: CreateSyncJobResponse, errors: [AccessDeniedException, ConflictException, InternalServerException, ServiceQuotaExceededException, ThrottlingException, ValidationException] }));
/**
 * Deletes an entity.
 */
export const deleteEntity = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteEntityRequest, output: DeleteEntityResponse, errors: [InternalServerException, ResourceNotFoundException, ServiceQuotaExceededException, ThrottlingException, ValidationException] }));
/**
 * Gets the SyncJob.
 */
export const getSyncJob = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetSyncJobRequest, output: GetSyncJobResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ServiceQuotaExceededException, ThrottlingException, ValidationException] }));
/**
 * Creates a workplace.
 */
export const createWorkspace = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateWorkspaceRequest, output: CreateWorkspaceResponse, errors: [AccessDeniedException, ConflictException, InternalServerException, ServiceQuotaExceededException, ThrottlingException, ValidationException] }));
/**
 * Creates a scene.
 */
export const createScene = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateSceneRequest, output: CreateSceneResponse, errors: [AccessDeniedException, ConflictException, InternalServerException, ServiceQuotaExceededException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const executeQuery = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ExecuteQueryRequest, output: ExecuteQueryResponse, errors: [AccessDeniedException, InternalServerException, QueryTimeoutException, ServiceQuotaExceededException, ThrottlingException, ValidationException] }));
/**
 * Lists all entities in a workspace.
 */
export const listEntities = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListEntitiesRequest, output: ListEntitiesResponse, errors: [InternalServerException, ServiceQuotaExceededException, ThrottlingException, ValidationException] }));
/**
 * Creates a component type.
 */
export const createComponentType = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateComponentTypeRequest, output: CreateComponentTypeResponse, errors: [AccessDeniedException, ConflictException, InternalServerException, ServiceQuotaExceededException, ThrottlingException, ValidationException] }));
/**
 * Creates an entity.
 */
export const createEntity = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateEntityRequest, output: CreateEntityResponse, errors: [AccessDeniedException, ConflictException, InternalServerException, ServiceQuotaExceededException, ThrottlingException, ValidationException] }));
/**
 * Creates a new metadata transfer job.
 */
export const createMetadataTransferJob = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateMetadataTransferJobRequest, output: CreateMetadataTransferJobResponse, errors: [AccessDeniedException, ConflictException, InternalServerException, ResourceNotFoundException, ServiceQuotaExceededException, ThrottlingException, ValidationException] }));
/**
 * Retrieves information about an entity.
 */
export const getEntity = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetEntityRequest, output: GetEntityResponse, errors: [InternalServerException, ResourceNotFoundException, ServiceQuotaExceededException, ThrottlingException, ValidationException] }));
/**
 * Sets values for multiple time series properties.
 */
export const batchPutPropertyValues = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: BatchPutPropertyValuesRequest, output: BatchPutPropertyValuesResponse, errors: [InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const getPropertyValue = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetPropertyValueRequest, output: GetPropertyValueResponse, errors: [AccessDeniedException, ConnectorFailureException, ConnectorTimeoutException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const getPropertyValueHistory = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetPropertyValueHistoryRequest, output: GetPropertyValueHistoryResponse, errors: [AccessDeniedException, ConnectorFailureException, ConnectorTimeoutException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
