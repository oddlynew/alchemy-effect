...
const svc = T.AwsApiService({ sdkId: "Connect Contact Lens", serviceShapeName: "AmazonConnectContactLens" });
...
//# Schemas
export class ListRealtimeContactAnalysisSegmentsRequest extends S.Class<ListRealtimeContactAnalysisSegmentsRequest>("ListRealtimeContactAnalysisSegmentsRequest")({InstanceId: S.String, ContactId: S.String, MaxResults: S.optional(S.Number), NextToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/realtime-contact-analysis/analysis-segments" }), svc, auth, proto, ver, rules)) {}
 ...
 */
export const listRealtimeContactAnalysisSegments = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListRealtimeContactAnalysisSegmentsRequest, output: ListRealtimeContactAnalysisSegmentsResponse, errors: [AccessDeniedException, InternalServiceException, InvalidRequestException, ResourceNotFoundException, ThrottlingException] }));
