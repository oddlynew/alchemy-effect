...
//# Schemas
export class GetRecordsInput extends S.Class<GetRecordsInput>("GetRecordsInput")({shardIterator: S.String, maxResults: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetShardIteratorInput extends S.Class<GetShardIteratorInput>("GetShardIteratorInput")({streamArn: S.String, shardId: S.String, shardIteratorType: S.String, sequenceNumber: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListStreamsInput extends S.Class<ListStreamsInput>("ListStreamsInput")({keyspaceName: S.optional(S.String), tableName: S.optional(S.String), maxResults: S.optional(S.Number), nextToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class GetStreamInput extends S.Class<GetStreamInput>("GetStreamInput")({streamArn: S.String, maxResults: S.optional(S.Number), shardFilter: S.optional(ShardFilter), nextToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export type KeyspacesCellValue = { asciiT: string } | { bigintT: string } | { blobT: Uint8Array } | { boolT: boolean } | { counterT: string } | { dateT: string } | { decimalT: string } | { doubleT: string } | { floatT: string } | { inetT: string } | { intT: string } | { listT: KeyspacesCellList } | { mapT: KeyspacesCellMap } | { setT: KeyspacesCellList } | { smallintT: string } | { textT: string } | { timeT: string } | { timestampT: string } | { timeuuidT: string } | { tinyintT: string } | { tupleT: KeyspacesCellList } | { uuidT: string } | { varcharT: string } | { varintT: string } | { udtT: KeyspacesUdtMap };
export const KeyspacesCellValue = S.Union(S.Struct({ asciiT: S.String }), S.Struct({ bigintT: S.String }), S.Struct({ blobT: T.Blob }), S.Struct({ boolT: S.Boolean }), S.Struct({ counterT: S.String }), S.Struct({ dateT: S.String }), S.Struct({ decimalT: S.String }), S.Struct({ doubleT: S.String }), S.Struct({ floatT: S.String }), S.Struct({ inetT: S.String }), S.Struct({ intT: S.String }), S.Struct({ listT: S.suspend(() => KeyspacesCellList) }), S.Struct({ mapT: S.suspend(() => KeyspacesCellMap) }), S.Struct({ setT: S.suspend(() => KeyspacesCellList) }), S.Struct({ smallintT: S.String }), S.Struct({ textT: S.String }), S.Struct({ timeT: S.String }), S.Struct({ timestampT: S.String }), S.Struct({ timeuuidT: S.String }), S.Struct({ tinyintT: S.String }), S.Struct({ tupleT: S.suspend(() => KeyspacesCellList) }), S.Struct({ uuidT: S.String }), S.Struct({ varcharT: S.String }), S.Struct({ varintT: S.String }), S.Struct({ udtT: S.suspend(() => KeyspacesUdtMap) })) as any as S.Schema<KeyspacesCellValue>;
export class GetStreamOutput extends S.Class<GetStreamOutput>("GetStreamOutput")({streamArn: S.String, streamLabel: S.String, streamStatus: S.String, streamViewType: S.String, creationRequestDateTime: S.Date.pipe(T.TimestampFormat("epoch-seconds")), keyspaceName: S.String, tableName: S.String, shards: S.optional(ShardDescriptionList), nextToken: S.optional(S.String)}) {}
...
//# Errors
export class AccessDeniedException extends S.TaggedError<AccessDeniedException>()("AccessDeniedException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "AccessDeniedException", httpResponseCode: 403 })) {}
export class InternalServerException extends S.TaggedError<InternalServerException>()("InternalServerException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "InternalServerException", httpResponseCode: 500 })).pipe(withCategory(ERROR_CATEGORIES.SERVER_ERROR)) {}
...
export class ThrottlingException extends S.TaggedError<ThrottlingException>()("ThrottlingException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "ThrottlingException", httpResponseCode: 429 })).pipe(withCategory(ERROR_CATEGORIES.THROTTLING_ERROR)) {}
export class ValidationException extends S.TaggedError<ValidationException>()("ValidationException", {message: S.optional(S.String), errorCode: S.optional(S.String)}, T.AwsQueryError({ code: "ValidationException", httpResponseCode: 400 })) {}
 ...
 */
export const getShardIterator = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetShardIteratorInput, output: GetShardIteratorOutput, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const getStream = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetStreamInput, output: GetStreamOutput, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const listStreams = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListStreamsInput, output: ListStreamsOutput, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const getRecords = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetRecordsInput, output: GetRecordsOutput, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
