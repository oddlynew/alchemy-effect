...
const svc = T.AwsApiService({ sdkId: "Marketplace Reporting", serviceShapeName: "AWSMarketplaceReporting" });
...
export class GetBuyerDashboardInput extends S.Class<GetBuyerDashboardInput>("GetBuyerDashboardInput")({dashboardIdentifier: S.String, embeddingDomains: EmbeddingDomains}, T.all(T.Http({ method: "POST", uri: "/getBuyerDashboard" }), svc, auth, proto, ver, rules)) {}
export class GetBuyerDashboardOutput extends S.Class<GetBuyerDashboardOutput>("GetBuyerDashboardOutput")({embedUrl: S.String, dashboardIdentifier: S.String, embeddingDomains: EmbeddingDomains}) {}
 ...
 */
export const getBuyerDashboard = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetBuyerDashboardInput, output: GetBuyerDashboardOutput, errors: [AccessDeniedException, BadRequestException, InternalServerException, UnauthorizedException] }));
