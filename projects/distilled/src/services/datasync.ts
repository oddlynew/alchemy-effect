...
export class CancelTaskExecutionRequest extends S.Class<CancelTaskExecutionRequest>("CancelTaskExecutionRequest")({TaskExecutionArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class CreateLocationFsxLustreRequest extends S.Class<CreateLocationFsxLustreRequest>("CreateLocationFsxLustreRequest")({FsxFilesystemArn: S.String, SecurityGroupArns: Ec2SecurityGroupArnList, Subdirectory: S.optional(S.String), Tags: S.optional(InputTagList)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class CreateLocationFsxOpenZfsRequest extends S.Class<CreateLocationFsxOpenZfsRequest>("CreateLocationFsxOpenZfsRequest")({FsxFilesystemArn: S.String, Protocol: FsxProtocol, SecurityGroupArns: Ec2SecurityGroupArnList, Subdirectory: S.optional(S.String), Tags: S.optional(InputTagList)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class CreateLocationObjectStorageRequest extends S.Class<CreateLocationObjectStorageRequest>("CreateLocationObjectStorageRequest")({ServerHostname: S.String, ServerPort: S.optional(S.Number), ServerProtocol: S.optional(S.String), Subdirectory: S.optional(S.String), BucketName: S.String, AccessKey: S.optional(S.String), SecretKey: S.optional(S.String), AgentArns: S.optional(AgentArnList), Tags: S.optional(InputTagList), ServerCertificate: S.optional(T.Blob), CmkSecretConfig: S.optional(CmkSecretConfig), CustomSecretConfig: S.optional(CustomSecretConfig)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteAgentRequest extends S.Class<DeleteAgentRequest>("DeleteAgentRequest")({AgentArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteAgentResponse extends S.Class<DeleteAgentResponse>("DeleteAgentResponse")({}) {}
export class DeleteLocationRequest extends S.Class<DeleteLocationRequest>("DeleteLocationRequest")({LocationArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteLocationResponse extends S.Class<DeleteLocationResponse>("DeleteLocationResponse")({}) {}
export class DeleteTaskRequest extends S.Class<DeleteTaskRequest>("DeleteTaskRequest")({TaskArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteTaskResponse extends S.Class<DeleteTaskResponse>("DeleteTaskResponse")({}) {}
export class DescribeAgentRequest extends S.Class<DescribeAgentRequest>("DescribeAgentRequest")({AgentArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeLocationAzureBlobRequest extends S.Class<DescribeLocationAzureBlobRequest>("DescribeLocationAzureBlobRequest")({LocationArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeLocationEfsRequest extends S.Class<DescribeLocationEfsRequest>("DescribeLocationEfsRequest")({LocationArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeLocationFsxLustreRequest extends S.Class<DescribeLocationFsxLustreRequest>("DescribeLocationFsxLustreRequest")({LocationArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeLocationFsxOntapRequest extends S.Class<DescribeLocationFsxOntapRequest>("DescribeLocationFsxOntapRequest")({LocationArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeLocationFsxOpenZfsRequest extends S.Class<DescribeLocationFsxOpenZfsRequest>("DescribeLocationFsxOpenZfsRequest")({LocationArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeLocationFsxWindowsRequest extends S.Class<DescribeLocationFsxWindowsRequest>("DescribeLocationFsxWindowsRequest")({LocationArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeLocationHdfsRequest extends S.Class<DescribeLocationHdfsRequest>("DescribeLocationHdfsRequest")({LocationArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeLocationNfsRequest extends S.Class<DescribeLocationNfsRequest>("DescribeLocationNfsRequest")({LocationArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeLocationObjectStorageRequest extends S.Class<DescribeLocationObjectStorageRequest>("DescribeLocationObjectStorageRequest")({LocationArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeLocationS3Request extends S.Class<DescribeLocationS3Request>("DescribeLocationS3Request")({LocationArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeLocationSmbRequest extends S.Class<DescribeLocationSmbRequest>("DescribeLocationSmbRequest")({LocationArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeTaskRequest extends S.Class<DescribeTaskRequest>("DescribeTaskRequest")({TaskArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeTaskExecutionRequest extends S.Class<DescribeTaskExecutionRequest>("DescribeTaskExecutionRequest")({TaskExecutionArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListAgentsRequest extends S.Class<ListAgentsRequest>("ListAgentsRequest")({MaxResults: S.optional(S.Number), NextToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListTagsForResourceRequest extends S.Class<ListTagsForResourceRequest>("ListTagsForResourceRequest")({ResourceArn: S.String, MaxResults: S.optional(S.Number), NextToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListTaskExecutionsRequest extends S.Class<ListTaskExecutionsRequest>("ListTaskExecutionsRequest")({TaskArn: S.optional(S.String), MaxResults: S.optional(S.Number), NextToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class StartTaskExecutionRequest extends S.Class<StartTaskExecutionRequest>("StartTaskExecutionRequest")({TaskArn: S.String, OverrideOptions: S.optional(Options), Includes: S.optional(FilterList), Excludes: S.optional(FilterList), ManifestConfig: S.optional(ManifestConfig), TaskReportConfig: S.optional(TaskReportConfig), Tags: S.optional(InputTagList)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class TagResourceRequest extends S.Class<TagResourceRequest>("TagResourceRequest")({ResourceArn: S.String, Tags: InputTagList}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class TagResourceResponse extends S.Class<TagResourceResponse>("TagResourceResponse")({}) {}
export class UntagResourceRequest extends S.Class<UntagResourceRequest>("UntagResourceRequest")({ResourceArn: S.String, Keys: TagKeyList}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class UntagResourceResponse extends S.Class<UntagResourceResponse>("UntagResourceResponse")({}) {}
export class UpdateAgentRequest extends S.Class<UpdateAgentRequest>("UpdateAgentRequest")({AgentArn: S.String, Name: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class UpdateLocationEfsRequest extends S.Class<UpdateLocationEfsRequest>("UpdateLocationEfsRequest")({LocationArn: S.String, Subdirectory: S.optional(S.String), AccessPointArn: S.optional(S.String), FileSystemAccessRoleArn: S.optional(S.String), InTransitEncryption: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class UpdateLocationEfsResponse extends S.Class<UpdateLocationEfsResponse>("UpdateLocationEfsResponse")({}) {}
export class UpdateLocationFsxLustreRequest extends S.Class<UpdateLocationFsxLustreRequest>("UpdateLocationFsxLustreRequest")({LocationArn: S.String, Subdirectory: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class UpdateLocationFsxOpenZfsRequest extends S.Class<UpdateLocationFsxOpenZfsRequest>("UpdateLocationFsxOpenZfsRequest")({LocationArn: S.String, Protocol: S.optional(FsxProtocol), Subdirectory: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class UpdateLocationFsxWindowsRequest extends S.Class<UpdateLocationFsxWindowsRequest>("UpdateLocationFsxWindowsRequest")({LocationArn: S.String, Subdirectory: S.optional(S.String), Domain: S.optional(S.String), User: S.optional(S.String), Password: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class UpdateLocationNfsRequest extends S.Class<UpdateLocationNfsRequest>("UpdateLocationNfsRequest")({LocationArn: S.String, Subdirectory: S.optional(S.String), ServerHostname: S.optional(S.String), OnPremConfig: S.optional(OnPremConfig), MountOptions: S.optional(NfsMountOptions)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class UpdateLocationNfsResponse extends S.Class<UpdateLocationNfsResponse>("UpdateLocationNfsResponse")({}) {}
export class UpdateLocationObjectStorageRequest extends S.Class<UpdateLocationObjectStorageRequest>("UpdateLocationObjectStorageRequest")({LocationArn: S.String, ServerPort: S.optional(S.Number), ServerProtocol: S.optional(S.String), Subdirectory: S.optional(S.String), ServerHostname: S.optional(S.String), AccessKey: S.optional(S.String), SecretKey: S.optional(S.String), AgentArns: S.optional(AgentArnList), ServerCertificate: S.optional(T.Blob), CmkSecretConfig: S.optional(CmkSecretConfig), CustomSecretConfig: S.optional(CustomSecretConfig)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class CreateAgentRequest extends S.Class<CreateAgentRequest>("CreateAgentRequest")({ActivationKey: S.String, AgentName: S.optional(S.String), Tags: S.optional(InputTagList), VpcEndpointId: S.optional(S.String), SubnetArns: S.optional(PLSubnetArnList), SecurityGroupArns: S.optional(PLSecurityGroupArnList)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class CreateLocationAzureBlobRequest extends S.Class<CreateLocationAzureBlobRequest>("CreateLocationAzureBlobRequest")({ContainerUrl: S.String, AuthenticationType: S.String, SasConfiguration: S.optional(AzureBlobSasConfiguration), BlobType: S.optional(S.String), AccessTier: S.optional(S.String), Subdirectory: S.optional(S.String), AgentArns: S.optional(AgentArnList), Tags: S.optional(InputTagList), CmkSecretConfig: S.optional(CmkSecretConfig), CustomSecretConfig: S.optional(CustomSecretConfig)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class CreateLocationHdfsRequest extends S.Class<CreateLocationHdfsRequest>("CreateLocationHdfsRequest")({Subdirectory: S.optional(S.String), NameNodes: HdfsNameNodeList, BlockSize: S.optional(S.Number), ReplicationFactor: S.optional(S.Number), KmsKeyProviderUri: S.optional(S.String), QopConfiguration: S.optional(QopConfiguration), AuthenticationType: S.String, SimpleUser: S.optional(S.String), KerberosPrincipal: S.optional(S.String), KerberosKeytab: S.optional(T.Blob), KerberosKrb5Conf: S.optional(T.Blob), AgentArns: AgentArnList, Tags: S.optional(InputTagList)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class CreateLocationNfsRequest extends S.Class<CreateLocationNfsRequest>("CreateLocationNfsRequest")({Subdirectory: S.String, ServerHostname: S.String, OnPremConfig: OnPremConfig, MountOptions: S.optional(NfsMountOptions), Tags: S.optional(InputTagList)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class CreateLocationS3Request extends S.Class<CreateLocationS3Request>("CreateLocationS3Request")({Subdirectory: S.optional(S.String), S3BucketArn: S.String, S3StorageClass: S.optional(S.String), S3Config: S3Config, AgentArns: S.optional(AgentArnList), Tags: S.optional(InputTagList)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class DescribeLocationNfsResponse extends S.Class<DescribeLocationNfsResponse>("DescribeLocationNfsResponse")({LocationArn: S.optional(S.String), LocationUri: S.optional(S.String), OnPremConfig: S.optional(OnPremConfig), MountOptions: S.optional(NfsMountOptions), CreationTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
export class ManagedSecretConfig extends S.Class<ManagedSecretConfig>("ManagedSecretConfig")({SecretArn: S.optional(S.String)}) {}
export class DescribeLocationObjectStorageResponse extends S.Class<DescribeLocationObjectStorageResponse>("DescribeLocationObjectStorageResponse")({LocationArn: S.optional(S.String), LocationUri: S.optional(S.String), AccessKey: S.optional(S.String), ServerPort: S.optional(S.Number), ServerProtocol: S.optional(S.String), AgentArns: S.optional(AgentArnList), CreationTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), ServerCertificate: S.optional(T.Blob), ManagedSecretConfig: S.optional(ManagedSecretConfig), CmkSecretConfig: S.optional(CmkSecretConfig), CustomSecretConfig: S.optional(CustomSecretConfig)}) {}
...
export class DescribeLocationSmbResponse extends S.Class<DescribeLocationSmbResponse>("DescribeLocationSmbResponse")({LocationArn: S.optional(S.String), LocationUri: S.optional(S.String), AgentArns: S.optional(AgentArnList), User: S.optional(S.String), Domain: S.optional(S.String), MountOptions: S.optional(SmbMountOptions), CreationTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), DnsIpAddresses: S.optional(DnsIpList), KerberosPrincipal: S.optional(S.String), AuthenticationType: S.optional(S.String), ManagedSecretConfig: S.optional(ManagedSecretConfig), CmkSecretConfig: S.optional(CmkSecretConfig), CustomSecretConfig: S.optional(CustomSecretConfig)}) {}
export class ListLocationsRequest extends S.Class<ListLocationsRequest>("ListLocationsRequest")({MaxResults: S.optional(S.Number), NextToken: S.optional(S.String), Filters: S.optional(LocationFilters)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class ListTasksRequest extends S.Class<ListTasksRequest>("ListTasksRequest")({MaxResults: S.optional(S.Number), NextToken: S.optional(S.String), Filters: S.optional(TaskFilters)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class TaskScheduleDetails extends S.Class<TaskScheduleDetails>("TaskScheduleDetails")({StatusUpdateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), DisabledReason: S.optional(S.String), DisabledBy: S.optional(S.String)}) {}
...
export class CreateLocationFsxOntapRequest extends S.Class<CreateLocationFsxOntapRequest>("CreateLocationFsxOntapRequest")({Protocol: FsxProtocol, SecurityGroupArns: Ec2SecurityGroupArnList, StorageVirtualMachineArn: S.String, Subdirectory: S.optional(S.String), Tags: S.optional(InputTagList)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class UpdateLocationFsxOntapRequest extends S.Class<UpdateLocationFsxOntapRequest>("UpdateLocationFsxOntapRequest")({LocationArn: S.String, Protocol: S.optional(FsxUpdateProtocol), Subdirectory: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
//# Errors
export class InternalException extends S.TaggedError<InternalException>()("InternalException", {message: S.optional(S.String), errorCode: S.optional(S.String)}) {}
export class InvalidRequestException extends S.TaggedError<InvalidRequestException>()("InvalidRequestException", {message: S.optional(S.String), errorCode: S.optional(S.String), datasyncErrorCode: S.optional(S.String)}) {}
 ...
 */
export const cancelTaskExecution = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CancelTaskExecutionRequest, output: CancelTaskExecutionResponse, errors: [InternalException, InvalidRequestException] }));
/**
 ...
 * agent?
 */
export const createAgent = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateAgentRequest, output: CreateAgentResponse, errors: [InternalException, InvalidRequestException] }));
/**
 ...
 */
export const createLocationAzureBlob = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateLocationAzureBlobRequest, output: CreateLocationAzureBlobResponse, errors: [InternalException, InvalidRequestException] }));
/**
 ...
 */
export const createLocationEfs = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateLocationEfsRequest, output: CreateLocationEfsResponse, errors: [InternalException, InvalidRequestException] }));
/**
 ...
 * clusters.
 */
export const createLocationHdfs = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateLocationHdfsRequest, output: CreateLocationHdfsResponse, errors: [InternalException, InvalidRequestException] }));
/**
 ...
 * servers.
 */
export const createLocationNfs = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateLocationNfsRequest, output: CreateLocationNfsResponse, errors: [InternalException, InvalidRequestException] }));
/**
 ...
 */
export const createLocationS3 = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateLocationS3Request, output: CreateLocationS3Response, errors: [InternalException, InvalidRequestException] }));
/**
 ...
 */
export const createLocationSmb = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateLocationSmbRequest, output: CreateLocationSmbResponse, errors: [InternalException, InvalidRequestException] }));
/**
 * Returns information about an DataSync agent, such as its name, service
 * endpoint type, and status.
 */
export const describeAgent = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeAgentRequest, output: DescribeAgentResponse, errors: [InternalException, InvalidRequestException] }));
/**
 * Provides details about how an DataSync transfer location for Microsoft Azure
 * Blob Storage is configured.
 */
export const describeLocationAzureBlob = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeLocationAzureBlobRequest, output: DescribeLocationAzureBlobResponse, errors: [InternalException, InvalidRequestException] }));
/**
 * Provides information about a *task*, which defines where and how
 * DataSync transfers your data.
 */
export const describeTask = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeTaskRequest, output: DescribeTaskResponse, errors: [InternalException, InvalidRequestException] }));
/**
 ...
 */
export const describeTaskExecution = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeTaskExecutionRequest, output: DescribeTaskExecutionResponse, errors: [InternalException, InvalidRequestException] }));
/**
 ...
 */
export const listAgents = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListAgentsRequest, output: ListAgentsResponse, errors: [InternalException, InvalidRequestException] }));
/**
 * Returns a list of executions for an DataSync transfer task.
 */
export const listTaskExecutions = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListTaskExecutionsRequest, output: ListTaskExecutionsResponse, errors: [InternalException, InvalidRequestException] }));
/**
 ...
 */
export const updateLocationFsxOntap = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateLocationFsxOntapRequest, output: UpdateLocationFsxOntapResponse, errors: [InternalException, InvalidRequestException] }));
/**
 ...
 */
export const createLocationFsxLustre = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateLocationFsxLustreRequest, output: CreateLocationFsxLustreResponse, errors: [InternalException, InvalidRequestException] }));
/**
 ...
 */
export const createLocationFsxOpenZfs = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateLocationFsxOpenZfsRequest, output: CreateLocationFsxOpenZfsResponse, errors: [InternalException, InvalidRequestException] }));
/**
 ...
 */
export const createLocationFsxWindows = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateLocationFsxWindowsRequest, output: CreateLocationFsxWindowsResponse, errors: [InternalException, InvalidRequestException] }));
/**
 ...
 */
export const createLocationObjectStorage = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateLocationObjectStorageRequest, output: CreateLocationObjectStorageResponse, errors: [InternalException, InvalidRequestException] }));
/**
 * Provides details about how an DataSync transfer location for an Amazon EFS file system is configured.
 */
export const describeLocationEfs = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeLocationEfsRequest, output: DescribeLocationEfsResponse, errors: [InternalException, InvalidRequestException] }));
/**
 * Provides details about how an DataSync transfer location for an Amazon FSx for Lustre file system is configured.
 */
export const describeLocationFsxLustre = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeLocationFsxLustreRequest, output: DescribeLocationFsxLustreResponse, errors: [InternalException, InvalidRequestException] }));
/**
 ...
 */
export const describeLocationFsxOntap = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeLocationFsxOntapRequest, output: DescribeLocationFsxOntapResponse, errors: [InternalException, InvalidRequestException] }));
/**
 ...
 */
export const describeLocationFsxOpenZfs = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeLocationFsxOpenZfsRequest, output: DescribeLocationFsxOpenZfsResponse, errors: [InternalException, InvalidRequestException] }));
/**
 * Provides details about how an DataSync transfer location for an Amazon FSx for Windows File Server file system is configured.
 */
export const describeLocationFsxWindows = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeLocationFsxWindowsRequest, output: DescribeLocationFsxWindowsResponse, errors: [InternalException, InvalidRequestException] }));
/**
 * Provides details about how an DataSync transfer location for a Hadoop
 * Distributed File System (HDFS) is configured.
 */
export const describeLocationHdfs = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeLocationHdfsRequest, output: DescribeLocationHdfsResponse, errors: [InternalException, InvalidRequestException] }));
/**
 * Provides details about how an DataSync transfer location for a Network
 * File System (NFS) file server is configured.
 */
export const describeLocationNfs = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeLocationNfsRequest, output: DescribeLocationNfsResponse, errors: [InternalException, InvalidRequestException] }));
/**
 * Provides details about how an DataSync transfer location for an object
 * storage system is configured.
 */
export const describeLocationObjectStorage = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeLocationObjectStorageRequest, output: DescribeLocationObjectStorageResponse, errors: [InternalException, InvalidRequestException] }));
/**
 * Provides details about how an DataSync transfer location for an S3 bucket
 * is configured.
 */
export const describeLocationS3 = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeLocationS3Request, output: DescribeLocationS3Response, errors: [InternalException, InvalidRequestException] }));
/**
 * Provides details about how an DataSync transfer location for a Server
 * Message Block (SMB) file server is configured.
 */
export const describeLocationSmb = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeLocationSmbRequest, output: DescribeLocationSmbResponse, errors: [InternalException, InvalidRequestException] }));
/**
 * Returns all the tags associated with an Amazon Web Services resource.
 */
export const listTagsForResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListTagsForResourceRequest, output: ListTagsForResourceResponse, errors: [InternalException, InvalidRequestException] }));
/**
 ...
 * you begin.
 */
export const startTaskExecution = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StartTaskExecutionRequest, output: StartTaskExecutionResponse, errors: [InternalException, InvalidRequestException] }));
/**
 ...
 * agent.
 */
export const deleteAgent = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteAgentRequest, output: DeleteAgentResponse, errors: [InternalException, InvalidRequestException] }));
/**
 * Deletes a transfer location resource from DataSync.
 */
export const deleteLocation = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteLocationRequest, output: DeleteLocationResponse, errors: [InternalException, InvalidRequestException] }));
/**
 * Deletes a transfer task resource from DataSync.
 */
export const deleteTask = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteTaskRequest, output: DeleteTaskResponse, errors: [InternalException, InvalidRequestException] }));
/**
 ...
 * executions.
 */
export const tagResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: TagResourceRequest, output: TagResourceResponse, errors: [InternalException, InvalidRequestException] }));
/**
 * Removes tags from an Amazon Web Services resource.
 */
export const untagResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UntagResourceRequest, output: UntagResourceResponse, errors: [InternalException, InvalidRequestException] }));
/**
 * Updates the name of an DataSync agent.
 */
export const updateAgent = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateAgentRequest, output: UpdateAgentResponse, errors: [InternalException, InvalidRequestException] }));
/**
 ...
 */
export const updateLocationAzureBlob = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateLocationAzureBlobRequest, output: UpdateLocationAzureBlobResponse, errors: [InternalException, InvalidRequestException] }));
/**
 ...
 */
export const updateLocationEfs = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateLocationEfsRequest, output: UpdateLocationEfsResponse, errors: [InternalException, InvalidRequestException] }));
/**
 ...
 */
export const updateLocationFsxLustre = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateLocationFsxLustreRequest, output: UpdateLocationFsxLustreResponse, errors: [InternalException, InvalidRequestException] }));
/**
 ...
 */
export const updateLocationFsxOpenZfs = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateLocationFsxOpenZfsRequest, output: UpdateLocationFsxOpenZfsResponse, errors: [InternalException, InvalidRequestException] }));
/**
 ...
 */
export const updateLocationFsxWindows = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateLocationFsxWindowsRequest, output: UpdateLocationFsxWindowsResponse, errors: [InternalException, InvalidRequestException] }));
/**
 ...
 */
export const updateLocationHdfs = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateLocationHdfsRequest, output: UpdateLocationHdfsResponse, errors: [InternalException, InvalidRequestException] }));
/**
 ...
 * file server.
 */
export const updateLocationNfs = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateLocationNfsRequest, output: UpdateLocationNfsResponse, errors: [InternalException, InvalidRequestException] }));
/**
 ...
 */
export const updateLocationObjectStorage = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateLocationObjectStorageRequest, output: UpdateLocationObjectStorageResponse, errors: [InternalException, InvalidRequestException] }));
/**
 ...
 * - Evaluating S3 request costs when using DataSync
 */
export const updateLocationS3 = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateLocationS3Request, output: UpdateLocationS3Response, errors: [InternalException, InvalidRequestException] }));
/**
 ...
 */
export const updateLocationSmb = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateLocationSmbRequest, output: UpdateLocationSmbResponse, errors: [InternalException, InvalidRequestException] }));
/**
 * Updates the configuration of a *task*, which defines where and how
 * DataSync transfers your data.
 */
export const updateTask = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateTaskRequest, output: UpdateTaskResponse, errors: [InternalException, InvalidRequestException] }));
/**
 ...
 * execution.
 */
export const updateTaskExecution = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateTaskExecutionRequest, output: UpdateTaskExecutionResponse, errors: [InternalException, InvalidRequestException] }));
/**
 ...
 */
export const createLocationFsxOntap = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateLocationFsxOntapRequest, output: CreateLocationFsxOntapResponse, errors: [InternalException, InvalidRequestException] }));
/**
 ...
 */
export const listLocations = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListLocationsRequest, output: ListLocationsResponse, errors: [InternalException, InvalidRequestException] }));
/**
 * Returns a list of the DataSync tasks you created.
 */
export const listTasks = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListTasksRequest, output: ListTasksResponse, errors: [InternalException, InvalidRequestException] }));
/**
 ...
 * you begin.
 */
export const createTask = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateTaskRequest, output: CreateTaskResponse, errors: [InternalException, InvalidRequestException] }));
