...
const svc = T.AwsApiService({ sdkId: "IoT Events Data", serviceShapeName: "IotColumboDataService" });
...
//# Schemas
export class DescribeAlarmRequest extends S.Class<DescribeAlarmRequest>("DescribeAlarmRequest")({alarmModelName: S.String.pipe(T.HttpLabel("alarmModelName")), keyValue: S.optional(S.String).pipe(T.HttpQuery("keyValue"))}, T.all(T.Http({ method: "GET", uri: "/alarms/{alarmModelName}/keyValues" }), svc, auth, proto, ver, rules)) {}
export class DescribeDetectorRequest extends S.Class<DescribeDetectorRequest>("DescribeDetectorRequest")({detectorModelName: S.String.pipe(T.HttpLabel("detectorModelName")), keyValue: S.optional(S.String).pipe(T.HttpQuery("keyValue"))}, T.all(T.Http({ method: "GET", uri: "/detectors/{detectorModelName}/keyValues" }), svc, auth, proto, ver, rules)) {}
export class ListAlarmsRequest extends S.Class<ListAlarmsRequest>("ListAlarmsRequest")({alarmModelName: S.String.pipe(T.HttpLabel("alarmModelName")), nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken")), maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults"))}, T.all(T.Http({ method: "GET", uri: "/alarms/{alarmModelName}" }), svc, auth, proto, ver, rules)) {}
export class ListDetectorsRequest extends S.Class<ListDetectorsRequest>("ListDetectorsRequest")({detectorModelName: S.String.pipe(T.HttpLabel("detectorModelName")), stateName: S.optional(S.String).pipe(T.HttpQuery("stateName")), nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken")), maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults"))}, T.all(T.Http({ method: "GET", uri: "/detectors/{detectorModelName}" }), svc, auth, proto, ver, rules)) {}
...
export class BatchAcknowledgeAlarmRequest extends S.Class<BatchAcknowledgeAlarmRequest>("BatchAcknowledgeAlarmRequest")({acknowledgeActionRequests: AcknowledgeAlarmActionRequests}, T.all(T.Http({ method: "POST", uri: "/alarms/acknowledge" }), svc, auth, proto, ver, rules)) {}
export class BatchDeleteDetectorRequest extends S.Class<BatchDeleteDetectorRequest>("BatchDeleteDetectorRequest")({detectors: DeleteDetectorRequests}, T.all(T.Http({ method: "POST", uri: "/detectors/delete" }), svc, auth, proto, ver, rules)) {}
export class BatchDisableAlarmRequest extends S.Class<BatchDisableAlarmRequest>("BatchDisableAlarmRequest")({disableActionRequests: DisableAlarmActionRequests}, T.all(T.Http({ method: "POST", uri: "/alarms/disable" }), svc, auth, proto, ver, rules)) {}
export class BatchEnableAlarmRequest extends S.Class<BatchEnableAlarmRequest>("BatchEnableAlarmRequest")({enableActionRequests: EnableAlarmActionRequests}, T.all(T.Http({ method: "POST", uri: "/alarms/enable" }), svc, auth, proto, ver, rules)) {}
export class BatchResetAlarmRequest extends S.Class<BatchResetAlarmRequest>("BatchResetAlarmRequest")({resetActionRequests: ResetAlarmActionRequests}, T.all(T.Http({ method: "POST", uri: "/alarms/reset" }), svc, auth, proto, ver, rules)) {}
export class BatchSnoozeAlarmRequest extends S.Class<BatchSnoozeAlarmRequest>("BatchSnoozeAlarmRequest")({snoozeActionRequests: SnoozeAlarmActionRequests}, T.all(T.Http({ method: "POST", uri: "/alarms/snooze" }), svc, auth, proto, ver, rules)) {}
export class TimestampValue extends S.Class<TimestampValue>("TimestampValue")({timeInMillis: S.optional(S.Number)}) {}
export class Message extends S.Class<Message>("Message")({messageId: S.String, inputName: S.String, payload: T.Blob, timestamp: S.optional(TimestampValue)}) {}
export const Messages = S.Array(Message);
export class AlarmSummary extends S.Class<AlarmSummary>("AlarmSummary")({alarmModelName: S.optional(S.String), alarmModelVersion: S.optional(S.String), keyValue: S.optional(S.String), stateName: S.optional(S.String), creationTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), lastUpdateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
...
export class BatchPutMessageRequest extends S.Class<BatchPutMessageRequest>("BatchPutMessageRequest")({messages: Messages}, T.all(T.Http({ method: "POST", uri: "/inputs/messages" }), svc, auth, proto, ver, rules)) {}
...
export class DetectorSummary extends S.Class<DetectorSummary>("DetectorSummary")({detectorModelName: S.optional(S.String), keyValue: S.optional(S.String), detectorModelVersion: S.optional(S.String), state: S.optional(DetectorStateSummary), creationTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), lastUpdateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
...
export class Timer extends S.Class<Timer>("Timer")({name: S.String, timestamp: S.Date.pipe(T.TimestampFormat("epoch-seconds"))}) {}
...
export class BatchUpdateDetectorRequest extends S.Class<BatchUpdateDetectorRequest>("BatchUpdateDetectorRequest")({detectors: UpdateDetectorRequests}, T.all(T.Http({ method: "POST", uri: "/detectors" }), svc, auth, proto, ver, rules)) {}
...
export class Detector extends S.Class<Detector>("Detector")({detectorModelName: S.optional(S.String), keyValue: S.optional(S.String), detectorModelVersion: S.optional(S.String), state: S.optional(DetectorState), creationTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), lastUpdateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
...
export class Alarm extends S.Class<Alarm>("Alarm")({alarmModelName: S.optional(S.String), alarmModelVersion: S.optional(S.String), keyValue: S.optional(S.String), alarmState: S.optional(AlarmState), severity: S.optional(S.Number), creationTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), lastUpdateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
 ...
 * you disable them.
 */
export const batchDisableAlarm = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: BatchDisableAlarmRequest, output: BatchDisableAlarmResponse, errors: [InternalFailureException, InvalidRequestException, ServiceUnavailableException, ThrottlingException] }));
/**
 * Updates the state, variable values, and timer settings of one or more detectors
 * (instances) of a specified detector model.
 */
export const batchUpdateDetector = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: BatchUpdateDetectorRequest, output: BatchUpdateDetectorResponse, errors: [InternalFailureException, InvalidRequestException, ServiceUnavailableException, ThrottlingException] }));
/**
 * Returns information about the specified detector (instance).
 */
export const describeDetector = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeDetectorRequest, output: DescribeDetectorResponse, errors: [InternalFailureException, InvalidRequestException, ResourceNotFoundException, ServiceUnavailableException, ThrottlingException] }));
/**
 ...
 * successful response.
 */
export const batchPutMessage = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: BatchPutMessageRequest, output: BatchPutMessageResponse, errors: [InternalFailureException, InvalidRequestException, ServiceUnavailableException, ThrottlingException] }));
/**
 * Enables one or more alarms. The alarms change to the `NORMAL` state after you
 * enable them.
 */
export const batchEnableAlarm = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: BatchEnableAlarmRequest, output: BatchEnableAlarmResponse, errors: [InternalFailureException, InvalidRequestException, ServiceUnavailableException, ThrottlingException] }));
/**
 * Resets one or more alarms. The alarms return to the `NORMAL` state after you
 * reset them.
 */
export const batchResetAlarm = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: BatchResetAlarmRequest, output: BatchResetAlarmResponse, errors: [InternalFailureException, InvalidRequestException, ServiceUnavailableException, ThrottlingException] }));
/**
 ...
 */
export const batchSnoozeAlarm = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: BatchSnoozeAlarmRequest, output: BatchSnoozeAlarmResponse, errors: [InternalFailureException, InvalidRequestException, ServiceUnavailableException, ThrottlingException] }));
/**
 * Acknowledges one or more alarms. The alarms change to the `ACKNOWLEDGED` state
 * after you acknowledge them.
 */
export const batchAcknowledgeAlarm = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: BatchAcknowledgeAlarmRequest, output: BatchAcknowledgeAlarmResponse, errors: [InternalFailureException, InvalidRequestException, ServiceUnavailableException, ThrottlingException] }));
/**
 * Deletes one or more detectors that were created. When a detector is deleted, its state will be cleared and the detector will be removed from the list of detectors. The deleted detector will no longer appear if referenced in the ListDetectors API call.
 */
export const batchDeleteDetector = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: BatchDeleteDetectorRequest, output: BatchDeleteDetectorResponse, errors: [InternalFailureException, InvalidRequestException, ServiceUnavailableException, ThrottlingException] }));
/**
 * Lists detectors (the instances of a detector model).
 */
export const listDetectors = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListDetectorsRequest, output: ListDetectorsResponse, errors: [InternalFailureException, InvalidRequestException, ResourceNotFoundException, ServiceUnavailableException, ThrottlingException] }));
/**
 * Lists one or more alarms. The operation returns only the metadata associated with each
 * alarm.
 */
export const listAlarms = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListAlarmsRequest, output: ListAlarmsResponse, errors: [InternalFailureException, InvalidRequestException, ResourceNotFoundException, ServiceUnavailableException, ThrottlingException] }));
/**
 * Retrieves information about an alarm.
 */
export const describeAlarm = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeAlarmRequest, output: DescribeAlarmResponse, errors: [InternalFailureException, InvalidRequestException, ResourceNotFoundException, ServiceUnavailableException, ThrottlingException] }));
