...
//# Schemas
export class DisassociateServiceRoleFromAccountRequest extends S.Class<DisassociateServiceRoleFromAccountRequest>("DisassociateServiceRoleFromAccountRequest")({}, T.all(T.Http({ method: "DELETE", uri: "/greengrass/servicerole" }), svc, auth, proto, ver, rules)) {}
export class GetServiceRoleForAccountRequest extends S.Class<GetServiceRoleForAccountRequest>("GetServiceRoleForAccountRequest")({}, T.all(T.Http({ method: "GET", uri: "/greengrass/servicerole" }), svc, auth, proto, ver, rules)) {}
export const TagKeyList = S.Array(S.String);
export class AssociateServiceRoleToAccountRequest extends S.Class<AssociateServiceRoleToAccountRequest>("AssociateServiceRoleToAccountRequest")({roleArn: S.String.pipe(T.JsonName("RoleArn"))}, T.all(T.Http({ method: "PUT", uri: "/greengrass/servicerole" }), svc, auth, proto, ver, rules)) {}
export class CancelDeploymentRequest extends S.Class<CancelDeploymentRequest>("CancelDeploymentRequest")({deploymentId: S.String.pipe(T.HttpLabel("deploymentId"))}, T.all(T.Http({ method: "POST", uri: "/greengrass/v2/deployments/{deploymentId}/cancel" }), svc, auth, proto, ver, rules)) {}
export class DeleteComponentRequest extends S.Class<DeleteComponentRequest>("DeleteComponentRequest")({arn: S.String.pipe(T.HttpLabel("arn"))}, T.all(T.Http({ method: "DELETE", uri: "/greengrass/v2/components/{arn}" }), svc, auth, proto, ver, rules)) {}
export class DeleteComponentResponse extends S.Class<DeleteComponentResponse>("DeleteComponentResponse")({}) {}
export class DeleteCoreDeviceRequest extends S.Class<DeleteCoreDeviceRequest>("DeleteCoreDeviceRequest")({coreDeviceThingName: S.String.pipe(T.HttpLabel("coreDeviceThingName"))}, T.all(T.Http({ method: "DELETE", uri: "/greengrass/v2/coreDevices/{coreDeviceThingName}" }), svc, auth, proto, ver, rules)) {}
export class DeleteCoreDeviceResponse extends S.Class<DeleteCoreDeviceResponse>("DeleteCoreDeviceResponse")({}) {}
export class DeleteDeploymentRequest extends S.Class<DeleteDeploymentRequest>("DeleteDeploymentRequest")({deploymentId: S.String.pipe(T.HttpLabel("deploymentId"))}, T.all(T.Http({ method: "DELETE", uri: "/greengrass/v2/deployments/{deploymentId}" }), svc, auth, proto, ver, rules)) {}
export class DeleteDeploymentResponse extends S.Class<DeleteDeploymentResponse>("DeleteDeploymentResponse")({}) {}
export class DescribeComponentRequest extends S.Class<DescribeComponentRequest>("DescribeComponentRequest")({arn: S.String.pipe(T.HttpLabel("arn"))}, T.all(T.Http({ method: "GET", uri: "/greengrass/v2/components/{arn}/metadata" }), svc, auth, proto, ver, rules)) {}
export class DisassociateServiceRoleFromAccountResponse extends S.Class<DisassociateServiceRoleFromAccountResponse>("DisassociateServiceRoleFromAccountResponse")({disassociatedAt: S.optional(S.String).pipe(T.JsonName("DisassociatedAt"))}) {}
export class GetComponentRequest extends S.Class<GetComponentRequest>("GetComponentRequest")({recipeOutputFormat: S.optional(S.String).pipe(T.HttpQuery("recipeOutputFormat")), arn: S.String.pipe(T.HttpLabel("arn"))}, T.all(T.Http({ method: "GET", uri: "/greengrass/v2/components/{arn}" }), svc, auth, proto, ver, rules)) {}
export class GetComponentVersionArtifactRequest extends S.Class<GetComponentVersionArtifactRequest>("GetComponentVersionArtifactRequest")({arn: S.String.pipe(T.HttpLabel("arn")), artifactName: S.String.pipe(T.HttpLabel("artifactName")), s3EndpointType: S.optional(S.String).pipe(T.HttpQuery("s3EndpointType")), iotEndpointType: S.optional(S.String).pipe(T.HttpHeader("x-amz-iot-endpoint-type"))}, T.all(T.Http({ method: "GET", uri: "/greengrass/v2/components/{arn}/artifacts/{artifactName+}" }), svc, auth, proto, ver, rules)) {}
export class GetConnectivityInfoRequest extends S.Class<GetConnectivityInfoRequest>("GetConnectivityInfoRequest")({thingName: S.String.pipe(T.HttpLabel("thingName"))}, T.all(T.Http({ method: "GET", uri: "/greengrass/things/{thingName}/connectivityInfo" }), svc, auth, proto, ver, rules)) {}
export class GetCoreDeviceRequest extends S.Class<GetCoreDeviceRequest>("GetCoreDeviceRequest")({coreDeviceThingName: S.String.pipe(T.HttpLabel("coreDeviceThingName"))}, T.all(T.Http({ method: "GET", uri: "/greengrass/v2/coreDevices/{coreDeviceThingName}" }), svc, auth, proto, ver, rules)) {}
export class GetDeploymentRequest extends S.Class<GetDeploymentRequest>("GetDeploymentRequest")({deploymentId: S.String.pipe(T.HttpLabel("deploymentId"))}, T.all(T.Http({ method: "GET", uri: "/greengrass/v2/deployments/{deploymentId}" }), svc, auth, proto, ver, rules)) {}
export class GetServiceRoleForAccountResponse extends S.Class<GetServiceRoleForAccountResponse>("GetServiceRoleForAccountResponse")({associatedAt: S.optional(S.String).pipe(T.JsonName("AssociatedAt")), roleArn: S.optional(S.String).pipe(T.JsonName("RoleArn"))}) {}
export class ListClientDevicesAssociatedWithCoreDeviceRequest extends S.Class<ListClientDevicesAssociatedWithCoreDeviceRequest>("ListClientDevicesAssociatedWithCoreDeviceRequest")({coreDeviceThingName: S.String.pipe(T.HttpLabel("coreDeviceThingName")), maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults")), nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken"))}, T.all(T.Http({ method: "GET", uri: "/greengrass/v2/coreDevices/{coreDeviceThingName}/associatedClientDevices" }), svc, auth, proto, ver, rules)) {}
export class ListComponentsRequest extends S.Class<ListComponentsRequest>("ListComponentsRequest")({scope: S.optional(S.String).pipe(T.HttpQuery("scope")), maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults")), nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken"))}, T.all(T.Http({ method: "GET", uri: "/greengrass/v2/components" }), svc, auth, proto, ver, rules)) {}
export class ListComponentVersionsRequest extends S.Class<ListComponentVersionsRequest>("ListComponentVersionsRequest")({arn: S.String.pipe(T.HttpLabel("arn")), maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults")), nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken"))}, T.all(T.Http({ method: "GET", uri: "/greengrass/v2/components/{arn}/versions" }), svc, auth, proto, ver, rules)) {}
export class ListCoreDevicesRequest extends S.Class<ListCoreDevicesRequest>("ListCoreDevicesRequest")({thingGroupArn: S.optional(S.String).pipe(T.HttpQuery("thingGroupArn")), status: S.optional(S.String).pipe(T.HttpQuery("status")), maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults")), nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken")), runtime: S.optional(S.String).pipe(T.HttpQuery("runtime"))}, T.all(T.Http({ method: "GET", uri: "/greengrass/v2/coreDevices" }), svc, auth, proto, ver, rules)) {}
export class ListDeploymentsRequest extends S.Class<ListDeploymentsRequest>("ListDeploymentsRequest")({targetArn: S.optional(S.String).pipe(T.HttpQuery("targetArn")), historyFilter: S.optional(S.String).pipe(T.HttpQuery("historyFilter")), parentTargetArn: S.optional(S.String).pipe(T.HttpQuery("parentTargetArn")), maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults")), nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken"))}, T.all(T.Http({ method: "GET", uri: "/greengrass/v2/deployments" }), svc, auth, proto, ver, rules)) {}
export class ListEffectiveDeploymentsRequest extends S.Class<ListEffectiveDeploymentsRequest>("ListEffectiveDeploymentsRequest")({coreDeviceThingName: S.String.pipe(T.HttpLabel("coreDeviceThingName")), maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults")), nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken"))}, T.all(T.Http({ method: "GET", uri: "/greengrass/v2/coreDevices/{coreDeviceThingName}/effectiveDeployments" }), svc, auth, proto, ver, rules)) {}
export class ListInstalledComponentsRequest extends S.Class<ListInstalledComponentsRequest>("ListInstalledComponentsRequest")({coreDeviceThingName: S.String.pipe(T.HttpLabel("coreDeviceThingName")), maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults")), nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken")), topologyFilter: S.optional(S.String).pipe(T.HttpQuery("topologyFilter"))}, T.all(T.Http({ method: "GET", uri: "/greengrass/v2/coreDevices/{coreDeviceThingName}/installedComponents" }), svc, auth, proto, ver, rules)) {}
...
export class ConnectivityInfo extends S.Class<ConnectivityInfo>("ConnectivityInfo")({id: S.optional(S.String).pipe(T.JsonName("Id")), hostAddress: S.optional(S.String).pipe(T.JsonName("HostAddress")), portNumber: S.optional(S.Number).pipe(T.JsonName("PortNumber")), metadata: S.optional(S.String).pipe(T.JsonName("Metadata"))}) {}
export const connectivityInfoList = S.Array(ConnectivityInfo);
export const LambdaExecArgsList = S.Array(S.String);
export class AssociateServiceRoleToAccountResponse extends S.Class<AssociateServiceRoleToAccountResponse>("AssociateServiceRoleToAccountResponse")({associatedAt: S.optional(S.String).pipe(T.JsonName("AssociatedAt"))}) {}
export class BatchAssociateClientDeviceWithCoreDeviceRequest extends S.Class<BatchAssociateClientDeviceWithCoreDeviceRequest>("BatchAssociateClientDeviceWithCoreDeviceRequest")({entries: S.optional(AssociateClientDeviceWithCoreDeviceEntryList), coreDeviceThingName: S.String.pipe(T.HttpLabel("coreDeviceThingName"))}, T.all(T.Http({ method: "POST", uri: "/greengrass/v2/coreDevices/{coreDeviceThingName}/associateClientDevices" }), svc, auth, proto, ver, rules)) {}
export class BatchDisassociateClientDeviceFromCoreDeviceRequest extends S.Class<BatchDisassociateClientDeviceFromCoreDeviceRequest>("BatchDisassociateClientDeviceFromCoreDeviceRequest")({entries: S.optional(DisassociateClientDeviceFromCoreDeviceEntryList), coreDeviceThingName: S.String.pipe(T.HttpLabel("coreDeviceThingName"))}, T.all(T.Http({ method: "POST", uri: "/greengrass/v2/coreDevices/{coreDeviceThingName}/disassociateClientDevices" }), svc, auth, proto, ver, rules)) {}
...
export class GetComponentResponse extends S.Class<GetComponentResponse>("GetComponentResponse")({recipeOutputFormat: S.String, recipe: T.Blob, tags: S.optional(TagMap)}) {}
...
export class GetConnectivityInfoResponse extends S.Class<GetConnectivityInfoResponse>("GetConnectivityInfoResponse")({connectivityInfo: S.optional(connectivityInfoList).pipe(T.JsonName("ConnectivityInfo")), message: S.optional(S.String).pipe(T.JsonName("Message"))}) {}
...
export class GetDeploymentResponse extends S.Class<GetDeploymentResponse>("GetDeploymentResponse")({targetArn: S.optional(S.String), revisionId: S.optional(S.String), deploymentId: S.optional(S.String), deploymentName: S.optional(S.String), deploymentStatus: S.optional(S.String), iotJobId: S.optional(S.String), iotJobArn: S.optional(S.String), components: S.optional(ComponentDeploymentSpecifications), deploymentPolicies: S.optional(DeploymentPolicies), iotJobConfiguration: S.optional(DeploymentIoTJobConfiguration), creationTimestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), isLatestForTarget: S.optional(S.Boolean), parentTargetArn: S.optional(S.String), tags: S.optional(TagMap)}) {}
export class ListTagsForResourceResponse extends S.Class<ListTagsForResourceResponse>("ListTagsForResourceResponse")({tags: S.optional(TagMap)}) {}
export class UpdateConnectivityInfoRequest extends S.Class<UpdateConnectivityInfoRequest>("UpdateConnectivityInfoRequest")({thingName: S.String.pipe(T.HttpLabel("thingName"), T.JsonName("ThingName")), connectivityInfo: connectivityInfoList.pipe(T.JsonName("ConnectivityInfo"))}, T.all(T.Http({ method: "PUT", uri: "/greengrass/things/{thingName}/connectivityInfo" }), svc, auth, proto, ver, rules)) {}
...
export class AssociatedClientDevice extends S.Class<AssociatedClientDevice>("AssociatedClientDevice")({thingName: S.optional(S.String), associationTimestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
...
export class EffectiveDeployment extends S.Class<EffectiveDeployment>("EffectiveDeployment")({deploymentId: S.String, deploymentName: S.String, iotJobId: S.optional(S.String), iotJobArn: S.optional(S.String), description: S.optional(S.String), targetArn: S.String, coreDeviceExecutionStatus: S.String, reason: S.optional(S.String), creationTimestamp: S.Date.pipe(T.TimestampFormat("epoch-seconds")), modifiedTimestamp: S.Date.pipe(T.TimestampFormat("epoch-seconds")), statusDetails: S.optional(EffectiveDeploymentStatusDetails)}) {}
...
export class ResolvedComponentVersion extends S.Class<ResolvedComponentVersion>("ResolvedComponentVersion")({arn: S.optional(S.String), componentName: S.optional(S.String), componentVersion: S.optional(S.String), recipe: S.optional(T.Blob), vendorGuidance: S.optional(S.String), message: S.optional(S.String)}) {}
...
export class CreateComponentVersionRequest extends S.Class<CreateComponentVersionRequest>("CreateComponentVersionRequest")({inlineRecipe: S.optional(T.Blob), lambdaFunction: S.optional(LambdaFunctionRecipeSource), tags: S.optional(TagMap), clientToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/greengrass/v2/createComponentVersion" }), svc, auth, proto, ver, rules)) {}
...
export class CreateComponentVersionResponse extends S.Class<CreateComponentVersionResponse>("CreateComponentVersionResponse")({arn: S.optional(S.String), componentName: S.String, componentVersion: S.String, creationTimestamp: S.Date.pipe(T.TimestampFormat("epoch-seconds")), status: CloudComponentStatus}) {}
...
export class RequestAlreadyInProgressException extends S.TaggedError<RequestAlreadyInProgressException>()("RequestAlreadyInProgressException", {message: S.String}) {}
 ...
 */
export const disassociateServiceRoleFromAccount = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DisassociateServiceRoleFromAccountRequest, output: DisassociateServiceRoleFromAccountResponse, errors: [InternalServerException] }));
/**
 ...
 * the *IoT Greengrass Version 2 Developer Guide*.
 */
export const getServiceRoleForAccount = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetServiceRoleForAccountRequest, output: GetServiceRoleForAccountResponse, errors: [InternalServerException] }));
/**
 ...
 */
export const getConnectivityInfo = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetConnectivityInfoRequest, output: GetConnectivityInfoResponse, errors: [InternalServerException, ValidationException] }));
/**
 ...
 */
export const listEffectiveDeployments = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListEffectiveDeploymentsRequest, output: ListEffectiveDeploymentsResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Retrieves a paginated list of client devices that are associated with a core
 * device.
 */
export const listClientDevicesAssociatedWithCoreDevice = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListClientDevicesAssociatedWithCoreDeviceRequest, output: ListClientDevicesAssociatedWithCoreDeviceResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Retrieves a paginated list of all versions for a component. Greater versions are listed
 * first.
 */
export const listComponentVersions = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListComponentVersionsRequest, output: ListComponentVersionsResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 ...
 * cloud deployment
 */
export const listCoreDevices = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListCoreDevicesRequest, output: ListCoreDevicesResponse, errors: [AccessDeniedException, InternalServerException, ThrottlingException, ValidationException] }));
/**
 * Retrieves a paginated list of deployments.
 */
export const listDeployments = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListDeploymentsRequest, output: ListDeploymentsResponse, errors: [AccessDeniedException, InternalServerException, ThrottlingException, ValidationException] }));
/**
 ...
 * cloud deployment
 */
export const listInstalledComponents = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListInstalledComponentsRequest, output: ListInstalledComponentsResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 ...
 * *IoT API Reference*.
 */
export const deleteCoreDevice = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteCoreDeviceRequest, output: DeleteCoreDeviceResponse, errors: [AccessDeniedException, ConflictException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const deleteDeployment = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteDeploymentRequest, output: DeleteDeploymentResponse, errors: [AccessDeniedException, ConflictException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const cancelDeployment = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CancelDeploymentRequest, output: CancelDeploymentResponse, errors: [AccessDeniedException, ConflictException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 ...
 * install.
 */
export const getComponentVersionArtifact = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetComponentVersionArtifactRequest, output: GetComponentVersionArtifactResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 ...
 * cloud deployment
 */
export const getCoreDevice = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetCoreDeviceRequest, output: GetCoreDeviceResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Gets a deployment. Deployments define the components that run on Greengrass core devices.
 */
export const getDeployment = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetDeploymentRequest, output: GetDeploymentResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const deleteComponent = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteComponentRequest, output: DeleteComponentResponse, errors: [AccessDeniedException, ConflictException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const batchAssociateClientDeviceWithCoreDevice = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: BatchAssociateClientDeviceWithCoreDeviceRequest, output: BatchAssociateClientDeviceWithCoreDeviceResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const batchDisassociateClientDeviceFromCoreDevice = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: BatchDisassociateClientDeviceFromCoreDeviceRequest, output: BatchDisassociateClientDeviceFromCoreDeviceResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Retrieves metadata for a version of a component.
 */
export const describeComponent = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeComponentRequest, output: DescribeComponentResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const associateServiceRoleToAccount = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: AssociateServiceRoleToAccountRequest, output: AssociateServiceRoleToAccountResponse, errors: [InternalServerException, ValidationException] }));
/**
 ...
 * core devices in the *IoT Greengrass Version 2 Developer Guide*.
 */
export const updateConnectivityInfo = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateConnectivityInfoRequest, output: UpdateConnectivityInfoResponse, errors: [InternalServerException, ValidationException] }));
/**
 ...
 */
export const getComponent = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetComponentRequest, output: GetComponentResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const resolveComponentCandidates = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ResolveComponentCandidatesRequest, output: ResolveComponentCandidatesResponse, errors: [AccessDeniedException, ConflictException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const createDeployment = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateDeploymentRequest, output: CreateDeploymentResponse, errors: [AccessDeniedException, ConflictException, InternalServerException, RequestAlreadyInProgressException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const createComponentVersion = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateComponentVersionRequest, output: CreateComponentVersionResponse, errors: [AccessDeniedException, ConflictException, InternalServerException, RequestAlreadyInProgressException, ServiceQuotaExceededException, ThrottlingException, ValidationException] }));
