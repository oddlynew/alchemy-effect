...
export class GetAIAgentRequest extends S.Class<GetAIAgentRequest>(
  ...
  {
    assistantId: S.String.pipe(T.HttpLabel()),
    aiAgentId: S.String.pipe(T.HttpLabel()),
  },
  T.all(
    T.Http({
      method: "GET",
...
export class GetAIGuardrailRequest extends S.Class<GetAIGuardrailRequest>(
  ...
  {
    assistantId: S.String.pipe(T.HttpLabel()),
    aiGuardrailId: S.String.pipe(T.HttpLabel()),
  },
  T.all(
    T.Http({
      method: "GET",
...
export class GetAIPromptRequest extends S.Class<GetAIPromptRequest>(
  ...
  {
    assistantId: S.String.pipe(T.HttpLabel()),
    aiPromptId: S.String.pipe(T.HttpLabel()),
  },
  T.all(
    T.Http({
      method: "GET",
...
export class GetContentAssociationRequest extends S.Class<GetContentAssociationRequest>(
...
)(
  {
    knowledgeBaseId: S.String.pipe(T.HttpLabel()),
    contentId: S.String.pipe(T.HttpLabel()),
    contentAssociationId: S.String.pipe(T.HttpLabel()),
  },
  T.all(
    T.Http({
      method: "GET",
...
export class GetMessageTemplateRequest extends S.Class<GetMessageTemplateRequest>(
  ...
  {
    messageTemplateId: S.String.pipe(T.HttpLabel()),
    knowledgeBaseId: S.String.pipe(T.HttpLabel()),
  },
  T.all(
    T.Http({
