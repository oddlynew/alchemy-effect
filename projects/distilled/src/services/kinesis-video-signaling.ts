...
const svc = T.AwsApiService({ sdkId: "Kinesis Video Signaling", serviceShapeName: "AWSAcuitySignalingService" });
...
//# Schemas
export class GetIceServerConfigRequest extends S.Class<GetIceServerConfigRequest>("GetIceServerConfigRequest")({ChannelARN: S.String, ClientId: S.optional(S.String), Service: S.optional(S.String), Username: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/v1/get-ice-server-config" }), svc, auth, proto, ver, rules)) {}
export class SendAlexaOfferToMasterRequest extends S.Class<SendAlexaOfferToMasterRequest>("SendAlexaOfferToMasterRequest")({ChannelARN: S.String, SenderClientId: S.String, MessagePayload: S.String}, T.all(T.Http({ method: "POST", uri: "/v1/send-alexa-offer-to-master" }), svc, auth, proto, ver, rules)) {}
 ...
 * expires.
 */
export const sendAlexaOfferToMaster = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: SendAlexaOfferToMasterRequest, output: SendAlexaOfferToMasterResponse, errors: [ClientLimitExceededException, InvalidArgumentException, NotAuthorizedException, ResourceNotFoundException] }));
/**
 ...
 * API.
 */
export const getIceServerConfig = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetIceServerConfigRequest, output: GetIceServerConfigResponse, errors: [ClientLimitExceededException, InvalidArgumentException, InvalidClientException, NotAuthorizedException, ResourceNotFoundException, SessionExpiredException] }));
