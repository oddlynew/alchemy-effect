...
//# Schemas
export class DeleteNotificationChannelRequest extends S.Class<DeleteNotificationChannelRequest>("DeleteNotificationChannelRequest")({}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteNotificationChannelResponse extends S.Class<DeleteNotificationChannelResponse>("DeleteNotificationChannelResponse")({}) {}
export class DisassociateAdminAccountRequest extends S.Class<DisassociateAdminAccountRequest>("DisassociateAdminAccountRequest")({}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DisassociateAdminAccountResponse extends S.Class<DisassociateAdminAccountResponse>("DisassociateAdminAccountResponse")({}) {}
export class GetAdminAccountRequest extends S.Class<GetAdminAccountRequest>("GetAdminAccountRequest")({}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetNotificationChannelRequest extends S.Class<GetNotificationChannelRequest>("GetNotificationChannelRequest")({}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export const IdentifierList = S.Array(S.String);
export const AWSAccountIdList = S.Array(S.String);
export const TagKeyList = S.Array(S.String);
export class AssociateAdminAccountRequest extends S.Class<AssociateAdminAccountRequest>("AssociateAdminAccountRequest")({AdminAccount: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class AssociateAdminAccountResponse extends S.Class<AssociateAdminAccountResponse>("AssociateAdminAccountResponse")({}) {}
export class AssociateThirdPartyFirewallRequest extends S.Class<AssociateThirdPartyFirewallRequest>("AssociateThirdPartyFirewallRequest")({ThirdPartyFirewall: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class BatchAssociateResourceRequest extends S.Class<BatchAssociateResourceRequest>("BatchAssociateResourceRequest")({ResourceSetIdentifier: S.String, Items: IdentifierList}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class BatchDisassociateResourceRequest extends S.Class<BatchDisassociateResourceRequest>("BatchDisassociateResourceRequest")({ResourceSetIdentifier: S.String, Items: IdentifierList}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteAppsListRequest extends S.Class<DeleteAppsListRequest>("DeleteAppsListRequest")({ListId: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteAppsListResponse extends S.Class<DeleteAppsListResponse>("DeleteAppsListResponse")({}) {}
export class DeletePolicyRequest extends S.Class<DeletePolicyRequest>("DeletePolicyRequest")({PolicyId: S.String, DeleteAllPolicyResources: S.optional(S.Boolean)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeletePolicyResponse extends S.Class<DeletePolicyResponse>("DeletePolicyResponse")({}) {}
export class DeleteProtocolsListRequest extends S.Class<DeleteProtocolsListRequest>("DeleteProtocolsListRequest")({ListId: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteProtocolsListResponse extends S.Class<DeleteProtocolsListResponse>("DeleteProtocolsListResponse")({}) {}
export class DeleteResourceSetRequest extends S.Class<DeleteResourceSetRequest>("DeleteResourceSetRequest")({Identifier: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteResourceSetResponse extends S.Class<DeleteResourceSetResponse>("DeleteResourceSetResponse")({}) {}
export class DisassociateThirdPartyFirewallRequest extends S.Class<DisassociateThirdPartyFirewallRequest>("DisassociateThirdPartyFirewallRequest")({ThirdPartyFirewall: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class GetAdminScopeRequest extends S.Class<GetAdminScopeRequest>("GetAdminScopeRequest")({AdminAccount: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetAppsListRequest extends S.Class<GetAppsListRequest>("GetAppsListRequest")({ListId: S.String, DefaultList: S.optional(S.Boolean)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetComplianceDetailRequest extends S.Class<GetComplianceDetailRequest>("GetComplianceDetailRequest")({PolicyId: S.String, MemberAccount: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class GetPolicyRequest extends S.Class<GetPolicyRequest>("GetPolicyRequest")({PolicyId: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetProtectionStatusRequest extends S.Class<GetProtectionStatusRequest>("GetProtectionStatusRequest")({PolicyId: S.String, MemberAccountId: S.optional(S.String), StartTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), EndTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), NextToken: S.optional(S.String), MaxResults: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetProtocolsListRequest extends S.Class<GetProtocolsListRequest>("GetProtocolsListRequest")({ListId: S.String, DefaultList: S.optional(S.Boolean)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetResourceSetRequest extends S.Class<GetResourceSetRequest>("GetResourceSetRequest")({Identifier: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetThirdPartyFirewallAssociationStatusRequest extends S.Class<GetThirdPartyFirewallAssociationStatusRequest>("GetThirdPartyFirewallAssociationStatusRequest")({ThirdPartyFirewall: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetViolationDetailsRequest extends S.Class<GetViolationDetailsRequest>("GetViolationDetailsRequest")({PolicyId: S.String, MemberAccount: S.String, ResourceId: S.String, ResourceType: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListAdminAccountsForOrganizationRequest extends S.Class<ListAdminAccountsForOrganizationRequest>("ListAdminAccountsForOrganizationRequest")({NextToken: S.optional(S.String), MaxResults: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListAdminsManagingAccountRequest extends S.Class<ListAdminsManagingAccountRequest>("ListAdminsManagingAccountRequest")({NextToken: S.optional(S.String), MaxResults: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListAppsListsRequest extends S.Class<ListAppsListsRequest>("ListAppsListsRequest")({DefaultLists: S.optional(S.Boolean), NextToken: S.optional(S.String), MaxResults: S.Number}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListComplianceStatusRequest extends S.Class<ListComplianceStatusRequest>("ListComplianceStatusRequest")({PolicyId: S.String, NextToken: S.optional(S.String), MaxResults: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListDiscoveredResourcesRequest extends S.Class<ListDiscoveredResourcesRequest>("ListDiscoveredResourcesRequest")({MemberAccountIds: AWSAccountIdList, ResourceType: S.String, MaxResults: S.optional(S.Number), NextToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListMemberAccountsRequest extends S.Class<ListMemberAccountsRequest>("ListMemberAccountsRequest")({NextToken: S.optional(S.String), MaxResults: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListPoliciesRequest extends S.Class<ListPoliciesRequest>("ListPoliciesRequest")({NextToken: S.optional(S.String), MaxResults: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListProtocolsListsRequest extends S.Class<ListProtocolsListsRequest>("ListProtocolsListsRequest")({DefaultLists: S.optional(S.Boolean), NextToken: S.optional(S.String), MaxResults: S.Number}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListResourceSetResourcesRequest extends S.Class<ListResourceSetResourcesRequest>("ListResourceSetResourcesRequest")({Identifier: S.String, MaxResults: S.optional(S.Number), NextToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListResourceSetsRequest extends S.Class<ListResourceSetsRequest>("ListResourceSetsRequest")({NextToken: S.optional(S.String), MaxResults: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class ListThirdPartyFirewallFirewallPoliciesRequest extends S.Class<ListThirdPartyFirewallFirewallPoliciesRequest>("ListThirdPartyFirewallFirewallPoliciesRequest")({ThirdPartyFirewall: S.String, NextToken: S.optional(S.String), MaxResults: S.Number}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutNotificationChannelRequest extends S.Class<PutNotificationChannelRequest>("PutNotificationChannelRequest")({SnsTopicArn: S.String, SnsRoleName: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutNotificationChannelResponse extends S.Class<PutNotificationChannelResponse>("PutNotificationChannelResponse")({}) {}
export class Tag extends S.Class<Tag>("Tag")({Key: S.String, Value: S.String}) {}
export const TagList = S.Array(Tag);
export class TagResourceRequest extends S.Class<TagResourceRequest>("TagResourceRequest")({ResourceArn: S.String, TagList: TagList}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class ResourceSet extends S.Class<ResourceSet>("ResourceSet")({Id: S.optional(S.String), Name: S.String, Description: S.optional(S.String), UpdateToken: S.optional(S.String), ResourceTypeList: ResourceTypeList, LastUpdateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), ResourceSetStatus: S.optional(S.String)}) {}
...
export class AppsListData extends S.Class<AppsListData>("AppsListData")({ListId: S.optional(S.String), ListName: S.String, ListUpdateToken: S.optional(S.String), CreateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), LastUpdateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), AppsList: AppsList, PreviousAppsList: S.optional(PreviousAppsList)}) {}
...
export class ProtocolsListData extends S.Class<ProtocolsListData>("ProtocolsListData")({ListId: S.optional(S.String), ListName: S.String, ListUpdateToken: S.optional(S.String), CreateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), LastUpdateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), ProtocolsList: ProtocolsList, PreviousProtocolsList: S.optional(PreviousProtocolsList)}) {}
...
export class PutResourceSetRequest extends S.Class<PutResourceSetRequest>("PutResourceSetRequest")({ResourceSet: ResourceSet, TagList: S.optional(TagList)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class ResourceSetSummary extends S.Class<ResourceSetSummary>("ResourceSetSummary")({Id: S.optional(S.String), Name: S.optional(S.String), Description: S.optional(S.String), LastUpdateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), ResourceSetStatus: S.optional(S.String)}) {}
...
export class PutAdminAccountRequest extends S.Class<PutAdminAccountRequest>("PutAdminAccountRequest")({AdminAccount: S.String, AdminScope: S.optional(AdminScope)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutAdminAccountResponse extends S.Class<PutAdminAccountResponse>("PutAdminAccountResponse")({}) {}
export class PutAppsListRequest extends S.Class<PutAppsListRequest>("PutAppsListRequest")({AppsList: AppsListData, TagList: S.optional(TagList)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutProtocolsListRequest extends S.Class<PutProtocolsListRequest>("PutProtocolsListRequest")({ProtocolsList: ProtocolsListData, TagList: S.optional(TagList)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class PutPolicyRequest extends S.Class<PutPolicyRequest>("PutPolicyRequest")({Policy: Policy, TagList: S.optional(TagList)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
 ...
 */
export const deleteNotificationChannel = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteNotificationChannelRequest, output: DeleteNotificationChannelResponse, errors: [InternalErrorException, InvalidOperationException, ResourceNotFoundException] }));
/**
 * Permanently deletes an Firewall Manager policy.
 */
export const deletePolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeletePolicyRequest, output: DeletePolicyResponse, errors: [InternalErrorException, InvalidInputException, InvalidOperationException, LimitExceededException, ResourceNotFoundException] }));
/**
 * Returns information about the specified Firewall Manager policy.
 */
export const getPolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetPolicyRequest, output: GetPolicyResponse, errors: [InternalErrorException, InvalidOperationException, InvalidTypeException, ResourceNotFoundException] }));
/**
 ...
 */
export const listAdminAccountsForOrganization = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListAdminAccountsForOrganizationRequest, output: ListAdminAccountsForOrganizationResponse, errors: [InternalErrorException, InvalidOperationException, LimitExceededException, ResourceNotFoundException] }));
/**
 * Returns an array of `AppsListDataSummary` objects.
 */
export const listAppsLists = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListAppsListsRequest, output: ListAppsListsResponse, errors: [InternalErrorException, InvalidOperationException, LimitExceededException, ResourceNotFoundException] }));
/**
 * Returns an array of resources in the organization's accounts that are available to be associated with a resource set.
 */
export const listDiscoveredResources = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListDiscoveredResourcesRequest, output: ListDiscoveredResourcesResponse, errors: [InternalErrorException, InvalidInputException, InvalidOperationException] }));
/**
 * Returns an array of `PolicySummary` objects.
 */
export const listPolicies = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListPoliciesRequest, output: ListPoliciesResponse, errors: [InternalErrorException, InvalidOperationException, LimitExceededException, ResourceNotFoundException] }));
/**
 * Returns an array of `ProtocolsListDataSummary` objects.
 */
export const listProtocolsLists = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListProtocolsListsRequest, output: ListProtocolsListsResponse, errors: [InternalErrorException, InvalidOperationException, ResourceNotFoundException] }));
/**
 * Returns an array of resources that are currently associated to a resource set.
 */
export const listResourceSetResources = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListResourceSetResourcesRequest, output: ListResourceSetResourcesResponse, errors: [InternalErrorException, InvalidInputException, InvalidOperationException, ResourceNotFoundException] }));
/**
 * Returns an array of `ResourceSetSummary` objects.
 */
export const listResourceSets = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListResourceSetsRequest, output: ListResourceSetsResponse, errors: [InternalErrorException, InvalidInputException, InvalidOperationException] }));
/**
 * Retrieves a list of all of the third-party firewall policies that are associated with the third-party firewall administrator's account.
 */
export const listThirdPartyFirewallFirewallPolicies = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListThirdPartyFirewallFirewallPoliciesRequest, output: ListThirdPartyFirewallFirewallPoliciesResponse, errors: [InternalErrorException, InvalidInputException, InvalidOperationException, ResourceNotFoundException] }));
/**
 ...
 */
export const putAdminAccount = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutAdminAccountRequest, output: PutAdminAccountResponse, errors: [InternalErrorException, InvalidInputException, InvalidOperationException, LimitExceededException] }));
/**
 ...
 */
export const putResourceSet = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutResourceSetRequest, output: PutResourceSetResponse, errors: [InternalErrorException, InvalidInputException, InvalidOperationException, LimitExceededException] }));
/**
 * Disassociates a Firewall Manager policy administrator from a third-party firewall tenant. When you call `DisassociateThirdPartyFirewall`, the third-party firewall vendor deletes all of the firewalls that are associated with the account.
 */
export const disassociateThirdPartyFirewall = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DisassociateThirdPartyFirewallRequest, output: DisassociateThirdPartyFirewallResponse, errors: [InternalErrorException, InvalidInputException, InvalidOperationException, ResourceNotFoundException] }));
/**
 * Returns information about the specified Firewall Manager applications list.
 */
export const getAppsList = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetAppsListRequest, output: GetAppsListResponse, errors: [InternalErrorException, InvalidOperationException, ResourceNotFoundException] }));
/**
 ...
 */
export const getProtectionStatus = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetProtectionStatusRequest, output: GetProtectionStatusResponse, errors: [InternalErrorException, InvalidInputException, ResourceNotFoundException] }));
/**
 * Returns information about the specified Firewall Manager protocols list.
 */
export const getProtocolsList = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetProtocolsListRequest, output: GetProtocolsListResponse, errors: [InternalErrorException, InvalidOperationException, ResourceNotFoundException] }));
/**
 * Gets information about a specific resource set.
 */
export const getResourceSet = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetResourceSetRequest, output: GetResourceSetResponse, errors: [InternalErrorException, InvalidInputException, InvalidOperationException, ResourceNotFoundException] }));
/**
 * The onboarding status of a Firewall Manager admin account to third-party firewall vendor tenant.
 */
export const getThirdPartyFirewallAssociationStatus = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetThirdPartyFirewallAssociationStatusRequest, output: GetThirdPartyFirewallAssociationStatusResponse, errors: [InternalErrorException, InvalidInputException, InvalidOperationException, ResourceNotFoundException] }));
/**
 * Lists the accounts that are managing the specified Organizations member account. This is useful for any member account so that they can view the accounts who are managing their account. This operation only returns the managing administrators that have the requested account within their AdminScope.
 */
export const listAdminsManagingAccount = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListAdminsManagingAccountRequest, output: ListAdminsManagingAccountResponse, errors: [InternalErrorException, InvalidInputException, ResourceNotFoundException] }));
/**
 ...
 */
export const listMemberAccounts = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListMemberAccountsRequest, output: ListMemberAccountsResponse, errors: [InternalErrorException, ResourceNotFoundException] }));
/**
 * Retrieves the list of tags for the specified Amazon Web Services resource.
 */
export const listTagsForResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListTagsForResourceRequest, output: ListTagsForResourceResponse, errors: [InternalErrorException, InvalidInputException, InvalidOperationException, ResourceNotFoundException] }));
/**
 * Permanently deletes an Firewall Manager protocols list.
 */
export const deleteProtocolsList = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteProtocolsListRequest, output: DeleteProtocolsListResponse, errors: [InternalErrorException, InvalidOperationException, ResourceNotFoundException] }));
/**
 * Returns the Organizations account that is associated with Firewall Manager
 * as the Firewall Manager default administrator.
 */
export const getAdminAccount = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetAdminAccountRequest, output: GetAdminAccountResponse, errors: [InternalErrorException, InvalidOperationException, ResourceNotFoundException] }));
/**
 * Information
 * about the Amazon Simple Notification Service (SNS) topic that is used to
 * record Firewall Manager SNS logs.
 */
export const getNotificationChannel = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetNotificationChannelRequest, output: GetNotificationChannelResponse, errors: [InternalErrorException, InvalidOperationException, ResourceNotFoundException] }));
/**
 ...
 */
export const putNotificationChannel = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutNotificationChannelRequest, output: PutNotificationChannelResponse, errors: [InternalErrorException, InvalidOperationException, ResourceNotFoundException] }));
/**
 ...
 */
export const disassociateAdminAccount = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DisassociateAdminAccountRequest, output: DisassociateAdminAccountResponse, errors: [InternalErrorException, InvalidOperationException, ResourceNotFoundException] }));
/**
 * Permanently deletes an Firewall Manager applications list.
 */
export const deleteAppsList = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteAppsListRequest, output: DeleteAppsListResponse, errors: [InternalErrorException, InvalidOperationException, ResourceNotFoundException] }));
/**
 * Deletes the specified ResourceSet.
 */
export const deleteResourceSet = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteResourceSetRequest, output: DeleteResourceSetResponse, errors: [InternalErrorException, InvalidInputException, InvalidOperationException, ResourceNotFoundException] }));
/**
 * Removes one or more tags from an Amazon Web Services resource.
 */
export const untagResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UntagResourceRequest, output: UntagResourceResponse, errors: [InternalErrorException, InvalidInputException, InvalidOperationException, ResourceNotFoundException] }));
/**
 * Sets the Firewall Manager policy administrator as a tenant administrator of a third-party firewall service. A tenant is an instance of the third-party firewall service that's associated with your Amazon Web Services customer account.
 */
export const associateThirdPartyFirewall = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: AssociateThirdPartyFirewallRequest, output: AssociateThirdPartyFirewallResponse, errors: [InternalErrorException, InvalidInputException, InvalidOperationException, ResourceNotFoundException] }));
/**
 * Disassociates resources from a Firewall Manager resource set.
 */
export const batchDisassociateResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: BatchDisassociateResourceRequest, output: BatchDisassociateResourceResponse, errors: [InternalErrorException, InvalidInputException, InvalidOperationException, ResourceNotFoundException] }));
/**
 ...
 */
export const getAdminScope = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetAdminScopeRequest, output: GetAdminScopeResponse, errors: [InternalErrorException, InvalidInputException, InvalidOperationException, LimitExceededException, ResourceNotFoundException] }));
/**
 * Adds one or more tags to an Amazon Web Services resource.
 */
export const tagResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: TagResourceRequest, output: TagResourceResponse, errors: [InternalErrorException, InvalidInputException, InvalidOperationException, LimitExceededException, ResourceNotFoundException] }));
/**
 ...
 */
export const associateAdminAccount = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: AssociateAdminAccountRequest, output: AssociateAdminAccountResponse, errors: [InternalErrorException, InvalidInputException, InvalidOperationException, LimitExceededException, ResourceNotFoundException] }));
/**
 * Associate resources to a Firewall Manager resource set.
 */
export const batchAssociateResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: BatchAssociateResourceRequest, output: BatchAssociateResourceResponse, errors: [InternalErrorException, InvalidInputException, InvalidOperationException, LimitExceededException, ResourceNotFoundException] }));
/**
 ...
 */
export const listComplianceStatus = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListComplianceStatusRequest, output: ListComplianceStatusResponse, errors: [InternalErrorException, ResourceNotFoundException] }));
/**
 * Creates an Firewall Manager applications list.
 */
export const putAppsList = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutAppsListRequest, output: PutAppsListResponse, errors: [InternalErrorException, InvalidInputException, InvalidOperationException, LimitExceededException, ResourceNotFoundException] }));
/**
 * Creates an Firewall Manager protocols list.
 */
export const putProtocolsList = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutProtocolsListRequest, output: PutProtocolsListResponse, errors: [InternalErrorException, InvalidInputException, InvalidOperationException, LimitExceededException, ResourceNotFoundException] }));
/**
 ...
 */
export const getComplianceDetail = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetComplianceDetailRequest, output: GetComplianceDetailResponse, errors: [InternalErrorException, InvalidInputException, InvalidOperationException, ResourceNotFoundException] }));
/**
 ...
 */
export const putPolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutPolicyRequest, output: PutPolicyResponse, errors: [InternalErrorException, InvalidInputException, InvalidOperationException, InvalidTypeException, LimitExceededException, ResourceNotFoundException] }));
/**
 * Retrieves violations for a resource based on the specified Firewall Manager policy and Amazon Web Services account.
 */
export const getViolationDetails = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetViolationDetailsRequest, output: GetViolationDetailsResponse, errors: [InternalErrorException, InvalidInputException, ResourceNotFoundException] }));
