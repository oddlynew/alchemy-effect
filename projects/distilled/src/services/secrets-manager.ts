...
export class CancelRotateSecretRequest extends S.Class<CancelRotateSecretRequest>("CancelRotateSecretRequest")({SecretId: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteResourcePolicyRequest extends S.Class<DeleteResourcePolicyRequest>("DeleteResourcePolicyRequest")({SecretId: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteSecretRequest extends S.Class<DeleteSecretRequest>("DeleteSecretRequest")({SecretId: S.String, RecoveryWindowInDays: S.optional(S.Number), ForceDeleteWithoutRecovery: S.optional(S.Boolean)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeSecretRequest extends S.Class<DescribeSecretRequest>("DescribeSecretRequest")({SecretId: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class GetResourcePolicyRequest extends S.Class<GetResourcePolicyRequest>("GetResourcePolicyRequest")({SecretId: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetSecretValueRequest extends S.Class<GetSecretValueRequest>("GetSecretValueRequest")({SecretId: S.String, VersionId: S.optional(S.String), VersionStage: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class ListSecretsRequest extends S.Class<ListSecretsRequest>("ListSecretsRequest")({IncludePlannedDeletion: S.optional(S.Boolean), MaxResults: S.optional(S.Number), NextToken: S.optional(S.String), Filters: S.optional(FiltersListType), SortOrder: S.optional(S.String), SortBy: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListSecretVersionIdsRequest extends S.Class<ListSecretVersionIdsRequest>("ListSecretVersionIdsRequest")({SecretId: S.String, MaxResults: S.optional(S.Number), NextToken: S.optional(S.String), IncludeDeprecated: S.optional(S.Boolean)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutResourcePolicyRequest extends S.Class<PutResourcePolicyRequest>("PutResourcePolicyRequest")({SecretId: S.String, ResourcePolicy: S.String, BlockPublicPolicy: S.optional(S.Boolean)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutSecretValueRequest extends S.Class<PutSecretValueRequest>("PutSecretValueRequest")({SecretId: S.String, ClientRequestToken: S.optional(S.String), SecretBinary: S.optional(T.Blob), SecretString: S.optional(S.String), VersionStages: S.optional(SecretVersionStagesType), RotationToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class RemoveRegionsFromReplicationRequest extends S.Class<RemoveRegionsFromReplicationRequest>("RemoveRegionsFromReplicationRequest")({SecretId: S.String, RemoveReplicaRegions: RemoveReplicaRegionListType}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class ReplicateSecretToRegionsRequest extends S.Class<ReplicateSecretToRegionsRequest>("ReplicateSecretToRegionsRequest")({SecretId: S.String, AddReplicaRegions: AddReplicaRegionListType, ForceOverwriteReplicaSecret: S.optional(S.Boolean)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class RestoreSecretRequest extends S.Class<RestoreSecretRequest>("RestoreSecretRequest")({SecretId: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class StopReplicationToReplicaRequest extends S.Class<StopReplicationToReplicaRequest>("StopReplicationToReplicaRequest")({SecretId: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class TagResourceRequest extends S.Class<TagResourceRequest>("TagResourceRequest")({SecretId: S.String, Tags: TagListType}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class TagResourceResponse extends S.Class<TagResourceResponse>("TagResourceResponse")({}) {}
export class UntagResourceRequest extends S.Class<UntagResourceRequest>("UntagResourceRequest")({SecretId: S.String, TagKeys: TagKeyListType}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class UpdateSecretVersionStageRequest extends S.Class<UpdateSecretVersionStageRequest>("UpdateSecretVersionStageRequest")({SecretId: S.String, VersionStage: S.String, RemoveFromVersionId: S.optional(S.String), MoveToVersionId: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ValidateResourcePolicyRequest extends S.Class<ValidateResourcePolicyRequest>("ValidateResourcePolicyRequest")({SecretId: S.optional(S.String), ResourcePolicy: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class BatchGetSecretValueRequest extends S.Class<BatchGetSecretValueRequest>("BatchGetSecretValueRequest")({SecretIdList: S.optional(SecretIdListType), Filters: S.optional(FiltersListType), MaxResults: S.optional(S.Number), NextToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class DeleteSecretResponse extends S.Class<DeleteSecretResponse>("DeleteSecretResponse")({ARN: S.optional(S.String), Name: S.optional(S.String), DeletionDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
...
export class ReplicationStatusType extends S.Class<ReplicationStatusType>("ReplicationStatusType")({Region: S.optional(S.String), KmsKeyId: S.optional(S.String), Status: S.optional(S.String), StatusMessage: S.optional(S.String), LastAccessedDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
...
export class SecretListEntry extends S.Class<SecretListEntry>("SecretListEntry")({ARN: S.optional(S.String), Name: S.optional(S.String), Type: S.optional(S.String), Description: S.optional(S.String), KmsKeyId: S.optional(S.String), RotationEnabled: S.optional(S.Boolean), RotationLambdaARN: S.optional(S.String), RotationRules: S.optional(RotationRulesType), ExternalSecretRotationMetadata: S.optional(ExternalSecretRotationMetadataType), ExternalSecretRotationRoleArn: S.optional(S.String), LastRotatedDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), LastChangedDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), LastAccessedDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), DeletedDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), NextRotationDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), Tags: S.optional(TagListType), SecretVersionsToStages: S.optional(SecretVersionsToStagesMapType), OwningService: S.optional(S.String), CreatedDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), PrimaryRegion: S.optional(S.String)}) {}
export const SecretListType = S.Array(SecretListEntry);
export class SecretVersionsListEntry extends S.Class<SecretVersionsListEntry>("SecretVersionsListEntry")({VersionId: S.optional(S.String), VersionStages: S.optional(SecretVersionStagesType), LastAccessedDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), CreatedDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), KmsKeyIds: S.optional(KmsKeyIdListType)}) {}
...
//# Errors
export class InternalServiceError extends S.TaggedError<InternalServiceError>()("InternalServiceError", {Message: S.optional(S.String)}) {}
export class DecryptionFailure extends S.TaggedError<DecryptionFailure>()("DecryptionFailure", {Message: S.optional(S.String)}) {}
...
export class EncryptionFailure extends S.TaggedError<EncryptionFailure>()("EncryptionFailure", {Message: S.optional(S.String)}) {}
...
export class ResourceExistsException extends S.TaggedError<ResourceExistsException>()("ResourceExistsException", {Message: S.optional(S.String)}) {}
export class PreconditionNotMetException extends S.TaggedError<PreconditionNotMetException>()("PreconditionNotMetException", {Message: S.optional(S.String)}) {}
 ...
 */
export const describeSecret = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeSecretRequest, output: DescribeSecretResponse, errors: [InternalServiceError, InvalidParameterException, ResourceNotFoundException] }));
/**
 ...
 * and access control in Secrets Manager.
 */
export const untagResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UntagResourceRequest, output: UntagResourceResponse, errors: [InternalServiceError, InvalidParameterException, InvalidRequestException, ResourceNotFoundException] }));
/**
 ...
 * and access control in Secrets Manager.
 */
export const cancelRotateSecret = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CancelRotateSecretRequest, output: CancelRotateSecretResponse, errors: [InternalServiceError, InvalidParameterException, InvalidRequestException, ResourceNotFoundException] }));
/**
 ...
 * and access control in Secrets Manager.
 */
export const deleteResourcePolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteResourcePolicyRequest, output: DeleteResourcePolicyResponse, errors: [InternalServiceError, InvalidParameterException, InvalidRequestException, ResourceNotFoundException] }));
/**
 ...
 * and access control in Secrets Manager.
 */
export const deleteSecret = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteSecretRequest, output: DeleteSecretResponse, errors: [InternalServiceError, InvalidParameterException, InvalidRequestException, ResourceNotFoundException] }));
/**
 ...
 * and access control in Secrets Manager.
 */
export const getRandomPassword = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetRandomPasswordRequest, output: GetRandomPasswordResponse, errors: [InternalServiceError, InvalidParameterException, InvalidRequestException] }));
/**
 ...
 * and access control in Secrets Manager.
 */
export const getResourcePolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetResourcePolicyRequest, output: GetResourcePolicyResponse, errors: [InternalServiceError, InvalidParameterException, InvalidRequestException, ResourceNotFoundException] }));
/**
 ...
 * and access control in Secrets Manager.
 */
export const removeRegionsFromReplication = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: RemoveRegionsFromReplicationRequest, output: RemoveRegionsFromReplicationResponse, errors: [InternalServiceError, InvalidParameterException, InvalidRequestException, ResourceNotFoundException] }));
/**
 ...
 * and access control in Secrets Manager.
 */
export const replicateSecretToRegions = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ReplicateSecretToRegionsRequest, output: ReplicateSecretToRegionsResponse, errors: [InternalServiceError, InvalidParameterException, InvalidRequestException, ResourceNotFoundException] }));
/**
 ...
 * and access control in Secrets Manager.
 */
export const restoreSecret = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: RestoreSecretRequest, output: RestoreSecretResponse, errors: [InternalServiceError, InvalidParameterException, InvalidRequestException, ResourceNotFoundException] }));
/**
 ...
 * and access control in Secrets Manager.
 */
export const stopReplicationToReplica = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StopReplicationToReplicaRequest, output: StopReplicationToReplicaResponse, errors: [InternalServiceError, InvalidParameterException, InvalidRequestException, ResourceNotFoundException] }));
/**
 ...
 * and access control in Secrets Manager.
 */
export const getSecretValue = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetSecretValueRequest, output: GetSecretValueResponse, errors: [DecryptionFailure, InternalServiceError, InvalidParameterException, InvalidRequestException, ResourceNotFoundException] }));
/**
 ...
 */
export const rotateSecret = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: RotateSecretRequest, output: RotateSecretResponse, errors: [InternalServiceError, InvalidParameterException, InvalidRequestException, ResourceNotFoundException] }));
/**
 ...
 * and access control in Secrets Manager.
 */
export const listSecrets = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListSecretsRequest, output: ListSecretsResponse, errors: [InternalServiceError, InvalidNextTokenException, InvalidParameterException, InvalidRequestException] }));
/**
 ...
 * and access control in Secrets Manager.
 */
export const tagResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: TagResourceRequest, output: TagResourceResponse, errors: [InternalServiceError, InvalidParameterException, InvalidRequestException, ResourceNotFoundException] }));
/**
 ...
 * and access control in Secrets Manager.
 */
export const listSecretVersionIds = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListSecretVersionIdsRequest, output: ListSecretVersionIdsResponse, errors: [InternalServiceError, InvalidNextTokenException, InvalidParameterException, ResourceNotFoundException] }));
/**
 * Retrieves the contents of the encrypted fields `SecretString` or
 ...
 * and access control in Secrets Manager.
 */
export const batchGetSecretValue = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: BatchGetSecretValueRequest, output: BatchGetSecretValueResponse, errors: [DecryptionFailure, InternalServiceError, InvalidNextTokenException, InvalidParameterException, InvalidRequestException, ResourceNotFoundException] }));
/**
 ...
 * and access control in Secrets Manager.
 */
export const validateResourcePolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ValidateResourcePolicyRequest, output: ValidateResourcePolicyResponse, errors: [InternalServiceError, InvalidParameterException, InvalidRequestException, MalformedPolicyDocumentException, ResourceNotFoundException] }));
/**
 ...
 * and access control in Secrets Manager.
 */
export const updateSecretVersionStage = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateSecretVersionStageRequest, output: UpdateSecretVersionStageResponse, errors: [InternalServiceError, InvalidParameterException, InvalidRequestException, LimitExceededException, ResourceNotFoundException] }));
/**
 ...
 */
export const putSecretValue = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutSecretValueRequest, output: PutSecretValueResponse, errors: [DecryptionFailure, EncryptionFailure, InternalServiceError, InvalidParameterException, InvalidRequestException, LimitExceededException, ResourceExistsException, ResourceNotFoundException] }));
/**
 ...
 * When you enter commands in a command shell, there is a risk of the command history being accessed or utilities having access to your command parameters. This is a concern if the command includes the value of a secret. Learn how to Mitigate the risks of using command-line tools to store Secrets Manager secrets.
 */
export const updateSecret = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateSecretRequest, output: UpdateSecretResponse, errors: [DecryptionFailure, EncryptionFailure, InternalServiceError, InvalidParameterException, InvalidRequestException, LimitExceededException, MalformedPolicyDocumentException, PreconditionNotMetException, ResourceExistsException, ResourceNotFoundException] }));
/**
 ...
 * and access control in Secrets Manager.
 */
export const putResourcePolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutResourcePolicyRequest, output: PutResourcePolicyResponse, errors: [InternalServiceError, InvalidParameterException, InvalidRequestException, MalformedPolicyDocumentException, PublicPolicyException, ResourceNotFoundException] }));
/**
 ...
 * When you enter commands in a command shell, there is a risk of the command history being accessed or utilities having access to your command parameters. This is a concern if the command includes the value of a secret. Learn how to Mitigate the risks of using command-line tools to store Secrets Manager secrets.
 */
export const createSecret = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateSecretRequest, output: CreateSecretResponse, errors: [DecryptionFailure, EncryptionFailure, InternalServiceError, InvalidParameterException, InvalidRequestException, LimitExceededException, MalformedPolicyDocumentException, PreconditionNotMetException, ResourceExistsException, ResourceNotFoundException] }));
