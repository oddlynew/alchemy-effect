...
export class AddProfilePermissionRequest extends S.Class<AddProfilePermissionRequest>("AddProfilePermissionRequest")({profileName: S.String.pipe(T.HttpLabel("profileName")), profileVersion: S.optional(S.String), action: S.String, principal: S.String, revisionId: S.optional(S.String), statementId: S.String}, T.all(T.Http({ method: "POST", uri: "/signing-profiles/{profileName}/permissions" }), svc, auth, proto, ver, rules)) {}
export class CancelSigningProfileRequest extends S.Class<CancelSigningProfileRequest>("CancelSigningProfileRequest")({profileName: S.String.pipe(T.HttpLabel("profileName"))}, T.all(T.Http({ method: "DELETE", uri: "/signing-profiles/{profileName}" }), svc, auth, proto, ver, rules)) {}
export class CancelSigningProfileResponse extends S.Class<CancelSigningProfileResponse>("CancelSigningProfileResponse")({}) {}
export class DescribeSigningJobRequest extends S.Class<DescribeSigningJobRequest>("DescribeSigningJobRequest")({jobId: S.String.pipe(T.HttpLabel("jobId"))}, T.all(T.Http({ method: "GET", uri: "/signing-jobs/{jobId}" }), svc, auth, proto, ver, rules)) {}
export class GetRevocationStatusRequest extends S.Class<GetRevocationStatusRequest>("GetRevocationStatusRequest")({signatureTimestamp: S.Date.pipe(T.TimestampFormat("epoch-seconds")).pipe(T.HttpQuery("signatureTimestamp")), platformId: S.String.pipe(T.HttpQuery("platformId")), profileVersionArn: S.String.pipe(T.HttpQuery("profileVersionArn")), jobArn: S.String.pipe(T.HttpQuery("jobArn")), certificateHashes: CertificateHashes.pipe(T.HttpQuery("certificateHashes"))}, T.all(T.Http({ method: "GET", uri: "/revocations" }), svc, auth, proto, ver, rules)) {}
export class GetSigningPlatformRequest extends S.Class<GetSigningPlatformRequest>("GetSigningPlatformRequest")({platformId: S.String.pipe(T.HttpLabel("platformId"))}, T.all(T.Http({ method: "GET", uri: "/signing-platforms/{platformId}" }), svc, auth, proto, ver, rules)) {}
export class GetSigningProfileRequest extends S.Class<GetSigningProfileRequest>("GetSigningProfileRequest")({profileName: S.String.pipe(T.HttpLabel("profileName")), profileOwner: S.optional(S.String).pipe(T.HttpQuery("profileOwner"))}, T.all(T.Http({ method: "GET", uri: "/signing-profiles/{profileName}" }), svc, auth, proto, ver, rules)) {}
export class ListProfilePermissionsRequest extends S.Class<ListProfilePermissionsRequest>("ListProfilePermissionsRequest")({profileName: S.String.pipe(T.HttpLabel("profileName")), nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken"))}, T.all(T.Http({ method: "GET", uri: "/signing-profiles/{profileName}/permissions" }), svc, auth, proto, ver, rules)) {}
export class ListSigningJobsRequest extends S.Class<ListSigningJobsRequest>("ListSigningJobsRequest")({status: S.optional(S.String).pipe(T.HttpQuery("status")), platformId: S.optional(S.String).pipe(T.HttpQuery("platformId")), requestedBy: S.optional(S.String).pipe(T.HttpQuery("requestedBy")), maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults")), nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken")), isRevoked: S.optional(S.Boolean).pipe(T.HttpQuery("isRevoked")), signatureExpiresBefore: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))).pipe(T.HttpQuery("signatureExpiresBefore")), signatureExpiresAfter: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))).pipe(T.HttpQuery("signatureExpiresAfter")), jobInvoker: S.optional(S.String).pipe(T.HttpQuery("jobInvoker"))}, T.all(T.Http({ method: "GET", uri: "/signing-jobs" }), svc, auth, proto, ver, rules)) {}
export class ListSigningPlatformsRequest extends S.Class<ListSigningPlatformsRequest>("ListSigningPlatformsRequest")({category: S.optional(S.String).pipe(T.HttpQuery("category")), partner: S.optional(S.String).pipe(T.HttpQuery("partner")), target: S.optional(S.String).pipe(T.HttpQuery("target")), maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults")), nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken"))}, T.all(T.Http({ method: "GET", uri: "/signing-platforms" }), svc, auth, proto, ver, rules)) {}
export class ListSigningProfilesRequest extends S.Class<ListSigningProfilesRequest>("ListSigningProfilesRequest")({includeCanceled: S.optional(S.Boolean).pipe(T.HttpQuery("includeCanceled")), maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults")), nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken")), platformId: S.optional(S.String).pipe(T.HttpQuery("platformId")), statuses: S.optional(Statuses).pipe(T.HttpQuery("statuses"))}, T.all(T.Http({ method: "GET", uri: "/signing-profiles" }), svc, auth, proto, ver, rules)) {}
...
export class RemoveProfilePermissionRequest extends S.Class<RemoveProfilePermissionRequest>("RemoveProfilePermissionRequest")({profileName: S.String.pipe(T.HttpLabel("profileName")), revisionId: S.String.pipe(T.HttpQuery("revisionId")), statementId: S.String.pipe(T.HttpLabel("statementId"))}, T.all(T.Http({ method: "DELETE", uri: "/signing-profiles/{profileName}/permissions/{statementId}" }), svc, auth, proto, ver, rules)) {}
export class RevokeSignatureRequest extends S.Class<RevokeSignatureRequest>("RevokeSignatureRequest")({jobId: S.String.pipe(T.HttpLabel("jobId")), jobOwner: S.optional(S.String), reason: S.String}, T.all(T.Http({ method: "PUT", uri: "/signing-jobs/{jobId}/revoke" }), svc, auth, proto, ver, rules)) {}
export class RevokeSignatureResponse extends S.Class<RevokeSignatureResponse>("RevokeSignatureResponse")({}) {}
export class RevokeSigningProfileRequest extends S.Class<RevokeSigningProfileRequest>("RevokeSigningProfileRequest")({profileName: S.String.pipe(T.HttpLabel("profileName")), profileVersion: S.String, reason: S.String, effectiveTime: S.Date.pipe(T.TimestampFormat("epoch-seconds"))}, T.all(T.Http({ method: "PUT", uri: "/signing-profiles/{profileName}/revoke" }), svc, auth, proto, ver, rules)) {}
export class RevokeSigningProfileResponse extends S.Class<RevokeSigningProfileResponse>("RevokeSigningProfileResponse")({}) {}
export class SignPayloadRequest extends S.Class<SignPayloadRequest>("SignPayloadRequest")({profileName: S.String, profileOwner: S.optional(S.String), payload: T.Blob, payloadFormat: S.String}, T.all(T.Http({ method: "POST", uri: "/signing-jobs/with-payload" }), svc, auth, proto, ver, rules)) {}
...
export class SigningJobRevocationRecord extends S.Class<SigningJobRevocationRecord>("SigningJobRevocationRecord")({reason: S.optional(S.String), revokedAt: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), revokedBy: S.optional(S.String)}) {}
...
export class SigningProfileRevocationRecord extends S.Class<SigningProfileRevocationRecord>("SigningProfileRevocationRecord")({revocationEffectiveFrom: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), revokedAt: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), revokedBy: S.optional(S.String)}) {}
...
export class PutSigningProfileRequest extends S.Class<PutSigningProfileRequest>("PutSigningProfileRequest")({profileName: S.String.pipe(T.HttpLabel("profileName")), signingMaterial: S.optional(SigningMaterial), signatureValidityPeriod: S.optional(SignatureValidityPeriod), platformId: S.String, overrides: S.optional(SigningPlatformOverrides), signingParameters: S.optional(SigningParameters), tags: S.optional(TagMap)}, T.all(T.Http({ method: "PUT", uri: "/signing-profiles/{profileName}" }), svc, auth, proto, ver, rules)) {}
export class SignPayloadResponse extends S.Class<SignPayloadResponse>("SignPayloadResponse")({jobId: S.optional(S.String), jobOwner: S.optional(S.String), metadata: S.optional(Metadata), signature: S.optional(T.Blob)}) {}
export class StartSigningJobRequest extends S.Class<StartSigningJobRequest>("StartSigningJobRequest")({source: Source, destination: Destination, profileName: S.String, clientRequestToken: S.String, profileOwner: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/signing-jobs" }), svc, auth, proto, ver, rules)) {}
export class DescribeSigningJobResponse extends S.Class<DescribeSigningJobResponse>("DescribeSigningJobResponse")({jobId: S.optional(S.String), source: S.optional(Source), signingMaterial: S.optional(SigningMaterial), platformId: S.optional(S.String), platformDisplayName: S.optional(S.String), profileName: S.optional(S.String), profileVersion: S.optional(S.String), overrides: S.optional(SigningPlatformOverrides), signingParameters: S.optional(SigningParameters), createdAt: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), completedAt: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), signatureExpiresAt: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), requestedBy: S.optional(S.String), status: S.optional(S.String), statusReason: S.optional(S.String), revocationRecord: S.optional(SigningJobRevocationRecord), signedObject: S.optional(SignedObject), jobOwner: S.optional(S.String), jobInvoker: S.optional(S.String)}) {}
...
export class BadRequestException extends S.TaggedError<BadRequestException>()("BadRequestException", {message: S.optional(S.String), code: S.optional(S.String)}) {}
export class InternalServiceErrorException extends S.TaggedError<InternalServiceErrorException>()("InternalServiceErrorException", {message: S.optional(S.String), code: S.optional(S.String)}).pipe(withCategory(ERROR_CATEGORIES.SERVER_ERROR)) {}
export class ConflictException extends S.TaggedError<ConflictException>()("ConflictException", {message: S.optional(S.String), code: S.optional(S.String)}) {}
export class ResourceNotFoundException extends S.TaggedError<ResourceNotFoundException>()("ResourceNotFoundException", {message: S.optional(S.String), code: S.optional(S.String)}) {}
export class TooManyRequestsException extends S.TaggedError<TooManyRequestsException>()("TooManyRequestsException", {message: S.optional(S.String), code: S.optional(S.String)}).pipe(withCategory(ERROR_CATEGORIES.THROTTLING_ERROR)) {}
export class NotFoundException extends S.TaggedError<NotFoundException>()("NotFoundException", {message: S.optional(S.String), code: S.optional(S.String)}) {}
export class ValidationException extends S.TaggedError<ValidationException>()("ValidationException", {message: S.optional(S.String), code: S.optional(S.String)}) {}
export class ThrottlingException extends S.TaggedError<ThrottlingException>()("ThrottlingException", {message: S.optional(S.String), code: S.optional(S.String)}).pipe(withCategory(ERROR_CATEGORIES.THROTTLING_ERROR)) {}
 ...
 */
export const tagResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: TagResourceRequest, output: TagResourceResponse, errors: [BadRequestException, InternalServiceErrorException, NotFoundException, TooManyRequestsException] }));
/**
 * Returns information on a specific signing profile.
 */
export const getSigningProfile = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetSigningProfileRequest, output: GetSigningProfileResponse, errors: [AccessDeniedException, InternalServiceErrorException, ResourceNotFoundException, TooManyRequestsException] }));
/**
 ...
 */
export const listSigningProfiles = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListSigningProfilesRequest, output: ListSigningProfilesResponse, errors: [AccessDeniedException, InternalServiceErrorException, TooManyRequestsException] }));
/**
 ...
 */
export const cancelSigningProfile = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CancelSigningProfileRequest, output: CancelSigningProfileResponse, errors: [AccessDeniedException, InternalServiceErrorException, ResourceNotFoundException, TooManyRequestsException] }));
/**
 ...
 * operation.
 */
export const describeSigningJob = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeSigningJobRequest, output: DescribeSigningJobResponse, errors: [AccessDeniedException, InternalServiceErrorException, ResourceNotFoundException, TooManyRequestsException] }));
/**
 * Returns information on a specific signing platform.
 */
export const getSigningPlatform = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetSigningPlatformRequest, output: GetSigningPlatformResponse, errors: [AccessDeniedException, InternalServiceErrorException, ResourceNotFoundException, TooManyRequestsException] }));
/**
 * Removes one or more tags from a signing profile. To remove the tags, specify a list of
 * tag keys.
 */
export const untagResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UntagResourceRequest, output: UntagResourceResponse, errors: [BadRequestException, InternalServiceErrorException, NotFoundException, TooManyRequestsException] }));
/**
 * Returns a list of the tags associated with a signing profile resource.
 */
export const listTagsForResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListTagsForResourceRequest, output: ListTagsForResourceResponse, errors: [BadRequestException, InternalServiceErrorException, NotFoundException, TooManyRequestsException] }));
/**
 ...
 */
export const listSigningJobs = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListSigningJobsRequest, output: ListSigningJobsResponse, errors: [AccessDeniedException, InternalServiceErrorException, TooManyRequestsException, ValidationException] }));
/**
 ...
 */
export const startSigningJob = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StartSigningJobRequest, output: StartSigningJobResponse, errors: [AccessDeniedException, InternalServiceErrorException, ResourceNotFoundException, ThrottlingException, TooManyRequestsException, ValidationException] }));
/**
 * Adds cross-account permissions to a signing profile.
 */
export const addProfilePermission = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: AddProfilePermissionRequest, output: AddProfilePermissionResponse, errors: [AccessDeniedException, ConflictException, InternalServiceErrorException, ResourceNotFoundException, ServiceLimitExceededException, TooManyRequestsException, ValidationException] }));
/**
 ...
 */
export const putSigningProfile = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutSigningProfileRequest, output: PutSigningProfileResponse, errors: [AccessDeniedException, InternalServiceErrorException, ResourceNotFoundException, TooManyRequestsException, ValidationException] }));
/**
 * Lists the cross-account permissions associated with a signing profile.
 */
export const listProfilePermissions = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListProfilePermissionsRequest, output: ListProfilePermissionsResponse, errors: [AccessDeniedException, InternalServiceErrorException, ResourceNotFoundException, TooManyRequestsException, ValidationException] }));
/**
 * Removes cross-account permissions from a signing profile.
 */
export const removeProfilePermission = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: RemoveProfilePermissionRequest, output: RemoveProfilePermissionResponse, errors: [AccessDeniedException, ConflictException, InternalServiceErrorException, ResourceNotFoundException, TooManyRequestsException, ValidationException] }));
/**
 * Signs a binary payload and returns a signature envelope.
 */
export const signPayload = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: SignPayloadRequest, output: SignPayloadResponse, errors: [AccessDeniedException, InternalServiceErrorException, ResourceNotFoundException, TooManyRequestsException, ValidationException] }));
/**
 * Changes the state of a signing job to `REVOKED`. This indicates that the signature is no
 * longer valid.
 */
export const revokeSignature = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: RevokeSignatureRequest, output: RevokeSignatureResponse, errors: [AccessDeniedException, InternalServiceErrorException, ResourceNotFoundException, TooManyRequestsException, ValidationException] }));
/**
 ...
 */
export const revokeSigningProfile = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: RevokeSigningProfileRequest, output: RevokeSigningProfileResponse, errors: [AccessDeniedException, InternalServiceErrorException, ResourceNotFoundException, TooManyRequestsException, ValidationException] }));
/**
 ...
 * returned.
 */
export const listSigningPlatforms = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListSigningPlatformsRequest, output: ListSigningPlatformsResponse, errors: [AccessDeniedException, InternalServiceErrorException, TooManyRequestsException, ValidationException] }));
/**
 * Retrieves the revocation status of one or more of the signing profile, signing job,
 * and signing certificate.
 */
export const getRevocationStatus = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetRevocationStatusRequest, output: GetRevocationStatusResponse, errors: [AccessDeniedException, InternalServiceErrorException, TooManyRequestsException, ValidationException] }));
