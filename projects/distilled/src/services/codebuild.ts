...
//# Schemas
export class ListCuratedEnvironmentImagesInput extends S.Class<ListCuratedEnvironmentImagesInput>("ListCuratedEnvironmentImagesInput")({}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListSourceCredentialsInput extends S.Class<ListSourceCredentialsInput>("ListSourceCredentialsInput")({}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class BatchDeleteBuildsInput extends S.Class<BatchDeleteBuildsInput>("BatchDeleteBuildsInput")({ids: BuildIds}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class BatchGetBuildBatchesInput extends S.Class<BatchGetBuildBatchesInput>("BatchGetBuildBatchesInput")({ids: BuildBatchIds}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class BatchGetBuildsInput extends S.Class<BatchGetBuildsInput>("BatchGetBuildsInput")({ids: BuildIds}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class BatchGetCommandExecutionsInput extends S.Class<BatchGetCommandExecutionsInput>("BatchGetCommandExecutionsInput")({sandboxId: S.String, commandExecutionIds: CommandExecutionIds}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class BatchGetFleetsInput extends S.Class<BatchGetFleetsInput>("BatchGetFleetsInput")({names: FleetNames}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class BatchGetProjectsInput extends S.Class<BatchGetProjectsInput>("BatchGetProjectsInput")({names: ProjectNames}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class BatchGetReportGroupsInput extends S.Class<BatchGetReportGroupsInput>("BatchGetReportGroupsInput")({reportGroupArns: ReportGroupArns}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class BatchGetReportsInput extends S.Class<BatchGetReportsInput>("BatchGetReportsInput")({reportArns: ReportArns}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class BatchGetSandboxesInput extends S.Class<BatchGetSandboxesInput>("BatchGetSandboxesInput")({ids: SandboxIds}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteBuildBatchInput extends S.Class<DeleteBuildBatchInput>("DeleteBuildBatchInput")({id: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteFleetInput extends S.Class<DeleteFleetInput>("DeleteFleetInput")({arn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteFleetOutput extends S.Class<DeleteFleetOutput>("DeleteFleetOutput")({}) {}
export class DeleteProjectInput extends S.Class<DeleteProjectInput>("DeleteProjectInput")({name: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteProjectOutput extends S.Class<DeleteProjectOutput>("DeleteProjectOutput")({}) {}
export class DeleteReportInput extends S.Class<DeleteReportInput>("DeleteReportInput")({arn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteReportOutput extends S.Class<DeleteReportOutput>("DeleteReportOutput")({}) {}
export class DeleteReportGroupInput extends S.Class<DeleteReportGroupInput>("DeleteReportGroupInput")({arn: S.String, deleteReports: S.optional(S.Boolean)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteReportGroupOutput extends S.Class<DeleteReportGroupOutput>("DeleteReportGroupOutput")({}) {}
export class DeleteResourcePolicyInput extends S.Class<DeleteResourcePolicyInput>("DeleteResourcePolicyInput")({resourceArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteResourcePolicyOutput extends S.Class<DeleteResourcePolicyOutput>("DeleteResourcePolicyOutput")({}) {}
export class DeleteSourceCredentialsInput extends S.Class<DeleteSourceCredentialsInput>("DeleteSourceCredentialsInput")({arn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteWebhookInput extends S.Class<DeleteWebhookInput>("DeleteWebhookInput")({projectName: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class GetReportGroupTrendInput extends S.Class<GetReportGroupTrendInput>("GetReportGroupTrendInput")({reportGroupArn: S.String, numOfReports: S.optional(S.Number), trendField: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetResourcePolicyInput extends S.Class<GetResourcePolicyInput>("GetResourcePolicyInput")({resourceArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ImportSourceCredentialsInput extends S.Class<ImportSourceCredentialsInput>("ImportSourceCredentialsInput")({username: S.optional(S.String), token: S.String, serverType: S.String, authType: S.String, shouldOverwrite: S.optional(S.Boolean)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class InvalidateProjectCacheInput extends S.Class<InvalidateProjectCacheInput>("InvalidateProjectCacheInput")({projectName: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class ListBuildBatchesForProjectInput extends S.Class<ListBuildBatchesForProjectInput>("ListBuildBatchesForProjectInput")({projectName: S.optional(S.String), filter: S.optional(BuildBatchFilter), maxResults: S.optional(S.Number), sortOrder: S.optional(S.String), nextToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListBuildsInput extends S.Class<ListBuildsInput>("ListBuildsInput")({sortOrder: S.optional(S.String), nextToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListBuildsForProjectInput extends S.Class<ListBuildsForProjectInput>("ListBuildsForProjectInput")({projectName: S.String, sortOrder: S.optional(S.String), nextToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListCommandExecutionsForSandboxInput extends S.Class<ListCommandExecutionsForSandboxInput>("ListCommandExecutionsForSandboxInput")({sandboxId: S.String, maxResults: S.optional(S.Number), sortOrder: S.optional(S.String), nextToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListFleetsInput extends S.Class<ListFleetsInput>("ListFleetsInput")({nextToken: S.optional(S.String), maxResults: S.optional(S.Number), sortOrder: S.optional(S.String), sortBy: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListProjectsInput extends S.Class<ListProjectsInput>("ListProjectsInput")({sortBy: S.optional(S.String), sortOrder: S.optional(S.String), nextToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListReportGroupsInput extends S.Class<ListReportGroupsInput>("ListReportGroupsInput")({sortOrder: S.optional(S.String), sortBy: S.optional(S.String), nextToken: S.optional(S.String), maxResults: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ReportFilter extends S.Class<ReportFilter>("ReportFilter")({status: S.optional(S.String)}) {}
export class ListReportsForReportGroupInput extends S.Class<ListReportsForReportGroupInput>("ListReportsForReportGroupInput")({reportGroupArn: S.String, nextToken: S.optional(S.String), sortOrder: S.optional(S.String), maxResults: S.optional(S.Number), filter: S.optional(ReportFilter)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListSandboxesInput extends S.Class<ListSandboxesInput>("ListSandboxesInput")({maxResults: S.optional(S.Number), sortOrder: S.optional(S.String), nextToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListSandboxesForProjectInput extends S.Class<ListSandboxesForProjectInput>("ListSandboxesForProjectInput")({projectName: S.String, maxResults: S.optional(S.Number), sortOrder: S.optional(S.String), nextToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListSharedProjectsInput extends S.Class<ListSharedProjectsInput>("ListSharedProjectsInput")({sortBy: S.optional(S.String), sortOrder: S.optional(S.String), maxResults: S.optional(S.Number), nextToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListSharedReportGroupsInput extends S.Class<ListSharedReportGroupsInput>("ListSharedReportGroupsInput")({sortOrder: S.optional(S.String), sortBy: S.optional(S.String), nextToken: S.optional(S.String), maxResults: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutResourcePolicyInput extends S.Class<PutResourcePolicyInput>("PutResourcePolicyInput")({policy: S.String, resourceArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class RetryBuildInput extends S.Class<RetryBuildInput>("RetryBuildInput")({id: S.optional(S.String), idempotencyToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class RetryBuildBatchInput extends S.Class<RetryBuildBatchInput>("RetryBuildBatchInput")({id: S.optional(S.String), idempotencyToken: S.optional(S.String), retryType: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class UpdateReportGroupInput extends S.Class<UpdateReportGroupInput>("UpdateReportGroupInput")({arn: S.String, exportConfig: S.optional(ReportExportConfig), tags: S.optional(TagList)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class UpdateWebhookInput extends S.Class<UpdateWebhookInput>("UpdateWebhookInput")({projectName: S.String, branchFilter: S.optional(S.String), rotateSecret: S.optional(S.Boolean), filterGroups: S.optional(FilterGroups), buildType: S.optional(S.String), pullRequestBuildPolicy: S.optional(PullRequestBuildPolicy)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class CreateWebhookInput extends S.Class<CreateWebhookInput>("CreateWebhookInput")({projectName: S.String, branchFilter: S.optional(S.String), filterGroups: S.optional(FilterGroups), buildType: S.optional(S.String), manualCreation: S.optional(S.Boolean), scopeConfiguration: S.optional(ScopeConfiguration), pullRequestBuildPolicy: S.optional(PullRequestBuildPolicy)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class DescribeTestCasesInput extends S.Class<DescribeTestCasesInput>("DescribeTestCasesInput")({reportArn: S.String, nextToken: S.optional(S.String), maxResults: S.optional(S.Number), filter: S.optional(TestCaseFilter)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class ListBuildBatchesInput extends S.Class<ListBuildBatchesInput>("ListBuildBatchesInput")({filter: S.optional(BuildBatchFilter), maxResults: S.optional(S.Number), sortOrder: S.optional(S.String), nextToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class ListReportsInput extends S.Class<ListReportsInput>("ListReportsInput")({sortOrder: S.optional(S.String), nextToken: S.optional(S.String), maxResults: S.optional(S.Number), filter: S.optional(ReportFilter)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class BuildPhase extends S.Class<BuildPhase>("BuildPhase")({phaseType: S.optional(S.String), phaseStatus: S.optional(S.String), startTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), endTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), durationInSeconds: S.optional(S.Number), contexts: S.optional(PhaseContexts)}) {}
...
export class BuildSummary extends S.Class<BuildSummary>("BuildSummary")({arn: S.optional(S.String), requestedOn: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), buildStatus: S.optional(S.String), primaryArtifact: S.optional(ResolvedArtifact), secondaryArtifacts: S.optional(ResolvedSecondaryArtifacts)}) {}
...
export class SandboxSessionPhase extends S.Class<SandboxSessionPhase>("SandboxSessionPhase")({phaseType: S.optional(S.String), phaseStatus: S.optional(S.String), startTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), endTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), durationInSeconds: S.optional(S.Number), contexts: S.optional(PhaseContexts)}) {}
...
export class ReportGroup extends S.Class<ReportGroup>("ReportGroup")({arn: S.optional(S.String), name: S.optional(S.String), type: S.optional(S.String), exportConfig: S.optional(ReportExportConfig), created: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), lastModified: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), tags: S.optional(TagList), status: S.optional(S.String)}) {}
...
export class CreateReportGroupInput extends S.Class<CreateReportGroupInput>("CreateReportGroupInput")({name: S.String, type: S.String, exportConfig: ReportExportConfig, tags: S.optional(TagList)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class AccountLimitExceededException extends S.TaggedError<AccountLimitExceededException>()("AccountLimitExceededException", {message: S.optional(S.String)}) {}
 ...
 */
export const deleteFleet = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteFleetInput, output: DeleteFleetOutput, errors: [InvalidInputException] }));
/**
 * Gets a list of build IDs, with each build ID representing a single build.
 */
export const listBuilds = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListBuildsInput, output: ListBuildsOutput, errors: [InvalidInputException] }));
/**
 * Gets a list of compute fleet names with each compute fleet name representing a single compute fleet.
 */
export const listFleets = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListFleetsInput, output: ListFleetsOutput, errors: [InvalidInputException] }));
/**
 * Gets a list of build project names, with each build project name representing a single
 * build project.
 */
export const listProjects = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListProjectsInput, output: ListProjectsOutput, errors: [InvalidInputException] }));
/**
 * Gets a list ARNs for the report groups in the current Amazon Web Services account.
 */
export const listReportGroups = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListReportGroupsInput, output: ListReportGroupsOutput, errors: [InvalidInputException] }));
/**
 * Gets a list of sandboxes.
 */
export const listSandboxes = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListSandboxesInput, output: ListSandboxesOutput, errors: [InvalidInputException] }));
/**
 * Gets a list of projects that are shared with other Amazon Web Services accounts or users.
 */
export const listSharedProjects = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListSharedProjectsInput, output: ListSharedProjectsOutput, errors: [InvalidInputException] }));
/**
 * Gets a list of report groups that are shared with other Amazon Web Services accounts or users.
 */
export const listSharedReportGroups = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListSharedReportGroupsInput, output: ListSharedReportGroupsOutput, errors: [InvalidInputException] }));
/**
 * Returns a list of `SourceCredentialsInfo` objects.
 */
export const listSourceCredentials = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListSourceCredentialsInput, output: ListSourceCredentialsOutput, errors: [InvalidInputException] }));
/**
 * Deletes a build project. When you delete a project, its builds are not deleted.
 */
export const deleteProject = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteProjectInput, output: DeleteProjectOutput, errors: [InvalidInputException] }));
/**
 * Deletes a report.
 */
export const deleteReport = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteReportInput, output: DeleteReportOutput, errors: [InvalidInputException] }));
/**
 * Deletes a report group. Before you delete a report group, you must delete its reports.
 */
export const deleteReportGroup = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteReportGroupInput, output: DeleteReportGroupOutput, errors: [InvalidInputException] }));
/**
 * Deletes a resource policy that is identified by its resource ARN.
 */
export const deleteResourcePolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteResourcePolicyInput, output: DeleteResourcePolicyOutput, errors: [InvalidInputException] }));
/**
 * Deletes a batch build.
 */
export const deleteBuildBatch = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteBuildBatchInput, output: DeleteBuildBatchOutput, errors: [InvalidInputException] }));
/**
 * Deletes one or more builds.
 */
export const batchDeleteBuilds = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: BatchDeleteBuildsInput, output: BatchDeleteBuildsOutput, errors: [InvalidInputException] }));
/**
 * Gets information about the command executions.
 */
export const batchGetCommandExecutions = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: BatchGetCommandExecutionsInput, output: BatchGetCommandExecutionsOutput, errors: [InvalidInputException] }));
/**
 * Returns an array of report groups.
 */
export const batchGetReportGroups = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: BatchGetReportGroupsInput, output: BatchGetReportGroupsOutput, errors: [InvalidInputException] }));
/**
 * Deletes a set of GitHub, GitHub Enterprise, or Bitbucket source credentials.
 */
export const deleteSourceCredentials = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteSourceCredentialsInput, output: DeleteSourceCredentialsOutput, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 * Retrieves one or more code coverage reports.
 */
export const describeCodeCoverages = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeCodeCoveragesInput, output: DescribeCodeCoveragesOutput, errors: [InvalidInputException] }));
/**
 * Analyzes and accumulates test report values for the specified test reports.
 */
export const getReportGroupTrend = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetReportGroupTrendInput, output: GetReportGroupTrendOutput, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 * Retrieves the identifiers of your build batches in the current region.
 */
export const listBuildBatches = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListBuildBatchesInput, output: ListBuildBatchesOutput, errors: [InvalidInputException] }));
/**
 * Returns a list of ARNs for the reports in the current Amazon Web Services account.
 */
export const listReports = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListReportsInput, output: ListReportsOutput, errors: [InvalidInputException] }));
/**
 ...
 */
export const startBuild = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StartBuildInput, output: StartBuildOutput, errors: [AccountLimitExceededException, InvalidInputException, ResourceNotFoundException] }));
/**
 * Starts a sandbox.
 */
export const startSandbox = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StartSandboxInput, output: StartSandboxOutput, errors: [AccountSuspendedException, InvalidInputException, ResourceNotFoundException] }));
/**
 * Starts a sandbox connection.
 */
export const startSandboxConnection = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StartSandboxConnectionInput, output: StartSandboxConnectionOutput, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 ...
 */
export const deleteWebhook = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteWebhookInput, output: DeleteWebhookOutput, errors: [InvalidInputException, OAuthProviderException, ResourceNotFoundException] }));
/**
 * Gets a resource policy that is identified by its resource ARN.
 */
export const getResourcePolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetResourcePolicyInput, output: GetResourcePolicyOutput, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 * Retrieves the identifiers of the build batches for a specific project.
 */
export const listBuildBatchesForProject = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListBuildBatchesForProjectInput, output: ListBuildBatchesForProjectOutput, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 * Gets a list of build identifiers for the specified build project, with each build
 * identifier representing a single build.
 */
export const listBuildsForProject = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListBuildsForProjectInput, output: ListBuildsForProjectOutput, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 * Gets a list of command executions for a sandbox.
 */
export const listCommandExecutionsForSandbox = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListCommandExecutionsForSandboxInput, output: ListCommandExecutionsForSandboxOutput, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 * Returns a list of ARNs for the reports that belong to a `ReportGroup`.
 */
export const listReportsForReportGroup = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListReportsForReportGroupInput, output: ListReportsForReportGroupOutput, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 * Gets a list of sandboxes for a given project.
 */
export const listSandboxesForProject = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListSandboxesForProjectInput, output: ListSandboxesForProjectOutput, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 * Stores a resource policy for the ARN of a `Project` or
 * `ReportGroup` object.
 */
export const putResourcePolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutResourcePolicyInput, output: PutResourcePolicyOutput, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 * Restarts a failed batch build. Only batch builds that have failed can be retried.
 */
export const retryBuildBatch = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: RetryBuildBatchInput, output: RetryBuildBatchOutput, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 * Starts a batch build for a project.
 */
export const startBuildBatch = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StartBuildBatchInput, output: StartBuildBatchOutput, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 * Starts a command execution.
 */
export const startCommandExecution = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StartCommandExecutionInput, output: StartCommandExecutionOutput, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 * Attempts to stop running a build.
 */
export const stopBuild = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StopBuildInput, output: StopBuildOutput, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 * Stops a running batch build.
 */
export const stopBuildBatch = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StopBuildBatchInput, output: StopBuildBatchOutput, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 * Stops a sandbox.
 */
export const stopSandbox = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StopSandboxInput, output: StopSandboxOutput, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 * Changes the settings of a build project.
 */
export const updateProject = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateProjectInput, output: UpdateProjectOutput, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 ...
 */
export const updateProjectVisibility = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateProjectVisibilityInput, output: UpdateProjectVisibilityOutput, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 * Updates a report group.
 */
export const updateReportGroup = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateReportGroupInput, output: UpdateReportGroupOutput, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 * Resets the cache for a project.
 */
export const invalidateProjectCache = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: InvalidateProjectCacheInput, output: InvalidateProjectCacheOutput, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 * Restarts a build.
 */
export const retryBuild = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: RetryBuildInput, output: RetryBuildOutput, errors: [AccountLimitExceededException, InvalidInputException, ResourceNotFoundException] }));
/**
 * Updates a compute fleet.
 */
export const updateFleet = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateFleetInput, output: UpdateFleetOutput, errors: [AccountLimitExceededException, InvalidInputException, ResourceNotFoundException] }));
/**
 * Updates the webhook associated with an CodeBuild build project.
 * 
 * If you use Bitbucket for your repository, `rotateSecret` is ignored.
 */
export const updateWebhook = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateWebhookInput, output: UpdateWebhookOutput, errors: [InvalidInputException, OAuthProviderException, ResourceNotFoundException] }));
/**
 * Gets information about one or more builds.
 */
export const batchGetBuilds = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: BatchGetBuildsInput, output: BatchGetBuildsOutput, errors: [InvalidInputException] }));
/**
 * Gets information about one or more compute fleets.
 */
export const batchGetFleets = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: BatchGetFleetsInput, output: BatchGetFleetsOutput, errors: [InvalidInputException] }));
/**
 * Gets information about one or more build projects.
 */
export const batchGetProjects = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: BatchGetProjectsInput, output: BatchGetProjectsOutput, errors: [InvalidInputException] }));
/**
 * Returns a list of details about test cases for a report.
 */
export const describeTestCases = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeTestCasesInput, output: DescribeTestCasesOutput, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 * Imports the source repository credentials for an CodeBuild project that has its
 * source code stored in a GitHub, GitHub Enterprise, GitLab, GitLab Self Managed, or Bitbucket repository.
 */
export const importSourceCredentials = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ImportSourceCredentialsInput, output: ImportSourceCredentialsOutput, errors: [AccountLimitExceededException, InvalidInputException, ResourceAlreadyExistsException] }));
/**
 * Gets information about Docker images that are managed by CodeBuild.
 */
export const listCuratedEnvironmentImages = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListCuratedEnvironmentImagesInput, output: ListCuratedEnvironmentImagesOutput, errors: [] }));
/**
 * For an existing CodeBuild build project that has its source code stored in a GitHub or
 ...
 */
export const createWebhook = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateWebhookInput, output: CreateWebhookOutput, errors: [InvalidInputException, OAuthProviderException, ResourceAlreadyExistsException, ResourceNotFoundException] }));
/**
 * Creates a compute fleet.
 */
export const createFleet = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateFleetInput, output: CreateFleetOutput, errors: [AccountLimitExceededException, InvalidInputException, ResourceAlreadyExistsException] }));
/**
 * Creates a report group. A report group contains a collection of reports.
 */
export const createReportGroup = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateReportGroupInput, output: CreateReportGroupOutput, errors: [AccountLimitExceededException, InvalidInputException, ResourceAlreadyExistsException] }));
/**
 * Returns an array of reports.
 */
export const batchGetReports = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: BatchGetReportsInput, output: BatchGetReportsOutput, errors: [InvalidInputException] }));
/**
 * Gets information about the sandbox status.
 */
export const batchGetSandboxes = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: BatchGetSandboxesInput, output: BatchGetSandboxesOutput, errors: [InvalidInputException] }));
/**
 * Creates a build project.
 */
export const createProject = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateProjectInput, output: CreateProjectOutput, errors: [AccountLimitExceededException, InvalidInputException, ResourceAlreadyExistsException] }));
/**
 * Retrieves information about one or more batch builds.
 */
export const batchGetBuildBatches = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: BatchGetBuildBatchesInput, output: BatchGetBuildBatchesOutput, errors: [InvalidInputException] }));
