...
const svc = T.AwsApiService({ sdkId: "Storage Gateway", serviceShapeName: "StorageGateway_20130630" });
...
export class AddCacheInput extends S.Class<AddCacheInput>("AddCacheInput")({GatewayARN: S.String, DiskIds: DiskIds}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class Tag extends S.Class<Tag>("Tag")({Key: S.String, Value: S.String}) {}
export const Tags = S.Array(Tag);
export class AddTagsToResourceInput extends S.Class<AddTagsToResourceInput>("AddTagsToResourceInput")({ResourceARN: S.String, Tags: Tags}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class AddUploadBufferInput extends S.Class<AddUploadBufferInput>("AddUploadBufferInput")({GatewayARN: S.String, DiskIds: DiskIds}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class AddWorkingStorageInput extends S.Class<AddWorkingStorageInput>("AddWorkingStorageInput")({GatewayARN: S.String, DiskIds: DiskIds}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class AssignTapePoolInput extends S.Class<AssignTapePoolInput>("AssignTapePoolInput")({TapeARN: S.String, PoolId: S.String, BypassGovernanceRetention: S.optional(S.Boolean)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class AttachVolumeInput extends S.Class<AttachVolumeInput>("AttachVolumeInput")({GatewayARN: S.String, TargetName: S.optional(S.String), VolumeARN: S.String, NetworkInterfaceId: S.String, DiskId: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class CancelArchivalInput extends S.Class<CancelArchivalInput>("CancelArchivalInput")({GatewayARN: S.String, TapeARN: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class CancelCacheReportInput extends S.Class<CancelCacheReportInput>("CancelCacheReportInput")({CacheReportARN: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class CancelRetrievalInput extends S.Class<CancelRetrievalInput>("CancelRetrievalInput")({GatewayARN: S.String, TapeARN: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class CreateTapePoolInput extends S.Class<CreateTapePoolInput>("CreateTapePoolInput")({PoolName: S.String, StorageClass: S.String, RetentionLockType: S.optional(S.String), RetentionLockTimeInDays: S.optional(S.Number), Tags: S.optional(Tags)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class CreateTapesInput extends S.Class<CreateTapesInput>("CreateTapesInput")({GatewayARN: S.String, TapeSizeInBytes: S.Number, ClientToken: S.String, NumTapesToCreate: S.Number, TapeBarcodePrefix: S.String, KMSEncrypted: S.optional(S.Boolean), KMSKey: S.optional(S.String), PoolId: S.optional(S.String), Worm: S.optional(S.Boolean), Tags: S.optional(Tags)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class DeleteAutomaticTapeCreationPolicyInput extends S.Class<DeleteAutomaticTapeCreationPolicyInput>("DeleteAutomaticTapeCreationPolicyInput")({GatewayARN: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteBandwidthRateLimitInput extends S.Class<DeleteBandwidthRateLimitInput>("DeleteBandwidthRateLimitInput")({GatewayARN: S.String, BandwidthType: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteCacheReportInput extends S.Class<DeleteCacheReportInput>("DeleteCacheReportInput")({CacheReportARN: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteChapCredentialsInput extends S.Class<DeleteChapCredentialsInput>("DeleteChapCredentialsInput")({TargetARN: S.String, InitiatorName: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteFileShareInput extends S.Class<DeleteFileShareInput>("DeleteFileShareInput")({FileShareARN: S.String, ForceDelete: S.optional(S.Boolean)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteGatewayInput extends S.Class<DeleteGatewayInput>("DeleteGatewayInput")({GatewayARN: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteSnapshotScheduleInput extends S.Class<DeleteSnapshotScheduleInput>("DeleteSnapshotScheduleInput")({VolumeARN: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteTapeInput extends S.Class<DeleteTapeInput>("DeleteTapeInput")({GatewayARN: S.String, TapeARN: S.String, BypassGovernanceRetention: S.optional(S.Boolean)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteTapeArchiveInput extends S.Class<DeleteTapeArchiveInput>("DeleteTapeArchiveInput")({TapeARN: S.String, BypassGovernanceRetention: S.optional(S.Boolean)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteTapePoolInput extends S.Class<DeleteTapePoolInput>("DeleteTapePoolInput")({PoolARN: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteVolumeInput extends S.Class<DeleteVolumeInput>("DeleteVolumeInput")({VolumeARN: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeAvailabilityMonitorTestInput extends S.Class<DescribeAvailabilityMonitorTestInput>("DescribeAvailabilityMonitorTestInput")({GatewayARN: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeBandwidthRateLimitInput extends S.Class<DescribeBandwidthRateLimitInput>("DescribeBandwidthRateLimitInput")({GatewayARN: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeBandwidthRateLimitScheduleInput extends S.Class<DescribeBandwidthRateLimitScheduleInput>("DescribeBandwidthRateLimitScheduleInput")({GatewayARN: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeCacheInput extends S.Class<DescribeCacheInput>("DescribeCacheInput")({GatewayARN: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeCachediSCSIVolumesInput extends S.Class<DescribeCachediSCSIVolumesInput>("DescribeCachediSCSIVolumesInput")({VolumeARNs: VolumeARNs}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeCacheReportInput extends S.Class<DescribeCacheReportInput>("DescribeCacheReportInput")({CacheReportARN: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeChapCredentialsInput extends S.Class<DescribeChapCredentialsInput>("DescribeChapCredentialsInput")({TargetARN: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeFileSystemAssociationsInput extends S.Class<DescribeFileSystemAssociationsInput>("DescribeFileSystemAssociationsInput")({FileSystemAssociationARNList: FileSystemAssociationARNList}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeGatewayInformationInput extends S.Class<DescribeGatewayInformationInput>("DescribeGatewayInformationInput")({GatewayARN: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeMaintenanceStartTimeInput extends S.Class<DescribeMaintenanceStartTimeInput>("DescribeMaintenanceStartTimeInput")({GatewayARN: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeNFSFileSharesInput extends S.Class<DescribeNFSFileSharesInput>("DescribeNFSFileSharesInput")({FileShareARNList: FileShareARNList}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeSMBFileSharesInput extends S.Class<DescribeSMBFileSharesInput>("DescribeSMBFileSharesInput")({FileShareARNList: FileShareARNList}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeSMBSettingsInput extends S.Class<DescribeSMBSettingsInput>("DescribeSMBSettingsInput")({GatewayARN: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeSnapshotScheduleInput extends S.Class<DescribeSnapshotScheduleInput>("DescribeSnapshotScheduleInput")({VolumeARN: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeStorediSCSIVolumesInput extends S.Class<DescribeStorediSCSIVolumesInput>("DescribeStorediSCSIVolumesInput")({VolumeARNs: VolumeARNs}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeTapeArchivesInput extends S.Class<DescribeTapeArchivesInput>("DescribeTapeArchivesInput")({TapeARNs: S.optional(TapeARNs), Marker: S.optional(S.String), Limit: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeTapeRecoveryPointsInput extends S.Class<DescribeTapeRecoveryPointsInput>("DescribeTapeRecoveryPointsInput")({GatewayARN: S.String, Marker: S.optional(S.String), Limit: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeTapesInput extends S.Class<DescribeTapesInput>("DescribeTapesInput")({GatewayARN: S.String, TapeARNs: S.optional(TapeARNs), Marker: S.optional(S.String), Limit: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeUploadBufferInput extends S.Class<DescribeUploadBufferInput>("DescribeUploadBufferInput")({GatewayARN: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeVTLDevicesInput extends S.Class<DescribeVTLDevicesInput>("DescribeVTLDevicesInput")({GatewayARN: S.String, VTLDeviceARNs: S.optional(VTLDeviceARNs), Marker: S.optional(S.String), Limit: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeWorkingStorageInput extends S.Class<DescribeWorkingStorageInput>("DescribeWorkingStorageInput")({GatewayARN: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DetachVolumeInput extends S.Class<DetachVolumeInput>("DetachVolumeInput")({VolumeARN: S.String, ForceDetach: S.optional(S.Boolean)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DisableGatewayInput extends S.Class<DisableGatewayInput>("DisableGatewayInput")({GatewayARN: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DisassociateFileSystemInput extends S.Class<DisassociateFileSystemInput>("DisassociateFileSystemInput")({FileSystemAssociationARN: S.String, ForceDelete: S.optional(S.Boolean)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class EvictFilesFailingUploadInput extends S.Class<EvictFilesFailingUploadInput>("EvictFilesFailingUploadInput")({FileShareARN: S.String, ForceRemove: S.optional(S.Boolean)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class JoinDomainInput extends S.Class<JoinDomainInput>("JoinDomainInput")({GatewayARN: S.String, DomainName: S.String, OrganizationalUnit: S.optional(S.String), DomainControllers: S.optional(Hosts), TimeoutInSeconds: S.optional(S.Number), UserName: S.String, Password: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListAutomaticTapeCreationPoliciesInput extends S.Class<ListAutomaticTapeCreationPoliciesInput>("ListAutomaticTapeCreationPoliciesInput")({GatewayARN: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListCacheReportsInput extends S.Class<ListCacheReportsInput>("ListCacheReportsInput")({Marker: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListFileSharesInput extends S.Class<ListFileSharesInput>("ListFileSharesInput")({GatewayARN: S.optional(S.String), Limit: S.optional(S.Number), Marker: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListFileSystemAssociationsInput extends S.Class<ListFileSystemAssociationsInput>("ListFileSystemAssociationsInput")({GatewayARN: S.optional(S.String), Limit: S.optional(S.Number), Marker: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListGatewaysInput extends S.Class<ListGatewaysInput>("ListGatewaysInput")({Marker: S.optional(S.String), Limit: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListLocalDisksInput extends S.Class<ListLocalDisksInput>("ListLocalDisksInput")({GatewayARN: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListTagsForResourceInput extends S.Class<ListTagsForResourceInput>("ListTagsForResourceInput")({ResourceARN: S.String, Marker: S.optional(S.String), Limit: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListTapePoolsInput extends S.Class<ListTapePoolsInput>("ListTapePoolsInput")({PoolARNs: S.optional(PoolARNs), Marker: S.optional(S.String), Limit: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListTapesInput extends S.Class<ListTapesInput>("ListTapesInput")({TapeARNs: S.optional(TapeARNs), Marker: S.optional(S.String), Limit: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListVolumeInitiatorsInput extends S.Class<ListVolumeInitiatorsInput>("ListVolumeInitiatorsInput")({VolumeARN: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListVolumeRecoveryPointsInput extends S.Class<ListVolumeRecoveryPointsInput>("ListVolumeRecoveryPointsInput")({GatewayARN: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListVolumesInput extends S.Class<ListVolumesInput>("ListVolumesInput")({GatewayARN: S.optional(S.String), Marker: S.optional(S.String), Limit: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class NotifyWhenUploadedInput extends S.Class<NotifyWhenUploadedInput>("NotifyWhenUploadedInput")({FileShareARN: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class RefreshCacheInput extends S.Class<RefreshCacheInput>("RefreshCacheInput")({FileShareARN: S.String, FolderList: S.optional(FolderList), Recursive: S.optional(S.Boolean)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class RemoveTagsFromResourceInput extends S.Class<RemoveTagsFromResourceInput>("RemoveTagsFromResourceInput")({ResourceARN: S.String, TagKeys: TagKeys}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ResetCacheInput extends S.Class<ResetCacheInput>("ResetCacheInput")({GatewayARN: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class RetrieveTapeArchiveInput extends S.Class<RetrieveTapeArchiveInput>("RetrieveTapeArchiveInput")({TapeARN: S.String, GatewayARN: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class RetrieveTapeRecoveryPointInput extends S.Class<RetrieveTapeRecoveryPointInput>("RetrieveTapeRecoveryPointInput")({TapeARN: S.String, GatewayARN: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class SetLocalConsolePasswordInput extends S.Class<SetLocalConsolePasswordInput>("SetLocalConsolePasswordInput")({GatewayARN: S.String, LocalConsolePassword: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class SetSMBGuestPasswordInput extends S.Class<SetSMBGuestPasswordInput>("SetSMBGuestPasswordInput")({GatewayARN: S.String, Password: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ShutdownGatewayInput extends S.Class<ShutdownGatewayInput>("ShutdownGatewayInput")({GatewayARN: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class StartAvailabilityMonitorTestInput extends S.Class<StartAvailabilityMonitorTestInput>("StartAvailabilityMonitorTestInput")({GatewayARN: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class StartGatewayInput extends S.Class<StartGatewayInput>("StartGatewayInput")({GatewayARN: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class UpdateBandwidthRateLimitInput extends S.Class<UpdateBandwidthRateLimitInput>("UpdateBandwidthRateLimitInput")({GatewayARN: S.String, AverageUploadRateLimitInBitsPerSec: S.optional(S.Number), AverageDownloadRateLimitInBitsPerSec: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class UpdateChapCredentialsInput extends S.Class<UpdateChapCredentialsInput>("UpdateChapCredentialsInput")({TargetARN: S.String, SecretToAuthenticateInitiator: S.String, InitiatorName: S.String, SecretToAuthenticateTarget: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class UpdateFileSystemAssociationInput extends S.Class<UpdateFileSystemAssociationInput>("UpdateFileSystemAssociationInput")({FileSystemAssociationARN: S.String, UserName: S.optional(S.String), Password: S.optional(S.String), AuditDestinationARN: S.optional(S.String), CacheAttributes: S.optional(CacheAttributes)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class UpdateGatewayInformationInput extends S.Class<UpdateGatewayInformationInput>("UpdateGatewayInformationInput")({GatewayARN: S.String, GatewayName: S.optional(S.String), GatewayTimezone: S.optional(S.String), CloudWatchLogGroupARN: S.optional(S.String), GatewayCapacity: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class UpdateGatewaySoftwareNowInput extends S.Class<UpdateGatewaySoftwareNowInput>("UpdateGatewaySoftwareNowInput")({GatewayARN: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class UpdateSMBFileShareVisibilityInput extends S.Class<UpdateSMBFileShareVisibilityInput>("UpdateSMBFileShareVisibilityInput")({GatewayARN: S.String, FileSharesVisible: S.Boolean}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class UpdateSMBSecurityStrategyInput extends S.Class<UpdateSMBSecurityStrategyInput>("UpdateSMBSecurityStrategyInput")({GatewayARN: S.String, SMBSecurityStrategy: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class UpdateSnapshotScheduleInput extends S.Class<UpdateSnapshotScheduleInput>("UpdateSnapshotScheduleInput")({VolumeARN: S.String, StartAt: S.Number, RecurrenceInHours: S.Number, Description: S.optional(S.String), Tags: S.optional(Tags)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class UpdateVTLDeviceTypeInput extends S.Class<UpdateVTLDeviceTypeInput>("UpdateVTLDeviceTypeInput")({VTLDeviceARN: S.String, DeviceType: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class AddCacheOutput extends S.Class<AddCacheOutput>("AddCacheOutput")({GatewayARN: S.optional(S.String)}, ns) {}
export class AddTagsToResourceOutput extends S.Class<AddTagsToResourceOutput>("AddTagsToResourceOutput")({ResourceARN: S.optional(S.String)}, ns) {}
export class AddUploadBufferOutput extends S.Class<AddUploadBufferOutput>("AddUploadBufferOutput")({GatewayARN: S.optional(S.String)}, ns) {}
export class AddWorkingStorageOutput extends S.Class<AddWorkingStorageOutput>("AddWorkingStorageOutput")({GatewayARN: S.optional(S.String)}, ns) {}
export class AssignTapePoolOutput extends S.Class<AssignTapePoolOutput>("AssignTapePoolOutput")({TapeARN: S.optional(S.String)}, ns) {}
export class AssociateFileSystemInput extends S.Class<AssociateFileSystemInput>("AssociateFileSystemInput")({UserName: S.String, Password: S.String, ClientToken: S.String, GatewayARN: S.String, LocationARN: S.String, Tags: S.optional(Tags), AuditDestinationARN: S.optional(S.String), CacheAttributes: S.optional(CacheAttributes), EndpointNetworkConfiguration: S.optional(EndpointNetworkConfiguration)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class AttachVolumeOutput extends S.Class<AttachVolumeOutput>("AttachVolumeOutput")({VolumeARN: S.optional(S.String), TargetARN: S.optional(S.String)}, ns) {}
export class CancelArchivalOutput extends S.Class<CancelArchivalOutput>("CancelArchivalOutput")({TapeARN: S.optional(S.String)}, ns) {}
export class CancelCacheReportOutput extends S.Class<CancelCacheReportOutput>("CancelCacheReportOutput")({CacheReportARN: S.optional(S.String)}, ns) {}
export class CancelRetrievalOutput extends S.Class<CancelRetrievalOutput>("CancelRetrievalOutput")({TapeARN: S.optional(S.String)}, ns) {}
export class CreateCachediSCSIVolumeOutput extends S.Class<CreateCachediSCSIVolumeOutput>("CreateCachediSCSIVolumeOutput")({VolumeARN: S.optional(S.String), TargetARN: S.optional(S.String)}, ns) {}
...
export class CreateSMBFileShareOutput extends S.Class<CreateSMBFileShareOutput>("CreateSMBFileShareOutput")({FileShareARN: S.optional(S.String)}, ns) {}
export class CreateSnapshotOutput extends S.Class<CreateSnapshotOutput>("CreateSnapshotOutput")({VolumeARN: S.optional(S.String), SnapshotId: S.optional(S.String)}, ns) {}
export class CreateSnapshotFromVolumeRecoveryPointOutput extends S.Class<CreateSnapshotFromVolumeRecoveryPointOutput>("CreateSnapshotFromVolumeRecoveryPointOutput")({SnapshotId: S.optional(S.String), VolumeARN: S.optional(S.String), VolumeRecoveryPointTime: S.optional(S.String)}, ns) {}
export class CreateStorediSCSIVolumeOutput extends S.Class<CreateStorediSCSIVolumeOutput>("CreateStorediSCSIVolumeOutput")({VolumeARN: S.optional(S.String), VolumeSizeInBytes: S.optional(S.Number), TargetARN: S.optional(S.String)}, ns) {}
export class CreateTapePoolOutput extends S.Class<CreateTapePoolOutput>("CreateTapePoolOutput")({PoolARN: S.optional(S.String)}, ns) {}
export class CreateTapesOutput extends S.Class<CreateTapesOutput>("CreateTapesOutput")({TapeARNs: S.optional(TapeARNs)}, ns) {}
export class CreateTapeWithBarcodeOutput extends S.Class<CreateTapeWithBarcodeOutput>("CreateTapeWithBarcodeOutput")({TapeARN: S.optional(S.String)}, ns) {}
export class DeleteAutomaticTapeCreationPolicyOutput extends S.Class<DeleteAutomaticTapeCreationPolicyOutput>("DeleteAutomaticTapeCreationPolicyOutput")({GatewayARN: S.optional(S.String)}, ns) {}
export class DeleteBandwidthRateLimitOutput extends S.Class<DeleteBandwidthRateLimitOutput>("DeleteBandwidthRateLimitOutput")({GatewayARN: S.optional(S.String)}, ns) {}
export class DeleteCacheReportOutput extends S.Class<DeleteCacheReportOutput>("DeleteCacheReportOutput")({CacheReportARN: S.optional(S.String)}, ns) {}
export class DeleteChapCredentialsOutput extends S.Class<DeleteChapCredentialsOutput>("DeleteChapCredentialsOutput")({TargetARN: S.optional(S.String), InitiatorName: S.optional(S.String)}, ns) {}
export class DeleteFileShareOutput extends S.Class<DeleteFileShareOutput>("DeleteFileShareOutput")({FileShareARN: S.optional(S.String)}, ns) {}
export class DeleteGatewayOutput extends S.Class<DeleteGatewayOutput>("DeleteGatewayOutput")({GatewayARN: S.optional(S.String)}, ns) {}
export class DeleteSnapshotScheduleOutput extends S.Class<DeleteSnapshotScheduleOutput>("DeleteSnapshotScheduleOutput")({VolumeARN: S.optional(S.String)}, ns) {}
export class DeleteTapeOutput extends S.Class<DeleteTapeOutput>("DeleteTapeOutput")({TapeARN: S.optional(S.String)}, ns) {}
export class DeleteTapeArchiveOutput extends S.Class<DeleteTapeArchiveOutput>("DeleteTapeArchiveOutput")({TapeARN: S.optional(S.String)}, ns) {}
export class DeleteTapePoolOutput extends S.Class<DeleteTapePoolOutput>("DeleteTapePoolOutput")({PoolARN: S.optional(S.String)}, ns) {}
export class DeleteVolumeOutput extends S.Class<DeleteVolumeOutput>("DeleteVolumeOutput")({VolumeARN: S.optional(S.String)}, ns) {}
export class DescribeAvailabilityMonitorTestOutput extends S.Class<DescribeAvailabilityMonitorTestOutput>("DescribeAvailabilityMonitorTestOutput")({GatewayARN: S.optional(S.String), Status: S.optional(S.String), StartTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}, ns) {}
export class DescribeBandwidthRateLimitOutput extends S.Class<DescribeBandwidthRateLimitOutput>("DescribeBandwidthRateLimitOutput")({GatewayARN: S.optional(S.String), AverageUploadRateLimitInBitsPerSec: S.optional(S.Number), AverageDownloadRateLimitInBitsPerSec: S.optional(S.Number)}, ns) {}
export class DescribeBandwidthRateLimitScheduleOutput extends S.Class<DescribeBandwidthRateLimitScheduleOutput>("DescribeBandwidthRateLimitScheduleOutput")({GatewayARN: S.optional(S.String), BandwidthRateLimitIntervals: S.optional(BandwidthRateLimitIntervals)}, ns) {}
export class DescribeCacheOutput extends S.Class<DescribeCacheOutput>("DescribeCacheOutput")({GatewayARN: S.optional(S.String), DiskIds: S.optional(DiskIds), CacheAllocatedInBytes: S.optional(S.Number), CacheUsedPercentage: S.optional(S.Number), CacheDirtyPercentage: S.optional(S.Number), CacheHitPercentage: S.optional(S.Number), CacheMissPercentage: S.optional(S.Number)}, ns) {}
export class DescribeMaintenanceStartTimeOutput extends S.Class<DescribeMaintenanceStartTimeOutput>("DescribeMaintenanceStartTimeOutput")({GatewayARN: S.optional(S.String), HourOfDay: S.optional(S.Number), MinuteOfHour: S.optional(S.Number), DayOfWeek: S.optional(S.Number), DayOfMonth: S.optional(S.Number), Timezone: S.optional(S.String), SoftwareUpdatePreferences: S.optional(SoftwareUpdatePreferences)}, ns) {}
export class DescribeSMBSettingsOutput extends S.Class<DescribeSMBSettingsOutput>("DescribeSMBSettingsOutput")({GatewayARN: S.optional(S.String), DomainName: S.optional(S.String), ActiveDirectoryStatus: S.optional(S.String), SMBGuestPasswordSet: S.optional(S.Boolean), SMBSecurityStrategy: S.optional(S.String), FileSharesVisible: S.optional(S.Boolean), SMBLocalGroups: S.optional(SMBLocalGroups)}, ns) {}
export class DescribeSnapshotScheduleOutput extends S.Class<DescribeSnapshotScheduleOutput>("DescribeSnapshotScheduleOutput")({VolumeARN: S.optional(S.String), StartAt: S.optional(S.Number), RecurrenceInHours: S.optional(S.Number), Description: S.optional(S.String), Timezone: S.optional(S.String), Tags: S.optional(Tags)}, ns) {}
export class DescribeUploadBufferOutput extends S.Class<DescribeUploadBufferOutput>("DescribeUploadBufferOutput")({GatewayARN: S.optional(S.String), DiskIds: S.optional(DiskIds), UploadBufferUsedInBytes: S.optional(S.Number), UploadBufferAllocatedInBytes: S.optional(S.Number)}, ns) {}
export class DescribeWorkingStorageOutput extends S.Class<DescribeWorkingStorageOutput>("DescribeWorkingStorageOutput")({GatewayARN: S.optional(S.String), DiskIds: S.optional(DiskIds), WorkingStorageUsedInBytes: S.optional(S.Number), WorkingStorageAllocatedInBytes: S.optional(S.Number)}, ns) {}
export class DetachVolumeOutput extends S.Class<DetachVolumeOutput>("DetachVolumeOutput")({VolumeARN: S.optional(S.String)}, ns) {}
export class DisableGatewayOutput extends S.Class<DisableGatewayOutput>("DisableGatewayOutput")({GatewayARN: S.optional(S.String)}, ns) {}
export class DisassociateFileSystemOutput extends S.Class<DisassociateFileSystemOutput>("DisassociateFileSystemOutput")({FileSystemAssociationARN: S.optional(S.String)}, ns) {}
export class EvictFilesFailingUploadOutput extends S.Class<EvictFilesFailingUploadOutput>("EvictFilesFailingUploadOutput")({NotificationId: S.optional(S.String)}, ns) {}
export class JoinDomainOutput extends S.Class<JoinDomainOutput>("JoinDomainOutput")({GatewayARN: S.optional(S.String), ActiveDirectoryStatus: S.optional(S.String)}, ns) {}
export class ListCacheReportsOutput extends S.Class<ListCacheReportsOutput>("ListCacheReportsOutput")({CacheReportList: S.optional(CacheReportList), Marker: S.optional(S.String)}, ns) {}
export class ListTagsForResourceOutput extends S.Class<ListTagsForResourceOutput>("ListTagsForResourceOutput")({ResourceARN: S.optional(S.String), Marker: S.optional(S.String), Tags: S.optional(Tags)}, ns) {}
export class ListVolumeInitiatorsOutput extends S.Class<ListVolumeInitiatorsOutput>("ListVolumeInitiatorsOutput")({Initiators: S.optional(Initiators)}, ns) {}
export class NotifyWhenUploadedOutput extends S.Class<NotifyWhenUploadedOutput>("NotifyWhenUploadedOutput")({FileShareARN: S.optional(S.String), NotificationId: S.optional(S.String)}, ns) {}
export class RefreshCacheOutput extends S.Class<RefreshCacheOutput>("RefreshCacheOutput")({FileShareARN: S.optional(S.String), NotificationId: S.optional(S.String)}, ns) {}
export class RemoveTagsFromResourceOutput extends S.Class<RemoveTagsFromResourceOutput>("RemoveTagsFromResourceOutput")({ResourceARN: S.optional(S.String)}, ns) {}
export class ResetCacheOutput extends S.Class<ResetCacheOutput>("ResetCacheOutput")({GatewayARN: S.optional(S.String)}, ns) {}
export class RetrieveTapeArchiveOutput extends S.Class<RetrieveTapeArchiveOutput>("RetrieveTapeArchiveOutput")({TapeARN: S.optional(S.String)}, ns) {}
export class RetrieveTapeRecoveryPointOutput extends S.Class<RetrieveTapeRecoveryPointOutput>("RetrieveTapeRecoveryPointOutput")({TapeARN: S.optional(S.String)}, ns) {}
export class SetLocalConsolePasswordOutput extends S.Class<SetLocalConsolePasswordOutput>("SetLocalConsolePasswordOutput")({GatewayARN: S.optional(S.String)}, ns) {}
export class SetSMBGuestPasswordOutput extends S.Class<SetSMBGuestPasswordOutput>("SetSMBGuestPasswordOutput")({GatewayARN: S.optional(S.String)}, ns) {}
export class ShutdownGatewayOutput extends S.Class<ShutdownGatewayOutput>("ShutdownGatewayOutput")({GatewayARN: S.optional(S.String)}, ns) {}
export class StartAvailabilityMonitorTestOutput extends S.Class<StartAvailabilityMonitorTestOutput>("StartAvailabilityMonitorTestOutput")({GatewayARN: S.optional(S.String)}, ns) {}
...
export class StartGatewayOutput extends S.Class<StartGatewayOutput>("StartGatewayOutput")({GatewayARN: S.optional(S.String)}, ns) {}
export class UpdateAutomaticTapeCreationPolicyInput extends S.Class<UpdateAutomaticTapeCreationPolicyInput>("UpdateAutomaticTapeCreationPolicyInput")({AutomaticTapeCreationRules: AutomaticTapeCreationRules, GatewayARN: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class UpdateBandwidthRateLimitOutput extends S.Class<UpdateBandwidthRateLimitOutput>("UpdateBandwidthRateLimitOutput")({GatewayARN: S.optional(S.String)}, ns) {}
export class UpdateBandwidthRateLimitScheduleInput extends S.Class<UpdateBandwidthRateLimitScheduleInput>("UpdateBandwidthRateLimitScheduleInput")({GatewayARN: S.String, BandwidthRateLimitIntervals: BandwidthRateLimitIntervals}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class UpdateChapCredentialsOutput extends S.Class<UpdateChapCredentialsOutput>("UpdateChapCredentialsOutput")({TargetARN: S.optional(S.String), InitiatorName: S.optional(S.String)}, ns) {}
export class UpdateFileSystemAssociationOutput extends S.Class<UpdateFileSystemAssociationOutput>("UpdateFileSystemAssociationOutput")({FileSystemAssociationARN: S.optional(S.String)}, ns) {}
export class UpdateGatewayInformationOutput extends S.Class<UpdateGatewayInformationOutput>("UpdateGatewayInformationOutput")({GatewayARN: S.optional(S.String), GatewayName: S.optional(S.String)}, ns) {}
export class UpdateGatewaySoftwareNowOutput extends S.Class<UpdateGatewaySoftwareNowOutput>("UpdateGatewaySoftwareNowOutput")({GatewayARN: S.optional(S.String)}, ns) {}
export class UpdateMaintenanceStartTimeInput extends S.Class<UpdateMaintenanceStartTimeInput>("UpdateMaintenanceStartTimeInput")({GatewayARN: S.String, HourOfDay: S.optional(S.Number), MinuteOfHour: S.optional(S.Number), DayOfWeek: S.optional(S.Number), DayOfMonth: S.optional(S.Number), SoftwareUpdatePreferences: S.optional(SoftwareUpdatePreferences)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class UpdateNFSFileShareOutput extends S.Class<UpdateNFSFileShareOutput>("UpdateNFSFileShareOutput")({FileShareARN: S.optional(S.String)}, ns) {}
export class UpdateSMBFileShareOutput extends S.Class<UpdateSMBFileShareOutput>("UpdateSMBFileShareOutput")({FileShareARN: S.optional(S.String)}, ns) {}
export class UpdateSMBFileShareVisibilityOutput extends S.Class<UpdateSMBFileShareVisibilityOutput>("UpdateSMBFileShareVisibilityOutput")({GatewayARN: S.optional(S.String)}, ns) {}
export class UpdateSMBLocalGroupsInput extends S.Class<UpdateSMBLocalGroupsInput>("UpdateSMBLocalGroupsInput")({GatewayARN: S.String, SMBLocalGroups: SMBLocalGroups}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class UpdateSMBSecurityStrategyOutput extends S.Class<UpdateSMBSecurityStrategyOutput>("UpdateSMBSecurityStrategyOutput")({GatewayARN: S.optional(S.String)}, ns) {}
export class UpdateSnapshotScheduleOutput extends S.Class<UpdateSnapshotScheduleOutput>("UpdateSnapshotScheduleOutput")({VolumeARN: S.optional(S.String)}, ns) {}
export class UpdateVTLDeviceTypeOutput extends S.Class<UpdateVTLDeviceTypeOutput>("UpdateVTLDeviceTypeOutput")({VTLDeviceARN: S.optional(S.String)}, ns) {}
...
export class ActivateGatewayOutput extends S.Class<ActivateGatewayOutput>("ActivateGatewayOutput")({GatewayARN: S.optional(S.String)}, ns) {}
export class AssociateFileSystemOutput extends S.Class<AssociateFileSystemOutput>("AssociateFileSystemOutput")({FileSystemAssociationARN: S.optional(S.String)}, ns) {}
export class CreateNFSFileShareOutput extends S.Class<CreateNFSFileShareOutput>("CreateNFSFileShareOutput")({FileShareARN: S.optional(S.String)}, ns) {}
export class DescribeCacheReportOutput extends S.Class<DescribeCacheReportOutput>("DescribeCacheReportOutput")({CacheReportInfo: S.optional(CacheReportInfo)}, ns) {}
export class DescribeChapCredentialsOutput extends S.Class<DescribeChapCredentialsOutput>("DescribeChapCredentialsOutput")({ChapCredentials: S.optional(ChapCredentials)}, ns) {}
...
export class DescribeNFSFileSharesOutput extends S.Class<DescribeNFSFileSharesOutput>("DescribeNFSFileSharesOutput")({NFSFileShareInfoList: S.optional(NFSFileShareInfoList)}, ns) {}
export class DescribeSMBFileSharesOutput extends S.Class<DescribeSMBFileSharesOutput>("DescribeSMBFileSharesOutput")({SMBFileShareInfoList: S.optional(SMBFileShareInfoList)}, ns) {}
export class DescribeStorediSCSIVolumesOutput extends S.Class<DescribeStorediSCSIVolumesOutput>("DescribeStorediSCSIVolumesOutput")({StorediSCSIVolumes: S.optional(StorediSCSIVolumes)}, ns) {}
export class DescribeTapeArchivesOutput extends S.Class<DescribeTapeArchivesOutput>("DescribeTapeArchivesOutput")({TapeArchives: S.optional(TapeArchives), Marker: S.optional(S.String)}, ns) {}
export class DescribeTapeRecoveryPointsOutput extends S.Class<DescribeTapeRecoveryPointsOutput>("DescribeTapeRecoveryPointsOutput")({GatewayARN: S.optional(S.String), TapeRecoveryPointInfos: S.optional(TapeRecoveryPointInfos), Marker: S.optional(S.String)}, ns) {}
export class DescribeTapesOutput extends S.Class<DescribeTapesOutput>("DescribeTapesOutput")({Tapes: S.optional(Tapes), Marker: S.optional(S.String)}, ns) {}
export class ListAutomaticTapeCreationPoliciesOutput extends S.Class<ListAutomaticTapeCreationPoliciesOutput>("ListAutomaticTapeCreationPoliciesOutput")({AutomaticTapeCreationPolicyInfos: S.optional(AutomaticTapeCreationPolicyInfos)}, ns) {}
export class ListFileSharesOutput extends S.Class<ListFileSharesOutput>("ListFileSharesOutput")({Marker: S.optional(S.String), NextMarker: S.optional(S.String), FileShareInfoList: S.optional(FileShareInfoList)}, ns) {}
export class ListFileSystemAssociationsOutput extends S.Class<ListFileSystemAssociationsOutput>("ListFileSystemAssociationsOutput")({Marker: S.optional(S.String), NextMarker: S.optional(S.String), FileSystemAssociationSummaryList: S.optional(FileSystemAssociationSummaryList)}, ns) {}
export class ListGatewaysOutput extends S.Class<ListGatewaysOutput>("ListGatewaysOutput")({Gateways: S.optional(Gateways), Marker: S.optional(S.String)}, ns) {}
export class ListLocalDisksOutput extends S.Class<ListLocalDisksOutput>("ListLocalDisksOutput")({GatewayARN: S.optional(S.String), Disks: S.optional(Disks)}, ns) {}
export class ListTapePoolsOutput extends S.Class<ListTapePoolsOutput>("ListTapePoolsOutput")({PoolInfos: S.optional(PoolInfos), Marker: S.optional(S.String)}, ns) {}
export class ListTapesOutput extends S.Class<ListTapesOutput>("ListTapesOutput")({TapeInfos: S.optional(TapeInfos), Marker: S.optional(S.String)}, ns) {}
export class ListVolumeRecoveryPointsOutput extends S.Class<ListVolumeRecoveryPointsOutput>("ListVolumeRecoveryPointsOutput")({GatewayARN: S.optional(S.String), VolumeRecoveryPointInfos: S.optional(VolumeRecoveryPointInfos)}, ns) {}
export class ListVolumesOutput extends S.Class<ListVolumesOutput>("ListVolumesOutput")({GatewayARN: S.optional(S.String), Marker: S.optional(S.String), VolumeInfos: S.optional(VolumeInfos)}, ns) {}
export class StartCacheReportOutput extends S.Class<StartCacheReportOutput>("StartCacheReportOutput")({CacheReportARN: S.optional(S.String)}, ns) {}
export class UpdateAutomaticTapeCreationPolicyOutput extends S.Class<UpdateAutomaticTapeCreationPolicyOutput>("UpdateAutomaticTapeCreationPolicyOutput")({GatewayARN: S.optional(S.String)}, ns) {}
export class UpdateBandwidthRateLimitScheduleOutput extends S.Class<UpdateBandwidthRateLimitScheduleOutput>("UpdateBandwidthRateLimitScheduleOutput")({GatewayARN: S.optional(S.String)}, ns) {}
export class UpdateMaintenanceStartTimeOutput extends S.Class<UpdateMaintenanceStartTimeOutput>("UpdateMaintenanceStartTimeOutput")({GatewayARN: S.optional(S.String)}, ns) {}
export class UpdateSMBLocalGroupsOutput extends S.Class<UpdateSMBLocalGroupsOutput>("UpdateSMBLocalGroupsOutput")({GatewayARN: S.optional(S.String)}, ns) {}
...
export class DescribeCachediSCSIVolumesOutput extends S.Class<DescribeCachediSCSIVolumesOutput>("DescribeCachediSCSIVolumesOutput")({CachediSCSIVolumes: S.optional(CachediSCSIVolumes)}, ns) {}
export class DescribeFileSystemAssociationsOutput extends S.Class<DescribeFileSystemAssociationsOutput>("DescribeFileSystemAssociationsOutput")({FileSystemAssociationInfoList: S.optional(FileSystemAssociationInfoList)}, ns) {}
export class DescribeVTLDevicesOutput extends S.Class<DescribeVTLDevicesOutput>("DescribeVTLDevicesOutput")({GatewayARN: S.optional(S.String), VTLDevices: S.optional(VTLDevices), Marker: S.optional(S.String)}, ns) {}
...
//# Errors
export class InternalServerError extends S.TaggedError<InternalServerError>()("InternalServerError", {message: S.optional(S.String), error: S.optional(StorageGatewayError)}).pipe(withCategory(ERROR_CATEGORIES.SERVER_ERROR)) {}
export class InvalidGatewayRequestException extends S.TaggedError<InvalidGatewayRequestException>()("InvalidGatewayRequestException", {message: S.optional(S.String), error: S.optional(StorageGatewayError)}) {}
export class ServiceUnavailableError extends S.TaggedError<ServiceUnavailableError>()("ServiceUnavailableError", {message: S.optional(S.String), error: S.optional(StorageGatewayError)}).pipe(withCategory(ERROR_CATEGORIES.SERVER_ERROR)) {}
 ...
 */
export const addCache = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: AddCacheInput, output: AddCacheOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const addTagsToResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: AddTagsToResourceInput, output: AddTagsToResourceOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 * buffer.
 */
export const addUploadBuffer = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: AddUploadBufferInput, output: AddUploadBufferOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 * storage.
 */
export const addWorkingStorage = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: AddWorkingStorageInput, output: AddWorkingStorageOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const assignTapePool = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: AssignTapePoolInput, output: AssignTapePoolOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const attachVolume = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: AttachVolumeInput, output: AttachVolumeOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const cancelArchival = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CancelArchivalInput, output: CancelArchivalOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 * error.
 */
export const cancelCacheReport = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CancelCacheReportInput, output: CancelCacheReportOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const cancelRetrieval = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CancelRetrievalInput, output: CancelRetrievalOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const createCachediSCSIVolume = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateCachediSCSIVolumeInput, output: CreateCachediSCSIVolumeOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 * share.
 */
export const createSMBFileShare = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateSMBFileShareInput, output: CreateSMBFileShareOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const createStorediSCSIVolume = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateStorediSCSIVolumeInput, output: CreateStorediSCSIVolumeOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const createTapePool = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateTapePoolInput, output: CreateTapePoolOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 * Use the AddCache operation to add cache storage to a gateway.
 */
export const createTapes = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateTapesInput, output: CreateTapesOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 * Use the AddCache operation to add cache storage to a gateway.
 */
export const createTapeWithBarcode = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateTapeWithBarcodeInput, output: CreateTapeWithBarcodeOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const deleteAutomaticTapeCreationPolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteAutomaticTapeCreationPolicyInput, output: DeleteAutomaticTapeCreationPolicyOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const deleteBandwidthRateLimit = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteBandwidthRateLimitInput, output: DeleteBandwidthRateLimitOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const deleteCacheReport = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteCacheReportInput, output: DeleteCacheReportOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 * Deletes Challenge-Handshake Authentication Protocol (CHAP) credentials for a specified
 * iSCSI target and initiator pair. This operation is supported in volume and tape gateway
 * types.
 */
export const deleteChapCredentials = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteChapCredentialsInput, output: DeleteChapCredentialsOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 * Deletes a file share from an S3 File Gateway. This operation is only supported for S3
 * File Gateways.
 */
export const deleteFileShare = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteFileShareInput, output: DeleteFileShareOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 * page.
 */
export const deleteGateway = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteGatewayInput, output: DeleteGatewayOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const deleteSnapshotSchedule = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteSnapshotScheduleInput, output: DeleteSnapshotScheduleOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 * Deletes the specified virtual tape. This operation is only supported in the tape gateway
 * type.
 */
export const deleteTape = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteTapeInput, output: DeleteTapeOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 * Deletes the specified virtual tape from the virtual tape shelf (VTS). This operation is
 * only supported in the tape gateway type.
 */
export const deleteTapeArchive = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteTapeArchiveInput, output: DeleteTapeArchiveOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 * tape pool.
 */
export const deleteTapePool = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteTapePoolInput, output: DeleteTapePoolOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 * you want to delete.
 */
export const deleteVolume = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteVolumeInput, output: DeleteVolumeOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const describeAvailabilityMonitorTest = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeAvailabilityMonitorTestInput, output: DescribeAvailabilityMonitorTestOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const describeBandwidthRateLimit = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeBandwidthRateLimitInput, output: DescribeBandwidthRateLimitOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const describeBandwidthRateLimitSchedule = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeBandwidthRateLimitScheduleInput, output: DescribeBandwidthRateLimitScheduleOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const describeCache = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeCacheInput, output: DescribeCacheOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const describeMaintenanceStartTime = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeMaintenanceStartTimeInput, output: DescribeMaintenanceStartTimeOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const describeSMBSettings = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeSMBSettingsInput, output: DescribeSMBSettingsOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 * types.
 */
export const describeSnapshotSchedule = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeSnapshotScheduleInput, output: DescribeSnapshotScheduleOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const describeUploadBuffer = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeUploadBufferInput, output: DescribeUploadBufferOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const describeWorkingStorage = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeWorkingStorageInput, output: DescribeWorkingStorageOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const detachVolume = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DetachVolumeInput, output: DetachVolumeOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const disableGateway = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DisableGatewayInput, output: DisableGatewayOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const disassociateFileSystem = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DisassociateFileSystemInput, output: DisassociateFileSystemOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 * loss.
 */
export const evictFilesFailingUpload = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: EvictFilesFailingUploadInput, output: EvictFilesFailingUploadOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const joinDomain = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: JoinDomainInput, output: JoinDomainOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const listCacheReports = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListCacheReportsInput, output: ListCacheReportsOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const listTagsForResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListTagsForResourceInput, output: ListTagsForResourceOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const listVolumeInitiators = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListVolumeInitiatorsInput, output: ListVolumeInitiatorsOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 * Guide.
 */
export const notifyWhenUploaded = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: NotifyWhenUploadedInput, output: NotifyWhenUploadedOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 * Guide.
 */
export const refreshCache = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: RefreshCacheInput, output: RefreshCacheOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 * Removes one or more tags from the specified resource. This operation is supported in
 * storage gateways of all types.
 */
export const removeTagsFromResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: RemoveTagsFromResourceInput, output: RemoveTagsFromResourceOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const resetCache = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ResetCacheInput, output: ResetCacheOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const retrieveTapeArchive = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: RetrieveTapeArchiveInput, output: RetrieveTapeArchiveOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const retrieveTapeRecoveryPoint = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: RetrieveTapeRecoveryPointInput, output: RetrieveTapeRecoveryPointOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 * password.
 */
export const setLocalConsolePassword = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: SetLocalConsolePasswordInput, output: SetLocalConsolePasswordOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const setSMBGuestPassword = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: SetSMBGuestPasswordInput, output: SetSMBGuestPasswordOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 * gateway.
 */
export const shutdownGateway = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ShutdownGatewayInput, output: ShutdownGatewayOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const startAvailabilityMonitorTest = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StartAvailabilityMonitorTestInput, output: StartAvailabilityMonitorTestOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 * your request.
 */
export const startGateway = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StartGatewayInput, output: StartGatewayOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 * your request.
 */
export const updateBandwidthRateLimit = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateBandwidthRateLimitInput, output: UpdateBandwidthRateLimitOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const updateChapCredentials = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateChapCredentialsInput, output: UpdateChapCredentialsOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 * Updates a file system association. This operation is only supported in the FSx File
 * Gateways.
 */
export const updateFileSystemAssociation = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateFileSystemAssociationInput, output: UpdateFileSystemAssociationOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const updateGatewayInformation = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateGatewayInformationInput, output: UpdateGatewayInformationOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const updateGatewaySoftwareNow = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateGatewaySoftwareNowInput, output: UpdateGatewaySoftwareNowOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const updateNFSFileShare = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateNFSFileShareInput, output: UpdateNFSFileShareOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 * share.
 */
export const updateSMBFileShare = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateSMBFileShareInput, output: UpdateSMBFileShareOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const updateSMBFileShareVisibility = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateSMBFileShareVisibilityInput, output: UpdateSMBFileShareVisibilityOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const updateSMBSecurityStrategy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateSMBSecurityStrategyInput, output: UpdateSMBSecurityStrategyOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const updateSnapshotSchedule = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateSnapshotScheduleInput, output: UpdateSnapshotScheduleOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 * only supported in the tape gateway type.
 */
export const updateVTLDeviceType = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateVTLDeviceTypeInput, output: UpdateVTLDeviceTypeOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const activateGateway = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ActivateGatewayInput, output: ActivateGatewayOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 * type.
 */
export const associateFileSystem = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: AssociateFileSystemInput, output: AssociateFileSystemOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 * share.
 */
export const createNFSFileShare = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateNFSFileShareInput, output: CreateNFSFileShareOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 * Returns information about the specified cache report, including completion status and
 * generation progress.
 */
export const describeCacheReport = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeCacheReportInput, output: DescribeCacheReportOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 * Returns an array of Challenge-Handshake Authentication Protocol (CHAP) credentials
 * information for a specified iSCSI target, one for each target-initiator pair. This
 * operation is supported in the volume and tape gateway types.
 */
export const describeChapCredentials = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeChapCredentialsInput, output: DescribeChapCredentialsOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 * Name (ARN) of the gateway in your request.
 */
export const describeGatewayInformation = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeGatewayInformationInput, output: DescribeGatewayInformationOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const describeNFSFileShares = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeNFSFileSharesInput, output: DescribeNFSFileSharesOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 * Gets a description for one or more Server Message Block (SMB) file shares from a S3 File
 * Gateway. This operation is only supported for S3 File Gateways.
 */
export const describeSMBFileShares = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeSMBFileSharesInput, output: DescribeSMBFileSharesOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const describeStorediSCSIVolumes = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeStorediSCSIVolumesInput, output: DescribeStorediSCSIVolumesOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const describeTapeArchives = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeTapeArchivesInput, output: DescribeTapeArchivesOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 * gateway type.
 */
export const describeTapeRecoveryPoints = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeTapeRecoveryPointsInput, output: DescribeTapeRecoveryPointsOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 * tapes.
 */
export const describeTapes = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeTapesInput, output: DescribeTapesOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const listAutomaticTapeCreationPolicies = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListAutomaticTapeCreationPoliciesInput, output: ListAutomaticTapeCreationPoliciesOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const listFileShares = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListFileSharesInput, output: ListFileSharesOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 * Gateways.
 */
export const listFileSystemAssociations = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListFileSystemAssociationsInput, output: ListFileSystemAssociationsOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const listGateways = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListGatewaysInput, output: ListGatewaysOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 * corrupted).
 */
export const listLocalDisks = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListLocalDisksInput, output: ListLocalDisksOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const listTapePools = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListTapePoolsInput, output: ListTapePoolsOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 * the tape gateway type.
 */
export const listTapes = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListTapesInput, output: ListTapesOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const listVolumeRecoveryPoints = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListVolumeRecoveryPointsInput, output: ListVolumeRecoveryPointsOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const listVolumes = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListVolumesInput, output: ListVolumesOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const startCacheReport = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StartCacheReportInput, output: StartCacheReportOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const updateAutomaticTapeCreationPolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateAutomaticTapeCreationPolicyInput, output: UpdateAutomaticTapeCreationPolicyOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 * limits.
 */
export const updateBandwidthRateLimitSchedule = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateBandwidthRateLimitScheduleInput, output: UpdateBandwidthRateLimitScheduleOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 * deployment.
 */
export const updateMaintenanceStartTime = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateMaintenanceStartTimeInput, output: UpdateMaintenanceStartTimeOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 * Updates the list of Active Directory users and groups that have special permissions for
 * SMB file shares on the gateway.
 */
export const updateSMBLocalGroups = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateSMBLocalGroupsInput, output: UpdateSMBLocalGroupsOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 * (ARN).
 */
export const describeCachediSCSIVolumes = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeCachediSCSIVolumesInput, output: DescribeCachediSCSIVolumesOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 * Gets the file system association information. This operation is only supported for FSx
 * File Gateways.
 */
export const describeFileSystemAssociations = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeFileSystemAssociationsInput, output: DescribeFileSystemAssociationsOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const describeVTLDevices = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeVTLDevicesInput, output: DescribeVTLDevicesOutput, errors: [InternalServerError, InvalidGatewayRequestException] }));
/**
 ...
 */
export const createSnapshot = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateSnapshotInput, output: CreateSnapshotOutput, errors: [InternalServerError, InvalidGatewayRequestException, ServiceUnavailableError] }));
/**
 ...
 * Reference.
 */
export const createSnapshotFromVolumeRecoveryPoint = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateSnapshotFromVolumeRecoveryPointInput, output: CreateSnapshotFromVolumeRecoveryPointOutput, errors: [InternalServerError, InvalidGatewayRequestException, ServiceUnavailableError] }));
