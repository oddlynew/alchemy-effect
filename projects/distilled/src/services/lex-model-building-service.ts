...
const svc = T.AwsApiService({ sdkId: "Lex Model Building Service", serviceShapeName: "AWSDeepSenseModelBuildingService" });
...
export class CreateBotVersionRequest extends S.Class<CreateBotVersionRequest>("CreateBotVersionRequest")({name: S.String.pipe(T.HttpLabel("name")), checksum: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/bots/{name}/versions" }), svc, auth, proto, ver, rules)) {}
export class CreateIntentVersionRequest extends S.Class<CreateIntentVersionRequest>("CreateIntentVersionRequest")({name: S.String.pipe(T.HttpLabel("name")), checksum: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/intents/{name}/versions" }), svc, auth, proto, ver, rules)) {}
export class CreateSlotTypeVersionRequest extends S.Class<CreateSlotTypeVersionRequest>("CreateSlotTypeVersionRequest")({name: S.String.pipe(T.HttpLabel("name")), checksum: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/slottypes/{name}/versions" }), svc, auth, proto, ver, rules)) {}
export class DeleteBotRequest extends S.Class<DeleteBotRequest>("DeleteBotRequest")({name: S.String.pipe(T.HttpLabel("name"))}, T.all(T.Http({ method: "DELETE", uri: "/bots/{name}" }), svc, auth, proto, ver, rules)) {}
export class DeleteBotResponse extends S.Class<DeleteBotResponse>("DeleteBotResponse")({}) {}
export class DeleteBotAliasRequest extends S.Class<DeleteBotAliasRequest>("DeleteBotAliasRequest")({name: S.String.pipe(T.HttpLabel("name")), botName: S.String.pipe(T.HttpLabel("botName"))}, T.all(T.Http({ method: "DELETE", uri: "/bots/{botName}/aliases/{name}" }), svc, auth, proto, ver, rules)) {}
export class DeleteBotAliasResponse extends S.Class<DeleteBotAliasResponse>("DeleteBotAliasResponse")({}) {}
export class DeleteBotChannelAssociationRequest extends S.Class<DeleteBotChannelAssociationRequest>("DeleteBotChannelAssociationRequest")({name: S.String.pipe(T.HttpLabel("name")), botName: S.String.pipe(T.HttpLabel("botName")), botAlias: S.String.pipe(T.HttpLabel("botAlias"))}, T.all(T.Http({ method: "DELETE", uri: "/bots/{botName}/aliases/{botAlias}/channels/{name}" }), svc, auth, proto, ver, rules)) {}
export class DeleteBotChannelAssociationResponse extends S.Class<DeleteBotChannelAssociationResponse>("DeleteBotChannelAssociationResponse")({}) {}
export class DeleteBotVersionRequest extends S.Class<DeleteBotVersionRequest>("DeleteBotVersionRequest")({name: S.String.pipe(T.HttpLabel("name")), version: S.String.pipe(T.HttpLabel("version"))}, T.all(T.Http({ method: "DELETE", uri: "/bots/{name}/versions/{version}" }), svc, auth, proto, ver, rules)) {}
export class DeleteBotVersionResponse extends S.Class<DeleteBotVersionResponse>("DeleteBotVersionResponse")({}) {}
export class DeleteIntentRequest extends S.Class<DeleteIntentRequest>("DeleteIntentRequest")({name: S.String.pipe(T.HttpLabel("name"))}, T.all(T.Http({ method: "DELETE", uri: "/intents/{name}" }), svc, auth, proto, ver, rules)) {}
export class DeleteIntentResponse extends S.Class<DeleteIntentResponse>("DeleteIntentResponse")({}) {}
export class DeleteIntentVersionRequest extends S.Class<DeleteIntentVersionRequest>("DeleteIntentVersionRequest")({name: S.String.pipe(T.HttpLabel("name")), version: S.String.pipe(T.HttpLabel("version"))}, T.all(T.Http({ method: "DELETE", uri: "/intents/{name}/versions/{version}" }), svc, auth, proto, ver, rules)) {}
export class DeleteIntentVersionResponse extends S.Class<DeleteIntentVersionResponse>("DeleteIntentVersionResponse")({}) {}
export class DeleteSlotTypeRequest extends S.Class<DeleteSlotTypeRequest>("DeleteSlotTypeRequest")({name: S.String.pipe(T.HttpLabel("name"))}, T.all(T.Http({ method: "DELETE", uri: "/slottypes/{name}" }), svc, auth, proto, ver, rules)) {}
export class DeleteSlotTypeResponse extends S.Class<DeleteSlotTypeResponse>("DeleteSlotTypeResponse")({}) {}
export class DeleteSlotTypeVersionRequest extends S.Class<DeleteSlotTypeVersionRequest>("DeleteSlotTypeVersionRequest")({name: S.String.pipe(T.HttpLabel("name")), version: S.String.pipe(T.HttpLabel("version"))}, T.all(T.Http({ method: "DELETE", uri: "/slottypes/{name}/version/{version}" }), svc, auth, proto, ver, rules)) {}
export class DeleteSlotTypeVersionResponse extends S.Class<DeleteSlotTypeVersionResponse>("DeleteSlotTypeVersionResponse")({}) {}
export class DeleteUtterancesRequest extends S.Class<DeleteUtterancesRequest>("DeleteUtterancesRequest")({botName: S.String.pipe(T.HttpLabel("botName")), userId: S.String.pipe(T.HttpLabel("userId"))}, T.all(T.Http({ method: "DELETE", uri: "/bots/{botName}/utterances/{userId}" }), svc, auth, proto, ver, rules)) {}
export class DeleteUtterancesResponse extends S.Class<DeleteUtterancesResponse>("DeleteUtterancesResponse")({}) {}
export class GetBotRequest extends S.Class<GetBotRequest>("GetBotRequest")({name: S.String.pipe(T.HttpLabel("name")), versionOrAlias: S.String.pipe(T.HttpLabel("versionOrAlias"))}, T.all(T.Http({ method: "GET", uri: "/bots/{name}/versions/{versionOrAlias}" }), svc, auth, proto, ver, rules)) {}
export class GetBotAliasRequest extends S.Class<GetBotAliasRequest>("GetBotAliasRequest")({name: S.String.pipe(T.HttpLabel("name")), botName: S.String.pipe(T.HttpLabel("botName"))}, T.all(T.Http({ method: "GET", uri: "/bots/{botName}/aliases/{name}" }), svc, auth, proto, ver, rules)) {}
export class GetBotAliasesRequest extends S.Class<GetBotAliasesRequest>("GetBotAliasesRequest")({botName: S.String.pipe(T.HttpLabel("botName")), nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken")), maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults")), nameContains: S.optional(S.String).pipe(T.HttpQuery("nameContains"))}, T.all(T.Http({ method: "GET", uri: "/bots/{botName}/aliases" }), svc, auth, proto, ver, rules)) {}
export class GetBotChannelAssociationRequest extends S.Class<GetBotChannelAssociationRequest>("GetBotChannelAssociationRequest")({name: S.String.pipe(T.HttpLabel("name")), botName: S.String.pipe(T.HttpLabel("botName")), botAlias: S.String.pipe(T.HttpLabel("botAlias"))}, T.all(T.Http({ method: "GET", uri: "/bots/{botName}/aliases/{botAlias}/channels/{name}" }), svc, auth, proto, ver, rules)) {}
export class GetBotChannelAssociationsRequest extends S.Class<GetBotChannelAssociationsRequest>("GetBotChannelAssociationsRequest")({botName: S.String.pipe(T.HttpLabel("botName")), botAlias: S.String.pipe(T.HttpLabel("botAlias")), nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken")), maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults")), nameContains: S.optional(S.String).pipe(T.HttpQuery("nameContains"))}, T.all(T.Http({ method: "GET", uri: "/bots/{botName}/aliases/{botAlias}/channels" }), svc, auth, proto, ver, rules)) {}
export class GetBotsRequest extends S.Class<GetBotsRequest>("GetBotsRequest")({nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken")), maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults")), nameContains: S.optional(S.String).pipe(T.HttpQuery("nameContains"))}, T.all(T.Http({ method: "GET", uri: "/bots" }), svc, auth, proto, ver, rules)) {}
export class GetBotVersionsRequest extends S.Class<GetBotVersionsRequest>("GetBotVersionsRequest")({name: S.String.pipe(T.HttpLabel("name")), nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken")), maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults"))}, T.all(T.Http({ method: "GET", uri: "/bots/{name}/versions" }), svc, auth, proto, ver, rules)) {}
export class GetBuiltinIntentRequest extends S.Class<GetBuiltinIntentRequest>("GetBuiltinIntentRequest")({signature: S.String.pipe(T.HttpLabel("signature"))}, T.all(T.Http({ method: "GET", uri: "/builtins/intents/{signature}" }), svc, auth, proto, ver, rules)) {}
export class GetBuiltinIntentsRequest extends S.Class<GetBuiltinIntentsRequest>("GetBuiltinIntentsRequest")({locale: S.optional(S.String).pipe(T.HttpQuery("locale")), signatureContains: S.optional(S.String).pipe(T.HttpQuery("signatureContains")), nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken")), maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults"))}, T.all(T.Http({ method: "GET", uri: "/builtins/intents" }), svc, auth, proto, ver, rules)) {}
export class GetBuiltinSlotTypesRequest extends S.Class<GetBuiltinSlotTypesRequest>("GetBuiltinSlotTypesRequest")({locale: S.optional(S.String).pipe(T.HttpQuery("locale")), signatureContains: S.optional(S.String).pipe(T.HttpQuery("signatureContains")), nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken")), maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults"))}, T.all(T.Http({ method: "GET", uri: "/builtins/slottypes" }), svc, auth, proto, ver, rules)) {}
export class GetExportRequest extends S.Class<GetExportRequest>("GetExportRequest")({name: S.String.pipe(T.HttpQuery("name")), version: S.String.pipe(T.HttpQuery("version")), resourceType: S.String.pipe(T.HttpQuery("resourceType")), exportType: S.String.pipe(T.HttpQuery("exportType"))}, T.all(T.Http({ method: "GET", uri: "/exports" }), svc, auth, proto, ver, rules)) {}
export class GetImportRequest extends S.Class<GetImportRequest>("GetImportRequest")({importId: S.String.pipe(T.HttpLabel("importId"))}, T.all(T.Http({ method: "GET", uri: "/imports/{importId}" }), svc, auth, proto, ver, rules)) {}
export class GetIntentRequest extends S.Class<GetIntentRequest>("GetIntentRequest")({name: S.String.pipe(T.HttpLabel("name")), version: S.String.pipe(T.HttpLabel("version"))}, T.all(T.Http({ method: "GET", uri: "/intents/{name}/versions/{version}" }), svc, auth, proto, ver, rules)) {}
export class GetIntentsRequest extends S.Class<GetIntentsRequest>("GetIntentsRequest")({nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken")), maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults")), nameContains: S.optional(S.String).pipe(T.HttpQuery("nameContains"))}, T.all(T.Http({ method: "GET", uri: "/intents" }), svc, auth, proto, ver, rules)) {}
export class GetIntentVersionsRequest extends S.Class<GetIntentVersionsRequest>("GetIntentVersionsRequest")({name: S.String.pipe(T.HttpLabel("name")), nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken")), maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults"))}, T.all(T.Http({ method: "GET", uri: "/intents/{name}/versions" }), svc, auth, proto, ver, rules)) {}
export class GetMigrationRequest extends S.Class<GetMigrationRequest>("GetMigrationRequest")({migrationId: S.String.pipe(T.HttpLabel("migrationId"))}, T.all(T.Http({ method: "GET", uri: "/migrations/{migrationId}" }), svc, auth, proto, ver, rules)) {}
export class GetMigrationsRequest extends S.Class<GetMigrationsRequest>("GetMigrationsRequest")({sortByAttribute: S.optional(S.String).pipe(T.HttpQuery("sortByAttribute")), sortByOrder: S.optional(S.String).pipe(T.HttpQuery("sortByOrder")), v1BotNameContains: S.optional(S.String).pipe(T.HttpQuery("v1BotNameContains")), migrationStatusEquals: S.optional(S.String).pipe(T.HttpQuery("migrationStatusEquals")), maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults")), nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken"))}, T.all(T.Http({ method: "GET", uri: "/migrations" }), svc, auth, proto, ver, rules)) {}
export class GetSlotTypeRequest extends S.Class<GetSlotTypeRequest>("GetSlotTypeRequest")({name: S.String.pipe(T.HttpLabel("name")), version: S.String.pipe(T.HttpLabel("version"))}, T.all(T.Http({ method: "GET", uri: "/slottypes/{name}/versions/{version}" }), svc, auth, proto, ver, rules)) {}
export class GetSlotTypesRequest extends S.Class<GetSlotTypesRequest>("GetSlotTypesRequest")({nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken")), maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults")), nameContains: S.optional(S.String).pipe(T.HttpQuery("nameContains"))}, T.all(T.Http({ method: "GET", uri: "/slottypes" }), svc, auth, proto, ver, rules)) {}
export class GetSlotTypeVersionsRequest extends S.Class<GetSlotTypeVersionsRequest>("GetSlotTypeVersionsRequest")({name: S.String.pipe(T.HttpLabel("name")), nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken")), maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults"))}, T.all(T.Http({ method: "GET", uri: "/slottypes/{name}/versions" }), svc, auth, proto, ver, rules)) {}
export class GetUtterancesViewRequest extends S.Class<GetUtterancesViewRequest>("GetUtterancesViewRequest")({botName: S.String.pipe(T.HttpLabel("botName")), botVersions: BotVersions.pipe(T.HttpQuery("bot_versions")), statusType: S.String.pipe(T.HttpQuery("status_type"))}, T.all(T.Http({ method: "GET", uri: "/bots/{botName}/utterances?view=aggregation" }), svc, auth, proto, ver, rules)) {}
...
export class StartImportRequest extends S.Class<StartImportRequest>("StartImportRequest")({payload: T.Blob, resourceType: S.String, mergeStrategy: S.String, tags: S.optional(TagList)}, T.all(T.Http({ method: "POST", uri: "/imports" }), svc, auth, proto, ver, rules)) {}
export class StartMigrationRequest extends S.Class<StartMigrationRequest>("StartMigrationRequest")({v1BotName: S.String, v1BotVersion: S.String, v2BotName: S.String, v2BotRole: S.String, migrationStrategy: S.String}, T.all(T.Http({ method: "POST", uri: "/migrations" }), svc, auth, proto, ver, rules)) {}
...
export class BotMetadata extends S.Class<BotMetadata>("BotMetadata")({name: S.optional(S.String), description: S.optional(S.String), status: S.optional(S.String), lastUpdatedDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), createdDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), version: S.optional(S.String)}) {}
...
export class IntentMetadata extends S.Class<IntentMetadata>("IntentMetadata")({name: S.optional(S.String), description: S.optional(S.String), lastUpdatedDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), createdDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), version: S.optional(S.String)}) {}
...
export class SlotTypeMetadata extends S.Class<SlotTypeMetadata>("SlotTypeMetadata")({name: S.optional(S.String), description: S.optional(S.String), lastUpdatedDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), createdDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), version: S.optional(S.String)}) {}
...
export class StartImportResponse extends S.Class<StartImportResponse>("StartImportResponse")({name: S.optional(S.String), resourceType: S.optional(S.String), mergeStrategy: S.optional(S.String), importId: S.optional(S.String), importStatus: S.optional(S.String), tags: S.optional(TagList), createdDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
...
export class PutBotRequest extends S.Class<PutBotRequest>("PutBotRequest")({name: S.String.pipe(T.HttpLabel("name")), description: S.optional(S.String), intents: S.optional(IntentList), enableModelImprovements: S.optional(S.Boolean), nluIntentConfidenceThreshold: S.optional(S.Number), clarificationPrompt: S.optional(Prompt), abortStatement: S.optional(Statement), idleSessionTTLInSeconds: S.optional(S.Number), voiceId: S.optional(S.String), checksum: S.optional(S.String), processBehavior: S.optional(S.String), locale: S.String, childDirected: S.Boolean, detectSentiment: S.optional(S.Boolean), createVersion: S.optional(S.Boolean), tags: S.optional(TagList)}, T.all(T.Http({ method: "PUT", uri: "/bots/{name}/versions/$LATEST" }), svc, auth, proto, ver, rules)) {}
export class PutBotAliasRequest extends S.Class<PutBotAliasRequest>("PutBotAliasRequest")({name: S.String.pipe(T.HttpLabel("name")), description: S.optional(S.String), botVersion: S.String, botName: S.String.pipe(T.HttpLabel("botName")), checksum: S.optional(S.String), conversationLogs: S.optional(ConversationLogsRequest), tags: S.optional(TagList)}, T.all(T.Http({ method: "PUT", uri: "/bots/{botName}/aliases/{name}" }), svc, auth, proto, ver, rules)) {}
export class PutSlotTypeRequest extends S.Class<PutSlotTypeRequest>("PutSlotTypeRequest")({name: S.String.pipe(T.HttpLabel("name")), description: S.optional(S.String), enumerationValues: S.optional(EnumerationValues), checksum: S.optional(S.String), valueSelectionStrategy: S.optional(S.String), createVersion: S.optional(S.Boolean), parentSlotTypeSignature: S.optional(S.String), slotTypeConfigurations: S.optional(SlotTypeConfigurations)}, T.all(T.Http({ method: "PUT", uri: "/slottypes/{name}/versions/$LATEST" }), svc, auth, proto, ver, rules)) {}
export class UtteranceData extends S.Class<UtteranceData>("UtteranceData")({utteranceString: S.optional(S.String), count: S.optional(S.Number), distinctUsers: S.optional(S.Number), firstUtteredDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), lastUtteredDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
...
export class InternalFailureException extends S.TaggedError<InternalFailureException>()("InternalFailureException", {message: S.optional(S.String)}).pipe(withCategory(ERROR_CATEGORIES.SERVER_ERROR)) {}
...
export class PreconditionFailedException extends S.TaggedError<PreconditionFailedException>()("PreconditionFailedException", {message: S.optional(S.String)}) {}
export class ResourceInUseException extends S.TaggedError<ResourceInUseException>()("ResourceInUseException", {referenceType: S.optional(S.String), exampleReference: S.optional(ResourceReference)}) {}
 ...
 */
export const getUtterancesView = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetUtterancesViewRequest, output: GetUtterancesViewResponse, errors: [BadRequestException, InternalFailureException, LimitExceededException] }));
/**
 ...
 */
export const getBotAliases = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetBotAliasesRequest, output: GetBotAliasesResponse, errors: [BadRequestException, InternalFailureException, LimitExceededException] }));
/**
 ...
 * action.
 */
export const getBotChannelAssociations = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetBotChannelAssociationsRequest, output: GetBotChannelAssociationsResponse, errors: [BadRequestException, InternalFailureException, LimitExceededException] }));
/**
 ...
 */
export const getBuiltinIntents = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetBuiltinIntentsRequest, output: GetBuiltinIntentsResponse, errors: [BadRequestException, InternalFailureException, LimitExceededException] }));
/**
 ...
 */
export const getBuiltinSlotTypes = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetBuiltinSlotTypesRequest, output: GetBuiltinSlotTypesResponse, errors: [BadRequestException, InternalFailureException, LimitExceededException] }));
/**
 * Gets a list of migrations between Amazon Lex V1 and Amazon Lex V2.
 */
export const getMigrations = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetMigrationsRequest, output: GetMigrationsResponse, errors: [BadRequestException, InternalFailureException, LimitExceededException] }));
/**
 * Starts a job to import a resource to Amazon Lex.
 */
export const startImport = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StartImportRequest, output: StartImportResponse, errors: [BadRequestException, InternalFailureException, LimitExceededException] }));
/**
 ...
 * `lex:GetBot` action.
 */
export const getBot = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetBotRequest, output: GetBotResponse, errors: [BadRequestException, InternalFailureException, LimitExceededException, NotFoundException] }));
/**
 ...
 */
export const putBot = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutBotRequest, output: PutBotResponse, errors: [BadRequestException, ConflictException, InternalFailureException, LimitExceededException, PreconditionFailedException] }));
/**
 ...
 */
export const putIntent = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutIntentRequest, output: PutIntentResponse, errors: [BadRequestException, ConflictException, InternalFailureException, LimitExceededException, PreconditionFailedException] }));
/**
 ...
 */
export const getBotAlias = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetBotAliasRequest, output: GetBotAliasResponse, errors: [BadRequestException, InternalFailureException, LimitExceededException, NotFoundException] }));
/**
 ...
 */
export const getBotChannelAssociation = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetBotChannelAssociationRequest, output: GetBotChannelAssociationResponse, errors: [BadRequestException, InternalFailureException, LimitExceededException, NotFoundException] }));
/**
 ...
 * action.
 */
export const getBots = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetBotsRequest, output: GetBotsResponse, errors: [BadRequestException, InternalFailureException, LimitExceededException, NotFoundException] }));
/**
 ...
 */
export const getBuiltinIntent = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetBuiltinIntentRequest, output: GetBuiltinIntentResponse, errors: [BadRequestException, InternalFailureException, LimitExceededException, NotFoundException] }));
/**
 ...
 */
export const getIntents = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetIntentsRequest, output: GetIntentsResponse, errors: [BadRequestException, InternalFailureException, LimitExceededException, NotFoundException] }));
/**
 ...
 */
export const getMigration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetMigrationRequest, output: GetMigrationResponse, errors: [BadRequestException, InternalFailureException, LimitExceededException, NotFoundException] }));
/**
 ...
 */
export const getSlotTypes = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetSlotTypesRequest, output: GetSlotTypesResponse, errors: [BadRequestException, InternalFailureException, LimitExceededException, NotFoundException] }));
/**
 ...
 * developer guide.
 */
export const startMigration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StartMigrationRequest, output: StartMigrationResponse, errors: [AccessDeniedException, BadRequestException, InternalFailureException, LimitExceededException, NotFoundException] }));
/**
 ...
 */
export const deleteBotChannelAssociation = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteBotChannelAssociationRequest, output: DeleteBotChannelAssociationResponse, errors: [BadRequestException, ConflictException, InternalFailureException, LimitExceededException, NotFoundException] }));
/**
 * Adds the specified tags to the specified resource. If a tag key
 * already exists, the existing value is replaced with the new value.
 */
export const tagResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: TagResourceRequest, output: TagResourceResponse, errors: [BadRequestException, ConflictException, InternalFailureException, LimitExceededException, NotFoundException] }));
/**
 * Removes tags from a bot, bot alias or bot channel.
 */
export const untagResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UntagResourceRequest, output: UntagResourceResponse, errors: [BadRequestException, ConflictException, InternalFailureException, LimitExceededException, NotFoundException] }));
/**
 ...
 */
export const createBotVersion = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateBotVersionRequest, output: CreateBotVersionResponse, errors: [BadRequestException, ConflictException, InternalFailureException, LimitExceededException, NotFoundException, PreconditionFailedException] }));
/**
 ...
 */
export const createIntentVersion = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateIntentVersionRequest, output: CreateIntentVersionResponse, errors: [BadRequestException, ConflictException, InternalFailureException, LimitExceededException, NotFoundException, PreconditionFailedException] }));
/**
 ...
 */
export const createSlotTypeVersion = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateSlotTypeVersionRequest, output: CreateSlotTypeVersionResponse, errors: [BadRequestException, ConflictException, InternalFailureException, LimitExceededException, NotFoundException, PreconditionFailedException] }));
/**
 ...
 */
export const getBotVersions = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetBotVersionsRequest, output: GetBotVersionsResponse, errors: [BadRequestException, InternalFailureException, LimitExceededException, NotFoundException] }));
/**
 * Exports the contents of a Amazon Lex resource in a specified format.
 */
export const getExport = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetExportRequest, output: GetExportResponse, errors: [BadRequestException, InternalFailureException, LimitExceededException, NotFoundException] }));
/**
 * Gets information about an import job started with the
 * `StartImport` operation.
 */
export const getImport = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetImportRequest, output: GetImportResponse, errors: [BadRequestException, InternalFailureException, LimitExceededException, NotFoundException] }));
/**
 ...
 */
export const getIntent = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetIntentRequest, output: GetIntentResponse, errors: [BadRequestException, InternalFailureException, LimitExceededException, NotFoundException] }));
/**
 ...
 */
export const getIntentVersions = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetIntentVersionsRequest, output: GetIntentVersionsResponse, errors: [BadRequestException, InternalFailureException, LimitExceededException, NotFoundException] }));
/**
 ...
 */
export const getSlotType = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetSlotTypeRequest, output: GetSlotTypeResponse, errors: [BadRequestException, InternalFailureException, LimitExceededException, NotFoundException] }));
/**
 ...
 */
export const getSlotTypeVersions = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetSlotTypeVersionsRequest, output: GetSlotTypeVersionsResponse, errors: [BadRequestException, InternalFailureException, LimitExceededException, NotFoundException] }));
/**
 ...
 */
export const listTagsForResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListTagsForResourceRequest, output: ListTagsForResourceResponse, errors: [BadRequestException, InternalFailureException, LimitExceededException, NotFoundException] }));
/**
 ...
 */
export const deleteUtterances = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteUtterancesRequest, output: DeleteUtterancesResponse, errors: [BadRequestException, InternalFailureException, LimitExceededException, NotFoundException] }));
/**
 ...
 */
export const putBotAlias = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutBotAliasRequest, output: PutBotAliasResponse, errors: [BadRequestException, ConflictException, InternalFailureException, LimitExceededException, PreconditionFailedException] }));
/**
 ...
 */
export const putSlotType = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutSlotTypeRequest, output: PutSlotTypeResponse, errors: [BadRequestException, ConflictException, InternalFailureException, LimitExceededException, PreconditionFailedException] }));
/**
 ...
 */
export const deleteBotAlias = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteBotAliasRequest, output: DeleteBotAliasResponse, errors: [BadRequestException, ConflictException, InternalFailureException, LimitExceededException, NotFoundException, ResourceInUseException] }));
/**
 ...
 */
export const deleteBotVersion = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteBotVersionRequest, output: DeleteBotVersionResponse, errors: [BadRequestException, ConflictException, InternalFailureException, LimitExceededException, NotFoundException, ResourceInUseException] }));
/**
 ...
 */
export const deleteIntent = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteIntentRequest, output: DeleteIntentResponse, errors: [BadRequestException, ConflictException, InternalFailureException, LimitExceededException, NotFoundException, ResourceInUseException] }));
/**
 ...
 */
export const deleteIntentVersion = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteIntentVersionRequest, output: DeleteIntentVersionResponse, errors: [BadRequestException, ConflictException, InternalFailureException, LimitExceededException, NotFoundException, ResourceInUseException] }));
/**
 ...
 */
export const deleteSlotType = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteSlotTypeRequest, output: DeleteSlotTypeResponse, errors: [BadRequestException, ConflictException, InternalFailureException, LimitExceededException, NotFoundException, ResourceInUseException] }));
/**
 ...
 */
export const deleteSlotTypeVersion = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteSlotTypeVersionRequest, output: DeleteSlotTypeVersionResponse, errors: [BadRequestException, ConflictException, InternalFailureException, LimitExceededException, NotFoundException, ResourceInUseException] }));
/**
 ...
 */
export const deleteBot = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteBotRequest, output: DeleteBotResponse, errors: [BadRequestException, ConflictException, InternalFailureException, LimitExceededException, NotFoundException, ResourceInUseException] }));
