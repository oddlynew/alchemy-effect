...
const svc = T.AwsApiService({ sdkId: "Organizations", serviceShapeName: "AWSOrganizationsV20161128" });
...
//# Schemas
export class DeleteOrganizationRequest extends S.Class<DeleteOrganizationRequest>("DeleteOrganizationRequest")({}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteOrganizationResponse extends S.Class<DeleteOrganizationResponse>("DeleteOrganizationResponse")({}, ns) {}
export class DeleteResourcePolicyRequest extends S.Class<DeleteResourcePolicyRequest>("DeleteResourcePolicyRequest")({}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteResourcePolicyResponse extends S.Class<DeleteResourcePolicyResponse>("DeleteResourcePolicyResponse")({}, ns) {}
export class DescribeOrganizationRequest extends S.Class<DescribeOrganizationRequest>("DescribeOrganizationRequest")({}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeResourcePolicyRequest extends S.Class<DescribeResourcePolicyRequest>("DescribeResourcePolicyRequest")({}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class EnableAllFeaturesRequest extends S.Class<EnableAllFeaturesRequest>("EnableAllFeaturesRequest")({}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class LeaveOrganizationRequest extends S.Class<LeaveOrganizationRequest>("LeaveOrganizationRequest")({}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class LeaveOrganizationResponse extends S.Class<LeaveOrganizationResponse>("LeaveOrganizationResponse")({}, ns) {}
export const CreateAccountStates = S.Array(S.String);
export const TagKeys = S.Array(S.String);
export class AcceptHandshakeRequest extends S.Class<AcceptHandshakeRequest>("AcceptHandshakeRequest")({HandshakeId: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class AttachPolicyRequest extends S.Class<AttachPolicyRequest>("AttachPolicyRequest")({PolicyId: S.String, TargetId: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class AttachPolicyResponse extends S.Class<AttachPolicyResponse>("AttachPolicyResponse")({}, ns) {}
export class CancelHandshakeRequest extends S.Class<CancelHandshakeRequest>("CancelHandshakeRequest")({HandshakeId: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class CloseAccountRequest extends S.Class<CloseAccountRequest>("CloseAccountRequest")({AccountId: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class CloseAccountResponse extends S.Class<CloseAccountResponse>("CloseAccountResponse")({}, ns) {}
export class Tag extends S.Class<Tag>("Tag")({Key: S.String, Value: S.String}) {}
export const Tags = S.Array(Tag);
export class CreateGovCloudAccountRequest extends S.Class<CreateGovCloudAccountRequest>("CreateGovCloudAccountRequest")({Email: S.String, AccountName: S.String, RoleName: S.optional(S.String), IamUserAccessToBilling: S.optional(S.String), Tags: S.optional(Tags)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class CreateOrganizationRequest extends S.Class<CreateOrganizationRequest>("CreateOrganizationRequest")({FeatureSet: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class CreateOrganizationalUnitRequest extends S.Class<CreateOrganizationalUnitRequest>("CreateOrganizationalUnitRequest")({ParentId: S.String, Name: S.String, Tags: S.optional(Tags)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class CreatePolicyRequest extends S.Class<CreatePolicyRequest>("CreatePolicyRequest")({Content: S.String, Description: S.String, Name: S.String, Type: S.String, Tags: S.optional(Tags)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeclineHandshakeRequest extends S.Class<DeclineHandshakeRequest>("DeclineHandshakeRequest")({HandshakeId: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteOrganizationalUnitRequest extends S.Class<DeleteOrganizationalUnitRequest>("DeleteOrganizationalUnitRequest")({OrganizationalUnitId: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteOrganizationalUnitResponse extends S.Class<DeleteOrganizationalUnitResponse>("DeleteOrganizationalUnitResponse")({}, ns) {}
export class DeletePolicyRequest extends S.Class<DeletePolicyRequest>("DeletePolicyRequest")({PolicyId: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeletePolicyResponse extends S.Class<DeletePolicyResponse>("DeletePolicyResponse")({}, ns) {}
export class DeregisterDelegatedAdministratorRequest extends S.Class<DeregisterDelegatedAdministratorRequest>("DeregisterDelegatedAdministratorRequest")({AccountId: S.String, ServicePrincipal: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeregisterDelegatedAdministratorResponse extends S.Class<DeregisterDelegatedAdministratorResponse>("DeregisterDelegatedAdministratorResponse")({}, ns) {}
export class DescribeAccountRequest extends S.Class<DescribeAccountRequest>("DescribeAccountRequest")({AccountId: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeCreateAccountStatusRequest extends S.Class<DescribeCreateAccountStatusRequest>("DescribeCreateAccountStatusRequest")({CreateAccountRequestId: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeEffectivePolicyRequest extends S.Class<DescribeEffectivePolicyRequest>("DescribeEffectivePolicyRequest")({PolicyType: S.String, TargetId: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeHandshakeRequest extends S.Class<DescribeHandshakeRequest>("DescribeHandshakeRequest")({HandshakeId: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeOrganizationalUnitRequest extends S.Class<DescribeOrganizationalUnitRequest>("DescribeOrganizationalUnitRequest")({OrganizationalUnitId: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribePolicyRequest extends S.Class<DescribePolicyRequest>("DescribePolicyRequest")({PolicyId: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeResponsibilityTransferRequest extends S.Class<DescribeResponsibilityTransferRequest>("DescribeResponsibilityTransferRequest")({Id: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DetachPolicyRequest extends S.Class<DetachPolicyRequest>("DetachPolicyRequest")({PolicyId: S.String, TargetId: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DetachPolicyResponse extends S.Class<DetachPolicyResponse>("DetachPolicyResponse")({}, ns) {}
export class DisableAWSServiceAccessRequest extends S.Class<DisableAWSServiceAccessRequest>("DisableAWSServiceAccessRequest")({ServicePrincipal: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DisableAWSServiceAccessResponse extends S.Class<DisableAWSServiceAccessResponse>("DisableAWSServiceAccessResponse")({}, ns) {}
export class DisablePolicyTypeRequest extends S.Class<DisablePolicyTypeRequest>("DisablePolicyTypeRequest")({RootId: S.String, PolicyType: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class EnableAWSServiceAccessRequest extends S.Class<EnableAWSServiceAccessRequest>("EnableAWSServiceAccessRequest")({ServicePrincipal: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class EnableAWSServiceAccessResponse extends S.Class<EnableAWSServiceAccessResponse>("EnableAWSServiceAccessResponse")({}, ns) {}
export class EnablePolicyTypeRequest extends S.Class<EnablePolicyTypeRequest>("EnablePolicyTypeRequest")({RootId: S.String, PolicyType: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class HandshakeParty extends S.Class<HandshakeParty>("HandshakeParty")({Id: S.String, Type: S.String}) {}
export class InviteOrganizationToTransferResponsibilityRequest extends S.Class<InviteOrganizationToTransferResponsibilityRequest>("InviteOrganizationToTransferResponsibilityRequest")({Type: S.String, Target: HandshakeParty, Notes: S.optional(S.String), StartTimestamp: S.Date.pipe(T.TimestampFormat("epoch-seconds")), SourceName: S.String, Tags: S.optional(Tags)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListAccountsRequest extends S.Class<ListAccountsRequest>("ListAccountsRequest")({NextToken: S.optional(S.String), MaxResults: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListAccountsForParentRequest extends S.Class<ListAccountsForParentRequest>("ListAccountsForParentRequest")({ParentId: S.String, NextToken: S.optional(S.String), MaxResults: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListAccountsWithInvalidEffectivePolicyRequest extends S.Class<ListAccountsWithInvalidEffectivePolicyRequest>("ListAccountsWithInvalidEffectivePolicyRequest")({PolicyType: S.String, NextToken: S.optional(S.String), MaxResults: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListAWSServiceAccessForOrganizationRequest extends S.Class<ListAWSServiceAccessForOrganizationRequest>("ListAWSServiceAccessForOrganizationRequest")({NextToken: S.optional(S.String), MaxResults: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListChildrenRequest extends S.Class<ListChildrenRequest>("ListChildrenRequest")({ParentId: S.String, ChildType: S.String, NextToken: S.optional(S.String), MaxResults: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListCreateAccountStatusRequest extends S.Class<ListCreateAccountStatusRequest>("ListCreateAccountStatusRequest")({States: S.optional(CreateAccountStates), NextToken: S.optional(S.String), MaxResults: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListDelegatedAdministratorsRequest extends S.Class<ListDelegatedAdministratorsRequest>("ListDelegatedAdministratorsRequest")({ServicePrincipal: S.optional(S.String), NextToken: S.optional(S.String), MaxResults: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListDelegatedServicesForAccountRequest extends S.Class<ListDelegatedServicesForAccountRequest>("ListDelegatedServicesForAccountRequest")({AccountId: S.String, NextToken: S.optional(S.String), MaxResults: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListEffectivePolicyValidationErrorsRequest extends S.Class<ListEffectivePolicyValidationErrorsRequest>("ListEffectivePolicyValidationErrorsRequest")({AccountId: S.String, PolicyType: S.String, NextToken: S.optional(S.String), MaxResults: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class ListHandshakesForOrganizationRequest extends S.Class<ListHandshakesForOrganizationRequest>("ListHandshakesForOrganizationRequest")({Filter: S.optional(HandshakeFilter), NextToken: S.optional(S.String), MaxResults: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListInboundResponsibilityTransfersRequest extends S.Class<ListInboundResponsibilityTransfersRequest>("ListInboundResponsibilityTransfersRequest")({Type: S.String, Id: S.optional(S.String), NextToken: S.optional(S.String), MaxResults: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListOrganizationalUnitsForParentRequest extends S.Class<ListOrganizationalUnitsForParentRequest>("ListOrganizationalUnitsForParentRequest")({ParentId: S.String, NextToken: S.optional(S.String), MaxResults: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListOutboundResponsibilityTransfersRequest extends S.Class<ListOutboundResponsibilityTransfersRequest>("ListOutboundResponsibilityTransfersRequest")({Type: S.String, NextToken: S.optional(S.String), MaxResults: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListParentsRequest extends S.Class<ListParentsRequest>("ListParentsRequest")({ChildId: S.String, NextToken: S.optional(S.String), MaxResults: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListPoliciesRequest extends S.Class<ListPoliciesRequest>("ListPoliciesRequest")({Filter: S.String, NextToken: S.optional(S.String), MaxResults: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListPoliciesForTargetRequest extends S.Class<ListPoliciesForTargetRequest>("ListPoliciesForTargetRequest")({TargetId: S.String, Filter: S.String, NextToken: S.optional(S.String), MaxResults: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListRootsRequest extends S.Class<ListRootsRequest>("ListRootsRequest")({NextToken: S.optional(S.String), MaxResults: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListTagsForResourceRequest extends S.Class<ListTagsForResourceRequest>("ListTagsForResourceRequest")({ResourceId: S.String, NextToken: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListTargetsForPolicyRequest extends S.Class<ListTargetsForPolicyRequest>("ListTargetsForPolicyRequest")({PolicyId: S.String, NextToken: S.optional(S.String), MaxResults: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class MoveAccountRequest extends S.Class<MoveAccountRequest>("MoveAccountRequest")({AccountId: S.String, SourceParentId: S.String, DestinationParentId: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class MoveAccountResponse extends S.Class<MoveAccountResponse>("MoveAccountResponse")({}, ns) {}
export class PutResourcePolicyRequest extends S.Class<PutResourcePolicyRequest>("PutResourcePolicyRequest")({Content: S.String, Tags: S.optional(Tags)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class RegisterDelegatedAdministratorRequest extends S.Class<RegisterDelegatedAdministratorRequest>("RegisterDelegatedAdministratorRequest")({AccountId: S.String, ServicePrincipal: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class RegisterDelegatedAdministratorResponse extends S.Class<RegisterDelegatedAdministratorResponse>("RegisterDelegatedAdministratorResponse")({}, ns) {}
export class RemoveAccountFromOrganizationRequest extends S.Class<RemoveAccountFromOrganizationRequest>("RemoveAccountFromOrganizationRequest")({AccountId: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class RemoveAccountFromOrganizationResponse extends S.Class<RemoveAccountFromOrganizationResponse>("RemoveAccountFromOrganizationResponse")({}, ns) {}
export class TagResourceRequest extends S.Class<TagResourceRequest>("TagResourceRequest")({ResourceId: S.String, Tags: Tags}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class TagResourceResponse extends S.Class<TagResourceResponse>("TagResourceResponse")({}, ns) {}
export class TerminateResponsibilityTransferRequest extends S.Class<TerminateResponsibilityTransferRequest>("TerminateResponsibilityTransferRequest")({Id: S.String, EndTimestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class UntagResourceRequest extends S.Class<UntagResourceRequest>("UntagResourceRequest")({ResourceId: S.String, TagKeys: TagKeys}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class UntagResourceResponse extends S.Class<UntagResourceResponse>("UntagResourceResponse")({}, ns) {}
export class UpdateOrganizationalUnitRequest extends S.Class<UpdateOrganizationalUnitRequest>("UpdateOrganizationalUnitRequest")({OrganizationalUnitId: S.String, Name: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class UpdatePolicyRequest extends S.Class<UpdatePolicyRequest>("UpdatePolicyRequest")({PolicyId: S.String, Name: S.optional(S.String), Description: S.optional(S.String), Content: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class UpdateResponsibilityTransferRequest extends S.Class<UpdateResponsibilityTransferRequest>("UpdateResponsibilityTransferRequest")({Id: S.String, Name: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export const HandshakeParties = S.Array(HandshakeParty);
export class Account extends S.Class<Account>("Account")({Id: S.optional(S.String), Arn: S.optional(S.String), Email: S.optional(S.String), Name: S.optional(S.String), Status: S.optional(S.String), State: S.optional(S.String), JoinedMethod: S.optional(S.String), JoinedTimestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
...
export class AcceptHandshakeResponse extends S.Class<AcceptHandshakeResponse>("AcceptHandshakeResponse")({Handshake: S.optional(Handshake)}, ns) {}
export class CancelHandshakeResponse extends S.Class<CancelHandshakeResponse>("CancelHandshakeResponse")({Handshake: S.optional(Handshake)}, ns) {}
export class CreateAccountRequest extends S.Class<CreateAccountRequest>("CreateAccountRequest")({Email: S.String, AccountName: S.String, RoleName: S.optional(S.String), IamUserAccessToBilling: S.optional(S.String), Tags: S.optional(Tags)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class CreateOrganizationResponse extends S.Class<CreateOrganizationResponse>("CreateOrganizationResponse")({Organization: S.optional(Organization)}, ns) {}
export class DeclineHandshakeResponse extends S.Class<DeclineHandshakeResponse>("DeclineHandshakeResponse")({Handshake: S.optional(Handshake)}, ns) {}
export class DescribeCreateAccountStatusResponse extends S.Class<DescribeCreateAccountStatusResponse>("DescribeCreateAccountStatusResponse")({CreateAccountStatus: S.optional(CreateAccountStatus)}, ns) {}
export class DescribeHandshakeResponse extends S.Class<DescribeHandshakeResponse>("DescribeHandshakeResponse")({Handshake: S.optional(Handshake)}, ns) {}
export class DescribeOrganizationalUnitResponse extends S.Class<DescribeOrganizationalUnitResponse>("DescribeOrganizationalUnitResponse")({OrganizationalUnit: S.optional(OrganizationalUnit)}, ns) {}
...
export class DescribePolicyResponse extends S.Class<DescribePolicyResponse>("DescribePolicyResponse")({Policy: S.optional(Policy)}, ns) {}
export class EnablePolicyTypeResponse extends S.Class<EnablePolicyTypeResponse>("EnablePolicyTypeResponse")({Root: S.optional(Root)}, ns) {}
export class InviteAccountToOrganizationRequest extends S.Class<InviteAccountToOrganizationRequest>("InviteAccountToOrganizationRequest")({Target: HandshakeParty, Notes: S.optional(S.String), Tags: S.optional(Tags)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class InviteOrganizationToTransferResponsibilityResponse extends S.Class<InviteOrganizationToTransferResponsibilityResponse>("InviteOrganizationToTransferResponsibilityResponse")({Handshake: S.optional(Handshake)}, ns) {}
export class ListAccountsResponse extends S.Class<ListAccountsResponse>("ListAccountsResponse")({Accounts: S.optional(Accounts), NextToken: S.optional(S.String)}, ns) {}
export class ListAccountsForParentResponse extends S.Class<ListAccountsForParentResponse>("ListAccountsForParentResponse")({Accounts: S.optional(Accounts), NextToken: S.optional(S.String)}, ns) {}
export class ListAccountsWithInvalidEffectivePolicyResponse extends S.Class<ListAccountsWithInvalidEffectivePolicyResponse>("ListAccountsWithInvalidEffectivePolicyResponse")({Accounts: S.optional(Accounts), PolicyType: S.optional(S.String), NextToken: S.optional(S.String)}, ns) {}
export class ListCreateAccountStatusResponse extends S.Class<ListCreateAccountStatusResponse>("ListCreateAccountStatusResponse")({CreateAccountStatuses: S.optional(CreateAccountStatuses), NextToken: S.optional(S.String)}, ns) {}
export class ListHandshakesForAccountRequest extends S.Class<ListHandshakesForAccountRequest>("ListHandshakesForAccountRequest")({Filter: S.optional(HandshakeFilter), NextToken: S.optional(S.String), MaxResults: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListHandshakesForOrganizationResponse extends S.Class<ListHandshakesForOrganizationResponse>("ListHandshakesForOrganizationResponse")({Handshakes: S.optional(Handshakes), NextToken: S.optional(S.String)}, ns) {}
export class ListInboundResponsibilityTransfersResponse extends S.Class<ListInboundResponsibilityTransfersResponse>("ListInboundResponsibilityTransfersResponse")({ResponsibilityTransfers: S.optional(ResponsibilityTransfers), NextToken: S.optional(S.String)}, ns) {}
export class ListOrganizationalUnitsForParentResponse extends S.Class<ListOrganizationalUnitsForParentResponse>("ListOrganizationalUnitsForParentResponse")({OrganizationalUnits: S.optional(OrganizationalUnits), NextToken: S.optional(S.String)}, ns) {}
export class ListOutboundResponsibilityTransfersResponse extends S.Class<ListOutboundResponsibilityTransfersResponse>("ListOutboundResponsibilityTransfersResponse")({ResponsibilityTransfers: S.optional(ResponsibilityTransfers), NextToken: S.optional(S.String)}, ns) {}
export const Policies = S.Array(PolicySummary);
export class ListPoliciesForTargetResponse extends S.Class<ListPoliciesForTargetResponse>("ListPoliciesForTargetResponse")({Policies: S.optional(Policies), NextToken: S.optional(S.String)}, ns) {}
export class ListRootsResponse extends S.Class<ListRootsResponse>("ListRootsResponse")({Roots: S.optional(Roots), NextToken: S.optional(S.String)}, ns) {}
export class ListTagsForResourceResponse extends S.Class<ListTagsForResourceResponse>("ListTagsForResourceResponse")({Tags: S.optional(Tags), NextToken: S.optional(S.String)}, ns) {}
...
export class PutResourcePolicyResponse extends S.Class<PutResourcePolicyResponse>("PutResourcePolicyResponse")({ResourcePolicy: S.optional(ResourcePolicy)}, ns) {}
export class TerminateResponsibilityTransferResponse extends S.Class<TerminateResponsibilityTransferResponse>("TerminateResponsibilityTransferResponse")({ResponsibilityTransfer: S.optional(ResponsibilityTransfer)}, ns) {}
export class UpdateOrganizationalUnitResponse extends S.Class<UpdateOrganizationalUnitResponse>("UpdateOrganizationalUnitResponse")({OrganizationalUnit: S.optional(OrganizationalUnit)}, ns) {}
export class UpdatePolicyResponse extends S.Class<UpdatePolicyResponse>("UpdatePolicyResponse")({Policy: S.optional(Policy)}, ns) {}
export class UpdateResponsibilityTransferResponse extends S.Class<UpdateResponsibilityTransferResponse>("UpdateResponsibilityTransferResponse")({ResponsibilityTransfer: S.optional(ResponsibilityTransfer)}, ns) {}
...
export class EffectivePolicy extends S.Class<EffectivePolicy>("EffectivePolicy")({PolicyContent: S.optional(S.String), LastUpdatedTimestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), TargetId: S.optional(S.String), PolicyType: S.optional(S.String)}) {}
export class EnabledServicePrincipal extends S.Class<EnabledServicePrincipal>("EnabledServicePrincipal")({ServicePrincipal: S.optional(S.String), DateEnabled: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
...
export class DelegatedAdministrator extends S.Class<DelegatedAdministrator>("DelegatedAdministrator")({Id: S.optional(S.String), Arn: S.optional(S.String), Email: S.optional(S.String), Name: S.optional(S.String), Status: S.optional(S.String), State: S.optional(S.String), JoinedMethod: S.optional(S.String), JoinedTimestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), DelegationEnabledDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
export const DelegatedAdministrators = S.Array(DelegatedAdministrator);
export class DelegatedService extends S.Class<DelegatedService>("DelegatedService")({ServicePrincipal: S.optional(S.String), DelegationEnabledDate: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
...
export class CreateAccountResponse extends S.Class<CreateAccountResponse>("CreateAccountResponse")({CreateAccountStatus: S.optional(CreateAccountStatus)}, ns) {}
export class CreateGovCloudAccountResponse extends S.Class<CreateGovCloudAccountResponse>("CreateGovCloudAccountResponse")({CreateAccountStatus: S.optional(CreateAccountStatus)}, ns) {}
export class CreateOrganizationalUnitResponse extends S.Class<CreateOrganizationalUnitResponse>("CreateOrganizationalUnitResponse")({OrganizationalUnit: S.optional(OrganizationalUnit)}, ns) {}
export class CreatePolicyResponse extends S.Class<CreatePolicyResponse>("CreatePolicyResponse")({Policy: S.optional(Policy)}, ns) {}
export class DescribeAccountResponse extends S.Class<DescribeAccountResponse>("DescribeAccountResponse")({Account: S.optional(Account)}, ns) {}
export class DescribeEffectivePolicyResponse extends S.Class<DescribeEffectivePolicyResponse>("DescribeEffectivePolicyResponse")({EffectivePolicy: S.optional(EffectivePolicy)}, ns) {}
export class DescribeOrganizationResponse extends S.Class<DescribeOrganizationResponse>("DescribeOrganizationResponse")({Organization: S.optional(Organization)}, ns) {}
export class DescribeResourcePolicyResponse extends S.Class<DescribeResourcePolicyResponse>("DescribeResourcePolicyResponse")({ResourcePolicy: S.optional(ResourcePolicy)}, ns) {}
export class DisablePolicyTypeResponse extends S.Class<DisablePolicyTypeResponse>("DisablePolicyTypeResponse")({Root: S.optional(Root)}, ns) {}
export class EnableAllFeaturesResponse extends S.Class<EnableAllFeaturesResponse>("EnableAllFeaturesResponse")({Handshake: S.optional(Handshake)}, ns) {}
export class InviteAccountToOrganizationResponse extends S.Class<InviteAccountToOrganizationResponse>("InviteAccountToOrganizationResponse")({Handshake: S.optional(Handshake)}, ns) {}
export class ListAWSServiceAccessForOrganizationResponse extends S.Class<ListAWSServiceAccessForOrganizationResponse>("ListAWSServiceAccessForOrganizationResponse")({EnabledServicePrincipals: S.optional(EnabledServicePrincipals), NextToken: S.optional(S.String)}, ns) {}
export class ListChildrenResponse extends S.Class<ListChildrenResponse>("ListChildrenResponse")({Children: S.optional(Children), NextToken: S.optional(S.String)}, ns) {}
export class ListDelegatedAdministratorsResponse extends S.Class<ListDelegatedAdministratorsResponse>("ListDelegatedAdministratorsResponse")({DelegatedAdministrators: S.optional(DelegatedAdministrators), NextToken: S.optional(S.String)}, ns) {}
export class ListDelegatedServicesForAccountResponse extends S.Class<ListDelegatedServicesForAccountResponse>("ListDelegatedServicesForAccountResponse")({DelegatedServices: S.optional(DelegatedServices), NextToken: S.optional(S.String)}, ns) {}
export class ListEffectivePolicyValidationErrorsResponse extends S.Class<ListEffectivePolicyValidationErrorsResponse>("ListEffectivePolicyValidationErrorsResponse")({AccountId: S.optional(S.String), PolicyType: S.optional(S.String), Path: S.optional(S.String), EvaluationTimestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), NextToken: S.optional(S.String), EffectivePolicyValidationErrors: S.optional(EffectivePolicyValidationErrors)}, ns) {}
export class ListHandshakesForAccountResponse extends S.Class<ListHandshakesForAccountResponse>("ListHandshakesForAccountResponse")({Handshakes: S.optional(Handshakes), NextToken: S.optional(S.String)}, ns) {}
export class ListParentsResponse extends S.Class<ListParentsResponse>("ListParentsResponse")({Parents: S.optional(Parents), NextToken: S.optional(S.String)}, ns) {}
export class ListPoliciesResponse extends S.Class<ListPoliciesResponse>("ListPoliciesResponse")({Policies: S.optional(Policies), NextToken: S.optional(S.String)}, ns) {}
export class ListTargetsForPolicyResponse extends S.Class<ListTargetsForPolicyResponse>("ListTargetsForPolicyResponse")({Targets: S.optional(PolicyTargets), NextToken: S.optional(S.String)}, ns) {}
export class DescribeResponsibilityTransferResponse extends S.Class<DescribeResponsibilityTransferResponse>("DescribeResponsibilityTransferResponse")({ResponsibilityTransfer: S.optional(ResponsibilityTransfer)}, ns) {}
...
export class AWSOrganizationsNotInUseException extends S.TaggedError<AWSOrganizationsNotInUseException>()("AWSOrganizationsNotInUseException", {Message: S.optional(S.String)}) {}
export class AccountNotFoundException extends S.TaggedError<AccountNotFoundException>()("AccountNotFoundException", {Message: S.optional(S.String)}) {}
...
export class AccessDeniedForDependencyException extends S.TaggedError<AccessDeniedForDependencyException>()("AccessDeniedForDependencyException", {Message: S.optional(S.String), Reason: S.optional(S.String)}) {}
...
export class InvalidInputException extends S.TaggedError<InvalidInputException>()("InvalidInputException", {Message: S.optional(S.String), Reason: S.optional(S.String)}) {}
export class ConstraintViolationException extends S.TaggedError<ConstraintViolationException>()("ConstraintViolationException", {Message: S.optional(S.String), Reason: S.optional(S.String)}) {}
export class HandshakeAlreadyInStateException extends S.TaggedError<HandshakeAlreadyInStateException>()("HandshakeAlreadyInStateException", {Message: S.optional(S.String)}) {}
export class ServiceException extends S.TaggedError<ServiceException>()("ServiceException", {Message: S.optional(S.String)}).pipe(withCategory(ERROR_CATEGORIES.SERVER_ERROR)) {}
export class OrganizationalUnitNotFoundException extends S.TaggedError<OrganizationalUnitNotFoundException>()("OrganizationalUnitNotFoundException", {Message: S.optional(S.String)}) {}
...
export class EffectivePolicyNotFoundException extends S.TaggedError<EffectivePolicyNotFoundException>()("EffectivePolicyNotFoundException", {Message: S.optional(S.String)}) {}
export class ParentNotFoundException extends S.TaggedError<ParentNotFoundException>()("ParentNotFoundException", {Message: S.optional(S.String)}) {}
...
export class PolicyNotFoundException extends S.TaggedError<PolicyNotFoundException>()("PolicyNotFoundException", {Message: S.optional(S.String)}) {}
...
export class HandshakeNotFoundException extends S.TaggedError<HandshakeNotFoundException>()("HandshakeNotFoundException", {Message: S.optional(S.String)}) {}
...
export class DuplicateOrganizationalUnitException extends S.TaggedError<DuplicateOrganizationalUnitException>()("DuplicateOrganizationalUnitException", {Message: S.optional(S.String)}) {}
export class DuplicatePolicyException extends S.TaggedError<DuplicatePolicyException>()("DuplicatePolicyException", {Message: S.optional(S.String)}) {}
...
export class MasterCannotLeaveOrganizationException extends S.TaggedError<MasterCannotLeaveOrganizationException>()("MasterCannotLeaveOrganizationException", {Message: S.optional(S.String)}) {}
export class ResponsibilityTransferNotFoundException extends S.TaggedError<ResponsibilityTransferNotFoundException>()("ResponsibilityTransferNotFoundException", {Message: S.optional(S.String)}) {}
export class FinalizingOrganizationException extends S.TaggedError<FinalizingOrganizationException>()("FinalizingOrganizationException", {Message: S.optional(S.String)}) {}
export class HandshakeConstraintViolationException extends S.TaggedError<HandshakeConstraintViolationException>()("HandshakeConstraintViolationException", {Message: S.optional(S.String), Reason: S.optional(S.String)}) {}
export class TooManyRequestsException extends S.TaggedError<TooManyRequestsException>()("TooManyRequestsException", {Type: S.optional(S.String), Message: S.optional(S.String)}).pipe(withCategory(ERROR_CATEGORIES.THROTTLING_ERROR)) {}
...
export class PolicyTypeNotEnabledException extends S.TaggedError<PolicyTypeNotEnabledException>()("PolicyTypeNotEnabledException", {Message: S.optional(S.String)}) {}
...
export class InvalidHandshakeTransitionException extends S.TaggedError<InvalidHandshakeTransitionException>()("InvalidHandshakeTransitionException", {Message: S.optional(S.String)}) {}
export class TargetNotFoundException extends S.TaggedError<TargetNotFoundException>()("TargetNotFoundException", {Message: S.optional(S.String)}) {}
...
export class PolicyTypeNotAvailableForOrganizationException extends S.TaggedError<PolicyTypeNotAvailableForOrganizationException>()("PolicyTypeNotAvailableForOrganizationException", {Message: S.optional(S.String)}) {}
export class UnsupportedAPIEndpointException extends S.TaggedError<UnsupportedAPIEndpointException>()("UnsupportedAPIEndpointException", {Message: S.optional(S.String)}) {}
 ...
 * root.
 */
export const describeOrganization = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeOrganizationRequest, output: DescribeOrganizationResponse, errors: [AccessDeniedException, AWSOrganizationsNotInUseException, ConcurrentModificationException, ServiceException, TooManyRequestsException] }));
/**
 ...
 * deleted.
 */
export const declineHandshake = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeclineHandshakeRequest, output: DeclineHandshakeResponse, errors: [AccessDeniedException, ConcurrentModificationException, HandshakeAlreadyInStateException, HandshakeNotFoundException, InvalidHandshakeTransitionException, InvalidInputException, ServiceException, TooManyRequestsException] }));
/**
 ...
 */
export const tagResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: TagResourceRequest, output: TagResourceResponse, errors: [AccessDeniedException, AWSOrganizationsNotInUseException, ConcurrentModificationException, ConstraintViolationException, InvalidInputException, ServiceException, TargetNotFoundException, TooManyRequestsException] }));
/**
 * Retrieves information about an organizational unit (OU).
 * 
 * You can only call this operation from the management account or a member account that is a delegated administrator.
 */
export const describeOrganizationalUnit = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeOrganizationalUnitRequest, output: DescribeOrganizationalUnitResponse, errors: [AccessDeniedException, AWSOrganizationsNotInUseException, InvalidInputException, OrganizationalUnitNotFoundException, ServiceException, TooManyRequestsException] }));
/**
 ...
 * You can only call this operation from the management account or a member account that is a delegated administrator.
 */
export const listChildren = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListChildrenRequest, output: ListChildrenResponse, errors: [AccessDeniedException, AWSOrganizationsNotInUseException, InvalidInputException, ParentNotFoundException, ServiceException, TooManyRequestsException] }));
/**
 ...
 */
export const listParents = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListParentsRequest, output: ListParentsResponse, errors: [AccessDeniedException, AWSOrganizationsNotInUseException, ChildNotFoundException, InvalidInputException, ServiceException, TooManyRequestsException] }));
/**
 ...
 */
export const deleteOrganization = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteOrganizationRequest, output: DeleteOrganizationResponse, errors: [AccessDeniedException, AWSOrganizationsNotInUseException, ConcurrentModificationException, ConstraintViolationException, InvalidInputException, OrganizationNotEmptyException, ServiceException, TooManyRequestsException] }));
/**
 ...
 * You can call this operation from any account in a organization.
 */
export const describeHandshake = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeHandshakeRequest, output: DescribeHandshakeResponse, errors: [AccessDeniedException, ConcurrentModificationException, HandshakeNotFoundException, InvalidInputException, ServiceException, TooManyRequestsException] }));
/**
 ...
 * You can only call this operation from the management account.
 */
export const deleteOrganizationalUnit = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteOrganizationalUnitRequest, output: DeleteOrganizationalUnitResponse, errors: [AccessDeniedException, AWSOrganizationsNotInUseException, ConcurrentModificationException, InvalidInputException, OrganizationalUnitNotEmptyException, OrganizationalUnitNotFoundException, ServiceException, TooManyRequestsException] }));
/**
 ...
 * Continue making requests until `NextToken` returns null. A null `NextToken` value indicates that you have retrieved all available results.
 */
export const listHandshakesForAccount = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListHandshakesForAccountRequest, output: ListHandshakesForAccountResponse, errors: [AccessDeniedException, ConcurrentModificationException, InvalidInputException, ServiceException, TooManyRequestsException] }));
/**
 ...
 * Continue making requests until `NextToken` returns null. A null `NextToken` value indicates that you have retrieved all available results.
 */
export const listHandshakesForOrganization = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListHandshakesForOrganizationRequest, output: ListHandshakesForOrganizationResponse, errors: [AccessDeniedException, AWSOrganizationsNotInUseException, ConcurrentModificationException, InvalidInputException, ServiceException, TooManyRequestsException] }));
/**
 ...
 * You can only call this operation from the management account or a member account that is a delegated administrator.
 */
export const listAccounts = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListAccountsRequest, output: ListAccountsResponse, errors: [AccessDeniedException, AWSOrganizationsNotInUseException, InvalidInputException, ServiceException, TooManyRequestsException] }));
/**
 ...
 */
export const listRoots = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListRootsRequest, output: ListRootsResponse, errors: [AccessDeniedException, AWSOrganizationsNotInUseException, InvalidInputException, ServiceException, TooManyRequestsException] }));
/**
 * Retrieves Organizations-related information about the specified account.
 * 
 * You can only call this operation from the management account or a member account that is a delegated administrator.
 */
export const describeAccount = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeAccountRequest, output: DescribeAccountResponse, errors: [AccessDeniedException, AccountNotFoundException, AWSOrganizationsNotInUseException, InvalidInputException, ServiceException, TooManyRequestsException] }));
/**
 ...
 * You can only call this operation from the management account or a member account that is a delegated administrator.
 */
export const listAccountsForParent = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListAccountsForParentRequest, output: ListAccountsForParentResponse, errors: [AccessDeniedException, AWSOrganizationsNotInUseException, InvalidInputException, ParentNotFoundException, ServiceException, TooManyRequestsException] }));
/**
 ...
 * You can only call this operation from the management account or a member account that is a delegated administrator.
 */
export const listOrganizationalUnitsForParent = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListOrganizationalUnitsForParentRequest, output: ListOrganizationalUnitsForParentResponse, errors: [AccessDeniedException, AWSOrganizationsNotInUseException, InvalidInputException, ParentNotFoundException, ServiceException, TooManyRequestsException] }));
/**
 ...
 * You can only call this operation from the management account.
 */
export const createOrganizationalUnit = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateOrganizationalUnitRequest, output: CreateOrganizationalUnitResponse, errors: [AccessDeniedException, AWSOrganizationsNotInUseException, ConcurrentModificationException, ConstraintViolationException, DuplicateOrganizationalUnitException, InvalidInputException, ParentNotFoundException, ServiceException, TooManyRequestsException] }));
/**
 ...
 */
export const leaveOrganization = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: LeaveOrganizationRequest, output: LeaveOrganizationResponse, errors: [AccessDeniedException, AccountNotFoundException, AWSOrganizationsNotInUseException, ConcurrentModificationException, ConstraintViolationException, InvalidInputException, MasterCannotLeaveOrganizationException, ServiceException, TooManyRequestsException] }));
/**
 * Cancels a Handshake.
 * 
 ...
 * deleted.
 */
export const cancelHandshake = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CancelHandshakeRequest, output: CancelHandshakeResponse, errors: [AccessDeniedException, ConcurrentModificationException, HandshakeAlreadyInStateException, HandshakeNotFoundException, InvalidHandshakeTransitionException, InvalidInputException, ServiceException, TooManyRequestsException] }));
/**
 ...
 * You can only call this operation from the management account or a member account that is a delegated administrator.
 */
export const untagResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UntagResourceRequest, output: UntagResourceResponse, errors: [AccessDeniedException, AWSOrganizationsNotInUseException, ConcurrentModificationException, ConstraintViolationException, InvalidInputException, ServiceException, TargetNotFoundException, TooManyRequestsException] }));
/**
 ...
 * You can only call this operation from the management account or a member account that is a delegated administrator.
 */
export const listTagsForResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListTagsForResourceRequest, output: ListTagsForResourceResponse, errors: [AccessDeniedException, AWSOrganizationsNotInUseException, InvalidInputException, ServiceException, TargetNotFoundException, TooManyRequestsException] }));
/**
 ...
 * You can only call this operation from the management account or a member account that is a delegated administrator.
 */
export const listTargetsForPolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListTargetsForPolicyRequest, output: ListTargetsForPolicyResponse, errors: [AccessDeniedException, AWSOrganizationsNotInUseException, InvalidInputException, PolicyNotFoundException, ServiceException, TooManyRequestsException, UnsupportedAPIEndpointException] }));
/**
 ...
 */
export const closeAccount = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CloseAccountRequest, output: CloseAccountResponse, errors: [AccessDeniedException, AccountAlreadyClosedException, AccountNotFoundException, AWSOrganizationsNotInUseException, ConcurrentModificationException, ConflictException, ConstraintViolationException, InvalidInputException, ServiceException, TooManyRequestsException, UnsupportedAPIEndpointException] }));
/**
 ...
 * You can only call this operation from the management account or a member account that is a delegated administrator.
 */
export const deletePolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeletePolicyRequest, output: DeletePolicyResponse, errors: [AccessDeniedException, AWSOrganizationsNotInUseException, ConcurrentModificationException, InvalidInputException, PolicyInUseException, PolicyNotFoundException, ServiceException, TooManyRequestsException, UnsupportedAPIEndpointException] }));
/**
 * Deletes the resource policy from your organization.
 * 
 * You can only call this operation from the management account.
 */
export const deleteResourcePolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteResourcePolicyRequest, output: DeleteResourcePolicyResponse, errors: [AccessDeniedException, AWSOrganizationsNotInUseException, ConcurrentModificationException, ConstraintViolationException, ResourcePolicyNotFoundException, ServiceException, TooManyRequestsException, UnsupportedAPIEndpointException] }));
/**
 ...
 * You can only call this operation from the management account or a member account that is a delegated administrator.
 */
export const listAWSServiceAccessForOrganization = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListAWSServiceAccessForOrganizationRequest, output: ListAWSServiceAccessForOrganizationResponse, errors: [AccessDeniedException, AWSOrganizationsNotInUseException, ConstraintViolationException, InvalidInputException, ServiceException, TooManyRequestsException, UnsupportedAPIEndpointException] }));
/**
 ...
 * You can only call this operation from the management account or a member account that is a delegated administrator.
 */
export const listDelegatedAdministrators = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListDelegatedAdministratorsRequest, output: ListDelegatedAdministratorsResponse, errors: [AccessDeniedException, AWSOrganizationsNotInUseException, ConstraintViolationException, InvalidInputException, ServiceException, TooManyRequestsException, UnsupportedAPIEndpointException] }));
/**
 ...
 * You can only call this operation from the management account or a member account that is a delegated administrator.
 */
export const listPolicies = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListPoliciesRequest, output: ListPoliciesResponse, errors: [AccessDeniedException, AWSOrganizationsNotInUseException, InvalidInputException, ServiceException, TooManyRequestsException, UnsupportedAPIEndpointException] }));
/**
 * Creates or updates a resource policy.
 * 
 * You can only call this operation from the management account..
 */
export const putResourcePolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutResourcePolicyRequest, output: PutResourcePolicyResponse, errors: [AccessDeniedException, AWSOrganizationsNotInUseException, ConcurrentModificationException, ConstraintViolationException, InvalidInputException, ServiceException, TooManyRequestsException, UnsupportedAPIEndpointException] }));
/**
 ...
 * You can only call this operation from the management account.
 */
export const registerDelegatedAdministrator = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: RegisterDelegatedAdministratorRequest, output: RegisterDelegatedAdministratorResponse, errors: [AccessDeniedException, AccountAlreadyRegisteredException, AccountNotFoundException, AWSOrganizationsNotInUseException, ConcurrentModificationException, ConstraintViolationException, InvalidInputException, ServiceException, TooManyRequestsException, UnsupportedAPIEndpointException] }));
/**
 ...
 * You can only call this operation from the management account.
 */
export const disableAWSServiceAccess = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DisableAWSServiceAccessRequest, output: DisableAWSServiceAccessResponse, errors: [AccessDeniedException, AWSOrganizationsNotInUseException, ConcurrentModificationException, ConstraintViolationException, InvalidInputException, ServiceException, TooManyRequestsException, UnsupportedAPIEndpointException] }));
/**
 ...
 * You can only call this operation from the management account.
 */
export const enableAWSServiceAccess = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: EnableAWSServiceAccessRequest, output: EnableAWSServiceAccessResponse, errors: [AccessDeniedException, AWSOrganizationsNotInUseException, ConcurrentModificationException, ConstraintViolationException, InvalidInputException, ServiceException, TooManyRequestsException, UnsupportedAPIEndpointException] }));
/**
 ...
 * You can only call this operation from the management account or a member account that is a delegated administrator.
 */
export const listCreateAccountStatus = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListCreateAccountStatusRequest, output: ListCreateAccountStatusResponse, errors: [AccessDeniedException, AWSOrganizationsNotInUseException, InvalidInputException, ServiceException, TooManyRequestsException, UnsupportedAPIEndpointException] }));
/**
 * Retrieves the current status of an asynchronous request to create an account.
 * 
 * You can only call this operation from the management account or a member account that is a delegated administrator.
 */
export const describeCreateAccountStatus = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeCreateAccountStatusRequest, output: DescribeCreateAccountStatusResponse, errors: [AccessDeniedException, AWSOrganizationsNotInUseException, CreateAccountStatusNotFoundException, InvalidInputException, ServiceException, TooManyRequestsException, UnsupportedAPIEndpointException] }));
/**
 ...
 * Continue making requests until `NextToken` returns null. A null `NextToken` value indicates that you have retrieved all available results.
 */
export const listOutboundResponsibilityTransfers = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListOutboundResponsibilityTransfersRequest, output: ListOutboundResponsibilityTransfersResponse, errors: [AccessDeniedException, AWSOrganizationsNotInUseException, ConstraintViolationException, InvalidInputException, ServiceException, TooManyRequestsException, UnsupportedAPIEndpointException] }));
/**
 ...
 * You can only call this operation from the management account.
 */
export const deregisterDelegatedAdministrator = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeregisterDelegatedAdministratorRequest, output: DeregisterDelegatedAdministratorResponse, errors: [AccessDeniedException, AccountNotFoundException, AccountNotRegisteredException, AWSOrganizationsNotInUseException, ConcurrentModificationException, ConstraintViolationException, InvalidInputException, ServiceException, TooManyRequestsException, UnsupportedAPIEndpointException] }));
/**
 ...
 * You can only call this operation from the management account or a member account that is a delegated administrator.
 */
export const listEffectivePolicyValidationErrors = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListEffectivePolicyValidationErrorsRequest, output: ListEffectivePolicyValidationErrorsResponse, errors: [AccessDeniedException, AccountNotFoundException, AWSOrganizationsNotInUseException, ConstraintViolationException, EffectivePolicyNotFoundException, InvalidInputException, ServiceException, TooManyRequestsException, UnsupportedAPIEndpointException] }));
/**
 * Retrieves information about a policy.
 * 
 * You can only call this operation from the management account or a member account that is a delegated administrator.
 */
export const describePolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribePolicyRequest, output: DescribePolicyResponse, errors: [AccessDeniedException, AWSOrganizationsNotInUseException, InvalidInputException, PolicyNotFoundException, ServiceException, TooManyRequestsException, UnsupportedAPIEndpointException] }));
/**
 * Retrieves information about a resource policy.
 * 
 * You can only call this operation from the management account or a member account that is a delegated administrator.
 */
export const describeResourcePolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeResourcePolicyRequest, output: DescribeResourcePolicyResponse, errors: [AccessDeniedException, AWSOrganizationsNotInUseException, ConstraintViolationException, ResourcePolicyNotFoundException, ServiceException, TooManyRequestsException, UnsupportedAPIEndpointException] }));
/**
 ...
 */
export const updateResponsibilityTransfer = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateResponsibilityTransferRequest, output: UpdateResponsibilityTransferResponse, errors: [AccessDeniedException, AWSOrganizationsNotInUseException, ConstraintViolationException, InvalidInputException, ResponsibilityTransferNotFoundException, ServiceException, TooManyRequestsException, UnsupportedAPIEndpointException] }));
/**
 ...
 * responsibilities for their organization.
 */
export const describeResponsibilityTransfer = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeResponsibilityTransferRequest, output: DescribeResponsibilityTransferResponse, errors: [AccessDeniedException, AWSOrganizationsNotInUseException, InvalidInputException, ResponsibilityTransferNotFoundException, ServiceException, TooManyRequestsException, UnsupportedAPIEndpointException] }));
/**
 ...
 */
export const createGovCloudAccount = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateGovCloudAccountRequest, output: CreateGovCloudAccountResponse, errors: [AccessDeniedException, AWSOrganizationsNotInUseException, ConcurrentModificationException, ConstraintViolationException, FinalizingOrganizationException, InvalidInputException, ServiceException, TooManyRequestsException, UnsupportedAPIEndpointException] }));
/**
 ...
 * You can only call this operation from the management account.
 */
export const inviteOrganizationToTransferResponsibility = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: InviteOrganizationToTransferResponsibilityRequest, output: InviteOrganizationToTransferResponsibilityResponse, errors: [AccessDeniedException, AWSOrganizationsNotInUseException, ConcurrentModificationException, ConstraintViolationException, DuplicateHandshakeException, HandshakeConstraintViolationException, InvalidInputException, ServiceException, TooManyRequestsException, UnsupportedAPIEndpointException] }));
/**
 ...
 * You can only call this operation from the management account or a member account that is a delegated administrator.
 */
export const detachPolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DetachPolicyRequest, output: DetachPolicyResponse, errors: [AccessDeniedException, AWSOrganizationsNotInUseException, ConcurrentModificationException, ConstraintViolationException, InvalidInputException, PolicyChangesInProgressException, PolicyNotAttachedException, PolicyNotFoundException, ServiceException, TargetNotFoundException, TooManyRequestsException, UnsupportedAPIEndpointException] }));
/**
 ...
 * You can call this operation from any account in a organization.
 */
export const describeEffectivePolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeEffectivePolicyRequest, output: DescribeEffectivePolicyResponse, errors: [AccessDeniedException, AWSOrganizationsNotInUseException, ConstraintViolationException, EffectivePolicyNotFoundException, InvalidInputException, ServiceException, TargetNotFoundException, TooManyRequestsException, UnsupportedAPIEndpointException] }));
/**
 ...
 */
export const disablePolicyType = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DisablePolicyTypeRequest, output: DisablePolicyTypeResponse, errors: [AccessDeniedException, AWSOrganizationsNotInUseException, ConcurrentModificationException, ConstraintViolationException, InvalidInputException, PolicyChangesInProgressException, PolicyTypeNotEnabledException, RootNotFoundException, ServiceException, TooManyRequestsException, UnsupportedAPIEndpointException] }));
/**
