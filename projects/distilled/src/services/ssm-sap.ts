...
export class DeleteResourcePermissionInput extends S.Class<DeleteResourcePermissionInput>("DeleteResourcePermissionInput")({ActionType: S.optional(S.String), SourceResourceArn: S.optional(S.String), ResourceArn: S.String}, T.all(T.Http({ method: "POST", uri: "/delete-resource-permission" }), svc, auth, proto, ver, rules)) {}
export class DeregisterApplicationInput extends S.Class<DeregisterApplicationInput>("DeregisterApplicationInput")({ApplicationId: S.String}, T.all(T.Http({ method: "POST", uri: "/deregister-application" }), svc, auth, proto, ver, rules)) {}
export class DeregisterApplicationOutput extends S.Class<DeregisterApplicationOutput>("DeregisterApplicationOutput")({}) {}
export class GetApplicationInput extends S.Class<GetApplicationInput>("GetApplicationInput")({ApplicationId: S.optional(S.String), ApplicationArn: S.optional(S.String), AppRegistryArn: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/get-application" }), svc, auth, proto, ver, rules)) {}
export class GetComponentInput extends S.Class<GetComponentInput>("GetComponentInput")({ApplicationId: S.String, ComponentId: S.String}, T.all(T.Http({ method: "POST", uri: "/get-component" }), svc, auth, proto, ver, rules)) {}
export class GetConfigurationCheckOperationInput extends S.Class<GetConfigurationCheckOperationInput>("GetConfigurationCheckOperationInput")({OperationId: S.String}, T.all(T.Http({ method: "POST", uri: "/get-configuration-check-operation" }), svc, auth, proto, ver, rules)) {}
export class GetDatabaseInput extends S.Class<GetDatabaseInput>("GetDatabaseInput")({ApplicationId: S.optional(S.String), ComponentId: S.optional(S.String), DatabaseId: S.optional(S.String), DatabaseArn: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/get-database" }), svc, auth, proto, ver, rules)) {}
export class GetOperationInput extends S.Class<GetOperationInput>("GetOperationInput")({OperationId: S.String}, T.all(T.Http({ method: "POST", uri: "/get-operation" }), svc, auth, proto, ver, rules)) {}
export class GetResourcePermissionInput extends S.Class<GetResourcePermissionInput>("GetResourcePermissionInput")({ActionType: S.optional(S.String), ResourceArn: S.String}, T.all(T.Http({ method: "POST", uri: "/get-resource-permission" }), svc, auth, proto, ver, rules)) {}
export class ListComponentsInput extends S.Class<ListComponentsInput>("ListComponentsInput")({ApplicationId: S.optional(S.String), NextToken: S.optional(S.String), MaxResults: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/list-components" }), svc, auth, proto, ver, rules)) {}
export class ListConfigurationCheckDefinitionsInput extends S.Class<ListConfigurationCheckDefinitionsInput>("ListConfigurationCheckDefinitionsInput")({MaxResults: S.optional(S.Number), NextToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/list-configuration-check-definitions" }), svc, auth, proto, ver, rules)) {}
export class Filter extends S.Class<Filter>("Filter")({Name: S.String, Value: S.String, Operator: S.String}) {}
export const FilterList = S.Array(Filter);
export class ListConfigurationCheckOperationsInput extends S.Class<ListConfigurationCheckOperationsInput>("ListConfigurationCheckOperationsInput")({ApplicationId: S.String, ListMode: S.optional(S.String), MaxResults: S.optional(S.Number), NextToken: S.optional(S.String), Filters: S.optional(FilterList)}, T.all(T.Http({ method: "POST", uri: "/list-configuration-check-operations" }), svc, auth, proto, ver, rules)) {}
export class ListDatabasesInput extends S.Class<ListDatabasesInput>("ListDatabasesInput")({ApplicationId: S.optional(S.String), ComponentId: S.optional(S.String), NextToken: S.optional(S.String), MaxResults: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/list-databases" }), svc, auth, proto, ver, rules)) {}
export class ListOperationEventsInput extends S.Class<ListOperationEventsInput>("ListOperationEventsInput")({OperationId: S.String, MaxResults: S.optional(S.Number), NextToken: S.optional(S.String), Filters: S.optional(FilterList)}, T.all(T.Http({ method: "POST", uri: "/list-operation-events" }), svc, auth, proto, ver, rules)) {}
export class ListOperationsInput extends S.Class<ListOperationsInput>("ListOperationsInput")({ApplicationId: S.String, MaxResults: S.optional(S.Number), NextToken: S.optional(S.String), Filters: S.optional(FilterList)}, T.all(T.Http({ method: "POST", uri: "/list-operations" }), svc, auth, proto, ver, rules)) {}
export class ListSubCheckResultsInput extends S.Class<ListSubCheckResultsInput>("ListSubCheckResultsInput")({OperationId: S.String, MaxResults: S.optional(S.Number), NextToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/list-sub-check-results" }), svc, auth, proto, ver, rules)) {}
export class ListSubCheckRuleResultsInput extends S.Class<ListSubCheckRuleResultsInput>("ListSubCheckRuleResultsInput")({SubCheckResultId: S.String, MaxResults: S.optional(S.Number), NextToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/list-sub-check-rule-results" }), svc, auth, proto, ver, rules)) {}
...
export class PutResourcePermissionInput extends S.Class<PutResourcePermissionInput>("PutResourcePermissionInput")({ActionType: S.String, SourceResourceArn: S.String, ResourceArn: S.String}, T.all(T.Http({ method: "POST", uri: "/put-resource-permission" }), svc, auth, proto, ver, rules)) {}
export class StartApplicationInput extends S.Class<StartApplicationInput>("StartApplicationInput")({ApplicationId: S.String}, T.all(T.Http({ method: "POST", uri: "/start-application" }), svc, auth, proto, ver, rules)) {}
export class StartApplicationRefreshInput extends S.Class<StartApplicationRefreshInput>("StartApplicationRefreshInput")({ApplicationId: S.String}, T.all(T.Http({ method: "POST", uri: "/start-application-refresh" }), svc, auth, proto, ver, rules)) {}
export class StartConfigurationChecksInput extends S.Class<StartConfigurationChecksInput>("StartConfigurationChecksInput")({ApplicationId: S.String, ConfigurationCheckIds: S.optional(ConfigurationCheckTypeList)}, T.all(T.Http({ method: "POST", uri: "/start-configuration-checks" }), svc, auth, proto, ver, rules)) {}
export class StopApplicationInput extends S.Class<StopApplicationInput>("StopApplicationInput")({ApplicationId: S.String, StopConnectedEntity: S.optional(S.String), IncludeEc2InstanceShutdown: S.optional(S.Boolean)}, T.all(T.Http({ method: "POST", uri: "/stop-application" }), svc, auth, proto, ver, rules)) {}
...
export class ListApplicationsInput extends S.Class<ListApplicationsInput>("ListApplicationsInput")({NextToken: S.optional(S.String), MaxResults: S.optional(S.Number), Filters: S.optional(FilterList)}, T.all(T.Http({ method: "POST", uri: "/list-applications" }), svc, auth, proto, ver, rules)) {}
...
export class OperationEvent extends S.Class<OperationEvent>("OperationEvent")({Description: S.optional(S.String), Resource: S.optional(Resource), Status: S.optional(S.String), StatusMessage: S.optional(S.String), Timestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
 ...
 */
export const listOperations = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListOperationsInput, output: ListOperationsOutput, errors: [InternalServerException, ValidationException] }));
/**
 * Lists the sub-check results of a specified configuration check operation.
 */
export const listSubCheckResults = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListSubCheckResultsInput, output: ListSubCheckResultsOutput, errors: [InternalServerException, ValidationException] }));
/**
 ...
 */
export const registerApplication = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: RegisterApplicationInput, output: RegisterApplicationOutput, errors: [ConflictException, InternalServerException, ResourceNotFoundException, ValidationException] }));
/**
 * Updates the settings of an application registered with AWS Systems Manager for SAP.
 */
export const updateApplicationSettings = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateApplicationSettingsInput, output: UpdateApplicationSettingsOutput, errors: [ConflictException, InternalServerException, ResourceNotFoundException, UnauthorizedException, ValidationException] }));
/**
 * Lists the configuration check operations performed by AWS Systems Manager for SAP.
 */
export const listConfigurationCheckOperations = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListConfigurationCheckOperationsInput, output: ListConfigurationCheckOperationsOutput, errors: [InternalServerException, ResourceNotFoundException, ValidationException] }));
/**
 * Adds permissions to the target database.
 */
export const putResourcePermission = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutResourcePermissionInput, output: PutResourcePermissionOutput, errors: [InternalServerException, ResourceNotFoundException, ValidationException] }));
/**
 * Creates tag for a resource by specifying the ARN.
 */
export const tagResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: TagResourceRequest, output: TagResourceResponse, errors: [ConflictException, ResourceNotFoundException, ValidationException] }));
/**
 * Removes permissions associated with the target database.
 */
export const deleteResourcePermission = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteResourcePermissionInput, output: DeleteResourcePermissionOutput, errors: [InternalServerException, ResourceNotFoundException, ValidationException] }));
/**
 ...
 */
export const listTagsForResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListTagsForResourceRequest, output: ListTagsForResourceResponse, errors: [ConflictException, ResourceNotFoundException, ValidationException] }));
/**
 * Request is an operation which starts an application.
 * 
 * Parameter `ApplicationId` is required.
 */
export const startApplication = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StartApplicationInput, output: StartApplicationOutput, errors: [ConflictException, InternalServerException, ResourceNotFoundException, ValidationException] }));
/**
 * Refreshes a registered application.
 */
export const startApplicationRefresh = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StartApplicationRefreshInput, output: StartApplicationRefreshOutput, errors: [ConflictException, InternalServerException, ResourceNotFoundException, UnauthorizedException, ValidationException] }));
/**
 * Initiates configuration check operations against a specified application.
 */
export const startConfigurationChecks = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StartConfigurationChecksInput, output: StartConfigurationChecksOutput, errors: [ConflictException, InternalServerException, ResourceNotFoundException, ValidationException] }));
/**
 * Request is an operation to stop an application.
 * 
 * Parameter `ApplicationId` is required. Parameters `StopConnectedEntity` and `IncludeEc2InstanceShutdown` are optional.
 */
export const stopApplication = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StopApplicationInput, output: StopApplicationOutput, errors: [ConflictException, InternalServerException, ResourceNotFoundException, ValidationException] }));
/**
 ...
 */
export const deregisterApplication = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeregisterApplicationInput, output: DeregisterApplicationOutput, errors: [InternalServerException, UnauthorizedException, ValidationException] }));
/**
 * Gets an application registered with AWS Systems Manager for SAP. It also returns the components of the application.
 */
export const getApplication = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetApplicationInput, output: GetApplicationOutput, errors: [InternalServerException, ValidationException] }));
/**
 * Gets the SAP HANA database of an application registered with AWS Systems Manager for SAP.
 */
export const getDatabase = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetDatabaseInput, output: GetDatabaseOutput, errors: [InternalServerException, ValidationException] }));
/**
 * Gets permissions associated with the target database.
 */
export const getResourcePermission = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetResourcePermissionInput, output: GetResourcePermissionOutput, errors: [InternalServerException, ResourceNotFoundException, ValidationException] }));
/**
 * Lists all the components registered with AWS Systems Manager for SAP.
 */
export const listComponents = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListComponentsInput, output: ListComponentsOutput, errors: [InternalServerException, ResourceNotFoundException, UnauthorizedException, ValidationException] }));
/**
 * Lists all configuration check types supported by AWS Systems Manager for SAP.
 */
export const listConfigurationCheckDefinitions = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListConfigurationCheckDefinitionsInput, output: ListConfigurationCheckDefinitionsOutput, errors: [InternalServerException, ValidationException] }));
/**
 * Lists the SAP HANA databases of an application registered with AWS Systems Manager for SAP.
 */
export const listDatabases = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListDatabasesInput, output: ListDatabasesOutput, errors: [InternalServerException, ResourceNotFoundException, ValidationException] }));
/**
 * Gets the details of a configuration check operation by specifying the operation ID.
 */
export const getConfigurationCheckOperation = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetConfigurationCheckOperationInput, output: GetConfigurationCheckOperationOutput, errors: [InternalServerException, ValidationException] }));
/**
 * Gets the details of an operation by specifying the operation ID.
 */
export const getOperation = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetOperationInput, output: GetOperationOutput, errors: [InternalServerException, ValidationException] }));
/**
 * Lists all the applications registered with AWS Systems Manager for SAP.
 */
export const listApplications = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListApplicationsInput, output: ListApplicationsOutput, errors: [InternalServerException, ResourceNotFoundException, ValidationException] }));
/**
 * Returns a list of operations events.
 * 
 * Available parameters include `OperationID`, as well as optional parameters `MaxResults`, `NextToken`, and `Filters`.
 */
export const listOperationEvents = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListOperationEventsInput, output: ListOperationEventsOutput, errors: [InternalServerException, ValidationException] }));
/**
 * Lists the rules of a specified sub-check belonging to a configuration check operation.
 */
export const listSubCheckRuleResults = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListSubCheckRuleResultsInput, output: ListSubCheckRuleResultsOutput, errors: [InternalServerException, ValidationException] }));
/**
 * Gets the component of an application registered with AWS Systems Manager for SAP.
 */
export const getComponent = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetComponentInput, output: GetComponentOutput, errors: [InternalServerException, UnauthorizedException, ValidationException] }));
