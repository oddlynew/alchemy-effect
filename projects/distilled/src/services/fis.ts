...
export class CreateTargetAccountConfigurationRequest extends S.Class<CreateTargetAccountConfigurationRequest>("CreateTargetAccountConfigurationRequest")({clientToken: S.optional(S.String), experimentTemplateId: S.String.pipe(T.HttpLabel("experimentTemplateId")), accountId: S.String.pipe(T.HttpLabel("accountId")), roleArn: S.String, description: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/experimentTemplates/{experimentTemplateId}/targetAccountConfigurations/{accountId}" }), svc, auth, proto, ver, rules)) {}
export class DeleteExperimentTemplateRequest extends S.Class<DeleteExperimentTemplateRequest>("DeleteExperimentTemplateRequest")({id: S.String.pipe(T.HttpLabel("id"))}, T.all(T.Http({ method: "DELETE", uri: "/experimentTemplates/{id}" }), svc, auth, proto, ver, rules)) {}
export class DeleteTargetAccountConfigurationRequest extends S.Class<DeleteTargetAccountConfigurationRequest>("DeleteTargetAccountConfigurationRequest")({experimentTemplateId: S.String.pipe(T.HttpLabel("experimentTemplateId")), accountId: S.String.pipe(T.HttpLabel("accountId"))}, T.all(T.Http({ method: "DELETE", uri: "/experimentTemplates/{experimentTemplateId}/targetAccountConfigurations/{accountId}" }), svc, auth, proto, ver, rules)) {}
export class GetActionRequest extends S.Class<GetActionRequest>("GetActionRequest")({id: S.String.pipe(T.HttpLabel("id"))}, T.all(T.Http({ method: "GET", uri: "/actions/{id}" }), svc, auth, proto, ver, rules)) {}
export class GetExperimentRequest extends S.Class<GetExperimentRequest>("GetExperimentRequest")({id: S.String.pipe(T.HttpLabel("id"))}, T.all(T.Http({ method: "GET", uri: "/experiments/{id}" }), svc, auth, proto, ver, rules)) {}
export class GetExperimentTargetAccountConfigurationRequest extends S.Class<GetExperimentTargetAccountConfigurationRequest>("GetExperimentTargetAccountConfigurationRequest")({experimentId: S.String.pipe(T.HttpLabel("experimentId")), accountId: S.String.pipe(T.HttpLabel("accountId"))}, T.all(T.Http({ method: "GET", uri: "/experiments/{experimentId}/targetAccountConfigurations/{accountId}" }), svc, auth, proto, ver, rules)) {}
export class GetExperimentTemplateRequest extends S.Class<GetExperimentTemplateRequest>("GetExperimentTemplateRequest")({id: S.String.pipe(T.HttpLabel("id"))}, T.all(T.Http({ method: "GET", uri: "/experimentTemplates/{id}" }), svc, auth, proto, ver, rules)) {}
export class GetSafetyLeverRequest extends S.Class<GetSafetyLeverRequest>("GetSafetyLeverRequest")({id: S.String.pipe(T.HttpLabel("id"))}, T.all(T.Http({ method: "GET", uri: "/safetyLevers/{id}" }), svc, auth, proto, ver, rules)) {}
export class GetTargetAccountConfigurationRequest extends S.Class<GetTargetAccountConfigurationRequest>("GetTargetAccountConfigurationRequest")({experimentTemplateId: S.String.pipe(T.HttpLabel("experimentTemplateId")), accountId: S.String.pipe(T.HttpLabel("accountId"))}, T.all(T.Http({ method: "GET", uri: "/experimentTemplates/{experimentTemplateId}/targetAccountConfigurations/{accountId}" }), svc, auth, proto, ver, rules)) {}
export class GetTargetResourceTypeRequest extends S.Class<GetTargetResourceTypeRequest>("GetTargetResourceTypeRequest")({resourceType: S.String.pipe(T.HttpLabel("resourceType"))}, T.all(T.Http({ method: "GET", uri: "/targetResourceTypes/{resourceType}" }), svc, auth, proto, ver, rules)) {}
export class ListActionsRequest extends S.Class<ListActionsRequest>("ListActionsRequest")({maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults")), nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken"))}, T.all(T.Http({ method: "GET", uri: "/actions" }), svc, auth, proto, ver, rules)) {}
export class ListExperimentResolvedTargetsRequest extends S.Class<ListExperimentResolvedTargetsRequest>("ListExperimentResolvedTargetsRequest")({experimentId: S.String.pipe(T.HttpLabel("experimentId")), maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults")), nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken")), targetName: S.optional(S.String).pipe(T.HttpQuery("targetName"))}, T.all(T.Http({ method: "GET", uri: "/experiments/{experimentId}/resolvedTargets" }), svc, auth, proto, ver, rules)) {}
export class ListExperimentsRequest extends S.Class<ListExperimentsRequest>("ListExperimentsRequest")({maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults")), nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken")), experimentTemplateId: S.optional(S.String).pipe(T.HttpQuery("experimentTemplateId"))}, T.all(T.Http({ method: "GET", uri: "/experiments" }), svc, auth, proto, ver, rules)) {}
export class ListExperimentTargetAccountConfigurationsRequest extends S.Class<ListExperimentTargetAccountConfigurationsRequest>("ListExperimentTargetAccountConfigurationsRequest")({experimentId: S.String.pipe(T.HttpLabel("experimentId")), nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken"))}, T.all(T.Http({ method: "GET", uri: "/experiments/{experimentId}/targetAccountConfigurations" }), svc, auth, proto, ver, rules)) {}
export class ListExperimentTemplatesRequest extends S.Class<ListExperimentTemplatesRequest>("ListExperimentTemplatesRequest")({maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults")), nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken"))}, T.all(T.Http({ method: "GET", uri: "/experimentTemplates" }), svc, auth, proto, ver, rules)) {}
...
export class ListTargetAccountConfigurationsRequest extends S.Class<ListTargetAccountConfigurationsRequest>("ListTargetAccountConfigurationsRequest")({experimentTemplateId: S.String.pipe(T.HttpLabel("experimentTemplateId")), maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults")), nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken"))}, T.all(T.Http({ method: "GET", uri: "/experimentTemplates/{experimentTemplateId}/targetAccountConfigurations" }), svc, auth, proto, ver, rules)) {}
export class ListTargetResourceTypesRequest extends S.Class<ListTargetResourceTypesRequest>("ListTargetResourceTypesRequest")({maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults")), nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken"))}, T.all(T.Http({ method: "GET", uri: "/targetResourceTypes" }), svc, auth, proto, ver, rules)) {}
export class StopExperimentRequest extends S.Class<StopExperimentRequest>("StopExperimentRequest")({id: S.String.pipe(T.HttpLabel("id"))}, T.all(T.Http({ method: "DELETE", uri: "/experiments/{id}" }), svc, auth, proto, ver, rules)) {}
...
export class UntagResourceRequest extends S.Class<UntagResourceRequest>("UntagResourceRequest")({resourceArn: S.String.pipe(T.HttpLabel("resourceArn")), tagKeys: S.optional(TagKeyList).pipe(T.HttpQuery("tagKeys"))}, T.all(T.Http({ method: "DELETE", uri: "/tags/{resourceArn}" }), svc, auth, proto, ver, rules)) {}
export class UntagResourceResponse extends S.Class<UntagResourceResponse>("UntagResourceResponse")({}) {}
export class UpdateTargetAccountConfigurationRequest extends S.Class<UpdateTargetAccountConfigurationRequest>("UpdateTargetAccountConfigurationRequest")({experimentTemplateId: S.String.pipe(T.HttpLabel("experimentTemplateId")), accountId: S.String.pipe(T.HttpLabel("accountId")), roleArn: S.optional(S.String), description: S.optional(S.String)}, T.all(T.Http({ method: "PATCH", uri: "/experimentTemplates/{experimentTemplateId}/targetAccountConfigurations/{accountId}" }), svc, auth, proto, ver, rules)) {}
...
export class StartExperimentRequest extends S.Class<StartExperimentRequest>("StartExperimentRequest")({clientToken: S.String, experimentTemplateId: S.String, experimentOptions: S.optional(StartExperimentExperimentOptionsInput), tags: S.optional(TagMap)}, T.all(T.Http({ method: "POST", uri: "/experiments" }), svc, auth, proto, ver, rules)) {}
...
export class UpdateSafetyLeverStateRequest extends S.Class<UpdateSafetyLeverStateRequest>("UpdateSafetyLeverStateRequest")({id: S.String.pipe(T.HttpLabel("id")), state: UpdateSafetyLeverStateInput}, T.all(T.Http({ method: "PATCH", uri: "/safetyLevers/{id}/state" }), svc, auth, proto, ver, rules)) {}
...
export class ExperimentTemplateSummary extends S.Class<ExperimentTemplateSummary>("ExperimentTemplateSummary")({id: S.optional(S.String), arn: S.optional(S.String), description: S.optional(S.String), creationTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), lastUpdateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), tags: S.optional(TagMap)}) {}
...
export class ValidationException extends S.TaggedError<ValidationException>()("ValidationException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "ValidationException", httpResponseCode: 400 })) {}
export class ServiceQuotaExceededException extends S.TaggedError<ServiceQuotaExceededException>()("ServiceQuotaExceededException", {message: S.optional(S.String)}, T.AwsQueryError({ code: "ServiceQuotaExceededException", httpResponseCode: 402 })) {}
 ...
 */
export const deleteTargetAccountConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteTargetAccountConfigurationRequest, output: DeleteTargetAccountConfigurationResponse, errors: [ResourceNotFoundException, ValidationException] }));
/**
 * Gets information about the specified safety lever.
 */
export const getSafetyLever = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetSafetyLeverRequest, output: GetSafetyLeverResponse, errors: [ResourceNotFoundException] }));
/**
 * Lists the resolved targets information of the specified experiment.
 */
export const listExperimentResolvedTargets = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListExperimentResolvedTargetsRequest, output: ListExperimentResolvedTargetsResponse, errors: [ResourceNotFoundException, ValidationException] }));
/**
 * Updates the specified safety lever state.
 */
export const updateSafetyLeverState = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateSafetyLeverStateRequest, output: UpdateSafetyLeverStateResponse, errors: [ConflictException, ResourceNotFoundException, ValidationException] }));
/**
 * Gets information about the specified target account configuration of the experiment.
 */
export const getExperimentTargetAccountConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetExperimentTargetAccountConfigurationRequest, output: GetExperimentTargetAccountConfigurationResponse, errors: [ResourceNotFoundException, ValidationException] }));
/**
 * Lists the available FIS actions.
 */
export const listActions = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListActionsRequest, output: ListActionsResponse, errors: [ValidationException] }));
/**
 * Lists your experiments.
 */
export const listExperiments = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListExperimentsRequest, output: ListExperimentsResponse, errors: [ValidationException] }));
/**
 * Lists the target account configurations of the specified experiment.
 */
export const listExperimentTargetAccountConfigurations = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListExperimentTargetAccountConfigurationsRequest, output: ListExperimentTargetAccountConfigurationsResponse, errors: [ResourceNotFoundException, ValidationException] }));
/**
 * Lists your experiment templates.
 */
export const listExperimentTemplates = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListExperimentTemplatesRequest, output: ListExperimentTemplatesResponse, errors: [ValidationException] }));
/**
 * Lists the target account configurations of the specified experiment template.
 */
export const listTargetAccountConfigurations = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListTargetAccountConfigurationsRequest, output: ListTargetAccountConfigurationsResponse, errors: [ResourceNotFoundException, ValidationException] }));
/**
 * Lists the target resource types.
 */
export const listTargetResourceTypes = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListTargetResourceTypesRequest, output: ListTargetResourceTypesResponse, errors: [ValidationException] }));
/**
 * Gets information about the specified experiment template.
 */
export const getExperimentTemplate = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetExperimentTemplateRequest, output: GetExperimentTemplateResponse, errors: [ResourceNotFoundException, ValidationException] }));
/**
 * Gets information about the specified target account configuration of the experiment template.
 */
export const getTargetAccountConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetTargetAccountConfigurationRequest, output: GetTargetAccountConfigurationResponse, errors: [ResourceNotFoundException, ValidationException] }));
/**
 * Stops the specified experiment.
 */
export const stopExperiment = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StopExperimentRequest, output: StopExperimentResponse, errors: [ResourceNotFoundException, ValidationException] }));
/**
 * Updates the target account configuration for the specified experiment template.
 */
export const updateTargetAccountConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateTargetAccountConfigurationRequest, output: UpdateTargetAccountConfigurationResponse, errors: [ResourceNotFoundException, ValidationException] }));
/**
 ...
 */
export const createTargetAccountConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateTargetAccountConfigurationRequest, output: CreateTargetAccountConfigurationResponse, errors: [ConflictException, ResourceNotFoundException, ServiceQuotaExceededException, ValidationException] }));
/**
 * Gets information about the specified FIS action.
 */
export const getAction = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetActionRequest, output: GetActionResponse, errors: [ResourceNotFoundException, ValidationException] }));
/**
 * Gets information about the specified resource type.
 */
export const getTargetResourceType = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetTargetResourceTypeRequest, output: GetTargetResourceTypeResponse, errors: [ResourceNotFoundException, ValidationException] }));
/**
 * Updates the specified experiment template.
 */
export const updateExperimentTemplate = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateExperimentTemplateRequest, output: UpdateExperimentTemplateResponse, errors: [ResourceNotFoundException, ServiceQuotaExceededException, ValidationException] }));
/**
 * Starts running an experiment from the specified experiment template.
 */
export const startExperiment = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StartExperimentRequest, output: StartExperimentResponse, errors: [ConflictException, ResourceNotFoundException, ServiceQuotaExceededException, ValidationException] }));
/**
 ...
 * in the *Fault Injection Service User Guide*.
 */
export const createExperimentTemplate = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateExperimentTemplateRequest, output: CreateExperimentTemplateResponse, errors: [ConflictException, ResourceNotFoundException, ServiceQuotaExceededException, ValidationException] }));
/**
 * Deletes the specified experiment template.
 */
export const deleteExperimentTemplate = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteExperimentTemplateRequest, output: DeleteExperimentTemplateResponse, errors: [ResourceNotFoundException, ValidationException] }));
/**
 * Gets information about the specified experiment.
 */
export const getExperiment = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetExperimentRequest, output: GetExperimentResponse, errors: [ResourceNotFoundException, ValidationException] }));
