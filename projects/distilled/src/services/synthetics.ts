...
export class AssociateResourceRequest extends S.Class<AssociateResourceRequest>("AssociateResourceRequest")({GroupIdentifier: S.String.pipe(T.HttpLabel("GroupIdentifier")), ResourceArn: S.String}, T.all(T.Http({ method: "PATCH", uri: "/group/{GroupIdentifier}/associate" }), svc, auth, proto, ver, rules)) {}
export class AssociateResourceResponse extends S.Class<AssociateResourceResponse>("AssociateResourceResponse")({}) {}
export const TagMap = S.Record({key: S.String, value: S.String});
export class CreateGroupRequest extends S.Class<CreateGroupRequest>("CreateGroupRequest")({Name: S.String, Tags: S.optional(TagMap)}, T.all(T.Http({ method: "POST", uri: "/group" }), svc, auth, proto, ver, rules)) {}
export class DeleteCanaryRequest extends S.Class<DeleteCanaryRequest>("DeleteCanaryRequest")({Name: S.String.pipe(T.HttpLabel("Name")), DeleteLambda: S.optional(S.Boolean).pipe(T.HttpQuery("deleteLambda"))}, T.all(T.Http({ method: "DELETE", uri: "/canary/{Name}" }), svc, auth, proto, ver, rules)) {}
export class DeleteCanaryResponse extends S.Class<DeleteCanaryResponse>("DeleteCanaryResponse")({}) {}
export class DeleteGroupRequest extends S.Class<DeleteGroupRequest>("DeleteGroupRequest")({GroupIdentifier: S.String.pipe(T.HttpLabel("GroupIdentifier"))}, T.all(T.Http({ method: "DELETE", uri: "/group/{GroupIdentifier}" }), svc, auth, proto, ver, rules)) {}
export class DeleteGroupResponse extends S.Class<DeleteGroupResponse>("DeleteGroupResponse")({}) {}
export class DescribeCanariesRequest extends S.Class<DescribeCanariesRequest>("DescribeCanariesRequest")({NextToken: S.optional(S.String), MaxResults: S.optional(S.Number), Names: S.optional(DescribeCanariesNameFilter)}, T.all(T.Http({ method: "POST", uri: "/canaries" }), svc, auth, proto, ver, rules)) {}
export class DescribeCanariesLastRunRequest extends S.Class<DescribeCanariesLastRunRequest>("DescribeCanariesLastRunRequest")({NextToken: S.optional(S.String), MaxResults: S.optional(S.Number), Names: S.optional(DescribeCanariesLastRunNameFilter), BrowserType: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/canaries/last-run" }), svc, auth, proto, ver, rules)) {}
export class DescribeRuntimeVersionsRequest extends S.Class<DescribeRuntimeVersionsRequest>("DescribeRuntimeVersionsRequest")({NextToken: S.optional(S.String), MaxResults: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/runtime-versions" }), svc, auth, proto, ver, rules)) {}
export class DisassociateResourceRequest extends S.Class<DisassociateResourceRequest>("DisassociateResourceRequest")({GroupIdentifier: S.String.pipe(T.HttpLabel("GroupIdentifier")), ResourceArn: S.String}, T.all(T.Http({ method: "PATCH", uri: "/group/{GroupIdentifier}/disassociate" }), svc, auth, proto, ver, rules)) {}
export class DisassociateResourceResponse extends S.Class<DisassociateResourceResponse>("DisassociateResourceResponse")({}) {}
export class GetCanaryRequest extends S.Class<GetCanaryRequest>("GetCanaryRequest")({Name: S.String.pipe(T.HttpLabel("Name")), DryRunId: S.optional(S.String).pipe(T.HttpQuery("dryRunId"))}, T.all(T.Http({ method: "GET", uri: "/canary/{Name}" }), svc, auth, proto, ver, rules)) {}
export class GetCanaryRunsRequest extends S.Class<GetCanaryRunsRequest>("GetCanaryRunsRequest")({Name: S.String.pipe(T.HttpLabel("Name")), NextToken: S.optional(S.String), MaxResults: S.optional(S.Number), DryRunId: S.optional(S.String), RunType: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/canary/{Name}/runs" }), svc, auth, proto, ver, rules)) {}
export class GetGroupRequest extends S.Class<GetGroupRequest>("GetGroupRequest")({GroupIdentifier: S.String.pipe(T.HttpLabel("GroupIdentifier"))}, T.all(T.Http({ method: "GET", uri: "/group/{GroupIdentifier}" }), svc, auth, proto, ver, rules)) {}
export class ListAssociatedGroupsRequest extends S.Class<ListAssociatedGroupsRequest>("ListAssociatedGroupsRequest")({NextToken: S.optional(S.String), MaxResults: S.optional(S.Number), ResourceArn: S.String.pipe(T.HttpLabel("ResourceArn"))}, T.all(T.Http({ method: "POST", uri: "/resource/{ResourceArn}/groups" }), svc, auth, proto, ver, rules)) {}
export class ListGroupResourcesRequest extends S.Class<ListGroupResourcesRequest>("ListGroupResourcesRequest")({NextToken: S.optional(S.String), MaxResults: S.optional(S.Number), GroupIdentifier: S.String.pipe(T.HttpLabel("GroupIdentifier"))}, T.all(T.Http({ method: "POST", uri: "/group/{GroupIdentifier}/resources" }), svc, auth, proto, ver, rules)) {}
export class ListGroupsRequest extends S.Class<ListGroupsRequest>("ListGroupsRequest")({NextToken: S.optional(S.String), MaxResults: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/groups" }), svc, auth, proto, ver, rules)) {}
...
export class StartCanaryRequest extends S.Class<StartCanaryRequest>("StartCanaryRequest")({Name: S.String.pipe(T.HttpLabel("Name"))}, T.all(T.Http({ method: "POST", uri: "/canary/{Name}/start" }), svc, auth, proto, ver, rules)) {}
export class StartCanaryResponse extends S.Class<StartCanaryResponse>("StartCanaryResponse")({}) {}
export class StopCanaryRequest extends S.Class<StopCanaryRequest>("StopCanaryRequest")({Name: S.String.pipe(T.HttpLabel("Name"))}, T.all(T.Http({ method: "POST", uri: "/canary/{Name}/stop" }), svc, auth, proto, ver, rules)) {}
...
export class CanaryCodeInput extends S.Class<CanaryCodeInput>("CanaryCodeInput")({S3Bucket: S.optional(S.String), S3Key: S.optional(S.String), S3Version: S.optional(S.String), ZipFile: S.optional(T.Blob), Handler: S.optional(S.String), BlueprintTypes: S.optional(BlueprintTypes), Dependencies: S.optional(Dependencies)}) {}
...
export class CanaryTimeline extends S.Class<CanaryTimeline>("CanaryTimeline")({Created: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), LastModified: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), LastStarted: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), LastStopped: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
...
export class Group extends S.Class<Group>("Group")({Id: S.optional(S.String), Name: S.optional(S.String), Arn: S.optional(S.String), Tags: S.optional(TagMap), CreatedTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), LastModifiedTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
...
export class CanaryRunTimeline extends S.Class<CanaryRunTimeline>("CanaryRunTimeline")({Started: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), Completed: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), MetricTimestampForRunAndRetries: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
 ...
 */
export const describeCanariesLastRun = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeCanariesLastRunRequest, output: DescribeCanariesLastRunResponse, errors: [InternalServerException, ValidationException] }));
/**
 * Retrieves a list of runs for a specified canary.
 */
export const getCanaryRuns = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetCanaryRunsRequest, output: GetCanaryRunsResponse, errors: [InternalServerException, ResourceNotFoundException, ValidationException] }));
/**
 * Use this operation to start a dry run for a canary that has already been created
 */
export const startCanaryDryRun = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StartCanaryDryRunRequest, output: StartCanaryDryRunResponse, errors: [AccessDeniedException, ConflictException, InternalServerException, ResourceNotFoundException, ValidationException] }));
/**
 ...
 */
export const updateCanary = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateCanaryRequest, output: UpdateCanaryResponse, errors: [AccessDeniedException, ConflictException, InternalServerException, RequestEntityTooLargeException, ResourceNotFoundException, ValidationException] }));
/**
 ...
 */
export const listAssociatedGroups = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListAssociatedGroupsRequest, output: ListAssociatedGroupsResponse, errors: [InternalServerException, ResourceNotFoundException, ValidationException] }));
/**
 * Returns information about one group. Groups are a global resource, so you can use this operation from
 * any Region.
 */
export const getGroup = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetGroupRequest, output: GetGroupResponse, errors: [ConflictException, InternalServerException, ResourceNotFoundException, ValidationException] }));
/**
 * This operation returns a list of the ARNs of the canaries that are associated with the specified group.
 */
export const listGroupResources = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListGroupResourcesRequest, output: ListGroupResourcesResponse, errors: [ConflictException, InternalServerException, ResourceNotFoundException, ValidationException] }));
/**
 ...
 */
export const deleteCanary = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteCanaryRequest, output: DeleteCanaryResponse, errors: [ConflictException, InternalServerException, ResourceNotFoundException, ValidationException] }));
/**
 ...
 */
export const deleteGroup = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteGroupRequest, output: DeleteGroupResponse, errors: [ConflictException, InternalServerException, ResourceNotFoundException, ValidationException] }));
/**
 * Removes a canary from a group. You must run this operation in the Region where the canary exists.
 */
export const disassociateResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DisassociateResourceRequest, output: DisassociateResourceResponse, errors: [ConflictException, InternalServerException, ResourceNotFoundException, ValidationException] }));
/**
 ...
 * use GetCanary.
 */
export const startCanary = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StartCanaryRequest, output: StartCanaryResponse, errors: [ConflictException, InternalServerException, ResourceNotFoundException, ValidationException] }));
/**
 ...
 */
export const stopCanary = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StopCanaryRequest, output: StopCanaryResponse, errors: [ConflictException, InternalServerException, ResourceNotFoundException, ValidationException] }));
/**
 ...
 */
export const associateResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: AssociateResourceRequest, output: AssociateResourceResponse, errors: [ConflictException, InternalServerException, ResourceNotFoundException, ServiceQuotaExceededException, ValidationException] }));
/**
 * Returns a list of Synthetics canary runtime versions. For more information,
 * see
 * Canary Runtime Versions.
 */
export const describeRuntimeVersions = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeRuntimeVersionsRequest, output: DescribeRuntimeVersionsResponse, errors: [InternalServerException, ValidationException] }));
/**
 * Retrieves complete information about one canary. You must specify
 * the name of the canary that you want. To get a list of canaries
 * and their names, use DescribeCanaries.
 */
export const getCanary = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetCanaryRequest, output: GetCanaryResponse, errors: [InternalServerException, ValidationException] }));
/**
 ...
 */
export const listGroups = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListGroupsRequest, output: ListGroupsResponse, errors: [InternalServerException, ValidationException] }));
/**
 ...
 */
export const createGroup = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateGroupRequest, output: CreateGroupResponse, errors: [ConflictException, InternalServerException, ServiceQuotaExceededException, ValidationException] }));
/**
 ...
 */
export const createCanary = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateCanaryRequest, output: CreateCanaryResponse, errors: [InternalServerException, RequestEntityTooLargeException, ValidationException] }));
/**
 ...
 * Limiting a user to viewing specific canaries.
 */
export const describeCanaries = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeCanariesRequest, output: DescribeCanariesResponse, errors: [InternalServerException, ValidationException] }));
/**
 ...
 */
export const tagResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: TagResourceRequest, output: TagResourceResponse, errors: [BadRequestException, ConflictException, InternalFailureException, NotFoundException, TooManyRequestsException] }));
/**
 * Removes one or more tags from the specified resource.
 */
export const untagResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UntagResourceRequest, output: UntagResourceResponse, errors: [BadRequestException, ConflictException, InternalFailureException, NotFoundException, TooManyRequestsException] }));
/**
 * Displays the tags associated with a canary or group.
 */
export const listTagsForResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListTagsForResourceRequest, output: ListTagsForResourceResponse, errors: [BadRequestException, ConflictException, InternalFailureException, NotFoundException, TooManyRequestsException] }));
