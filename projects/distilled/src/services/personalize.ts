...
export class CreateDatasetRequest extends S.Class<CreateDatasetRequest>("CreateDatasetRequest")({name: S.String, schemaArn: S.String, datasetGroupArn: S.String, datasetType: S.String, tags: S.optional(Tags)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class CreateDatasetGroupRequest extends S.Class<CreateDatasetGroupRequest>("CreateDatasetGroupRequest")({name: S.String, roleArn: S.optional(S.String), kmsKeyArn: S.optional(S.String), domain: S.optional(S.String), tags: S.optional(Tags)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class CreateEventTrackerRequest extends S.Class<CreateEventTrackerRequest>("CreateEventTrackerRequest")({name: S.String, datasetGroupArn: S.String, tags: S.optional(Tags)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class CreateFilterRequest extends S.Class<CreateFilterRequest>("CreateFilterRequest")({name: S.String, datasetGroupArn: S.String, filterExpression: S.String, tags: S.optional(Tags)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class CreateSchemaRequest extends S.Class<CreateSchemaRequest>("CreateSchemaRequest")({name: S.String, schema: S.String, domain: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class CreateSolutionVersionRequest extends S.Class<CreateSolutionVersionRequest>("CreateSolutionVersionRequest")({name: S.optional(S.String), solutionArn: S.String, trainingMode: S.optional(S.String), tags: S.optional(Tags)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteCampaignRequest extends S.Class<DeleteCampaignRequest>("DeleteCampaignRequest")({campaignArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteCampaignResponse extends S.Class<DeleteCampaignResponse>("DeleteCampaignResponse")({}) {}
export class DeleteDatasetRequest extends S.Class<DeleteDatasetRequest>("DeleteDatasetRequest")({datasetArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteDatasetResponse extends S.Class<DeleteDatasetResponse>("DeleteDatasetResponse")({}) {}
export class DeleteDatasetGroupRequest extends S.Class<DeleteDatasetGroupRequest>("DeleteDatasetGroupRequest")({datasetGroupArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteDatasetGroupResponse extends S.Class<DeleteDatasetGroupResponse>("DeleteDatasetGroupResponse")({}) {}
export class DeleteEventTrackerRequest extends S.Class<DeleteEventTrackerRequest>("DeleteEventTrackerRequest")({eventTrackerArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteEventTrackerResponse extends S.Class<DeleteEventTrackerResponse>("DeleteEventTrackerResponse")({}) {}
export class DeleteFilterRequest extends S.Class<DeleteFilterRequest>("DeleteFilterRequest")({filterArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteFilterResponse extends S.Class<DeleteFilterResponse>("DeleteFilterResponse")({}) {}
export class DeleteMetricAttributionRequest extends S.Class<DeleteMetricAttributionRequest>("DeleteMetricAttributionRequest")({metricAttributionArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteMetricAttributionResponse extends S.Class<DeleteMetricAttributionResponse>("DeleteMetricAttributionResponse")({}) {}
export class DeleteRecommenderRequest extends S.Class<DeleteRecommenderRequest>("DeleteRecommenderRequest")({recommenderArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteRecommenderResponse extends S.Class<DeleteRecommenderResponse>("DeleteRecommenderResponse")({}) {}
export class DeleteSchemaRequest extends S.Class<DeleteSchemaRequest>("DeleteSchemaRequest")({schemaArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteSchemaResponse extends S.Class<DeleteSchemaResponse>("DeleteSchemaResponse")({}) {}
export class DeleteSolutionRequest extends S.Class<DeleteSolutionRequest>("DeleteSolutionRequest")({solutionArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteSolutionResponse extends S.Class<DeleteSolutionResponse>("DeleteSolutionResponse")({}) {}
export class DescribeAlgorithmRequest extends S.Class<DescribeAlgorithmRequest>("DescribeAlgorithmRequest")({algorithmArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeBatchInferenceJobRequest extends S.Class<DescribeBatchInferenceJobRequest>("DescribeBatchInferenceJobRequest")({batchInferenceJobArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeBatchSegmentJobRequest extends S.Class<DescribeBatchSegmentJobRequest>("DescribeBatchSegmentJobRequest")({batchSegmentJobArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeCampaignRequest extends S.Class<DescribeCampaignRequest>("DescribeCampaignRequest")({campaignArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeDataDeletionJobRequest extends S.Class<DescribeDataDeletionJobRequest>("DescribeDataDeletionJobRequest")({dataDeletionJobArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeDatasetRequest extends S.Class<DescribeDatasetRequest>("DescribeDatasetRequest")({datasetArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeDatasetExportJobRequest extends S.Class<DescribeDatasetExportJobRequest>("DescribeDatasetExportJobRequest")({datasetExportJobArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeDatasetGroupRequest extends S.Class<DescribeDatasetGroupRequest>("DescribeDatasetGroupRequest")({datasetGroupArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeDatasetImportJobRequest extends S.Class<DescribeDatasetImportJobRequest>("DescribeDatasetImportJobRequest")({datasetImportJobArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeEventTrackerRequest extends S.Class<DescribeEventTrackerRequest>("DescribeEventTrackerRequest")({eventTrackerArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeFeatureTransformationRequest extends S.Class<DescribeFeatureTransformationRequest>("DescribeFeatureTransformationRequest")({featureTransformationArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeFilterRequest extends S.Class<DescribeFilterRequest>("DescribeFilterRequest")({filterArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeMetricAttributionRequest extends S.Class<DescribeMetricAttributionRequest>("DescribeMetricAttributionRequest")({metricAttributionArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeRecipeRequest extends S.Class<DescribeRecipeRequest>("DescribeRecipeRequest")({recipeArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeRecommenderRequest extends S.Class<DescribeRecommenderRequest>("DescribeRecommenderRequest")({recommenderArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeSchemaRequest extends S.Class<DescribeSchemaRequest>("DescribeSchemaRequest")({schemaArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeSolutionRequest extends S.Class<DescribeSolutionRequest>("DescribeSolutionRequest")({solutionArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeSolutionVersionRequest extends S.Class<DescribeSolutionVersionRequest>("DescribeSolutionVersionRequest")({solutionVersionArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetSolutionMetricsRequest extends S.Class<GetSolutionMetricsRequest>("GetSolutionMetricsRequest")({solutionVersionArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListBatchInferenceJobsRequest extends S.Class<ListBatchInferenceJobsRequest>("ListBatchInferenceJobsRequest")({solutionVersionArn: S.optional(S.String), nextToken: S.optional(S.String), maxResults: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListBatchSegmentJobsRequest extends S.Class<ListBatchSegmentJobsRequest>("ListBatchSegmentJobsRequest")({solutionVersionArn: S.optional(S.String), nextToken: S.optional(S.String), maxResults: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListCampaignsRequest extends S.Class<ListCampaignsRequest>("ListCampaignsRequest")({solutionArn: S.optional(S.String), nextToken: S.optional(S.String), maxResults: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListDataDeletionJobsRequest extends S.Class<ListDataDeletionJobsRequest>("ListDataDeletionJobsRequest")({datasetGroupArn: S.optional(S.String), nextToken: S.optional(S.String), maxResults: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListDatasetExportJobsRequest extends S.Class<ListDatasetExportJobsRequest>("ListDatasetExportJobsRequest")({datasetArn: S.optional(S.String), nextToken: S.optional(S.String), maxResults: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListDatasetGroupsRequest extends S.Class<ListDatasetGroupsRequest>("ListDatasetGroupsRequest")({nextToken: S.optional(S.String), maxResults: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListDatasetImportJobsRequest extends S.Class<ListDatasetImportJobsRequest>("ListDatasetImportJobsRequest")({datasetArn: S.optional(S.String), nextToken: S.optional(S.String), maxResults: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListDatasetsRequest extends S.Class<ListDatasetsRequest>("ListDatasetsRequest")({datasetGroupArn: S.optional(S.String), nextToken: S.optional(S.String), maxResults: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListEventTrackersRequest extends S.Class<ListEventTrackersRequest>("ListEventTrackersRequest")({datasetGroupArn: S.optional(S.String), nextToken: S.optional(S.String), maxResults: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListFiltersRequest extends S.Class<ListFiltersRequest>("ListFiltersRequest")({datasetGroupArn: S.optional(S.String), nextToken: S.optional(S.String), maxResults: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListMetricAttributionMetricsRequest extends S.Class<ListMetricAttributionMetricsRequest>("ListMetricAttributionMetricsRequest")({metricAttributionArn: S.optional(S.String), nextToken: S.optional(S.String), maxResults: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListMetricAttributionsRequest extends S.Class<ListMetricAttributionsRequest>("ListMetricAttributionsRequest")({datasetGroupArn: S.optional(S.String), nextToken: S.optional(S.String), maxResults: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListRecipesRequest extends S.Class<ListRecipesRequest>("ListRecipesRequest")({recipeProvider: S.optional(S.String), nextToken: S.optional(S.String), maxResults: S.optional(S.Number), domain: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListRecommendersRequest extends S.Class<ListRecommendersRequest>("ListRecommendersRequest")({datasetGroupArn: S.optional(S.String), nextToken: S.optional(S.String), maxResults: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListSchemasRequest extends S.Class<ListSchemasRequest>("ListSchemasRequest")({nextToken: S.optional(S.String), maxResults: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListSolutionsRequest extends S.Class<ListSolutionsRequest>("ListSolutionsRequest")({datasetGroupArn: S.optional(S.String), nextToken: S.optional(S.String), maxResults: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListSolutionVersionsRequest extends S.Class<ListSolutionVersionsRequest>("ListSolutionVersionsRequest")({solutionArn: S.optional(S.String), nextToken: S.optional(S.String), maxResults: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class StartRecommenderRequest extends S.Class<StartRecommenderRequest>("StartRecommenderRequest")({recommenderArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class StopRecommenderRequest extends S.Class<StopRecommenderRequest>("StopRecommenderRequest")({recommenderArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class StopSolutionVersionCreationRequest extends S.Class<StopSolutionVersionCreationRequest>("StopSolutionVersionCreationRequest")({solutionVersionArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class StopSolutionVersionCreationResponse extends S.Class<StopSolutionVersionCreationResponse>("StopSolutionVersionCreationResponse")({}) {}
export class TagResourceRequest extends S.Class<TagResourceRequest>("TagResourceRequest")({resourceArn: S.String, tags: Tags}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class TagResourceResponse extends S.Class<TagResourceResponse>("TagResourceResponse")({}) {}
export class UntagResourceRequest extends S.Class<UntagResourceRequest>("UntagResourceRequest")({resourceArn: S.String, tagKeys: TagKeys}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class UpdateCampaignRequest extends S.Class<UpdateCampaignRequest>("UpdateCampaignRequest")({campaignArn: S.String, solutionVersionArn: S.optional(S.String), minProvisionedTPS: S.optional(S.Number), campaignConfig: S.optional(CampaignConfig)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class UpdateDatasetRequest extends S.Class<UpdateDatasetRequest>("UpdateDatasetRequest")({datasetArn: S.String, schemaArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class UpdateRecommenderRequest extends S.Class<UpdateRecommenderRequest>("UpdateRecommenderRequest")({recommenderArn: S.String, recommenderConfig: RecommenderConfig}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class CreateCampaignRequest extends S.Class<CreateCampaignRequest>("CreateCampaignRequest")({name: S.String, solutionVersionArn: S.String, minProvisionedTPS: S.optional(S.Number), campaignConfig: S.optional(CampaignConfig), tags: S.optional(Tags)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class CreateDataDeletionJobRequest extends S.Class<CreateDataDeletionJobRequest>("CreateDataDeletionJobRequest")({jobName: S.String, datasetGroupArn: S.String, dataSource: DataSource, roleArn: S.String, tags: S.optional(Tags)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class CreateDatasetExportJobRequest extends S.Class<CreateDatasetExportJobRequest>("CreateDatasetExportJobRequest")({jobName: S.String, datasetArn: S.String, ingestionMode: S.optional(S.String), roleArn: S.String, jobOutput: DatasetExportJobOutput, tags: S.optional(Tags)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class CreateMetricAttributionRequest extends S.Class<CreateMetricAttributionRequest>("CreateMetricAttributionRequest")({name: S.String, datasetGroupArn: S.String, metrics: MetricAttributes, metricsOutputConfig: MetricAttributionOutput}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class UpdateSolutionRequest extends S.Class<UpdateSolutionRequest>("UpdateSolutionRequest")({solutionArn: S.String, performAutoTraining: S.optional(S.Boolean), performIncrementalUpdate: S.optional(S.Boolean), solutionUpdateConfig: S.optional(SolutionUpdateConfig)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class Filter extends S.Class<Filter>("Filter")({name: S.optional(S.String), filterArn: S.optional(S.String), creationDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), lastUpdatedDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), datasetGroupArn: S.optional(S.String), failureReason: S.optional(S.String), filterExpression: S.optional(S.String), status: S.optional(S.String)}) {}
...
export class Recipe extends S.Class<Recipe>("Recipe")({name: S.optional(S.String), recipeArn: S.optional(S.String), algorithmArn: S.optional(S.String), featureTransformationArn: S.optional(S.String), status: S.optional(S.String), description: S.optional(S.String), creationDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), recipeType: S.optional(S.String), lastUpdatedDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
export class DatasetSchema extends S.Class<DatasetSchema>("DatasetSchema")({name: S.optional(S.String), schemaArn: S.optional(S.String), schema: S.optional(S.String), creationDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), lastUpdatedDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), domain: S.optional(S.String)}) {}
...
export class DatasetSummary extends S.Class<DatasetSummary>("DatasetSummary")({name: S.optional(S.String), datasetArn: S.optional(S.String), datasetType: S.optional(S.String), status: S.optional(S.String), creationDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), lastUpdatedDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
export const Datasets = S.Array(DatasetSummary);
export class EventTrackerSummary extends S.Class<EventTrackerSummary>("EventTrackerSummary")({name: S.optional(S.String), eventTrackerArn: S.optional(S.String), status: S.optional(S.String), creationDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), lastUpdatedDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
export const EventTrackers = S.Array(EventTrackerSummary);
export class FilterSummary extends S.Class<FilterSummary>("FilterSummary")({name: S.optional(S.String), filterArn: S.optional(S.String), creationDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), lastUpdatedDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), datasetGroupArn: S.optional(S.String), failureReason: S.optional(S.String), status: S.optional(S.String)}) {}
...
export class DatasetSchemaSummary extends S.Class<DatasetSchemaSummary>("DatasetSchemaSummary")({name: S.optional(S.String), schemaArn: S.optional(S.String), creationDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), lastUpdatedDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), domain: S.optional(S.String)}) {}
export const Schemas = S.Array(DatasetSchemaSummary);
export class SolutionSummary extends S.Class<SolutionSummary>("SolutionSummary")({name: S.optional(S.String), solutionArn: S.optional(S.String), status: S.optional(S.String), creationDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), lastUpdatedDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), recipeArn: S.optional(S.String)}) {}
...
export class DatasetUpdateSummary extends S.Class<DatasetUpdateSummary>("DatasetUpdateSummary")({schemaArn: S.optional(S.String), status: S.optional(S.String), failureReason: S.optional(S.String), creationDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), lastUpdatedDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
export const FeaturizationParameters = S.Record({key: S.String, value: S.String});
export class RecommenderUpdateSummary extends S.Class<RecommenderUpdateSummary>("RecommenderUpdateSummary")({recommenderConfig: S.optional(RecommenderConfig), creationDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), lastUpdatedDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), status: S.optional(S.String), failureReason: S.optional(S.String)}) {}
...
export class Campaign extends S.Class<Campaign>("Campaign")({name: S.optional(S.String), campaignArn: S.optional(S.String), solutionVersionArn: S.optional(S.String), minProvisionedTPS: S.optional(S.Number), campaignConfig: S.optional(CampaignConfig), status: S.optional(S.String), failureReason: S.optional(S.String), creationDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), lastUpdatedDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), latestCampaignUpdate: S.optional(CampaignUpdateSummary)}) {}
export class Dataset extends S.Class<Dataset>("Dataset")({name: S.optional(S.String), datasetArn: S.optional(S.String), datasetGroupArn: S.optional(S.String), datasetType: S.optional(S.String), schemaArn: S.optional(S.String), status: S.optional(S.String), creationDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), lastUpdatedDateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), latestDatasetUpdate: S.optional(DatasetUpdateSummary), trackingId: S.optional(S.String)}) {}
...
export class CreateRecommenderRequest extends S.Class<CreateRecommenderRequest>("CreateRecommenderRequest")({name: S.String, datasetGroupArn: S.String, recipeArn: S.String, recommenderConfig: S.optional(RecommenderConfig), tags: S.optional(Tags)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
 ...
 */
export const listMetricAttributionMetrics = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListMetricAttributionMetricsRequest, output: ListMetricAttributionMetricsResponse, errors: [InvalidInputException, InvalidNextTokenException] }));
/**
 * Lists metric attributions.
 */
export const listMetricAttributions = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListMetricAttributionsRequest, output: ListMetricAttributionsResponse, errors: [InvalidInputException, InvalidNextTokenException] }));
/**
 ...
 */
export const listRecipes = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListRecipesRequest, output: ListRecipesResponse, errors: [InvalidInputException, InvalidNextTokenException] }));
/**
 ...
 */
export const listRecommenders = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListRecommendersRequest, output: ListRecommendersResponse, errors: [InvalidInputException, InvalidNextTokenException] }));
/**
 ...
 */
export const listSchemas = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListSchemasRequest, output: ListSchemasResponse, errors: [InvalidNextTokenException] }));
/**
 ...
 */
export const listSolutions = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListSolutionsRequest, output: ListSolutionsResponse, errors: [InvalidInputException, InvalidNextTokenException] }));
/**
 * Gets a list of the batch inference jobs that have been performed off of a solution
 * version.
 */
export const listBatchInferenceJobs = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListBatchInferenceJobsRequest, output: ListBatchInferenceJobsResponse, errors: [InvalidInputException, InvalidNextTokenException] }));
/**
 * Gets a list of the batch segment jobs that have been performed off of a solution
 * version that you specify.
 */
export const listBatchSegmentJobs = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListBatchSegmentJobsRequest, output: ListBatchSegmentJobsResponse, errors: [InvalidInputException, InvalidNextTokenException] }));
/**
 ...
 */
export const listCampaigns = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListCampaignsRequest, output: ListCampaignsResponse, errors: [InvalidInputException, InvalidNextTokenException] }));
/**
 ...
 */
export const listDataDeletionJobs = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListDataDeletionJobsRequest, output: ListDataDeletionJobsResponse, errors: [InvalidInputException, InvalidNextTokenException] }));
/**
 ...
 * CreateDataset.
 */
export const listDatasetExportJobs = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListDatasetExportJobsRequest, output: ListDatasetExportJobsResponse, errors: [InvalidInputException, InvalidNextTokenException] }));
/**
 ...
 */
export const listDatasetGroups = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListDatasetGroupsRequest, output: ListDatasetGroupsResponse, errors: [InvalidNextTokenException] }));
/**
 ...
 * CreateDataset.
 */
export const listDatasetImportJobs = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListDatasetImportJobsRequest, output: ListDatasetImportJobsResponse, errors: [InvalidInputException, InvalidNextTokenException] }));
/**
 ...
 */
export const listDatasets = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListDatasetsRequest, output: ListDatasetsResponse, errors: [InvalidInputException, InvalidNextTokenException] }));
/**
 ...
 */
export const listEventTrackers = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListEventTrackersRequest, output: ListEventTrackersResponse, errors: [InvalidInputException, InvalidNextTokenException] }));
/**
 * Lists all filters that belong to a given dataset group.
 */
export const listFilters = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListFiltersRequest, output: ListFiltersResponse, errors: [InvalidInputException, InvalidNextTokenException] }));
/**
 ...
 * - DeleteSchema
 */
export const createSchema = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateSchemaRequest, output: CreateSchemaResponse, errors: [InvalidInputException, LimitExceededException, ResourceAlreadyExistsException] }));
/**
 ...
 */
export const deleteCampaign = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteCampaignRequest, output: DeleteCampaignResponse, errors: [InvalidInputException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 * For more information on campaigns, see CreateCampaign.
 */
export const describeCampaign = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeCampaignRequest, output: DescribeCampaignResponse, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 * Describes the given dataset. For more information on datasets, see
 * CreateDataset.
 */
export const describeDataset = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeDatasetRequest, output: DescribeDatasetResponse, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 * Describes the given feature transformation.
 */
export const describeFeatureTransformation = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeFeatureTransformationRequest, output: DescribeFeatureTransformationResponse, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 ...
 * For more information on recommenders, see CreateRecommender.
 */
export const describeRecommender = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeRecommenderRequest, output: DescribeRecommenderResponse, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 * Describes a solution.
 * For more information on solutions, see CreateSolution.
 */
export const describeSolution = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeSolutionRequest, output: DescribeSolutionResponse, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 * Describes a specific version of a solution. For more information on solutions, see CreateSolution
 */
export const describeSolutionVersion = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeSolutionVersionRequest, output: DescribeSolutionVersionResponse, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 * Gets the properties of a batch inference job including name, Amazon Resource Name (ARN),
 * status, input and output configurations, and the ARN of the solution version used to generate
 * the recommendations.
 */
export const describeBatchInferenceJob = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeBatchInferenceJobRequest, output: DescribeBatchInferenceJobResponse, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 * Gets the properties of a batch segment job including name, Amazon Resource Name (ARN),
 * status, input and output configurations, and the ARN of the solution version used to generate
 * segments.
 */
export const describeBatchSegmentJob = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeBatchSegmentJobRequest, output: DescribeBatchSegmentJobResponse, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 * Describes the data deletion job created by CreateDataDeletionJob, including the job status.
 */
export const describeDataDeletionJob = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeDataDeletionJobRequest, output: DescribeDataDeletionJobResponse, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 * Describes the dataset export job created by CreateDatasetExportJob, including the export job status.
 */
export const describeDatasetExportJob = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeDatasetExportJobRequest, output: DescribeDatasetExportJobResponse, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 * Describes the given dataset group. For more information on dataset
 * groups, see CreateDatasetGroup.
 */
export const describeDatasetGroup = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeDatasetGroupRequest, output: DescribeDatasetGroupResponse, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 * Describes the dataset import job created by CreateDatasetImportJob, including the import job status.
 */
export const describeDatasetImportJob = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeDatasetImportJobRequest, output: DescribeDatasetImportJobResponse, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 ...
 */
export const describeEventTracker = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeEventTrackerRequest, output: DescribeEventTrackerResponse, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 * Describes a filter's properties.
 */
export const describeFilter = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeFilterRequest, output: DescribeFilterResponse, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 * Describes a metric attribution.
 */
export const describeMetricAttribution = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeMetricAttributionRequest, output: DescribeMetricAttributionResponse, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 * Describes a recipe.
 * 
 ...
 */
export const describeRecipe = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeRecipeRequest, output: DescribeRecipeResponse, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 * Describes a schema. For more information on schemas, see
 * CreateSchema.
 */
export const describeSchema = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeSchemaRequest, output: DescribeSchemaResponse, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 * Gets the metrics for the specified solution version.
 */
export const getSolutionMetrics = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetSolutionMetricsRequest, output: GetSolutionMetricsResponse, errors: [InvalidInputException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 */
export const listSolutionVersions = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListSolutionVersionsRequest, output: ListSolutionVersionsResponse, errors: [InvalidInputException, InvalidNextTokenException, ResourceNotFoundException] }));
/**
 * Updates a metric attribution.
 */
export const updateMetricAttribution = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateMetricAttributionRequest, output: UpdateMetricAttributionResponse, errors: [InvalidInputException, ResourceAlreadyExistsException, ResourceInUseException, ResourceNotFoundException] }));
/**
 * Get a list of tags attached to a resource.
 */
export const listTagsForResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListTagsForResourceRequest, output: ListTagsForResourceResponse, errors: [InvalidInputException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 */
export const startRecommender = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StartRecommenderRequest, output: StartRecommenderResponse, errors: [InvalidInputException, ResourceInUseException, ResourceNotFoundException] }));
/**
 * Stops a recommender that is ACTIVE. Stopping a recommender halts billing and automatic retraining for the recommender.
 */
export const stopRecommender = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StopRecommenderRequest, output: StopRecommenderResponse, errors: [InvalidInputException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 */
export const updateCampaign = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateCampaignRequest, output: UpdateCampaignResponse, errors: [InvalidInputException, ResourceInUseException, ResourceNotFoundException] }));
/**
 * Update a dataset to replace its schema with a new or existing one. For more information, see Replacing a dataset's schema.
 */
export const updateDataset = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateDatasetRequest, output: UpdateDatasetResponse, errors: [InvalidInputException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 * operation.
 */
export const updateRecommender = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateRecommenderRequest, output: UpdateRecommenderResponse, errors: [InvalidInputException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 */
export const deleteDataset = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteDatasetRequest, output: DeleteDatasetResponse, errors: [InvalidInputException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 */
export const deleteDatasetGroup = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteDatasetGroupRequest, output: DeleteDatasetGroupResponse, errors: [InvalidInputException, ResourceInUseException, ResourceNotFoundException] }));
/**
 * Deletes the event tracker. Does not delete the dataset from
 * the dataset group. For more
 * information on event trackers, see CreateEventTracker.
 */
export const deleteEventTracker = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteEventTrackerRequest, output: DeleteEventTrackerResponse, errors: [InvalidInputException, ResourceInUseException, ResourceNotFoundException] }));
/**
 * Deletes a filter.
 */
export const deleteFilter = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteFilterRequest, output: DeleteFilterResponse, errors: [InvalidInputException, ResourceInUseException, ResourceNotFoundException] }));
/**
 * Deletes a metric attribution.
 */
export const deleteMetricAttribution = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteMetricAttributionRequest, output: DeleteMetricAttributionResponse, errors: [InvalidInputException, ResourceInUseException, ResourceNotFoundException] }));
/**
 * Deactivates and removes a recommender. A deleted recommender can no longer be specified in a GetRecommendations
 * request.
 */
export const deleteRecommender = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteRecommenderRequest, output: DeleteRecommenderResponse, errors: [InvalidInputException, ResourceInUseException, ResourceNotFoundException] }));
/**
 * Deletes a schema. Before deleting a schema, you must delete all
 * datasets referencing the schema. For more information on schemas, see
 * CreateSchema.
 */
export const deleteSchema = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteSchemaRequest, output: DeleteSchemaResponse, errors: [InvalidInputException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 * For more information on solutions, see CreateSolution.
 */
export const deleteSolution = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteSolutionRequest, output: DeleteSolutionResponse, errors: [InvalidInputException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 */
export const stopSolutionVersionCreation = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StopSolutionVersionCreationRequest, output: StopSolutionVersionCreationResponse, errors: [InvalidInputException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 */
export const createMetricAttribution = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateMetricAttributionRequest, output: CreateMetricAttributionResponse, errors: [InvalidInputException, LimitExceededException, ResourceAlreadyExistsException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 */
export const updateSolution = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateSolutionRequest, output: UpdateSolutionResponse, errors: [InvalidInputException, LimitExceededException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 * - DeleteDatasetGroup
 */
export const createDatasetGroup = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateDatasetGroupRequest, output: CreateDatasetGroupResponse, errors: [InvalidInputException, LimitExceededException, ResourceAlreadyExistsException, TooManyTagsException] }));
/**
 * Add a list of tags to a resource.
 */
export const tagResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: TagResourceRequest, output: TagResourceResponse, errors: [InvalidInputException, LimitExceededException, ResourceInUseException, ResourceNotFoundException, TooManyTagsException] }));
/**
 ...
 * - DeleteDataset
 */
export const createDataset = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateDatasetRequest, output: CreateDatasetResponse, errors: [InvalidInputException, LimitExceededException, ResourceAlreadyExistsException, ResourceInUseException, ResourceNotFoundException, TooManyTagsException] }));
/**
 ...
 */
export const createDatasetImportJob = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateDatasetImportJobRequest, output: CreateDatasetImportJobResponse, errors: [InvalidInputException, LimitExceededException, ResourceAlreadyExistsException, ResourceInUseException, ResourceNotFoundException, TooManyTagsException] }));
/**
 ...
 * - DeleteEventTracker
 */
export const createEventTracker = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateEventTrackerRequest, output: CreateEventTrackerResponse, errors: [InvalidInputException, LimitExceededException, ResourceAlreadyExistsException, ResourceInUseException, ResourceNotFoundException, TooManyTagsException] }));
/**
 * Creates a recommendation filter. For more information, see Filtering recommendations and user segments.
 */
export const createFilter = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateFilterRequest, output: CreateFilterResponse, errors: [InvalidInputException, LimitExceededException, ResourceAlreadyExistsException, ResourceNotFoundException, TooManyTagsException] }));
/**
 ...
 * - DeleteSolution
 */
export const createSolutionVersion = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateSolutionVersionRequest, output: CreateSolutionVersionResponse, errors: [InvalidInputException, LimitExceededException, ResourceAlreadyExistsException, ResourceInUseException, ResourceNotFoundException, TooManyTagsException] }));
/**
 ...
 */
export const createBatchSegmentJob = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateBatchSegmentJobRequest, output: CreateBatchSegmentJobResponse, errors: [InvalidInputException, LimitExceededException, ResourceAlreadyExistsException, ResourceInUseException, ResourceNotFoundException, TooManyTagsException] }));
/**
 ...
 * - DeleteCampaign
 */
export const createCampaign = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateCampaignRequest, output: CreateCampaignResponse, errors: [InvalidInputException, LimitExceededException, ResourceAlreadyExistsException, ResourceInUseException, ResourceNotFoundException, TooManyTagsException] }));
/**
 ...
 */
export const createDataDeletionJob = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateDataDeletionJobRequest, output: CreateDataDeletionJobResponse, errors: [InvalidInputException, LimitExceededException, ResourceAlreadyExistsException, ResourceInUseException, ResourceNotFoundException, TooManyTagsException] }));
/**
 ...
 * failed.
 */
export const createDatasetExportJob = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateDatasetExportJobRequest, output: CreateDatasetExportJobResponse, errors: [InvalidInputException, LimitExceededException, ResourceAlreadyExistsException, ResourceInUseException, ResourceNotFoundException, TooManyTagsException] }));
/**
 ...
 */
export const createBatchInferenceJob = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateBatchInferenceJobRequest, output: CreateBatchInferenceJobResponse, errors: [InvalidInputException, LimitExceededException, ResourceAlreadyExistsException, ResourceInUseException, ResourceNotFoundException, TooManyTagsException] }));
/**
 ...
 * - DeleteRecommender
 */
export const createRecommender = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateRecommenderRequest, output: CreateRecommenderResponse, errors: [InvalidInputException, LimitExceededException, ResourceAlreadyExistsException, ResourceInUseException, ResourceNotFoundException, TooManyTagsException] }));
/**
 * Describes the given algorithm.
 */
export const describeAlgorithm = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeAlgorithmRequest, output: DescribeAlgorithmResponse, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 ...
 */
export const untagResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UntagResourceRequest, output: UntagResourceResponse, errors: [InvalidInputException, ResourceInUseException, ResourceNotFoundException, TooManyTagKeysException] }));
/**
 ...
 * - DescribeSolutionVersion
 */
export const createSolution = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateSolutionRequest, output: CreateSolutionResponse, errors: [InvalidInputException, LimitExceededException, ResourceAlreadyExistsException, ResourceInUseException, ResourceNotFoundException, TooManyTagsException] }));
