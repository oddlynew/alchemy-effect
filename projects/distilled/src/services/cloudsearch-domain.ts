...
const svc = T.AwsApiService({ sdkId: "CloudSearch Domain", serviceShapeName: "AmazonCloudSearch2013" });
...
//# Schemas
export class SearchRequest extends S.Class<SearchRequest>("SearchRequest")({cursor: S.optional(S.String).pipe(T.HttpQuery("cursor")), expr: S.optional(S.String).pipe(T.HttpQuery("expr")), facet: S.optional(S.String).pipe(T.HttpQuery("facet")), filterQuery: S.optional(S.String).pipe(T.HttpQuery("fq")), highlight: S.optional(S.String).pipe(T.HttpQuery("highlight")), partial: S.optional(S.Boolean).pipe(T.HttpQuery("partial")), query: S.String.pipe(T.HttpQuery("q")), queryOptions: S.optional(S.String).pipe(T.HttpQuery("q.options")), queryParser: S.optional(S.String).pipe(T.HttpQuery("q.parser")), return: S.optional(S.String).pipe(T.HttpQuery("return")), size: S.optional(S.Number).pipe(T.HttpQuery("size")), sort: S.optional(S.String).pipe(T.HttpQuery("sort")), start: S.optional(S.Number).pipe(T.HttpQuery("start")), stats: S.optional(S.String).pipe(T.HttpQuery("stats"))}, T.all(ns, T.Http({ method: "GET", uri: "/2013-01-01/search?format=sdk&pretty=true" }), svc, auth, proto, ver, rules)) {}
export class SuggestRequest extends S.Class<SuggestRequest>("SuggestRequest")({query: S.String.pipe(T.HttpQuery("q")), suggester: S.String.pipe(T.HttpQuery("suggester")), size: S.optional(S.Number).pipe(T.HttpQuery("size"))}, T.all(ns, T.Http({ method: "GET", uri: "/2013-01-01/suggest?format=sdk&pretty=true" }), svc, auth, proto, ver, rules)) {}
export class UploadDocumentsRequest extends S.Class<UploadDocumentsRequest>("UploadDocumentsRequest")({documents: T.StreamingInput.pipe(T.HttpPayload()), contentType: S.String.pipe(T.HttpHeader("Content-Type"))}, T.all(ns, T.Http({ method: "POST", uri: "/2013-01-01/documents/batch?format=sdk" }), svc, auth, proto, ver, rules)) {}
...
export class UploadDocumentsResponse extends S.Class<UploadDocumentsResponse>("UploadDocumentsResponse")({status: S.optional(S.String), adds: S.optional(S.Number), deletes: S.optional(S.Number), warnings: S.optional(DocumentServiceWarnings)}, ns) {}
...
export class SuggestResponse extends S.Class<SuggestResponse>("SuggestResponse")({status: S.optional(SuggestStatus), suggest: S.optional(SuggestModel)}, ns) {}
...
export class SearchResponse extends S.Class<SearchResponse>("SearchResponse")({status: S.optional(SearchStatus), hits: S.optional(Hits), facets: S.optional(Facets), stats: S.optional(Stats)}, ns) {}
...
export class SearchException extends S.TaggedError<SearchException>()("SearchException", {message: S.optional(S.String)}) {}
 ...
 */
export const uploadDocuments = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UploadDocumentsRequest, output: UploadDocumentsResponse, errors: [DocumentServiceException] }));
/**
 ...
 */
export const suggest = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: SuggestRequest, output: SuggestResponse, errors: [SearchException] }));
/**
 ...
 */
export const search = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: SearchRequest, output: SearchResponse, errors: [SearchException] }));
