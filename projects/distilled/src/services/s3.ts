...
export class AccessControlPolicy extends S.Class<AccessControlPolicy>("AccessControlPolicy")({Grants: S.optional(Grants).pipe(T.XmlName("AccessControlList")), Owner: S.optional(Owner)}) {}
export class PutObjectAclRequest extends S.Class<PutObjectAclRequest>("PutObjectAclRequest")({ACL: S.optional(S.String).pipe(T.HttpHeader("x-amz-acl")), AccessControlPolicy: S.optional(AccessControlPolicy).pipe(T.HttpPayload(), T.XmlName("AccessControlPolicy")), Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket")), ContentMD5: S.optional(S.String).pipe(T.HttpHeader("Content-MD5")), ChecksumAlgorithm: S.optional(S.String).pipe(T.HttpHeader("x-amz-sdk-checksum-algorithm")), GrantFullControl: S.optional(S.String).pipe(T.HttpHeader("x-amz-grant-full-control")), GrantRead: S.optional(S.String).pipe(T.HttpHeader("x-amz-grant-read")), GrantReadACP: S.optional(S.String).pipe(T.HttpHeader("x-amz-grant-read-acp")), GrantWrite: S.optional(S.String).pipe(T.HttpHeader("x-amz-grant-write")), GrantWriteACP: S.optional(S.String).pipe(T.HttpHeader("x-amz-grant-write-acp")), Key: S.String.pipe(T.HttpLabel("Key"), T.ContextParam("Key")), RequestPayer: S.optional(S.String).pipe(T.HttpHeader("x-amz-request-payer")), VersionId: S.optional(S.String).pipe(T.HttpQuery("versionId")), ExpectedBucketOwner: S.optional(S.String).pipe(T.HttpHeader("x-amz-expected-bucket-owner"))}, T.all(ns, T.Http({ method: "PUT", uri: "/{Bucket}/{Key+}?acl" }), svc, auth, proto, ver, rules, T.AwsProtocolsHttpChecksum({ requestAlgorithmMember: "ChecksumAlgorithm", requestChecksumRequired: true }))) {}
...
export class PutObjectTaggingRequest extends S.Class<PutObjectTaggingRequest>("PutObjectTaggingRequest")({Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket")), Key: S.String.pipe(T.HttpLabel("Key")), VersionId: S.optional(S.String).pipe(T.HttpQuery("versionId")), ContentMD5: S.optional(S.String).pipe(T.HttpHeader("Content-MD5")), ChecksumAlgorithm: S.optional(S.String).pipe(T.HttpHeader("x-amz-sdk-checksum-algorithm")), Tagging: Tagging.pipe(T.HttpPayload(), T.XmlName("Tagging")), ExpectedBucketOwner: S.optional(S.String).pipe(T.HttpHeader("x-amz-expected-bucket-owner")), RequestPayer: S.optional(S.String).pipe(T.HttpHeader("x-amz-request-payer"))}, T.all(ns, T.Http({ method: "PUT", uri: "/{Bucket}/{Key+}?tagging" }), svc, auth, proto, ver, rules, T.AwsProtocolsHttpChecksum({ requestAlgorithmMember: "ChecksumAlgorithm", requestChecksumRequired: true }))) {}
export class RenameObjectRequest extends S.Class<RenameObjectRequest>("RenameObjectRequest")({Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket")), Key: S.String.pipe(T.HttpLabel("Key"), T.ContextParam("Key")), RenameSource: S.String.pipe(T.HttpHeader("x-amz-rename-source")), DestinationIfMatch: S.optional(S.String).pipe(T.HttpHeader("If-Match")), DestinationIfNoneMatch: S.optional(S.String).pipe(T.HttpHeader("If-None-Match")), DestinationIfModifiedSince: S.optional(S.Date.pipe(T.TimestampFormat("http-date"))).pipe(T.HttpHeader("If-Modified-Since")), DestinationIfUnmodifiedSince: S.optional(S.Date.pipe(T.TimestampFormat("http-date"))).pipe(T.HttpHeader("If-Unmodified-Since")), SourceIfMatch: S.optional(S.String).pipe(T.HttpHeader("x-amz-rename-source-if-match")), SourceIfNoneMatch: S.optional(S.String).pipe(T.HttpHeader("x-amz-rename-source-if-none-match")), SourceIfModifiedSince: S.optional(S.Date.pipe(T.TimestampFormat("http-date"))).pipe(T.HttpHeader("x-amz-rename-source-if-modified-since")), SourceIfUnmodifiedSince: S.optional(S.Date.pipe(T.TimestampFormat("http-date"))).pipe(T.HttpHeader("x-amz-rename-source-if-unmodified-since")), ClientToken: S.optional(S.String).pipe(T.HttpHeader("x-amz-client-token"))}, T.all(ns, T.Http({ method: "PUT", uri: "/{Bucket}/{Key+}?renameObject" }), svc, auth, proto, ver, rules)) {}
export class RenameObjectOutput extends S.Class<RenameObjectOutput>("RenameObjectOutput")({}, ns) {}
export class UploadPartRequest extends S.Class<UploadPartRequest>("UploadPartRequest")({Body: S.optional(T.StreamingInput).pipe(T.HttpPayload()), Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket")), ContentLength: S.optional(S.Number).pipe(T.HttpHeader("Content-Length")), ContentMD5: S.optional(S.String).pipe(T.HttpHeader("Content-MD5")), ChecksumAlgorithm: S.optional(S.String).pipe(T.HttpHeader("x-amz-sdk-checksum-algorithm")), ChecksumCRC32: S.optional(S.String).pipe(T.HttpHeader("x-amz-checksum-crc32")), ChecksumCRC32C: S.optional(S.String).pipe(T.HttpHeader("x-amz-checksum-crc32c")), ChecksumCRC64NVME: S.optional(S.String).pipe(T.HttpHeader("x-amz-checksum-crc64nvme")), ChecksumSHA1: S.optional(S.String).pipe(T.HttpHeader("x-amz-checksum-sha1")), ChecksumSHA256: S.optional(S.String).pipe(T.HttpHeader("x-amz-checksum-sha256")), Key: S.String.pipe(T.HttpLabel("Key"), T.ContextParam("Key")), PartNumber: S.Number.pipe(T.HttpQuery("partNumber")), UploadId: S.String.pipe(T.HttpQuery("uploadId")), SSECustomerAlgorithm: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-customer-algorithm")), SSECustomerKey: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-customer-key")), SSECustomerKeyMD5: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-customer-key-MD5")), RequestPayer: S.optional(S.String).pipe(T.HttpHeader("x-amz-request-payer")), ExpectedBucketOwner: S.optional(S.String).pipe(T.HttpHeader("x-amz-expected-bucket-owner"))}, T.all(ns, T.Http({ method: "PUT", uri: "/{Bucket}/{Key+}?x-id=UploadPart" }), svc, auth, proto, ver, rules, T.AwsProtocolsHttpChecksum({ requestAlgorithmMember: "ChecksumAlgorithm" }))) {}
export class UploadPartCopyRequest extends S.Class<UploadPartCopyRequest>("UploadPartCopyRequest")({Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket")), CopySource: S.String.pipe(T.HttpHeader("x-amz-copy-source")), CopySourceIfMatch: S.optional(S.String).pipe(T.HttpHeader("x-amz-copy-source-if-match")), CopySourceIfModifiedSince: S.optional(S.Date.pipe(T.TimestampFormat("http-date"))).pipe(T.HttpHeader("x-amz-copy-source-if-modified-since")), CopySourceIfNoneMatch: S.optional(S.String).pipe(T.HttpHeader("x-amz-copy-source-if-none-match")), CopySourceIfUnmodifiedSince: S.optional(S.Date.pipe(T.TimestampFormat("http-date"))).pipe(T.HttpHeader("x-amz-copy-source-if-unmodified-since")), CopySourceRange: S.optional(S.String).pipe(T.HttpHeader("x-amz-copy-source-range")), Key: S.String.pipe(T.HttpLabel("Key")), PartNumber: S.Number.pipe(T.HttpQuery("partNumber")), UploadId: S.String.pipe(T.HttpQuery("uploadId")), SSECustomerAlgorithm: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-customer-algorithm")), SSECustomerKey: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-customer-key")), SSECustomerKeyMD5: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-customer-key-MD5")), CopySourceSSECustomerAlgorithm: S.optional(S.String).pipe(T.HttpHeader("x-amz-copy-source-server-side-encryption-customer-algorithm")), CopySourceSSECustomerKey: S.optional(S.String).pipe(T.HttpHeader("x-amz-copy-source-server-side-encryption-customer-key")), CopySourceSSECustomerKeyMD5: S.optional(S.String).pipe(T.HttpHeader("x-amz-copy-source-server-side-encryption-customer-key-MD5")), RequestPayer: S.optional(S.String).pipe(T.HttpHeader("x-amz-request-payer")), ExpectedBucketOwner: S.optional(S.String).pipe(T.HttpHeader("x-amz-expected-bucket-owner")), ExpectedSourceBucketOwner: S.optional(S.String).pipe(T.HttpHeader("x-amz-source-expected-bucket-owner"))}, T.all(ns, T.Http({ method: "PUT", uri: "/{Bucket}/{Key+}?x-id=UploadPartCopy" }), svc, auth, proto, ver, rules, T.StaticContextParams({"DisableS3ExpressSessionAuth":{"value":true}}))) {}
export class WriteGetObjectResponseRequest extends S.Class<WriteGetObjectResponseRequest>("WriteGetObjectResponseRequest")({RequestRoute: S.String.pipe(T.HttpHeader("x-amz-request-route"), T.HostLabel()), RequestToken: S.String.pipe(T.HttpHeader("x-amz-request-token")), Body: S.optional(T.StreamingInput).pipe(T.HttpPayload()), StatusCode: S.optional(S.Number).pipe(T.HttpHeader("x-amz-fwd-status")), ErrorCode: S.optional(S.String).pipe(T.HttpHeader("x-amz-fwd-error-code")), ErrorMessage: S.optional(S.String).pipe(T.HttpHeader("x-amz-fwd-error-message")), AcceptRanges: S.optional(S.String).pipe(T.HttpHeader("x-amz-fwd-header-accept-ranges")), CacheControl: S.optional(S.String).pipe(T.HttpHeader("x-amz-fwd-header-Cache-Control")), ContentDisposition: S.optional(S.String).pipe(T.HttpHeader("x-amz-fwd-header-Content-Disposition")), ContentEncoding: S.optional(S.String).pipe(T.HttpHeader("x-amz-fwd-header-Content-Encoding")), ContentLanguage: S.optional(S.String).pipe(T.HttpHeader("x-amz-fwd-header-Content-Language")), ContentLength: S.optional(S.Number).pipe(T.HttpHeader("Content-Length")), ContentRange: S.optional(S.String).pipe(T.HttpHeader("x-amz-fwd-header-Content-Range")), ContentType: S.optional(S.String).pipe(T.HttpHeader("x-amz-fwd-header-Content-Type")), ChecksumCRC32: S.optional(S.String).pipe(T.HttpHeader("x-amz-fwd-header-x-amz-checksum-crc32")), ChecksumCRC32C: S.optional(S.String).pipe(T.HttpHeader("x-amz-fwd-header-x-amz-checksum-crc32c")), ChecksumCRC64NVME: S.optional(S.String).pipe(T.HttpHeader("x-amz-fwd-header-x-amz-checksum-crc64nvme")), ChecksumSHA1: S.optional(S.String).pipe(T.HttpHeader("x-amz-fwd-header-x-amz-checksum-sha1")), ChecksumSHA256: S.optional(S.String).pipe(T.HttpHeader("x-amz-fwd-header-x-amz-checksum-sha256")), DeleteMarker: S.optional(S.Boolean).pipe(T.HttpHeader("x-amz-fwd-header-x-amz-delete-marker")), ETag: S.optional(S.String).pipe(T.HttpHeader("x-amz-fwd-header-ETag")), Expires: S.optional(S.String).pipe(T.HttpHeader("x-amz-fwd-header-Expires")), Expiration: S.optional(S.String).pipe(T.HttpHeader("x-amz-fwd-header-x-amz-expiration")), LastModified: S.optional(S.Date.pipe(T.TimestampFormat("http-date"))).pipe(T.HttpHeader("x-amz-fwd-header-Last-Modified")), MissingMeta: S.optional(S.Number).pipe(T.HttpHeader("x-amz-fwd-header-x-amz-missing-meta")), Metadata: S.optional(Metadata).pipe(T.HttpPrefixHeaders("x-amz-meta-")), ObjectLockMode: S.optional(S.String).pipe(T.HttpHeader("x-amz-fwd-header-x-amz-object-lock-mode")), ObjectLockLegalHoldStatus: S.optional(S.String).pipe(T.HttpHeader("x-amz-fwd-header-x-amz-object-lock-legal-hold")), ObjectLockRetainUntilDate: S.optional(S.Date.pipe(T.TimestampFormat("http-date"))).pipe(T.HttpHeader("x-amz-fwd-header-x-amz-object-lock-retain-until-date")), PartsCount: S.optional(S.Number).pipe(T.HttpHeader("x-amz-fwd-header-x-amz-mp-parts-count")), ReplicationStatus: S.optional(S.String).pipe(T.HttpHeader("x-amz-fwd-header-x-amz-replication-status")), RequestCharged: S.optional(S.String).pipe(T.HttpHeader("x-amz-fwd-header-x-amz-request-charged")), Restore: S.optional(S.String).pipe(T.HttpHeader("x-amz-fwd-header-x-amz-restore")), ServerSideEncryption: S.optional(S.String).pipe(T.HttpHeader("x-amz-fwd-header-x-amz-server-side-encryption")), SSECustomerAlgorithm: S.optional(S.String).pipe(T.HttpHeader("x-amz-fwd-header-x-amz-server-side-encryption-customer-algorithm")), SSEKMSKeyId: S.optional(S.String).pipe(T.HttpHeader("x-amz-fwd-header-x-amz-server-side-encryption-aws-kms-key-id")), SSECustomerKeyMD5: S.optional(S.String).pipe(T.HttpHeader("x-amz-fwd-header-x-amz-server-side-encryption-customer-key-MD5")), StorageClass: S.optional(S.String).pipe(T.HttpHeader("x-amz-fwd-header-x-amz-storage-class")), TagCount: S.optional(S.Number).pipe(T.HttpHeader("x-amz-fwd-header-x-amz-tagging-count")), VersionId: S.optional(S.String).pipe(T.HttpHeader("x-amz-fwd-header-x-amz-version-id")), BucketKeyEnabled: S.optional(S.Boolean).pipe(T.HttpHeader("x-amz-fwd-header-x-amz-server-side-encryption-bucket-key-enabled"))}, T.all(ns, T.Http({ method: "POST", uri: "/WriteGetObjectResponse" }), svc, auth, proto, ver, rules, T.StaticContextParams({"UseObjectLambdaEndpoint":{"value":true}}))) {}
export class WriteGetObjectResponseResponse extends S.Class<WriteGetObjectResponseResponse>("WriteGetObjectResponseResponse")({}, ns) {}
export const InventoryOptionalFields = S.Array(S.String.pipe(T.XmlName("Field")));
...
export class AnalyticsAndOperator extends S.Class<AnalyticsAndOperator>("AnalyticsAndOperator")({Prefix: S.optional(S.String), Tags: S.optional(TagSet).pipe(T.XmlName("Tag"), T.XmlFlattened())}) {}
export const AnalyticsFilter = S.Union(S.Struct({ Prefix: S.String }), S.Struct({ Tag: Tag }), S.Struct({ And: AnalyticsAndOperator }));
...
export class IntelligentTieringAndOperator extends S.Class<IntelligentTieringAndOperator>("IntelligentTieringAndOperator")({Prefix: S.optional(S.String), Tags: S.optional(TagSet).pipe(T.XmlName("Tag"), T.XmlFlattened())}) {}
...
export class IntelligentTieringConfiguration extends S.Class<IntelligentTieringConfiguration>("IntelligentTieringConfiguration")({Id: S.String, Filter: S.optional(IntelligentTieringFilter), Status: S.String, Tierings: TieringList.pipe(T.XmlName("Tiering"), T.XmlFlattened())}) {}
...
export class SSEKMS extends S.Class<SSEKMS>("SSEKMS")({KeyId: S.String}, T.XmlName("SSE-KMS")) {}
export class InventoryEncryption extends S.Class<InventoryEncryption>("InventoryEncryption")({SSES3: S.optional(SSES3).pipe(T.XmlName("SSE-S3")), SSEKMS: S.optional(SSEKMS).pipe(T.XmlName("SSE-KMS"))}) {}
...
export class MetricsAndOperator extends S.Class<MetricsAndOperator>("MetricsAndOperator")({Prefix: S.optional(S.String), Tags: S.optional(TagSet).pipe(T.XmlName("Tag"), T.XmlFlattened()), AccessPointArn: S.optional(S.String)}) {}
export const MetricsFilter = S.Union(S.Struct({ Prefix: S.String }), S.Struct({ Tag: Tag }), S.Struct({ AccessPointArn: S.String }), S.Struct({ And: MetricsAndOperator }));
...
export class VersioningConfiguration extends S.Class<VersioningConfiguration>("VersioningConfiguration")({MFADelete: S.optional(S.String).pipe(T.XmlName("MfaDelete")), Status: S.optional(S.String)}) {}
export class ObjectLockLegalHold extends S.Class<ObjectLockLegalHold>("ObjectLockLegalHold")({Status: S.optional(S.String)}) {}
export class ObjectLockRetention extends S.Class<ObjectLockRetention>("ObjectLockRetention")({Mode: S.optional(S.String), RetainUntilDate: S.optional(S.Date.pipe(T.TimestampFormat("date-time")))}) {}
export class PublicAccessBlockConfiguration extends S.Class<PublicAccessBlockConfiguration>("PublicAccessBlockConfiguration")({BlockPublicAcls: S.optional(S.Boolean).pipe(T.XmlName("BlockPublicAcls")), IgnorePublicAcls: S.optional(S.Boolean).pipe(T.XmlName("IgnorePublicAcls")), BlockPublicPolicy: S.optional(S.Boolean).pipe(T.XmlName("BlockPublicPolicy")), RestrictPublicBuckets: S.optional(S.Boolean).pipe(T.XmlName("RestrictPublicBuckets"))}) {}
...
export class AbortMultipartUploadOutput extends S.Class<AbortMultipartUploadOutput>("AbortMultipartUploadOutput")({RequestCharged: S.optional(S.String).pipe(T.HttpHeader("x-amz-request-charged"))}, ns) {}
export class CopyObjectRequest extends S.Class<CopyObjectRequest>("CopyObjectRequest")({ACL: S.optional(S.String).pipe(T.HttpHeader("x-amz-acl")), Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket")), CacheControl: S.optional(S.String).pipe(T.HttpHeader("Cache-Control")), ChecksumAlgorithm: S.optional(S.String).pipe(T.HttpHeader("x-amz-checksum-algorithm")), ContentDisposition: S.optional(S.String).pipe(T.HttpHeader("Content-Disposition")), ContentEncoding: S.optional(S.String).pipe(T.HttpHeader("Content-Encoding")), ContentLanguage: S.optional(S.String).pipe(T.HttpHeader("Content-Language")), ContentType: S.optional(S.String).pipe(T.HttpHeader("Content-Type")), CopySource: S.String.pipe(T.HttpHeader("x-amz-copy-source"), T.ContextParam("CopySource")), CopySourceIfMatch: S.optional(S.String).pipe(T.HttpHeader("x-amz-copy-source-if-match")), CopySourceIfModifiedSince: S.optional(S.Date.pipe(T.TimestampFormat("http-date"))).pipe(T.HttpHeader("x-amz-copy-source-if-modified-since")), CopySourceIfNoneMatch: S.optional(S.String).pipe(T.HttpHeader("x-amz-copy-source-if-none-match")), CopySourceIfUnmodifiedSince: S.optional(S.Date.pipe(T.TimestampFormat("http-date"))).pipe(T.HttpHeader("x-amz-copy-source-if-unmodified-since")), Expires: S.optional(S.String).pipe(T.HttpHeader("Expires")), GrantFullControl: S.optional(S.String).pipe(T.HttpHeader("x-amz-grant-full-control")), GrantRead: S.optional(S.String).pipe(T.HttpHeader("x-amz-grant-read")), GrantReadACP: S.optional(S.String).pipe(T.HttpHeader("x-amz-grant-read-acp")), GrantWriteACP: S.optional(S.String).pipe(T.HttpHeader("x-amz-grant-write-acp")), IfMatch: S.optional(S.String).pipe(T.HttpHeader("If-Match")), IfNoneMatch: S.optional(S.String).pipe(T.HttpHeader("If-None-Match")), Key: S.String.pipe(T.HttpLabel("Key"), T.ContextParam("Key")), Metadata: S.optional(Metadata).pipe(T.HttpPrefixHeaders("x-amz-meta-")), MetadataDirective: S.optional(S.String).pipe(T.HttpHeader("x-amz-metadata-directive")), TaggingDirective: S.optional(S.String).pipe(T.HttpHeader("x-amz-tagging-directive")), ServerSideEncryption: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption")), StorageClass: S.optional(S.String).pipe(T.HttpHeader("x-amz-storage-class")), WebsiteRedirectLocation: S.optional(S.String).pipe(T.HttpHeader("x-amz-website-redirect-location")), SSECustomerAlgorithm: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-customer-algorithm")), SSECustomerKey: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-customer-key")), SSECustomerKeyMD5: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-customer-key-MD5")), SSEKMSKeyId: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-aws-kms-key-id")), SSEKMSEncryptionContext: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-context")), BucketKeyEnabled: S.optional(S.Boolean).pipe(T.HttpHeader("x-amz-server-side-encryption-bucket-key-enabled")), CopySourceSSECustomerAlgorithm: S.optional(S.String).pipe(T.HttpHeader("x-amz-copy-source-server-side-encryption-customer-algorithm")), CopySourceSSECustomerKey: S.optional(S.String).pipe(T.HttpHeader("x-amz-copy-source-server-side-encryption-customer-key")), CopySourceSSECustomerKeyMD5: S.optional(S.String).pipe(T.HttpHeader("x-amz-copy-source-server-side-encryption-customer-key-MD5")), RequestPayer: S.optional(S.String).pipe(T.HttpHeader("x-amz-request-payer")), Tagging: S.optional(S.String).pipe(T.HttpHeader("x-amz-tagging")), ObjectLockMode: S.optional(S.String).pipe(T.HttpHeader("x-amz-object-lock-mode")), ObjectLockRetainUntilDate: S.optional(S.Date.pipe(T.TimestampFormat("http-date"))).pipe(T.HttpHeader("x-amz-object-lock-retain-until-date")), ObjectLockLegalHoldStatus: S.optional(S.String).pipe(T.HttpHeader("x-amz-object-lock-legal-hold")), ExpectedBucketOwner: S.optional(S.String).pipe(T.HttpHeader("x-amz-expected-bucket-owner")), ExpectedSourceBucketOwner: S.optional(S.String).pipe(T.HttpHeader("x-amz-source-expected-bucket-owner"))}, T.all(ns, T.Http({ method: "PUT", uri: "/{Bucket}/{Key+}?x-id=CopyObject" }), svc, auth, proto, ver, rules, T.StaticContextParams({"DisableS3ExpressSessionAuth":{"value":true}}))) {}
export class CreateMultipartUploadOutput extends S.Class<CreateMultipartUploadOutput>("CreateMultipartUploadOutput")({AbortDate: S.optional(S.Date.pipe(T.TimestampFormat("http-date"))).pipe(T.HttpHeader("x-amz-abort-date")), AbortRuleId: S.optional(S.String).pipe(T.HttpHeader("x-amz-abort-rule-id")), Bucket: S.optional(S.String).pipe(T.XmlName("Bucket")), Key: S.optional(S.String), UploadId: S.optional(S.String), ServerSideEncryption: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption")), SSECustomerAlgorithm: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-customer-algorithm")), SSECustomerKeyMD5: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-customer-key-MD5")), SSEKMSKeyId: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-aws-kms-key-id")), SSEKMSEncryptionContext: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-context")), BucketKeyEnabled: S.optional(S.Boolean).pipe(T.HttpHeader("x-amz-server-side-encryption-bucket-key-enabled")), RequestCharged: S.optional(S.String).pipe(T.HttpHeader("x-amz-request-charged")), ChecksumAlgorithm: S.optional(S.String).pipe(T.HttpHeader("x-amz-checksum-algorithm")), ChecksumType: S.optional(S.String).pipe(T.HttpHeader("x-amz-checksum-type"))}, T.all(T.XmlName("InitiateMultipartUploadResult"), ns)) {}
export class DeleteObjectOutput extends S.Class<DeleteObjectOutput>("DeleteObjectOutput")({DeleteMarker: S.optional(S.Boolean).pipe(T.HttpHeader("x-amz-delete-marker")), VersionId: S.optional(S.String).pipe(T.HttpHeader("x-amz-version-id")), RequestCharged: S.optional(S.String).pipe(T.HttpHeader("x-amz-request-charged"))}, ns) {}
export class DeleteObjectTaggingOutput extends S.Class<DeleteObjectTaggingOutput>("DeleteObjectTaggingOutput")({VersionId: S.optional(S.String).pipe(T.HttpHeader("x-amz-version-id"))}, ns) {}
export class GetBucketAbacOutput extends S.Class<GetBucketAbacOutput>("GetBucketAbacOutput")({AbacStatus: S.optional(AbacStatus).pipe(T.HttpPayload())}, ns) {}
export class GetBucketAccelerateConfigurationOutput extends S.Class<GetBucketAccelerateConfigurationOutput>("GetBucketAccelerateConfigurationOutput")({Status: S.optional(S.String), RequestCharged: S.optional(S.String).pipe(T.HttpHeader("x-amz-request-charged"))}, T.all(T.XmlName("AccelerateConfiguration"), ns)) {}
export class GetBucketAclOutput extends S.Class<GetBucketAclOutput>("GetBucketAclOutput")({Owner: S.optional(Owner), Grants: S.optional(Grants).pipe(T.XmlName("AccessControlList"))}, T.all(T.XmlName("AccessControlPolicy"), ns)) {}
export class GetBucketAnalyticsConfigurationOutput extends S.Class<GetBucketAnalyticsConfigurationOutput>("GetBucketAnalyticsConfigurationOutput")({AnalyticsConfiguration: S.optional(AnalyticsConfiguration).pipe(T.HttpPayload())}, ns) {}
export class CORSRule extends S.Class<CORSRule>("CORSRule")({ID: S.optional(S.String), AllowedHeaders: S.optional(AllowedHeaders).pipe(T.XmlName("AllowedHeader"), T.XmlFlattened()), AllowedMethods: AllowedMethods.pipe(T.XmlName("AllowedMethod"), T.XmlFlattened()), AllowedOrigins: AllowedOrigins.pipe(T.XmlName("AllowedOrigin"), T.XmlFlattened()), ExposeHeaders: S.optional(ExposeHeaders).pipe(T.XmlName("ExposeHeader"), T.XmlFlattened()), MaxAgeSeconds: S.optional(S.Number)}) {}
export const CORSRules = S.Array(CORSRule);
export class GetBucketCorsOutput extends S.Class<GetBucketCorsOutput>("GetBucketCorsOutput")({CORSRules: S.optional(CORSRules).pipe(T.XmlName("CORSRule"), T.XmlFlattened())}, T.all(T.XmlName("CORSConfiguration"), ns)) {}
...
export const EncryptionTypeList = S.Array(S.String.pipe(T.XmlName("EncryptionType")));
export class BlockedEncryptionTypes extends S.Class<BlockedEncryptionTypes>("BlockedEncryptionTypes")({EncryptionType: S.optional(EncryptionTypeList).pipe(T.XmlFlattened())}) {}
...
export class ServerSideEncryptionConfiguration extends S.Class<ServerSideEncryptionConfiguration>("ServerSideEncryptionConfiguration")({Rules: ServerSideEncryptionRules.pipe(T.XmlName("Rule"), T.XmlFlattened())}) {}
export class GetBucketEncryptionOutput extends S.Class<GetBucketEncryptionOutput>("GetBucketEncryptionOutput")({ServerSideEncryptionConfiguration: S.optional(ServerSideEncryptionConfiguration).pipe(T.HttpPayload())}, ns) {}
export class GetBucketIntelligentTieringConfigurationOutput extends S.Class<GetBucketIntelligentTieringConfigurationOutput>("GetBucketIntelligentTieringConfigurationOutput")({IntelligentTieringConfiguration: S.optional(IntelligentTieringConfiguration).pipe(T.HttpPayload())}, ns) {}
export class GetBucketInventoryConfigurationOutput extends S.Class<GetBucketInventoryConfigurationOutput>("GetBucketInventoryConfigurationOutput")({InventoryConfiguration: S.optional(InventoryConfiguration).pipe(T.HttpPayload())}, ns) {}
export class LifecycleExpiration extends S.Class<LifecycleExpiration>("LifecycleExpiration")({Date: S.optional(S.Date.pipe(T.TimestampFormat("date-time"))), Days: S.optional(S.Number), ExpiredObjectDeleteMarker: S.optional(S.Boolean)}) {}
export class LifecycleRuleAndOperator extends S.Class<LifecycleRuleAndOperator>("LifecycleRuleAndOperator")({Prefix: S.optional(S.String), Tags: S.optional(TagSet).pipe(T.XmlName("Tag"), T.XmlFlattened()), ObjectSizeGreaterThan: S.optional(S.Number), ObjectSizeLessThan: S.optional(S.Number)}) {}
...
export class Transition extends S.Class<Transition>("Transition")({Date: S.optional(S.Date.pipe(T.TimestampFormat("date-time"))), Days: S.optional(S.Number), StorageClass: S.optional(S.String)}) {}
...
export class SimplePrefix extends S.Class<SimplePrefix>("SimplePrefix")({}, T.XmlName("SimplePrefix")) {}
export class PartitionedPrefix extends S.Class<PartitionedPrefix>("PartitionedPrefix")({PartitionDateSource: S.optional(S.String)}, T.XmlName("PartitionedPrefix")) {}
export class TargetObjectKeyFormat extends S.Class<TargetObjectKeyFormat>("TargetObjectKeyFormat")({SimplePrefix: S.optional(SimplePrefix).pipe(T.XmlName("SimplePrefix")), PartitionedPrefix: S.optional(PartitionedPrefix).pipe(T.XmlName("PartitionedPrefix"))}) {}
...
export class GetBucketLoggingOutput extends S.Class<GetBucketLoggingOutput>("GetBucketLoggingOutput")({LoggingEnabled: S.optional(LoggingEnabled)}, T.all(T.XmlName("BucketLoggingStatus"), ns)) {}
export class GetBucketMetricsConfigurationOutput extends S.Class<GetBucketMetricsConfigurationOutput>("GetBucketMetricsConfigurationOutput")({MetricsConfiguration: S.optional(MetricsConfiguration).pipe(T.HttpPayload())}, ns) {}
...
export class OwnershipControls extends S.Class<OwnershipControls>("OwnershipControls")({Rules: OwnershipControlsRules.pipe(T.XmlName("Rule"), T.XmlFlattened())}) {}
export class GetBucketOwnershipControlsOutput extends S.Class<GetBucketOwnershipControlsOutput>("GetBucketOwnershipControlsOutput")({OwnershipControls: S.optional(OwnershipControls).pipe(T.HttpPayload())}, ns) {}
export class GetBucketPolicyOutput extends S.Class<GetBucketPolicyOutput>("GetBucketPolicyOutput")({Policy: S.optional(S.String).pipe(T.HttpPayload())}, ns) {}
export class ReplicationRuleAndOperator extends S.Class<ReplicationRuleAndOperator>("ReplicationRuleAndOperator")({Prefix: S.optional(S.String), Tags: S.optional(TagSet).pipe(T.XmlName("Tag"), T.XmlFlattened())}) {}
...
export class ReplicationConfiguration extends S.Class<ReplicationConfiguration>("ReplicationConfiguration")({Role: S.String, Rules: ReplicationRules.pipe(T.XmlName("Rule"), T.XmlFlattened())}) {}
export class GetBucketReplicationOutput extends S.Class<GetBucketReplicationOutput>("GetBucketReplicationOutput")({ReplicationConfiguration: S.optional(ReplicationConfiguration).pipe(T.HttpPayload())}, ns) {}
export class GetBucketRequestPaymentOutput extends S.Class<GetBucketRequestPaymentOutput>("GetBucketRequestPaymentOutput")({Payer: S.optional(S.String)}, T.all(T.XmlName("RequestPaymentConfiguration"), ns)) {}
export class GetBucketTaggingOutput extends S.Class<GetBucketTaggingOutput>("GetBucketTaggingOutput")({TagSet: TagSet}, T.all(T.XmlName("Tagging"), ns)) {}
export class GetBucketVersioningOutput extends S.Class<GetBucketVersioningOutput>("GetBucketVersioningOutput")({Status: S.optional(S.String), MFADelete: S.optional(S.String).pipe(T.XmlName("MfaDelete"))}, T.all(T.XmlName("VersioningConfiguration"), ns)) {}
...
export class GetBucketWebsiteOutput extends S.Class<GetBucketWebsiteOutput>("GetBucketWebsiteOutput")({RedirectAllRequestsTo: S.optional(RedirectAllRequestsTo), IndexDocument: S.optional(IndexDocument), ErrorDocument: S.optional(ErrorDocument), RoutingRules: S.optional(RoutingRules)}, T.all(T.XmlName("WebsiteConfiguration"), ns)) {}
export class GetObjectOutput extends S.Class<GetObjectOutput>("GetObjectOutput")({Body: S.optional(T.StreamingOutput).pipe(T.HttpPayload()), DeleteMarker: S.optional(S.Boolean).pipe(T.HttpHeader("x-amz-delete-marker")), AcceptRanges: S.optional(S.String).pipe(T.HttpHeader("accept-ranges")), Expiration: S.optional(S.String).pipe(T.HttpHeader("x-amz-expiration")), Restore: S.optional(S.String).pipe(T.HttpHeader("x-amz-restore")), LastModified: S.optional(S.Date.pipe(T.TimestampFormat("http-date"))).pipe(T.HttpHeader("Last-Modified")), ContentLength: S.optional(S.Number).pipe(T.HttpHeader("Content-Length")), ETag: S.optional(S.String).pipe(T.HttpHeader("ETag")), ChecksumCRC32: S.optional(S.String).pipe(T.HttpHeader("x-amz-checksum-crc32")), ChecksumCRC32C: S.optional(S.String).pipe(T.HttpHeader("x-amz-checksum-crc32c")), ChecksumCRC64NVME: S.optional(S.String).pipe(T.HttpHeader("x-amz-checksum-crc64nvme")), ChecksumSHA1: S.optional(S.String).pipe(T.HttpHeader("x-amz-checksum-sha1")), ChecksumSHA256: S.optional(S.String).pipe(T.HttpHeader("x-amz-checksum-sha256")), ChecksumType: S.optional(S.String).pipe(T.HttpHeader("x-amz-checksum-type")), MissingMeta: S.optional(S.Number).pipe(T.HttpHeader("x-amz-missing-meta")), VersionId: S.optional(S.String).pipe(T.HttpHeader("x-amz-version-id")), CacheControl: S.optional(S.String).pipe(T.HttpHeader("Cache-Control")), ContentDisposition: S.optional(S.String).pipe(T.HttpHeader("Content-Disposition")), ContentEncoding: S.optional(S.String).pipe(T.HttpHeader("Content-Encoding")), ContentLanguage: S.optional(S.String).pipe(T.HttpHeader("Content-Language")), ContentRange: S.optional(S.String).pipe(T.HttpHeader("Content-Range")), ContentType: S.optional(S.String).pipe(T.HttpHeader("Content-Type")), Expires: S.optional(S.String).pipe(T.HttpHeader("Expires")), WebsiteRedirectLocation: S.optional(S.String).pipe(T.HttpHeader("x-amz-website-redirect-location")), ServerSideEncryption: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption")), Metadata: S.optional(Metadata).pipe(T.HttpPrefixHeaders("x-amz-meta-")), SSECustomerAlgorithm: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-customer-algorithm")), SSECustomerKeyMD5: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-customer-key-MD5")), SSEKMSKeyId: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-aws-kms-key-id")), BucketKeyEnabled: S.optional(S.Boolean).pipe(T.HttpHeader("x-amz-server-side-encryption-bucket-key-enabled")), StorageClass: S.optional(S.String).pipe(T.HttpHeader("x-amz-storage-class")), RequestCharged: S.optional(S.String).pipe(T.HttpHeader("x-amz-request-charged")), ReplicationStatus: S.optional(S.String).pipe(T.HttpHeader("x-amz-replication-status")), PartsCount: S.optional(S.Number).pipe(T.HttpHeader("x-amz-mp-parts-count")), TagCount: S.optional(S.Number).pipe(T.HttpHeader("x-amz-tagging-count")), ObjectLockMode: S.optional(S.String).pipe(T.HttpHeader("x-amz-object-lock-mode")), ObjectLockRetainUntilDate: S.optional(S.Date.pipe(T.TimestampFormat("http-date"))).pipe(T.HttpHeader("x-amz-object-lock-retain-until-date")), ObjectLockLegalHoldStatus: S.optional(S.String).pipe(T.HttpHeader("x-amz-object-lock-legal-hold"))}, ns) {}
export class GetObjectAclOutput extends S.Class<GetObjectAclOutput>("GetObjectAclOutput")({Owner: S.optional(Owner), Grants: S.optional(Grants).pipe(T.XmlName("AccessControlList")), RequestCharged: S.optional(S.String).pipe(T.HttpHeader("x-amz-request-charged"))}, T.all(T.XmlName("AccessControlPolicy"), ns)) {}
export class GetObjectLegalHoldOutput extends S.Class<GetObjectLegalHoldOutput>("GetObjectLegalHoldOutput")({LegalHold: S.optional(ObjectLockLegalHold).pipe(T.HttpPayload(), T.XmlName("LegalHold"))}, ns) {}
...
export class GetObjectLockConfigurationOutput extends S.Class<GetObjectLockConfigurationOutput>("GetObjectLockConfigurationOutput")({ObjectLockConfiguration: S.optional(ObjectLockConfiguration).pipe(T.HttpPayload())}, ns) {}
export class GetObjectRetentionOutput extends S.Class<GetObjectRetentionOutput>("GetObjectRetentionOutput")({Retention: S.optional(ObjectLockRetention).pipe(T.HttpPayload(), T.XmlName("Retention"))}, ns) {}
export class GetObjectTaggingOutput extends S.Class<GetObjectTaggingOutput>("GetObjectTaggingOutput")({VersionId: S.optional(S.String).pipe(T.HttpHeader("x-amz-version-id")), TagSet: TagSet}, T.all(T.XmlName("Tagging"), ns)) {}
export class GetObjectTorrentOutput extends S.Class<GetObjectTorrentOutput>("GetObjectTorrentOutput")({Body: S.optional(T.StreamingOutput).pipe(T.HttpPayload()), RequestCharged: S.optional(S.String).pipe(T.HttpHeader("x-amz-request-charged"))}, ns) {}
export class GetPublicAccessBlockOutput extends S.Class<GetPublicAccessBlockOutput>("GetPublicAccessBlockOutput")({PublicAccessBlockConfiguration: S.optional(PublicAccessBlockConfiguration).pipe(T.HttpPayload())}, ns) {}
export class HeadBucketOutput extends S.Class<HeadBucketOutput>("HeadBucketOutput")({BucketArn: S.optional(S.String).pipe(T.HttpHeader("x-amz-bucket-arn")), BucketLocationType: S.optional(S.String).pipe(T.HttpHeader("x-amz-bucket-location-type")), BucketLocationName: S.optional(S.String).pipe(T.HttpHeader("x-amz-bucket-location-name")), BucketRegion: S.optional(S.String).pipe(T.HttpHeader("x-amz-bucket-region")), AccessPointAlias: S.optional(S.Boolean).pipe(T.HttpHeader("x-amz-access-point-alias"))}, ns) {}
export class HeadObjectOutput extends S.Class<HeadObjectOutput>("HeadObjectOutput")({DeleteMarker: S.optional(S.Boolean).pipe(T.HttpHeader("x-amz-delete-marker")), AcceptRanges: S.optional(S.String).pipe(T.HttpHeader("accept-ranges")), Expiration: S.optional(S.String).pipe(T.HttpHeader("x-amz-expiration")), Restore: S.optional(S.String).pipe(T.HttpHeader("x-amz-restore")), ArchiveStatus: S.optional(S.String).pipe(T.HttpHeader("x-amz-archive-status")), LastModified: S.optional(S.Date.pipe(T.TimestampFormat("http-date"))).pipe(T.HttpHeader("Last-Modified")), ContentLength: S.optional(S.Number).pipe(T.HttpHeader("Content-Length")), ChecksumCRC32: S.optional(S.String).pipe(T.HttpHeader("x-amz-checksum-crc32")), ChecksumCRC32C: S.optional(S.String).pipe(T.HttpHeader("x-amz-checksum-crc32c")), ChecksumCRC64NVME: S.optional(S.String).pipe(T.HttpHeader("x-amz-checksum-crc64nvme")), ChecksumSHA1: S.optional(S.String).pipe(T.HttpHeader("x-amz-checksum-sha1")), ChecksumSHA256: S.optional(S.String).pipe(T.HttpHeader("x-amz-checksum-sha256")), ChecksumType: S.optional(S.String).pipe(T.HttpHeader("x-amz-checksum-type")), ETag: S.optional(S.String).pipe(T.HttpHeader("ETag")), MissingMeta: S.optional(S.Number).pipe(T.HttpHeader("x-amz-missing-meta")), VersionId: S.optional(S.String).pipe(T.HttpHeader("x-amz-version-id")), CacheControl: S.optional(S.String).pipe(T.HttpHeader("Cache-Control")), ContentDisposition: S.optional(S.String).pipe(T.HttpHeader("Content-Disposition")), ContentEncoding: S.optional(S.String).pipe(T.HttpHeader("Content-Encoding")), ContentLanguage: S.optional(S.String).pipe(T.HttpHeader("Content-Language")), ContentType: S.optional(S.String).pipe(T.HttpHeader("Content-Type")), ContentRange: S.optional(S.String).pipe(T.HttpHeader("Content-Range")), Expires: S.optional(S.String).pipe(T.HttpHeader("Expires")), WebsiteRedirectLocation: S.optional(S.String).pipe(T.HttpHeader("x-amz-website-redirect-location")), ServerSideEncryption: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption")), Metadata: S.optional(Metadata).pipe(T.HttpPrefixHeaders("x-amz-meta-")), SSECustomerAlgorithm: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-customer-algorithm")), SSECustomerKeyMD5: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-customer-key-MD5")), SSEKMSKeyId: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-aws-kms-key-id")), BucketKeyEnabled: S.optional(S.Boolean).pipe(T.HttpHeader("x-amz-server-side-encryption-bucket-key-enabled")), StorageClass: S.optional(S.String).pipe(T.HttpHeader("x-amz-storage-class")), RequestCharged: S.optional(S.String).pipe(T.HttpHeader("x-amz-request-charged")), ReplicationStatus: S.optional(S.String).pipe(T.HttpHeader("x-amz-replication-status")), PartsCount: S.optional(S.Number).pipe(T.HttpHeader("x-amz-mp-parts-count")), TagCount: S.optional(S.Number).pipe(T.HttpHeader("x-amz-tagging-count")), ObjectLockMode: S.optional(S.String).pipe(T.HttpHeader("x-amz-object-lock-mode")), ObjectLockRetainUntilDate: S.optional(S.Date.pipe(T.TimestampFormat("http-date"))).pipe(T.HttpHeader("x-amz-object-lock-retain-until-date")), ObjectLockLegalHoldStatus: S.optional(S.String).pipe(T.HttpHeader("x-amz-object-lock-legal-hold"))}, ns) {}
export class ListBucketAnalyticsConfigurationsOutput extends S.Class<ListBucketAnalyticsConfigurationsOutput>("ListBucketAnalyticsConfigurationsOutput")({IsTruncated: S.optional(S.Boolean), ContinuationToken: S.optional(S.String), NextContinuationToken: S.optional(S.String), AnalyticsConfigurationList: S.optional(AnalyticsConfigurationList).pipe(T.XmlName("AnalyticsConfiguration"), T.XmlFlattened())}, T.all(T.XmlName("ListBucketAnalyticsConfigurationResult"), ns)) {}
export class ListBucketIntelligentTieringConfigurationsOutput extends S.Class<ListBucketIntelligentTieringConfigurationsOutput>("ListBucketIntelligentTieringConfigurationsOutput")({IsTruncated: S.optional(S.Boolean), ContinuationToken: S.optional(S.String), NextContinuationToken: S.optional(S.String), IntelligentTieringConfigurationList: S.optional(IntelligentTieringConfigurationList).pipe(T.XmlName("IntelligentTieringConfiguration"), T.XmlFlattened())}, ns) {}
export class ListBucketInventoryConfigurationsOutput extends S.Class<ListBucketInventoryConfigurationsOutput>("ListBucketInventoryConfigurationsOutput")({ContinuationToken: S.optional(S.String), InventoryConfigurationList: S.optional(InventoryConfigurationList).pipe(T.XmlName("InventoryConfiguration"), T.XmlFlattened()), IsTruncated: S.optional(S.Boolean), NextContinuationToken: S.optional(S.String)}, T.all(T.XmlName("ListInventoryConfigurationsResult"), ns)) {}
export class ListBucketMetricsConfigurationsOutput extends S.Class<ListBucketMetricsConfigurationsOutput>("ListBucketMetricsConfigurationsOutput")({IsTruncated: S.optional(S.Boolean), ContinuationToken: S.optional(S.String), NextContinuationToken: S.optional(S.String), MetricsConfigurationList: S.optional(MetricsConfigurationList).pipe(T.XmlName("MetricsConfiguration"), T.XmlFlattened())}, T.all(T.XmlName("ListMetricsConfigurationsResult"), ns)) {}
...
export class ListDirectoryBucketsOutput extends S.Class<ListDirectoryBucketsOutput>("ListDirectoryBucketsOutput")({Buckets: S.optional(Buckets), ContinuationToken: S.optional(S.String)}, T.all(T.XmlName("ListAllMyDirectoryBucketsResult"), ns)) {}
...
export class ListObjectsV2Output extends S.Class<ListObjectsV2Output>("ListObjectsV2Output")({IsTruncated: S.optional(S.Boolean), Contents: S.optional(ObjectList).pipe(T.XmlFlattened()), Name: S.optional(S.String), Prefix: S.optional(S.String), Delimiter: S.optional(S.String), MaxKeys: S.optional(S.Number), CommonPrefixes: S.optional(CommonPrefixList).pipe(T.XmlFlattened()), EncodingType: S.optional(S.String), KeyCount: S.optional(S.Number), ContinuationToken: S.optional(S.String), NextContinuationToken: S.optional(S.String), StartAfter: S.optional(S.String), RequestCharged: S.optional(S.String).pipe(T.HttpHeader("x-amz-request-charged"))}, T.all(T.XmlName("ListBucketResult"), ns)) {}
export class PutBucketAbacRequest extends S.Class<PutBucketAbacRequest>("PutBucketAbacRequest")({Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket")), ContentMD5: S.optional(S.String).pipe(T.HttpHeader("Content-MD5")), ChecksumAlgorithm: S.optional(S.String).pipe(T.HttpHeader("x-amz-sdk-checksum-algorithm")), ExpectedBucketOwner: S.optional(S.String).pipe(T.HttpHeader("x-amz-expected-bucket-owner")), AbacStatus: AbacStatus.pipe(T.HttpPayload(), T.XmlName("AbacStatus"))}, T.all(ns, T.Http({ method: "PUT", uri: "/{Bucket}?abac" }), svc, auth, proto, ver, rules, T.AwsProtocolsHttpChecksum({ requestAlgorithmMember: "ChecksumAlgorithm" }))) {}
export class PutBucketAbacResponse extends S.Class<PutBucketAbacResponse>("PutBucketAbacResponse")({}, ns) {}
export class PutBucketAccelerateConfigurationRequest extends S.Class<PutBucketAccelerateConfigurationRequest>("PutBucketAccelerateConfigurationRequest")({Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket")), AccelerateConfiguration: AccelerateConfiguration.pipe(T.HttpPayload(), T.XmlName("AccelerateConfiguration")), ExpectedBucketOwner: S.optional(S.String).pipe(T.HttpHeader("x-amz-expected-bucket-owner")), ChecksumAlgorithm: S.optional(S.String).pipe(T.HttpHeader("x-amz-sdk-checksum-algorithm"))}, T.all(ns, T.Http({ method: "PUT", uri: "/{Bucket}?accelerate" }), svc, auth, proto, ver, rules, T.AwsProtocolsHttpChecksum({ requestAlgorithmMember: "ChecksumAlgorithm" }), T.StaticContextParams({"UseS3ExpressControlEndpoint":{"value":true}}))) {}
export class PutBucketAccelerateConfigurationResponse extends S.Class<PutBucketAccelerateConfigurationResponse>("PutBucketAccelerateConfigurationResponse")({}, ns) {}
export class PutBucketRequestPaymentRequest extends S.Class<PutBucketRequestPaymentRequest>("PutBucketRequestPaymentRequest")({Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket")), ContentMD5: S.optional(S.String).pipe(T.HttpHeader("Content-MD5")), ChecksumAlgorithm: S.optional(S.String).pipe(T.HttpHeader("x-amz-sdk-checksum-algorithm")), RequestPaymentConfiguration: RequestPaymentConfiguration.pipe(T.HttpPayload(), T.XmlName("RequestPaymentConfiguration")), ExpectedBucketOwner: S.optional(S.String).pipe(T.HttpHeader("x-amz-expected-bucket-owner"))}, T.all(ns, T.Http({ method: "PUT", uri: "/{Bucket}?requestPayment" }), svc, auth, proto, ver, rules, T.AwsProtocolsHttpChecksum({ requestAlgorithmMember: "ChecksumAlgorithm", requestChecksumRequired: true }), T.StaticContextParams({"UseS3ExpressControlEndpoint":{"value":true}}))) {}
export class PutBucketRequestPaymentResponse extends S.Class<PutBucketRequestPaymentResponse>("PutBucketRequestPaymentResponse")({}, ns) {}
export class PutBucketTaggingRequest extends S.Class<PutBucketTaggingRequest>("PutBucketTaggingRequest")({Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket")), ContentMD5: S.optional(S.String).pipe(T.HttpHeader("Content-MD5")), ChecksumAlgorithm: S.optional(S.String).pipe(T.HttpHeader("x-amz-sdk-checksum-algorithm")), Tagging: Tagging.pipe(T.HttpPayload(), T.XmlName("Tagging")), ExpectedBucketOwner: S.optional(S.String).pipe(T.HttpHeader("x-amz-expected-bucket-owner"))}, T.all(ns, T.Http({ method: "PUT", uri: "/{Bucket}?tagging" }), svc, auth, proto, ver, rules, T.AwsProtocolsHttpChecksum({ requestAlgorithmMember: "ChecksumAlgorithm", requestChecksumRequired: true }), T.StaticContextParams({"UseS3ExpressControlEndpoint":{"value":true}}))) {}
export class PutBucketTaggingResponse extends S.Class<PutBucketTaggingResponse>("PutBucketTaggingResponse")({}, ns) {}
export class PutBucketVersioningRequest extends S.Class<PutBucketVersioningRequest>("PutBucketVersioningRequest")({Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket")), ContentMD5: S.optional(S.String).pipe(T.HttpHeader("Content-MD5")), ChecksumAlgorithm: S.optional(S.String).pipe(T.HttpHeader("x-amz-sdk-checksum-algorithm")), MFA: S.optional(S.String).pipe(T.HttpHeader("x-amz-mfa")), VersioningConfiguration: VersioningConfiguration.pipe(T.HttpPayload(), T.XmlName("VersioningConfiguration")), ExpectedBucketOwner: S.optional(S.String).pipe(T.HttpHeader("x-amz-expected-bucket-owner"))}, T.all(ns, T.Http({ method: "PUT", uri: "/{Bucket}?versioning" }), svc, auth, proto, ver, rules, T.AwsProtocolsHttpChecksum({ requestAlgorithmMember: "ChecksumAlgorithm", requestChecksumRequired: true }), T.StaticContextParams({"UseS3ExpressControlEndpoint":{"value":true}}))) {}
export class PutBucketVersioningResponse extends S.Class<PutBucketVersioningResponse>("PutBucketVersioningResponse")({}, ns) {}
export class PutObjectOutput extends S.Class<PutObjectOutput>("PutObjectOutput")({Expiration: S.optional(S.String).pipe(T.HttpHeader("x-amz-expiration")), ETag: S.optional(S.String).pipe(T.HttpHeader("ETag")), ChecksumCRC32: S.optional(S.String).pipe(T.HttpHeader("x-amz-checksum-crc32")), ChecksumCRC32C: S.optional(S.String).pipe(T.HttpHeader("x-amz-checksum-crc32c")), ChecksumCRC64NVME: S.optional(S.String).pipe(T.HttpHeader("x-amz-checksum-crc64nvme")), ChecksumSHA1: S.optional(S.String).pipe(T.HttpHeader("x-amz-checksum-sha1")), ChecksumSHA256: S.optional(S.String).pipe(T.HttpHeader("x-amz-checksum-sha256")), ChecksumType: S.optional(S.String).pipe(T.HttpHeader("x-amz-checksum-type")), ServerSideEncryption: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption")), VersionId: S.optional(S.String).pipe(T.HttpHeader("x-amz-version-id")), SSECustomerAlgorithm: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-customer-algorithm")), SSECustomerKeyMD5: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-customer-key-MD5")), SSEKMSKeyId: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-aws-kms-key-id")), SSEKMSEncryptionContext: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-context")), BucketKeyEnabled: S.optional(S.Boolean).pipe(T.HttpHeader("x-amz-server-side-encryption-bucket-key-enabled")), Size: S.optional(S.Number).pipe(T.HttpHeader("x-amz-object-size")), RequestCharged: S.optional(S.String).pipe(T.HttpHeader("x-amz-request-charged"))}, ns) {}
export class PutObjectAclOutput extends S.Class<PutObjectAclOutput>("PutObjectAclOutput")({RequestCharged: S.optional(S.String).pipe(T.HttpHeader("x-amz-request-charged"))}, ns) {}
export class PutObjectLegalHoldRequest extends S.Class<PutObjectLegalHoldRequest>("PutObjectLegalHoldRequest")({Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket")), Key: S.String.pipe(T.HttpLabel("Key")), LegalHold: S.optional(ObjectLockLegalHold).pipe(T.HttpPayload(), T.XmlName("LegalHold")), RequestPayer: S.optional(S.String).pipe(T.HttpHeader("x-amz-request-payer")), VersionId: S.optional(S.String).pipe(T.HttpQuery("versionId")), ContentMD5: S.optional(S.String).pipe(T.HttpHeader("Content-MD5")), ChecksumAlgorithm: S.optional(S.String).pipe(T.HttpHeader("x-amz-sdk-checksum-algorithm")), ExpectedBucketOwner: S.optional(S.String).pipe(T.HttpHeader("x-amz-expected-bucket-owner"))}, T.all(ns, T.Http({ method: "PUT", uri: "/{Bucket}/{Key+}?legal-hold" }), svc, auth, proto, ver, rules, T.AwsProtocolsHttpChecksum({ requestAlgorithmMember: "ChecksumAlgorithm", requestChecksumRequired: true }))) {}
export class PutObjectRetentionRequest extends S.Class<PutObjectRetentionRequest>("PutObjectRetentionRequest")({Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket")), Key: S.String.pipe(T.HttpLabel("Key")), Retention: S.optional(ObjectLockRetention).pipe(T.HttpPayload(), T.XmlName("Retention")), RequestPayer: S.optional(S.String).pipe(T.HttpHeader("x-amz-request-payer")), VersionId: S.optional(S.String).pipe(T.HttpQuery("versionId")), BypassGovernanceRetention: S.optional(S.Boolean).pipe(T.HttpHeader("x-amz-bypass-governance-retention")), ContentMD5: S.optional(S.String).pipe(T.HttpHeader("Content-MD5")), ChecksumAlgorithm: S.optional(S.String).pipe(T.HttpHeader("x-amz-sdk-checksum-algorithm")), ExpectedBucketOwner: S.optional(S.String).pipe(T.HttpHeader("x-amz-expected-bucket-owner"))}, T.all(ns, T.Http({ method: "PUT", uri: "/{Bucket}/{Key+}?retention" }), svc, auth, proto, ver, rules, T.AwsProtocolsHttpChecksum({ requestAlgorithmMember: "ChecksumAlgorithm", requestChecksumRequired: true }))) {}
export class PutObjectTaggingOutput extends S.Class<PutObjectTaggingOutput>("PutObjectTaggingOutput")({VersionId: S.optional(S.String).pipe(T.HttpHeader("x-amz-version-id"))}, ns) {}
export class PutPublicAccessBlockRequest extends S.Class<PutPublicAccessBlockRequest>("PutPublicAccessBlockRequest")({Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket")), ContentMD5: S.optional(S.String).pipe(T.HttpHeader("Content-MD5")), ChecksumAlgorithm: S.optional(S.String).pipe(T.HttpHeader("x-amz-sdk-checksum-algorithm")), PublicAccessBlockConfiguration: PublicAccessBlockConfiguration.pipe(T.HttpPayload(), T.XmlName("PublicAccessBlockConfiguration")), ExpectedBucketOwner: S.optional(S.String).pipe(T.HttpHeader("x-amz-expected-bucket-owner"))}, T.all(ns, T.Http({ method: "PUT", uri: "/{Bucket}?publicAccessBlock" }), svc, auth, proto, ver, rules, T.AwsProtocolsHttpChecksum({ requestAlgorithmMember: "ChecksumAlgorithm", requestChecksumRequired: true }), T.StaticContextParams({"UseS3ExpressControlEndpoint":{"value":true}}))) {}
export class PutPublicAccessBlockResponse extends S.Class<PutPublicAccessBlockResponse>("PutPublicAccessBlockResponse")({}, ns) {}
export class UploadPartOutput extends S.Class<UploadPartOutput>("UploadPartOutput")({ServerSideEncryption: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption")), ETag: S.optional(S.String).pipe(T.HttpHeader("ETag")), ChecksumCRC32: S.optional(S.String).pipe(T.HttpHeader("x-amz-checksum-crc32")), ChecksumCRC32C: S.optional(S.String).pipe(T.HttpHeader("x-amz-checksum-crc32c")), ChecksumCRC64NVME: S.optional(S.String).pipe(T.HttpHeader("x-amz-checksum-crc64nvme")), ChecksumSHA1: S.optional(S.String).pipe(T.HttpHeader("x-amz-checksum-sha1")), ChecksumSHA256: S.optional(S.String).pipe(T.HttpHeader("x-amz-checksum-sha256")), SSECustomerAlgorithm: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-customer-algorithm")), SSECustomerKeyMD5: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-customer-key-MD5")), SSEKMSKeyId: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-aws-kms-key-id")), BucketKeyEnabled: S.optional(S.Boolean).pipe(T.HttpHeader("x-amz-server-side-encryption-bucket-key-enabled")), RequestCharged: S.optional(S.String).pipe(T.HttpHeader("x-amz-request-charged"))}, ns) {}
...
export class ObjectIdentifier extends S.Class<ObjectIdentifier>("ObjectIdentifier")({Key: S.String, VersionId: S.optional(S.String), ETag: S.optional(S.String), LastModifiedTime: S.optional(S.Date.pipe(T.TimestampFormat("http-date"))), Size: S.optional(S.Number)}) {}
...
export class S3KeyFilter extends S.Class<S3KeyFilter>("S3KeyFilter")({FilterRules: S.optional(FilterRuleList).pipe(T.XmlName("FilterRule"), T.XmlFlattened())}) {}
export class NotificationConfigurationFilter extends S.Class<NotificationConfigurationFilter>("NotificationConfigurationFilter")({Key: S.optional(S3KeyFilter).pipe(T.XmlName("S3Key"))}) {}
export class QueueConfiguration extends S.Class<QueueConfiguration>("QueueConfiguration")({Id: S.optional(S.String), QueueArn: S.String.pipe(T.XmlName("Queue")), Events: EventList.pipe(T.XmlName("Event"), T.XmlFlattened()), Filter: S.optional(NotificationConfigurationFilter)}) {}
export const QueueConfigurationList = S.Array(QueueConfiguration);
export class LambdaFunctionConfiguration extends S.Class<LambdaFunctionConfiguration>("LambdaFunctionConfiguration")({Id: S.optional(S.String), LambdaFunctionArn: S.String.pipe(T.XmlName("CloudFunction")), Events: EventList.pipe(T.XmlName("Event"), T.XmlFlattened()), Filter: S.optional(NotificationConfigurationFilter)}) {}
...
export class CompletedMultipartUpload extends S.Class<CompletedMultipartUpload>("CompletedMultipartUpload")({Parts: S.optional(CompletedPartList).pipe(T.XmlName("Part"), T.XmlFlattened())}) {}
...
export class SessionCredentials extends S.Class<SessionCredentials>("SessionCredentials")({AccessKeyId: S.String.pipe(T.XmlName("AccessKeyId")), SecretAccessKey: S.String.pipe(T.XmlName("SecretAccessKey")), SessionToken: S.String.pipe(T.XmlName("SessionToken")), Expiration: S.Date.pipe(T.XmlName("Expiration"))}) {}
export class Delete extends S.Class<Delete>("Delete")({Objects: ObjectIdentifierList.pipe(T.XmlName("Object"), T.XmlFlattened()), Quiet: S.optional(S.Boolean)}) {}
export class PolicyStatus extends S.Class<PolicyStatus>("PolicyStatus")({IsPublic: S.optional(S.Boolean).pipe(T.XmlName("IsPublic"))}) {}
...
export class CORSConfiguration extends S.Class<CORSConfiguration>("CORSConfiguration")({CORSRules: CORSRules.pipe(T.XmlName("CORSRule"), T.XmlFlattened())}) {}
...
export class CompleteMultipartUploadRequest extends S.Class<CompleteMultipartUploadRequest>("CompleteMultipartUploadRequest")({Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket")), Key: S.String.pipe(T.HttpLabel("Key"), T.ContextParam("Key")), MultipartUpload: S.optional(CompletedMultipartUpload).pipe(T.HttpPayload(), T.XmlName("CompleteMultipartUpload")), UploadId: S.String.pipe(T.HttpQuery("uploadId")), ChecksumCRC32: S.optional(S.String).pipe(T.HttpHeader("x-amz-checksum-crc32")), ChecksumCRC32C: S.optional(S.String).pipe(T.HttpHeader("x-amz-checksum-crc32c")), ChecksumCRC64NVME: S.optional(S.String).pipe(T.HttpHeader("x-amz-checksum-crc64nvme")), ChecksumSHA1: S.optional(S.String).pipe(T.HttpHeader("x-amz-checksum-sha1")), ChecksumSHA256: S.optional(S.String).pipe(T.HttpHeader("x-amz-checksum-sha256")), ChecksumType: S.optional(S.String).pipe(T.HttpHeader("x-amz-checksum-type")), MpuObjectSize: S.optional(S.Number).pipe(T.HttpHeader("x-amz-mp-object-size")), RequestPayer: S.optional(S.String).pipe(T.HttpHeader("x-amz-request-payer")), ExpectedBucketOwner: S.optional(S.String).pipe(T.HttpHeader("x-amz-expected-bucket-owner")), IfMatch: S.optional(S.String).pipe(T.HttpHeader("If-Match")), IfNoneMatch: S.optional(S.String).pipe(T.HttpHeader("If-None-Match")), SSECustomerAlgorithm: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-customer-algorithm")), SSECustomerKey: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-customer-key")), SSECustomerKeyMD5: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-customer-key-MD5"))}, T.all(ns, T.Http({ method: "POST", uri: "/{Bucket}/{Key+}" }), svc, auth, proto, ver, rules)) {}
export class CreateBucketRequest extends S.Class<CreateBucketRequest>("CreateBucketRequest")({ACL: S.optional(S.String).pipe(T.HttpHeader("x-amz-acl")), Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket")), CreateBucketConfiguration: S.optional(CreateBucketConfiguration).pipe(T.HttpPayload(), T.XmlName("CreateBucketConfiguration")), GrantFullControl: S.optional(S.String).pipe(T.HttpHeader("x-amz-grant-full-control")), GrantRead: S.optional(S.String).pipe(T.HttpHeader("x-amz-grant-read")), GrantReadACP: S.optional(S.String).pipe(T.HttpHeader("x-amz-grant-read-acp")), GrantWrite: S.optional(S.String).pipe(T.HttpHeader("x-amz-grant-write")), GrantWriteACP: S.optional(S.String).pipe(T.HttpHeader("x-amz-grant-write-acp")), ObjectLockEnabledForBucket: S.optional(S.Boolean).pipe(T.HttpHeader("x-amz-bucket-object-lock-enabled")), ObjectOwnership: S.optional(S.String).pipe(T.HttpHeader("x-amz-object-ownership"))}, T.all(ns, T.Http({ method: "PUT", uri: "/{Bucket}" }), svc, auth, proto, ver, rules, T.StaticContextParams({"UseS3ExpressControlEndpoint":{"value":true},"DisableAccessPoints":{"value":true}}))) {}
export class CreateBucketMetadataConfigurationRequest extends S.Class<CreateBucketMetadataConfigurationRequest>("CreateBucketMetadataConfigurationRequest")({Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket")), ContentMD5: S.optional(S.String).pipe(T.HttpHeader("Content-MD5")), ChecksumAlgorithm: S.optional(S.String).pipe(T.HttpHeader("x-amz-sdk-checksum-algorithm")), MetadataConfiguration: MetadataConfiguration.pipe(T.HttpPayload(), T.XmlName("MetadataConfiguration")), ExpectedBucketOwner: S.optional(S.String).pipe(T.HttpHeader("x-amz-expected-bucket-owner"))}, T.all(ns, T.Http({ method: "POST", uri: "/{Bucket}?metadataConfiguration" }), svc, auth, proto, ver, rules, T.AwsProtocolsHttpChecksum({ requestAlgorithmMember: "ChecksumAlgorithm", requestChecksumRequired: true }), T.StaticContextParams({"UseS3ExpressControlEndpoint":{"value":true}}))) {}
export class CreateBucketMetadataConfigurationResponse extends S.Class<CreateBucketMetadataConfigurationResponse>("CreateBucketMetadataConfigurationResponse")({}, ns) {}
export class CreateBucketMetadataTableConfigurationRequest extends S.Class<CreateBucketMetadataTableConfigurationRequest>("CreateBucketMetadataTableConfigurationRequest")({Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket")), ContentMD5: S.optional(S.String).pipe(T.HttpHeader("Content-MD5")), ChecksumAlgorithm: S.optional(S.String).pipe(T.HttpHeader("x-amz-sdk-checksum-algorithm")), MetadataTableConfiguration: MetadataTableConfiguration.pipe(T.HttpPayload(), T.XmlName("MetadataTableConfiguration")), ExpectedBucketOwner: S.optional(S.String).pipe(T.HttpHeader("x-amz-expected-bucket-owner"))}, T.all(ns, T.Http({ method: "POST", uri: "/{Bucket}?metadataTable" }), svc, auth, proto, ver, rules, T.AwsProtocolsHttpChecksum({ requestAlgorithmMember: "ChecksumAlgorithm", requestChecksumRequired: true }), T.StaticContextParams({"UseS3ExpressControlEndpoint":{"value":true}}))) {}
export class CreateBucketMetadataTableConfigurationResponse extends S.Class<CreateBucketMetadataTableConfigurationResponse>("CreateBucketMetadataTableConfigurationResponse")({}, ns) {}
export class CreateSessionOutput extends S.Class<CreateSessionOutput>("CreateSessionOutput")({ServerSideEncryption: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption")), SSEKMSKeyId: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-aws-kms-key-id")), SSEKMSEncryptionContext: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-context")), BucketKeyEnabled: S.optional(S.Boolean).pipe(T.HttpHeader("x-amz-server-side-encryption-bucket-key-enabled")), Credentials: SessionCredentials.pipe(T.XmlName("Credentials"))}, T.all(T.XmlName("CreateSessionResult"), ns)) {}
export class DeleteObjectsRequest extends S.Class<DeleteObjectsRequest>("DeleteObjectsRequest")({Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket")), Delete: Delete.pipe(T.HttpPayload(), T.XmlName("Delete")), MFA: S.optional(S.String).pipe(T.HttpHeader("x-amz-mfa")), RequestPayer: S.optional(S.String).pipe(T.HttpHeader("x-amz-request-payer")), BypassGovernanceRetention: S.optional(S.Boolean).pipe(T.HttpHeader("x-amz-bypass-governance-retention")), ExpectedBucketOwner: S.optional(S.String).pipe(T.HttpHeader("x-amz-expected-bucket-owner")), ChecksumAlgorithm: S.optional(S.String).pipe(T.HttpHeader("x-amz-sdk-checksum-algorithm"))}, T.all(ns, T.Http({ method: "POST", uri: "/{Bucket}?delete" }), svc, auth, proto, ver, rules, T.AwsProtocolsHttpChecksum({ requestAlgorithmMember: "ChecksumAlgorithm", requestChecksumRequired: true }))) {}
export class GetBucketPolicyStatusOutput extends S.Class<GetBucketPolicyStatusOutput>("GetBucketPolicyStatusOutput")({PolicyStatus: S.optional(PolicyStatus).pipe(T.HttpPayload())}, ns) {}
export class ListBucketsOutput extends S.Class<ListBucketsOutput>("ListBucketsOutput")({Buckets: S.optional(Buckets), Owner: S.optional(Owner), ContinuationToken: S.optional(S.String), Prefix: S.optional(S.String)}, T.all(T.XmlName("ListAllMyBucketsResult"), ns)) {}
export class ListMultipartUploadsOutput extends S.Class<ListMultipartUploadsOutput>("ListMultipartUploadsOutput")({Bucket: S.optional(S.String), KeyMarker: S.optional(S.String), UploadIdMarker: S.optional(S.String), NextKeyMarker: S.optional(S.String), Prefix: S.optional(S.String), Delimiter: S.optional(S.String), NextUploadIdMarker: S.optional(S.String), MaxUploads: S.optional(S.Number), IsTruncated: S.optional(S.Boolean), Uploads: S.optional(MultipartUploadList).pipe(T.XmlName("Upload"), T.XmlFlattened()), CommonPrefixes: S.optional(CommonPrefixList).pipe(T.XmlFlattened()), EncodingType: S.optional(S.String), RequestCharged: S.optional(S.String).pipe(T.HttpHeader("x-amz-request-charged"))}, T.all(T.XmlName("ListMultipartUploadsResult"), ns)) {}
...
export class ListPartsOutput extends S.Class<ListPartsOutput>("ListPartsOutput")({AbortDate: S.optional(S.Date.pipe(T.TimestampFormat("http-date"))).pipe(T.HttpHeader("x-amz-abort-date")), AbortRuleId: S.optional(S.String).pipe(T.HttpHeader("x-amz-abort-rule-id")), Bucket: S.optional(S.String), Key: S.optional(S.String), UploadId: S.optional(S.String), PartNumberMarker: S.optional(S.String), NextPartNumberMarker: S.optional(S.String), MaxParts: S.optional(S.Number), IsTruncated: S.optional(S.Boolean), Parts: S.optional(Parts).pipe(T.XmlName("Part"), T.XmlFlattened()), Initiator: S.optional(Initiator), Owner: S.optional(Owner), StorageClass: S.optional(S.String), RequestCharged: S.optional(S.String).pipe(T.HttpHeader("x-amz-request-charged")), ChecksumAlgorithm: S.optional(S.String), ChecksumType: S.optional(S.String)}, T.all(T.XmlName("ListPartsResult"), ns)) {}
export class PutBucketCorsRequest extends S.Class<PutBucketCorsRequest>("PutBucketCorsRequest")({Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket")), CORSConfiguration: CORSConfiguration.pipe(T.HttpPayload(), T.XmlName("CORSConfiguration")), ContentMD5: S.optional(S.String).pipe(T.HttpHeader("Content-MD5")), ChecksumAlgorithm: S.optional(S.String).pipe(T.HttpHeader("x-amz-sdk-checksum-algorithm")), ExpectedBucketOwner: S.optional(S.String).pipe(T.HttpHeader("x-amz-expected-bucket-owner"))}, T.all(ns, T.Http({ method: "PUT", uri: "/{Bucket}?cors" }), svc, auth, proto, ver, rules, T.AwsProtocolsHttpChecksum({ requestAlgorithmMember: "ChecksumAlgorithm", requestChecksumRequired: true }), T.StaticContextParams({"UseS3ExpressControlEndpoint":{"value":true}}))) {}
export class PutBucketCorsResponse extends S.Class<PutBucketCorsResponse>("PutBucketCorsResponse")({}, ns) {}
export class PutBucketOwnershipControlsRequest extends S.Class<PutBucketOwnershipControlsRequest>("PutBucketOwnershipControlsRequest")({Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket")), ContentMD5: S.optional(S.String).pipe(T.HttpHeader("Content-MD5")), ExpectedBucketOwner: S.optional(S.String).pipe(T.HttpHeader("x-amz-expected-bucket-owner")), OwnershipControls: OwnershipControls.pipe(T.HttpPayload(), T.XmlName("OwnershipControls")), ChecksumAlgorithm: S.optional(S.String).pipe(T.HttpHeader("x-amz-sdk-checksum-algorithm"))}, T.all(ns, T.Http({ method: "PUT", uri: "/{Bucket}?ownershipControls" }), svc, auth, proto, ver, rules, T.AwsProtocolsHttpChecksum({ requestAlgorithmMember: "ChecksumAlgorithm", requestChecksumRequired: true }), T.StaticContextParams({"UseS3ExpressControlEndpoint":{"value":true}}))) {}
export class PutBucketOwnershipControlsResponse extends S.Class<PutBucketOwnershipControlsResponse>("PutBucketOwnershipControlsResponse")({}, ns) {}
export class PutObjectLegalHoldOutput extends S.Class<PutObjectLegalHoldOutput>("PutObjectLegalHoldOutput")({RequestCharged: S.optional(S.String).pipe(T.HttpHeader("x-amz-request-charged"))}, ns) {}
export class PutObjectRetentionOutput extends S.Class<PutObjectRetentionOutput>("PutObjectRetentionOutput")({RequestCharged: S.optional(S.String).pipe(T.HttpHeader("x-amz-request-charged"))}, ns) {}
export class SelectObjectContentRequest extends S.Class<SelectObjectContentRequest>("SelectObjectContentRequest")({Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket")), Key: S.String.pipe(T.HttpLabel("Key")), SSECustomerAlgorithm: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-customer-algorithm")), SSECustomerKey: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-customer-key")), SSECustomerKeyMD5: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-customer-key-MD5")), Expression: S.String, ExpressionType: S.String, RequestProgress: S.optional(RequestProgress), InputSerialization: InputSerialization, OutputSerialization: OutputSerialization, ScanRange: S.optional(ScanRange), ExpectedBucketOwner: S.optional(S.String).pipe(T.HttpHeader("x-amz-expected-bucket-owner"))}, T.all(ns, T.Http({ method: "POST", uri: "/{Bucket}/{Key+}?select&select-type=2" }), svc, auth, proto, ver, rules)) {}
export class UpdateBucketMetadataInventoryTableConfigurationRequest extends S.Class<UpdateBucketMetadataInventoryTableConfigurationRequest>("UpdateBucketMetadataInventoryTableConfigurationRequest")({Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket")), ContentMD5: S.optional(S.String).pipe(T.HttpHeader("Content-MD5")), ChecksumAlgorithm: S.optional(S.String).pipe(T.HttpHeader("x-amz-sdk-checksum-algorithm")), InventoryTableConfiguration: InventoryTableConfigurationUpdates.pipe(T.HttpPayload(), T.XmlName("InventoryTableConfiguration")), ExpectedBucketOwner: S.optional(S.String).pipe(T.HttpHeader("x-amz-expected-bucket-owner"))}, T.all(ns, T.Http({ method: "PUT", uri: "/{Bucket}?metadataInventoryTable" }), svc, auth, proto, ver, rules, T.AwsProtocolsHttpChecksum({ requestAlgorithmMember: "ChecksumAlgorithm", requestChecksumRequired: true }), T.StaticContextParams({"UseS3ExpressControlEndpoint":{"value":true}}))) {}
export class UpdateBucketMetadataInventoryTableConfigurationResponse extends S.Class<UpdateBucketMetadataInventoryTableConfigurationResponse>("UpdateBucketMetadataInventoryTableConfigurationResponse")({}, ns) {}
export class UpdateBucketMetadataJournalTableConfigurationRequest extends S.Class<UpdateBucketMetadataJournalTableConfigurationRequest>("UpdateBucketMetadataJournalTableConfigurationRequest")({Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket")), ContentMD5: S.optional(S.String).pipe(T.HttpHeader("Content-MD5")), ChecksumAlgorithm: S.optional(S.String).pipe(T.HttpHeader("x-amz-sdk-checksum-algorithm")), JournalTableConfiguration: JournalTableConfigurationUpdates.pipe(T.HttpPayload(), T.XmlName("JournalTableConfiguration")), ExpectedBucketOwner: S.optional(S.String).pipe(T.HttpHeader("x-amz-expected-bucket-owner"))}, T.all(ns, T.Http({ method: "PUT", uri: "/{Bucket}?metadataJournalTable" }), svc, auth, proto, ver, rules, T.AwsProtocolsHttpChecksum({ requestAlgorithmMember: "ChecksumAlgorithm", requestChecksumRequired: true }), T.StaticContextParams({"UseS3ExpressControlEndpoint":{"value":true}}))) {}
export class UpdateBucketMetadataJournalTableConfigurationResponse extends S.Class<UpdateBucketMetadataJournalTableConfigurationResponse>("UpdateBucketMetadataJournalTableConfigurationResponse")({}, ns) {}
export class UploadPartCopyOutput extends S.Class<UploadPartCopyOutput>("UploadPartCopyOutput")({CopySourceVersionId: S.optional(S.String).pipe(T.HttpHeader("x-amz-copy-source-version-id")), CopyPartResult: S.optional(CopyPartResult).pipe(T.HttpPayload()), ServerSideEncryption: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption")), SSECustomerAlgorithm: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-customer-algorithm")), SSECustomerKeyMD5: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-customer-key-MD5")), SSEKMSKeyId: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-aws-kms-key-id")), BucketKeyEnabled: S.optional(S.Boolean).pipe(T.HttpHeader("x-amz-server-side-encryption-bucket-key-enabled")), RequestCharged: S.optional(S.String).pipe(T.HttpHeader("x-amz-request-charged"))}, ns) {}
...
export const UserMetadata = S.Array(MetadataEntry.pipe(T.XmlName("MetadataEntry")));
export class CopyObjectResult extends S.Class<CopyObjectResult>("CopyObjectResult")({ETag: S.optional(S.String), LastModified: S.optional(S.Date), ChecksumType: S.optional(S.String), ChecksumCRC32: S.optional(S.String), ChecksumCRC32C: S.optional(S.String), ChecksumCRC64NVME: S.optional(S.String), ChecksumSHA1: S.optional(S.String), ChecksumSHA256: S.optional(S.String)}) {}
export class GetObjectAttributesParts extends S.Class<GetObjectAttributesParts>("GetObjectAttributesParts")({TotalPartsCount: S.optional(S.Number).pipe(T.XmlName("PartsCount")), PartNumberMarker: S.optional(S.String), NextPartNumberMarker: S.optional(S.String), MaxParts: S.optional(S.Number), IsTruncated: S.optional(S.Boolean), Parts: S.optional(PartsList).pipe(T.XmlName("Part"), T.XmlFlattened())}) {}
...
export class CompleteMultipartUploadOutput extends S.Class<CompleteMultipartUploadOutput>("CompleteMultipartUploadOutput")({Location: S.optional(S.String), Bucket: S.optional(S.String), Key: S.optional(S.String), Expiration: S.optional(S.String).pipe(T.HttpHeader("x-amz-expiration")), ETag: S.optional(S.String), ChecksumCRC32: S.optional(S.String), ChecksumCRC32C: S.optional(S.String), ChecksumCRC64NVME: S.optional(S.String), ChecksumSHA1: S.optional(S.String), ChecksumSHA256: S.optional(S.String), ChecksumType: S.optional(S.String), ServerSideEncryption: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption")), VersionId: S.optional(S.String).pipe(T.HttpHeader("x-amz-version-id")), SSEKMSKeyId: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-aws-kms-key-id")), BucketKeyEnabled: S.optional(S.Boolean).pipe(T.HttpHeader("x-amz-server-side-encryption-bucket-key-enabled")), RequestCharged: S.optional(S.String).pipe(T.HttpHeader("x-amz-request-charged"))}, T.all(T.XmlName("CompleteMultipartUploadResult"), ns)) {}
export class CopyObjectOutput extends S.Class<CopyObjectOutput>("CopyObjectOutput")({CopyObjectResult: S.optional(CopyObjectResult).pipe(T.HttpPayload()), Expiration: S.optional(S.String).pipe(T.HttpHeader("x-amz-expiration")), CopySourceVersionId: S.optional(S.String).pipe(T.HttpHeader("x-amz-copy-source-version-id")), VersionId: S.optional(S.String).pipe(T.HttpHeader("x-amz-version-id")), ServerSideEncryption: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption")), SSECustomerAlgorithm: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-customer-algorithm")), SSECustomerKeyMD5: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-customer-key-MD5")), SSEKMSKeyId: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-aws-kms-key-id")), SSEKMSEncryptionContext: S.optional(S.String).pipe(T.HttpHeader("x-amz-server-side-encryption-context")), BucketKeyEnabled: S.optional(S.Boolean).pipe(T.HttpHeader("x-amz-server-side-encryption-bucket-key-enabled")), RequestCharged: S.optional(S.String).pipe(T.HttpHeader("x-amz-request-charged"))}, ns) {}
export class CreateBucketOutput extends S.Class<CreateBucketOutput>("CreateBucketOutput")({Location: S.optional(S.String).pipe(T.HttpHeader("Location")), BucketArn: S.optional(S.String).pipe(T.HttpHeader("x-amz-bucket-arn"))}, ns) {}
export class GetObjectAttributesOutput extends S.Class<GetObjectAttributesOutput>("GetObjectAttributesOutput")({DeleteMarker: S.optional(S.Boolean).pipe(T.HttpHeader("x-amz-delete-marker")), LastModified: S.optional(S.Date.pipe(T.TimestampFormat("http-date"))).pipe(T.HttpHeader("Last-Modified")), VersionId: S.optional(S.String).pipe(T.HttpHeader("x-amz-version-id")), RequestCharged: S.optional(S.String).pipe(T.HttpHeader("x-amz-request-charged")), ETag: S.optional(S.String), Checksum: S.optional(Checksum), ObjectParts: S.optional(GetObjectAttributesParts), StorageClass: S.optional(S.String), ObjectSize: S.optional(S.Number)}, T.all(T.XmlName("GetObjectAttributesResponse"), ns)) {}
...
export class PutBucketAclRequest extends S.Class<PutBucketAclRequest>("PutBucketAclRequest")({ACL: S.optional(S.String).pipe(T.HttpHeader("x-amz-acl")), AccessControlPolicy: S.optional(AccessControlPolicy).pipe(T.HttpPayload(), T.XmlName("AccessControlPolicy")), Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket")), ContentMD5: S.optional(S.String).pipe(T.HttpHeader("Content-MD5")), ChecksumAlgorithm: S.optional(S.String).pipe(T.HttpHeader("x-amz-sdk-checksum-algorithm")), GrantFullControl: S.optional(S.String).pipe(T.HttpHeader("x-amz-grant-full-control")), GrantRead: S.optional(S.String).pipe(T.HttpHeader("x-amz-grant-read")), GrantReadACP: S.optional(S.String).pipe(T.HttpHeader("x-amz-grant-read-acp")), GrantWrite: S.optional(S.String).pipe(T.HttpHeader("x-amz-grant-write")), GrantWriteACP: S.optional(S.String).pipe(T.HttpHeader("x-amz-grant-write-acp")), ExpectedBucketOwner: S.optional(S.String).pipe(T.HttpHeader("x-amz-expected-bucket-owner"))}, T.all(ns, T.Http({ method: "PUT", uri: "/{Bucket}?acl" }), svc, auth, proto, ver, rules, T.AwsProtocolsHttpChecksum({ requestAlgorithmMember: "ChecksumAlgorithm", requestChecksumRequired: true }), T.StaticContextParams({"UseS3ExpressControlEndpoint":{"value":true}}))) {}
export class PutBucketAclResponse extends S.Class<PutBucketAclResponse>("PutBucketAclResponse")({}, ns) {}
export class PutBucketEncryptionRequest extends S.Class<PutBucketEncryptionRequest>("PutBucketEncryptionRequest")({Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket")), ContentMD5: S.optional(S.String).pipe(T.HttpHeader("Content-MD5")), ChecksumAlgorithm: S.optional(S.String).pipe(T.HttpHeader("x-amz-sdk-checksum-algorithm")), ServerSideEncryptionConfiguration: ServerSideEncryptionConfiguration.pipe(T.HttpPayload(), T.XmlName("ServerSideEncryptionConfiguration")), ExpectedBucketOwner: S.optional(S.String).pipe(T.HttpHeader("x-amz-expected-bucket-owner"))}, T.all(ns, T.Http({ method: "PUT", uri: "/{Bucket}?encryption" }), svc, auth, proto, ver, rules, T.AwsProtocolsHttpChecksum({ requestAlgorithmMember: "ChecksumAlgorithm", requestChecksumRequired: true }), T.StaticContextParams({"UseS3ExpressControlEndpoint":{"value":true}}))) {}
export class PutBucketEncryptionResponse extends S.Class<PutBucketEncryptionResponse>("PutBucketEncryptionResponse")({}, ns) {}
export class PutBucketIntelligentTieringConfigurationRequest extends S.Class<PutBucketIntelligentTieringConfigurationRequest>("PutBucketIntelligentTieringConfigurationRequest")({Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket")), Id: S.String.pipe(T.HttpQuery("id")), ExpectedBucketOwner: S.optional(S.String).pipe(T.HttpHeader("x-amz-expected-bucket-owner")), IntelligentTieringConfiguration: IntelligentTieringConfiguration.pipe(T.HttpPayload(), T.XmlName("IntelligentTieringConfiguration"))}, T.all(ns, T.Http({ method: "PUT", uri: "/{Bucket}?intelligent-tiering" }), svc, auth, proto, ver, rules, T.StaticContextParams({"UseS3ExpressControlEndpoint":{"value":true}}))) {}
export class PutBucketIntelligentTieringConfigurationResponse extends S.Class<PutBucketIntelligentTieringConfigurationResponse>("PutBucketIntelligentTieringConfigurationResponse")({}, ns) {}
export class PutBucketMetricsConfigurationRequest extends S.Class<PutBucketMetricsConfigurationRequest>("PutBucketMetricsConfigurationRequest")({Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket")), Id: S.String.pipe(T.HttpQuery("id")), MetricsConfiguration: MetricsConfiguration.pipe(T.HttpPayload(), T.XmlName("MetricsConfiguration")), ExpectedBucketOwner: S.optional(S.String).pipe(T.HttpHeader("x-amz-expected-bucket-owner"))}, T.all(ns, T.Http({ method: "PUT", uri: "/{Bucket}?metrics" }), svc, auth, proto, ver, rules, T.StaticContextParams({"UseS3ExpressControlEndpoint":{"value":true}}))) {}
export class PutBucketMetricsConfigurationResponse extends S.Class<PutBucketMetricsConfigurationResponse>("PutBucketMetricsConfigurationResponse")({}, ns) {}
export class PutBucketWebsiteRequest extends S.Class<PutBucketWebsiteRequest>("PutBucketWebsiteRequest")({Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket")), ContentMD5: S.optional(S.String).pipe(T.HttpHeader("Content-MD5")), ChecksumAlgorithm: S.optional(S.String).pipe(T.HttpHeader("x-amz-sdk-checksum-algorithm")), WebsiteConfiguration: WebsiteConfiguration.pipe(T.HttpPayload(), T.XmlName("WebsiteConfiguration")), ExpectedBucketOwner: S.optional(S.String).pipe(T.HttpHeader("x-amz-expected-bucket-owner"))}, T.all(ns, T.Http({ method: "PUT", uri: "/{Bucket}?website" }), svc, auth, proto, ver, rules, T.AwsProtocolsHttpChecksum({ requestAlgorithmMember: "ChecksumAlgorithm", requestChecksumRequired: true }), T.StaticContextParams({"UseS3ExpressControlEndpoint":{"value":true}}))) {}
export class PutBucketWebsiteResponse extends S.Class<PutBucketWebsiteResponse>("PutBucketWebsiteResponse")({}, ns) {}
export class PutObjectLockConfigurationRequest extends S.Class<PutObjectLockConfigurationRequest>("PutObjectLockConfigurationRequest")({Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket")), ObjectLockConfiguration: S.optional(ObjectLockConfiguration).pipe(T.HttpPayload(), T.XmlName("ObjectLockConfiguration")), RequestPayer: S.optional(S.String).pipe(T.HttpHeader("x-amz-request-payer")), Token: S.optional(S.String).pipe(T.HttpHeader("x-amz-bucket-object-lock-token")), ContentMD5: S.optional(S.String).pipe(T.HttpHeader("Content-MD5")), ChecksumAlgorithm: S.optional(S.String).pipe(T.HttpHeader("x-amz-sdk-checksum-algorithm")), ExpectedBucketOwner: S.optional(S.String).pipe(T.HttpHeader("x-amz-expected-bucket-owner"))}, T.all(ns, T.Http({ method: "PUT", uri: "/{Bucket}?object-lock" }), svc, auth, proto, ver, rules, T.AwsProtocolsHttpChecksum({ requestAlgorithmMember: "ChecksumAlgorithm", requestChecksumRequired: true }))) {}
...
export class BucketLifecycleConfiguration extends S.Class<BucketLifecycleConfiguration>("BucketLifecycleConfiguration")({Rules: LifecycleRules.pipe(T.XmlName("Rule"), T.XmlFlattened())}) {}
...
export class GetBucketMetadataConfigurationOutput extends S.Class<GetBucketMetadataConfigurationOutput>("GetBucketMetadataConfigurationOutput")({GetBucketMetadataConfigurationResult: S.optional(GetBucketMetadataConfigurationResult).pipe(T.HttpPayload())}, ns) {}
export class GetBucketMetadataTableConfigurationOutput extends S.Class<GetBucketMetadataTableConfigurationOutput>("GetBucketMetadataTableConfigurationOutput")({GetBucketMetadataTableConfigurationResult: S.optional(GetBucketMetadataTableConfigurationResult).pipe(T.HttpPayload())}, ns) {}
export class PutBucketLifecycleConfigurationRequest extends S.Class<PutBucketLifecycleConfigurationRequest>("PutBucketLifecycleConfigurationRequest")({Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket")), ChecksumAlgorithm: S.optional(S.String).pipe(T.HttpHeader("x-amz-sdk-checksum-algorithm")), LifecycleConfiguration: S.optional(BucketLifecycleConfiguration).pipe(T.HttpPayload(), T.XmlName("LifecycleConfiguration")), ExpectedBucketOwner: S.optional(S.String).pipe(T.HttpHeader("x-amz-expected-bucket-owner")), TransitionDefaultMinimumObjectSize: S.optional(S.String).pipe(T.HttpHeader("x-amz-transition-default-minimum-object-size"))}, T.all(ns, T.Http({ method: "PUT", uri: "/{Bucket}?lifecycle" }), svc, auth, proto, ver, rules, T.AwsProtocolsHttpChecksum({ requestAlgorithmMember: "ChecksumAlgorithm", requestChecksumRequired: true }), T.StaticContextParams({"UseS3ExpressControlEndpoint":{"value":true}}))) {}
export class PutBucketLoggingRequest extends S.Class<PutBucketLoggingRequest>("PutBucketLoggingRequest")({Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket")), BucketLoggingStatus: BucketLoggingStatus.pipe(T.HttpPayload(), T.XmlName("BucketLoggingStatus")), ContentMD5: S.optional(S.String).pipe(T.HttpHeader("Content-MD5")), ChecksumAlgorithm: S.optional(S.String).pipe(T.HttpHeader("x-amz-sdk-checksum-algorithm")), ExpectedBucketOwner: S.optional(S.String).pipe(T.HttpHeader("x-amz-expected-bucket-owner"))}, T.all(ns, T.Http({ method: "PUT", uri: "/{Bucket}?logging" }), svc, auth, proto, ver, rules, T.AwsProtocolsHttpChecksum({ requestAlgorithmMember: "ChecksumAlgorithm", requestChecksumRequired: true }), T.StaticContextParams({"UseS3ExpressControlEndpoint":{"value":true}}))) {}
export class PutBucketLoggingResponse extends S.Class<PutBucketLoggingResponse>("PutBucketLoggingResponse")({}, ns) {}
export class PutObjectLockConfigurationOutput extends S.Class<PutObjectLockConfigurationOutput>("PutObjectLockConfigurationOutput")({RequestCharged: S.optional(S.String).pipe(T.HttpHeader("x-amz-request-charged"))}, ns) {}
export class RestoreObjectRequest extends S.Class<RestoreObjectRequest>("RestoreObjectRequest")({Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket")), Key: S.String.pipe(T.HttpLabel("Key")), VersionId: S.optional(S.String).pipe(T.HttpQuery("versionId")), RestoreRequest: S.optional(RestoreRequest).pipe(T.HttpPayload(), T.XmlName("RestoreRequest")), RequestPayer: S.optional(S.String).pipe(T.HttpHeader("x-amz-request-payer")), ChecksumAlgorithm: S.optional(S.String).pipe(T.HttpHeader("x-amz-sdk-checksum-algorithm")), ExpectedBucketOwner: S.optional(S.String).pipe(T.HttpHeader("x-amz-expected-bucket-owner"))}, T.all(ns, T.Http({ method: "POST", uri: "/{Bucket}/{Key+}?restore" }), svc, auth, proto, ver, rules, T.AwsProtocolsHttpChecksum({ requestAlgorithmMember: "ChecksumAlgorithm" }))) {}
export class TopicConfiguration extends S.Class<TopicConfiguration>("TopicConfiguration")({Id: S.optional(S.String), TopicArn: S.String.pipe(T.XmlName("Topic")), Events: EventList.pipe(T.XmlName("Event"), T.XmlFlattened()), Filter: S.optional(NotificationConfigurationFilter)}) {}
export const TopicConfigurationList = S.Array(TopicConfiguration);
export class RecordsEvent extends S.Class<RecordsEvent>("RecordsEvent")({Payload: S.optional(T.Blob).pipe(T.EventPayload())}) {}
export class NotificationConfiguration extends S.Class<NotificationConfiguration>("NotificationConfiguration")({TopicConfigurations: S.optional(TopicConfigurationList).pipe(T.XmlName("TopicConfiguration"), T.XmlFlattened()), QueueConfigurations: S.optional(QueueConfigurationList).pipe(T.XmlName("QueueConfiguration"), T.XmlFlattened()), LambdaFunctionConfigurations: S.optional(LambdaFunctionConfigurationList).pipe(T.XmlName("CloudFunctionConfiguration"), T.XmlFlattened()), EventBridgeConfiguration: S.optional(EventBridgeConfiguration)}, ns) {}
...
export class PutBucketAnalyticsConfigurationRequest extends S.Class<PutBucketAnalyticsConfigurationRequest>("PutBucketAnalyticsConfigurationRequest")({Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket")), Id: S.String.pipe(T.HttpQuery("id")), AnalyticsConfiguration: AnalyticsConfiguration.pipe(T.HttpPayload(), T.XmlName("AnalyticsConfiguration")), ExpectedBucketOwner: S.optional(S.String).pipe(T.HttpHeader("x-amz-expected-bucket-owner"))}, T.all(ns, T.Http({ method: "PUT", uri: "/{Bucket}?analytics" }), svc, auth, proto, ver, rules, T.StaticContextParams({"UseS3ExpressControlEndpoint":{"value":true}}))) {}
export class PutBucketAnalyticsConfigurationResponse extends S.Class<PutBucketAnalyticsConfigurationResponse>("PutBucketAnalyticsConfigurationResponse")({}, ns) {}
export class PutBucketInventoryConfigurationRequest extends S.Class<PutBucketInventoryConfigurationRequest>("PutBucketInventoryConfigurationRequest")({Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket")), Id: S.String.pipe(T.HttpQuery("id")), InventoryConfiguration: InventoryConfiguration.pipe(T.HttpPayload(), T.XmlName("InventoryConfiguration")), ExpectedBucketOwner: S.optional(S.String).pipe(T.HttpHeader("x-amz-expected-bucket-owner"))}, T.all(ns, T.Http({ method: "PUT", uri: "/{Bucket}?inventory" }), svc, auth, proto, ver, rules, T.StaticContextParams({"UseS3ExpressControlEndpoint":{"value":true}}))) {}
export class PutBucketInventoryConfigurationResponse extends S.Class<PutBucketInventoryConfigurationResponse>("PutBucketInventoryConfigurationResponse")({}, ns) {}
export class PutBucketLifecycleConfigurationOutput extends S.Class<PutBucketLifecycleConfigurationOutput>("PutBucketLifecycleConfigurationOutput")({TransitionDefaultMinimumObjectSize: S.optional(S.String).pipe(T.HttpHeader("x-amz-transition-default-minimum-object-size"))}, ns) {}
export class PutBucketNotificationConfigurationRequest extends S.Class<PutBucketNotificationConfigurationRequest>("PutBucketNotificationConfigurationRequest")({Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket")), NotificationConfiguration: NotificationConfiguration.pipe(T.HttpPayload(), T.XmlName("NotificationConfiguration")), ExpectedBucketOwner: S.optional(S.String).pipe(T.HttpHeader("x-amz-expected-bucket-owner")), SkipDestinationValidation: S.optional(S.Boolean).pipe(T.HttpHeader("x-amz-skip-destination-validation"))}, T.all(ns, T.Http({ method: "PUT", uri: "/{Bucket}?notification" }), svc, auth, proto, ver, rules, T.StaticContextParams({"UseS3ExpressControlEndpoint":{"value":true}}))) {}
export class PutBucketNotificationConfigurationResponse extends S.Class<PutBucketNotificationConfigurationResponse>("PutBucketNotificationConfigurationResponse")({}, ns) {}
export class PutBucketReplicationRequest extends S.Class<PutBucketReplicationRequest>("PutBucketReplicationRequest")({Bucket: S.String.pipe(T.HttpLabel("Bucket"), T.ContextParam("Bucket")), ContentMD5: S.optional(S.String).pipe(T.HttpHeader("Content-MD5")), ChecksumAlgorithm: S.optional(S.String).pipe(T.HttpHeader("x-amz-sdk-checksum-algorithm")), ReplicationConfiguration: ReplicationConfiguration.pipe(T.HttpPayload(), T.XmlName("ReplicationConfiguration")), Token: S.optional(S.String).pipe(T.HttpHeader("x-amz-bucket-object-lock-token")), ExpectedBucketOwner: S.optional(S.String).pipe(T.HttpHeader("x-amz-expected-bucket-owner"))}, T.all(ns, T.Http({ method: "PUT", uri: "/{Bucket}?replication" }), svc, auth, proto, ver, rules, T.AwsProtocolsHttpChecksum({ requestAlgorithmMember: "ChecksumAlgorithm", requestChecksumRequired: true }), T.StaticContextParams({"UseS3ExpressControlEndpoint":{"value":true}}))) {}
export class PutBucketReplicationResponse extends S.Class<PutBucketReplicationResponse>("PutBucketReplicationResponse")({}, ns) {}
export class RestoreObjectOutput extends S.Class<RestoreObjectOutput>("RestoreObjectOutput")({RequestCharged: S.optional(S.String).pipe(T.HttpHeader("x-amz-request-charged")), RestoreOutputPath: S.optional(S.String).pipe(T.HttpHeader("x-amz-restore-output-path"))}, ns) {}
export class StatsEvent extends S.Class<StatsEvent>("StatsEvent")({Details: S.optional(Stats).pipe(T.EventPayload())}) {}
export class ProgressEvent extends S.Class<ProgressEvent>("ProgressEvent")({Details: S.optional(Progress).pipe(T.EventPayload())}) {}
export const SelectObjectContentEventStream = T.EventStream(S.Union(S.Struct({ Records: RecordsEvent }), S.Struct({ Stats: StatsEvent }), S.Struct({ Progress: ProgressEvent }), S.Struct({ Cont: ContinuationEvent }), S.Struct({ End: EndEvent })));
export class SelectObjectContentOutput extends S.Class<SelectObjectContentOutput>("SelectObjectContentOutput")({Payload: S.optional(SelectObjectContentEventStream).pipe(T.HttpPayload())}, ns) {}

//# Errors
export class BucketNotEmpty extends S.TaggedError<BucketNotEmpty>()("BucketNotEmpty", {}) {}
...
export class MalformedPolicy extends S.TaggedError<MalformedPolicy>()("MalformedPolicy", {}) {}
...
export class NoSuchConfiguration extends S.TaggedError<NoSuchConfiguration>()("NoSuchConfiguration", {}) {}
export class NoSuchCORSConfiguration extends S.TaggedError<NoSuchCORSConfiguration>()("NoSuchCORSConfiguration", {}) {}
export class ParseError extends S.TaggedError<ParseError>()("ParseError", {}) {}
export class NoSuchLifecycleConfiguration extends S.TaggedError<NoSuchLifecycleConfiguration>()("NoSuchLifecycleConfiguration", {}) {}
export class NoSuchBucketPolicy extends S.TaggedError<NoSuchBucketPolicy>()("NoSuchBucketPolicy", {}) {}
export class ReplicationConfigurationNotFoundError extends S.TaggedError<ReplicationConfigurationNotFoundError>()("ReplicationConfigurationNotFoundError", {}) {}
export class NoSuchTagSet extends S.TaggedError<NoSuchTagSet>()("NoSuchTagSet", {}) {}
export class NoSuchWebsiteConfiguration extends S.TaggedError<NoSuchWebsiteConfiguration>()("NoSuchWebsiteConfiguration", {}) {}
export class InvalidRequest extends S.TaggedError<InvalidRequest>()("InvalidRequest", {}) {}
export class ObjectLockConfigurationNotFoundError extends S.TaggedError<ObjectLockConfigurationNotFoundError>()("ObjectLockConfigurationNotFoundError", {}) {}
...
export class MalformedXML extends S.TaggedError<MalformedXML>()("MalformedXML", {}) {}
...
export class IllegalLocationConstraintException extends S.TaggedError<IllegalLocationConstraintException>()("IllegalLocationConstraintException", {}) {}
export class InvalidArgument extends S.TaggedError<InvalidArgument>()("InvalidArgument", {}) {}
export class InvalidBucketName extends S.TaggedError<InvalidBucketName>()("InvalidBucketName", {}) {}
export class InvalidLocationConstraint extends S.TaggedError<InvalidLocationConstraint>()("InvalidLocationConstraint", {}) {}
export class InvalidBucketState extends S.TaggedError<InvalidBucketState>()("InvalidBucketState", {}) {}
 ...
 */
export const deleteBucket = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteBucketRequest, output: DeleteBucketResponse, errors: [BucketNotEmpty, NoSuchBucket] }));
/**
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const deleteBucketAnalyticsConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteBucketAnalyticsConfigurationRequest, output: DeleteBucketAnalyticsConfigurationResponse, errors: [NoSuchBucket] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const deleteBucketCors = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteBucketCorsRequest, output: DeleteBucketCorsResponse, errors: [NoSuchBucket] }));
/**
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const deleteBucketEncryption = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteBucketEncryptionRequest, output: DeleteBucketEncryptionResponse, errors: [NoSuchBucket] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const deleteBucketIntelligentTieringConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteBucketIntelligentTieringConfigurationRequest, output: DeleteBucketIntelligentTieringConfigurationResponse, errors: [NoSuchBucket] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const deleteBucketInventoryConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteBucketInventoryConfigurationRequest, output: DeleteBucketInventoryConfigurationResponse, errors: [NoSuchBucket] }));
/**
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const deleteBucketLifecycle = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteBucketLifecycleRequest, output: DeleteBucketLifecycleResponse, errors: [] }));
/**
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const deleteBucketMetadataConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteBucketMetadataConfigurationRequest, output: DeleteBucketMetadataConfigurationResponse, errors: [] }));
/**
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const deleteBucketMetadataTableConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteBucketMetadataTableConfigurationRequest, output: DeleteBucketMetadataTableConfigurationResponse, errors: [] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const deleteBucketMetricsConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteBucketMetricsConfigurationRequest, output: DeleteBucketMetricsConfigurationResponse, errors: [NoSuchBucket] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const deleteBucketOwnershipControls = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteBucketOwnershipControlsRequest, output: DeleteBucketOwnershipControlsResponse, errors: [NoSuchBucket] }));
/**
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const deleteBucketPolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteBucketPolicyRequest, output: DeleteBucketPolicyResponse, errors: [NoSuchBucket] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const deleteBucketReplication = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteBucketReplicationRequest, output: DeleteBucketReplicationResponse, errors: [NoSuchBucket] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const deleteBucketTagging = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteBucketTaggingRequest, output: DeleteBucketTaggingResponse, errors: [NoSuchBucket] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const deleteBucketWebsite = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteBucketWebsiteRequest, output: DeleteBucketWebsiteResponse, errors: [NoSuchBucket] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const deletePublicAccessBlock = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeletePublicAccessBlockRequest, output: DeletePublicAccessBlockResponse, errors: [NoSuchBucket] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const getBucketNotificationConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetBucketNotificationConfigurationRequest, output: NotificationConfiguration, errors: [NoSuchBucket] }));
/**
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const putBucketPolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutBucketPolicyRequest, output: PutBucketPolicyResponse, errors: [AccessDenied, MalformedPolicy, NoSuchBucket] }));
/**
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const renameObject = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: RenameObjectRequest, output: RenameObjectOutput, errors: [IdempotencyParameterMismatch] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const writeGetObjectResponse = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: WriteGetObjectResponseRequest, output: WriteGetObjectResponseResponse, errors: [] }));
/**
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const abortMultipartUpload = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: AbortMultipartUploadRequest, output: AbortMultipartUploadOutput, errors: [NoSuchUpload, NoSuchBucket] }));
/**
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const createMultipartUpload = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateMultipartUploadRequest, output: CreateMultipartUploadOutput, errors: [NoSuchBucket] }));
/**
 ...
 */
export const deleteObject = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteObjectRequest, output: DeleteObjectOutput, errors: [NoSuchBucket] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const deleteObjectTagging = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteObjectTaggingRequest, output: DeleteObjectTaggingOutput, errors: [NoSuchKey] }));
/**
 ...
 */
export const getBucketAbac = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetBucketAbacRequest, output: GetBucketAbacOutput, errors: [] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const getBucketAccelerateConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetBucketAccelerateConfigurationRequest, output: GetBucketAccelerateConfigurationOutput, errors: [NoSuchBucket] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * - ListObjects
 */
export const getBucketAcl = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetBucketAclRequest, output: GetBucketAclOutput, errors: [NoSuchBucket] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const getBucketAnalyticsConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetBucketAnalyticsConfigurationRequest, output: GetBucketAnalyticsConfigurationOutput, errors: [NoSuchBucket, NoSuchConfiguration] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const getBucketCors = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetBucketCorsRequest, output: GetBucketCorsOutput, errors: [NoSuchBucket, NoSuchCORSConfiguration] }));
/**
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const getBucketEncryption = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetBucketEncryptionRequest, output: GetBucketEncryptionOutput, errors: [NoSuchBucket, ParseError] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const getBucketIntelligentTieringConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetBucketIntelligentTieringConfigurationRequest, output: GetBucketIntelligentTieringConfigurationOutput, errors: [NoSuchBucket, NoSuchConfiguration] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const getBucketInventoryConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetBucketInventoryConfigurationRequest, output: GetBucketInventoryConfigurationOutput, errors: [NoSuchBucket, NoSuchConfiguration] }));
/**
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const getBucketLifecycleConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetBucketLifecycleConfigurationRequest, output: GetBucketLifecycleConfigurationOutput, errors: [NoSuchBucket, NoSuchLifecycleConfiguration] }));
/**
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const getBucketLocation = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetBucketLocationRequest, output: GetBucketLocationOutput, errors: [NoSuchBucket] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const getBucketLogging = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetBucketLoggingRequest, output: GetBucketLoggingOutput, errors: [NoSuchBucket] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const getBucketMetricsConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetBucketMetricsConfigurationRequest, output: GetBucketMetricsConfigurationOutput, errors: [NoSuchBucket, NoSuchConfiguration] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const getBucketOwnershipControls = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetBucketOwnershipControlsRequest, output: GetBucketOwnershipControlsOutput, errors: [NoSuchBucket] }));
/**
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const getBucketPolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetBucketPolicyRequest, output: GetBucketPolicyOutput, errors: [NoSuchBucket, NoSuchBucketPolicy] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const getBucketReplication = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetBucketReplicationRequest, output: GetBucketReplicationOutput, errors: [NoSuchBucket, ReplicationConfigurationNotFoundError] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const getBucketRequestPayment = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetBucketRequestPaymentRequest, output: GetBucketRequestPaymentOutput, errors: [NoSuchBucket] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const getBucketTagging = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetBucketTaggingRequest, output: GetBucketTaggingOutput, errors: [NoSuchBucket, NoSuchTagSet] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const getBucketVersioning = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetBucketVersioningRequest, output: GetBucketVersioningOutput, errors: [NoSuchBucket] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const getBucketWebsite = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetBucketWebsiteRequest, output: GetBucketWebsiteOutput, errors: [NoSuchBucket, NoSuchWebsiteConfiguration] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const getObjectAcl = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetObjectAclRequest, output: GetObjectAclOutput, errors: [NoSuchKey, NoSuchBucket] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const getObjectLegalHold = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetObjectLegalHoldRequest, output: GetObjectLegalHoldOutput, errors: [InvalidRequest] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const getObjectLockConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetObjectLockConfigurationRequest, output: GetObjectLockConfigurationOutput, errors: [NoSuchBucket, ObjectLockConfigurationNotFoundError] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const getObjectRetention = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetObjectRetentionRequest, output: GetObjectRetentionOutput, errors: [InvalidRequest] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const getObjectTagging = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetObjectTaggingRequest, output: GetObjectTaggingOutput, errors: [NoSuchBucket, NoSuchKey] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const getObjectTorrent = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetObjectTorrentRequest, output: GetObjectTorrentOutput, errors: [] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const getPublicAccessBlock = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetPublicAccessBlockRequest, output: GetPublicAccessBlockOutput, errors: [NoSuchBucket] }));
/**
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const headBucket = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: HeadBucketRequest, output: HeadBucketOutput, errors: [NotFound, ParseError] }));
/**
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const headObject = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: HeadObjectRequest, output: HeadObjectOutput, errors: [NotFound, ParseError] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const listBucketAnalyticsConfigurations = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListBucketAnalyticsConfigurationsRequest, output: ListBucketAnalyticsConfigurationsOutput, errors: [NoSuchBucket] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const listBucketIntelligentTieringConfigurations = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListBucketIntelligentTieringConfigurationsRequest, output: ListBucketIntelligentTieringConfigurationsOutput, errors: [NoSuchBucket] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const listBucketInventoryConfigurations = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListBucketInventoryConfigurationsRequest, output: ListBucketInventoryConfigurationsOutput, errors: [NoSuchBucket] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const listBucketMetricsConfigurations = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListBucketMetricsConfigurationsRequest, output: ListBucketMetricsConfigurationsOutput, errors: [NoSuchBucket] }));
/**
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const listDirectoryBuckets = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListDirectoryBucketsRequest, output: ListDirectoryBucketsOutput, errors: [] }));
/**
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const listObjectsV2 = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListObjectsV2Request, output: ListObjectsV2Output, errors: [NoSuchBucket] }));
/**
 ...
 */
export const putBucketAbac = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutBucketAbacRequest, output: PutBucketAbacResponse, errors: [] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const putBucketAccelerateConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutBucketAccelerateConfigurationRequest, output: PutBucketAccelerateConfigurationResponse, errors: [NoSuchBucket] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const putBucketRequestPayment = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutBucketRequestPaymentRequest, output: PutBucketRequestPaymentResponse, errors: [NoSuchBucket] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const putBucketTagging = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutBucketTaggingRequest, output: PutBucketTaggingResponse, errors: [NoSuchBucket] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const putBucketVersioning = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutBucketVersioningRequest, output: PutBucketVersioningResponse, errors: [NoSuchBucket] }));
/**
 * End of support notice: As of October 1, 2025, Amazon S3 has discontinued support for Email Grantee Access Control Lists (ACLs). If you attempt to use an Email Grantee ACL in a request after October 1, 2025,
 * the request will receive an `HTTP 405` (Method Not Allowed) error.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const putObject = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutObjectRequest, output: PutObjectOutput, errors: [EncryptionTypeMismatch, InvalidRequest, InvalidWriteOffset, TooManyParts, NoSuchBucket] }));
/**
 * End of support notice: As of October 1, 2025, Amazon S3 has discontinued support for Email Grantee Access Control Lists (ACLs). If you attempt to use an Email Grantee ACL in a request after October 1, 2025,
 * the request will receive an `HTTP 405` (Method Not Allowed) error.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const putObjectAcl = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutObjectAclRequest, output: PutObjectAclOutput, errors: [NoSuchKey] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const putObjectTagging = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutObjectTaggingRequest, output: PutObjectTaggingOutput, errors: [NoSuchKey] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const putPublicAccessBlock = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutPublicAccessBlockRequest, output: PutPublicAccessBlockResponse, errors: [NoSuchBucket] }));
/**
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const uploadPart = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UploadPartRequest, output: UploadPartOutput, errors: [NoSuchBucket] }));
/**
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const createBucketMetadataConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateBucketMetadataConfigurationRequest, output: CreateBucketMetadataConfigurationResponse, errors: [] }));
/**
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const createBucketMetadataTableConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateBucketMetadataTableConfigurationRequest, output: CreateBucketMetadataTableConfigurationResponse, errors: [] }));
/**
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const createSession = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateSessionRequest, output: CreateSessionOutput, errors: [NoSuchBucket] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const getBucketPolicyStatus = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetBucketPolicyStatusRequest, output: GetBucketPolicyStatusOutput, errors: [] }));
/**
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const getObject = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetObjectRequest, output: GetObjectOutput, errors: [InvalidObjectState, NoSuchKey, NoSuchBucket] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const listBuckets = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListBucketsRequest, output: ListBucketsOutput, errors: [] }));
/**
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const listMultipartUploads = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListMultipartUploadsRequest, output: ListMultipartUploadsOutput, errors: [NoSuchBucket] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const listObjectVersions = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListObjectVersionsRequest, output: ListObjectVersionsOutput, errors: [NoSuchBucket] }));
/**
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const listParts = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListPartsRequest, output: ListPartsOutput, errors: [NoSuchBucket] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const putBucketCors = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutBucketCorsRequest, output: PutBucketCorsResponse, errors: [NoSuchBucket] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const putBucketOwnershipControls = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutBucketOwnershipControlsRequest, output: PutBucketOwnershipControlsResponse, errors: [NoSuchBucket] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const putObjectLegalHold = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutObjectLegalHoldRequest, output: PutObjectLegalHoldOutput, errors: [MalformedXML] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const putObjectRetention = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutObjectRetentionRequest, output: PutObjectRetentionOutput, errors: [InvalidRequest] }));
/**
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const updateBucketMetadataInventoryTableConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateBucketMetadataInventoryTableConfigurationRequest, output: UpdateBucketMetadataInventoryTableConfigurationResponse, errors: [] }));
/**
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const updateBucketMetadataJournalTableConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateBucketMetadataJournalTableConfigurationRequest, output: UpdateBucketMetadataJournalTableConfigurationResponse, errors: [] }));
/**
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const uploadPartCopy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UploadPartCopyRequest, output: UploadPartCopyOutput, errors: [NoSuchBucket] }));
/**
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const completeMultipartUpload = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CompleteMultipartUploadRequest, output: CompleteMultipartUploadOutput, errors: [] }));
/**
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const copyObject = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CopyObjectRequest, output: CopyObjectOutput, errors: [ObjectNotInActiveTierError, NoSuchBucket] }));
/**
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const createBucket = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateBucketRequest, output: CreateBucketOutput, errors: [BucketAlreadyExists, BucketAlreadyOwnedByYou, IllegalLocationConstraintException, InvalidArgument, InvalidBucketName, InvalidLocationConstraint] }));
/**
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const getObjectAttributes = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetObjectAttributesRequest, output: GetObjectAttributesOutput, errors: [NoSuchKey] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const listObjects = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListObjectsRequest, output: ListObjectsOutput, errors: [NoSuchBucket] }));
/**
 * End of support notice: As of October 1, 2025, Amazon S3 has discontinued support for Email Grantee Access Control Lists (ACLs). If you attempt to use an Email Grantee ACL in a request after October 1, 2025,
 * the request will receive an `HTTP 405` (Method Not Allowed) error.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const putBucketAcl = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutBucketAclRequest, output: PutBucketAclResponse, errors: [NoSuchBucket] }));
/**
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const putBucketEncryption = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutBucketEncryptionRequest, output: PutBucketEncryptionResponse, errors: [NoSuchBucket] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const putBucketIntelligentTieringConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutBucketIntelligentTieringConfigurationRequest, output: PutBucketIntelligentTieringConfigurationResponse, errors: [NoSuchBucket] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const putBucketMetricsConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutBucketMetricsConfigurationRequest, output: PutBucketMetricsConfigurationResponse, errors: [NoSuchBucket] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const putBucketWebsite = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutBucketWebsiteRequest, output: PutBucketWebsiteResponse, errors: [NoSuchBucket] }));
/**
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const deleteObjects = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteObjectsRequest, output: DeleteObjectsOutput, errors: [NoSuchBucket] }));
/**
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const getBucketMetadataConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetBucketMetadataConfigurationRequest, output: GetBucketMetadataConfigurationOutput, errors: [] }));
/**
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const getBucketMetadataTableConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetBucketMetadataTableConfigurationRequest, output: GetBucketMetadataTableConfigurationOutput, errors: [] }));
/**
 * End of support notice: As of October 1, 2025, Amazon S3 has discontinued support for Email Grantee Access Control Lists (ACLs). If you attempt to use an Email Grantee ACL in a request after October 1, 2025,
 * the request will receive an `HTTP 405` (Method Not Allowed) error.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const putBucketLogging = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutBucketLoggingRequest, output: PutBucketLoggingResponse, errors: [NoSuchBucket] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const putObjectLockConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutObjectLockConfigurationRequest, output: PutObjectLockConfigurationOutput, errors: [InvalidBucketState, NoSuchBucket] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const putBucketAnalyticsConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutBucketAnalyticsConfigurationRequest, output: PutBucketAnalyticsConfigurationResponse, errors: [] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const putBucketInventoryConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutBucketInventoryConfigurationRequest, output: PutBucketInventoryConfigurationResponse, errors: [NoSuchBucket] }));
/**
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const putBucketLifecycleConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutBucketLifecycleConfigurationRequest, output: PutBucketLifecycleConfigurationOutput, errors: [InvalidRequest, MalformedXML, NoSuchBucket] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const putBucketNotificationConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutBucketNotificationConfigurationRequest, output: PutBucketNotificationConfigurationResponse, errors: [NoSuchBucket] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const putBucketReplication = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutBucketReplicationRequest, output: PutBucketReplicationResponse, errors: [InvalidRequest, NoSuchBucket] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const restoreObject = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: RestoreObjectRequest, output: RestoreObjectOutput, errors: [ObjectAlreadyInActiveTierError, NoSuchKey] }));
/**
 * This operation is not supported for directory buckets.
 * 
 ...
 * You must URL encode any signed header values that contain spaces. For example, if your header value is `my file.txt`, containing two spaces after `my`, you must URL encode this value to `my%20%20file.txt`.
 */
export const selectObjectContent = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: SelectObjectContentRequest, output: SelectObjectContentOutput, errors: [] }));
