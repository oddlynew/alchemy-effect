...
export class CreateDatasetGroupRequest extends S.Class<CreateDatasetGroupRequest>("CreateDatasetGroupRequest")({DatasetGroupName: S.String, Domain: S.String, DatasetArns: S.optional(ArnList), Tags: S.optional(Tags)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class CreateForecastExportJobRequest extends S.Class<CreateForecastExportJobRequest>("CreateForecastExportJobRequest")({ForecastExportJobName: S.String, ForecastArn: S.String, Destination: DataDestination, Tags: S.optional(Tags), Format: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class CreateMonitorRequest extends S.Class<CreateMonitorRequest>("CreateMonitorRequest")({MonitorName: S.String, ResourceArn: S.String, Tags: S.optional(Tags)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class CreatePredictorBacktestExportJobRequest extends S.Class<CreatePredictorBacktestExportJobRequest>("CreatePredictorBacktestExportJobRequest")({PredictorBacktestExportJobName: S.String, PredictorArn: S.String, Destination: DataDestination, Tags: S.optional(Tags), Format: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class CreateWhatIfAnalysisRequest extends S.Class<CreateWhatIfAnalysisRequest>("CreateWhatIfAnalysisRequest")({WhatIfAnalysisName: S.String, ForecastArn: S.String, TimeSeriesSelector: S.optional(TimeSeriesSelector), Tags: S.optional(Tags)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class CreateWhatIfForecastExportRequest extends S.Class<CreateWhatIfForecastExportRequest>("CreateWhatIfForecastExportRequest")({WhatIfForecastExportName: S.String, WhatIfForecastArns: WhatIfForecastArnListForExport, Destination: DataDestination, Tags: S.optional(Tags), Format: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class DeleteDatasetImportJobRequest extends S.Class<DeleteDatasetImportJobRequest>("DeleteDatasetImportJobRequest")({DatasetImportJobArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteDatasetImportJobResponse extends S.Class<DeleteDatasetImportJobResponse>("DeleteDatasetImportJobResponse")({}) {}
export class DeleteExplainabilityRequest extends S.Class<DeleteExplainabilityRequest>("DeleteExplainabilityRequest")({ExplainabilityArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteExplainabilityResponse extends S.Class<DeleteExplainabilityResponse>("DeleteExplainabilityResponse")({}) {}
export class DeleteExplainabilityExportRequest extends S.Class<DeleteExplainabilityExportRequest>("DeleteExplainabilityExportRequest")({ExplainabilityExportArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteExplainabilityExportResponse extends S.Class<DeleteExplainabilityExportResponse>("DeleteExplainabilityExportResponse")({}) {}
export class DeleteForecastRequest extends S.Class<DeleteForecastRequest>("DeleteForecastRequest")({ForecastArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteForecastResponse extends S.Class<DeleteForecastResponse>("DeleteForecastResponse")({}) {}
export class DeleteForecastExportJobRequest extends S.Class<DeleteForecastExportJobRequest>("DeleteForecastExportJobRequest")({ForecastExportJobArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteForecastExportJobResponse extends S.Class<DeleteForecastExportJobResponse>("DeleteForecastExportJobResponse")({}) {}
export class DeleteMonitorRequest extends S.Class<DeleteMonitorRequest>("DeleteMonitorRequest")({MonitorArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteMonitorResponse extends S.Class<DeleteMonitorResponse>("DeleteMonitorResponse")({}) {}
export class DeletePredictorRequest extends S.Class<DeletePredictorRequest>("DeletePredictorRequest")({PredictorArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeletePredictorResponse extends S.Class<DeletePredictorResponse>("DeletePredictorResponse")({}) {}
export class DeletePredictorBacktestExportJobRequest extends S.Class<DeletePredictorBacktestExportJobRequest>("DeletePredictorBacktestExportJobRequest")({PredictorBacktestExportJobArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeletePredictorBacktestExportJobResponse extends S.Class<DeletePredictorBacktestExportJobResponse>("DeletePredictorBacktestExportJobResponse")({}) {}
export class DeleteResourceTreeRequest extends S.Class<DeleteResourceTreeRequest>("DeleteResourceTreeRequest")({ResourceArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteResourceTreeResponse extends S.Class<DeleteResourceTreeResponse>("DeleteResourceTreeResponse")({}) {}
export class DeleteWhatIfAnalysisRequest extends S.Class<DeleteWhatIfAnalysisRequest>("DeleteWhatIfAnalysisRequest")({WhatIfAnalysisArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteWhatIfAnalysisResponse extends S.Class<DeleteWhatIfAnalysisResponse>("DeleteWhatIfAnalysisResponse")({}) {}
export class DeleteWhatIfForecastRequest extends S.Class<DeleteWhatIfForecastRequest>("DeleteWhatIfForecastRequest")({WhatIfForecastArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteWhatIfForecastResponse extends S.Class<DeleteWhatIfForecastResponse>("DeleteWhatIfForecastResponse")({}) {}
export class DeleteWhatIfForecastExportRequest extends S.Class<DeleteWhatIfForecastExportRequest>("DeleteWhatIfForecastExportRequest")({WhatIfForecastExportArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteWhatIfForecastExportResponse extends S.Class<DeleteWhatIfForecastExportResponse>("DeleteWhatIfForecastExportResponse")({}) {}
export class DescribeAutoPredictorRequest extends S.Class<DescribeAutoPredictorRequest>("DescribeAutoPredictorRequest")({PredictorArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class DescribeExplainabilityRequest extends S.Class<DescribeExplainabilityRequest>("DescribeExplainabilityRequest")({ExplainabilityArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeExplainabilityExportRequest extends S.Class<DescribeExplainabilityExportRequest>("DescribeExplainabilityExportRequest")({ExplainabilityExportArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeForecastRequest extends S.Class<DescribeForecastRequest>("DescribeForecastRequest")({ForecastArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeForecastExportJobRequest extends S.Class<DescribeForecastExportJobRequest>("DescribeForecastExportJobRequest")({ForecastExportJobArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeMonitorRequest extends S.Class<DescribeMonitorRequest>("DescribeMonitorRequest")({MonitorArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribePredictorRequest extends S.Class<DescribePredictorRequest>("DescribePredictorRequest")({PredictorArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribePredictorBacktestExportJobRequest extends S.Class<DescribePredictorBacktestExportJobRequest>("DescribePredictorBacktestExportJobRequest")({PredictorBacktestExportJobArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeWhatIfAnalysisRequest extends S.Class<DescribeWhatIfAnalysisRequest>("DescribeWhatIfAnalysisRequest")({WhatIfAnalysisArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeWhatIfForecastRequest extends S.Class<DescribeWhatIfForecastRequest>("DescribeWhatIfForecastRequest")({WhatIfForecastArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeWhatIfForecastExportRequest extends S.Class<DescribeWhatIfForecastExportRequest>("DescribeWhatIfForecastExportRequest")({WhatIfForecastExportArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetAccuracyMetricsRequest extends S.Class<GetAccuracyMetricsRequest>("GetAccuracyMetricsRequest")({PredictorArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class ListDatasetsRequest extends S.Class<ListDatasetsRequest>("ListDatasetsRequest")({NextToken: S.optional(S.String), MaxResults: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class Filter extends S.Class<Filter>("Filter")({Key: S.String, Value: S.String, Condition: S.String}) {}
export const Filters = S.Array(Filter);
export class ListExplainabilitiesRequest extends S.Class<ListExplainabilitiesRequest>("ListExplainabilitiesRequest")({NextToken: S.optional(S.String), MaxResults: S.optional(S.Number), Filters: S.optional(Filters)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListExplainabilityExportsRequest extends S.Class<ListExplainabilityExportsRequest>("ListExplainabilityExportsRequest")({NextToken: S.optional(S.String), MaxResults: S.optional(S.Number), Filters: S.optional(Filters)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListForecastExportJobsRequest extends S.Class<ListForecastExportJobsRequest>("ListForecastExportJobsRequest")({NextToken: S.optional(S.String), MaxResults: S.optional(S.Number), Filters: S.optional(Filters)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListForecastsRequest extends S.Class<ListForecastsRequest>("ListForecastsRequest")({NextToken: S.optional(S.String), MaxResults: S.optional(S.Number), Filters: S.optional(Filters)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListMonitorEvaluationsRequest extends S.Class<ListMonitorEvaluationsRequest>("ListMonitorEvaluationsRequest")({NextToken: S.optional(S.String), MaxResults: S.optional(S.Number), MonitorArn: S.String, Filters: S.optional(Filters)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListMonitorsRequest extends S.Class<ListMonitorsRequest>("ListMonitorsRequest")({NextToken: S.optional(S.String), MaxResults: S.optional(S.Number), Filters: S.optional(Filters)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListPredictorBacktestExportJobsRequest extends S.Class<ListPredictorBacktestExportJobsRequest>("ListPredictorBacktestExportJobsRequest")({NextToken: S.optional(S.String), MaxResults: S.optional(S.Number), Filters: S.optional(Filters)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListPredictorsRequest extends S.Class<ListPredictorsRequest>("ListPredictorsRequest")({NextToken: S.optional(S.String), MaxResults: S.optional(S.Number), Filters: S.optional(Filters)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class ListWhatIfAnalysesRequest extends S.Class<ListWhatIfAnalysesRequest>("ListWhatIfAnalysesRequest")({NextToken: S.optional(S.String), MaxResults: S.optional(S.Number), Filters: S.optional(Filters)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListWhatIfForecastExportsRequest extends S.Class<ListWhatIfForecastExportsRequest>("ListWhatIfForecastExportsRequest")({NextToken: S.optional(S.String), MaxResults: S.optional(S.Number), Filters: S.optional(Filters)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListWhatIfForecastsRequest extends S.Class<ListWhatIfForecastsRequest>("ListWhatIfForecastsRequest")({NextToken: S.optional(S.String), MaxResults: S.optional(S.Number), Filters: S.optional(Filters)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ResumeResourceRequest extends S.Class<ResumeResourceRequest>("ResumeResourceRequest")({ResourceArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ResumeResourceResponse extends S.Class<ResumeResourceResponse>("ResumeResourceResponse")({}) {}
export class StopResourceRequest extends S.Class<StopResourceRequest>("StopResourceRequest")({ResourceArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class StopResourceResponse extends S.Class<StopResourceResponse>("StopResourceResponse")({}) {}
...
export class UpdateDatasetGroupRequest extends S.Class<UpdateDatasetGroupRequest>("UpdateDatasetGroupRequest")({DatasetGroupArn: S.String, DatasetArns: ArnList}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class CreateExplainabilityExportRequest extends S.Class<CreateExplainabilityExportRequest>("CreateExplainabilityExportRequest")({ExplainabilityExportName: S.String, ExplainabilityArn: S.String, Destination: DataDestination, Tags: S.optional(Tags), Format: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class DescribeWhatIfForecastResponse extends S.Class<DescribeWhatIfForecastResponse>("DescribeWhatIfForecastResponse")({WhatIfForecastName: S.optional(S.String), WhatIfForecastArn: S.optional(S.String), WhatIfAnalysisArn: S.optional(S.String), EstimatedTimeRemainingInMinutes: S.optional(S.Number), Status: S.optional(S.String), Message: S.optional(S.String), CreationTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), LastModificationTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), TimeSeriesTransformations: S.optional(TimeSeriesTransformations), TimeSeriesReplacementsDataSource: S.optional(TimeSeriesReplacementsDataSource), ForecastTypes: S.optional(ForecastTypes)}) {}
export class DescribeWhatIfForecastExportResponse extends S.Class<DescribeWhatIfForecastExportResponse>("DescribeWhatIfForecastExportResponse")({WhatIfForecastExportArn: S.optional(S.String), WhatIfForecastExportName: S.optional(S.String), WhatIfForecastArns: S.optional(LongArnList), Destination: S.optional(DataDestination), Message: S.optional(S.String), Status: S.optional(S.String), CreationTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), EstimatedTimeRemainingInMinutes: S.optional(S.Number), LastModificationTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), Format: S.optional(S.String)}) {}
export class ListDatasetImportJobsRequest extends S.Class<ListDatasetImportJobsRequest>("ListDatasetImportJobsRequest")({NextToken: S.optional(S.String), MaxResults: S.optional(S.Number), Filters: S.optional(Filters)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class DatasetGroupSummary extends S.Class<DatasetGroupSummary>("DatasetGroupSummary")({DatasetGroupArn: S.optional(S.String), DatasetGroupName: S.optional(S.String), CreationTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), LastModificationTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
export const DatasetGroups = S.Array(DatasetGroupSummary);
export class DatasetSummary extends S.Class<DatasetSummary>("DatasetSummary")({DatasetArn: S.optional(S.String), DatasetName: S.optional(S.String), DatasetType: S.optional(S.String), Domain: S.optional(S.String), CreationTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), LastModificationTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
...
export class CreateForecastRequest extends S.Class<CreateForecastRequest>("CreateForecastRequest")({ForecastName: S.String, PredictorArn: S.String, ForecastTypes: S.optional(ForecastTypes), Tags: S.optional(Tags), TimeSeriesSelector: S.optional(TimeSeriesSelector)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class CreateWhatIfForecastRequest extends S.Class<CreateWhatIfForecastRequest>("CreateWhatIfForecastRequest")({WhatIfForecastName: S.String, WhatIfAnalysisArn: S.String, TimeSeriesTransformations: S.optional(TimeSeriesTransformations), TimeSeriesReplacementsDataSource: S.optional(TimeSeriesReplacementsDataSource), Tags: S.optional(Tags)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class PredictorEvent extends S.Class<PredictorEvent>("PredictorEvent")({Detail: S.optional(S.String), Datetime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
...
export class PredictorMonitorEvaluation extends S.Class<PredictorMonitorEvaluation>("PredictorMonitorEvaluation")({ResourceArn: S.optional(S.String), MonitorArn: S.optional(S.String), EvaluationTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), EvaluationState: S.optional(S.String), WindowStartDatetime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), WindowEndDatetime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), PredictorEvent: S.optional(PredictorEvent), MonitorDataSource: S.optional(MonitorDataSource), MetricResults: S.optional(MetricResults), NumItemsEvaluated: S.optional(S.Number), Message: S.optional(S.String)}) {}
...
export class WindowSummary extends S.Class<WindowSummary>("WindowSummary")({TestWindowStart: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), TestWindowEnd: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), ItemCount: S.optional(S.Number), EvaluationType: S.optional(S.String), Metrics: S.optional(Metrics)}) {}
 ...
 */
export const resumeResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ResumeResourceRequest, output: ResumeResourceResponse, errors: [InvalidInputException, LimitExceededException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 * operation.
 */
export const deleteDatasetImportJob = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteDatasetImportJobRequest, output: DeleteDatasetImportJobResponse, errors: [InvalidInputException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 */
export const deleteExplainability = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteExplainabilityRequest, output: DeleteExplainabilityResponse, errors: [InvalidInputException, ResourceInUseException, ResourceNotFoundException] }));
/**
 * Deletes an Explainability export.
 */
export const deleteExplainabilityExport = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteExplainabilityExportRequest, output: DeleteExplainabilityExportResponse, errors: [InvalidInputException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 */
export const deleteForecast = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteForecastRequest, output: DeleteForecastResponse, errors: [InvalidInputException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 */
export const deleteForecastExportJob = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteForecastExportJobRequest, output: DeleteForecastExportJobResponse, errors: [InvalidInputException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 */
export const deleteMonitor = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteMonitorRequest, output: DeleteMonitorResponse, errors: [InvalidInputException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 */
export const deletePredictor = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeletePredictorRequest, output: DeletePredictorResponse, errors: [InvalidInputException, ResourceInUseException, ResourceNotFoundException] }));
/**
 * Deletes a predictor backtest export job.
 */
export const deletePredictorBacktestExportJob = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeletePredictorBacktestExportJobRequest, output: DeletePredictorBacktestExportJobResponse, errors: [InvalidInputException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 */
export const deleteResourceTree = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteResourceTreeRequest, output: DeleteResourceTreeResponse, errors: [InvalidInputException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 */
export const deleteWhatIfAnalysis = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteWhatIfAnalysisRequest, output: DeleteWhatIfAnalysisResponse, errors: [InvalidInputException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 */
export const deleteWhatIfForecast = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteWhatIfForecastRequest, output: DeleteWhatIfForecastResponse, errors: [InvalidInputException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 */
export const deleteWhatIfForecastExport = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteWhatIfForecastExportRequest, output: DeleteWhatIfForecastExportResponse, errors: [InvalidInputException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 */
export const updateDatasetGroup = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateDatasetGroupRequest, output: UpdateDatasetGroupResponse, errors: [InvalidInputException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 */
export const describeExplainability = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeExplainabilityRequest, output: DescribeExplainabilityResponse, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 * Describes an Explainability export created using the CreateExplainabilityExport operation.
 */
export const describeExplainabilityExport = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeExplainabilityExportRequest, output: DescribeExplainabilityExportResponse, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 ...
 */
export const describeForecast = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeForecastRequest, output: DescribeForecastResponse, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 ...
 * - `Message` - If an error occurred, information about the error.
 */
export const describeForecastExportJob = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeForecastExportJobRequest, output: DescribeForecastExportJobResponse, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 ...
 */
export const describePredictorBacktestExportJob = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribePredictorBacktestExportJobRequest, output: DescribePredictorBacktestExportJobResponse, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 ...
 * - `Status`
 */
export const describeWhatIfAnalysis = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeWhatIfAnalysisRequest, output: DescribeWhatIfAnalysisResponse, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 ...
 * - `Status`
 */
export const describeWhatIfForecast = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeWhatIfForecastRequest, output: DescribeWhatIfForecastResponse, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 ...
 * - `Status`
 */
export const describeWhatIfForecastExport = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeWhatIfForecastExportRequest, output: DescribeWhatIfForecastExportResponse, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 * Lists the tags for an Amazon Forecast resource.
 */
export const listTagsForResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListTagsForResourceRequest, output: ListTagsForResourceResponse, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 * Deletes the specified tags from a resource.
 */
export const untagResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UntagResourceRequest, output: UntagResourceResponse, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 ...
 */
export const describeAutoPredictor = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeAutoPredictorRequest, output: DescribeAutoPredictorResponse, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 * Stops a resource.
 * 
 ...
 */
export const stopResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StopResourceRequest, output: StopResourceResponse, errors: [InvalidInputException, LimitExceededException, ResourceNotFoundException] }));
/**
 ...
 * deleted.
 */
export const tagResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: TagResourceRequest, output: TagResourceResponse, errors: [InvalidInputException, LimitExceededException, ResourceNotFoundException] }));
/**
 ...
 */
export const listMonitorEvaluations = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListMonitorEvaluationsRequest, output: ListMonitorEvaluationsResponse, errors: [InvalidInputException, InvalidNextTokenException, ResourceNotFoundException] }));
/**
 ...
 */
export const listDatasets = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListDatasetsRequest, output: ListDatasetsResponse, errors: [InvalidNextTokenException] }));
/**
 ...
 */
export const listExplainabilities = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListExplainabilitiesRequest, output: ListExplainabilitiesResponse, errors: [InvalidInputException, InvalidNextTokenException] }));
/**
 ...
 */
export const listExplainabilityExports = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListExplainabilityExportsRequest, output: ListExplainabilityExportsResponse, errors: [InvalidInputException, InvalidNextTokenException] }));
/**
 ...
 */
export const listForecastExportJobs = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListForecastExportJobsRequest, output: ListForecastExportJobsResponse, errors: [InvalidInputException, InvalidNextTokenException] }));
/**
 ...
 * Filter objects.
 */
export const listForecasts = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListForecastsRequest, output: ListForecastsResponse, errors: [InvalidInputException, InvalidNextTokenException] }));
/**
 ...
 */
export const listMonitors = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListMonitorsRequest, output: ListMonitorsResponse, errors: [InvalidInputException, InvalidNextTokenException] }));
/**
 ...
 */
export const listPredictorBacktestExportJobs = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListPredictorBacktestExportJobsRequest, output: ListPredictorBacktestExportJobsResponse, errors: [InvalidInputException, InvalidNextTokenException] }));
/**
 ...
 */
export const listPredictors = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListPredictorsRequest, output: ListPredictorsResponse, errors: [InvalidInputException, InvalidNextTokenException] }));
/**
 ...
 */
export const listWhatIfAnalyses = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListWhatIfAnalysesRequest, output: ListWhatIfAnalysesResponse, errors: [InvalidInputException, InvalidNextTokenException] }));
/**
 * Returns a list of what-if forecast exports created using the CreateWhatIfForecastExport operation. For each what-if forecast export, this operation returns a summary of its properties, including its Amazon Resource Name (ARN). You can retrieve the complete set of properties by using the what-if forecast export ARN with the DescribeWhatIfForecastExport operation.
 */
export const listWhatIfForecastExports = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListWhatIfForecastExportsRequest, output: ListWhatIfForecastExportsResponse, errors: [InvalidInputException, InvalidNextTokenException] }));
/**
 * Returns a list of what-if forecasts created using the CreateWhatIfForecast operation. For each what-if forecast, this operation returns a summary of its properties, including its Amazon Resource Name (ARN). You can retrieve the complete set of properties by using the what-if forecast ARN with the DescribeWhatIfForecast operation.
 */
export const listWhatIfForecasts = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListWhatIfForecastsRequest, output: ListWhatIfForecastsResponse, errors: [InvalidInputException, InvalidNextTokenException] }));
/**
 ...
 */
export const createDatasetGroup = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateDatasetGroupRequest, output: CreateDatasetGroupResponse, errors: [InvalidInputException, LimitExceededException, ResourceAlreadyExistsException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 */
export const createForecastExportJob = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateForecastExportJobRequest, output: CreateForecastExportJobResponse, errors: [InvalidInputException, LimitExceededException, ResourceAlreadyExistsException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 */
export const createMonitor = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateMonitorRequest, output: CreateMonitorResponse, errors: [InvalidInputException, LimitExceededException, ResourceAlreadyExistsException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 */
export const createPredictorBacktestExportJob = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreatePredictorBacktestExportJobRequest, output: CreatePredictorBacktestExportJobResponse, errors: [InvalidInputException, LimitExceededException, ResourceAlreadyExistsException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 */
export const createWhatIfAnalysis = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateWhatIfAnalysisRequest, output: CreateWhatIfAnalysisResponse, errors: [InvalidInputException, LimitExceededException, ResourceAlreadyExistsException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 */
export const createWhatIfForecastExport = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateWhatIfForecastExportRequest, output: CreateWhatIfForecastExportResponse, errors: [InvalidInputException, LimitExceededException, ResourceAlreadyExistsException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 * points.
 */
export const createExplainability = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateExplainabilityRequest, output: CreateExplainabilityResponse, errors: [InvalidInputException, LimitExceededException, ResourceAlreadyExistsException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 */
export const createExplainabilityExport = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateExplainabilityExportRequest, output: CreateExplainabilityExportResponse, errors: [InvalidInputException, LimitExceededException, ResourceAlreadyExistsException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 * the status.
 */
export const createDataset = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateDatasetRequest, output: CreateDatasetResponse, errors: [InvalidInputException, LimitExceededException, ResourceAlreadyExistsException] }));
/**
 ...
 */
export const createDatasetImportJob = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateDatasetImportJobRequest, output: CreateDatasetImportJobResponse, errors: [InvalidInputException, LimitExceededException, ResourceAlreadyExistsException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 */
export const createForecast = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateForecastRequest, output: CreateForecastResponse, errors: [InvalidInputException, LimitExceededException, ResourceAlreadyExistsException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 */
export const createWhatIfForecast = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateWhatIfForecastRequest, output: CreateWhatIfForecastResponse, errors: [InvalidInputException, LimitExceededException, ResourceAlreadyExistsException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 */
export const createAutoPredictor = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateAutoPredictorRequest, output: CreateAutoPredictorResponse, errors: [InvalidInputException, LimitExceededException, ResourceAlreadyExistsException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 * - `Status`
 */
export const describeMonitor = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeMonitorRequest, output: DescribeMonitorResponse, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 ...
 * - `Message` - If an error occurred, information about the error.
 */
export const describePredictor = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribePredictorRequest, output: DescribePredictorResponse, errors: [InvalidInputException, ResourceNotFoundException] }));
/**
 ...
 */
export const createPredictor = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreatePredictorRequest, output: CreatePredictorResponse, errors: [InvalidInputException, LimitExceededException, ResourceAlreadyExistsException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 */
export const getAccuracyMetrics = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetAccuracyMetricsRequest, output: GetAccuracyMetricsResponse, errors: [InvalidInputException, ResourceInUseException, ResourceNotFoundException] }));
