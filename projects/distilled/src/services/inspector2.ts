...
//# Schemas
export class DescribeOrganizationConfigurationRequest extends S.Class<DescribeOrganizationConfigurationRequest>("DescribeOrganizationConfigurationRequest")({}, T.all(T.Http({ method: "POST", uri: "/organizationconfiguration/describe" }), svc, auth, proto, ver, rules)) {}
export class GetConfigurationRequest extends S.Class<GetConfigurationRequest>("GetConfigurationRequest")({}, T.all(T.Http({ method: "POST", uri: "/configuration/get" }), svc, auth, proto, ver, rules)) {}
export class GetDelegatedAdminAccountRequest extends S.Class<GetDelegatedAdminAccountRequest>("GetDelegatedAdminAccountRequest")({}, T.all(T.Http({ method: "POST", uri: "/delegatedadminaccounts/get" }), svc, auth, proto, ver, rules)) {}
export class GetEc2DeepInspectionConfigurationRequest extends S.Class<GetEc2DeepInspectionConfigurationRequest>("GetEc2DeepInspectionConfigurationRequest")({}, T.all(T.Http({ method: "POST", uri: "/ec2deepinspectionconfiguration/get" }), svc, auth, proto, ver, rules)) {}
...
export class AssociateMemberRequest extends S.Class<AssociateMemberRequest>("AssociateMemberRequest")({accountId: S.String}, T.all(T.Http({ method: "POST", uri: "/members/associate" }), svc, auth, proto, ver, rules)) {}
export class BatchGetAccountStatusRequest extends S.Class<BatchGetAccountStatusRequest>("BatchGetAccountStatusRequest")({accountIds: S.optional(AccountIdSet)}, T.all(T.Http({ method: "POST", uri: "/status/batch/get" }), svc, auth, proto, ver, rules)) {}
export class BatchGetCodeSnippetRequest extends S.Class<BatchGetCodeSnippetRequest>("BatchGetCodeSnippetRequest")({findingArns: FindingArns}, T.all(T.Http({ method: "POST", uri: "/codesnippet/batchget" }), svc, auth, proto, ver, rules)) {}
export class BatchGetFindingDetailsRequest extends S.Class<BatchGetFindingDetailsRequest>("BatchGetFindingDetailsRequest")({findingArns: FindingArnList}, T.all(T.Http({ method: "POST", uri: "/findings/details/batch/get" }), svc, auth, proto, ver, rules)) {}
export class BatchGetFreeTrialInfoRequest extends S.Class<BatchGetFreeTrialInfoRequest>("BatchGetFreeTrialInfoRequest")({accountIds: MeteringAccountIdList}, T.all(T.Http({ method: "POST", uri: "/freetrialinfo/batchget" }), svc, auth, proto, ver, rules)) {}
export class BatchGetMemberEc2DeepInspectionStatusRequest extends S.Class<BatchGetMemberEc2DeepInspectionStatusRequest>("BatchGetMemberEc2DeepInspectionStatusRequest")({accountIds: S.optional(AccountIdSet)}, T.all(T.Http({ method: "POST", uri: "/ec2deepinspectionstatus/member/batch/get" }), svc, auth, proto, ver, rules)) {}
export class CancelFindingsReportRequest extends S.Class<CancelFindingsReportRequest>("CancelFindingsReportRequest")({reportId: S.String}, T.all(T.Http({ method: "POST", uri: "/reporting/cancel" }), svc, auth, proto, ver, rules)) {}
export class CancelSbomExportRequest extends S.Class<CancelSbomExportRequest>("CancelSbomExportRequest")({reportId: S.String}, T.all(T.Http({ method: "POST", uri: "/sbomexport/cancel" }), svc, auth, proto, ver, rules)) {}
export class DeleteCisScanConfigurationRequest extends S.Class<DeleteCisScanConfigurationRequest>("DeleteCisScanConfigurationRequest")({scanConfigurationArn: S.String}, T.all(T.Http({ method: "POST", uri: "/cis/scan-configuration/delete" }), svc, auth, proto, ver, rules)) {}
export class DeleteCodeSecurityIntegrationRequest extends S.Class<DeleteCodeSecurityIntegrationRequest>("DeleteCodeSecurityIntegrationRequest")({integrationArn: S.String}, T.all(T.Http({ method: "POST", uri: "/codesecurity/integration/delete" }), svc, auth, proto, ver, rules)) {}
export class DeleteCodeSecurityScanConfigurationRequest extends S.Class<DeleteCodeSecurityScanConfigurationRequest>("DeleteCodeSecurityScanConfigurationRequest")({scanConfigurationArn: S.String}, T.all(T.Http({ method: "POST", uri: "/codesecurity/scan-configuration/delete" }), svc, auth, proto, ver, rules)) {}
export class DeleteFilterRequest extends S.Class<DeleteFilterRequest>("DeleteFilterRequest")({arn: S.String}, T.all(T.Http({ method: "POST", uri: "/filters/delete" }), svc, auth, proto, ver, rules)) {}
export class DisableRequest extends S.Class<DisableRequest>("DisableRequest")({accountIds: S.optional(AccountIdSet), resourceTypes: S.optional(DisableResourceTypeList)}, T.all(T.Http({ method: "POST", uri: "/disable" }), svc, auth, proto, ver, rules)) {}
export class DisableDelegatedAdminAccountRequest extends S.Class<DisableDelegatedAdminAccountRequest>("DisableDelegatedAdminAccountRequest")({delegatedAdminAccountId: S.String}, T.all(T.Http({ method: "POST", uri: "/delegatedadminaccounts/disable" }), svc, auth, proto, ver, rules)) {}
export class DisassociateMemberRequest extends S.Class<DisassociateMemberRequest>("DisassociateMemberRequest")({accountId: S.String}, T.all(T.Http({ method: "POST", uri: "/members/disassociate" }), svc, auth, proto, ver, rules)) {}
export class EnableRequest extends S.Class<EnableRequest>("EnableRequest")({accountIds: S.optional(AccountIdSet), resourceTypes: EnableResourceTypeList, clientToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/enable" }), svc, auth, proto, ver, rules)) {}
export class EnableDelegatedAdminAccountRequest extends S.Class<EnableDelegatedAdminAccountRequest>("EnableDelegatedAdminAccountRequest")({delegatedAdminAccountId: S.String, clientToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/delegatedadminaccounts/enable" }), svc, auth, proto, ver, rules)) {}
export class GetCisScanReportRequest extends S.Class<GetCisScanReportRequest>("GetCisScanReportRequest")({scanArn: S.String, targetAccounts: S.optional(ReportTargetAccounts), reportFormat: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/cis/scan/report/get" }), svc, auth, proto, ver, rules)) {}
export const TagMap = S.Record({key: S.String, value: S.String});
export class GetCodeSecurityIntegrationRequest extends S.Class<GetCodeSecurityIntegrationRequest>("GetCodeSecurityIntegrationRequest")({integrationArn: S.String, tags: S.optional(TagMap)}, T.all(T.Http({ method: "POST", uri: "/codesecurity/integration/get" }), svc, auth, proto, ver, rules)) {}
export class GetCodeSecurityScanConfigurationRequest extends S.Class<GetCodeSecurityScanConfigurationRequest>("GetCodeSecurityScanConfigurationRequest")({scanConfigurationArn: S.String}, T.all(T.Http({ method: "POST", uri: "/codesecurity/scan-configuration/get" }), svc, auth, proto, ver, rules)) {}
...
export class GetEncryptionKeyRequest extends S.Class<GetEncryptionKeyRequest>("GetEncryptionKeyRequest")({scanType: S.String.pipe(T.HttpQuery("scanType")), resourceType: S.String.pipe(T.HttpQuery("resourceType"))}, T.all(T.Http({ method: "GET", uri: "/encryptionkey/get" }), svc, auth, proto, ver, rules)) {}
export class GetFindingsReportStatusRequest extends S.Class<GetFindingsReportStatusRequest>("GetFindingsReportStatusRequest")({reportId: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/reporting/status/get" }), svc, auth, proto, ver, rules)) {}
export class GetMemberRequest extends S.Class<GetMemberRequest>("GetMemberRequest")({accountId: S.String}, T.all(T.Http({ method: "POST", uri: "/members/get" }), svc, auth, proto, ver, rules)) {}
export class GetSbomExportRequest extends S.Class<GetSbomExportRequest>("GetSbomExportRequest")({reportId: S.String}, T.all(T.Http({ method: "POST", uri: "/sbomexport/get" }), svc, auth, proto, ver, rules)) {}
export class ListAccountPermissionsRequest extends S.Class<ListAccountPermissionsRequest>("ListAccountPermissionsRequest")({service: S.optional(S.String), maxResults: S.optional(S.Number), nextToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/accountpermissions/list" }), svc, auth, proto, ver, rules)) {}
export class ListCodeSecurityIntegrationsRequest extends S.Class<ListCodeSecurityIntegrationsRequest>("ListCodeSecurityIntegrationsRequest")({nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken")), maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults"))}, T.all(T.Http({ method: "POST", uri: "/codesecurity/integration/list" }), svc, auth, proto, ver, rules)) {}
export class ListCodeSecurityScanConfigurationAssociationsRequest extends S.Class<ListCodeSecurityScanConfigurationAssociationsRequest>("ListCodeSecurityScanConfigurationAssociationsRequest")({scanConfigurationArn: S.String, nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken")), maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults"))}, T.all(T.Http({ method: "POST", uri: "/codesecurity/scan-configuration/associations/list" }), svc, auth, proto, ver, rules)) {}
export class ListCodeSecurityScanConfigurationsRequest extends S.Class<ListCodeSecurityScanConfigurationsRequest>("ListCodeSecurityScanConfigurationsRequest")({nextToken: S.optional(S.String).pipe(T.HttpQuery("nextToken")), maxResults: S.optional(S.Number).pipe(T.HttpQuery("maxResults"))}, T.all(T.Http({ method: "POST", uri: "/codesecurity/scan-configuration/list" }), svc, auth, proto, ver, rules)) {}
...
export class CoverageDateFilter extends S.Class<CoverageDateFilter>("CoverageDateFilter")({startInclusive: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), endInclusive: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
...
export class ListCoverageStatisticsRequest extends S.Class<ListCoverageStatisticsRequest>("ListCoverageStatisticsRequest")({filterCriteria: S.optional(CoverageFilterCriteria), groupBy: S.optional(S.String), nextToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/coverage/statistics/list" }), svc, auth, proto, ver, rules)) {}
export class ListDelegatedAdminAccountsRequest extends S.Class<ListDelegatedAdminAccountsRequest>("ListDelegatedAdminAccountsRequest")({maxResults: S.optional(S.Number), nextToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/delegatedadminaccounts/list" }), svc, auth, proto, ver, rules)) {}
export class ListFiltersRequest extends S.Class<ListFiltersRequest>("ListFiltersRequest")({arns: S.optional(FilterArnList), action: S.optional(S.String), nextToken: S.optional(S.String), maxResults: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/filters/list" }), svc, auth, proto, ver, rules)) {}
export class ListMembersRequest extends S.Class<ListMembersRequest>("ListMembersRequest")({onlyAssociated: S.optional(S.Boolean), maxResults: S.optional(S.Number), nextToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/members/list" }), svc, auth, proto, ver, rules)) {}
...
export class ListUsageTotalsRequest extends S.Class<ListUsageTotalsRequest>("ListUsageTotalsRequest")({maxResults: S.optional(S.Number), nextToken: S.optional(S.String), accountIds: S.optional(UsageAccountIdList)}, T.all(T.Http({ method: "POST", uri: "/usage/list" }), svc, auth, proto, ver, rules)) {}
export class ResetEncryptionKeyRequest extends S.Class<ResetEncryptionKeyRequest>("ResetEncryptionKeyRequest")({scanType: S.String, resourceType: S.String}, T.all(T.Http({ method: "PUT", uri: "/encryptionkey/reset" }), svc, auth, proto, ver, rules)) {}
export class ResetEncryptionKeyResponse extends S.Class<ResetEncryptionKeyResponse>("ResetEncryptionKeyResponse")({}) {}
export class SendCisSessionHealthRequest extends S.Class<SendCisSessionHealthRequest>("SendCisSessionHealthRequest")({scanJobId: S.String, sessionToken: S.String}, T.all(T.Http({ method: "PUT", uri: "/cissession/health/send" }), svc, auth, proto, ver, rules)) {}
...
export class StartCodeSecurityScanRequest extends S.Class<StartCodeSecurityScanRequest>("StartCodeSecurityScanRequest")({clientToken: S.optional(S.String), resource: CodeSecurityResource}, T.all(T.Http({ method: "POST", uri: "/codesecurity/scan/start" }), svc, auth, proto, ver, rules)) {}
...
export class UpdateCodeSecurityScanConfigurationRequest extends S.Class<UpdateCodeSecurityScanConfigurationRequest>("UpdateCodeSecurityScanConfigurationRequest")({scanConfigurationArn: S.String, configuration: CodeSecurityScanConfiguration}, T.all(T.Http({ method: "POST", uri: "/codesecurity/scan-configuration/update" }), svc, auth, proto, ver, rules)) {}
export class UpdateEc2DeepInspectionConfigurationRequest extends S.Class<UpdateEc2DeepInspectionConfigurationRequest>("UpdateEc2DeepInspectionConfigurationRequest")({activateDeepInspection: S.optional(S.Boolean), packagePaths: S.optional(PathList)}, T.all(T.Http({ method: "POST", uri: "/ec2deepinspectionconfiguration/update" }), svc, auth, proto, ver, rules)) {}
export class UpdateEncryptionKeyRequest extends S.Class<UpdateEncryptionKeyRequest>("UpdateEncryptionKeyRequest")({kmsKeyId: S.String, scanType: S.String, resourceType: S.String}, T.all(T.Http({ method: "PUT", uri: "/encryptionkey/update" }), svc, auth, proto, ver, rules)) {}
...
export class DateFilter extends S.Class<DateFilter>("DateFilter")({startInclusive: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), endInclusive: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
...
export class UpdateFilterRequest extends S.Class<UpdateFilterRequest>("UpdateFilterRequest")({action: S.optional(S.String), description: S.optional(S.String), filterCriteria: S.optional(FilterCriteria), name: S.optional(S.String), filterArn: S.String, reason: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/filters/update" }), svc, auth, proto, ver, rules)) {}
...
export class UpdateOrganizationConfigurationRequest extends S.Class<UpdateOrganizationConfigurationRequest>("UpdateOrganizationConfigurationRequest")({autoEnable: AutoEnable}, T.all(T.Http({ method: "POST", uri: "/organizationconfiguration/update" }), svc, auth, proto, ver, rules)) {}
export class UpdateOrgEc2DeepInspectionConfigurationRequest extends S.Class<UpdateOrgEc2DeepInspectionConfigurationRequest>("UpdateOrgEc2DeepInspectionConfigurationRequest")({orgPackagePaths: PathList}, T.all(T.Http({ method: "POST", uri: "/ec2deepinspectionconfiguration/org/update" }), svc, auth, proto, ver, rules)) {}
...
export class Member extends S.Class<Member>("Member")({accountId: S.optional(S.String), relationshipStatus: S.optional(S.String), delegatedAdminAccountId: S.optional(S.String), updatedAt: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
...
export class CisSessionMessage extends S.Class<CisSessionMessage>("CisSessionMessage")({ruleId: S.String, status: S.String, cisRuleDetails: T.Blob}) {}
...
export class BatchAssociateCodeSecurityScanConfigurationRequest extends S.Class<BatchAssociateCodeSecurityScanConfigurationRequest>("BatchAssociateCodeSecurityScanConfigurationRequest")({associateConfigurationRequests: AssociateConfigurationRequestList}, T.all(T.Http({ method: "POST", uri: "/codesecurity/scan-configuration/batch/associate" }), svc, auth, proto, ver, rules)) {}
export class BatchDisassociateCodeSecurityScanConfigurationRequest extends S.Class<BatchDisassociateCodeSecurityScanConfigurationRequest>("BatchDisassociateCodeSecurityScanConfigurationRequest")({disassociateConfigurationRequests: DisassociateConfigurationRequestList}, T.all(T.Http({ method: "POST", uri: "/codesecurity/scan-configuration/batch/disassociate" }), svc, auth, proto, ver, rules)) {}
export class BatchUpdateMemberEc2DeepInspectionStatusRequest extends S.Class<BatchUpdateMemberEc2DeepInspectionStatusRequest>("BatchUpdateMemberEc2DeepInspectionStatusRequest")({accountIds: MemberAccountEc2DeepInspectionStatusList}, T.all(T.Http({ method: "POST", uri: "/ec2deepinspectionstatus/member/batch/update" }), svc, auth, proto, ver, rules)) {}
...
export class CreateFindingsReportRequest extends S.Class<CreateFindingsReportRequest>("CreateFindingsReportRequest")({filterCriteria: S.optional(FilterCriteria), reportFormat: S.String, s3Destination: Destination}, T.all(T.Http({ method: "POST", uri: "/reporting/create" }), svc, auth, proto, ver, rules)) {}
...
export class GetClustersForImageRequest extends S.Class<GetClustersForImageRequest>("GetClustersForImageRequest")({filter: ClusterForImageFilterCriteria, maxResults: S.optional(S.Number), nextToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/cluster/get" }), svc, auth, proto, ver, rules)) {}
export class GetCodeSecurityIntegrationResponse extends S.Class<GetCodeSecurityIntegrationResponse>("GetCodeSecurityIntegrationResponse")({integrationArn: S.String, name: S.String, type: S.String, status: S.String, statusReason: S.String, createdOn: S.Date.pipe(T.TimestampFormat("epoch-seconds")), lastUpdateOn: S.Date.pipe(T.TimestampFormat("epoch-seconds")), tags: S.optional(TagMap), authorizationUrl: S.optional(S.String)}) {}
export class GetCodeSecurityScanRequest extends S.Class<GetCodeSecurityScanRequest>("GetCodeSecurityScanRequest")({resource: CodeSecurityResource, scanId: S.String}, T.all(T.Http({ method: "POST", uri: "/codesecurity/scan/get" }), svc, auth, proto, ver, rules)) {}
...
export class ListFindingsRequest extends S.Class<ListFindingsRequest>("ListFindingsRequest")({maxResults: S.optional(S.Number), nextToken: S.optional(S.String), filterCriteria: S.optional(FilterCriteria), sortCriteria: S.optional(SortCriteria)}, T.all(T.Http({ method: "POST", uri: "/findings/list" }), svc, auth, proto, ver, rules)) {}
...
export class SearchVulnerabilitiesRequest extends S.Class<SearchVulnerabilitiesRequest>("SearchVulnerabilitiesRequest")({filterCriteria: SearchVulnerabilitiesFilterCriteria, nextToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/vulnerabilities/search" }), svc, auth, proto, ver, rules)) {}
export class SendCisSessionTelemetryRequest extends S.Class<SendCisSessionTelemetryRequest>("SendCisSessionTelemetryRequest")({scanJobId: S.String, sessionToken: S.String, messages: CisSessionMessages}, T.all(T.Http({ method: "PUT", uri: "/cissession/telemetry/send" }), svc, auth, proto, ver, rules)) {}
...
export class StartCisSessionRequest extends S.Class<StartCisSessionRequest>("StartCisSessionRequest")({scanJobId: S.String, message: StartCisSessionMessage}, T.all(T.Http({ method: "PUT", uri: "/cissession/start" }), svc, auth, proto, ver, rules)) {}
...
export class UpdateCisScanConfigurationRequest extends S.Class<UpdateCisScanConfigurationRequest>("UpdateCisScanConfigurationRequest")({scanConfigurationArn: S.String, scanName: S.optional(S.String), securityLevel: S.optional(S.String), schedule: S.optional(Schedule), targets: S.optional(UpdateCisTargets)}, T.all(T.Http({ method: "POST", uri: "/cis/scan-configuration/update" }), svc, auth, proto, ver, rules)) {}
...
export class UpdateConfigurationRequest extends S.Class<UpdateConfigurationRequest>("UpdateConfigurationRequest")({ecrConfiguration: S.optional(EcrConfiguration), ec2Configuration: S.optional(Ec2Configuration)}, T.all(T.Http({ method: "POST", uri: "/configuration/update" }), svc, auth, proto, ver, rules)) {}
...
export class CisDateFilter extends S.Class<CisDateFilter>("CisDateFilter")({earliestScanStartTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), latestScanStartTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
...
export class CodeSecurityIntegrationSummary extends S.Class<CodeSecurityIntegrationSummary>("CodeSecurityIntegrationSummary")({integrationArn: S.String, name: S.String, type: S.String, status: S.String, statusReason: S.String, createdOn: S.Date.pipe(T.TimestampFormat("epoch-seconds")), lastUpdateOn: S.Date.pipe(T.TimestampFormat("epoch-seconds")), tags: S.optional(TagMap)}) {}
...
export class CreateCodeSecurityIntegrationRequest extends S.Class<CreateCodeSecurityIntegrationRequest>("CreateCodeSecurityIntegrationRequest")({name: S.String, type: S.String, details: S.optional(CreateIntegrationDetail), tags: S.optional(TagMap)}, T.all(T.Http({ method: "POST", uri: "/codesecurity/integration/create" }), svc, auth, proto, ver, rules)) {}
export class CreateCodeSecurityScanConfigurationRequest extends S.Class<CreateCodeSecurityScanConfigurationRequest>("CreateCodeSecurityScanConfigurationRequest")({name: S.String, level: S.String, configuration: CodeSecurityScanConfiguration, scopeSettings: S.optional(ScopeSettings), tags: S.optional(TagMap)}, T.all(T.Http({ method: "POST", uri: "/codesecurity/scan-configuration/create" }), svc, auth, proto, ver, rules)) {}
export class CreateFilterRequest extends S.Class<CreateFilterRequest>("CreateFilterRequest")({action: S.String, description: S.optional(S.String), filterCriteria: FilterCriteria, name: S.String, tags: S.optional(TagMap), reason: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/filters/create" }), svc, auth, proto, ver, rules)) {}
...
export class CreateSbomExportRequest extends S.Class<CreateSbomExportRequest>("CreateSbomExportRequest")({resourceFilterCriteria: S.optional(ResourceFilterCriteria), reportFormat: S.String, s3Destination: Destination}, T.all(T.Http({ method: "POST", uri: "/sbomexport/create" }), svc, auth, proto, ver, rules)) {}
...
export class ListCoverageRequest extends S.Class<ListCoverageRequest>("ListCoverageRequest")({maxResults: S.optional(S.Number), nextToken: S.optional(S.String), filterCriteria: S.optional(CoverageFilterCriteria)}, T.all(T.Http({ method: "POST", uri: "/coverage/list" }), svc, auth, proto, ver, rules)) {}
...
export class ListFindingAggregationsRequest extends S.Class<ListFindingAggregationsRequest>("ListFindingAggregationsRequest")({aggregationType: S.String, nextToken: S.optional(S.String), maxResults: S.optional(S.Number), accountIds: S.optional(StringFilterList), aggregationRequest: S.optional(AggregationRequest)}, T.all(T.Http({ method: "POST", uri: "/findings/aggregation/list" }), svc, auth, proto, ver, rules)) {}
export class StopCisSessionRequest extends S.Class<StopCisSessionRequest>("StopCisSessionRequest")({scanJobId: S.String, sessionToken: S.String, message: StopCisSessionMessage}, T.all(T.Http({ method: "PUT", uri: "/cissession/stop" }), svc, auth, proto, ver, rules)) {}
...
export class UpdateCodeSecurityIntegrationRequest extends S.Class<UpdateCodeSecurityIntegrationRequest>("UpdateCodeSecurityIntegrationRequest")({integrationArn: S.String, details: UpdateIntegrationDetails}, T.all(T.Http({ method: "POST", uri: "/codesecurity/integration/update" }), svc, auth, proto, ver, rules)) {}
...
export class CisaData extends S.Class<CisaData>("CisaData")({dateAdded: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), dateDue: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), action: S.optional(S.String)}) {}
...
export class ExploitObserved extends S.Class<ExploitObserved>("ExploitObserved")({lastSeen: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), firstSeen: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
export class FreeTrialInfo extends S.Class<FreeTrialInfo>("FreeTrialInfo")({type: S.String, start: S.Date.pipe(T.TimestampFormat("epoch-seconds")), end: S.Date.pipe(T.TimestampFormat("epoch-seconds")), status: S.String}) {}
...
export class CreateCisScanConfigurationRequest extends S.Class<CreateCisScanConfigurationRequest>("CreateCisScanConfigurationRequest")({scanName: S.String, securityLevel: S.String, schedule: Schedule, targets: CreateCisTargets, tags: S.optional(CisTagMap)}, T.all(T.Http({ method: "POST", uri: "/cis/scan-configuration/create" }), svc, auth, proto, ver, rules)) {}
...
export class ExploitabilityDetails extends S.Class<ExploitabilityDetails>("ExploitabilityDetails")({lastKnownExploitAt: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
export class EpssDetails extends S.Class<EpssDetails>("EpssDetails")({score: S.optional(S.Number)}) {}
export class AtigData extends S.Class<AtigData>("AtigData")({firstSeen: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), lastSeen: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), targets: S.optional(Targets), ttps: S.optional(Ttps)}) {}
...
export class EcrContainerImageMetadata extends S.Class<EcrContainerImageMetadata>("EcrContainerImageMetadata")({tags: S.optional(TagList), imagePulledAt: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), lastInUseAt: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), inUseCount: S.optional(S.Number)}) {}
...
export class CodeRepositoryOnDemandScan extends S.Class<CodeRepositoryOnDemandScan>("CodeRepositoryOnDemandScan")({lastScannedCommitId: S.optional(S.String), lastScanAt: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), scanStatus: S.optional(ScanStatus)}) {}
...
export class ClusterDetails extends S.Class<ClusterDetails>("ClusterDetails")({lastInUse: S.Date.pipe(T.TimestampFormat("epoch-seconds")), runningUnitCount: S.optional(S.Number), stoppedUnitCount: S.optional(S.Number), clusterMetadata: ClusterMetadata}) {}
...
export class InternalServerException extends S.TaggedError<InternalServerException>()("InternalServerException", {message: S.String, retryAfterSeconds: S.optional(S.Number).pipe(T.HttpHeader("Retry-After"))}, T.Retryable()).pipe(withCategory(ERROR_CATEGORIES.SERVER_ERROR)) {}
...
export class ThrottlingException extends S.TaggedError<ThrottlingException>()("ThrottlingException", {message: S.String, retryAfterSeconds: S.optional(S.Number).pipe(T.HttpHeader("Retry-After"))}, T.Retryable({ throttling: true })).pipe(withCategory(ERROR_CATEGORIES.THROTTLING_ERROR)) {}
 ...
 * with your account.
 */
export const getEc2DeepInspectionConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetEc2DeepInspectionConfigurationRequest, output: GetEc2DeepInspectionConfigurationResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException] }));
/**
 * Retrieves setting configurations for Inspector scans.
 */
export const getConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetConfigurationRequest, output: GetConfigurationResponse, errors: [InternalServerException, ResourceNotFoundException, ThrottlingException] }));
/**
 ...
 */
export const updateConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateConfigurationRequest, output: UpdateConfigurationResponse, errors: [AccessDeniedException, InternalServerException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const associateMember = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: AssociateMemberRequest, output: AssociateMemberResponse, errors: [AccessDeniedException, InternalServerException, ServiceQuotaExceededException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const startCisSession = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StartCisSessionRequest, output: StartCisSessionResponse, errors: [AccessDeniedException, ConflictException, InternalServerException, ThrottlingException, ValidationException] }));
/**
 * Initiates a code security scan on a specified repository.
 */
export const startCodeSecurityScan = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StartCodeSecurityScanRequest, output: StartCodeSecurityScanResponse, errors: [AccessDeniedException, ConflictException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Updates an existing code security scan configuration.
 */
export const updateCodeSecurityScanConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateCodeSecurityScanConfigurationRequest, output: UpdateCodeSecurityScanConfigurationResponse, errors: [AccessDeniedException, ConflictException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Sends a CIS session health. This API is used by the Amazon Inspector SSM plugin to
 * communicate with the Amazon Inspector service. The Amazon Inspector SSM plugin calls
 * this API to start a CIS scan session for the scan ID supplied by the service.
 */
export const sendCisSessionHealth = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: SendCisSessionHealthRequest, output: SendCisSessionHealthResponse, errors: [AccessDeniedException, ConflictException, InternalServerException, ThrottlingException, ValidationException] }));
/**
 * Disables the Amazon Inspector delegated administrator for your organization.
 */
export const disableDelegatedAdminAccount = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DisableDelegatedAdminAccountRequest, output: DisableDelegatedAdminAccountResponse, errors: [AccessDeniedException, ConflictException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Enables the Amazon Inspector delegated administrator for your Organizations organization.
 */
export const enableDelegatedAdminAccount = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: EnableDelegatedAdminAccountRequest, output: EnableDelegatedAdminAccountResponse, errors: [AccessDeniedException, ConflictException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Disassociates multiple code repositories from an Amazon Inspector code security scan
 * configuration.
 */
export const batchDisassociateCodeSecurityScanConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: BatchDisassociateCodeSecurityScanConfigurationRequest, output: BatchDisassociateCodeSecurityScanConfigurationResponse, errors: [AccessDeniedException, ConflictException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Retrieves information about a specific code security scan.
 */
export const getCodeSecurityScan = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetCodeSecurityScanRequest, output: GetCodeSecurityScanResponse, errors: [AccessDeniedException, ConflictException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Specifies the action that is to be applied to the findings that match the filter.
 */
export const updateFilter = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateFilterRequest, output: UpdateFilterResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Resets an encryption key. After the key is reset your resources will be encrypted by an
 * Amazon Web Services owned key.
 */
export const resetEncryptionKey = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ResetEncryptionKeyRequest, output: ResetEncryptionKeyResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const updateEncryptionKey = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateEncryptionKeyRequest, output: UpdateEncryptionKeyResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Cancels the given findings report.
 */
export const cancelFindingsReport = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CancelFindingsReportRequest, output: CancelFindingsReportResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Cancels a software bill of materials (SBOM) report.
 */
export const cancelSbomExport = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CancelSbomExportRequest, output: CancelSbomExportResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Deletes a CIS scan configuration.
 */
export const deleteCisScanConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteCisScanConfigurationRequest, output: DeleteCisScanConfigurationResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Deletes a code security integration.
 */
export const deleteCodeSecurityIntegration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteCodeSecurityIntegrationRequest, output: DeleteCodeSecurityIntegrationResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Deletes a code security scan configuration.
 */
export const deleteCodeSecurityScanConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteCodeSecurityScanConfigurationRequest, output: DeleteCodeSecurityScanConfigurationResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Deletes a filter resource.
 */
export const deleteFilter = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteFilterRequest, output: DeleteFilterResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Enables Amazon Inspector scans for one or more Amazon Web Services accounts.
 */
export const enable = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: EnableRequest, output: EnableResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Retrieves a CIS scan report.
 */
export const getCisScanReport = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetCisScanReportRequest, output: GetCisScanReportResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Retrieves information about a code security integration.
 */
export const getCodeSecurityIntegration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetCodeSecurityIntegrationRequest, output: GetCodeSecurityIntegrationResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Retrieves information about a code security scan configuration.
 */
export const getCodeSecurityScanConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetCodeSecurityScanConfigurationRequest, output: GetCodeSecurityScanConfigurationResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Retrieves information about the Amazon Inspector delegated administrator for your
 * organization.
 */
export const getDelegatedAdminAccount = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetDelegatedAdminAccountRequest, output: GetDelegatedAdminAccountResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Gets an encryption key.
 */
export const getEncryptionKey = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetEncryptionKeyRequest, output: GetEncryptionKeyResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Gets the status of a findings report.
 */
export const getFindingsReportStatus = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetFindingsReportStatusRequest, output: GetFindingsReportStatusResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Gets details of a software bill of materials (SBOM) report.
 */
export const getSbomExport = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetSbomExportRequest, output: GetSbomExportResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Lists all tags attached to a given resource.
 */
export const listTagsForResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListTagsForResourceRequest, output: ListTagsForResourceResponse, errors: [InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Adds tags to a resource.
 */
export const tagResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: TagResourceRequest, output: TagResourceResponse, errors: [BadRequestException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const createFindingsReport = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateFindingsReportRequest, output: CreateFindingsReportResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const disable = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DisableRequest, output: DisableResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Gets member information for your organization.
 */
export const getMember = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetMemberRequest, output: GetMemberResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Lists the associations between code repositories and Amazon Inspector code security scan
 * configurations.
 */
export const listCodeSecurityScanConfigurationAssociations = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListCodeSecurityScanConfigurationAssociationsRequest, output: ListCodeSecurityScanConfigurationAssociationsResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Lists all code security scan configurations in your account.
 */
export const listCodeSecurityScanConfigurations = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListCodeSecurityScanConfigurationsRequest, output: ListCodeSecurityScanConfigurationsResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Activates, deactivates Amazon Inspector deep inspection, or updates custom paths for your account.
 */
export const updateEc2DeepInspectionConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateEc2DeepInspectionConfigurationRequest, output: UpdateEc2DeepInspectionConfigurationResponse, errors: [AccessDeniedException, InternalServerException, ThrottlingException, ValidationException] }));
/**
 * Updates the configurations for your Amazon Inspector organization.
 */
export const updateOrganizationConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateOrganizationConfigurationRequest, output: UpdateOrganizationConfigurationResponse, errors: [AccessDeniedException, InternalServerException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const updateOrgEc2DeepInspectionConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateOrgEc2DeepInspectionConfigurationRequest, output: UpdateOrgEc2DeepInspectionConfigurationResponse, errors: [AccessDeniedException, InternalServerException, ThrottlingException, ValidationException] }));
/**
 * Describe Amazon Inspector configuration settings for an Amazon Web Services organization.
 */
export const describeOrganizationConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeOrganizationConfigurationRequest, output: DescribeOrganizationConfigurationResponse, errors: [AccessDeniedException, InternalServerException, ThrottlingException, ValidationException] }));
/**
 * Disassociates a member account from an Amazon Inspector delegated administrator.
 */
export const disassociateMember = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DisassociateMemberRequest, output: DisassociateMemberResponse, errors: [AccessDeniedException, InternalServerException, ThrottlingException, ValidationException] }));
/**
 * List members associated with the Amazon Inspector delegated administrator for your
 * organization.
 */
export const listMembers = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListMembersRequest, output: ListMembersResponse, errors: [AccessDeniedException, InternalServerException, ThrottlingException, ValidationException] }));
/**
 ...
 * use this API.
 */
export const batchGetMemberEc2DeepInspectionStatus = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: BatchGetMemberEc2DeepInspectionStatusRequest, output: BatchGetMemberEc2DeepInspectionStatusResponse, errors: [AccessDeniedException, InternalServerException, ThrottlingException, ValidationException] }));
/**
 ...
 * this API.
 */
export const batchUpdateMemberEc2DeepInspectionStatus = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: BatchUpdateMemberEc2DeepInspectionStatusRequest, output: BatchUpdateMemberEc2DeepInspectionStatusResponse, errors: [AccessDeniedException, InternalServerException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const listAccountPermissions = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListAccountPermissionsRequest, output: ListAccountPermissionsResponse, errors: [AccessDeniedException, InternalServerException, ThrottlingException, ValidationException] }));
/**
 * Lists all code security integrations in your account.
 */
export const listCodeSecurityIntegrations = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListCodeSecurityIntegrationsRequest, output: ListCodeSecurityIntegrationsResponse, errors: [AccessDeniedException, InternalServerException, ThrottlingException, ValidationException] }));
/**
 * Lists Amazon Inspector coverage statistics for your environment.
 */
export const listCoverageStatistics = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListCoverageStatisticsRequest, output: ListCoverageStatisticsResponse, errors: [InternalServerException, ThrottlingException, ValidationException] }));
/**
 * Lists information about the Amazon Inspector delegated administrator of your organization.
 */
export const listDelegatedAdminAccounts = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListDelegatedAdminAccountsRequest, output: ListDelegatedAdminAccountsResponse, errors: [AccessDeniedException, InternalServerException, ThrottlingException, ValidationException] }));
/**
 * Lists the filters associated with your account.
 */
export const listFilters = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListFiltersRequest, output: ListFiltersResponse, errors: [AccessDeniedException, InternalServerException, ThrottlingException, ValidationException] }));
/**
 * Sends a CIS session telemetry. This API is used by the Amazon Inspector SSM plugin to
 * communicate with the Amazon Inspector service. The Amazon Inspector SSM plugin calls
 * this API to start a CIS scan session for the scan ID supplied by the service.
 */
export const sendCisSessionTelemetry = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: SendCisSessionTelemetryRequest, output: SendCisSessionTelemetryResponse, errors: [AccessDeniedException, ConflictException, InternalServerException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const stopCisSession = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StopCisSessionRequest, output: StopCisSessionResponse, errors: [AccessDeniedException, ConflictException, InternalServerException, ThrottlingException, ValidationException] }));
/**
 * Removes tags from a resource.
 */
export const untagResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UntagResourceRequest, output: UntagResourceResponse, errors: [InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Updates a CIS scan configuration.
 */
export const updateCisScanConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateCisScanConfigurationRequest, output: UpdateCisScanConfigurationResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Associates multiple code repositories with an Amazon Inspector code security scan
 * configuration.
 */
export const batchAssociateCodeSecurityScanConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: BatchAssociateCodeSecurityScanConfigurationRequest, output: BatchAssociateCodeSecurityScanConfigurationResponse, errors: [AccessDeniedException, ConflictException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Retrieves the Amazon Inspector status of multiple Amazon Web Services accounts within your environment.
 */
export const batchGetAccountStatus = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: BatchGetAccountStatusRequest, output: BatchGetAccountStatusResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Retrieves code snippets from findings that Amazon Inspector detected code vulnerabilities
 * in.
 */
export const batchGetCodeSnippet = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: BatchGetCodeSnippetRequest, output: BatchGetCodeSnippetResponse, errors: [AccessDeniedException, InternalServerException, ThrottlingException, ValidationException] }));
/**
 * Gets vulnerability details for findings.
 */
export const batchGetFindingDetails = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: BatchGetFindingDetailsRequest, output: BatchGetFindingDetailsResponse, errors: [AccessDeniedException, InternalServerException, ThrottlingException, ValidationException] }));
/**
 * Gets free trial status for multiple Amazon Web Services accounts.
 */
export const batchGetFreeTrialInfo = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: BatchGetFreeTrialInfoRequest, output: BatchGetFreeTrialInfoResponse, errors: [AccessDeniedException, InternalServerException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const createCodeSecurityIntegration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateCodeSecurityIntegrationRequest, output: CreateCodeSecurityIntegrationResponse, errors: [AccessDeniedException, ConflictException, InternalServerException, ServiceQuotaExceededException, ThrottlingException, ValidationException] }));
/**
 * Creates a scan configuration for code security scanning.
 */
export const createCodeSecurityScanConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateCodeSecurityScanConfigurationRequest, output: CreateCodeSecurityScanConfigurationResponse, errors: [AccessDeniedException, ConflictException, InternalServerException, ServiceQuotaExceededException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const createFilter = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateFilterRequest, output: CreateFilterResponse, errors: [AccessDeniedException, BadRequestException, InternalServerException, ServiceQuotaExceededException, ThrottlingException, ValidationException] }));
/**
 * Creates a software bill of materials (SBOM) report.
 */
export const createSbomExport = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateSbomExportRequest, output: CreateSbomExportResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Lists the Amazon Inspector usage totals over the last 30 days.
 */
export const listUsageTotals = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListUsageTotalsRequest, output: ListUsageTotalsResponse, errors: [AccessDeniedException, InternalServerException, ThrottlingException, ValidationException] }));
/**
 ...
 * to complete the integration setup
 */
export const updateCodeSecurityIntegration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateCodeSecurityIntegrationRequest, output: UpdateCodeSecurityIntegrationResponse, errors: [AccessDeniedException, ConflictException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Creates a CIS scan configuration.
 */
export const createCisScanConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateCisScanConfigurationRequest, output: CreateCisScanConfigurationResponse, errors: [AccessDeniedException, InternalServerException, ThrottlingException, ValidationException] }));
/**
 * Retrieves CIS scan result details.
 */
export const getCisScanResultDetails = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetCisScanResultDetailsRequest, output: GetCisScanResultDetailsResponse, errors: [AccessDeniedException, InternalServerException, ThrottlingException, ValidationException] }));
/**
 * Lists scan results aggregated by a target resource.
 */
export const listCisScanResultsAggregatedByTargetResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListCisScanResultsAggregatedByTargetResourceRequest, output: ListCisScanResultsAggregatedByTargetResourceResponse, errors: [AccessDeniedException, InternalServerException, ThrottlingException, ValidationException] }));
/**
 * Returns a CIS scan list.
 */
export const listCisScans = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListCisScansRequest, output: ListCisScansResponse, errors: [AccessDeniedException, InternalServerException, ThrottlingException, ValidationException] }));
/**
 * Lists Amazon Inspector coverage details for a specific vulnerability.
 */
export const searchVulnerabilities = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: SearchVulnerabilitiesRequest, output: SearchVulnerabilitiesResponse, errors: [AccessDeniedException, InternalServerException, ThrottlingException, ValidationException] }));
/**
 * Lists CIS scan configurations.
 */
export const listCisScanConfigurations = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListCisScanConfigurationsRequest, output: ListCisScanConfigurationsResponse, errors: [AccessDeniedException, InternalServerException, ThrottlingException, ValidationException] }));
/**
 * Lists scan results aggregated by checks.
 */
export const listCisScanResultsAggregatedByChecks = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListCisScanResultsAggregatedByChecksRequest, output: ListCisScanResultsAggregatedByChecksResponse, errors: [AccessDeniedException, InternalServerException, ThrottlingException, ValidationException] }));
/**
 * Lists aggregated finding data for your environment based on specific criteria.
 */
export const listFindingAggregations = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListFindingAggregationsRequest, output: ListFindingAggregationsResponse, errors: [InternalServerException, ThrottlingException, ValidationException] }));
/**
 * Returns a list of clusters and metadata associated with an image.
 */
export const getClustersForImage = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetClustersForImageRequest, output: GetClustersForImageResponse, errors: [AccessDeniedException, InternalServerException, ThrottlingException, ValidationException] }));
/**
 * Lists findings for your environment.
 */
export const listFindings = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListFindingsRequest, output: ListFindingsResponse, errors: [InternalServerException, ThrottlingException, ValidationException] }));
/**
 * Lists coverage details for your environment.
 */
export const listCoverage = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListCoverageRequest, output: ListCoverageResponse, errors: [InternalServerException, ThrottlingException, ValidationException] }));
