...
const svc = T.AwsApiService({ sdkId: "Kinesis Video WebRTC Storage", serviceShapeName: "AWSAcuityRoutingServiceLambda" });
...
//# Schemas
export class JoinStorageSessionInput extends S.Class<JoinStorageSessionInput>("JoinStorageSessionInput")({channelArn: S.String}, T.all(T.Http({ method: "POST", uri: "/joinStorageSession" }), svc, auth, proto, ver, rules)) {}
export class JoinStorageSessionResponse extends S.Class<JoinStorageSessionResponse>("JoinStorageSessionResponse")({}) {}
export class JoinStorageSessionAsViewerInput extends S.Class<JoinStorageSessionAsViewerInput>("JoinStorageSessionAsViewerInput")({channelArn: S.String, clientId: S.String}, T.all(T.Http({ method: "POST", uri: "/joinStorageSessionAsViewer" }), svc, auth, proto, ver, rules)) {}
export class JoinStorageSessionAsViewerResponse extends S.Class<JoinStorageSessionAsViewerResponse>("JoinStorageSessionAsViewerResponse")({}) {}
 ...
 */
export const joinStorageSession = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: JoinStorageSessionInput, output: JoinStorageSessionResponse, errors: [AccessDeniedException, ClientLimitExceededException, InvalidArgumentException, ResourceNotFoundException] }));
/**
 ...
 */
export const joinStorageSessionAsViewer = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: JoinStorageSessionAsViewerInput, output: JoinStorageSessionAsViewerResponse, errors: [AccessDeniedException, ClientLimitExceededException, InvalidArgumentException, ResourceNotFoundException] }));
