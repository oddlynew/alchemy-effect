...
export class AssociateKmsKeyRequest extends S.Class<AssociateKmsKeyRequest>("AssociateKmsKeyRequest")({logGroupName: S.optional(S.String), kmsKeyId: S.String, resourceIdentifier: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class AssociateKmsKeyResponse extends S.Class<AssociateKmsKeyResponse>("AssociateKmsKeyResponse")({}, ns) {}
export class CancelExportTaskRequest extends S.Class<CancelExportTaskRequest>("CancelExportTaskRequest")({taskId: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class CancelExportTaskResponse extends S.Class<CancelExportTaskResponse>("CancelExportTaskResponse")({}, ns) {}
export class CancelImportTaskRequest extends S.Class<CancelImportTaskRequest>("CancelImportTaskRequest")({importId: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class CreateExportTaskRequest extends S.Class<CreateExportTaskRequest>("CreateExportTaskRequest")({taskName: S.optional(S.String), logGroupName: S.String, logStreamNamePrefix: S.optional(S.String), from: S.Number, to: S.Number, destination: S.String, destinationPrefix: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export const Tags = S.Record({key: S.String, value: S.String});
export class CreateLogAnomalyDetectorRequest extends S.Class<CreateLogAnomalyDetectorRequest>("CreateLogAnomalyDetectorRequest")({logGroupArnList: LogGroupArnList, detectorName: S.optional(S.String), evaluationFrequency: S.optional(S.String), filterPattern: S.optional(S.String), kmsKeyId: S.optional(S.String), anomalyVisibilityTime: S.optional(S.Number), tags: S.optional(Tags)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class CreateLogGroupRequest extends S.Class<CreateLogGroupRequest>("CreateLogGroupRequest")({logGroupName: S.String, kmsKeyId: S.optional(S.String), tags: S.optional(Tags), logGroupClass: S.optional(S.String), deletionProtectionEnabled: S.optional(S.Boolean)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class CreateLogGroupResponse extends S.Class<CreateLogGroupResponse>("CreateLogGroupResponse")({}, ns) {}
export class CreateLogStreamRequest extends S.Class<CreateLogStreamRequest>("CreateLogStreamRequest")({logGroupName: S.String, logStreamName: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class CreateLogStreamResponse extends S.Class<CreateLogStreamResponse>("CreateLogStreamResponse")({}, ns) {}
export class DeleteAccountPolicyRequest extends S.Class<DeleteAccountPolicyRequest>("DeleteAccountPolicyRequest")({policyName: S.String, policyType: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteAccountPolicyResponse extends S.Class<DeleteAccountPolicyResponse>("DeleteAccountPolicyResponse")({}, ns) {}
export class DeleteDataProtectionPolicyRequest extends S.Class<DeleteDataProtectionPolicyRequest>("DeleteDataProtectionPolicyRequest")({logGroupIdentifier: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteDataProtectionPolicyResponse extends S.Class<DeleteDataProtectionPolicyResponse>("DeleteDataProtectionPolicyResponse")({}, ns) {}
export class DeleteDeliveryRequest extends S.Class<DeleteDeliveryRequest>("DeleteDeliveryRequest")({id: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteDeliveryResponse extends S.Class<DeleteDeliveryResponse>("DeleteDeliveryResponse")({}, ns) {}
export class DeleteDeliveryDestinationRequest extends S.Class<DeleteDeliveryDestinationRequest>("DeleteDeliveryDestinationRequest")({name: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteDeliveryDestinationResponse extends S.Class<DeleteDeliveryDestinationResponse>("DeleteDeliveryDestinationResponse")({}, ns) {}
export class DeleteDeliveryDestinationPolicyRequest extends S.Class<DeleteDeliveryDestinationPolicyRequest>("DeleteDeliveryDestinationPolicyRequest")({deliveryDestinationName: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteDeliveryDestinationPolicyResponse extends S.Class<DeleteDeliveryDestinationPolicyResponse>("DeleteDeliveryDestinationPolicyResponse")({}, ns) {}
export class DeleteDeliverySourceRequest extends S.Class<DeleteDeliverySourceRequest>("DeleteDeliverySourceRequest")({name: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteDeliverySourceResponse extends S.Class<DeleteDeliverySourceResponse>("DeleteDeliverySourceResponse")({}, ns) {}
export class DeleteDestinationRequest extends S.Class<DeleteDestinationRequest>("DeleteDestinationRequest")({destinationName: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteDestinationResponse extends S.Class<DeleteDestinationResponse>("DeleteDestinationResponse")({}, ns) {}
export class DeleteIndexPolicyRequest extends S.Class<DeleteIndexPolicyRequest>("DeleteIndexPolicyRequest")({logGroupIdentifier: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteIndexPolicyResponse extends S.Class<DeleteIndexPolicyResponse>("DeleteIndexPolicyResponse")({}, ns) {}
export class DeleteIntegrationRequest extends S.Class<DeleteIntegrationRequest>("DeleteIntegrationRequest")({integrationName: S.String, force: S.optional(S.Boolean)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteIntegrationResponse extends S.Class<DeleteIntegrationResponse>("DeleteIntegrationResponse")({}, ns) {}
export class DeleteLogAnomalyDetectorRequest extends S.Class<DeleteLogAnomalyDetectorRequest>("DeleteLogAnomalyDetectorRequest")({anomalyDetectorArn: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteLogAnomalyDetectorResponse extends S.Class<DeleteLogAnomalyDetectorResponse>("DeleteLogAnomalyDetectorResponse")({}, ns) {}
export class DeleteLogGroupRequest extends S.Class<DeleteLogGroupRequest>("DeleteLogGroupRequest")({logGroupName: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteLogGroupResponse extends S.Class<DeleteLogGroupResponse>("DeleteLogGroupResponse")({}, ns) {}
export class DeleteLogStreamRequest extends S.Class<DeleteLogStreamRequest>("DeleteLogStreamRequest")({logGroupName: S.String, logStreamName: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteLogStreamResponse extends S.Class<DeleteLogStreamResponse>("DeleteLogStreamResponse")({}, ns) {}
export class DeleteMetricFilterRequest extends S.Class<DeleteMetricFilterRequest>("DeleteMetricFilterRequest")({logGroupName: S.String, filterName: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteMetricFilterResponse extends S.Class<DeleteMetricFilterResponse>("DeleteMetricFilterResponse")({}, ns) {}
export class DeleteQueryDefinitionRequest extends S.Class<DeleteQueryDefinitionRequest>("DeleteQueryDefinitionRequest")({queryDefinitionId: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteResourcePolicyRequest extends S.Class<DeleteResourcePolicyRequest>("DeleteResourcePolicyRequest")({policyName: S.optional(S.String), resourceArn: S.optional(S.String), expectedRevisionId: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteResourcePolicyResponse extends S.Class<DeleteResourcePolicyResponse>("DeleteResourcePolicyResponse")({}, ns) {}
export class DeleteRetentionPolicyRequest extends S.Class<DeleteRetentionPolicyRequest>("DeleteRetentionPolicyRequest")({logGroupName: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteRetentionPolicyResponse extends S.Class<DeleteRetentionPolicyResponse>("DeleteRetentionPolicyResponse")({}, ns) {}
export class DeleteScheduledQueryRequest extends S.Class<DeleteScheduledQueryRequest>("DeleteScheduledQueryRequest")({identifier: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteScheduledQueryResponse extends S.Class<DeleteScheduledQueryResponse>("DeleteScheduledQueryResponse")({}, ns) {}
export class DeleteSubscriptionFilterRequest extends S.Class<DeleteSubscriptionFilterRequest>("DeleteSubscriptionFilterRequest")({logGroupName: S.String, filterName: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteSubscriptionFilterResponse extends S.Class<DeleteSubscriptionFilterResponse>("DeleteSubscriptionFilterResponse")({}, ns) {}
export class DeleteTransformerRequest extends S.Class<DeleteTransformerRequest>("DeleteTransformerRequest")({logGroupIdentifier: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteTransformerResponse extends S.Class<DeleteTransformerResponse>("DeleteTransformerResponse")({}, ns) {}
export class DescribeAccountPoliciesRequest extends S.Class<DescribeAccountPoliciesRequest>("DescribeAccountPoliciesRequest")({policyType: S.String, policyName: S.optional(S.String), accountIdentifiers: S.optional(AccountIds), nextToken: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class DescribeDeliveriesRequest extends S.Class<DescribeDeliveriesRequest>("DescribeDeliveriesRequest")({nextToken: S.optional(S.String), limit: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeDeliveryDestinationsRequest extends S.Class<DescribeDeliveryDestinationsRequest>("DescribeDeliveryDestinationsRequest")({nextToken: S.optional(S.String), limit: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeDeliverySourcesRequest extends S.Class<DescribeDeliverySourcesRequest>("DescribeDeliverySourcesRequest")({nextToken: S.optional(S.String), limit: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeDestinationsRequest extends S.Class<DescribeDestinationsRequest>("DescribeDestinationsRequest")({DestinationNamePrefix: S.optional(S.String), nextToken: S.optional(S.String), limit: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeExportTasksRequest extends S.Class<DescribeExportTasksRequest>("DescribeExportTasksRequest")({taskId: S.optional(S.String), statusCode: S.optional(S.String), nextToken: S.optional(S.String), limit: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeFieldIndexesRequest extends S.Class<DescribeFieldIndexesRequest>("DescribeFieldIndexesRequest")({logGroupIdentifiers: DescribeFieldIndexesLogGroupIdentifiers, nextToken: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeImportTaskBatchesRequest extends S.Class<DescribeImportTaskBatchesRequest>("DescribeImportTaskBatchesRequest")({importId: S.String, batchImportStatus: S.optional(ImportStatusList), limit: S.optional(S.Number), nextToken: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeImportTasksRequest extends S.Class<DescribeImportTasksRequest>("DescribeImportTasksRequest")({importId: S.optional(S.String), importStatus: S.optional(S.String), importSourceArn: S.optional(S.String), limit: S.optional(S.Number), nextToken: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeIndexPoliciesRequest extends S.Class<DescribeIndexPoliciesRequest>("DescribeIndexPoliciesRequest")({logGroupIdentifiers: DescribeIndexPoliciesLogGroupIdentifiers, nextToken: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeLogGroupsRequest extends S.Class<DescribeLogGroupsRequest>("DescribeLogGroupsRequest")({accountIdentifiers: S.optional(AccountIds), logGroupNamePrefix: S.optional(S.String), logGroupNamePattern: S.optional(S.String), nextToken: S.optional(S.String), limit: S.optional(S.Number), includeLinkedAccounts: S.optional(S.Boolean), logGroupClass: S.optional(S.String), logGroupIdentifiers: S.optional(DescribeLogGroupsLogGroupIdentifiers)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class DescribeQueriesRequest extends S.Class<DescribeQueriesRequest>("DescribeQueriesRequest")({logGroupName: S.optional(S.String), status: S.optional(S.String), maxResults: S.optional(S.Number), nextToken: S.optional(S.String), queryLanguage: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeQueryDefinitionsRequest extends S.Class<DescribeQueryDefinitionsRequest>("DescribeQueryDefinitionsRequest")({queryLanguage: S.optional(S.String), queryDefinitionNamePrefix: S.optional(S.String), maxResults: S.optional(S.Number), nextToken: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeResourcePoliciesRequest extends S.Class<DescribeResourcePoliciesRequest>("DescribeResourcePoliciesRequest")({nextToken: S.optional(S.String), limit: S.optional(S.Number), resourceArn: S.optional(S.String), policyScope: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeSubscriptionFiltersRequest extends S.Class<DescribeSubscriptionFiltersRequest>("DescribeSubscriptionFiltersRequest")({logGroupName: S.String, filterNamePrefix: S.optional(S.String), nextToken: S.optional(S.String), limit: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DisassociateKmsKeyRequest extends S.Class<DisassociateKmsKeyRequest>("DisassociateKmsKeyRequest")({logGroupName: S.optional(S.String), resourceIdentifier: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DisassociateKmsKeyResponse extends S.Class<DisassociateKmsKeyResponse>("DisassociateKmsKeyResponse")({}, ns) {}
export class DisassociateSourceFromS3TableIntegrationRequest extends S.Class<DisassociateSourceFromS3TableIntegrationRequest>("DisassociateSourceFromS3TableIntegrationRequest")({identifier: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class FilterLogEventsRequest extends S.Class<FilterLogEventsRequest>("FilterLogEventsRequest")({logGroupName: S.optional(S.String), logGroupIdentifier: S.optional(S.String), logStreamNames: S.optional(InputLogStreamNames), logStreamNamePrefix: S.optional(S.String), startTime: S.optional(S.Number), endTime: S.optional(S.Number), filterPattern: S.optional(S.String), nextToken: S.optional(S.String), limit: S.optional(S.Number), interleaved: S.optional(S.Boolean), unmask: S.optional(S.Boolean)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetDataProtectionPolicyRequest extends S.Class<GetDataProtectionPolicyRequest>("GetDataProtectionPolicyRequest")({logGroupIdentifier: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetDeliveryRequest extends S.Class<GetDeliveryRequest>("GetDeliveryRequest")({id: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetDeliveryDestinationRequest extends S.Class<GetDeliveryDestinationRequest>("GetDeliveryDestinationRequest")({name: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetDeliveryDestinationPolicyRequest extends S.Class<GetDeliveryDestinationPolicyRequest>("GetDeliveryDestinationPolicyRequest")({deliveryDestinationName: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetDeliverySourceRequest extends S.Class<GetDeliverySourceRequest>("GetDeliverySourceRequest")({name: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetIntegrationRequest extends S.Class<GetIntegrationRequest>("GetIntegrationRequest")({integrationName: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetLogAnomalyDetectorRequest extends S.Class<GetLogAnomalyDetectorRequest>("GetLogAnomalyDetectorRequest")({anomalyDetectorArn: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetLogEventsRequest extends S.Class<GetLogEventsRequest>("GetLogEventsRequest")({logGroupName: S.optional(S.String), logGroupIdentifier: S.optional(S.String), logStreamName: S.String, startTime: S.optional(S.Number), endTime: S.optional(S.Number), nextToken: S.optional(S.String), limit: S.optional(S.Number), startFromHead: S.optional(S.Boolean), unmask: S.optional(S.Boolean)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetLogFieldsRequest extends S.Class<GetLogFieldsRequest>("GetLogFieldsRequest")({dataSourceName: S.String, dataSourceType: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetLogGroupFieldsRequest extends S.Class<GetLogGroupFieldsRequest>("GetLogGroupFieldsRequest")({logGroupName: S.optional(S.String), time: S.optional(S.Number), logGroupIdentifier: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetLogObjectRequest extends S.Class<GetLogObjectRequest>("GetLogObjectRequest")({unmask: S.optional(S.Boolean), logObjectPointer: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetLogRecordRequest extends S.Class<GetLogRecordRequest>("GetLogRecordRequest")({logRecordPointer: S.String, unmask: S.optional(S.Boolean)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetQueryResultsRequest extends S.Class<GetQueryResultsRequest>("GetQueryResultsRequest")({queryId: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetScheduledQueryRequest extends S.Class<GetScheduledQueryRequest>("GetScheduledQueryRequest")({identifier: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetScheduledQueryHistoryRequest extends S.Class<GetScheduledQueryHistoryRequest>("GetScheduledQueryHistoryRequest")({identifier: S.String, startTime: S.Number, endTime: S.Number, executionStatuses: S.optional(ExecutionStatusList), maxResults: S.optional(S.Number), nextToken: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetTransformerRequest extends S.Class<GetTransformerRequest>("GetTransformerRequest")({logGroupIdentifier: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListAnomaliesRequest extends S.Class<ListAnomaliesRequest>("ListAnomaliesRequest")({anomalyDetectorArn: S.optional(S.String), suppressionState: S.optional(S.String), limit: S.optional(S.Number), nextToken: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListIntegrationsRequest extends S.Class<ListIntegrationsRequest>("ListIntegrationsRequest")({integrationNamePrefix: S.optional(S.String), integrationType: S.optional(S.String), integrationStatus: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListLogAnomalyDetectorsRequest extends S.Class<ListLogAnomalyDetectorsRequest>("ListLogAnomalyDetectorsRequest")({filterLogGroupArn: S.optional(S.String), limit: S.optional(S.Number), nextToken: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class ListLogGroupsRequest extends S.Class<ListLogGroupsRequest>("ListLogGroupsRequest")({logGroupNamePattern: S.optional(S.String), logGroupClass: S.optional(S.String), includeLinkedAccounts: S.optional(S.Boolean), accountIdentifiers: S.optional(AccountIds), nextToken: S.optional(S.String), limit: S.optional(S.Number), dataSources: S.optional(DataSourceFilters), fieldIndexNames: S.optional(FieldIndexNames)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListLogGroupsForQueryRequest extends S.Class<ListLogGroupsForQueryRequest>("ListLogGroupsForQueryRequest")({queryId: S.String, nextToken: S.optional(S.String), maxResults: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListScheduledQueriesRequest extends S.Class<ListScheduledQueriesRequest>("ListScheduledQueriesRequest")({maxResults: S.optional(S.Number), nextToken: S.optional(S.String), state: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListSourcesForS3TableIntegrationRequest extends S.Class<ListSourcesForS3TableIntegrationRequest>("ListSourcesForS3TableIntegrationRequest")({integrationArn: S.String, maxResults: S.optional(S.Number), nextToken: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListTagsForResourceRequest extends S.Class<ListTagsForResourceRequest>("ListTagsForResourceRequest")({resourceArn: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListTagsLogGroupRequest extends S.Class<ListTagsLogGroupRequest>("ListTagsLogGroupRequest")({logGroupName: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutAccountPolicyRequest extends S.Class<PutAccountPolicyRequest>("PutAccountPolicyRequest")({policyName: S.String, policyDocument: S.String, policyType: S.String, scope: S.optional(S.String), selectionCriteria: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutDataProtectionPolicyRequest extends S.Class<PutDataProtectionPolicyRequest>("PutDataProtectionPolicyRequest")({logGroupIdentifier: S.String, policyDocument: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutDeliveryDestinationPolicyRequest extends S.Class<PutDeliveryDestinationPolicyRequest>("PutDeliveryDestinationPolicyRequest")({deliveryDestinationName: S.String, deliveryDestinationPolicy: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutDeliverySourceRequest extends S.Class<PutDeliverySourceRequest>("PutDeliverySourceRequest")({name: S.String, resourceArn: S.String, logType: S.String, tags: S.optional(Tags)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutDestinationRequest extends S.Class<PutDestinationRequest>("PutDestinationRequest")({destinationName: S.String, targetArn: S.String, roleArn: S.String, tags: S.optional(Tags)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutDestinationPolicyRequest extends S.Class<PutDestinationPolicyRequest>("PutDestinationPolicyRequest")({destinationName: S.String, accessPolicy: S.String, forceUpdate: S.optional(S.Boolean)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutDestinationPolicyResponse extends S.Class<PutDestinationPolicyResponse>("PutDestinationPolicyResponse")({}, ns) {}
export class PutIndexPolicyRequest extends S.Class<PutIndexPolicyRequest>("PutIndexPolicyRequest")({logGroupIdentifier: S.String, policyDocument: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutLogGroupDeletionProtectionRequest extends S.Class<PutLogGroupDeletionProtectionRequest>("PutLogGroupDeletionProtectionRequest")({logGroupIdentifier: S.String, deletionProtectionEnabled: S.Boolean}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutLogGroupDeletionProtectionResponse extends S.Class<PutLogGroupDeletionProtectionResponse>("PutLogGroupDeletionProtectionResponse")({}, ns) {}
export class PutQueryDefinitionRequest extends S.Class<PutQueryDefinitionRequest>("PutQueryDefinitionRequest")({queryLanguage: S.optional(S.String), name: S.String, queryDefinitionId: S.optional(S.String), logGroupNames: S.optional(LogGroupNames), queryString: S.String, clientToken: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutResourcePolicyRequest extends S.Class<PutResourcePolicyRequest>("PutResourcePolicyRequest")({policyName: S.optional(S.String), policyDocument: S.optional(S.String), resourceArn: S.optional(S.String), expectedRevisionId: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutRetentionPolicyRequest extends S.Class<PutRetentionPolicyRequest>("PutRetentionPolicyRequest")({logGroupName: S.String, retentionInDays: S.Number}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutRetentionPolicyResponse extends S.Class<PutRetentionPolicyResponse>("PutRetentionPolicyResponse")({}, ns) {}
export class PutSubscriptionFilterRequest extends S.Class<PutSubscriptionFilterRequest>("PutSubscriptionFilterRequest")({logGroupName: S.String, filterName: S.String, filterPattern: S.String, destinationArn: S.String, roleArn: S.optional(S.String), distribution: S.optional(S.String), applyOnTransformedLogs: S.optional(S.Boolean), fieldSelectionCriteria: S.optional(S.String), emitSystemFields: S.optional(EmitSystemFields)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutSubscriptionFilterResponse extends S.Class<PutSubscriptionFilterResponse>("PutSubscriptionFilterResponse")({}, ns) {}
export class StartLiveTailRequest extends S.Class<StartLiveTailRequest>("StartLiveTailRequest")({logGroupIdentifiers: StartLiveTailLogGroupIdentifiers, logStreamNames: S.optional(InputLogStreamNames), logStreamNamePrefixes: S.optional(InputLogStreamNames), logEventFilterPattern: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class StopQueryRequest extends S.Class<StopQueryRequest>("StopQueryRequest")({queryId: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class TagLogGroupRequest extends S.Class<TagLogGroupRequest>("TagLogGroupRequest")({logGroupName: S.String, tags: Tags}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class TagLogGroupResponse extends S.Class<TagLogGroupResponse>("TagLogGroupResponse")({}, ns) {}
export class TagResourceRequest extends S.Class<TagResourceRequest>("TagResourceRequest")({resourceArn: S.String, tags: Tags}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class TagResourceResponse extends S.Class<TagResourceResponse>("TagResourceResponse")({}, ns) {}
export class TestMetricFilterRequest extends S.Class<TestMetricFilterRequest>("TestMetricFilterRequest")({filterPattern: S.String, logEventMessages: TestEventMessages}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class TestTransformerRequest extends S.Class<TestTransformerRequest>("TestTransformerRequest")({transformerConfig: Processors, logEventMessages: TestEventMessages}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class UntagLogGroupRequest extends S.Class<UntagLogGroupRequest>("UntagLogGroupRequest")({logGroupName: S.String, tags: TagList}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class UntagLogGroupResponse extends S.Class<UntagLogGroupResponse>("UntagLogGroupResponse")({}, ns) {}
...
export class UpdateDeliveryConfigurationRequest extends S.Class<UpdateDeliveryConfigurationRequest>("UpdateDeliveryConfigurationRequest")({id: S.String, recordFields: S.optional(RecordFields), fieldDelimiter: S.optional(S.String), s3DeliveryConfiguration: S.optional(S3DeliveryConfiguration)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class UpdateDeliveryConfigurationResponse extends S.Class<UpdateDeliveryConfigurationResponse>("UpdateDeliveryConfigurationResponse")({}, ns) {}
export class UpdateLogAnomalyDetectorRequest extends S.Class<UpdateLogAnomalyDetectorRequest>("UpdateLogAnomalyDetectorRequest")({anomalyDetectorArn: S.String, evaluationFrequency: S.optional(S.String), filterPattern: S.optional(S.String), anomalyVisibilityTime: S.optional(S.Number), enabled: S.Boolean}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class UpdateLogAnomalyDetectorResponse extends S.Class<UpdateLogAnomalyDetectorResponse>("UpdateLogAnomalyDetectorResponse")({}, ns) {}
...
export class AssociateSourceToS3TableIntegrationRequest extends S.Class<AssociateSourceToS3TableIntegrationRequest>("AssociateSourceToS3TableIntegrationRequest")({integrationArn: S.String, dataSource: DataSource}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class CreateDeliveryRequest extends S.Class<CreateDeliveryRequest>("CreateDeliveryRequest")({deliverySourceName: S.String, deliveryDestinationArn: S.String, recordFields: S.optional(RecordFields), fieldDelimiter: S.optional(S.String), s3DeliveryConfiguration: S.optional(S3DeliveryConfiguration), tags: S.optional(Tags)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class CreateExportTaskResponse extends S.Class<CreateExportTaskResponse>("CreateExportTaskResponse")({taskId: S.optional(S.String)}, ns) {}
export class CreateImportTaskRequest extends S.Class<CreateImportTaskRequest>("CreateImportTaskRequest")({importSourceArn: S.String, importRoleArn: S.String, importFilter: S.optional(ImportFilter)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class CreateLogAnomalyDetectorResponse extends S.Class<CreateLogAnomalyDetectorResponse>("CreateLogAnomalyDetectorResponse")({anomalyDetectorArn: S.optional(S.String)}, ns) {}
export class DeleteQueryDefinitionResponse extends S.Class<DeleteQueryDefinitionResponse>("DeleteQueryDefinitionResponse")({success: S.optional(S.Boolean)}, ns) {}
export class DisassociateSourceFromS3TableIntegrationResponse extends S.Class<DisassociateSourceFromS3TableIntegrationResponse>("DisassociateSourceFromS3TableIntegrationResponse")({identifier: S.optional(S.String)}, ns) {}
export class GetDataProtectionPolicyResponse extends S.Class<GetDataProtectionPolicyResponse>("GetDataProtectionPolicyResponse")({logGroupIdentifier: S.optional(S.String), policyDocument: S.optional(S.String), lastUpdatedTime: S.optional(S.Number)}, ns) {}
...
export class GetDeliveryResponse extends S.Class<GetDeliveryResponse>("GetDeliveryResponse")({delivery: S.optional(Delivery)}, ns) {}
...
export class GetDeliveryDestinationResponse extends S.Class<GetDeliveryDestinationResponse>("GetDeliveryDestinationResponse")({deliveryDestination: S.optional(DeliveryDestination)}, ns) {}
...
export class ListLogGroupsForQueryResponse extends S.Class<ListLogGroupsForQueryResponse>("ListLogGroupsForQueryResponse")({logGroupIdentifiers: S.optional(LogGroupIdentifiers), nextToken: S.optional(S.String)}, ns) {}
export class ListTagsForResourceResponse extends S.Class<ListTagsForResourceResponse>("ListTagsForResourceResponse")({tags: S.optional(Tags)}, ns) {}
export class ListTagsLogGroupResponse extends S.Class<ListTagsLogGroupResponse>("ListTagsLogGroupResponse")({tags: S.optional(Tags)}, ns) {}
...
export class PutAccountPolicyResponse extends S.Class<PutAccountPolicyResponse>("PutAccountPolicyResponse")({accountPolicy: S.optional(AccountPolicy)}, ns) {}
export class PutDataProtectionPolicyResponse extends S.Class<PutDataProtectionPolicyResponse>("PutDataProtectionPolicyResponse")({logGroupIdentifier: S.optional(S.String), policyDocument: S.optional(S.String), lastUpdatedTime: S.optional(S.Number)}, ns) {}
...
export class PutDeliveryDestinationPolicyResponse extends S.Class<PutDeliveryDestinationPolicyResponse>("PutDeliveryDestinationPolicyResponse")({policy: S.optional(Policy)}, ns) {}
export class PutDeliverySourceResponse extends S.Class<PutDeliverySourceResponse>("PutDeliverySourceResponse")({deliverySource: S.optional(DeliverySource)}, ns) {}
...
export class PutDestinationResponse extends S.Class<PutDestinationResponse>("PutDestinationResponse")({destination: S.optional(Destination)}, ns) {}
...
export class PutIndexPolicyResponse extends S.Class<PutIndexPolicyResponse>("PutIndexPolicyResponse")({indexPolicy: S.optional(IndexPolicy)}, ns) {}
export class PutQueryDefinitionResponse extends S.Class<PutQueryDefinitionResponse>("PutQueryDefinitionResponse")({queryDefinitionId: S.optional(S.String)}, ns) {}
...
export class PutResourcePolicyResponse extends S.Class<PutResourcePolicyResponse>("PutResourcePolicyResponse")({resourcePolicy: S.optional(ResourcePolicy), revisionId: S.optional(S.String)}, ns) {}
export class StartQueryResponse extends S.Class<StartQueryResponse>("StartQueryResponse")({queryId: S.optional(S.String)}, ns) {}
export class StopQueryResponse extends S.Class<StopQueryResponse>("StopQueryResponse")({success: S.optional(S.Boolean)}, ns) {}
export class UpdateAnomalyRequest extends S.Class<UpdateAnomalyRequest>("UpdateAnomalyRequest")({anomalyId: S.optional(S.String), patternId: S.optional(S.String), anomalyDetectorArn: S.String, suppressionType: S.optional(S.String), suppressionPeriod: S.optional(SuppressionPeriod), baseline: S.optional(S.Boolean)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class UpdateAnomalyResponse extends S.Class<UpdateAnomalyResponse>("UpdateAnomalyResponse")({}, ns) {}
...
export const ResourceConfig = S.Union(S.Struct({ openSearchResourceConfig: OpenSearchResourceConfig }));
...
export class AssociateSourceToS3TableIntegrationResponse extends S.Class<AssociateSourceToS3TableIntegrationResponse>("AssociateSourceToS3TableIntegrationResponse")({identifier: S.optional(S.String)}, ns) {}
export class CancelImportTaskResponse extends S.Class<CancelImportTaskResponse>("CancelImportTaskResponse")({importId: S.optional(S.String), importStatistics: S.optional(ImportStatistics), importStatus: S.optional(S.String), creationTime: S.optional(S.Number), lastUpdatedTime: S.optional(S.Number)}, ns) {}
export class CreateDeliveryResponse extends S.Class<CreateDeliveryResponse>("CreateDeliveryResponse")({delivery: S.optional(Delivery)}, ns) {}
export class CreateImportTaskResponse extends S.Class<CreateImportTaskResponse>("CreateImportTaskResponse")({importId: S.optional(S.String), importDestinationArn: S.optional(S.String), creationTime: S.optional(S.Number)}, ns) {}
...
export class DescribeAccountPoliciesResponse extends S.Class<DescribeAccountPoliciesResponse>("DescribeAccountPoliciesResponse")({accountPolicies: S.optional(AccountPolicies), nextToken: S.optional(S.String)}, ns) {}
export class DescribeDeliveriesResponse extends S.Class<DescribeDeliveriesResponse>("DescribeDeliveriesResponse")({deliveries: S.optional(Deliveries), nextToken: S.optional(S.String)}, ns) {}
export class DescribeDeliveryDestinationsResponse extends S.Class<DescribeDeliveryDestinationsResponse>("DescribeDeliveryDestinationsResponse")({deliveryDestinations: S.optional(DeliveryDestinations), nextToken: S.optional(S.String)}, ns) {}
export class DescribeDeliverySourcesResponse extends S.Class<DescribeDeliverySourcesResponse>("DescribeDeliverySourcesResponse")({deliverySources: S.optional(DeliverySources), nextToken: S.optional(S.String)}, ns) {}
export class DescribeDestinationsResponse extends S.Class<DescribeDestinationsResponse>("DescribeDestinationsResponse")({destinations: S.optional(Destinations), nextToken: S.optional(S.String)}, ns) {}
export class DescribeFieldIndexesResponse extends S.Class<DescribeFieldIndexesResponse>("DescribeFieldIndexesResponse")({fieldIndexes: S.optional(FieldIndexes), nextToken: S.optional(S.String)}, ns) {}
export class DescribeImportTaskBatchesResponse extends S.Class<DescribeImportTaskBatchesResponse>("DescribeImportTaskBatchesResponse")({importSourceArn: S.optional(S.String), importId: S.optional(S.String), importBatches: S.optional(ImportBatchList), nextToken: S.optional(S.String)}, ns) {}
export class DescribeImportTasksResponse extends S.Class<DescribeImportTasksResponse>("DescribeImportTasksResponse")({imports: S.optional(ImportList), nextToken: S.optional(S.String)}, ns) {}
export class DescribeIndexPoliciesResponse extends S.Class<DescribeIndexPoliciesResponse>("DescribeIndexPoliciesResponse")({indexPolicies: S.optional(IndexPolicies), nextToken: S.optional(S.String)}, ns) {}
export class DescribeLogGroupsResponse extends S.Class<DescribeLogGroupsResponse>("DescribeLogGroupsResponse")({logGroups: S.optional(LogGroups), nextToken: S.optional(S.String)}, ns) {}
export class DescribeLogStreamsResponse extends S.Class<DescribeLogStreamsResponse>("DescribeLogStreamsResponse")({logStreams: S.optional(LogStreams), nextToken: S.optional(S.String)}, ns) {}
export class DescribeMetricFiltersResponse extends S.Class<DescribeMetricFiltersResponse>("DescribeMetricFiltersResponse")({metricFilters: S.optional(MetricFilters), nextToken: S.optional(S.String)}, ns) {}
export class DescribeQueriesResponse extends S.Class<DescribeQueriesResponse>("DescribeQueriesResponse")({queries: S.optional(QueryInfoList), nextToken: S.optional(S.String)}, ns) {}
export class DescribeQueryDefinitionsResponse extends S.Class<DescribeQueryDefinitionsResponse>("DescribeQueryDefinitionsResponse")({queryDefinitions: S.optional(QueryDefinitionList), nextToken: S.optional(S.String)}, ns) {}
export class DescribeResourcePoliciesResponse extends S.Class<DescribeResourcePoliciesResponse>("DescribeResourcePoliciesResponse")({resourcePolicies: S.optional(ResourcePolicies), nextToken: S.optional(S.String)}, ns) {}
export class DescribeSubscriptionFiltersResponse extends S.Class<DescribeSubscriptionFiltersResponse>("DescribeSubscriptionFiltersResponse")({subscriptionFilters: S.optional(SubscriptionFilters), nextToken: S.optional(S.String)}, ns) {}
export class FilterLogEventsResponse extends S.Class<FilterLogEventsResponse>("FilterLogEventsResponse")({events: S.optional(FilteredLogEvents), searchedLogStreams: S.optional(SearchedLogStreams), nextToken: S.optional(S.String)}, ns) {}
export class GetDeliveryDestinationPolicyResponse extends S.Class<GetDeliveryDestinationPolicyResponse>("GetDeliveryDestinationPolicyResponse")({policy: S.optional(Policy)}, ns) {}
export class GetLogEventsResponse extends S.Class<GetLogEventsResponse>("GetLogEventsResponse")({events: S.optional(OutputLogEvents), nextForwardToken: S.optional(S.String), nextBackwardToken: S.optional(S.String)}, ns) {}
export class GetLogGroupFieldsResponse extends S.Class<GetLogGroupFieldsResponse>("GetLogGroupFieldsResponse")({logGroupFields: S.optional(LogGroupFieldList)}, ns) {}
export class GetLogRecordResponse extends S.Class<GetLogRecordResponse>("GetLogRecordResponse")({logRecord: S.optional(LogRecord)}, ns) {}
export class GetQueryResultsResponse extends S.Class<GetQueryResultsResponse>("GetQueryResultsResponse")({queryLanguage: S.optional(S.String), results: S.optional(QueryResults), statistics: S.optional(QueryStatistics), status: S.optional(S.String), encryptionKey: S.optional(S.String)}, ns) {}
export class ListIntegrationsResponse extends S.Class<ListIntegrationsResponse>("ListIntegrationsResponse")({integrationSummaries: S.optional(IntegrationSummaries)}, ns) {}
export class ListLogAnomalyDetectorsResponse extends S.Class<ListLogAnomalyDetectorsResponse>("ListLogAnomalyDetectorsResponse")({anomalyDetectors: S.optional(AnomalyDetectors), nextToken: S.optional(S.String)}, ns) {}
export class ListLogGroupsResponse extends S.Class<ListLogGroupsResponse>("ListLogGroupsResponse")({logGroups: S.optional(LogGroupSummaries), nextToken: S.optional(S.String)}, ns) {}
export class ListScheduledQueriesResponse extends S.Class<ListScheduledQueriesResponse>("ListScheduledQueriesResponse")({nextToken: S.optional(S.String), scheduledQueries: S.optional(ScheduledQuerySummaryList)}, ns) {}
export class ListSourcesForS3TableIntegrationResponse extends S.Class<ListSourcesForS3TableIntegrationResponse>("ListSourcesForS3TableIntegrationResponse")({sources: S.optional(S3TableIntegrationSources), nextToken: S.optional(S.String)}, ns) {}
export class PutDeliveryDestinationResponse extends S.Class<PutDeliveryDestinationResponse>("PutDeliveryDestinationResponse")({deliveryDestination: S.optional(DeliveryDestination)}, ns) {}
export class PutIntegrationRequest extends S.Class<PutIntegrationRequest>("PutIntegrationRequest")({integrationName: S.String, resourceConfig: ResourceConfig, integrationType: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutLogEventsRequest extends S.Class<PutLogEventsRequest>("PutLogEventsRequest")({logGroupName: S.String, logStreamName: S.String, logEvents: InputLogEvents, sequenceToken: S.optional(S.String), entity: S.optional(Entity)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutMetricFilterRequest extends S.Class<PutMetricFilterRequest>("PutMetricFilterRequest")({logGroupName: S.String, filterName: S.String, filterPattern: S.String, metricTransformations: MetricTransformations, applyOnTransformedLogs: S.optional(S.Boolean), fieldSelectionCriteria: S.optional(S.String), emitSystemFieldDimensions: S.optional(EmitSystemFields)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutMetricFilterResponse extends S.Class<PutMetricFilterResponse>("PutMetricFilterResponse")({}, ns) {}
export class TestTransformerResponse extends S.Class<TestTransformerResponse>("TestTransformerResponse")({transformedLogs: S.optional(TransformedLogs)}, ns) {}
...
export class FieldsData extends S.Class<FieldsData>("FieldsData")({data: S.optional(T.Blob)}) {}
...
export const GetLogObjectResponseStream = T.EventStream(S.Union(S.Struct({ fields: FieldsData }), S.Struct({ InternalStreamingException: InternalStreamingException })));
...
export class CreateScheduledQueryResponse extends S.Class<CreateScheduledQueryResponse>("CreateScheduledQueryResponse")({scheduledQueryArn: S.optional(S.String), state: S.optional(S.String)}, ns) {}
export class DescribeConfigurationTemplatesResponse extends S.Class<DescribeConfigurationTemplatesResponse>("DescribeConfigurationTemplatesResponse")({configurationTemplates: S.optional(ConfigurationTemplates), nextToken: S.optional(S.String)}, ns) {}
export class DescribeExportTasksResponse extends S.Class<DescribeExportTasksResponse>("DescribeExportTasksResponse")({exportTasks: S.optional(ExportTasks), nextToken: S.optional(S.String)}, ns) {}
export class GetLogFieldsResponse extends S.Class<GetLogFieldsResponse>("GetLogFieldsResponse")({logFields: S.optional(LogFieldsList)}, ns) {}
export class GetLogObjectResponse extends S.Class<GetLogObjectResponse>("GetLogObjectResponse")({fieldStream: S.optional(GetLogObjectResponseStream)}, ns) {}
export class GetScheduledQueryHistoryResponse extends S.Class<GetScheduledQueryHistoryResponse>("GetScheduledQueryHistoryResponse")({name: S.optional(S.String), scheduledQueryArn: S.optional(S.String), triggerHistory: S.optional(TriggerHistoryRecordList), nextToken: S.optional(S.String)}, ns) {}
export class PutIntegrationResponse extends S.Class<PutIntegrationResponse>("PutIntegrationResponse")({integrationName: S.optional(S.String), integrationStatus: S.optional(S.String)}, ns) {}
export class PutTransformerRequest extends S.Class<PutTransformerRequest>("PutTransformerRequest")({logGroupIdentifier: S.String, transformerConfig: Processors}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutTransformerResponse extends S.Class<PutTransformerResponse>("PutTransformerResponse")({}, ns) {}
export class TestMetricFilterResponse extends S.Class<TestMetricFilterResponse>("TestMetricFilterResponse")({matches: S.optional(MetricFilterMatches)}, ns) {}
...
export const StartLiveTailResponseStream = T.EventStream(S.Union(S.Struct({ sessionStart: LiveTailSessionStart }), S.Struct({ sessionUpdate: LiveTailSessionUpdate }), S.Struct({ SessionTimeoutException: SessionTimeoutException }), S.Struct({ SessionStreamingException: SessionStreamingException })));
...
export class ListAggregateLogGroupSummariesResponse extends S.Class<ListAggregateLogGroupSummariesResponse>("ListAggregateLogGroupSummariesResponse")({aggregateLogGroupSummaries: S.optional(AggregateLogGroupSummaries), nextToken: S.optional(S.String)}, ns) {}
export class ListAnomaliesResponse extends S.Class<ListAnomaliesResponse>("ListAnomaliesResponse")({anomalies: S.optional(Anomalies), nextToken: S.optional(S.String)}, ns) {}
export class PutLogEventsResponse extends S.Class<PutLogEventsResponse>("PutLogEventsResponse")({nextSequenceToken: S.optional(S.String), rejectedLogEventsInfo: S.optional(RejectedLogEventsInfo), rejectedEntityInfo: S.optional(RejectedEntityInfo)}, ns) {}
export class StartLiveTailResponse extends S.Class<StartLiveTailResponse>("StartLiveTailResponse")({responseStream: S.optional(StartLiveTailResponseStream)}, ns) {}
...
export const IntegrationDetails = S.Union(S.Struct({ openSearchIntegrationDetails: OpenSearchIntegrationDetails }));
...
export class GetIntegrationResponse extends S.Class<GetIntegrationResponse>("GetIntegrationResponse")({integrationName: S.optional(S.String), integrationType: S.optional(S.String), integrationStatus: S.optional(S.String), integrationDetails: S.optional(IntegrationDetails)}, ns) {}
...
export class OperationAbortedException extends S.TaggedError<OperationAbortedException>()("OperationAbortedException", {message: S.optional(S.String)}) {}
 ...
 */
export const untagLogGroup = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UntagLogGroupRequest, output: UntagLogGroupResponse, errors: [ResourceNotFoundException] }));
/**
 ...
 */
export const tagLogGroup = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: TagLogGroupRequest, output: TagLogGroupResponse, errors: [InvalidParameterException, ResourceNotFoundException] }));
/**
 * Returns information about a log group data protection policy.
 */
export const getDataProtectionPolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetDataProtectionPolicyRequest, output: GetDataProtectionPolicyResponse, errors: [InvalidParameterException, OperationAbortedException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 * Retrieves information about the log anomaly detector that you specify. The KMS key ARN detected is valid.
 */
export const getLogAnomalyDetector = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetLogAnomalyDetectorRequest, output: GetLogAnomalyDetectorResponse, errors: [InvalidParameterException, OperationAbortedException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 ...
 */
export const putDestination = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutDestinationRequest, output: PutDestinationResponse, errors: [InvalidParameterException, OperationAbortedException, ServiceUnavailableException] }));
/**
 ...
 */
export const updateAnomaly = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateAnomalyRequest, output: UpdateAnomalyResponse, errors: [InvalidParameterException, OperationAbortedException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 ...
 * Insights queries.
 */
export const deleteAccountPolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteAccountPolicyRequest, output: DeleteAccountPolicyResponse, errors: [InvalidParameterException, OperationAbortedException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 * Deletes the data protection policy from the specified log group.
 * 
 * For more information about data protection policies, see PutDataProtectionPolicy.
 */
export const deleteDataProtectionPolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteDataProtectionPolicyRequest, output: DeleteDataProtectionPolicyResponse, errors: [InvalidParameterException, OperationAbortedException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 ...
 * destination.
 */
export const deleteDestination = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteDestinationRequest, output: DeleteDestinationResponse, errors: [InvalidParameterException, OperationAbortedException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 * Deletes the specified CloudWatch Logs anomaly detector.
 */
export const deleteLogAnomalyDetector = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteLogAnomalyDetectorRequest, output: DeleteLogAnomalyDetectorResponse, errors: [InvalidParameterException, OperationAbortedException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 * Deletes the specified metric filter.
 */
export const deleteMetricFilter = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteMetricFilterRequest, output: DeleteMetricFilterResponse, errors: [InvalidParameterException, OperationAbortedException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 ...
 */
export const deleteResourcePolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteResourcePolicyRequest, output: DeleteResourcePolicyResponse, errors: [InvalidParameterException, OperationAbortedException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 ...
 * policy.
 */
export const deleteRetentionPolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteRetentionPolicyRequest, output: DeleteRetentionPolicyResponse, errors: [InvalidParameterException, OperationAbortedException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 * Deletes the specified subscription filter.
 */
export const deleteSubscriptionFilter = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteSubscriptionFilterRequest, output: DeleteSubscriptionFilterResponse, errors: [InvalidParameterException, OperationAbortedException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 ...
 */
export const disassociateKmsKey = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DisassociateKmsKeyRequest, output: DisassociateKmsKeyResponse, errors: [InvalidParameterException, OperationAbortedException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 ...
 */
export const putDestinationPolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutDestinationPolicyRequest, output: PutDestinationPolicyResponse, errors: [InvalidParameterException, OperationAbortedException, ServiceUnavailableException] }));
/**
 ...
 */
export const putRetentionPolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutRetentionPolicyRequest, output: PutRetentionPolicyResponse, errors: [InvalidParameterException, OperationAbortedException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 * Updates an existing log anomaly detector.
 */
export const updateLogAnomalyDetector = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateLogAnomalyDetectorRequest, output: UpdateLogAnomalyDetectorResponse, errors: [InvalidParameterException, OperationAbortedException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 ...
 */
export const deleteTransformer = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteTransformerRequest, output: DeleteTransformerResponse, errors: [InvalidOperationException, InvalidParameterException, OperationAbortedException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 ...
 */
export const putLogGroupDeletionProtection = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutLogGroupDeletionProtectionRequest, output: PutLogGroupDeletionProtectionResponse, errors: [AccessDeniedException, InvalidOperationException, InvalidParameterException, OperationAbortedException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 ...
 * data with masking.
 */
export const createLogAnomalyDetector = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateLogAnomalyDetectorRequest, output: CreateLogAnomalyDetectorResponse, errors: [InvalidParameterException, LimitExceededException, OperationAbortedException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 ...
 * `"/aws/lambda"`.
 */
export const putAccountPolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutAccountPolicyRequest, output: PutAccountPolicyResponse, errors: [InvalidParameterException, LimitExceededException, OperationAbortedException, ServiceUnavailableException] }));
/**
 ...
 * specified in either policy is masked.
 */
export const putDataProtectionPolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutDataProtectionPolicyRequest, output: PutDataProtectionPolicyResponse, errors: [InvalidParameterException, LimitExceededException, OperationAbortedException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 ...
 */
export const putIndexPolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutIndexPolicyRequest, output: PutIndexPolicyResponse, errors: [InvalidParameterException, LimitExceededException, OperationAbortedException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 ...
 * this operation.
 */
export const putQueryDefinition = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutQueryDefinitionRequest, output: PutQueryDefinitionResponse, errors: [InvalidParameterException, LimitExceededException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 ...
 * policies.
 */
export const putResourcePolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutResourcePolicyRequest, output: PutResourcePolicyResponse, errors: [InvalidParameterException, LimitExceededException, OperationAbortedException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 ...
 */
export const createLogGroup = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateLogGroupRequest, output: CreateLogGroupResponse, errors: [InvalidParameterException, LimitExceededException, OperationAbortedException, ResourceAlreadyExistsException, ServiceUnavailableException] }));
/**
 ...
 * the log group.
 */
export const deleteIndexPolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteIndexPolicyRequest, output: DeleteIndexPolicyResponse, errors: [InvalidParameterException, LimitExceededException, OperationAbortedException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 ...
 * permission.
 */
export const putSubscriptionFilter = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutSubscriptionFilterRequest, output: PutSubscriptionFilterResponse, errors: [InvalidOperationException, InvalidParameterException, LimitExceededException, OperationAbortedException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 ...
 */
export const createExportTask = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateExportTaskRequest, output: CreateExportTaskResponse, errors: [InvalidParameterException, LimitExceededException, OperationAbortedException, ResourceAlreadyExistsException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 * Removes one or more tags from the specified resource.
 */
export const untagResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UntagResourceRequest, output: UntagResourceResponse, errors: [InvalidParameterException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 * Cancels the specified export task.
 * 
 * The task must be in the `PENDING` or `RUNNING` state.
 */
export const cancelExportTask = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CancelExportTaskRequest, output: CancelExportTaskResponse, errors: [InvalidOperationException, InvalidParameterException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 ...
 * this operation.
 */
export const deleteQueryDefinition = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteQueryDefinitionRequest, output: DeleteQueryDefinitionResponse, errors: [InvalidParameterException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 ...
 */
export const getTransformer = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetTransformerRequest, output: GetTransformerResponse, errors: [InvalidOperationException, InvalidParameterException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 ...
 */
export const listLogGroupsForQuery = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListLogGroupsForQueryRequest, output: ListLogGroupsForQueryResponse, errors: [AccessDeniedException, InvalidParameterException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 * Displays the tags associated with a CloudWatch Logs resource. Currently, log groups and
 * destinations support tagging.
 */
export const listTagsForResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListTagsForResourceRequest, output: ListTagsForResourceResponse, errors: [InvalidParameterException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 ...
 */
export const listTagsLogGroup = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListTagsLogGroupRequest, output: ListTagsLogGroupResponse, errors: [ResourceNotFoundException, ServiceUnavailableException] }));
/**
 ...
 * itself.
 */
export const stopQuery = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StopQueryRequest, output: StopQueryResponse, errors: [InvalidParameterException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 ...
 * `InvalidParameterException` error.
 */
export const associateKmsKey = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: AssociateKmsKeyRequest, output: AssociateKmsKeyResponse, errors: [InvalidParameterException, OperationAbortedException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 ...
 */
export const describeAccountPolicies = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeAccountPoliciesRequest, output: DescribeAccountPoliciesResponse, errors: [InvalidParameterException, OperationAbortedException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 * Lists all your destinations. The results are ASCII-sorted by destination
 * name.
 */
export const describeDestinations = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeDestinationsRequest, output: DescribeDestinationsResponse, errors: [InvalidParameterException, ServiceUnavailableException] }));
/**
 ...
 */
export const describeFieldIndexes = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeFieldIndexesRequest, output: DescribeFieldIndexesResponse, errors: [InvalidParameterException, LimitExceededException, OperationAbortedException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 ...
 */
export const describeIndexPolicies = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeIndexPoliciesRequest, output: DescribeIndexPoliciesResponse, errors: [InvalidParameterException, LimitExceededException, OperationAbortedException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 ...
 */
export const describeLogGroups = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeLogGroupsRequest, output: DescribeLogGroupsResponse, errors: [InvalidParameterException, ServiceUnavailableException] }));
/**
 ...
 * see CloudWatch cross-account observability.
 */
export const describeLogStreams = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeLogStreamsRequest, output: DescribeLogStreamsResponse, errors: [InvalidParameterException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 * Lists the specified metric filters. You can list all of the metric filters or filter
 * the results by log name, prefix, metric name, or metric namespace. The results are
 * ASCII-sorted by filter name.
 */
export const describeMetricFilters = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeMetricFiltersRequest, output: DescribeMetricFiltersResponse, errors: [InvalidParameterException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 ...
 * your account.
 */
export const describeQueries = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeQueriesRequest, output: DescribeQueriesResponse, errors: [InvalidParameterException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 ...
 */
export const describeQueryDefinitions = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeQueryDefinitionsRequest, output: DescribeQueryDefinitionsResponse, errors: [InvalidParameterException, ServiceUnavailableException] }));
/**
 * Lists the resource policies in this account.
 */
export const describeResourcePolicies = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeResourcePoliciesRequest, output: DescribeResourcePoliciesResponse, errors: [InvalidParameterException, ServiceUnavailableException] }));
/**
 ...
 * name.
 */
export const describeSubscriptionFilters = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeSubscriptionFiltersRequest, output: DescribeSubscriptionFiltersResponse, errors: [InvalidParameterException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 ...
 * query.
 */
export const filterLogEvents = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: FilterLogEventsRequest, output: FilterLogEventsResponse, errors: [InvalidParameterException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 ...
 * query.
 */
export const getLogEvents = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetLogEventsRequest, output: GetLogEventsResponse, errors: [InvalidParameterException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 ...
 * see CloudWatch cross-account observability.
 */
export const getLogGroupFields = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetLogGroupFieldsRequest, output: GetLogGroupFieldsResponse, errors: [InvalidParameterException, LimitExceededException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 ...
 */
export const getLogRecord = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetLogRecordRequest, output: GetLogRecordResponse, errors: [InvalidParameterException, LimitExceededException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 ...
 */
export const getQueryResults = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetQueryResultsRequest, output: GetQueryResultsResponse, errors: [InvalidParameterException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 ...
 */
export const listIntegrations = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListIntegrationsRequest, output: ListIntegrationsResponse, errors: [InvalidParameterException, ServiceUnavailableException] }));
/**
 * Retrieves a list of the log anomaly detectors in the account.
 */
export const listLogAnomalyDetectors = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListLogAnomalyDetectorsRequest, output: ListLogAnomalyDetectorsResponse, errors: [InvalidParameterException, OperationAbortedException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 ...
 */
export const listLogGroups = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListLogGroupsRequest, output: ListLogGroupsResponse, errors: [InvalidParameterException, ServiceUnavailableException] }));
/**
 ...
 */
export const putMetricFilter = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutMetricFilterRequest, output: PutMetricFilterResponse, errors: [InvalidOperationException, InvalidParameterException, LimitExceededException, OperationAbortedException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 ...
 */
export const testTransformer = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: TestTransformerRequest, output: TestTransformerResponse, errors: [InvalidOperationException, InvalidParameterException, ServiceUnavailableException] }));
/**
 ...
 */
export const createLogStream = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateLogStreamRequest, output: CreateLogStreamResponse, errors: [InvalidParameterException, ResourceAlreadyExistsException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 * Cancels an active import task and stops importing data from the CloudTrail Lake Event Data Store.
 */
export const cancelImportTask = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CancelImportTaskRequest, output: CancelImportTaskResponse, errors: [AccessDeniedException, InvalidOperationException, InvalidParameterException, ResourceNotFoundException, ThrottlingException] }));
/**
 * Lists the specified export tasks. You can list all your export tasks or filter the
 * results based on task ID or task status.
 */
export const describeExportTasks = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeExportTasksRequest, output: DescribeExportTasksResponse, errors: [InvalidParameterException, ServiceUnavailableException] }));
/**
 ...
 */
export const getLogFields = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetLogFieldsRequest, output: GetLogFieldsResponse, errors: [InvalidParameterException, OperationAbortedException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 ...
 */
export const getLogObject = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetLogObjectRequest, output: GetLogObjectResponse, errors: [AccessDeniedException, InvalidOperationException, InvalidParameterException, LimitExceededException, ResourceNotFoundException] }));
/**
 ...
 * account-level transformer.
 */
export const putTransformer = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutTransformerRequest, output: PutTransformerResponse, errors: [InvalidOperationException, InvalidParameterException, LimitExceededException, OperationAbortedException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 * Tests the filter pattern of a metric filter against a sample of log event messages. You
 * can use this operation to validate the correctness of a metric filter pattern.
 */
export const testMetricFilter = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: TestMetricFilterRequest, output: TestMetricFilterResponse, errors: [InvalidParameterException, ServiceUnavailableException] }));
/**
 ...
 */
export const deleteIntegration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteIntegrationRequest, output: DeleteIntegrationResponse, errors: [InvalidParameterException, ResourceNotFoundException, ServiceUnavailableException, ValidationException] }));
/**
 ...
 */
export const createImportTask = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateImportTaskRequest, output: CreateImportTaskResponse, errors: [AccessDeniedException, ConflictException, InvalidOperationException, InvalidParameterException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const deleteScheduledQuery = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteScheduledQueryRequest, output: DeleteScheduledQueryResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const describeImportTaskBatches = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeImportTaskBatchesRequest, output: DescribeImportTaskBatchesResponse, errors: [AccessDeniedException, InvalidOperationException, InvalidParameterException, ResourceNotFoundException, ThrottlingException] }));
/**
 * Lists and describes import tasks, with optional filtering by import status and source ARN.
 */
export const describeImportTasks = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeImportTasksRequest, output: DescribeImportTasksResponse, errors: [AccessDeniedException, InvalidOperationException, InvalidParameterException, ResourceNotFoundException, ThrottlingException] }));
/**
 ...
 */
export const listScheduledQueries = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListScheduledQueriesRequest, output: ListScheduledQueriesResponse, errors: [AccessDeniedException, InternalServerException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const listSourcesForS3TableIntegration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListSourcesForS3TableIntegrationRequest, output: ListSourcesForS3TableIntegrationResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const deleteDeliveryDestination = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteDeliveryDestinationRequest, output: DeleteDeliveryDestinationResponse, errors: [ConflictException, ResourceNotFoundException, ServiceQuotaExceededException, ServiceUnavailableException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const disassociateSourceFromS3TableIntegration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DisassociateSourceFromS3TableIntegrationRequest, output: DisassociateSourceFromS3TableIntegrationResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Retrieves details about a specific scheduled query, including its configuration, execution
 * status, and metadata.
 */
export const getScheduledQuery = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetScheduledQueryRequest, output: GetScheduledQueryResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const updateScheduledQuery = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateScheduledQueryRequest, output: UpdateScheduledQueryResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const associateSourceToS3TableIntegration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: AssociateSourceToS3TableIntegrationRequest, output: AssociateSourceToS3TableIntegrationResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const updateDeliveryConfiguration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateDeliveryConfigurationRequest, output: UpdateDeliveryConfigurationResponse, errors: [AccessDeniedException, ConflictException, ResourceNotFoundException, ServiceUnavailableException, ThrottlingException, ValidationException] }));
/**
 ...
 * the results.
 */
export const deleteDeliverySource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteDeliverySourceRequest, output: DeleteDeliverySourceResponse, errors: [ConflictException, ResourceNotFoundException, ServiceQuotaExceededException, ServiceUnavailableException, ThrottlingException, ValidationException] }));
/**
 ...
 * source.
 */
export const deleteDelivery = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteDeliveryRequest, output: DeleteDeliveryResponse, errors: [ConflictException, ResourceNotFoundException, ServiceQuotaExceededException, ServiceUnavailableException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const getDelivery = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetDeliveryRequest, output: GetDeliveryResponse, errors: [ResourceNotFoundException, ServiceQuotaExceededException, ServiceUnavailableException, ThrottlingException, ValidationException] }));
/**
 * Retrieves complete information about one delivery destination.
 */
export const getDeliveryDestination = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetDeliveryDestinationRequest, output: GetDeliveryDestinationResponse, errors: [ResourceNotFoundException, ServiceQuotaExceededException, ServiceUnavailableException, ThrottlingException, ValidationException] }));
/**
 * Retrieves complete information about one delivery source.
 */
export const getDeliverySource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetDeliverySourceRequest, output: GetDeliverySourceResponse, errors: [ResourceNotFoundException, ServiceQuotaExceededException, ServiceUnavailableException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const putDeliverySource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutDeliverySourceRequest, output: PutDeliverySourceResponse, errors: [ConflictException, ResourceNotFoundException, ServiceQuotaExceededException, ServiceUnavailableException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const createDelivery = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateDeliveryRequest, output: CreateDeliveryResponse, errors: [AccessDeniedException, ConflictException, ResourceNotFoundException, ServiceQuotaExceededException, ServiceUnavailableException, ThrottlingException, ValidationException] }));
/**
 ...
 * Amazon Web Services services.
 */
export const describeDeliveries = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeDeliveriesRequest, output: DescribeDeliveriesResponse, errors: [ServiceQuotaExceededException, ServiceUnavailableException, ThrottlingException, ValidationException] }));
/**
 * Retrieves a list of the delivery destinations that have been created in the
 * account.
 */
export const describeDeliveryDestinations = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeDeliveryDestinationsRequest, output: DescribeDeliveryDestinationsResponse, errors: [ServiceQuotaExceededException, ServiceUnavailableException, ThrottlingException, ValidationException] }));
/**
 * Retrieves a list of the delivery sources that have been created in the account.
 */
export const describeDeliverySources = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeDeliverySourcesRequest, output: DescribeDeliverySourcesResponse, errors: [ServiceQuotaExceededException, ServiceUnavailableException, ThrottlingException, ValidationException] }));
/**
 ...
 * specify.
 */
export const putDeliveryDestination = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutDeliveryDestinationRequest, output: PutDeliveryDestinationResponse, errors: [ConflictException, ResourceNotFoundException, ServiceQuotaExceededException, ServiceUnavailableException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const tagResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: TagResourceRequest, output: TagResourceResponse, errors: [InvalidParameterException, ResourceNotFoundException, ServiceUnavailableException, TooManyTagsException] }));
/**
 * Deletes the specified log group and permanently deletes all the archived log events
 * associated with the log group.
 */
export const deleteLogGroup = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteLogGroupRequest, output: DeleteLogGroupResponse, errors: [InvalidParameterException, OperationAbortedException, ResourceNotFoundException, ServiceUnavailableException, ValidationException] }));
/**
 * Deletes the specified log stream and permanently deletes all the archived log events
 * associated with the log stream.
 */
export const deleteLogStream = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteLogStreamRequest, output: DeleteLogStreamResponse, errors: [InvalidParameterException, OperationAbortedException, ResourceNotFoundException, ServiceUnavailableException, ValidationException] }));
/**
 * Deletes a delivery destination policy. For more information about these policies, see
 * PutDeliveryDestinationPolicy.
 */
export const deleteDeliveryDestinationPolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteDeliveryDestinationPolicyRequest, output: DeleteDeliveryDestinationPolicyResponse, errors: [ConflictException, ResourceNotFoundException, ServiceUnavailableException, ValidationException] }));
/**
 ...
 * needed policies.
 */
export const putDeliveryDestinationPolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutDeliveryDestinationPolicyRequest, output: PutDeliveryDestinationPolicyResponse, errors: [ConflictException, ResourceNotFoundException, ServiceUnavailableException, ValidationException] }));
/**
 ...
 */
export const getDeliveryDestinationPolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetDeliveryDestinationPolicyRequest, output: GetDeliveryDestinationPolicyResponse, errors: [ResourceNotFoundException, ServiceUnavailableException, ValidationException] }));
/**
 ...
 */
export const createScheduledQuery = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateScheduledQueryRequest, output: CreateScheduledQueryResponse, errors: [AccessDeniedException, ConflictException, InternalServerException, ResourceNotFoundException, ServiceQuotaExceededException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const describeConfigurationTemplates = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeConfigurationTemplatesRequest, output: DescribeConfigurationTemplatesResponse, errors: [ResourceNotFoundException, ServiceUnavailableException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const getScheduledQueryHistory = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetScheduledQueryHistoryRequest, output: GetScheduledQueryHistoryResponse, errors: [AccessDeniedException, InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 ...
 * integration.
 */
export const putIntegration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutIntegrationRequest, output: PutIntegrationResponse, errors: [InvalidParameterException, LimitExceededException, ServiceUnavailableException, ValidationException] }));
/**
 ...
 * results.
 */
export const listAggregateLogGroupSummaries = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListAggregateLogGroupSummariesRequest, output: ListAggregateLogGroupSummariesResponse, errors: [InvalidParameterException, ServiceUnavailableException, ValidationException] }));
/**
 ...
 * section.
 */
export const listAnomalies = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListAnomaliesRequest, output: ListAnomaliesResponse, errors: [InvalidParameterException, OperationAbortedException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 ...
 */
export const startLiveTail = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StartLiveTailRequest, output: StartLiveTailResponse, errors: [AccessDeniedException, InvalidOperationException, InvalidParameterException, LimitExceededException, ResourceNotFoundException] }));
/**
 * Returns information about one integration between CloudWatch Logs and OpenSearch Service.
 */
export const getIntegration = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetIntegrationRequest, output: GetIntegrationResponse, errors: [InvalidParameterException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 ...
 */
export const startQuery = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StartQueryRequest, output: StartQueryResponse, errors: [InvalidParameterException, LimitExceededException, MalformedQueryException, ResourceNotFoundException, ServiceUnavailableException] }));
/**
 ...
 */
export const putLogEvents = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutLogEventsRequest, output: PutLogEventsResponse, errors: [DataAlreadyAcceptedException, InvalidParameterException, InvalidSequenceTokenException, ResourceNotFoundException, ServiceUnavailableException, UnrecognizedClientException] }));
