...
const svc = T.AwsApiService({ sdkId: "BCM Data Exports", serviceShapeName: "AWSBillingAndCostManagementDataExports" });
...
export class DeleteExportRequest extends S.Class<DeleteExportRequest>("DeleteExportRequest")({ExportArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetExecutionRequest extends S.Class<GetExecutionRequest>("GetExecutionRequest")({ExportArn: S.String, ExecutionId: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetExportRequest extends S.Class<GetExportRequest>("GetExportRequest")({ExportArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListExecutionsRequest extends S.Class<ListExecutionsRequest>("ListExecutionsRequest")({ExportArn: S.String, MaxResults: S.optional(S.Number), NextToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListExportsRequest extends S.Class<ListExportsRequest>("ListExportsRequest")({MaxResults: S.optional(S.Number), NextToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListTablesRequest extends S.Class<ListTablesRequest>("ListTablesRequest")({NextToken: S.optional(S.String), MaxResults: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class TagResourceRequest extends S.Class<TagResourceRequest>("TagResourceRequest")({ResourceArn: S.String, ResourceTags: ResourceTagList}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class TagResourceResponse extends S.Class<TagResourceResponse>("TagResourceResponse")({}) {}
export class UntagResourceRequest extends S.Class<UntagResourceRequest>("UntagResourceRequest")({ResourceArn: S.String, ResourceTagKeys: ResourceTagKeyList}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class UpdateExportRequest extends S.Class<UpdateExportRequest>("UpdateExportRequest")({ExportArn: S.String, Export: Export}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class GetTableRequest extends S.Class<GetTableRequest>("GetTableRequest")({TableName: S.String, TableProperties: S.optional(TableProperties)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class ExecutionStatus extends S.Class<ExecutionStatus>("ExecutionStatus")({StatusCode: S.optional(S.String), StatusReason: S.optional(S.String), CreatedAt: S.optional(S.Date.pipe(T.TimestampFormat("date-time"))), CompletedAt: S.optional(S.Date.pipe(T.TimestampFormat("date-time"))), LastUpdatedAt: S.optional(S.Date.pipe(T.TimestampFormat("date-time")))}) {}
export class ExportStatus extends S.Class<ExportStatus>("ExportStatus")({StatusCode: S.optional(S.String), StatusReason: S.optional(S.String), CreatedAt: S.optional(S.Date.pipe(T.TimestampFormat("date-time"))), LastUpdatedAt: S.optional(S.Date.pipe(T.TimestampFormat("date-time"))), LastRefreshedAt: S.optional(S.Date.pipe(T.TimestampFormat("date-time")))}) {}
...
export class CreateExportRequest extends S.Class<CreateExportRequest>("CreateExportRequest")({Export: Export, ResourceTags: S.optional(ResourceTagList)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class ThrottlingException extends S.TaggedError<ThrottlingException>()("ThrottlingException", {Message: S.String, QuotaCode: S.optional(S.String), ServiceCode: S.optional(S.String)}).pipe(withCategory(ERROR_CATEGORIES.THROTTLING_ERROR)) {}
 ...
 */
export const listExports = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListExportsRequest, output: ListExportsResponse, errors: [InternalServerException, ThrottlingException, ValidationException] }));
/**
 * Lists all available tables in data exports.
 */
export const listTables = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListTablesRequest, output: ListTablesResponse, errors: [InternalServerException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const updateExport = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateExportRequest, output: UpdateExportResponse, errors: [InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const deleteExport = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteExportRequest, output: DeleteExportResponse, errors: [InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const getExecution = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetExecutionRequest, output: GetExecutionResponse, errors: [InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Views the definition of an existing data export.
 */
export const getExport = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetExportRequest, output: GetExportResponse, errors: [InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 * Lists the historical executions for the export.
 */
export const listExecutions = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListExecutionsRequest, output: ListExecutionsResponse, errors: [InternalServerException, ResourceNotFoundException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const getTable = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetTableRequest, output: GetTableResponse, errors: [InternalServerException, ThrottlingException, ValidationException] }));
/**
 ...
 */
export const createExport = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateExportRequest, output: CreateExportResponse, errors: [InternalServerException, ServiceQuotaExceededException, ThrottlingException, ValidationException] }));
