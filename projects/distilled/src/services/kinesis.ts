...
//# Schemas
export class DescribeAccountSettingsInput extends S.Class<DescribeAccountSettingsInput>("DescribeAccountSettingsInput")({}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeLimitsInput extends S.Class<DescribeLimitsInput>("DescribeLimitsInput")({}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export const MetricsNameList = S.Array(S.String);
export const TagKeyList = S.Array(S.String);
export class DecreaseStreamRetentionPeriodInput extends S.Class<DecreaseStreamRetentionPeriodInput>("DecreaseStreamRetentionPeriodInput")({StreamName: S.optional(S.String), RetentionPeriodHours: S.Number, StreamARN: S.optional(S.String).pipe(T.ContextParam("StreamARN"))}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules, T.StaticContextParams({"OperationType":{"value":"control"}}))) {}
export class DecreaseStreamRetentionPeriodResponse extends S.Class<DecreaseStreamRetentionPeriodResponse>("DecreaseStreamRetentionPeriodResponse")({}, ns) {}
export class DeleteResourcePolicyInput extends S.Class<DeleteResourcePolicyInput>("DeleteResourcePolicyInput")({ResourceARN: S.String.pipe(T.ContextParam("ResourceARN"))}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules, T.StaticContextParams({"OperationType":{"value":"control"}}))) {}
export class DeleteResourcePolicyResponse extends S.Class<DeleteResourcePolicyResponse>("DeleteResourcePolicyResponse")({}, ns) {}
export class DeleteStreamInput extends S.Class<DeleteStreamInput>("DeleteStreamInput")({StreamName: S.optional(S.String), EnforceConsumerDeletion: S.optional(S.Boolean), StreamARN: S.optional(S.String).pipe(T.ContextParam("StreamARN"))}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules, T.StaticContextParams({"OperationType":{"value":"control"}}))) {}
export class DeleteStreamResponse extends S.Class<DeleteStreamResponse>("DeleteStreamResponse")({}, ns) {}
export class DeregisterStreamConsumerInput extends S.Class<DeregisterStreamConsumerInput>("DeregisterStreamConsumerInput")({StreamARN: S.optional(S.String).pipe(T.ContextParam("StreamARN")), ConsumerName: S.optional(S.String), ConsumerARN: S.optional(S.String).pipe(T.ContextParam("ConsumerARN"))}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules, T.StaticContextParams({"OperationType":{"value":"control"}}))) {}
export class DeregisterStreamConsumerResponse extends S.Class<DeregisterStreamConsumerResponse>("DeregisterStreamConsumerResponse")({}, ns) {}
export class DescribeLimitsOutput extends S.Class<DescribeLimitsOutput>("DescribeLimitsOutput")({ShardLimit: S.Number, OpenShardCount: S.Number, OnDemandStreamCount: S.Number, OnDemandStreamCountLimit: S.Number}, ns) {}
export class DescribeStreamInput extends S.Class<DescribeStreamInput>("DescribeStreamInput")({StreamName: S.optional(S.String), Limit: S.optional(S.Number), ExclusiveStartShardId: S.optional(S.String), StreamARN: S.optional(S.String).pipe(T.ContextParam("StreamARN"))}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules, T.StaticContextParams({"OperationType":{"value":"control"}}))) {}
export class DescribeStreamConsumerInput extends S.Class<DescribeStreamConsumerInput>("DescribeStreamConsumerInput")({StreamARN: S.optional(S.String).pipe(T.ContextParam("StreamARN")), ConsumerName: S.optional(S.String), ConsumerARN: S.optional(S.String).pipe(T.ContextParam("ConsumerARN"))}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules, T.StaticContextParams({"OperationType":{"value":"control"}}))) {}
export class DescribeStreamSummaryInput extends S.Class<DescribeStreamSummaryInput>("DescribeStreamSummaryInput")({StreamName: S.optional(S.String), StreamARN: S.optional(S.String).pipe(T.ContextParam("StreamARN"))}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules, T.StaticContextParams({"OperationType":{"value":"control"}}))) {}
export class DisableEnhancedMonitoringInput extends S.Class<DisableEnhancedMonitoringInput>("DisableEnhancedMonitoringInput")({StreamName: S.optional(S.String), ShardLevelMetrics: MetricsNameList, StreamARN: S.optional(S.String).pipe(T.ContextParam("StreamARN"))}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules, T.StaticContextParams({"OperationType":{"value":"control"}}))) {}
export class EnableEnhancedMonitoringInput extends S.Class<EnableEnhancedMonitoringInput>("EnableEnhancedMonitoringInput")({StreamName: S.optional(S.String), ShardLevelMetrics: MetricsNameList, StreamARN: S.optional(S.String).pipe(T.ContextParam("StreamARN"))}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules, T.StaticContextParams({"OperationType":{"value":"control"}}))) {}
export class GetRecordsInput extends S.Class<GetRecordsInput>("GetRecordsInput")({ShardIterator: S.String, Limit: S.optional(S.Number), StreamARN: S.optional(S.String).pipe(T.ContextParam("StreamARN"))}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules, T.StaticContextParams({"OperationType":{"value":"data"}}))) {}
export class GetResourcePolicyInput extends S.Class<GetResourcePolicyInput>("GetResourcePolicyInput")({ResourceARN: S.String.pipe(T.ContextParam("ResourceARN"))}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules, T.StaticContextParams({"OperationType":{"value":"control"}}))) {}
export class GetShardIteratorInput extends S.Class<GetShardIteratorInput>("GetShardIteratorInput")({StreamName: S.optional(S.String), ShardId: S.String, ShardIteratorType: S.String, StartingSequenceNumber: S.optional(S.String), Timestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), StreamARN: S.optional(S.String).pipe(T.ContextParam("StreamARN"))}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules, T.StaticContextParams({"OperationType":{"value":"data"}}))) {}
export class IncreaseStreamRetentionPeriodInput extends S.Class<IncreaseStreamRetentionPeriodInput>("IncreaseStreamRetentionPeriodInput")({StreamName: S.optional(S.String), RetentionPeriodHours: S.Number, StreamARN: S.optional(S.String).pipe(T.ContextParam("StreamARN"))}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules, T.StaticContextParams({"OperationType":{"value":"control"}}))) {}
export class IncreaseStreamRetentionPeriodResponse extends S.Class<IncreaseStreamRetentionPeriodResponse>("IncreaseStreamRetentionPeriodResponse")({}, ns) {}
export class ListStreamConsumersInput extends S.Class<ListStreamConsumersInput>("ListStreamConsumersInput")({StreamARN: S.String.pipe(T.ContextParam("StreamARN")), NextToken: S.optional(S.String), MaxResults: S.optional(S.Number), StreamCreationTimestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules, T.StaticContextParams({"OperationType":{"value":"control"}}))) {}
export class ListStreamsInput extends S.Class<ListStreamsInput>("ListStreamsInput")({Limit: S.optional(S.Number), ExclusiveStartStreamName: S.optional(S.String), NextToken: S.optional(S.String)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListTagsForResourceInput extends S.Class<ListTagsForResourceInput>("ListTagsForResourceInput")({ResourceARN: S.String.pipe(T.ContextParam("ResourceARN"))}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules, T.StaticContextParams({"OperationType":{"value":"control"}}))) {}
export class ListTagsForStreamInput extends S.Class<ListTagsForStreamInput>("ListTagsForStreamInput")({StreamName: S.optional(S.String), ExclusiveStartTagKey: S.optional(S.String), Limit: S.optional(S.Number), StreamARN: S.optional(S.String).pipe(T.ContextParam("StreamARN"))}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules, T.StaticContextParams({"OperationType":{"value":"control"}}))) {}
export class MergeShardsInput extends S.Class<MergeShardsInput>("MergeShardsInput")({StreamName: S.optional(S.String), ShardToMerge: S.String, AdjacentShardToMerge: S.String, StreamARN: S.optional(S.String).pipe(T.ContextParam("StreamARN"))}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules, T.StaticContextParams({"OperationType":{"value":"control"}}))) {}
export class MergeShardsResponse extends S.Class<MergeShardsResponse>("MergeShardsResponse")({}, ns) {}
export class PutRecordInput extends S.Class<PutRecordInput>("PutRecordInput")({StreamName: S.optional(S.String), Data: T.Blob, PartitionKey: S.String, ExplicitHashKey: S.optional(S.String), SequenceNumberForOrdering: S.optional(S.String), StreamARN: S.optional(S.String).pipe(T.ContextParam("StreamARN"))}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules, T.StaticContextParams({"OperationType":{"value":"data"}}))) {}
export class PutResourcePolicyInput extends S.Class<PutResourcePolicyInput>("PutResourcePolicyInput")({ResourceARN: S.String.pipe(T.ContextParam("ResourceARN")), Policy: S.String}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules, T.StaticContextParams({"OperationType":{"value":"control"}}))) {}
export class PutResourcePolicyResponse extends S.Class<PutResourcePolicyResponse>("PutResourcePolicyResponse")({}, ns) {}
export const TagMap = S.Record({key: S.String, value: S.String});
export class RegisterStreamConsumerInput extends S.Class<RegisterStreamConsumerInput>("RegisterStreamConsumerInput")({StreamARN: S.String.pipe(T.ContextParam("StreamARN")), ConsumerName: S.String, Tags: S.optional(TagMap)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules, T.StaticContextParams({"OperationType":{"value":"control"}}))) {}
export class RemoveTagsFromStreamInput extends S.Class<RemoveTagsFromStreamInput>("RemoveTagsFromStreamInput")({StreamName: S.optional(S.String), TagKeys: TagKeyList, StreamARN: S.optional(S.String).pipe(T.ContextParam("StreamARN"))}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules, T.StaticContextParams({"OperationType":{"value":"control"}}))) {}
export class RemoveTagsFromStreamResponse extends S.Class<RemoveTagsFromStreamResponse>("RemoveTagsFromStreamResponse")({}, ns) {}
export class SplitShardInput extends S.Class<SplitShardInput>("SplitShardInput")({StreamName: S.optional(S.String), ShardToSplit: S.String, NewStartingHashKey: S.String, StreamARN: S.optional(S.String).pipe(T.ContextParam("StreamARN"))}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules, T.StaticContextParams({"OperationType":{"value":"control"}}))) {}
export class SplitShardResponse extends S.Class<SplitShardResponse>("SplitShardResponse")({}, ns) {}
export class StartStreamEncryptionInput extends S.Class<StartStreamEncryptionInput>("StartStreamEncryptionInput")({StreamName: S.optional(S.String), EncryptionType: S.String, KeyId: S.String, StreamARN: S.optional(S.String).pipe(T.ContextParam("StreamARN"))}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules, T.StaticContextParams({"OperationType":{"value":"control"}}))) {}
export class StartStreamEncryptionResponse extends S.Class<StartStreamEncryptionResponse>("StartStreamEncryptionResponse")({}, ns) {}
export class StopStreamEncryptionInput extends S.Class<StopStreamEncryptionInput>("StopStreamEncryptionInput")({StreamName: S.optional(S.String), EncryptionType: S.String, KeyId: S.String, StreamARN: S.optional(S.String).pipe(T.ContextParam("StreamARN"))}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules, T.StaticContextParams({"OperationType":{"value":"control"}}))) {}
export class StopStreamEncryptionResponse extends S.Class<StopStreamEncryptionResponse>("StopStreamEncryptionResponse")({}, ns) {}
export class TagResourceInput extends S.Class<TagResourceInput>("TagResourceInput")({Tags: TagMap, ResourceARN: S.String.pipe(T.ContextParam("ResourceARN"))}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules, T.StaticContextParams({"OperationType":{"value":"control"}}))) {}
export class TagResourceResponse extends S.Class<TagResourceResponse>("TagResourceResponse")({}, ns) {}
export class UntagResourceInput extends S.Class<UntagResourceInput>("UntagResourceInput")({TagKeys: TagKeyList, ResourceARN: S.String.pipe(T.ContextParam("ResourceARN"))}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules, T.StaticContextParams({"OperationType":{"value":"control"}}))) {}
export class UntagResourceResponse extends S.Class<UntagResourceResponse>("UntagResourceResponse")({}, ns) {}
export class UpdateMaxRecordSizeInput extends S.Class<UpdateMaxRecordSizeInput>("UpdateMaxRecordSizeInput")({StreamARN: S.optional(S.String).pipe(T.ContextParam("StreamARN")), MaxRecordSizeInKiB: S.Number}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules, T.StaticContextParams({"OperationType":{"value":"control"}}))) {}
export class UpdateMaxRecordSizeResponse extends S.Class<UpdateMaxRecordSizeResponse>("UpdateMaxRecordSizeResponse")({}, ns) {}
export class UpdateShardCountInput extends S.Class<UpdateShardCountInput>("UpdateShardCountInput")({StreamName: S.optional(S.String), TargetShardCount: S.Number, ScalingType: S.String, StreamARN: S.optional(S.String).pipe(T.ContextParam("StreamARN"))}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules, T.StaticContextParams({"OperationType":{"value":"control"}}))) {}
export class StreamModeDetails extends S.Class<StreamModeDetails>("StreamModeDetails")({StreamMode: S.String}) {}
export class UpdateStreamModeInput extends S.Class<UpdateStreamModeInput>("UpdateStreamModeInput")({StreamARN: S.String.pipe(T.ContextParam("StreamARN")), StreamModeDetails: StreamModeDetails, WarmThroughputMiBps: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules, T.StaticContextParams({"OperationType":{"value":"control"}}))) {}
export class UpdateStreamModeResponse extends S.Class<UpdateStreamModeResponse>("UpdateStreamModeResponse")({}, ns) {}
export class UpdateStreamWarmThroughputInput extends S.Class<UpdateStreamWarmThroughputInput>("UpdateStreamWarmThroughputInput")({StreamARN: S.optional(S.String).pipe(T.ContextParam("StreamARN")), StreamName: S.optional(S.String), WarmThroughputMiBps: S.Number}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules, T.StaticContextParams({"OperationType":{"value":"control"}}))) {}
export class MinimumThroughputBillingCommitmentOutput extends S.Class<MinimumThroughputBillingCommitmentOutput>("MinimumThroughputBillingCommitmentOutput")({Status: S.String, StartedAt: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), EndedAt: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), EarliestAllowedEndAt: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
export class ShardFilter extends S.Class<ShardFilter>("ShardFilter")({Type: S.String, ShardId: S.optional(S.String), Timestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
export const StreamNameList = S.Array(S.String);
export class PutRecordsRequestEntry extends S.Class<PutRecordsRequestEntry>("PutRecordsRequestEntry")({Data: T.Blob, ExplicitHashKey: S.optional(S.String), PartitionKey: S.String}) {}
export const PutRecordsRequestEntryList = S.Array(PutRecordsRequestEntry);
export class StartingPosition extends S.Class<StartingPosition>("StartingPosition")({Type: S.String, SequenceNumber: S.optional(S.String), Timestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
...
export class AddTagsToStreamInput extends S.Class<AddTagsToStreamInput>("AddTagsToStreamInput")({StreamName: S.optional(S.String), Tags: TagMap, StreamARN: S.optional(S.String).pipe(T.ContextParam("StreamARN"))}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules, T.StaticContextParams({"OperationType":{"value":"control"}}))) {}
export class AddTagsToStreamResponse extends S.Class<AddTagsToStreamResponse>("AddTagsToStreamResponse")({}, ns) {}
export class CreateStreamInput extends S.Class<CreateStreamInput>("CreateStreamInput")({StreamName: S.String, ShardCount: S.optional(S.Number), StreamModeDetails: S.optional(StreamModeDetails), Tags: S.optional(TagMap), WarmThroughputMiBps: S.optional(S.Number), MaxRecordSizeInKiB: S.optional(S.Number)}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class CreateStreamResponse extends S.Class<CreateStreamResponse>("CreateStreamResponse")({}, ns) {}
export class DescribeAccountSettingsOutput extends S.Class<DescribeAccountSettingsOutput>("DescribeAccountSettingsOutput")({MinimumThroughputBillingCommitment: S.optional(MinimumThroughputBillingCommitmentOutput)}, ns) {}
export class EnhancedMonitoringOutput extends S.Class<EnhancedMonitoringOutput>("EnhancedMonitoringOutput")({StreamName: S.optional(S.String), CurrentShardLevelMetrics: S.optional(MetricsNameList), DesiredShardLevelMetrics: S.optional(MetricsNameList), StreamARN: S.optional(S.String)}, ns) {}
export class GetResourcePolicyOutput extends S.Class<GetResourcePolicyOutput>("GetResourcePolicyOutput")({Policy: S.String}, ns) {}
export class GetShardIteratorOutput extends S.Class<GetShardIteratorOutput>("GetShardIteratorOutput")({ShardIterator: S.optional(S.String)}, ns) {}
export class ListShardsInput extends S.Class<ListShardsInput>("ListShardsInput")({StreamName: S.optional(S.String), NextToken: S.optional(S.String), ExclusiveStartShardId: S.optional(S.String), MaxResults: S.optional(S.Number), StreamCreationTimestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), ShardFilter: S.optional(ShardFilter), StreamARN: S.optional(S.String).pipe(T.ContextParam("StreamARN"))}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules, T.StaticContextParams({"OperationType":{"value":"control"}}))) {}
export class Tag extends S.Class<Tag>("Tag")({Key: S.String, Value: S.optional(S.String)}) {}
export const TagList = S.Array(Tag);
export class ListTagsForStreamOutput extends S.Class<ListTagsForStreamOutput>("ListTagsForStreamOutput")({Tags: TagList, HasMoreTags: S.Boolean}, ns) {}
export class PutRecordOutput extends S.Class<PutRecordOutput>("PutRecordOutput")({ShardId: S.String, SequenceNumber: S.String, EncryptionType: S.optional(S.String)}, ns) {}
export class PutRecordsInput extends S.Class<PutRecordsInput>("PutRecordsInput")({Records: PutRecordsRequestEntryList, StreamName: S.optional(S.String), StreamARN: S.optional(S.String).pipe(T.ContextParam("StreamARN"))}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules, T.StaticContextParams({"OperationType":{"value":"data"}}))) {}
export class Consumer extends S.Class<Consumer>("Consumer")({ConsumerName: S.String, ConsumerARN: S.String, ConsumerStatus: S.String, ConsumerCreationTimestamp: S.Date.pipe(T.TimestampFormat("epoch-seconds"))}) {}
export class RegisterStreamConsumerOutput extends S.Class<RegisterStreamConsumerOutput>("RegisterStreamConsumerOutput")({Consumer: Consumer}, ns) {}
export class SubscribeToShardInput extends S.Class<SubscribeToShardInput>("SubscribeToShardInput")({ConsumerARN: S.String.pipe(T.ContextParam("ConsumerARN")), ShardId: S.String, StartingPosition: StartingPosition}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules, T.StaticContextParams({"OperationType":{"value":"data"}}))) {}
export class UpdateAccountSettingsInput extends S.Class<UpdateAccountSettingsInput>("UpdateAccountSettingsInput")({MinimumThroughputBillingCommitment: MinimumThroughputBillingCommitmentInput}, T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class UpdateShardCountOutput extends S.Class<UpdateShardCountOutput>("UpdateShardCountOutput")({StreamName: S.optional(S.String), CurrentShardCount: S.optional(S.Number), TargetShardCount: S.optional(S.Number), StreamARN: S.optional(S.String)}, ns) {}
export const ShardIdList = S.Array(S.String);
export class ConsumerDescription extends S.Class<ConsumerDescription>("ConsumerDescription")({ConsumerName: S.String, ConsumerARN: S.String, ConsumerStatus: S.String, ConsumerCreationTimestamp: S.Date.pipe(T.TimestampFormat("epoch-seconds")), StreamARN: S.String}) {}
...
export class StreamDescriptionSummary extends S.Class<StreamDescriptionSummary>("StreamDescriptionSummary")({StreamName: S.String, StreamARN: S.String, StreamStatus: S.String, StreamModeDetails: S.optional(StreamModeDetails), RetentionPeriodHours: S.Number, StreamCreationTimestamp: S.Date.pipe(T.TimestampFormat("epoch-seconds")), EnhancedMonitoring: EnhancedMonitoringList, EncryptionType: S.optional(S.String), KeyId: S.optional(S.String), OpenShardCount: S.Number, ConsumerCount: S.optional(S.Number), WarmThroughput: S.optional(WarmThroughputObject), MaxRecordSizeInKiB: S.optional(S.Number)}) {}
export class Record extends S.Class<Record>("Record")({SequenceNumber: S.String, ApproximateArrivalTimestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), Data: T.Blob, PartitionKey: S.String, EncryptionType: S.optional(S.String)}) {}
export const RecordList = S.Array(Record);
export const ConsumerList = S.Array(Consumer);
export class StreamSummary extends S.Class<StreamSummary>("StreamSummary")({StreamName: S.String, StreamARN: S.String, StreamStatus: S.String, StreamModeDetails: S.optional(StreamModeDetails), StreamCreationTimestamp: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
export const StreamSummaryList = S.Array(StreamSummary);
export class DescribeStreamConsumerOutput extends S.Class<DescribeStreamConsumerOutput>("DescribeStreamConsumerOutput")({ConsumerDescription: ConsumerDescription}, ns) {}
export class DescribeStreamSummaryOutput extends S.Class<DescribeStreamSummaryOutput>("DescribeStreamSummaryOutput")({StreamDescriptionSummary: StreamDescriptionSummary}, ns) {}
...
export class ListShardsOutput extends S.Class<ListShardsOutput>("ListShardsOutput")({Shards: S.optional(ShardList), NextToken: S.optional(S.String)}, ns) {}
export class ListStreamConsumersOutput extends S.Class<ListStreamConsumersOutput>("ListStreamConsumersOutput")({Consumers: S.optional(ConsumerList), NextToken: S.optional(S.String)}, ns) {}
export class ListStreamsOutput extends S.Class<ListStreamsOutput>("ListStreamsOutput")({StreamNames: StreamNameList, HasMoreStreams: S.Boolean, NextToken: S.optional(S.String), StreamSummaries: S.optional(StreamSummaryList)}, ns) {}
export class ListTagsForResourceOutput extends S.Class<ListTagsForResourceOutput>("ListTagsForResourceOutput")({Tags: S.optional(TagList)}, ns) {}
export class UpdateAccountSettingsOutput extends S.Class<UpdateAccountSettingsOutput>("UpdateAccountSettingsOutput")({MinimumThroughputBillingCommitment: S.optional(MinimumThroughputBillingCommitmentOutput)}, ns) {}
export class UpdateStreamWarmThroughputOutput extends S.Class<UpdateStreamWarmThroughputOutput>("UpdateStreamWarmThroughputOutput")({StreamARN: S.optional(S.String), StreamName: S.optional(S.String), WarmThroughput: S.optional(WarmThroughputObject)}, ns) {}
...
export class GetRecordsOutput extends S.Class<GetRecordsOutput>("GetRecordsOutput")({Records: RecordList, NextShardIterator: S.optional(S.String), MillisBehindLatest: S.optional(S.Number), ChildShards: S.optional(ChildShardList)}, ns) {}
export class PutRecordsOutput extends S.Class<PutRecordsOutput>("PutRecordsOutput")({FailedRecordCount: S.optional(S.Number), Records: PutRecordsResultEntryList, EncryptionType: S.optional(S.String)}, ns) {}
...
export const SubscribeToShardEventStream = T.EventStream(S.Union(S.Struct({ SubscribeToShardEvent: SubscribeToShardEvent }), S.Struct({ ResourceNotFoundException: S.suspend(() => ResourceNotFoundException) }), S.Struct({ ResourceInUseException: S.suspend(() => ResourceInUseException) }), S.Struct({ KMSDisabledException: S.suspend(() => KMSDisabledException) }), S.Struct({ KMSInvalidStateException: S.suspend(() => KMSInvalidStateException) }), S.Struct({ KMSAccessDeniedException: S.suspend(() => KMSAccessDeniedException) }), S.Struct({ KMSNotFoundException: S.suspend(() => KMSNotFoundException) }), S.Struct({ KMSOptInRequired: S.suspend(() => KMSOptInRequired) }), S.Struct({ KMSThrottlingException: S.suspend(() => KMSThrottlingException) }), S.Struct({ InternalFailureException: S.suspend(() => InternalFailureException) })));
export class DescribeStreamOutput extends S.Class<DescribeStreamOutput>("DescribeStreamOutput")({StreamDescription: StreamDescription}, ns) {}
export class SubscribeToShardOutput extends S.Class<SubscribeToShardOutput>("SubscribeToShardOutput")({EventStream: SubscribeToShardEventStream}, ns) {}
...
export class ExpiredNextTokenException extends S.TaggedError<ExpiredNextTokenException>()("ExpiredNextTokenException", {message: S.optional(S.String)}) {}
...
export class KMSInvalidStateException extends S.TaggedError<KMSInvalidStateException>()("KMSInvalidStateException", {message: S.optional(S.String)}) {}
export class KMSNotFoundException extends S.TaggedError<KMSNotFoundException>()("KMSNotFoundException", {message: S.optional(S.String)}) {}
export class KMSOptInRequired extends S.TaggedError<KMSOptInRequired>()("KMSOptInRequired", {message: S.optional(S.String)}) {}
export class KMSThrottlingException extends S.TaggedError<KMSThrottlingException>()("KMSThrottlingException", {message: S.optional(S.String)}) {}
 ...
 */
export const describeLimits = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeLimitsInput, output: DescribeLimitsOutput, errors: [LimitExceededException] }));
/**
 ...
 */
export const describeAccountSettings = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeAccountSettingsInput, output: DescribeAccountSettingsOutput, errors: [LimitExceededException] }));
/**
 ...
 */
export const listTagsForStream = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListTagsForStreamInput, output: ListTagsForStreamOutput, errors: [AccessDeniedException, InvalidArgumentException, LimitExceededException, ResourceNotFoundException] }));
/**
 ...
 */
export const getResourcePolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetResourcePolicyInput, output: GetResourcePolicyOutput, errors: [AccessDeniedException, InvalidArgumentException, LimitExceededException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 */
export const registerStreamConsumer = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: RegisterStreamConsumerInput, output: RegisterStreamConsumerOutput, errors: [InvalidArgumentException, LimitExceededException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 * - Consumer pattern: `^(arn):aws.*:kinesis:.*:\d{12}:.*stream\/[a-zA-Z0-9_.-]+\/consumer\/[a-zA-Z0-9_.-]+:[0-9]+`
 */
export const deleteResourcePolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteResourcePolicyInput, output: DeleteResourcePolicyResponse, errors: [AccessDeniedException, InvalidArgumentException, LimitExceededException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 * account.
 */
export const deleteStream = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteStreamInput, output: DeleteStreamResponse, errors: [AccessDeniedException, InvalidArgumentException, LimitExceededException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 * `StreamARN` input parameter when you invoke this API.
 */
export const enableEnhancedMonitoring = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: EnableEnhancedMonitoringInput, output: EnhancedMonitoringOutput, errors: [AccessDeniedException, InvalidArgumentException, LimitExceededException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 */
export const increaseStreamRetentionPeriod = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: IncreaseStreamRetentionPeriodInput, output: IncreaseStreamRetentionPeriodResponse, errors: [AccessDeniedException, InvalidArgumentException, LimitExceededException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 */
export const putResourcePolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutResourcePolicyInput, output: PutResourcePolicyResponse, errors: [AccessDeniedException, InvalidArgumentException, LimitExceededException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 * account.
 */
export const removeTagsFromStream = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: RemoveTagsFromStreamInput, output: RemoveTagsFromStreamResponse, errors: [AccessDeniedException, InvalidArgumentException, LimitExceededException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 */
export const stopStreamEncryption = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: StopStreamEncryptionInput, output: StopStreamEncryptionResponse, errors: [AccessDeniedException, InvalidArgumentException, LimitExceededException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 */
export const tagResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: TagResourceInput, output: TagResourceResponse, errors: [AccessDeniedException, InvalidArgumentException, LimitExceededException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 */
export const untagResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UntagResourceInput, output: UntagResourceResponse, errors: [AccessDeniedException, InvalidArgumentException, LimitExceededException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 * account.
 */
export const addTagsToStream = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: AddTagsToStreamInput, output: AddTagsToStreamResponse, errors: [AccessDeniedException, InvalidArgumentException, LimitExceededException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 */
export const decreaseStreamRetentionPeriod = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DecreaseStreamRetentionPeriodInput, output: DecreaseStreamRetentionPeriodResponse, errors: [AccessDeniedException, InvalidArgumentException, LimitExceededException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 */
export const deregisterStreamConsumer = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeregisterStreamConsumerInput, output: DeregisterStreamConsumerResponse, errors: [InvalidArgumentException, LimitExceededException, ResourceNotFoundException] }));
/**
 ...
 */
export const describeStreamConsumer = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeStreamConsumerInput, output: DescribeStreamConsumerOutput, errors: [InvalidArgumentException, LimitExceededException, ResourceNotFoundException] }));
/**
 ...
 * account.
 */
export const describeStreamSummary = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeStreamSummaryInput, output: DescribeStreamSummaryOutput, errors: [AccessDeniedException, InvalidArgumentException, LimitExceededException, ResourceNotFoundException] }));
/**
 ...
 * `StreamARN` input parameter when you invoke this API.
 */
export const disableEnhancedMonitoring = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DisableEnhancedMonitoringInput, output: EnhancedMonitoringOutput, errors: [AccessDeniedException, InvalidArgumentException, LimitExceededException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 */
export const listTagsForResource = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListTagsForResourceInput, output: ListTagsForResourceOutput, errors: [AccessDeniedException, InvalidArgumentException, LimitExceededException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 */
export const getShardIterator = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetShardIteratorInput, output: GetShardIteratorOutput, errors: [AccessDeniedException, InternalFailureException, InvalidArgumentException, ProvisionedThroughputExceededException, ResourceNotFoundException] }));
/**
 ...
 * IAM.
 */
export const listShards = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListShardsInput, output: ListShardsOutput, errors: [AccessDeniedException, ExpiredNextTokenException, InvalidArgumentException, LimitExceededException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 * - This API has a call limit of 5 transactions per second (TPS) for each Amazon Web Services account. TPS over 5 will initiate the `LimitExceededException`.
 */
export const updateAccountSettings = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateAccountSettingsInput, output: UpdateAccountSettingsOutput, errors: [InvalidArgumentException, LimitExceededException, ValidationException] }));
/**
 ...
 */
export const listStreamConsumers = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListStreamConsumersInput, output: ListStreamConsumersOutput, errors: [ExpiredNextTokenException, InvalidArgumentException, LimitExceededException, ResourceInUseException, ResourceNotFoundException] }));
/**
 ...
 * account.
 */
export const listStreams = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListStreamsInput, output: ListStreamsOutput, errors: [ExpiredNextTokenException, InvalidArgumentException, LimitExceededException] }));
/**
 ...
 */
export const updateStreamWarmThroughput = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateStreamWarmThroughputInput, output: UpdateStreamWarmThroughputOutput, errors: [AccessDeniedException, InvalidArgumentException, LimitExceededException, ResourceInUseException, ResourceNotFoundException, ValidationException] }));
/**
 ...
 */
export const updateShardCount = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateShardCountInput, output: UpdateShardCountOutput, errors: [AccessDeniedException, InvalidArgumentException, LimitExceededException, ResourceInUseException, ResourceNotFoundException, ValidationException] }));
/**
 ...
 */
export const mergeShards = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: MergeShardsInput, output: MergeShardsResponse, errors: [AccessDeniedException, InvalidArgumentException, LimitExceededException, ResourceInUseException, ResourceNotFoundException, ValidationException] }));
/**
 ...
 */
export const splitShard = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: SplitShardInput, output: SplitShardResponse, errors: [AccessDeniedException, InvalidArgumentException, LimitExceededException, ResourceInUseException, ResourceNotFoundException, ValidationException] }));
/**
 ...
 */
export const updateMaxRecordSize = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateMaxRecordSizeInput, output: UpdateMaxRecordSizeResponse, errors: [AccessDeniedException, InvalidArgumentException, LimitExceededException, ResourceInUseException, ResourceNotFoundException, ValidationException] }));
/**
 ...
 */
export const updateStreamMode = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateStreamModeInput, output: UpdateStreamModeResponse, errors: [InvalidArgumentException, LimitExceededException, ResourceInUseException, ResourceNotFoundException, ValidationException] }));
/**
 ...
 */
export const createStream = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateStreamInput, output: CreateStreamResponse, errors: [InvalidArgumentException, LimitExceededException, ResourceInUseException, ValidationException] }));
/**
 ...
 * to a stream. You can use IncreaseStreamRetentionPeriod or DecreaseStreamRetentionPeriod to modify this retention period.
 */
export const putRecords = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutRecordsInput, output: PutRecordsOutput, errors: [AccessDeniedException, InternalFailureException, InvalidArgumentException, KMSAccessDeniedException, KMSDisabledException, KMSInvalidStateException, KMSNotFoundException, KMSOptInRequired, KMSThrottlingException, ProvisionedThroughputExceededException, ResourceNotFoundException] }));
/**
 ...
 */
export const describeStream = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeStreamInput, output: DescribeStreamOutput, errors: [AccessDeniedException, InvalidArgumentException, LimitExceededException, ResourceNotFoundException] }));
/**
 ...
 */
export const getRecords = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetRecordsInput, output: GetRecordsOutput, errors: [AccessDeniedException, ExpiredIteratorException, InternalFailureException, InvalidArgumentException, KMSAccessDeniedException, KMSDisabledException, KMSInvalidStateException, KMSNotFoundException, KMSOptInRequired, KMSThrottlingException, ProvisionedThroughputExceededException, ResourceNotFoundException] }));
/**
 ...
 * Using the Kinesis Data Streams API.
 */
export const subscribeToShard = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: SubscribeToShardInput, output: SubscribeToShardOutput, errors: [AccessDeniedException, InvalidArgumentException, LimitExceededException, ResourceInUseException, ResourceNotFoundException] }));
