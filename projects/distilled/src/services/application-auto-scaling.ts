...
const svc = T.AwsApiService({ sdkId: "Application Auto Scaling", serviceShapeName: "AnyScaleFrontendService" });
...
export class DeleteScalingPolicyRequest extends S.Class<DeleteScalingPolicyRequest>("DeleteScalingPolicyRequest")({PolicyName: S.String, ServiceNamespace: S.String, ResourceId: S.String, ScalableDimension: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteScalingPolicyResponse extends S.Class<DeleteScalingPolicyResponse>("DeleteScalingPolicyResponse")({}) {}
export class DeleteScheduledActionRequest extends S.Class<DeleteScheduledActionRequest>("DeleteScheduledActionRequest")({ServiceNamespace: S.String, ScheduledActionName: S.String, ResourceId: S.String, ScalableDimension: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteScheduledActionResponse extends S.Class<DeleteScheduledActionResponse>("DeleteScheduledActionResponse")({}) {}
export class DeregisterScalableTargetRequest extends S.Class<DeregisterScalableTargetRequest>("DeregisterScalableTargetRequest")({ServiceNamespace: S.String, ResourceId: S.String, ScalableDimension: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class DescribeScalableTargetsRequest extends S.Class<DescribeScalableTargetsRequest>("DescribeScalableTargetsRequest")({ServiceNamespace: S.String, ResourceIds: S.optional(ResourceIdsMaxLen1600), ScalableDimension: S.optional(S.String), MaxResults: S.optional(S.Number), NextToken: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeScalingActivitiesRequest extends S.Class<DescribeScalingActivitiesRequest>("DescribeScalingActivitiesRequest")({ServiceNamespace: S.String, ResourceId: S.optional(S.String), ScalableDimension: S.optional(S.String), MaxResults: S.optional(S.Number), NextToken: S.optional(S.String), IncludeNotScaledActivities: S.optional(S.Boolean)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class TagResourceRequest extends S.Class<TagResourceRequest>("TagResourceRequest")({ResourceARN: S.String, Tags: TagMap}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
...
export class GetPredictiveScalingForecastResponse extends S.Class<GetPredictiveScalingForecastResponse>("GetPredictiveScalingForecastResponse")({LoadForecast: S.optional(LoadForecasts), CapacityForecast: S.optional(CapacityForecast), UpdateTime: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
...
//# Errors
export class ConcurrentUpdateException extends S.TaggedError<ConcurrentUpdateException>()("ConcurrentUpdateException", {Message: S.optional(S.String)}, T.AwsQueryError({ code: "ConcurrentUpdateException", httpResponseCode: 500 })).pipe(withCategory(ERROR_CATEGORIES.SERVER_ERROR)) {}
export class ResourceNotFoundException extends S.TaggedError<ResourceNotFoundException>()("ResourceNotFoundException", {Message: S.optional(S.String), ResourceName: S.optional(S.String)}) {}
export class InternalServiceException extends S.TaggedError<InternalServiceException>()("InternalServiceException", {Message: S.optional(S.String)}, T.AwsQueryError({ code: "InternalServiceException", httpResponseCode: 500 })).pipe(withCategory(ERROR_CATEGORIES.SERVER_ERROR)) {}
...
export class ObjectNotFoundException extends S.TaggedError<ObjectNotFoundException>()("ObjectNotFoundException", {Message: S.optional(S.String)}, T.AwsQueryError({ code: "ObjectNotFoundException", httpResponseCode: 400 })) {}
export class InvalidNextTokenException extends S.TaggedError<InvalidNextTokenException>()("InvalidNextTokenException", {Message: S.optional(S.String)}, T.AwsQueryError({ code: "InvalidNextTokenException", httpResponseCode: 400 })) {}
...
export class FailedResourceAccessException extends S.TaggedError<FailedResourceAccessException>()("FailedResourceAccessException", {Message: S.optional(S.String)}, T.AwsQueryError({ code: "FailedResourceAccessException", httpResponseCode: 400 })) {}
 ...
 */
export const getPredictiveScalingForecast = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetPredictiveScalingForecastRequest, output: GetPredictiveScalingForecastResponse, errors: [InternalServiceException, ValidationException] }));
/**
 ...
 */
export const deleteScalingPolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteScalingPolicyRequest, output: DeleteScalingPolicyResponse, errors: [ConcurrentUpdateException, InternalServiceException, ObjectNotFoundException, ValidationException] }));
/**
 ...
 * `ScalableDimension`.
 */
export const describeScalableTargets = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeScalableTargetsRequest, output: DescribeScalableTargetsResponse, errors: [ConcurrentUpdateException, InternalServiceException, InvalidNextTokenException, ValidationException] }));
/**
 ...
 */
export const describeScalingActivities = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeScalingActivitiesRequest, output: DescribeScalingActivitiesResponse, errors: [ConcurrentUpdateException, InternalServiceException, InvalidNextTokenException, ValidationException] }));
/**
 ...
 * parameters.
 */
export const registerScalableTarget = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: RegisterScalableTargetRequest, output: RegisterScalableTargetResponse, errors: [ConcurrentUpdateException, InternalServiceException, LimitExceededException, ValidationException] }));
/**
 * Deletes the specified scheduled action for an Application Auto Scaling scalable target.
 * 
 * For more information, see Delete a scheduled action in the *Application Auto Scaling User Guide*.
 */
export const deleteScheduledAction = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteScheduledActionRequest, output: DeleteScheduledActionResponse, errors: [ConcurrentUpdateException, InternalServiceException, ObjectNotFoundException, ValidationException] }));
/**
 ...
 */
export const deregisterScalableTarget = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeregisterScalableTargetRequest, output: DeregisterScalableTargetResponse, errors: [ConcurrentUpdateException, InternalServiceException, ObjectNotFoundException, ValidationException] }));
/**
 ...
 */
export const describeScheduledActions = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeScheduledActionsRequest, output: DescribeScheduledActionsResponse, errors: [ConcurrentUpdateException, InternalServiceException, InvalidNextTokenException, ValidationException] }));
/**
 ...
 * are deleted.
 */
export const putScheduledAction = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutScheduledActionRequest, output: PutScheduledActionResponse, errors: [ConcurrentUpdateException, InternalServiceException, LimitExceededException, ObjectNotFoundException, ValidationException] }));
/**
 ...
 */
export const describeScalingPolicies = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeScalingPoliciesRequest, output: DescribeScalingPoliciesResponse, errors: [ConcurrentUpdateException, FailedResourceAccessException, InternalServiceException, InvalidNextTokenException, ValidationException] }));
/**
 ...
 * are deleted.
 */
export const putScalingPolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutScalingPolicyRequest, output: PutScalingPolicyResponse, errors: [ConcurrentUpdateException, FailedResourceAccessException, InternalServiceException, LimitExceededException, ObjectNotFoundException, ValidationException] }));
