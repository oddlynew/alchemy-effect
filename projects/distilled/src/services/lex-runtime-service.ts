...
const svc = T.AwsApiService({ sdkId: "Lex Runtime Service", serviceShapeName: "AWSDeepSenseRunTimeService" });
...
//# Schemas
export class DeleteSessionRequest extends S.Class<DeleteSessionRequest>("DeleteSessionRequest")({botName: S.String.pipe(T.HttpLabel("botName")), botAlias: S.String.pipe(T.HttpLabel("botAlias")), userId: S.String.pipe(T.HttpLabel("userId"))}, T.all(T.Http({ method: "DELETE", uri: "/bot/{botName}/alias/{botAlias}/user/{userId}/session" }), svc, auth, proto, ver, rules)) {}
export class GetSessionRequest extends S.Class<GetSessionRequest>("GetSessionRequest")({botName: S.String.pipe(T.HttpLabel("botName")), botAlias: S.String.pipe(T.HttpLabel("botAlias")), userId: S.String.pipe(T.HttpLabel("userId")), checkpointLabelFilter: S.optional(S.String).pipe(T.HttpQuery("checkpointLabelFilter"))}, T.all(T.Http({ method: "GET", uri: "/bot/{botName}/alias/{botAlias}/user/{userId}/session" }), svc, auth, proto, ver, rules)) {}
export class PostContentRequest extends S.Class<PostContentRequest>("PostContentRequest")({botName: S.String.pipe(T.HttpLabel("botName")), botAlias: S.String.pipe(T.HttpLabel("botAlias")), userId: S.String.pipe(T.HttpLabel("userId")), sessionAttributes: S.optional(S.String).pipe(T.HttpHeader("x-amz-lex-session-attributes")), requestAttributes: S.optional(S.String).pipe(T.HttpHeader("x-amz-lex-request-attributes")), contentType: S.String.pipe(T.HttpHeader("Content-Type")), accept: S.optional(S.String).pipe(T.HttpHeader("Accept")), inputStream: T.StreamingInput.pipe(T.HttpPayload()), activeContexts: S.optional(S.String).pipe(T.HttpHeader("x-amz-lex-active-contexts"))}, T.all(T.Http({ method: "POST", uri: "/bot/{botName}/alias/{botAlias}/user/{userId}/content" }), svc, auth, proto, ver, rules)) {}
...
export class PostContentResponse extends S.Class<PostContentResponse>("PostContentResponse")({contentType: S.optional(S.String).pipe(T.HttpHeader("Content-Type")), intentName: S.optional(S.String).pipe(T.HttpHeader("x-amz-lex-intent-name")), nluIntentConfidence: S.optional(S.String).pipe(T.HttpHeader("x-amz-lex-nlu-intent-confidence")), alternativeIntents: S.optional(S.String).pipe(T.HttpHeader("x-amz-lex-alternative-intents")), slots: S.optional(S.String).pipe(T.HttpHeader("x-amz-lex-slots")), sessionAttributes: S.optional(S.String).pipe(T.HttpHeader("x-amz-lex-session-attributes")), sentimentResponse: S.optional(S.String).pipe(T.HttpHeader("x-amz-lex-sentiment")), message: S.optional(S.String).pipe(T.HttpHeader("x-amz-lex-message")), encodedMessage: S.optional(S.String).pipe(T.HttpHeader("x-amz-lex-encoded-message")), messageFormat: S.optional(S.String).pipe(T.HttpHeader("x-amz-lex-message-format")), dialogState: S.optional(S.String).pipe(T.HttpHeader("x-amz-lex-dialog-state")), slotToElicit: S.optional(S.String).pipe(T.HttpHeader("x-amz-lex-slot-to-elicit")), inputTranscript: S.optional(S.String).pipe(T.HttpHeader("x-amz-lex-input-transcript")), encodedInputTranscript: S.optional(S.String).pipe(T.HttpHeader("x-amz-lex-encoded-input-transcript")), audioStream: S.optional(T.StreamingOutput).pipe(T.HttpPayload()), botVersion: S.optional(S.String).pipe(T.HttpHeader("x-amz-lex-bot-version")), sessionId: S.optional(S.String).pipe(T.HttpHeader("x-amz-lex-session-id")), activeContexts: S.optional(S.String).pipe(T.HttpHeader("x-amz-lex-active-contexts"))}) {}
export class PutSessionRequest extends S.Class<PutSessionRequest>("PutSessionRequest")({botName: S.String.pipe(T.HttpLabel("botName")), botAlias: S.String.pipe(T.HttpLabel("botAlias")), userId: S.String.pipe(T.HttpLabel("userId")), sessionAttributes: S.optional(StringMap), dialogAction: S.optional(DialogAction), recentIntentSummaryView: S.optional(IntentSummaryList), accept: S.optional(S.String).pipe(T.HttpHeader("Accept")), activeContexts: S.optional(ActiveContextsList)}, T.all(T.Http({ method: "POST", uri: "/bot/{botName}/alias/{botAlias}/user/{userId}/session" }), svc, auth, proto, ver, rules)) {}
export class PostTextRequest extends S.Class<PostTextRequest>("PostTextRequest")({botName: S.String.pipe(T.HttpLabel("botName")), botAlias: S.String.pipe(T.HttpLabel("botAlias")), userId: S.String.pipe(T.HttpLabel("userId")), sessionAttributes: S.optional(StringMap), requestAttributes: S.optional(StringMap), inputText: S.String, activeContexts: S.optional(ActiveContextsList)}, T.all(T.Http({ method: "POST", uri: "/bot/{botName}/alias/{botAlias}/user/{userId}/text" }), svc, auth, proto, ver, rules)) {}
export class PutSessionResponse extends S.Class<PutSessionResponse>("PutSessionResponse")({contentType: S.optional(S.String).pipe(T.HttpHeader("Content-Type")), intentName: S.optional(S.String).pipe(T.HttpHeader("x-amz-lex-intent-name")), slots: S.optional(S.String).pipe(T.HttpHeader("x-amz-lex-slots")), sessionAttributes: S.optional(S.String).pipe(T.HttpHeader("x-amz-lex-session-attributes")), message: S.optional(S.String).pipe(T.HttpHeader("x-amz-lex-message")), encodedMessage: S.optional(S.String).pipe(T.HttpHeader("x-amz-lex-encoded-message")), messageFormat: S.optional(S.String).pipe(T.HttpHeader("x-amz-lex-message-format")), dialogState: S.optional(S.String).pipe(T.HttpHeader("x-amz-lex-dialog-state")), slotToElicit: S.optional(S.String).pipe(T.HttpHeader("x-amz-lex-slot-to-elicit")), audioStream: S.optional(T.StreamingOutput).pipe(T.HttpPayload()), sessionId: S.optional(S.String).pipe(T.HttpHeader("x-amz-lex-session-id")), activeContexts: S.optional(S.String).pipe(T.HttpHeader("x-amz-lex-active-contexts"))}) {}
...
export class BadGatewayException extends S.TaggedError<BadGatewayException>()("BadGatewayException", {Message: S.optional(S.String)}).pipe(withCategory(ERROR_CATEGORIES.SERVER_ERROR)) {}
...
export class DependencyFailedException extends S.TaggedError<DependencyFailedException>()("DependencyFailedException", {Message: S.optional(S.String)}) {}
export class NotFoundException extends S.TaggedError<NotFoundException>()("NotFoundException", {message: S.optional(S.String)}) {}
export class LoopDetectedException extends S.TaggedError<LoopDetectedException>()("LoopDetectedException", {Message: S.optional(S.String)}).pipe(withCategory(ERROR_CATEGORIES.SERVER_ERROR)) {}
 ...
 * ID.
 */
export const getSession = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetSessionRequest, output: GetSessionResponse, errors: [BadRequestException, InternalFailureException, LimitExceededException, NotFoundException] }));
/**
 * Removes session information for a specified bot, alias, and user ID.
 */
export const deleteSession = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteSessionRequest, output: DeleteSessionResponse, errors: [BadRequestException, ConflictException, InternalFailureException, LimitExceededException, NotFoundException] }));
/**
 ...
 * Sessions.
 */
export const putSession = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutSessionRequest, output: PutSessionResponse, errors: [BadGatewayException, BadRequestException, ConflictException, DependencyFailedException, InternalFailureException, LimitExceededException, NotAcceptableException, NotFoundException] }));
/**
 ...
 */
export const postText = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PostTextRequest, output: PostTextResponse, errors: [BadGatewayException, BadRequestException, ConflictException, DependencyFailedException, InternalFailureException, LimitExceededException, LoopDetectedException, NotFoundException] }));
/**
 ...
 * Conversation Context.
 */
export const postContent = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PostContentRequest, output: PostContentResponse, errors: [BadGatewayException, BadRequestException, ConflictException, DependencyFailedException, InternalFailureException, LimitExceededException, LoopDetectedException, NotAcceptableException, NotFoundException, RequestTimeoutException, UnsupportedMediaTypeException] }));
