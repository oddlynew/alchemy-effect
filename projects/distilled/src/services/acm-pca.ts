...
export class CreateCertificateAuthorityAuditReportRequest extends S.Class<CreateCertificateAuthorityAuditReportRequest>("CreateCertificateAuthorityAuditReportRequest")({CertificateAuthorityArn: S.String, S3BucketName: S.String, AuditReportResponseFormat: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class CreatePermissionRequest extends S.Class<CreatePermissionRequest>("CreatePermissionRequest")({CertificateAuthorityArn: S.String, Principal: S.String, SourceAccount: S.optional(S.String), Actions: ActionList}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class CreatePermissionResponse extends S.Class<CreatePermissionResponse>("CreatePermissionResponse")({}) {}
export class DeleteCertificateAuthorityRequest extends S.Class<DeleteCertificateAuthorityRequest>("DeleteCertificateAuthorityRequest")({CertificateAuthorityArn: S.String, PermanentDeletionTimeInDays: S.optional(S.Number)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeleteCertificateAuthorityResponse extends S.Class<DeleteCertificateAuthorityResponse>("DeleteCertificateAuthorityResponse")({}) {}
export class DeletePermissionRequest extends S.Class<DeletePermissionRequest>("DeletePermissionRequest")({CertificateAuthorityArn: S.String, Principal: S.String, SourceAccount: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeletePermissionResponse extends S.Class<DeletePermissionResponse>("DeletePermissionResponse")({}) {}
export class DeletePolicyRequest extends S.Class<DeletePolicyRequest>("DeletePolicyRequest")({ResourceArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DeletePolicyResponse extends S.Class<DeletePolicyResponse>("DeletePolicyResponse")({}) {}
export class DescribeCertificateAuthorityRequest extends S.Class<DescribeCertificateAuthorityRequest>("DescribeCertificateAuthorityRequest")({CertificateAuthorityArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class DescribeCertificateAuthorityAuditReportRequest extends S.Class<DescribeCertificateAuthorityAuditReportRequest>("DescribeCertificateAuthorityAuditReportRequest")({CertificateAuthorityArn: S.String, AuditReportId: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetCertificateRequest extends S.Class<GetCertificateRequest>("GetCertificateRequest")({CertificateAuthorityArn: S.String, CertificateArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetCertificateAuthorityCertificateRequest extends S.Class<GetCertificateAuthorityCertificateRequest>("GetCertificateAuthorityCertificateRequest")({CertificateAuthorityArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetCertificateAuthorityCsrRequest extends S.Class<GetCertificateAuthorityCsrRequest>("GetCertificateAuthorityCsrRequest")({CertificateAuthorityArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class GetPolicyRequest extends S.Class<GetPolicyRequest>("GetPolicyRequest")({ResourceArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ImportCertificateAuthorityCertificateRequest extends S.Class<ImportCertificateAuthorityCertificateRequest>("ImportCertificateAuthorityCertificateRequest")({CertificateAuthorityArn: S.String, Certificate: T.Blob, CertificateChain: S.optional(T.Blob)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ImportCertificateAuthorityCertificateResponse extends S.Class<ImportCertificateAuthorityCertificateResponse>("ImportCertificateAuthorityCertificateResponse")({}) {}
export class ListCertificateAuthoritiesRequest extends S.Class<ListCertificateAuthoritiesRequest>("ListCertificateAuthoritiesRequest")({MaxResults: S.optional(S.Number), NextToken: S.optional(S.String), ResourceOwner: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListPermissionsRequest extends S.Class<ListPermissionsRequest>("ListPermissionsRequest")({MaxResults: S.optional(S.Number), NextToken: S.optional(S.String), CertificateAuthorityArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class ListTagsRequest extends S.Class<ListTagsRequest>("ListTagsRequest")({MaxResults: S.optional(S.Number), NextToken: S.optional(S.String), CertificateAuthorityArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutPolicyRequest extends S.Class<PutPolicyRequest>("PutPolicyRequest")({ResourceArn: S.String, Policy: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class PutPolicyResponse extends S.Class<PutPolicyResponse>("PutPolicyResponse")({}) {}
export class RestoreCertificateAuthorityRequest extends S.Class<RestoreCertificateAuthorityRequest>("RestoreCertificateAuthorityRequest")({CertificateAuthorityArn: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class RestoreCertificateAuthorityResponse extends S.Class<RestoreCertificateAuthorityResponse>("RestoreCertificateAuthorityResponse")({}) {}
export class RevokeCertificateRequest extends S.Class<RevokeCertificateRequest>("RevokeCertificateRequest")({CertificateAuthorityArn: S.String, CertificateSerial: S.String, RevocationReason: S.String}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class RevokeCertificateResponse extends S.Class<RevokeCertificateResponse>("RevokeCertificateResponse")({}) {}
export class Tag extends S.Class<Tag>("Tag")({Key: S.String, Value: S.optional(S.String)}) {}
export const TagList = S.Array(Tag);
export class TagCertificateAuthorityRequest extends S.Class<TagCertificateAuthorityRequest>("TagCertificateAuthorityRequest")({CertificateAuthorityArn: S.String, Tags: TagList}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class TagCertificateAuthorityResponse extends S.Class<TagCertificateAuthorityResponse>("TagCertificateAuthorityResponse")({}) {}
export class UntagCertificateAuthorityRequest extends S.Class<UntagCertificateAuthorityRequest>("UntagCertificateAuthorityRequest")({CertificateAuthorityArn: S.String, Tags: TagList}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class UntagCertificateAuthorityResponse extends S.Class<UntagCertificateAuthorityResponse>("UntagCertificateAuthorityResponse")({}) {}
...
export class UpdateCertificateAuthorityRequest extends S.Class<UpdateCertificateAuthorityRequest>("UpdateCertificateAuthorityRequest")({CertificateAuthorityArn: S.String, RevocationConfiguration: S.optional(RevocationConfiguration), Status: S.optional(S.String)}, T.all(T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules)) {}
export class UpdateCertificateAuthorityResponse extends S.Class<UpdateCertificateAuthorityResponse>("UpdateCertificateAuthorityResponse")({}) {}
...
export class DescribeCertificateAuthorityAuditReportResponse extends S.Class<DescribeCertificateAuthorityAuditReportResponse>("DescribeCertificateAuthorityAuditReportResponse")({AuditReportStatus: S.optional(S.String), S3BucketName: S.optional(S.String), S3Key: S.optional(S.String), CreatedAt: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds")))}) {}
...
export class Permission extends S.Class<Permission>("Permission")({CertificateAuthorityArn: S.optional(S.String), CreatedAt: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))), Principal: S.optional(S.String), SourceAccount: S.optional(S.String), Actions: S.optional(ActionList), Policy: S.optional(S.String)}) {}
...
//# Errors
export class InvalidArnException extends S.TaggedError<InvalidArnException>()("InvalidArnException", {message: S.optional(S.String)}) {}
...
export class RequestInProgressException extends S.TaggedError<RequestInProgressException>()("RequestInProgressException", {message: S.optional(S.String)}) {}
 ...
 */
export const listCertificateAuthorities = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListCertificateAuthoritiesRequest, output: ListCertificateAuthoritiesResponse, errors: [InvalidNextTokenException] }));
/**
 ...
 */
export const describeCertificateAuthority = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeCertificateAuthorityRequest, output: DescribeCertificateAuthorityResponse, errors: [InvalidArnException, ResourceNotFoundException] }));
/**
 ...
 */
export const listPermissions = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListPermissionsRequest, output: ListPermissionsResponse, errors: [InvalidArnException, InvalidNextTokenException, InvalidStateException, RequestFailedException, ResourceNotFoundException] }));
/**
 ...
 */
export const deletePolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeletePolicyRequest, output: DeletePolicyResponse, errors: [ConcurrentModificationException, InvalidArnException, InvalidStateException, LockoutPreventedException, RequestFailedException, ResourceNotFoundException] }));
/**
 * Lists information about a specific audit report created by calling the CreateCertificateAuthorityAuditReport action. Audit information is created every time the certificate authority (CA) private key is used. The private key is used when you call the IssueCertificate action or the RevokeCertificate action.
 */
export const describeCertificateAuthorityAuditReport = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DescribeCertificateAuthorityAuditReportRequest, output: DescribeCertificateAuthorityAuditReportResponse, errors: [InvalidArgsException, InvalidArnException, ResourceNotFoundException] }));
/**
 ...
 */
export const deleteCertificateAuthority = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeleteCertificateAuthorityRequest, output: DeleteCertificateAuthorityResponse, errors: [ConcurrentModificationException, InvalidArnException, InvalidStateException, ResourceNotFoundException] }));
/**
 * Retrieves the certificate and certificate chain for your private certificate authority (CA) or one that has been shared with you. Both the certificate and the chain are base64 PEM-encoded. The chain does not include the CA certificate. Each certificate in the chain signs the one before it.
 */
export const getCertificateAuthorityCertificate = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetCertificateAuthorityCertificateRequest, output: GetCertificateAuthorityCertificateResponse, errors: [InvalidArnException, InvalidStateException, ResourceNotFoundException] }));
/**
 ...
 */
export const restoreCertificateAuthority = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: RestoreCertificateAuthorityRequest, output: RestoreCertificateAuthorityResponse, errors: [InvalidArnException, InvalidStateException, ResourceNotFoundException] }));
/**
 ...
 */
export const updateCertificateAuthority = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UpdateCertificateAuthorityRequest, output: UpdateCertificateAuthorityResponse, errors: [ConcurrentModificationException, InvalidArgsException, InvalidArnException, InvalidPolicyException, InvalidStateException, ResourceNotFoundException] }));
/**
 ...
 * - Updates made in Amazon Web Services Resource Manager (RAM) are reflected in policies. For more information, see Attach a Policy for Cross-Account Access.
 */
export const getPolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetPolicyRequest, output: GetPolicyResponse, errors: [InvalidArnException, InvalidStateException, RequestFailedException, ResourceNotFoundException] }));
/**
 * Lists the tags, if any, that are associated with your private CA or one that has been shared with you. Tags are labels that you can use to identify and organize your CAs. Each tag consists of a key and an optional value. Call the TagCertificateAuthority action to add one or more tags to your CA. Call the UntagCertificateAuthority action to remove tags.
 */
export const listTags = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ListTagsRequest, output: ListTagsResponse, errors: [InvalidArnException, InvalidStateException, RequestFailedException, ResourceNotFoundException] }));
/**
 ...
 * - If the private CA and the ACM certificates reside in different accounts, then permissions cannot be used to enable automatic renewals. Instead, the ACM certificate owner must set up a resource-based policy to enable cross-account issuance and renewals. For more information, see Using a Resource Based Policy with Amazon Web Services Private CA.
 */
export const deletePermission = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: DeletePermissionRequest, output: DeletePermissionResponse, errors: [InvalidArnException, InvalidStateException, RequestFailedException, ResourceNotFoundException] }));
/**
 * Remove one or more tags from your private CA. A tag consists of a key-value pair. If you do not specify the value portion of the tag when calling this action, the tag will be removed regardless of value. If you specify a value, the tag is removed only if it is associated with the specified value. To add tags to a private CA, use the TagCertificateAuthority. Call the ListTags action to see what tags are associated with your CA.
 */
export const untagCertificateAuthority = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: UntagCertificateAuthorityRequest, output: UntagCertificateAuthorityResponse, errors: [InvalidArnException, InvalidStateException, InvalidTagException, ResourceNotFoundException] }));
/**
 ...
 * - Updates made in Amazon Web Services Resource Manager (RAM) are reflected in policies. For more information, see Attach a Policy for Cross-Account Access.
 */
export const putPolicy = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: PutPolicyRequest, output: PutPolicyResponse, errors: [ConcurrentModificationException, InvalidArnException, InvalidPolicyException, InvalidStateException, LockoutPreventedException, RequestFailedException, ResourceNotFoundException] }));
/**
 ...
 * - If the private CA and the ACM certificates reside in different accounts, then permissions cannot be used to enable automatic renewals. Instead, the ACM certificate owner must set up a resource-based policy to enable cross-account issuance and renewals. For more information, see Using a Resource Based Policy with Amazon Web Services Private CA.
 */
export const createPermission = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreatePermissionRequest, output: CreatePermissionResponse, errors: [InvalidArnException, InvalidStateException, LimitExceededException, PermissionAlreadyExistsException, RequestFailedException, ResourceNotFoundException] }));
/**
 ...
 */
export const tagCertificateAuthority = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: TagCertificateAuthorityRequest, output: TagCertificateAuthorityResponse, errors: [InvalidArnException, InvalidStateException, InvalidTagException, ResourceNotFoundException, TooManyTagsException] }));
/**
 ...
 */
export const getCertificate = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetCertificateRequest, output: GetCertificateResponse, errors: [InvalidArnException, InvalidStateException, RequestFailedException, RequestInProgressException, ResourceNotFoundException] }));
/**
 ...
 */
export const getCertificateAuthorityCsr = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: GetCertificateAuthorityCsrRequest, output: GetCertificateAuthorityCsrResponse, errors: [InvalidArnException, InvalidStateException, RequestFailedException, RequestInProgressException, ResourceNotFoundException] }));
/**
 ...
 */
export const createCertificateAuthorityAuditReport = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateCertificateAuthorityAuditReportRequest, output: CreateCertificateAuthorityAuditReportResponse, errors: [InvalidArgsException, InvalidArnException, InvalidStateException, RequestFailedException, RequestInProgressException, ResourceNotFoundException] }));
/**
 ...
 */
export const importCertificateAuthorityCertificate = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: ImportCertificateAuthorityCertificateRequest, output: ImportCertificateAuthorityCertificateResponse, errors: [CertificateMismatchException, ConcurrentModificationException, InvalidArnException, InvalidRequestException, InvalidStateException, MalformedCertificateException, RequestFailedException, RequestInProgressException, ResourceNotFoundException] }));
/**
 ...
 */
export const revokeCertificate = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: RevokeCertificateRequest, output: RevokeCertificateResponse, errors: [ConcurrentModificationException, InvalidArnException, InvalidRequestException, InvalidStateException, LimitExceededException, RequestAlreadyProcessedException, RequestFailedException, RequestInProgressException, ResourceNotFoundException] }));
/**
 ...
 */
export const createCertificateAuthority = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: CreateCertificateAuthorityRequest, output: CreateCertificateAuthorityResponse, errors: [InvalidArgsException, InvalidPolicyException, InvalidTagException, LimitExceededException] }));
/**
 ...
 */
export const issueCertificate = /*@__PURE__*/ /*#__PURE__*/ API.make(() => ({ input: IssueCertificateRequest, output: IssueCertificateResponse, errors: [InvalidArgsException, InvalidArnException, InvalidStateException, LimitExceededException, MalformedCSRException, ResourceNotFoundException] }));
