...
// Input Schema
export const CreateProjectBranchAnonymizedInput = Schema.Struct({
  project_id: Schema.String.pipe(T.PathParam()),
}).pipe(
  T.Http({ method: "POST", path: "/projects/{project_id}/branch_anonymized" }),
);
export type CreateProjectBranchAnonymizedInput =
  typeof CreateProjectBranchAnonymizedInput.Type;

// Output Schema
export const CreateProjectBranchAnonymizedOutput = Schema.Struct({
