...
export type WorkflowReverseTrafficInput =
  typeof WorkflowReverseTrafficInput.Type;

// Output Schema
export const WorkflowReverseTrafficOutput = Schema.Struct({
  id: Schema.String,
  name: Schema.String,
...
export type WorkflowReverseTrafficOutput =
  typeof WorkflowReverseTrafficOutput.Type;
