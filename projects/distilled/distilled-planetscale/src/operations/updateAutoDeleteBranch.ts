...
export const UpdateAutoDeleteBranchInput = Schema.Struct({
  ...
  T.Http({
    method: "PUT",
    path: "/organizations/{organization}/databases/{database}/deploy-requests/{number}/auto-delete-branch",
  }),
);
export type UpdateAutoDeleteBranchInput =
  typeof UpdateAutoDeleteBranchInput.Type;

// Output Schema
export const UpdateAutoDeleteBranchOutput = Schema.Struct({
  id: Schema.String,
...
export type UpdateAutoDeleteBranchOutput =
  typeof UpdateAutoDeleteBranchOutput.Type;
