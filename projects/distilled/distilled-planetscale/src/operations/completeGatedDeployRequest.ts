...
export type CompleteGatedDeployRequestInput =
  typeof CompleteGatedDeployRequestInput.Type;

// Output Schema
export const CompleteGatedDeployRequestOutput = Schema.Struct({
  id: Schema.String,
...
export type CompleteGatedDeployRequestOutput =
  typeof CompleteGatedDeployRequestOutput.Type;
