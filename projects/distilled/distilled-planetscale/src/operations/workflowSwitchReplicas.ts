...
export type WorkflowSwitchReplicasInput =
  typeof WorkflowSwitchReplicasInput.Type;

// Output Schema
export const WorkflowSwitchReplicasOutput = Schema.Struct({
  id: Schema.String,
  name: Schema.String,
...
export type WorkflowSwitchReplicasOutput =
  typeof WorkflowSwitchReplicasOutput.Type;
