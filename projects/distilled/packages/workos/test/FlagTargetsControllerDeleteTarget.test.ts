...
describe("FlagTargetsControllerDeleteTarget", () => {
  it("removes a feature flag target", { timeout: 30_000 }, async () => {
    ...
    // Create a target first so the delete has something to remove.
    await runEffect(
