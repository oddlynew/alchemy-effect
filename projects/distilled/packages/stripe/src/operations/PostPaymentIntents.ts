...
export const PostPaymentIntentsInput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
    ...
    confirmation_method: Schema.optional(
...
export type PostPaymentIntentsInput = typeof PostPaymentIntentsInput.Type;
...
export type PostPaymentIntentsOutput = typeof PostPaymentIntentsOutput.Type;
