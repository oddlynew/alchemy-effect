...
export type PostWebhookEndpointsInput = typeof PostWebhookEndpointsInput.Type;

// Output Schema
export const PostWebhookEndpointsOutput =
  /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
export type PostWebhookEndpointsOutput = typeof PostWebhookEndpointsOutput.Type;
 ...
 */
export const PostWebhookEndpoints = /*@__PURE__*/ /*#__PURE__*/ API.make(
  () => ({
    inputSchema: PostWebhookEndpointsInput,
    outputSchema: PostWebhookEndpointsOutput,
  }),
);
