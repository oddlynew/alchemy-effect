...
).annotate({ identifier: "OnlineAbConfig" }) as any as S.Schema<OnlineAbConfig>;
...
).annotate({ identifier: "MetricGoal" }) as any as S.Schema<MetricGoal>;
...
export const DeleteExperimentResponse = S.suspend(() => S.Struct({})).annotate({
...
export const EntityOverrideMap = S.Record(S.String, S.String.pipe(S.optional));
...
).annotate({ identifier: "Variation" }) as any as S.Schema<Variation>;
...
export const DeleteFeatureResponse = S.suspend(() => S.Struct({})).annotate({
...
).annotate({ identifier: "FeatureSummary" }) as any as S.Schema<FeatureSummary>;
...
export const GroupToWeightMap = S.Record(S.String, S.Number.pipe(S.optional));
...
).annotate({ identifier: "LaunchGroup" }) as any as S.Schema<LaunchGroup>;
...
).annotate({ identifier: "MetricMonitor" }) as any as S.Schema<MetricMonitor>;
...
).annotate({ identifier: "ScheduledSplit" }) as any as S.Schema<ScheduledSplit>;
...
).annotate({ identifier: "Launch" }) as any as S.Schema<Launch>;
...
export const DeleteLaunchResponse = S.suspend(() => S.Struct({})).annotate({
...
export const DeleteSegmentResponse = S.suspend(() => S.Struct({})).annotate({
...
).annotate({ identifier: "RefResource" }) as any as S.Schema<RefResource>;
