...
export const StartChannelResponse = S.suspend(() => S.Struct({})).annotate({
...
export const StopChannelResponse = S.suspend(() => S.Struct({})).annotate({
...
export const DeleteProgramResponse = S.suspend(() => S.Struct({})).annotate({
...
export const DeleteLiveSourceResponse = S.suspend(() => S.Struct({})).annotate({
...
export const DeleteVodSourceResponse = S.suspend(() => S.Struct({})).annotate({
