...
export const DeleteExperienceResponse = S.suspend(() => S.Struct({})).annotate({
...
export const DeleteFaqResponse = S.suspend(() => S.Struct({})).annotate({
...
export const DeleteThesaurusResponse = S.suspend(() => S.Struct({})).annotate({
...
export const ValueImportanceMap = S.Record(S.String, S.Number.pipe(S.optional));
...
export const UpdateExperienceResponse = S.suspend(() => S.Struct({})).annotate({
...
export const UpdateThesaurusResponse = S.suspend(() => S.Struct({})).annotate({
