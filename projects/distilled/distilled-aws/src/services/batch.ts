...
export const TagrisTagsMap = S.Record(S.String, S.String.pipe(S.optional));
...
export const EksLimits = S.Record(S.String, S.String.pipe(S.optional));
export type EksRequests = { [key: string]: string | undefined };
export const EksRequests = S.Record(S.String, S.String.pipe(S.optional));
...
export const EksLabelsMap = S.Record(S.String, S.String.pipe(S.optional));
export type EksAnnotationsMap = { [key: string]: string | undefined };
export const EksAnnotationsMap = S.Record(S.String, S.String.pipe(S.optional));
