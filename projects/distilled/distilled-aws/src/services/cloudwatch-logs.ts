...
export const Dimensions = S.Record(S.String, S.String.pipe(S.optional));
...
export const LogRecord = S.Record(S.String, S.String.pipe(S.optional));
...
export const Histogram = S.Record(S.String, S.Number.pipe(S.optional));
...
export const Enumerations = S.Record(S.String, S.Number.pipe(S.optional));
...
export const EntityAttributes = S.Record(S.String, S.String.pipe(S.optional));
...
export const ExtractedValues = S.Record(S.String, S.String.pipe(S.optional));
