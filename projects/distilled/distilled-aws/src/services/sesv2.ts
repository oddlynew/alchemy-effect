...
export const CancelExportJobResponse = S.suspend(() => S.Struct({})).annotate({
...
export const CreateContactResponse = S.suspend(() => S.Struct({})).annotate({
...
export const CreateContactListResponse = S.suspend(() => S.Struct({})).annotate(
...
export const DeleteContactResponse = S.suspend(() => S.Struct({})).annotate({
...
export const DeleteContactListResponse = S.suspend(() => S.Struct({})).annotate(
...
export const DeleteTenantResponse = S.suspend(() => S.Struct({})).annotate({
...
export const Route = S.suspend(() => S.Struct({ Region: S.String })).annotate({
  identifier: "Route",
...
export const PutAccountDetailsResponse = S.suspend(() => S.Struct({})).annotate(
...
export const UpdateContactListResponse = S.suspend(() => S.Struct({})).annotate(
