...
export const ContentMap = S.Record(S.String, Parameters.pipe(S.optional));
...
export const ResponseBody = S.Record(S.String, ContentBody.pipe(S.optional));
...
export const DeleteAgentMemoryResponse = S.suspend(() => S.Struct({})).annotate(
...
export const SessionMetadataMap = S.Record(S.String, S.String.pipe(S.optional));
...
export const DeleteSessionResponse = S.suspend(() => S.Struct({})).annotate({
