...
export const Environment = S.Record(S.String, S.String.pipe(S.optional));
...
export const ContainerMap = S.Record(S.String, Container.pipe(S.optional));
...
export const DomainEntryOptions = S.Record(S.String, S.String.pipe(S.optional));
...
export const AttachedDiskMap = S.Record(S.String, DiskMapList.pipe(S.optional));
