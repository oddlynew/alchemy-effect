...
export const CreatePermissionResponse = S.suspend(() => S.Struct({})).annotate({
...
export const DeletePermissionResponse = S.suspend(() => S.Struct({})).annotate({
...
export const PutPolicyResponse = S.suspend(() => S.Struct({})).annotate({
...
export const RevokeCertificateResponse = S.suspend(() => S.Struct({})).annotate(
