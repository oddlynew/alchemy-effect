...
export const SyncStates = S.Record(S.String, SyncState.pipe(S.optional));
...
export const IPSets = S.Record(S.String, IPSet.pipe(S.optional));
...
export const PortSets = S.Record(S.String, PortSet.pipe(S.optional));
...
export const LogDestinationMap = S.Record(S.String, S.String.pipe(S.optional));
