...
export const DeleteRequest = S.suspend(() => S.Struct({ Key: Key })).annotate({
...
export const KeyConditions = S.Record(S.String, Condition.pipe(S.optional));
...
export const TransactGetItem = S.suspend(() => S.Struct({ Get: Get })).annotate(
