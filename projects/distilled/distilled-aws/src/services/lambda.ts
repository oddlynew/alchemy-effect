...
export const ContextStartedDetails = S.suspend(() => S.Struct({})).annotate({
...
export const StepStartedDetails = S.suspend(() => S.Struct({})).annotate({
...
export const Endpoints = S.Record(EndPointType, EndpointLists.pipe(S.optional));
...
export const DeleteAliasResponse = S.suspend(() => S.Struct({})).annotate({
