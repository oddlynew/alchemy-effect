...
export const DeleteAccessResponse = S.suspend(() => S.Struct({})).annotate({
...
export const DeleteHostKeyResponse = S.suspend(() => S.Struct({})).annotate({
...
export const StartServerResponse = S.suspend(() => S.Struct({})).annotate({
...
export const StopServerResponse = S.suspend(() => S.Struct({})).annotate({
...
export const DeleteAgreementResponse = S.suspend(() => S.Struct({})).annotate({
...
export const DeleteServerResponse = S.suspend(() => S.Struct({})).annotate({
...
export const DeleteWebAppResponse = S.suspend(() => S.Struct({})).annotate({
