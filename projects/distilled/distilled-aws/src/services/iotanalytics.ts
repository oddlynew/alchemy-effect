...
).annotate({ identifier: "ChannelStorage" }) as any as S.Schema<ChannelStorage>;
...
).annotate({ identifier: "DeltaTime" }) as any as S.Schema<DeltaTime>;
...
).annotate({ identifier: "DatasetAction" }) as any as S.Schema<DatasetAction>;
...
).annotate({ identifier: "DatasetTrigger" }) as any as S.Schema<DatasetTrigger>;
...
).annotate({ identifier: "LateDataRule" }) as any as S.Schema<LateDataRule>;
...
export const JsonConfiguration = S.suspend(() => S.Struct({})).annotate({
...
).annotate({ identifier: "LambdaActivity" }) as any as S.Schema<LambdaActivity>;
...
).annotate({ identifier: "FilterActivity" }) as any as S.Schema<FilterActivity>;
...
).annotate({ identifier: "MathActivity" }) as any as S.Schema<MathActivity>;
...
export const DeleteDatastoreResponse = S.suspend(() => S.Struct({})).annotate({
...
export const DeletePipelineResponse = S.suspend(() => S.Struct({})).annotate({
...
export const UpdateChannelResponse = S.suspend(() => S.Struct({})).annotate({
...
export const UpdateDatasetResponse = S.suspend(() => S.Struct({})).annotate({
...
export const UpdateDatastoreResponse = S.suspend(() => S.Struct({})).annotate({
...
export const UpdatePipelineResponse = S.suspend(() => S.Struct({})).annotate({
