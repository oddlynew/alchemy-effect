...
export const DeleteAccessPointResponse = S.suspend(() => S.Struct({})).annotate(
...
export const DeleteFileSystemResponse = S.suspend(() => S.Struct({})).annotate({
...
export const DeleteMountTargetResponse = S.suspend(() => S.Struct({})).annotate(
