...
- [`LocalState.ts`](https://github.com/alchemy-run/alchemy-effect/blob/main/projects/alchemy/packages/alchemy/src/State/LocalState.ts) — filesystem-backed, the simplest end-to-end example
- [`HttpStateStore.ts`](https://github.com/alchemy-run/alchemy-effect/blob/main/projects/alchemy/packages/alchemy/src/State/HttpStateStore.ts) — HTTP client against the Alchemy state API
- [`InMemoryState.ts`](https://github.com/alchemy-run/alchemy-effect/blob/main/projects/alchemy/packages/alchemy/src/State/InMemoryState.ts) — minimal in-process map, useful as a template
