...
- [`examples/monorepo-single-stack`](https://github.com/alchemy-run/alchemy-effect/tree/main/projects/alchemy/examples/monorepo-single-stack)
- [`examples/monorepo-multi-stack`](https://github.com/alchemy-run/alchemy-effect/tree/main/projects/alchemy/examples/monorepo-multi-stack)
