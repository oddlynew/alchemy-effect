...
[`Binding.ts`](https://github.com/alchemy-run/alchemy-effect/blob/main/projects/alchemy/packages/alchemy/src/Binding.ts):
...
- [`AWS/S3/GetObject.ts`](https://github.com/alchemy-run/alchemy-effect/blob/main/projects/alchemy/packages/alchemy/src/AWS/S3/GetObject.ts)
